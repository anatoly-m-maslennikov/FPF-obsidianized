...
**Builds on.** [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] (TaskSignature attachment and task-family anchoring), [[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] (`BLP` compatibility), [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (role, method, work-plan, and work-occurrence split for scout/probe work), [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] (`CheckpointReturn` planning semantics), [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] (budget enforcement).
**Coordinates with.** [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] (selector specialization profiles), [[G.9 - Parity and Benchmark Harness|G.9]] (adaptation parity), [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] (later telemetry and refresh reuse).
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:1 - Problem frame
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:2 - Problem

FPF needs one compact way to publish a bounded specialization claim on the same declared task family and work target without retyping the task anchor from [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] or silently pushing the adaptation-signature question into selector/parity prose.

## [[C.22.1 - Task-family adaptation signature|C.22.1]]:3 - Use this when
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:4 - What goes wrong if missed
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:5 - What this buys
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:6 - Forces
...
| Task anchor vs adaptation-signature question | The section must keep the adaptation-signature question readable without retyping task anchoring from [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] or turning selector/parity law into the same pattern. |
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:7 - Solution — one adaptation signature over the [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] anchor

- Use one shared adaptation-signature field set for this question. [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], and later notes may cite or consume it, but they should not silently rename threshold, prior-exposure, transfer, downside, or corridor-entry terms.
...
- These fields stay anchored to the same work target and work-measure threshold semantics already declared by [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]], so adaptation is typed as movement toward usable specialization rather than as an ungrounded growth story.
- [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] continues to carry the declared task-family anchor, task typing, and baseline `TaskSignature`. [[C.22.1 - Task-family adaptation signature|C.22.1]] narrows the adaptation-signature question to threshold timing, reuse, downside, and corridor-entry disclosure over that existing anchor.

## [[C.22.1 - Task-family adaptation signature|C.22.1]]:8 - Corridor, transfer, and durability discipline
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:9 - Worked moment
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:10 - Consequences
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:11 - Rationale

The reader needs one place where the adaptation claim stays whole. [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] keeps the task family and work target explicit. [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], and [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] may generate the probe, checkpoint, and budget evidence. [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] and [[G.9 - Parity and Benchmark Harness|G.9]] later compare several candidates or parity runs. [[C.22.1 - Task-family adaptation signature|C.22.1]] keeps the specialization story readable across those neighbouring pattern applications by making threshold timing, reuse, downside, and corridor-entry field recoverable in one short read instead of forcing the reader to reconstruct it from scattered notes.

## [[C.22.1 - Task-family adaptation signature|C.22.1]]:12 - SoTA-Echoing
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:13 - Relations
...
- [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] may flag: a claim that a holder, dyad, team, specialist portfolio, method, or agent acquires usable specialization faster on one declared `TaskFamilyRef` or `TaskSignature`.
...
- Non-admissible use: generic "learns faster" wording without task-family anchors does not create a [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] profile or a complete adaptation signature; faster threshold crossing is not durable specialization unless transfer, retention, downside, and corridor-entry evidence are stated when claimed.

- Exit: downgrade to Dyn1 trend when only a trend is live; use [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] when the question is only tool-use planning; use [[C.22.1 - Task-family adaptation signature|C.22.1]] when specialization is the live adaptation question.

**Builds on:** [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] TaskSignature anchoring, [[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] `BLP` compatibility, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] role, method, work-plan, and work-occurrence separation, [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] scout/probe and `CheckpointReturn` semantics, [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] budget enforcement.
**Coordinates with:** [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] selector specialization profiles, [[G.9 - Parity and Benchmark Harness|G.9]] adaptation parity, [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] later telemetry/refresh reuse.

**Coordinates with:** [[E.23 - Quality Improvement Loop Method|E.23]] when a quality-improvement loop claims durable task-family specialization. [[C.22.1 - Task-family adaptation signature|C.22.1]] carries the adaptation-signature fields for threshold target, time-to-threshold, budget-to-threshold, prior exposure, transfer, retention, downside, and corridor entry; it does not restate the [[E.23 - Quality Improvement Loop Method|E.23]] loop method, [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] review framing, or pattern-quality or DRR-adequacy object-under-improvement evaluations.

**Constrained by:** [[E.10 - Unified Lexical Rules for FPF|E.10]] lexical discipline and [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] pattern-quality review when this child section is newly landed or materially revised.

## [[C.22.1 - Task-family adaptation signature|C.22.1]]:14 - Not this pattern when

- the claim only needs to name the task family and work-measure threshold target, with no adaptation-speed or transfer claim at all; ordinary [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] anchoring is enough
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:15 - Conformance checklist
...
- `CC-C22.1-4` This pattern may refine specialization timing and reuse claims over the declared [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] anchor, but it **SHALL NOT** redefine acceptance-gate thresholds, task-family attachment, or selector/parity law governed by another FPF pattern.
...
## [[C.22.1 - Task-family adaptation signature|C.22.1]]:End
