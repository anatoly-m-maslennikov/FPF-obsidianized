...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:1 - Problem frame
...
Start with [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] when the architecture claim itself is unclear. Use [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] only when a structural view over selected architecture-relevant structure changes the next move. Use a full `ArchitectureStructuralView@Context` only when the view changes action, selected reliance relation, correspondence, source return, publication, comparison, or another governing-pattern use.

What goes wrong if [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] is missed: one favored diagram, module view, TEVB viewpoint, generated relation graph, control sketch, or neural-network block diagram is treated as the architecture view or proof without naming the selected structure kind, hidden or lost structure, correspondence, and next move.

What [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] buys in practice: the practitioner can bind selected structure kind to view record, viewpoint, construction mode, selected relations, hidden or lost structure, correspondence, source-return condition, and admissible use before relying on that view.

Not this pattern when the question under repair is only the general architecture claim, structure as such, selected transformation-flow relation, mathematical graph description, path relation, or crossing relation. Use [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]], [[E.18 - Transformation Flow Structure|E.18]], [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]], [[C.29 - Mathematical Lens Use|C.29]], or [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]] as appropriate. If the view is used for another claim being made, use the governing pattern and keep [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] only to the view portion.

Thin precision-restoration pointer: if the issue under repair is still whether *view*, *architecture view*, *architecture structural view*, *diagram*, *model*, *graph*, *layer*, or *functional architecture* names a structural view, an architecture description, a publication face, a publication form, a source relation, or another governed claim or relation named by value, use [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] first. Do not copy the [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] trigger table here; apply [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] only after the architecture structural-view claim or non-ASV claim named by value is recoverable.

## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:2 - Problem
...
- functional architecture is treated as a peer ontology rather than a structure-kind interpretation under [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]];
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:3 - Forces
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4 - Solution
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.2 - Architecture structure-kind classifier
...
Inside [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], `OtherDeclaredStructureKind` is always an architecture-structure-kind classifier value over `U.Structure`; it does not mint a general FPF root kind.
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.3 - Small triage output
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.4 - Architecture viewpoint bundle and binding rows
...
Declaration source: `VF.ARCH.STRUCTURE` is an [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] and [[F.18 - Local‑First Unification Naming Protocol|F.18]] declared viewpoint bundle for architecture structural-view records. Its `VP.Architecture*` ids are viewpoint ids only. They do not add TEVB viewpoints, name structure kinds, define publication faces, or carry decision, evidence, gate, or assurance authority.

### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.4a - Structural-view publication-use boundary

This subsection is the [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] structural-view publication-use boundary. [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] governs architecture structural-view adequacy: selected architecture-relevant structure, structure kind, view construction, correspondence, hidden structure and lost structure, source return, and next architecture move. When a view, diagram, graph, card, benchmark, probe output, model publication, or architecture note is used for evidence sufficiency, safety assurance, gate passage, release permission, work record, or decision authority, apply the pattern governing that claim; keep only the structural-view record and the next architecture move in [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]].
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.5 - Initial architecture structure kinds and view records
...
| --- | --- | --- | --- |
| `FunctionalStructure` | `FunctionalStructureView@Context` | `functionalBehaviorRefs`, `functionalElementRefs?`, `transformerSideFillerRefs?`, `candidateBearerRefs?`, input-condition refs, output-condition refs, functional-port refs, capability refs, dependency refs, allocation refs, correspondence refs | Use [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]], capability, work, module-allocation, or requirement patterns when those claims are being made. |
| `TransformationFlowStructure` | `TransformationFlowStructureView@Context` | `transformationFlowStructureRef`, `pathSliceRefs`, `crossingRefs`, `valuationRefs`, `mathematicalDescriptionRefs?` | Use [[E.18 - Transformation Flow Structure|E.18]] and [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]] for selected transformation-flow structure, path, or crossing input; use [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]] and [[C.29 - Mathematical Lens Use|C.29]] for mathematical graph descriptions; use [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal claims. |
...
| `ModuleInterfaceStructure` | `ModuleInterfaceStructureView@Context` | module relation refs, interface specs, admissibility conditions, substitutability policy or change policy | Use [[A.6.M - Module Relation Repair|A.6.M]] module-relation repair and conformance evidence when those claims are being made. |
...
| `ControlStructure` | `ControlStructureView@Context` | control role refs, declared control-rate refs, observer, estimator, controller, planner, and supervisor relations, feedback refs | Use [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], dynamics, temporal, causal, evidence, and assurance patterns when those claims are being made. |
...
Externally governed classifier values remain admissible when they are the architecture-relevant structure under consideration, but [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] does not define their full record families:

| Externally governed classifier value | ASV use | Full semantics and governing patterns |
| --- | --- | --- |
| `WorkMethodStructure` | Method arrangement or work arrangement changes the architecture move. | Use `MethodDescription`, `WorkPlan`, `WorkEnactment`, exception path, launch relation or gate relation, and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] governing patterns; do not turn a work-method diagram into work authority. |
...
| `EvidenceAssuranceStructure` | Evidence reuse or assurance arrangement changes affected structure or source return. | Use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence sufficiency or assurance verdict; ASV only names the structure and loss boundary. |
| `ScaleEvolutionStructure` | Scale window, replacement or change policy, trajectory reference, or coarse-graining changes the architecture move. | Use [[C.29 - Mathematical Lens Use|C.29]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], temporal, source-return, or decision patterns for scale, characterization, or selection claims. |
...
| --- | --- | --- | --- |
| `FunctionalStructure` | Capability, effect, or transformation allocation. | Purpose truth or requirement satisfaction. | [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], capability, work, or requirement pattern when that claim kind is being made. |
| `TransformationFlowStructure` | Path, crossing, valuation, or selected transformation slice. | Whole architecture or causal proof. | [[E.18 - Transformation Flow Structure|E.18]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]], [[C.29 - Mathematical Lens Use|C.29]], or [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] when selected structure, graph description, path, crossing, mathematical-lens, or causal-use claim kind is being made. |
| `ControlStructure` | Controller, observer, plant, feedback, or rate relation. | Stability, safety, or assurance proof. | [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], temporal, dynamics, causal, evidence, or assurance pattern when that claim kind is being made. |
| `ModuleInterfaceStructure` | Module relation, interface spec, or substitutability boundary. | Module tree as all architecture. | [[A.6.M - Module Relation Repair|A.6.M]] module-relation repair, conformance evidence, or decision pattern when that claim kind is being made. |
...
| `SecurityTrustBoundaryStructure` | Trust boundary, untrusted input, privilege path, or attack exposure. | Security proof, risk score, or compliance label. | Evidence, assurance, gate, [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] agentic tool-use relation or call-planning relation, [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], or [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] when that security, evidence, assurance, gate, tool-use, measurement, quality, or control claim kind is being made. |
...
SecurityTrustBoundaryStructureView@Context ::= {
  ...
  governingPatternApplicationRefs:
    [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] | [[G.6 - Evidence Graph & Provenance Ledger|G.6]] | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] | [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] | [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] | [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] |
    [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] | [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] agentic tool-use relation or call-planning relation when tool authority is being claimed | [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] when a control relation is being claimed
  admissibleUse:
...
SafetyLossControlStructureNote:
  ...
  architectureStructureKindRefs:
    ...
    EvidenceAssuranceStructure
  governingPatternApplicationRefs:
    [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] dynamics, [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] temporal or rate,
    [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[G.6 - Evidence Graph & Provenance Ledger|G.6]] evidence,
    [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate
  nonAdmissibleUse:
...
A selected transformation-flow structure, mathematical graph description, path slice, crossing, or flow valuation is not a functional element by default. When a transformation-flow relation is being used, connect the functional view to `TransformationFlowStructure` through [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]]. When a mathematical graph description is being used, connect it through [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]]; when math-lens use is being claimed, connect it through [[C.29 - Mathematical Lens Use|C.29]]. When module allocation is being claimed, connect the functional view to [[A.6.M - Module Relation Repair|A.6.M]] module-relation repair rather than treating function and module as one kind. Functional ports and module interfaces can both use `U.Signature` discipline, but functional ports govern behavior input and output slots while module interfaces govern substitution, compatibility, boundary, and change-policy claims.
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.7 - Correspondence and source return
...
| "This evidence covers the replacement." | `EvidenceReuseToAffectedStructure`; assign sufficiency or verdict to [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. |
| "This requirement constrains that structure." | `RequirementToStructureConstraint` or a constraint record named by value. |
| "This scale window changes the structure kind." | `ScaleWindowToStructureKindCorrespondence`; assign scale-lens claims to [[C.29 - Mathematical Lens Use|C.29]] when those claims are being made. |
...
### [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:4.8 - Worked slices
...
Use [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] only when tool-use, call planning, call graph, work execution, or budgeted agentic tool-use is the claim being made. Do not absorb those claims into architecture structure.
...
Evidence reuse across product variants:
  ...
  governingPatternApplicationRefs:
    [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence sufficiency or assurance verdict
  nonAdmissibleUse:
...
governingPatternApplicationRefs:
  [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]] when an [[E.18 - Transformation Flow Structure|E.18]] flow relation is being used,
  [[A.6.M - Module Relation Repair|A.6.M]] module-relation repair for tool, API, or interface relation claims,
  [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when evidence or assurance reliance is being claimed,
  [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] agentic tool-use relation or call-planning relation, [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] when tool-call, autonomy, constraint, or gate authority is being claimed
stop condition:
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:5 - Archetypal Grounding

| Tell-Show-Show row | Grounding |
| --- | --- |
| Tell | A practitioner looks at an architecture "view" and asks whether it is functional, flow, control, module-interface, information or data, placement, scale, work, evidence, or declared logical structure. [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] turns that question into structure-kind triage or a full structural view record. |
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:6 - Bias-Annotation
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:7 - Conformance Checklist
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:9 - Consequences
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:11 - SoTA-Echoing

| Practice or source line | [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] adoption | Action consequence | Boundary |
| --- | --- | --- | --- |
...
| UAF, ArchiMate, C4, and multi-view architecture practice | Adapt viewpoint-library and lightweight diagram communication pressure. C4 contributes communication and zoom pressure only. | C4-like, UAF-like, and ArchiMate-like diagrams can publish ASV records only when Description-episteme or specification-use content, DescriptionContext EntityOfConcern, structure refs, structure kind, viewpoint, and publication relation are explicit. | Do not import their layer, viewpoint, enterprise taxonomies, structure-kind adequacy, evidence sufficiency, or architecture decision claim without a recoverable [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] or [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] source view. |
...
## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:12 - Relations

Builds on: [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]], [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[A.1 - U.Holon, U.System, and U.Episteme|A.1]], [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]], [[E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]], [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]], [[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], and [[F.18 - Local‑First Unification Naming Protocol|F.18]].

Coordinates with: [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[A.6.M - Module Relation Repair|A.6.M]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], [[C.30.ILC - Cross-Scope Architecture Residual Triage|C.30.ILC]], [[E.18 - Transformation Flow Structure|E.18]], [[C.29 - Mathematical Lens Use|C.29]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], and governing patterns for architecture decision and candidate-set claims. Use [[A.6.M - Module Relation Repair|A.6.M]] when the module-interface claim kind is being made.

Neighboring claims stay with their governing patterns: [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] for grounded architecture and selected-structure adequacy, [[A.1 - U.Holon, U.System, and U.Episteme|A.1]] for the described holon recovered through `ArchitectureOf@Context`, [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] for selected-structure EntityOfConcern, [[E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] for ontic-description and publication-form boundary, [[E.18 - Transformation Flow Structure|E.18]] for selected transformation-flow structure, path, and crossing discipline, [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]] and [[C.29 - Mathematical Lens Use|C.29]] for mathematical graph descriptions and mathematical-lens use, [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] for characterization, [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] for Q-Bundles, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal use, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[G.6 - Evidence Graph & Provenance Ledger|G.6]] for evidence, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] and [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gate or release records, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for work, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] for decisions, and [[E.17 - Multi‑View Publication Kit|E.17]] for publication. [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] governs architecture structural-view adequacy for the selected structure being viewed.

## [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]]:End
