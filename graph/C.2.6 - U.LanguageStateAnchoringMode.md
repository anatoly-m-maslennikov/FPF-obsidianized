...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:1 - Problem frame
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:2 - Problem
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:4 - Solution
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:4.1 - Starter family
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:4.2 - Governing boundary
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:4.3 - Mixed-mode rule
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:4.4 - Bridge implications
Bridge work over governed `U.Episteme` publications in the declared language-state chart should pay attention to anchoring shifts. A translation from `AM.EmbodiedFelt` to `AM.DocumentMediated`, or from `AM.ModelLatent` to prose, often requires explicit loss notes in [[F.9 - Alignment & Bridge across Contexts|F.9]] and often justifies a stance annotation in [[F.9.1 - Bridge Stance Overlay|F.9.1]].

## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:5 - Archetypal Grounding
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:6 - Bias-Annotation
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:7 - Conformance Checklist
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].6-1` Anchoring mode **SHALL NOT** be inferred from publication phrasing alone when it matters for routing, trust, or bridge interpretation.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].6-2` Embodiment-sensitive or operator-loop cases **SHOULD** declare the embodiment or operator anchor explicitly.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].6-3` `U.LanguageStateAnchoringMode` **MUST NOT** be collapsed into `U.LanguageStateRepresentationFactorBundle`.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].6-4` Mixed-mode declarations **SHALL** list their component modes explicitly.

## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:9 - Consequences
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:10 - Rationale
The declared language-state chart over `U.CharacteristicSpace` needs one explicit anchoring basis slot so that [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], and [[F.9.1 - Bridge Stance Overlay|F.9.1]] can refer to anchoring regime without redefining it.

## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:11 - SoTA-Echoing
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:12 - Relations
...
- Coordinates with: [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]], [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[F.9.1 - Bridge Stance Overlay|F.9.1]].
- Constrains: cue publication and bridge loss notes.

## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:13 - Worked Examples and Bridge-Loss Cases

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:13.1 - Embodied-to-document shift
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:13.2 - Model-latent to operator-loop case
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:13.3 - Mixed-mode publication
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:14 - Authoring and Review Guidance

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:14.1 - Author prompt
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:14.2 - Review prompt
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:14.3 - Bridge note
If anchoring changes across publication or translation, [[F.9 - Alignment & Bridge across Contexts|F.9]] and [[F.9.1 - Bridge Stance Overlay|F.9.1]] should often carry explicit loss or stance notes rather than silent equivalence language.

## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:15 - Extension and Migration Notes

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:15.1 - Local extension rule
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:15.2 - Migration from metaphorical prose
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:15.3 - Boundary reminder
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:16 - Anchoring Publication Package Discipline

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:16.1 - Minimal anchoring package
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:16.2 - Source-versus-face rule
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:16.3 - Mixed-mode decomposition rule
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:17 - Anchoring Shift and Transport Discipline

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:17.1 - Shift declaration rule
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:17.2 - Bridge-loss handoff
If an anchoring shift matters across contexts, [[F.9 - Alignment & Bridge across Contexts|F.9]] or [[F.9.1 - Bridge Stance Overlay|F.9.1]] should govern the loss or stance note. [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]] only requires the shift to be noticed and not misrepresented as lossless.

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:17.3 - Same-content illusion test
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:18 - Review Matrix and Extension Tests

### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:18.1 - Review matrix
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:18.2 - Local extension test
...
### [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:18.3 - Cross-facet reminder
...
## [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]]:End
