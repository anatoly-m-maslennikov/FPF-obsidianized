...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:1 - Problem Frame
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:2 - Problem
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:3 - Forces
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:4 - Solution — *The Three‑Domain Falsification Test*
...
(References: **[[C.17 - Characterising Generative Novelty & Value (Creativity‑CHR)|C.17]]** `Diversity_P` & illumination Summary as telemetry metric; **[[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]]** `U.DescriptorMap`, `U.IlluminationSummary`.)
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:5 - Archetypal Grounding (System / Episteme)
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:6 - Conformance Checklist
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:7 - Consequences
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:8 - Rationale
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:9 - Relations
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:10 - Known Uses
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:11 - Open Questions
...
## [[A.8 - Universal Core Principle (C‑1)|A.8]]:End
