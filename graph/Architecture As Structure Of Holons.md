...
The architecture patterns make this distinction usable. [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] governs architecture as an EntityOfConcern. [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] governs architectural characteristics. [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] governs architecture structural views. [[C.30.AD - Architecture Description Adequacy|C.30.AD]] governs architecture descriptions. [[A.6.M - Module Relation Repair|A.6.M]] governs module-interface relation repair. [[C.31 - Modularity and Reusable Structure Characteristics|C.31]] and related architecture patterns govern modularity, reusable structure, scale, selected structures, interlevel tension, and architecture-changing moves.
