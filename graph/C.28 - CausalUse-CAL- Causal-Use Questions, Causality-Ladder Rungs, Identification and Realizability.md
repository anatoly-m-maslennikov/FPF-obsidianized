...
related:
  ...
  - "[[A.2.4 - U.EvidenceRole|A.2.4]]"
  - "[[A.6 - Signature Stack & Boundary Discipline|A.6]]"
  - "[[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]"
  - "[[A.6.C - Contract Unpacking for Boundaries|A.6.C]]"
  ...
  - "[[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]]"
  ...
  - "[[D.5 - Bias-Audit & Ethical Assurance|D.5]]"
...
**Not a physical ontology.** [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs how FPF authors, reviewers, and operators use causal models, evidence, and counterfactual reasoning in records, policy claims, fairness claims, method comparisons, and work plans. It does not define physical causality in general and does not replace local domain science.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0 - Use This When

Use [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] when a claim is being used causally:
...
Use [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] especially when the claim must distinguish:
...
**Not this pattern when.** If no causal use is claimed, keep the work in the neighboring pattern: [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] for measurement, [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal trend or rate-change adequacy, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance result, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence graph reference, [[G.9 - Parity and Benchmark Harness|G.9]] for ordinary parity, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] for local choice, [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] for pool policy, [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] for call planning, or [[C.26 - Quantum-Like Modeling Lens|C.26]] for a surviving quantum-like modeling cue after ordinary causal explanations have been tried.

**Activation boundary.** [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates at `CausalUseActivation`: causal wording changes what the claim makes admissible for publication, choice, deployment, assurance, audit, benchmark, or support treatment. The trigger is admissible downstream use, not the presence of a causal-looking word. If the wording is only exploratory prose and no causal use governed by [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] is made, rewrite to association, trend, measurement, or simulation-only wording and stop.

Exploratory causal-looking prose is not a `CausalUseActivation` by itself. A note may say that a relation is plausible, worth probing, or suggested by traces and still remain in [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], or [[G.9 - Parity and Benchmark Harness|G.9]] until the text makes a causal use governed by [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] admissible. The moment the text makes publication, choice, deployment, assurance, audit, benchmark, or support treatment depend on causal support, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs the causal-use boundary.

### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.1 - What Goes Wrong If Missed

A causal-looking phrase backed only by association, proxy, simulation-only, or rhetorical support gets promoted into a causal use that requires a named [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis and verdict.
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.2 - What This Buys

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] gives FPF one cheap first stop for causal use.
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.3 - First-Minute Questions

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] in 60 seconds is the operational entry into `CausalUseTriageRecord`:
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.4 - First Output
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:1 - Problem Frame
...
[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] exists because causal use cuts across those neighbors. The same sentence can be:

- a measurement description handled by [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]];
- a temporal trend handled by [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]];
- an assurance claim handled by [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]];
- an evidence graph reference handled by [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]];
- a decision record handled by [[C.11 - Decision Theory (Decsn-CAL)|C.11]];
- a pool-policy record handled by [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]];
- a call-planning record handled by [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]];
- a fairness audit handled by [[D.5 - Bias-Audit & Ethical Assurance|D.5]];
- a parity report handled by [[G.9 - Parity and Benchmark Harness|G.9]];
- a quantum-like residual handled by [[C.26 - Quantum-Like Modeling Lens|C.26]];
- or a causal-use claim governed here.

The first pattern task is therefore not to classify wording for its own sake. It is to recover the live causal question, the target causality-ladder rung, the support basis currently available, and the cheapest truthful next move. Sometimes that move is to downgrade the claim to association, temporal change, metric-only fairness, or simulation-only use. Sometimes it is to open identification, realizability, evidence-design, fairness, policy-evaluation, or benchmark-parity work. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] exists to keep those moves distinct and to stop teams from acting as if an identification, realizability, or intervention-support basis had already been earned.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:2 - Problem
...
[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] prevents those collapses by making rung, support, and use explicit before claims requiring higher causal support are admitted.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:3 - Forces
...
| Domain plurality vs one FPF pattern | SCM/PCH, potential outcomes, target-trial emulation, causal ML, transportability, causal representation learning, causal RL, and causal fairness must all remain recognizable without making [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] a one-school vocabulary. |
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4 - Solution
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.0 - Causal-use governance and consumer carry-through boundary

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs causal-use objects and causal-use support roles. Neighbor patterns keep their local authority and consume only the causal-use pieces they need: measurement, evidence path, assurance, fairness, decision, exploration, call-planning, dispatch, parity, and refresh records do not become causal-use governing patterns by carrying [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] fields.

| Object or decision | [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs | Neighbor may carry | Neighbor must not do |
| --- | --- | --- | --- |
| Causal-use kind and rung | `CausalUseClaimKind`, `CausalityLadderRung`, causal-use question, comparator/counterfactual, estimand, supported use, unsupported use | `causalUseSpec?`, `causalActionUseSpec?`, method dispatch spec, parity record, fairness audit card | Infer causal-use kind from local vocabulary alone or publish a higher `CausalityLadderRung` without [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support |
| Causal evidence support basis | `CausalEvidenceSupportBasis` and its five values | Evidence path refs in [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], evidence-role specializations in [[A.2.4 - U.EvidenceRole|A.2.4]], consumer fields in [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[D.5 - Bias-Audit & Ethical Assurance|D.5]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[G.9 - Parity and Benchmark Harness|G.9]] | Mint another support-basis value set, add assumption-only/no-support values, or let simulation-only output become realized evidence by name |
...
| Assurance consequence | `CausalUseSupportVerdict` as causal-use action grammar | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] degrade/block/abstain consequences for `F-G-R/CL` assurance | Let assurance prose certify causal identification, realizability, or fairness |
| Fairness, policy, and parity specialization | Causal-use question/rung/estimand/support basis/support verdict for fairness, policy, and causal method comparison | [[D.5 - Bias-Audit & Ethical Assurance|D.5]] ethical/fairness audit card, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] choice result, [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] pool policy, [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] call plan, [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] method dispatch spec, [[G.9 - Parity and Benchmark Harness|G.9]] parity report with local refs to consumed [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support | Collapse metric disparity, policy replay, method dispatch, or benchmark score into a causal-use verdict |

A neighbor may quote the [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] values it consumes for by-value readability. Quoting the values does not transfer governing authority. A neighbor pattern governs only its local record and must cite [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] when the causal-use question or causal-support basis is live.
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.1 - Causality-Ladder Rung
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.1a - Causal-Use Claim Kind
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.2 - Causal-Use Cards
...
The durable card is not the default. It is the record used when a causal note without the required [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis would be unsafe.

### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.3 - Causal Evidence Support Basis
...
This is the [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]-governed value set for causal evidence support basis. `causalAssumptionOnlySupport` and `noCausalEvidenceSupport` are not values of `CausalEvidenceSupportBasis`: assumption-only support condition belongs in `causalAssumptionSetRef` plus supported use and unsupported use; no-support basis value belongs in `CausalUseSupportVerdict`, `unsupportedUse`, or `abstain`.
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.4 - Identification Profile
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.5 - Counterfactual Sampling Realizability Profile
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.6 - Applied Causal-Inference Profiles
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.7 - Causal Graph Representation Names
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.8 - Causal Use Evidence Design
...
This record does not replace [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. It gives them causal-use structure.
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.9 - Verdicts
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.10 - Causal Action Policy Class
...
This distinction matters for [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], and [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]]; it does not make those patterns the authority for causal evidence, identification, or realizability.

`CausalActionPolicyClass` is a classification value for policy-use class: natural behavior, interventional action, counterfactual policy, mixed policy, or unknown policy. It is not the policy object, not `U.Policy`, not [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] pool policy, and not the executable policy used by an agent.

### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.10a - Local `U.*` Docking
...
| --- | --- |
| "causal evidence" | name `CausalEvidenceSupportBasis`, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path refs, `CausalUseSupportRecordRef`, and `CausalUseSupportStatement` / `CausalUseUnsupportedStatement` |
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.11 - Neighbor Routing Table

| If the issue under repair is... | Use... | [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] role |
| --- | --- | --- |
| measured value, score, scale, indicator, or metric definition | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] | Only active when the measure is used causally. |
| temporal trend, rate, acceleration, inertia, or rhythm wording | [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] | Active when temporal wording is used as causal effect or intervention evidence. |
| evidence graph reference or provenance | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] | Carries evidence/provenance path and [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support-basis refs, not causal-use support authority. |
| assurance level, degrade, abstain, or trust or assurance result | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] | Consumes [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support verdicts and applies assurance consequences. |
| local decision among options | [[C.11 - Decision Theory (Decsn-CAL)|C.11]] | Provides causal action-policy hooks when value/regret/optimality depends on causal rung. |
| exploration/exploitation over live pools | [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] | Provides causal data-collection or causal policy-learning hooks when live. |
| tool/call/enactment plan | [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] | Provides optional causal action use spec when the call selects observation, intervention, counterfactual-rung evidence collection, or counterfactual policy conditioning. |
| bias and fairness audit | [[D.5 - Bias-Audit & Ethical Assurance|D.5]] | Provides causal fairness rung and supported fairness use. |
| method dispatch or selector-facing registry | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] | Provides causal method/policy class declarations when causal methods are compared. |
| benchmark or method parity | [[G.9 - Parity and Benchmark Harness|G.9]] | Provides causal method rung parity. |
| quantum-like modeling cue | [[C.26 - Quantum-Like Modeling Lens|C.26]] | Receives only the residual QL cue after causal-use explanation has been tried. |

### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.12 - Non-Goals

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] does not:
...
- replace [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] measurement and metrics characterization, including metric construction, calibration, and non-causal score interpretation;
- replace [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence graph referring, provenance paths, evidence-role carriers, or evidence graph path discipline;
- replace [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] trust and assurance calculus, assurance tuples, `F-G-R/CL` consequences, or assurance publication use;
- replace [[D.5 - Bias-Audit & Ethical Assurance|D.5]] bias audit and ethical assurance, causal-fairness audit responsibility, or human/group-impact review;
- replace [[G.9 - Parity and Benchmark Harness|G.9]] parity benchmark harness, causal-rung parity screen, or benchmark report structure;
- replace [[C.11 - Decision Theory (Decsn-CAL)|C.11]] choice, [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] exploration/exploitation policy, or [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] call-planning patterns; it only supplies causal-use support boundaries consumed by those patterns.

### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.13 - Cheap Downgrade Library
...
### [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.14 - CausalUseBureaucracySniffTest
...
| Did it block a concrete causal overclaim by naming the causal use governed by [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] as unsupported? | Use association, trend, simulation-only, or metric-only wording and stop. |
...
| Cross-rung benchmark: "method A beats method B as a causal method." | claim kind = `causalBenchmarkParityClaim`; use [[G.9 - Parity and Benchmark Harness|G.9]] `CausalRungParityScreen`; supported use = within-rung parity or declared bridge and loss; unsupported use = one scalar causal winner when rungs/support bases differ. |
| Temporal-cause wording: "after launch, recovery got faster, so launch caused resilience." | supported use = [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] temporal/rate adequacy; unsupported use = causal-effect claim until [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] names intervention timing, outcome window, assumptions, rival causes, and support basis. |
| QL escape: "ordinary probability is hard here, so the effect is quantum-like." | supported use = causal-use triage and ordinary-neighbor explanation first; unsupported use = bypassing [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] with quantum-like vocabulary; [[C.26 - Quantum-Like Modeling Lens|C.26]] is retained only for residual quantum-like probe, frame, order, export, or coarsening issue. |
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:5 - Archetypal Grounding
...
**Show (System).** A product team observes that users who received an intervention had better outcomes. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] first records an observational association unless the team can name an interventional-action design, target trial protocol, identification profile, or evidence design that supports intervention-effect use. If the team only has observational association, the next move is to publish association or build evidence, not to claim causal improvement.

**Show (Episteme).** A fairness report says one model is fair because a metric improved after a policy change. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] asks whether the fairness claim is associative, interventional, or counterfactual. If it is interventional-action-rung only, it cannot be published as counterfactual fairness without identification or realizability support.

**Show (Policy).** A team wants to deploy a causal policy learned from logged behavior data. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] records `causalPolicyClaim`, `interventionalActionRung` or `counterfactualComparisonRung` as appropriate, `CausalActionPolicyClass`, `OffPolicyCausalEvaluationProfile`, support/overlap checks, uncertainty, supported policy use, and unsupported policy use. If the behavior policy cannot support the target policy, the admissible output is bounded use or abstain rather than "the policy is optimal".

**Show (Causal RL).** An online learner uses behavior-policy logs and counterfactual data-fusion to choose a treatment, ranking, or action policy. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] records the natural behavior policy, evaluation policy, `CausalActionPolicyClass`, target rung, confounding/support assumptions, `OffPolicyCausalEvaluationProfile`, uncertainty, supported policy use, and unsupported policy use. The learner may publish bounded causal policy support only for the declared regime; it must not turn replay reward, exploration success, or counterfactual strategy output into an unqualified optimal-action claim.

**Show (Evidence Work).** A lab can physically run a counterfactual-rung sampling procedure by assigning compatible action regimes to matched units under ethical and operational constraints. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] separates `CounterfactualSamplingRealizabilityProfile` from `CausalIdentificationProfile`: the realized sampling work becomes `U.Work` with evidence carriers and guards, while identification remains the inferential route from assumptions, graph, calculus, and available data.

**Show (Simulation-Only).** A simulator produces "what would have happened" traces for a rollout decision. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] can allow useful model-supported use without calling the traces realized counterfactual-rung evidence: the record uses `simulationOnlyCounterfactualOutputBasis`, names `counterfactualModelAssumptionSetRef`, `simulationValidationRef`, supported simulation use, and unsupported use. The output may support rehearsal, sensitivity exploration, or model-based explanation inside declared limits; it does not support direct counterfactual sample wording or intervention-effect publication by vocabulary alone.

**Show (Benchmark).** A benchmark compares one observational predictor, one intervention optimizer, and one counterfactual strategy. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] does not ban the comparison, but it requires `CausalMethodRungParityRecord` through [[G.9 - Parity and Benchmark Harness|G.9]]: if rung, `estimandRef`, interventional-action basis, support basis, consumed [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support record and verdict, transportability, follow-up window, and estimation-validity basis are not comparable, the benchmark publishes bridge and loss relation, degraded use, or abstain instead of one superiority claim.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:6 - Bias-Annotation

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] is mainly a causal-discipline and anti-overclaim pattern for decision-bearing causal use. One part of that work is catching language laundering, but the larger job is to keep causal reasoning, evidence design, realizability, policy evaluation, fairness use, and benchmark parity from silently borrowing a [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis, support verdict, or admissible-use value they do not actually have.
...
The repair is not to ban causal language. The repair is to recover the live causal question, choose the least-committing admissible causal use supported by the available evidence, and then either downgrade, bound, design a causal-evidence plan with the required [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis, open identification or realizability work, or abstain.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:7 - Conformance Checklist
...
| `CC-C28-9` Semantic-authority split | [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs causal-use value sets, identification profiles and realizability profiles, graph naming and calculus naming, and support verdicts; neighbors may consume or quote them but must not define competing causal-use value sets. |
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:8 - Common Anti-Patterns and How to Avoid Them
...
| QL escape | Causal confusion is rebranded as quantum-like because ordinary probability feels hard. | Use [[C.26 - Quantum-Like Modeling Lens|C.26]] only after causal-use explanation and ordinary FPF neighbors have done their work. |

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:9 - Consequences

[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] makes causal use slower only when the claim commitment, consequence risk, or evidence demand warrants it. Cheap causal triage remains cheap.
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:10 - Rationale
...
[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] therefore uses a semantic-authority split:

- [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs causal-use question, rung, estimand, identification, realizability, causal evidence support basis, and causal-use verdict.
- Neighbor patterns keep their own authority and cite [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] only when causal use is live.
- [[C.26 - Quantum-Like Modeling Lens|C.26]] receives a causal exit: intervention, causal effect, causal fairness, causal policy, and counterfactual-rung-data realizability are ordinary causal-use questions before they are quantum-like modeling questions.
...
## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:11 - SoTA-Echoing
...
| Causal fairness is not only metric choice. | Fairness claims must declare causal rung, path/estimand where live, and supported fairness use. | Plecko and Bareinboim: [Fairness-Accuracy Trade-Offs: A Causal Perspective](https://causalai.net/r107.pdf). | Adopted through [[D.5 - Bias-Audit & Ethical Assurance|D.5]] relation and `CausalFairnessUseAuditCard`. |

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:12 - Relations

- [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] governs measurement and metrics. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates only when a measurement is used causally.
- [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] governs temporal claim adequacy. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates when temporal change is used as causal effect, intervention evidence, or counterfactual comparison.
- [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] governs evidence graph referring. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal evidence support basis and causal-use support refs for evidence paths.
- [[A.2.4 - U.EvidenceRole|A.2.4]] governs evidence roles. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] requires the evidence-role distinctions that keep `simulationOnlyCounterfactualOutputBasis`, `identifiedCounterfactualEstimateSupportBasis`, interventional evidence, and `realizedCounterfactualSampleSupportBasis` from being confused.
- [[A.6 - Signature Stack & Boundary Discipline|A.6]] / [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]] / [[A.6.C - Contract Unpacking for Boundaries|A.6.C]] govern boundary, deontic, promise, commitment, utterance, contract-language, and L/A/D/E-classified claim language. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies only causal-use support when mixed boundary sentences claim causal effect or counterfactual support.
- [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] governs role, method, plan, and work alignment. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies the causal-use semantics for intervention assignment, target-trial emulation, counterfactual sampling work, and causal evidence collection.
- [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] governs trust and assurance. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies the causal-use verdict that [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] can degrade, bound, or abstain over.
- [[C.11 - Decision Theory (Decsn-CAL)|C.11]] governs decision theory. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal-use question and causal action-policy class when value, utility, regret, or optimality depends on causal rung.
- [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] governs explore/exploit pool policy. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal rung and policy/regime fields when exploration collects causal data or learns causal policy.
- [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] governs agentic tool use and call planning. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies `causalActionUseSpec` when calls select observation, intervention, counterfactual-rung evidence collection, or counterfactual policy conditioning.
- [[D.5 - Bias-Audit & Ethical Assurance|D.5]] governs bias audit and ethical assurance. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal fairness rung, estimand, support, and supported fairness use.
- [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] governs method dispatch and MethodFamily registry. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal method or policy class declarations when method dispatch compares causal methods.
- [[G.9 - Parity and Benchmark Harness|G.9]] governs parity and benchmarks. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal method rung parity.
- [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] governs refresh orchestration. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal-use support records whose realizability, identification, fairness, representation, off-policy, target-trial, and simulation-validation shifts can trigger refresh.
- [[C.26 - Quantum-Like Modeling Lens|C.26]] governs quantum-like modeling. [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] is a required causal exit before QL retention when the question under repair is intervention, causal effect, causal fairness, causal policy, counterfactual comparison, or counterfactual-rung-data realizability.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:13 - Footer Marker

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:12a - [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> [[C.29 - Mathematical Lens Use|C.29]] may document that a mathematical mapping appears abstraction-like, quotient-like, coarse-graining-like, simulation-like, or macro-model-like. It does not decide causal-use support. When the supported use includes intervention, policy, counterfactual, causal explanation, or causal decision, apply [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]; otherwise record `CausalUseDisposition = noCausalUseClaim` or `causalUseBlocked`.

## [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:End
