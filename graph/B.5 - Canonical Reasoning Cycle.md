...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:1 - **Problem Frame**

While preceding patterns define the anatomy of trust (`Assurance Levels` in [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) and the structure of holons ([[A.1 - U.Holon, U.System, and U.Episteme|A.1]], [[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]), they do not specify the cognitive "engine" that drives the creation and evolution of knowledge within FPF. A framework for thinking must provide more than just a filing system for conclusions; it must offer a repeatable, rigorous method for arriving at them, especially when confronting novel, complex, or ill-defined problems.

## [[B.5 - Canonical Reasoning Cycle|B.5]]:2 - **Problem**
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:3 - **Forces**
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:4 - **Solution**
...
### [[B.5 - Canonical Reasoning Cycle|B.5]]:4.3 - Induction (Empirical Evaluation)
...
### [[B.5 - Canonical Reasoning Cycle|B.5]]:4.4 - **Didactic Note for Managers: The "Propose → Analyze → Test" Cycle**
>
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:5 - **Conformance Checklist**
...
*   **CC-B5.4 (Cycle Closure):** The outcome of an inductive test (whether corroboration or refutation) **MUST** be formally recorded as an evidence carrier (Pattern [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]), and that evidence carrier **MUST** be used as an input for the next iteration of the reasoning cycle.
*   **CC-B5.5 (State Machine Alignment):** The Abductive–Deductive–Inductive Loop is the cognitive engine that drives state transitions in the **Explore → Shape → Evidence → Operate** state machine (Pattern [[B.5.1 - Explore → Shape → Evidence → Operate|B.5.1]]). Abduction dominates the *Explore* phase; Deduction dominates the *Shape* phase; and Induction is the core of the *Evidence* phase.
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:6 - **Consequences**
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:7 - **Rationale**
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:8 - **Relations**
...
## [[B.5 - Canonical Reasoning Cycle|B.5]]:End
