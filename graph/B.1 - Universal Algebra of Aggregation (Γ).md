...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:1 - Problem Frame
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:2 - Problem
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:3 -  Forces
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:4 - Solution — **The Invariant Quintet Standard**
...
### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:4.1 - The Universal Aggregation Operator
...
* **`T`** — an external `U.TransformerRole` (not a node of `D`); see [[A.12 - External Transformer & Reflexive Split|A.12]].
...
### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:4.2 - The Five Grounding Invariants
...
### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:4.3 - Why only five?  (A didactic sidebar)
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:6 - Walkthrough Examples

### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:6.1 - `Γ\_sys` — Offshore Wind Farm (2025 build)
...
### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:6.2 - `Γ_epist` — Living Systematic Review on mRNA Therapies (2024–2025)
...
### [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:6.3 - `Γ\_time` — National Grid Frequency Forecast (2025‑2030)
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:7 - Conformance Checklist (for pattern adopters)
...
A proposal that skips any line of the checklist **fails** pattern [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]] and must iterate before peer review.

## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:8 - Consequences
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:9 - Rationale
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:10 - Anti-Patterns & Conceptual Repairs
...
| **Synergy by Narrative** | A claim is made that the whole is greater than the sum of its parts, without a formal mechanism. | This violates **WLNK**. If the synergy is real (e.g., due to redundancy or a new feedback loop), it must be modeled as a **Meta-Holon Transition** (Pattern [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]). |

## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:11 - Relations
...
## [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]]:End
