...
## [[E.2 - The Eleven Pillars|E.2]]:1 - Problem frame
Pattern [[E.1 - Vision & Mission- “Operating System for Thought”|E.1]] set the FPF mission as an **operating system for thought**. To turn that mission into a durable architecture, FPF needs a small, explicit constitution - principles that remain stable while everything built on top of them can evolve. Without such invariants, domain silos, vocabulary drift, and tool-centric shortcuts quickly erode coherence and reproducibility across disciplines.
...
## [[E.2 - The Eleven Pillars|E.2]]:2 - Problem
...
## [[E.2 - The Eleven Pillars|E.2]]:3 - Forces
| Force                          | Tension                                                |
| ------------------------------ | ------------------------------------------------------ |
...
## [[E.2 - The Eleven Pillars|E.2]]:4 - Solution
...
| **CC‑P‑6** | A pillar-impact analysis that relies on mathematical structure, scale behavior, optimization, uncertainty, invariance, obstruction, or other first-principles modeling support is complete only when that support is ordinary accepted local theory, a cited [[C.29 - Mathematical Lens Use|C.29]] output, or a named neighboring-pattern output for evidence, causal, bridge, assurance, measurement, work, decision, publication, or admission claims. | Keeps mathematical support for pillars inspectable without letting [[C.29 - Mathematical Lens Use|C.29]] revise pillar authority. |

## [[E.2 - The Eleven Pillars|E.2]]:6 - Policy — Bitter‑Lesson Preference (BLP)
...
* (a) **Parity harness**: same **ComparatorSet**, **freshness window**, and **evaluation seeds/replicates**; set-returning evaluation (see **G.5/G.9**). Dominance criterion: **Pareto‑only** by default across the declared objective vector; any alternative requires a documented waiver by **Gov‑CAL** under **[[E.3 - Principle Taxonomy & Precedence Model|E.3]]** precedence.
...
* (c) **Slopes & uncertainty**: report ∂quality/∂compute, ∂quality/∂data, and (where applicable) ∂coverage/∂**freedom‑of‑action** and **∂novelty/∂budget**; include **error bars/CI** from multi‑seed trials; publish edition pins and policy‑IDs in SCR/telemetry (**[[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]**).
...
**BLP‑5 — Continuous‑Learning Posture.** Where product policy allows, enable **feedback‑driven adaptation** (e.g., preference learning, critique loops) within Guard‑Rails (**[[E.5 - Four Guard‑Rails of FPF|E.5]]**) and privacy/regulatory controls, with appropriate opt‑outs where required. Disabling adaptation requires DRR justification and a review date.

**BLP‑6 — Precedence & Safeguards.** BLP is a **Gov/Arch** policy instantiated by Pillars **P‑10 (Open‑Ended Evolution)**, **P‑11 (SoTA Alignment)**, **P‑7 (Pragmatic Utility)**, and **P‑1 (Cognitive Elegance)**. It does **not** override safety/ethics (**[[E.5 - Four Guard‑Rails of FPF|E.5]]**) **nor** [[E.3 - Principle Taxonomy & Precedence Model|E.3]] precedence rulings; where BLP conflicts with Guard‑Rails, **Guard‑Rails prevail**. When **NQD/E/E‑LOG** elevates illumination to dominance for exploration mandates, BLP **adopts that lens** rather than overriding it.
...
## [[E.2 - The Eleven Pillars|E.2]]:7 - Conformance Checklist — BLP
...
| **CC‑BLP.6**  | Resource accounts (time/energy/FLOPs) and assurance deltas are reported via **Resrc‑CAL** and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].             | Avoids “free heuristic” illusions.            |
...
## [[E.2 - The Eleven Pillars|E.2]]:8 - Relations
* **Instantiates pillars:** P‑10, P‑11, P‑7, P‑1.
* **Depends on:** **G.5/G.9** (admission/comparator/selector & parity harness), **[[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]** (refresh telemetry), **C.5** (Resrc‑CAL), **[[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]]** (NQD‑CAL), **[[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]]** (E/E‑LOG), **F.7/F.9** (Bridges, CL/Φ/Ψ).
* **Constrained by:** **[[E.5 - Four Guard‑Rails of FPF|E.5]]** Guard‑Rails (DevOps Lexical Firewall; Notational Independence; Cross‑Disciplinary Bias Audit) and **[[E.3 - Principle Taxonomy & Precedence Model|E.3]]** precedence.

## [[E.2 - The Eleven Pillars|E.2]]:9 - Definitions
**α (budget tolerance)** may be relative or absolute; declare units (e.g., % cost, wall‑time, energy). **δ (assurance tolerance)** is the permissible delta in assurance under **[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]**; declare measure and floor(s).

## [[E.2 - The Eleven Pillars|E.2]]:10 - Consequences
...
## [[E.2 - The Eleven Pillars|E.2]]:11 - Rationale
...
[[C.29 - Mathematical Lens Use|C.29]] is a downstream support pattern for this constitution when mathematical first-principles structure is part of an argument about pillar support. It makes the structure, loss, and stop condition explicit while [[E.2 - The Eleven Pillars|E.2]] remains authority over what counts as a pillar.

## [[E.2 - The Eleven Pillars|E.2]]:12 - Relations
...
* **Mathematical support path:** [[C.29 - Mathematical Lens Use|C.29]] supports pillar-impact arguments only for adequacy of mathematical lenses used to express first-principles structure. It does not amend pillar content, priority, or conformance.
...
## [[E.2 - The Eleven Pillars|E.2]]:End
