...
**Status and placement.** Part [[E.10 - Unified Lexical Rules for FPF|E.10]] (“Lexical Discipline and Stratification”); complements **[[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] (D.CTX)**, **[[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary and specification-use gates)**, the **DesignRunTag and CtxState boundary discipline** (**[[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]**; **[[E.18 - Transformation Flow Structure|E.18]]**), [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] wording-use restoration architecture, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] relation precision restoration, [[C.2.P - Epistemic Precision Restoration|C.2.P]] epistemic precision restoration, [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] state-family precision restoration, and [[F.18 - Local‑First Unification Naming Protocol|F.18]] local-first naming. `E.10:0.2` is the shared lexical trigger scan. The detailed LEX sections below supply register, naming, morphology, and local rewrite checks only for the selected wording problem; they are not a second wording-recognition table and do not replace [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], the selected precision-restoration realization patterns, governing patterns, or [[F.18 - Local‑First Unification Naming Protocol|F.18]].

**Builds on:** [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] **Strict Distinction (Clarity Lattice)**; [[E.5 - Four Guard‑Rails of FPF|E.5]] Guard‑Rails (DevOps Lexical Firewall; Notational Independence; Unidirectional Dependency); [[F.5 - Naming Discipline for U.Types & Roles|F.5]] **Naming Discipline for U.Types and Roles**.
**Coordinates with.** [[A.2 - Role Taxonomy|A.2]] and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role–Method–Work alignment), [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] (Evidence Graph Referring), [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]] and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] (Γ‑algebras and assurance), F‑cluster (context of meaning; Bridges).

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:0 - Use this when
...
**What this buys.** [[E.10 - Unified Lexical Rules for FPF|E.10]] gives one cheap trigger scan before heavier repair: ordinary wording stays ordinary, local lexical mistakes are repaired locally, relation-like wording applies [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]]; episteme, publication, or source-use wording applies [[C.2.P - Epistemic Precision Restoration|C.2.P]]; declarative-representation wording overread as imperative action, method, work, permission, release, evidence, or pattern dispatch applies [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]; method, algorithm, program, proof, solver, workflow, process, procedure, access-path, query-plan, and control-strategy wording recovers the slot or use-position before any replacement; architecture or structure wording applies [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]]; stratification or source-label wording such as `layer`, `level`, `tier`, `stack`, `ladder`, `rung`, `block`, `expert`, `cache`, `router`, or `gate` applies [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]; characteristic or scale wording applies [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]; quality or evaluative wording applies [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]; state-family wording applies [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]]; and already recoverable cases apply the governing pattern directly. The result is precise enough to compose with FPF without making every phrase into a new pattern or review artifact.

Use [[E.10 - Unified Lexical Rules for FPF|E.10]] when a word, head, or local phrase in conformant FPF text is starting to hide what kind it names, which register it belongs to, which context of meaning governs it, or which relation or action claim it carries.

**First useful move.** Restore the head kind and register of the local wording. If no FPF-governed use remains, make the small local rewrite under [[E.10 - Unified Lexical Rules for FPF|E.10]] and stop. If an `E.10:0.2` row selects a precision-restoration realization pattern or a governing pattern, apply that pattern instead of inventing a synonym. If the repaired wording becomes a durable reusable head, apply [[F.18 - Local‑First Unification Naming Protocol|F.18]] after the selected precision-restoration branch has recovered the kind and use. Governing FPF patterns are named only after that repair has made the EntityOfConcern, relation, claim, admissible use, project-side reference, or non-use disposition recoverable by value.

**Cheap stop.** If one local lexical repair restores kind, relation, and admissible use without changing the normative meaning of FPF, stop with the repaired wording; do not create or use a Name Card, DRR, review profile, or larger epistemic precision restoration note by habit. Ordinary application starts at `E.10:0.2`, applies only the row selected by the sentence under repair, and then stops at local repair, the selected restoration pattern or governing pattern, controlled precision reduction, or [[F.18 - Local‑First Unification Naming Protocol|F.18]] when a durable reusable head is actually being minted. Later LEX sections are detailed checks for the selected case, not a universal interpretation sequence.

**Not this pattern when.** Do not use [[E.10 - Unified Lexical Rules for FPF|E.10]] as the ontology that governs the recovered claim. If the use under repair is evidence, assurance, work, gate, decision, causal use, publication, relation precision, or epistemic precision, the accepted text must make the governing FPF pattern application explicit; [[E.10 - Unified Lexical Rules for FPF|E.10]] contributes only the wording-problem classification. For non-FPF source prose, use [[C.2.P - Epistemic Precision Restoration|C.2.P]] source-expression unpacking mode and borrow [[E.10 - Unified Lexical Rules for FPF|E.10]] only as a repair test, not as a conformance verdict.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.0a - One-screen ordinary use

Ordinary [[E.10 - Unified Lexical Rules for FPF|E.10]] use is one bounded FPF-governed wording repair, not a full lexical audit. The bounded complete accepted result is:
...
When [[E.10 - Unified Lexical Rules for FPF|E.10]] is applied beyond one sentence, add a bounded-text line: exact accepted `DRR` named by value, FPF pattern, monolith section, extracted host, review packet, pattern section, source span, or other named text span; trigger spans or grouped loci; selected interpretation; repair boundary; and expected non-use boundary. This prevents accidental whole-corpus sweeps and makes change impact inspectable.

Formal fields from the older LEX substrate are used only when the selected wording problem needs them: `triggerSpan`, `boundedTextSpan`, `structuralRole`, `selectedInterpretation`, `LEX.TokenClass?`, `register`, `USM.Scope?`, `EntityOfConcern and Description-episteme boundary and specification use?`, `governingPattern`, and `finalWordingOrBlocker`.

Local patterns may cite the relevant [[E.10 - Unified Lexical Rules for FPF|E.10]] recognition row, but they should not reproduce large wording-recognition lists or create local lexical registries unless a named local application profile has its own primary `EntityOfConcern`, first useful move, and governing-pattern boundary. New recurring wording families enter [[E.10 - Unified Lexical Rules for FPF|E.10]] only when they recur across FPF-governed texts and cannot be handled by one local pattern; specialized patterns receive the detailed ontology when the problem is no longer lexical. Stale or overly broad recognition rows are narrowed or retired.

Self-application is bounded. When [[E.10 - Unified Lexical Rules for FPF|E.10]] is under improvement, use [[E.10 - Unified Lexical Rules for FPF|E.10]] only for its own wording-trigger repairs; use [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] for pattern-quality evaluation, [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] for improvement-oriented quality-evaluation framing, [[E.23 - Quality Improvement Loop Method|E.23]] for the improvement loop, [[E.2.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] for FPF-level Pillar effect, and neighboring pattern governing the claims for relation, episteme, publication, source-use, naming, or quality-word issues.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.1 - Scope split

[[E.10 - Unified Lexical Rules for FPF|E.10]] governs lexical conformance for FPF pattern text, extracted pattern hosts, `FPF-Spec` monolith text, FPF governing documents, accepted `DRR` text, and any project, product, research, engineering, or review text that deliberately uses FPF terms, pattern references, FPF relation names, FPF kind claims, FPF admissibility claims, or claims FPF conformance.

For ordinary source text, intake notes, seminar transcripts, external reviews, project documents, source publications, tool outputs, or other text that does not itself claim FPF-governed use, use [[C.2.P - Epistemic Precision Restoration|C.2.P]] source-expression unpacking mode. That use may borrow [[E.10 - Unified Lexical Rules for FPF|E.10]] tests, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] relation repair, [[A.6.6 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] basedness repair, [[F.18 - Local‑First Unification Naming Protocol|F.18]] naming tests, or another governing pattern as methods, but it does not judge the source text as failed FPF wording.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2 - Problem and applicability table

[[E.10 - Unified Lexical Rules for FPF|E.10]] is a lexical trigger scan and conformance pattern. Its primary `EntityOfConcern` for one pattern use is one wording use in conformant FPF text as a lexical or register sign: the head, register, morphology, local label, name candidate, kind-reference, relation-bearing cue, or replacement candidate used by the sentence.

[[E.10 - Unified Lexical Rules for FPF|E.10]] recognizes which wording-use problem the sentence raises and selects the first applicable closure disposition. It does not itself become the ontology for the recovered relation, episteme, evidence, work, gate, decision, publication, architecture, characteristic, quality, or project-side FPF kind and reference named by value.

The full shared recovery order and applicability-row architecture belong to [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]. [[E.10 - Unified Lexical Rules for FPF|E.10]] keeps only the cheap scan, local rewrite option, direct known governing-pattern rule, compact applicability table, bounded complete result rule, and fail-closed non-use boundary.
...
- [[F.18 - Local‑First Unification Naming Protocol|F.18]] durable-name application after the kind under repair or relation is known;
...
| FPF-governed use found by [[E.10 - Unified Lexical Rules for FPF|E.10]] | First applicable restoration or governing pattern | Closure result |
| --- | --- | --- |
...
| Local lexical or register ambiguity only | Local rewrite under [[E.10 - Unified Lexical Rules for FPF|E.10]]. | Repaired wording plus remaining reader move, or ordinary-prose demotion. |
| Relation-like wording or relation-bearing use | Apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or a retained [[A.6 - Signature Stack & Boundary Discipline|A.6]] relation specialization. | Named relation kind, slots and qualifiers, admissible relation use, blocked overread, and reader move. |
| Source-expression, publication, publication form, face, `PublicationUnit`, FPF-governed use, or `reading`, `read`, or `quality-read` wording whose entity or construction is not yet recovered | Apply [[C.2.P - Epistemic Precision Restoration|C.2.P]] first. If the recovered entity or construction is evaluation for improvement, then use the evaluation pattern governing that evaluation claim, such as [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], or [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]. | Source-local meaning, publication relation set, publication-form relation when that relation is being made, EntityOfConcern, project-side FPF kind, use disposition, evaluation claim or bundle named by value when that evaluation claim is being made, adjacent overread blocked, and reader move. |
| Ontic, ontic candidate, concept cluster, semantic area, ontological neighborhood, slot relation, schema, data structure, record, card, table, or publication-form wording whose EntityOfConcern and publication boundary are hidden | Apply [[E.24.CD - Ontic Candidate Detection|E.24.CD]] when repeated material may require an ontic candidate decision; apply [[E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] when the confusion is among ontic, ontic-description episteme, publication form, view, record, card, table, schema, or data-structure expression. Use [[E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] or the direct governing pattern when the ontic or subject pattern is already recovered. | Candidate ontic cluster, EntityOfConcern, slot relation or slot-position, subject pattern, ontic-description episteme, publication form or source relation, admissible use, blocked publication-form overread, and remaining reader move. |
| Admissibility-like, legal-looking, authority-looking, readiness-looking, validity-looking, pass-looking, fail-looking, or conformance-looking wording whose bearer, claim kind, source relation, value frame, bounded use, or governing pattern is hidden | Use the direct governing pattern when recoverable: evidence, assurance, gate, constraint validity, work, work plan, publication use, temporal use, source restoration, legal or external-rule claim, pattern-quality result, state-like value, or another claim-specific pattern. If the word is only the trigger, restore by [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] and the claim-specific pattern; do not mint a generic admissibility object. | Bearer, claim kind, value frame or decision class, source relation when that relation is being made, bounded admissible use, non-admissible overread, reopen or stop condition, and governing pattern; otherwise quote-only, reduced-use, or blocked-use. |
| Method, algorithm, program, solver, proof, recipe, workflow, process, procedure, access-path, query-plan, control-strategy, or programming-paradigm wording whose slot is hidden | Recover the slot before rewriting: `A.3.1 U.Method`, `A.3.2 U.MethodDescription`, [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] formal-substrate declaration, [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use, [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] with [[E.20 - Mechanism Introduction Protocol|E.20]] mechanism claim, `A.15.2 U.WorkPlan`, `A.15.1 U.Work`, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence relation, quote-only source wording, or another direct governing pattern. | Pre-repair and post-repair kind or relation position, slot or use-position, admissible use, blocked overread, and remaining reader move. Do not replace one umbrella with `method`, `mechanism`, `algorithm`, or `workflow` by taste. |
| Transformation, change, pipeline, dataflow, flow, network, circuit, path, slice, workflow, process, operation, or close change-situation wording whose object or slot is hidden | Apply [[A.3.4.P - Transformation Ontic Precision Restoration|A.3.4.P]] first. If `U.Transformation`, `TransformationFlowStructure`, mathematical description, method, method description, mechanism, work plan, dated work, functioning relation, temporal aspect, evidence, source, publication, gate, decision, assurance, result, or quote-only source wording is already recovered, use the direct governing pattern. | Recovered transformation identity or non-transformation value, recovered slot or filler, governing pattern, retained use, blocked overread, and remaining reader move. Do not replace one source label with `flow`, `network`, `process`, `method`, `function`, or `transformation` by taste. |
| Declarative representation wording overread as imperative action, method, work, permission, release, evidence, or pattern dispatch: graph path, path slice, flow valuation, evidence path, state predicate, SQL-like query, checklist predicate, table, dashboard, publication face, mathematical representation, method-description representation, source-chain relation, file path, or FPF pattern relation | Apply [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] unless the direct governing pattern already closes the repair. Accepted direct cases include [[E.18 - Transformation Flow Structure|E.18]] graph path or `PathSlice`, `A.10 evidence path for a claim, effect, or use`, [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] state predicate or value, [[E.17 - Multi‑View Publication Kit|E.17]] publication face, [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use, [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]] method, [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] method description, [[A.15.2 - U.WorkPlan|A.15.2]] work plan, [[A.15.1 - U.Work|A.15.1]] work occurrence, carrier file path, source-chain relation, and declarative pattern relation under [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] or [[F.19 - Ontology-First Plain Technical Rewriting|F.19]]. | Encountered representation, representation kind, represented object or claim, source expression or publication face when that relation is being made, tempting imperative overread, recovered governing pattern, admissible use now, non-admissible overread, stop or reopen condition. |
| Architecture or structure wording with hidden selected structure, `ArchitectureOf@Context` relation, architecture-description use, structural-view use, source-return condition, or named [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] subcase | Apply [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]]. If [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]], [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], or a named [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] subpattern is already recoverable, use it directly. | Recovered selected structure, `ArchitectureOf@Context`, architecture description, structural view, source-return condition, governing-pattern result, or stop. |
| Stratification or structure-source-label wording such as `layer`, `level`, `tier`, `stack`, `ladder`, `rung`, `block`, `expert`, `cache`, `router`, or `gate` when the FPF kind under repair, relation, claim-use, or source-use disposition is not yet recovered | Apply [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] first. If a control-layer relation, module-interface relation, architecture-to-`TransformationFlowStructure` relation, mathematical scale relation, coarse-graining relation, publication relation set, gate relation, or neighboring use named by value is already recovered, use that governing pattern directly. | Recovered FPF kind, relation, claim-use, source-use disposition, and governing pattern; `StratificationSourceLabelRepairNote`; ordinary source label; quote-only, reduced-use, or blocked-use disposition; or stop. |
| Characteristic, scale, score, coordinate, metric, indicator, threshold, comparison, or scalar-quality wording with hidden construction | Apply [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]. If [[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]], [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.29 - Mathematical Lens Use|C.29]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], or a governing pattern is already recoverable, use it directly. | Recovered `Characteristic`, `Scale`, `Coordinate`, `Value`, `Score`, unit, scoring method, comparison basis, indicator role, governing-pattern result, or stop. |
| State-family wording with hidden bearer, state frame, value set, admissible use, or governing pattern: `state`, `status`, `posture`, `readiness`, `stance`, currentness, or close compounds | Apply [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]]. If the governing pattern and state-like field are already recoverable by value, use that governing pattern directly. | Recovered bearer, state frame or governing pattern, value or classification, admissible use, non-admissible overread, reopen condition, governing-pattern result, or stop. |
| Quality or evaluative characterization wording | Apply [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], or another characterization pattern governing the claim after any needed [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] repair. If the found problem is relation construction, apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] instead. | Quality-term repair, Q-bundle or pattern-quality coordinate use, relation split or bridge split when that relation or bridge claim is being made, and blocked scalar, gate, or release overread. |
| Function-like wording with hidden FPF kind, relation, claim, view, or governing-pattern application: `function`, `functional`, `functionality`, `effect`, or close compounds | Apply [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] first when kind and relation recovery is needed. If the FPF kind named by value or pattern relation is already recovered by value, use the governing pattern directly. | FPF kind or relation named by value assignment, governing-pattern application, mathematical-lens use, quality pattern application, characteristic pattern application, module-interface pattern application, ordinary-prose demotion, or stop. |
| Intentional loss of precision for a narrower admissible use | Apply the controlled precision-reduction pattern, normally [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], with neighboring `E.17.*`, [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[F.9 - Alignment & Bridge across Contexts|F.9]], or [[C.29 - Mathematical Lens Use|C.29]] when that relation is being made. | Source-bearing side, declared loss, narrower admissible use, blocked downstream use, and reopen condition. |
| Durable reusable head, deprecated alias, concept-set row, cross-context name-use, or UTS-facing name | Apply [[F.18 - Local‑First Unification Naming Protocol|F.18]] after the selected repair has recovered what the name would name. | Name card or naming row only for durable naming need; one-off local wording closes locally. |
...
`reading`, `read`, and `quality-read` are trigger wording only when the sentence uses the word to carry interpretation, publication use, source-use assignment, evaluation, comparison, evidence, gate, work, decision, release, assurance, or admissibility claim. Do not create `ReadingPrecisionRestoration`. Recover the actual EntityOfConcern, publication lane, evaluation claim or bundle, relation, or work-side kind and apply [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] plus object-under-improvement evaluation named by value, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], or the neighboring FPF pattern governing that claim.

`function`, `functional`, `functionality`, and `effect` are trigger wording when the FPF kind named by value, relation, claim, view, or governing-pattern application is hidden. Do not assign the wording by architecture default. [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] remains the function-like wording unpacker; mathematical function, mapping, relation, loss, objective, value functional, or operator goes to [[C.29 - Mathematical Lens Use|C.29]] when mathematical-lens use is being claimed. Functional-architecture use goes to [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] or [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] when the architecture or structural-view claim is recovered by value; architecture-to-`TransformationFlowStructure` use goes to the current Architecture Transformation-Flow Structure Relation ([[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]]).

`layer`, `level`, `tier`, `stack`, `ladder`, `rung`, `block`, `expert`, `cache`, `router`, and `gate` are source labels when they first arrive from engineering, mathematical, publication, or project prose without a recovered FPF kind. Do not mint `U.Layer`, `U.Level`, `U.Tier`, `U.Stack`, or a universal stratification kind. Use [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] to recover the governing pattern, or go directly to the governing pattern when the FPF kind under repair, relation, claim-use, or source-use disposition is already recovered by value: [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] for control-layer relations, [[A.6.M - Module Relation Repair|A.6.M]] for module-interface relations, the current Architecture Transformation-Flow Structure Relation ([[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]]) for architecture-to-`TransformationFlowStructure` claims, [[E.18 - Transformation Flow Structure|E.18]] for selected transformation-flow structure, [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] or [[C.29 - Mathematical Lens Use|C.29]] for scale relation, coarse-graining relation, or mathematical use, [[C.2.P - Epistemic Precision Restoration|C.2.P]] for publication relation set or source-use relation, and gate patterns, work patterns, or decision patterns when those claims are being made.

Local patterns may cite the relevant [[E.10 - Unified Lexical Rules for FPF|E.10]] recognition row, but they must not reproduce the wording-recognition table or create local lexical registries unless a named local application profile has its own primary `EntityOfConcern`, first useful move, and governing-pattern boundary. Specialized restoration patterns receive the detailed ontology when the problem is no longer lexical.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2a - Bounded complete result and direct known governing-pattern rule
...
Apply a precision-restoration realization pattern such as [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]], [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], or [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] only when wording hides the EntityOfConcern under repair, relation, characteristic, scale, score, quality characterization, source-use disposition, state-family field, admissible use, or remaining reader move.

The bounded complete result is the shortest result that fully recovers the kind under repair and remaining reader move. Shortest is not lowest effort: every FPF-governed use receives a by-value disposition, and `not triggered` or ordinary prose must be stated as such with the checked span.
...
**Replacement-candidate closure.** A repair that replaces one trigger word with another word or phrase is not closed until the replacement candidate itself passes the same [[E.10 - Unified Lexical Rules for FPF|E.10]] trigger scan. If the candidate is another umbrella word, quasi-scale, process metaphor, role-free deontic word, or untyped head, recover the kind named by value, relation, admissible use, and governing pattern, send a durable naming case to [[F.18 - Local‑First Unification Naming Protocol|F.18]], or fail closed. A bounded repair may therefore require repeated [[E.10 - Unified Lexical Rules for FPF|E.10]] passes until the candidate wording reaches a stable closure point: ordinary wording with no FPF-governed use, local repair with recovered kind and use, governing-pattern application, [[F.18 - Local‑First Unification Naming Protocol|F.18]] durable-name result, controlled precision-reduction result, or explicit blocker. Do not accept a smoother synonym as repair evidence.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2b - Wording-Use Trigger Check Registry

`E.10:0.2` is the shared trigger scan. This section is the check registry for high-pressure wording in FPF-governed text and source prose being unpacked for possible FPF use. It does not create a second all-purpose ontology and does not create domain-pattern outcomes. It selects a closure disposition: local rewrite, selected precision-restoration realization pattern, governing pattern, controlled precision reduction, [[F.18 - Local‑First Unification Naming Protocol|F.18]] durable-name application, or fail-closed non-use.
...
| `state`, `status`, `posture`, `readiness`, `stance`, `currentness`, or close state-family compounds | state-like claim over a named bearer, state frame or governing pattern, value or classification, admissible use, non-admissible overread, and reopen condition; apply [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] when hidden | maturity adjective, authority, gate passage, release permission, evidence, assurance, source authority, work completion, or process state by appearance |
...
| `transformation`, `change`, `pipeline`, `dataflow`, `flow`, `network`, `circuit`, `path`, `slice`, `workflow`, `process`, `operation`, or close change-situation labels | apply [[A.3.4.P - Transformation Ontic Precision Restoration|A.3.4.P]] when wording points to a situation of change; recover `U.Transformation`, transformed object, transformer or system-in-context, method, method description, mechanism, work plan, dated work, functioning or functional structure, `TransformationFlowStructure`, mathematical description, dynamics, temporal aspect, evidence, source, publication, gate, decision, assurance, result, quote-only source wording, or another direct governing pattern by value | one source-label ontology, generic flow or network head, continuity by older source label alone, graph proof, path proof, method by default, work by default, function by default, or transformation occurrence by wording alone |
| `route`, `path`, `workflow`, `lifecycle`, `dispatch`, `exit`, `receiver`, `call`, `invoke`, `run`, `flow`, `EvidencePath`, or close movement and control metaphors over representations or pattern relations | [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] repair, [[E.18 - Transformation Flow Structure|E.18]] graph path or `PathSlice`, `A.10 evidence path for a claim, effect, or use`, state predicate, checklist predicate, SQL-like query, table representation, dashboard representation, publication face, source-chain relation, carrier file path, mathematical-lens use, method claim, method-description claim, work plan, dated work occurrence, or declarative FPF pattern relation under [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] or [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] | imperative program, action route, permission route, release route, evidence route, pattern dispatch, or work sequence unless that governing kind is recovered by value |
...
| `EntityOfConcern`, `EntityOfInterest`, `EoI`, `EoIClass`, `describedEntity`, `DescribedEntityRef`, `primary described entity`, or EntityOfConcern-like heads | EntityOfConcern, EntityOfConcern reference, EntityOfConcern class constraint, publication-unit primary entity of concern, source-side wording translated to the adopted EntityOfConcern family, ordinary topic or subject, or project-side kind and reference pair | universal object, second [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] slot family, relation-valued bucket, free publication-unit field, authoring target, carrier, or reader interest |

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c - Lexical Trigger Rewrite Rules

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.1 - EntityOfConcern, primary entity of concern, and local topic wording
...
| --- | --- |
| the EntityOfConcern named by a claim-bearing episteme or episteme-lane `U.View` | `EntityOfConcern`, `EntityOfConcernRef`, or `entityOfConcernRef` under [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] |
...
| an FPF-side pattern, pattern section, accepted `DRR`, FPF publication, FPF view, document with named source-basis, evidence-basis, architecture-basis, or review-basis role, or companion or projection material being improved | governing FPF pattern, pattern section, accepted `DRR`, FPF publication, FPF view, document with named source-basis, evidence-basis, architecture-basis, or review-basis role, or companion or projection material |
| a project-side episteme, publication, record, carrier, or activity under work | project episteme, view, or publication named by value, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, typed evidence record, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `DecisionLogRef`, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification record, typed status record whose FPF status pattern is named, [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]] `U.Commitment`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision record, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`, `U.Method`, `U.MethodDescription`, carrier relation, or front-end relation |
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.2 - publication-unit wording that implies authoring or interpretation work
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.3 - `content`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.4 - `publication`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.5 - `surface`, `view`, `face`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.6 - `source`, `target`

These are relation words, not final kinds.

Split `source` into source `U.Episteme`, source `U.EpistemePublication`, `U.View` over a source `U.Episteme`, document with named source-basis, evidence-basis, architecture-basis, or review-basis role, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, authority-reference relation, named FPF pattern cited as source, file carrier, source frame, source context, relation slot on the source side of a named relation, or project-side FPF kind and reference named by value.
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.7 - `artifact`, `material`, `output`, `deliverable`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.8 - `record`
...
- [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path or evidence record for a named claim;
- [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision` or `DecisionLogRef`;
- [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record;
- [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult` or decision record;
- [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, or other named work record;
- [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]] `U.Commitment` or [[A.2.9 - U.SpeechAct (Communicative Work Object)|A.2.9]] `SpeechAct` publication;
- `U.RoleAssignment` or status-register entry under the named governing pattern;
- [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] review run record or another named review record whose review target and review relation are explicit;
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.9 - `model`, `diagram`, `screen`, `dashboard`, `table`, `note`, `memo`, `summary`, `explanation`
...
- carrier, front-end, or rendering;
- project-side FPF kind and reference named by value;
- explanation and source-finding relation under [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]];
- evidence, currentness, and provenance relation under [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]];
- gate-bearing claim or effect under [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]];
- assurance and engineering-justification record under [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]];
- work and reliance source-restoration relation under [[A.15.4 - Work-Relevant Source Restoration|A.15.4]].

Keep the ordinary example word only after the governing kind is visible nearby.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.10 - `reader`, `reviewer`, `author`, `operator`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.11 - `owner`, `home`, `host`, `locus`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.12 - `route`, `branch`, `handoff`, `path`, `trajectory`, `move`, `flow`

Recover the movement, control, and temporal relation set before using these words:
- [[A.16 - Language-State Move Coordination|A.16]] local move;
- [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] trajectory account;
- [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]] position in characteristic space or state space;
- [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] control relation, control-layer relation;
- process handoff;
- selector relation or selection mechanism;
- work transfer;
- [[E.18 - Transformation Flow Structure|E.18]] path publication;
- [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] episteme morphism or retargeting.

If no movement, control, and temporal relation is being made, keep the word ordinary and non-authorizing.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.13 - `use`, `supported use`, `action`, `effect`
...
- admissible act, work, or claim under a named FPF pattern, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] relation claim, relation phrase, or project-side FPF kind and reference named by value;
- non-admissible act, work, or claim requiring one other named value: FPF pattern, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] relation claim, relation phrase, project-side FPF kind and reference named by value, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision record, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, `U.Method`, `U.MethodDescription`, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `DecisionLogRef`, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, typed evidence record, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification record, typed status record whose FPF status pattern is named, carrier relation, or front-end relation;
- planned work;
- actual `U.Work`;
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.15 - `pattern`, generic FPF-side object wording, `locus`, `row`, `target`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.16 - Union-field unpacking under [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]]
...
When one of these union-fields appears, make the [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] choice explicit:
...
- if the same unpacking recurs across cases with one stable recovery apparatus, record a light [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] specialization candidate rather than minting a vocabulary-wide replacement field.
...
Do not fill one project-side slot with whichever nearby FPF kind is easiest to name. A project publication or record is a description-side item or record-side item; [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation, [[A.2.9 - U.SpeechAct (Communicative Work Object)|A.2.9]] `SpeechActRef`, [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]] `U.Commitment`, and `U.Method` and `U.MethodDescription` belong to different FPF kinds.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.17 - Heterogeneous kind lists

Do not repair a heterogeneous list by giving it one broader umbrella name.
When a sentence lists unlike candidates such as pattern, `DRR`, publication, `U.View`, carrier relation, front-end relation, project-side FPF kind and reference named by value, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision record, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, `U.Method`, `U.MethodDescription`, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `DecisionLogRef`, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, typed evidence record, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification record, or typed status record whose FPF status pattern is named, do not promote the row to a new kind. Classify the list as one of:
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.18 - `strong`, `stronger`, `weak`, `weaker`, `support`
...
- `weaker claim` -> narrower claim scope, lower evidence-support class, bounded admissible act, work, or claim, `source-loss mode` under [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] when a source-to-rendering loss is being claimed, coarsened rendering, or explicit abstain or reopen condition;
- `support` -> one selected support-like interpretation under [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], not a more polished synonym. If the selected interpretation is base, anchor, or basedness, apply [[A.6.6 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] and state `dependent`, `base`, `baseRelation`, `scope`, applicable `Γ_time`, witnesses, `admissibleUse`, and `nonAdmissibleUse`.
...
- base, anchor, or basedness relation: the phrase means relative-to, based-on, anchored-in, base change, or scoped grounding as a base relation; use [[A.6.6 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] support wording selection and rewrite as `baseRelation(dependent, base)` or SWBD, not as a generic `SupportBasis`, `SupportRelation`, or `SupportRecord`;
...
Support-headed names such as `SupportRecord`, `SupportSource`, `SupportLine`, `SupportForm`, a support phrase that hides a state-family claim, `SupportSection`, `SupportMaterial`, `support basis`, `support relation`, `support view`, and `supported use` are diagnostic triggers; they are conformant only when rewritten to a governing FPF record named by value, field, publication function, state-family value under [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] only when the selected claim is actually a state-family claim, relation, admissible-use boundary, or, for the [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] case, `DeclaredSubstrateInterpretiveView` under [[A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]]. If the phrase is base-dependence, [[A.6.6 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] is the governing pattern and the text must expose `dependent`, `base`, `baseRelation`, `scope`, applicable `Γ_time`, witnesses, `admissibleUse`, and `nonAdmissibleUse`. Otherwise rewrite the head to the selected interpretation: source-description relation, EntityOfConcern grounding, grounding-holon relation, evidence path, source-use relation, source-currentness claim, source adoption decision, source adaptation decision, source rejection decision, source-description relation, relation record, admissible-use boundary, assurance claim, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use relation or causal-use verdict, [[C.29 - Mathematical Lens Use|C.29]] lens-use output, [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] characteristic construction, measure relation, comparability relation, bridge card, comparison card, work enablement relation, publication companion, or ordinary reader help.

A support-headed phrase selected by an accepted `DRR`, pattern draft, table heading, schema field, coordinate name, or future drafting vocabulary is already durable enough to trigger [[F.18 - Local‑First Unification Naming Protocol|F.18]] unless the text explicitly marks it as source-only, quote-only, or rejected. Do not accept `subject to [[F.18 - Local‑First Unification Naming Protocol|F.18]] later` as [[E.10 - Unified Lexical Rules for FPF|E.10]] closure when the phrase is already being used to guide authoring, review, landing, or reusable FPF wording. Either complete the naming decision now, replace the head with the selected interpretation named by value, or leave the naming issue blocking by value.

If the sentence cannot name the scale, evidence class, threshold, relation, source-loss mode, EntityOfConcern, grounding holon, base relation, admissible-use target, or support-like interpretation named by value, it is not ready for architecture or pattern prose. [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] governs FPF-governed source-loss-mode governance; [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] governs support-like interpretation discrimination and relation precision restoration; [[C.2.P - Epistemic Precision Restoration|C.2.P]] requires the wording to recover the governing pattern and mode.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.19 - Applying patterns versus procedural calls
...
Do not use `project action` as a final class. For project-side activity, choose exactly one kind under repair for the sentence: `U.Method`; `U.MethodDescription`; `U.Mechanism`; [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`; [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence; work-result record or result-measurement record; [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`; [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision record; [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation; [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `DecisionLogRef`; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path; typed evidence record; [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification record; typed status record whose FPF status pattern is named; carrier relation; front-end relation; or another accepted project-side FPF kind.
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.20 - FPF-side and project-side episteme and publication contexts
...
- project-side episteme and publication context: the engineer-manager's project epistemes, publications, views, records, carriers, cues, evidence records, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision records, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate decisions, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] decision-log refs, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification records, commitments, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrences, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult` values, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision records, and [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitations.
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.21 - `decision`, `action`, `work`, `method`, `plan`

Do not let `action` cover every project-side event.
Split:
- decision-making and decision records under [[C.11 - Decision Theory (Decsn-CAL)|C.11]] when a decision claim is being made;
- role, method, and work-plan and actual-work alignment under [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]];
...
- action invitation under [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] when the representation invites an action without itself becoming authority;
- [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence when the [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] object under repair is work; [[A.2.9 - U.SpeechAct (Communicative Work Object)|A.2.9]] `SpeechActRef` when the act under repair is a communicative act; [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]] `U.Commitment` when the act institutes a commitment.

P2W language from [[E.18 - Transformation Flow Structure|E.18]] transformation-flow structure is not a generic `source-to-work` slogan.
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.22 - Whole-corpus trigger use
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.23 - `case`, `scenario`, `example`, `pilot`, `anti-case`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.24 - `basis`, `context`, `scope`, `frame`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.24a - translation and multilingual heads
...
When a state-family word has FPF-governed use, apply [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] unless the governing pattern and local state-like field are already recoverable by value.
...
| --- | --- |
| position in a declared `CharacteristicSpace` | [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], with [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] first if characteristic, scale, coordinate, score, or threshold construction is hidden |
| reusable state-transition or dynamics law | [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] |
| language-state position for an episteme, publication, or wording-use object | [[C.2.P - Epistemic Precision Restoration|C.2.P]] where source-publication recovery is needed, then [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]] and `A.16.*` |
| source use, source currentness, source publication, or source-use disposition | [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]], or the source-use field named by value |
| evidence path state, evidence relation, or reliance disposition | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] |
| assurance result, assurance claim, or assurance input | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] |
| local CV, constraint, adjudication, gate, or release readiness | [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or the release pattern governing the claim or gate pattern |
| temporal claim status or temporal-use classification | [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], retaining `dynClaimPosture` only as a declared [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] field |
| mathematical-lens use admissibility | [[C.29 - Mathematical Lens Use|C.29]], retaining `LensUseAdmissibilityValue` only as a declared [[C.29 - Mathematical Lens Use|C.29]] field |
| `DRR` decision-adequacy result or source-use classification | [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] |
| pattern-quality result or quality-evaluation status | [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]; [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] remains review and admission profile |
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.25a - `live`, `current`, `active`, and status or article overwrap
...
- If it means source currentness, state, status, readiness, publication-use disposition, quality result, admission state, campaign state, or process state, apply [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], the release or process carrier named by value, or the governing pattern for that value.
...
- If it only points to "the thing under discussion", treat it as phrase-level apparatus and apply [[F.19 - Ontology-First Plain Technical Rewriting|F.19]]: write `the pattern`, `pattern of concern`, record named by value kind, affected field, operation claim, relation claim, or other object named by value instead of `live X`.
...
Do not close this row by deleting `live` or replacing it with `current`, `active`, `at issue`, or another status word. Closure is a `KindRestorationCheck`: the modifier is ordinary prose, a state, currentness, or use-position value named by value, a retained claim marker, use marker, or relation marker with named admissible use, an [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] apparatus removal, or a blocker.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.26 - `claim`, `evidence`, `witness`, `ground`, `proof`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.27 - `authority`, `permission`, `approval`, `commitment`, `obligation`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.28 - `profile`, `harness`, `catalog`, `registry`, `index`, `map`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.29 - `entry`, `front door`, `corridor`, `route`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.30 - `same`, `parity`, `identity`, `equivalence`, `mirror`
...
If the relation is semantic, use [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[F.9 - Alignment & Bridge across Contexts|F.9]], or the selected bridge pattern or equivalence pattern rather than relying on matching labels.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.31 - `file`, `path`, `host`, `packet`, `bundle`, `package`
...
#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.32 - `quality`, `characteristic`, `metric`, `indicator`, `score`
...
If "quality improved" refers to an FPF pattern version, name whether the change affects an [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] required coordinate value, status payload, stop condition, bounded non-use, or governing-pattern application.

#### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2c.33 - `slot`, `field`, `row`, `label`, `badge`, `mark`, `cue`
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2d - Current Scan Reading
...
- `strong`, `stronger`, `weak`, `weaker`: replace with scope, evidence class, threshold, gate or admission threshold, `source-loss mode` under [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] when a source-to-rendering loss is being claimed, coarsened rendering, or explicit abstain or reopen condition;
...
- `route`, `call`, `invoke`, or procedure-like pattern wording: replace with pattern application or with project-side `U.Work` occurrence, `U.Method`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision value, or [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation.
...
- project-side umbrellas: `artifact`, `material`, `output`, `screen`, `dashboard`, `credential`, `badge`, and `explanation` must be unpacked into one recovered value named by value, such as publication, generic publication face, declared MVPK face, publication form, carrier relation, front-end relation, project-side FPF kind and reference named by value, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, typed evidence record, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint or adjudication decision record, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `DecisionLogRef`, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance or engineering-justification record, typed status record whose FPF status pattern is named, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`, [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision record, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] action invitation, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] `U.WorkPlan`, [[A.15.1 - U.Work|A.15.1]] dated `U.Work` occurrence, `U.Method`, `U.MethodDescription`, work-result record, or result-measurement record;
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.2e - Trigger Concordance And Closure Mechanism

[[E.10 - Unified Lexical Rules for FPF|E.10]] is applied to a bounded FPF-facing text object, not only to one remembered example sentence. Before claiming [[E.10 - Unified Lexical Rules for FPF|E.10]] closure over an accepted `DRR`, FPF pattern, extracted pattern host, monolith section, review-facing packet, or FPF-facing guidance, complete trigger concordance when a high-pressure trigger is FPF-governed across the bounded object.
...
3. For each local interpretation, choose and complete the repair consequence. Local repair may close under [[E.10 - Unified Lexical Rules for FPF|E.10]]. Relation-like wording applies [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or its retained specialization. Episteme wording, publication wording, or source-use wording applies [[C.2.P - Epistemic Precision Restoration|C.2.P]]. Durable reusable naming applies [[F.18 - Local‑First Unification Naming Protocol|F.18]] after the kind under repair and use recovery. Quote-only or source-only wording needs a non-use disposition. Classification labels are not closure endpoints.
4. Rewrite the bounded object, or leave a blocker. A note saying `apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] when triggered`, `apply [[C.2.P - Epistemic Precision Restoration|C.2.P]] when triggered`, `apply the governing pattern when the recovered claim is being made`, `subject to [[F.18 - Local‑First Unification Naming Protocol|F.18]] later`, `classified under [[A.6 - Signature Stack & Boundary Discipline|A.6]].P`, `classified under [[C.2 - Epistemic holon composition (KD-CAL)|C.2]].P`, or `boundaries are stated nearby` is not closure unless the recovered result is already present in the final wording or the missing required repair is explicitly blocking. The `Final wording or blocker` cell must not be empty for any FPF-governed trigger.
...
| --- | --- | --- | --- | --- | --- |
|  |  | ordinary no FPF-governed use; local repair; relation-like use; episteme, publication, or source-use; durable naming; quote-only; false positive; blocker | [[E.10 - Unified Lexical Rules for FPF|E.10]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[F.18 - Local‑First Unification Naming Protocol|F.18]], or not triggered |  | closed locally; recovered and integrated; quote-only; not triggered by value; still blocking |

Allowed closure dispositions are only:

- ordinary wording with no FPF-governed use accepted;
- local lexical repair closed under [[E.10 - Unified Lexical Rules for FPF|E.10]];
- [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] recovery completed and integrated into the text;
- [[C.2.P - Epistemic Precision Restoration|C.2.P]] recovery completed and integrated into the text;
- [[F.18 - Local‑First Unification Naming Protocol|F.18]] naming decision completed after kind and use recovery and integrated into the text;
- quote-only, source-only, or non-use disposition stated by value;
- false positive stated by value;
- still blocking.

Do not close trigger concordance with a summary statement that `E.10 was applied`, with a citation to [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or [[C.2.P - Epistemic Precision Restoration|C.2.P]] alone, with a correct classification but no governing-pattern repair product, with a later-work promise, or with a table that covers only representative examples while the remaining FPF-governed occurrences keep the same unresolved head.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.3 - Recovery and disposition table

[[E.10 - Unified Lexical Rules for FPF|E.10]] gives only a small local recovery and disposition form. It does not unpack relation-like or episteme-publication-heavy source meaning by itself.

| [[E.10 - Unified Lexical Rules for FPF|E.10]] result | Recovery product | Disposition |
| --- | --- | --- |
...
| relational precision restoration required | Trigger span plus the relation-like wording or relation-bearing use: endpoint, qualifier, slot, scope, time, viewpoint, support-like interpretation, basedness, service, bridge wording, whole-part, mapping, comparison, or dependency. | Apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or its retained specialization before accepting current FPF wording; if the trigger is a false positive, state that reason by value. |
| epistemic precision restoration required | Trigger span plus the episteme, publication, source-use relation, or source-expression relation under repair. | Apply [[C.2.P - Epistemic Precision Restoration|C.2.P]] before accepting current FPF wording; if the trigger is a false positive, state that reason by value. |
| combined precision restoration required | Trigger span plus both relation-like wording and episteme, publication, or source-use wording. | Apply [[C.2.P - Epistemic Precision Restoration|C.2.P]] for source-currentness relation and the claim-bearing episteme or publication relation set; apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] for the relation-bearing slice. |

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:0.4 - Closure rules

| Closure question | Conforming answer |
| --- | --- |
| Can [[E.10 - Unified Lexical Rules for FPF|E.10]] alone close the case? | Yes only for `not-triggered`, false-positive by value, ordinary wording with no FPF-governed use, and local lexical-repair outcomes whose replacement candidate has also passed [[E.10 - Unified Lexical Rules for FPF|E.10]]. |
...
| What counts as [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or [[C.2.P - Epistemic Precision Restoration|C.2.P]] application? | A governing-pattern application is not the classification label. It is the completed recovery product: selected relation interpretation, relation phrase or record named by value, endpoint repair, qualifier repair, scope repair, admissible-use repair, source-use disposition, episteme construction or publication construction named by value, project-side reference, false-positive reason, quote-only disposition, non-use disposition, or named blocker integrated by value into the text or closure account. |
| Can [[E.10 - Unified Lexical Rules for FPF|E.10]] close relation-like wording by itself? | No. If the problem under repair is endpoint, qualifier, slot, scope, time, viewpoint, support-like interpretation, basedness, service, bridge wording, whole-part, mapping, comparison, or dependency, the conforming text applies [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or a retained specialization, or states the false-positive reason by value. |
| Can [[E.10 - Unified Lexical Rules for FPF|E.10]] close episteme-publication or source-use wording by itself? | No. If the problem under repair is source wording, episteme, publication, view, face, carrier, publication unit, EntityOfConcern, grounding, FPF transfer, project-side claim, admissible-use claim, or pattern-application wording, the conforming text applies [[C.2.P - Epistemic Precision Restoration|C.2.P]] or states the false-positive reason by value. |
...
| Where do trigger words and examples belong? | In this shared [[E.10 - Unified Lexical Rules for FPF|E.10]] scan architecture or in a named local application profile tied to its own primary `EntityOfConcern`, relation record, or claim record. Do not copy growing word lists into [[F.18 - Local‑First Unification Naming Protocol|F.18]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], or local checklists. |

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:1 - Problem context
**Current name set.** [[E.10 - Unified Lexical Rules for FPF|E.10]] is the current FPF pattern. `E.10:0.2` is the shared wording-use trigger scan. The older `LEX-BUNDLE` or `ULR` material below is retained as detailed reference apparatus for selected lexical, register, naming, morphology, and local rewrite problems. It is not a second current ontology, not a second wording-recognition table, not a second pattern head, and not a replacement for [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], the selected precision-restoration realization pattern, a governing pattern, or [[F.18 - Local‑First Unification Naming Protocol|F.18]]. When the retained material conflicts with `E.10:0.2`, [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[A.3.4.P - Transformation Ontic Precision Restoration|A.3.4.P]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], `E.24.*`, [[F.18 - Local‑First Unification Naming Protocol|F.18]], or a governing pattern named by value, the current applicability table and that governing pattern control the repair.
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:2 - Problem
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:3 - Forces
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:4 - Retained register and naming reference

**LEX-BUNDLE** and **ULR (Unified Lexical Rules)** are retained labels for reference apparatus inside the current [[E.10 - Unified Lexical Rules for FPF|E.10]] pattern. They name register, naming, morphology, and local rewrite checks only; they do not name a second pattern, a second ontology, or a second mandatory audit. Use this material only after the `E.10:0.2` scan has selected a lexical, register, morphology, or naming problem that actually needs those details.

1. **Vertical Stratification** ([[E.10 - Unified Lexical Rules for FPF|E.10]] -> four strata);
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:5 - Vertical Stratification (four strata; no cross-bleed)
...
**V‑3 (Citation style).** When a Context term is used, its **Context** must be visible at first mention (e.g., `OwnerRole:ITIL_2020`). If an author needs Cross‑context reuse, they **MUST** cite a **Bridge** with a stated **Congruence Level (CL)** (see [[F.9 - Alignment & Bridge across Contexts|F.9]]).
 ...
 **Onto2 — EntityOfConcern and Description-episteme boundary and specification-use morphology**  *(ref. [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]])*
* **Rule:** A term for the EntityOfConcern uses the bare head for the FPF kind under concern: `Method`, `Tradition`, `Characteristic`. A **Description episteme** appends **`…Description`**: `MethodDescription`, `TraditionDescription`. A **Description episteme admitted for specification use** appends **`...Spec`** and presupposes acceptance criteria, harnesses, measurable anchors, formal checkability, verification use, or another specification-granting gate named by value (normative in **[[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]** and neighbouring patterns). E.g., *Algorithm* is a species of `MethodDescription` for a computer (a system in the role of information transformer); **if** expressed in a formal language **and** bundled with acceptance tests, it is **`MethodSpec`** (per **[[F.11 - Method Quartet Harmonisation|F.11]]**). **If** expressed as pseudo-code, it is **`MethodDescription`**.
...
**Onto4 — Domain only as a catalog mark**  *(ref. [[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] D.CTX; publish stitching on UTS)*
...
* **Required stitching (see D.CTX and UTS).** Any use of `Domain` **MUST** present: 1. the enumerated list of `ContextId` in **D.CTX**, and 2. the corresponding **UTS strings** ([[F.17 - Unified Term Sheet (UTS)|F.17]]) with twin labels.
* **“Discipline ≠ Domain.”** _Domain_ labels are **catalog‑only (D.CTX + UTS)**; **Discipline** is a **CG‑Spec‑governed holon** (`U.Discipline`). Cross‑use requires **Bridge ([[F.9 - Alignment & Bridge across Contexts|F.9]]) + CL**; **LexicalCheck** MUST fail texts that equate Domain with Discipline.
...
**Onto6 — Bans and ontology recovery hints**  *(mirror [[E.10 - Unified Lexical Rules for FPF|E.10]] § 9 L-rules; do not duplicate tables; not a substitution table)*
* `process`, `procedure`, `workflow`, `function`, or `activity` -> first recover the wording family: change-situation wording applies [[A.3.4.P - Transformation Ontic Precision Restoration|A.3.4.P]]; function-like wording applies [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]; possible recovered values include `U.Method`, `U.MethodDescription`, `U.WorkPlan`, dated `U.Work`, `U.Transformation`, and `TransformationFlowStructure` only after the governing kind and use-position are named by value.
...
> **Note on registers.** Keep figurative or business-casual terms in the **Plain** register only, with strict **twin-label** links to the Tech token under current [[E.10 - Unified Lexical Rules for FPF|E.10]]. In the **Tech** register, speak in KL-CAL: **episteme-about-epistemes** (Tradition, Lineage, Profile), not in catalogue-admin idioms.

* **Onto‑Deon — Deontic lexicon guard (Core register)**
**Rule.** In the Conceptual Core, avoid using **“Standard”** as the head noun of an EntityOfConcern name unless the object is an explicit **deontic speech-act** under the **Gov** lens (cf. [[E.3 - Principle Taxonomy & Precedence Model|E.3]]).
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:6.2 - Twin‑Register Discipline (Tech and Plain)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:6.2.1 - Allowed pairs (normative table; examples)

| **Tech (authoritative)** | **Plain (didactic)**                        | **Notes and guards**                                                                           |
| ------------------------ | ------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `U.System`               | system, machine, team                        | Bare “service” is **never** a safe Plain twin for `U.System`; treat it as an **always‑unpack** token (L‑SERV, [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]]). Avoid “service‑instance”; prefer “system instance”, “service access point”, or “service offering” depending on facet. |
| `U.Episteme`             | body of knowledge, document, dataset, model | Pair must respect the **Carrier and Content** distinction ([[A.7 - Strict Distinction (Clarity Lattice)|A.7]]).                                              |
| `U.Method`               | how‑to, procedure (abstract)                | Do **not** call this “process” (L‑PROC).                                                     |
| `U.MethodDescription`    | recipe, SOP, playbook, code, spec‑text      | If testable, call out **Spec** explicitly per [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary and specification use).                               |
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:6.2.2 - Plain Twin Safety constraints (normative)
...
A plain twin **MUST** bind to the **same SenseCell** as its Tech name in that Context ([[F.3 - Intra‑Context Sense Clustering|F.3]] and [[F.7 - Concept‑Set Table|F.7]]). Authors **MUST** record at least one **counter‑example test** showing how the twin could be misread and why it still passes **in this Context** (SenseCell notes).
...
A plain twin **MUST NOT** map across **Kinds** ([[C.3 - Kinds, Intent-Extent, and Typed Reasoning (Kind‑CAL)|C.3]]). If the twin’s everyday interpretation could denote a different Kind (e.g., *Tradition* = organization, corpus, domain), it is **forbidden** unless qualified by a bracketed head and **Context gloss** on first use (see CC‑TWIN‑7).
...
**At most one** plain twin per Tech name per Context. Synonym piles are prohibited (control vocabulary sprawl; see [[F.14 - Anti‑Explosion Control (Roles & Statuses)|F.14]]).
...
**CC‑TWIN‑11 - Tests.**
 Twin entries **MUST** pass the **Twin Harness** (see [[F.15 - SCR-RSCR Harness for Unification|F.15]]): *Head term*, *Kind consistency*, *SenseCell match*, *Stop‑list compliance*, and *First‑use gloss*.

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:7 - Minimal Generality and Domain Anchoring (MG-DA) — names neither parochial nor vacuous
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.1 - `LEX.TokenClass` (meta‑lexical; not a USM Scope)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.2 - `KernelToken` — Minimal Generality (MG‑K)
...
**MG‑K6 (Refactoring safety, MUST).** If a name fails MG, do **not** mutate it silently. Record a DRR and apply [[F.13 - Lexical Continuity & Deprecation|F.13]] **Lexical Continuity and Deprecation** (aliases; Bridges for Cross‑context mappings).

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.3 - `DiscriminatorToken` and `ContextToken` — Domain Anchoring (DA‑D)
...
**DA‑D5 (Mapping discipline, MUST).** Cross‑context interpretations go through a **Bridge** ([[F.9 - Alignment & Bridge across Contexts|F.9]]). Discriminator names must not suggest global identity.
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.4  - Global tests (apply after 7.2 and 7.3)
...
**MG-DA‑T6 (Teaching swap).** In didactic prose ([[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]), the term can be swapped in **without caveats**.
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.5 - Compatibility with USM (how tokens and scopes meet)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.6 - Metaphor guidance (non‑binding heuristics)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.7 - Short‑form and acronym discipline
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.8 - Examples (illustrative, canonical)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:7.9 - Acceptance and regression checks (LEX and USM)
...
**SCR‑LEX‑S06 (Slot and Ref suffix discipline).** Any token with suffix **`…Slot`** or **`…Ref`** is either (a) a **SlotKind** or **RefKind** declared under [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]], or (b) an episteme field whose type is a RefKind; no ValueKind or other type class may end with these suffixes.
**SCR‑LEX‑S07 (Manifest `provides` covers SlotKinds and RefKinds).** If a `SignatureManifest` is present ([[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]]), its `provides` list MUST include any public **SlotKinds** (`…Slot`) and **RefKinds** (`…Ref`) introduced by that signature or mechanism, in addition to types, relations, and operators, so SD and lexical linters can treat them as exported API.
...
**RSCR‑LEX‑E03 (Strategy token minting).** Reject new Kernel tokens named **Strategy** or **Policy** as kinds; model them as **lenses**, **flows**, or **compositions** inside **[[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]]**, or as **…Description** or **…Spec** in Contexts. (Prevents kernel overloading; aligns with [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] “no minted Strategy head”.)

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:8 - Morphology and Lexical Form (LEX.Morph)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.0 - Casing and basic forms
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.1 - Reserved suffixes (gated by LEX.TokenClass, EntityOfConcern and Description-episteme boundary, and specification use)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.1.1 - Legacy suffix conventions

| **Suffix** | **Lexical class** | **Meaning and ontology** | **Where it lives** | **Examples and notes** |
|--- |--- |--- |--- |--- |
| **Space** | EntityOfConcern-side kind | A typed **state space** (finite product of Characteristic×Scale slots); no procedures | Kernel [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]; CHR and space consumers | `CharacteristicSpace`, `CreativitySpace`. Edition of a Space is a **phase** of the episteme that defines it. |
...
| **Spec** | Description episteme admitted for specification use | Testable invariants bound to acceptance harnesses | [[E.10 - Unified Lexical Rules for FPF|E.10]] and [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] | Stable, testable definitions; **normative** by default; admitted for specification use. Use for normative calculi plus scoring and normalization specifications. |
| **Slot** | Structural position | Named **argument position** in a relation or morphism signature (SlotKind in [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]]) | Kernel [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] and [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] | `EntityOfConcernSlot`, `GroundingHolonSlot`. Always names a *position*; never used for ValueKinds or episteme fields. |
| **Ref** | Pointer | **Reference or identifier** to a registry item of some ValueKind (RefKind in [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]]), not the thing itself | Data fields and UTS; RefKind types | `U.EntityRef`, `U.HolonRef`; episteme fields `…Ref : U.EntityRef`. Reserved for **RefKinds** and episteme fields typed as them; `…Ref` **never** carries content and is never used for ValueKinds or SlotKinds. |
...
* Use `U.Episteme` for the claim-bearing unit. Use `U.EpistemePublication` or governed `U.Episteme` publication only when that episteme is available as a published episteme under [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[E.17 - Multi‑View Publication Kit|E.17]] discipline.
...
* Use [[C.2.P - Epistemic Precision Restoration|C.2.P]] when episteme-publication-heavy wording carries episteme, publication, view, carrier, relation, admissibility, evidence, work, gate, decision, method, or FPF-pattern-application claim. This parent pattern keeps the lexical and naming discipline; [[C.2.P - Epistemic Precision Restoration|C.2.P]] supplies the epistemic precision-restoration profile that recovers the FPF kind named by value, relation record, relation phrase, tuple-like record, project-side FPF kind and reference named by value, or not-triggered disposition before final wording is accepted.
...
* Use *Space* only for **CHR‑grounded measurement and state constructs** such as `CharacteristicSpace` per [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]. Do **not** coin generic `…Space` for sets, portfolios, or publication forms. Publish portfolios and archives as **sets** via admissible selectors; publish them on UTS as **views** or **cards**, not as spaces.
* **Field‑name guard (Kernel blocks).** In **Kernel conceptual blocks** (e.g., [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] and [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] lists), **do not** name a field `…Space`; reserve *Space* to the **types** (CHR and ReferencePlane families). Use **BaseType** as the field name and let the referenced `U.Type` carry `…Space` where appropriate; otherwise, for set‑valued universes, use `…Set`.
...
* **Param-slot and relation-endpoint guard.** Do **not** use the morpheme **`Role`** for **formal parameter positions** in operator algebra declarations (`OperationAlgebra`) or Signature arguments. Reserve **`Role`** for **agentive kinds** only ([[A.2 - Role Taxonomy|A.2]], [[F.4 - Role Description (RCS + RoleStateGraph + Checklists)|F.4]], and [[F.6 - Role Assignment & Enactment Cycle (Six-Step)|F.6]]). Prefer SlotKinds + SlotSpecs ([[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]]) to type formal slots; if a didactic list is useful, use a `ValueKindView` (name→ValueKind) projection derived from SlotSpecs and SlotIndex. Same for similar situations (table columns, tuple placements): use MG-DA with domain‑**specific** terminology, never “Role”.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.2 - Forbidden suffixes and the DevOps, Data Governance and Repository-Workflow Lexical Firewall
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.3 - Prefix discipline
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.4 - Morphology tests (apply with § 7 MG-DA)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.5 - Alias hygiene
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.5a - Entry lexeme support and lexical-query discipline

Public first-entry scenario text, ToC query rows, local Problem-frame recognition text, or expanded [[I.2 - Expanded Entry Disambiguation Cases|I.2]] entry-disambiguation cases may use one compact **entry lexeme cue** block when the lexical issue changes the first useful FPF entry.
That cue block should not be copied into every pattern body by default.
Keep it instead in:

* FPF `readme` section,
* [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] entry-distribution loci,
* [[I.2 - Expanded Entry Disambiguation Cases|I.2]] expanded entry-disambiguation cases,
* `Table of Content` query rows,
* or one bounded lexical-query record governed by [[F.17 - Unified Term Sheet (UTS)|F.17]], `UTS`, or [[F.18 - Local‑First Unification Naming Protocol|F.18]].
...
* ordinary `README` scenario or [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] entry-distribution cues: keep only the most discriminating domain phrases and false friends;
* fuller lexical sets belong under `F.17, [[F.18 - Local‑First Unification Naming Protocol|F.18]], and E.10` only when one real
...
admitted through [[F.18 - Local‑First Unification Naming Protocol|F.18]] or [[E.10 - Unified Lexical Rules for FPF|E.10]].
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.6 - Compatibility with USM (acts and tokens)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.7 - Acceptance and regression checks (LEX and USM)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.8 - Autonomy lexicon (L‑AUTO )
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.9 - LEX-CHR-STRICT — Reserve *Characteristic* for CSLC-measurable aspects

**Intent.** Prevent calling **non-measurable** objects (sets, statuses, scopes, policies, bridges, contexts, guards) “characteristics”.

**Rule L-CHR-S1 (Reservation).** Use **Characteristic** **only** for variables that **declare a CSLC scale** (nominal, ordinal, interval, or ratio) with admissible values, units, and polarity (Part [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] and [[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]]–[[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]]).
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:8.10 - LEX‑QA‑1 — Using “‑ility/‑ilities” terms (availability, reliability, …)
...
**Authoring choice:**
— To use such a term as a **CHR** characteristic, **bind** it to a **named `U.Characteristic` with one CSLC Scale** ([[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]]) and refer to that Characteristic in guards and UTS;
— Otherwise **publish a Q‑Bundle** (see **[[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]**) that includes **Measures (CHR)** (the measurable slots) and, where relevant, **Scope** (USM set over `U.ContextSlice`) plus window, mechanism, and status fields.

**Rationale.** Scope is **set‑valued** (USM) and **not** a CHR measurement; mechanism fields and status fields are governance records. Keeping them outside the CHR CSLC avoids illegal scalarisation and preserves set‑algebra semantics for scope. ([[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] § 6.2; [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]; [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] and [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]]).

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:9 - Ontology recovery rows for overloaded words (LEX L-rules; normative)
...
> **Guards.** Tokens are classified by **`LEX.TokenClass ∈ {KernelToken, ContextToken, DiscriminatorToken}`** (§ 7.1). Only **CHR:ReferencePlane** may use the bare word *plane*. [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] names the boundary between EntityOfConcern and Description epistemes with `DescriptionContext`; specification use needs a granting gate named by value; publication faces, forms, units, carriers, and renderings stay in publication lanes. Enumerations are **Characteristics** in a **CharacteristicSpace** **only when a CSLC scale is declared; otherwise treat such slots as non-measurable attributes (not Characteristics)**.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.1 - Hard bans and ontology recovery rows (single table; normative)
...
| **L‑BRIDGE** | cross‑context equivalence “by same label” | Explicit **Bridge Card** ([[F.9 - Alignment & Bridge across Contexts|F.9]]): state kind, direction, congruence level, loss, and scope; apply **[[A.6.9 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR‑XCTX)|A.6.9]] (RPR‑XCTX)** for disambiguation and licence-revealing name or verb choice. | — | — | Same label ≠ same concept; umbrella wording such as “same”, “equivalent”, “align”, or “map” must be repaired into a Bridge before it can justify reuse, rows, or substitution. |
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.2 - Diagnostic examples, not substitutions
...
| “function of component A fails” | Apply [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]; if the recovered claim is performed behavior, **Work** performed by `SystemA#Role` **failed** acceptance (observations show …). |
| “context is unclear here”       | **Name** the `U.BoundedContext`; else split and Bridge                                  |

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.3 - Acceptance tests (LEX‑AC)
...
6. **Cross‑context reuse.** Any reuse across Contexts cites a **Bridge id** with kind, direction, congruence level, loss, and scope. Apply **[[A.6.9 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR‑XCTX)|A.6.9]] (RPR‑XCTX)** when the published prose uses “same”, “equivalent”, “align”, “map”, or similar bridge wording.
...
9. **Banned tokens absent or recovered.** No *process*, *function*, *task*, or *activity* in Kernel senses unless the sentence applies the selected recovery pattern ([[A.3.4.P - Transformation Ontic Precision Restoration|A.3.4.P]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], work patterns, method patterns, or another governing pattern) and names the recovered value by value; no tooling or file suffixes in Kernel tokens.
10. **State gating present (when needed).** Readiness is expressed via **RSG state** + **StateAssertion**, not vague “approved” or “ready”.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.4 - Coordination map (how LEX plugs into the rest of FPF)

* **With [[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] D.CTX (Context discipline).**
  E10-CTX-1: Every Core meaning that can vary **names its `U.BoundedContext`**.
  E10-CTX-2: Same-spelled labels are **distinct senses** across Contexts; reuse requires a **Bridge** ([[F.9 - Alignment & Bridge across Contexts|F.9]]) with CL and loss notes.

* **With [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary and specification use and refinement discipline).**
...
* **With [[A.2 - Role Taxonomy|A.2]] and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role–Method–Work alignment).**
...
* **With F‑cluster (Unification) and UTS ([[F.17 - Unified Term Sheet (UTS)|F.17]]).**
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.5 - Conformance checklist (LEX‑CC)
...
✓ [[A.16 - Language-State Move Coordination|A.16]] keeps `projection` as a move name for route-bounded partialization; [[F.9.1 - Bridge Stance Overlay|F.9.1]] keeps `projection` as a bridge stance label. If one durable reusable replacement name is really needed, handle the naming question with **[[F.18 - Local‑First Unification Naming Protocol|F.18]] `MintNew` or an explicit source-retention naming decision** rather than flattening both local interpretations into one umbrella rewrite.
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:9.7 - Guarded-head cross-reference *(normative lexical caution)*
...
If cleanup reveals that no admissible existing token can carry the needed meaning, use the local repair pattern for one-off wording. If the change needs one durable reusable name, handle the naming question with **[[F.18 - Local‑First Unification Naming Protocol|F.18]] `MintNew` or `DocumentLegacy`** rather than inventing an ad hoc synonym by feel.
...
`projection` is the main current example: [[A.16 - Language-State Move Coordination|A.16]] keeps it as a move name for route-bounded partialization, while [[F.9.1 - Bridge Stance Overlay|F.9.1]] keeps it as a bridge stance label. [[E.10 - Unified Lexical Rules for FPF|E.10]] therefore requires deconfliction notes and explicit naming of the cited text that governs each local interpretation, not one umbrella rewrite that erases the distinction.

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:10 - Reference routine for turning messy language into E.10-clean prose *(informative)*
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:10.1 - Pass 0 — *Pre‑flight (2 minutes per page)*
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:10.2 - Pass 1 — *Harvest in the Context*
...
2.5 Record a local `KindRestorationCheck` for every changed FPF-governed phrase: pre-repair kind, relation, slot-or-use-position, use, and scope; post-repair kind, relation, slot-or-use-position, use, and scope; and preserved, split, intentionally changed, or blocker disposition. A changed word without this check remains an unresolved lexical finding. If a relation, signature, field, mathematical-lens, role, method, work, evidence, assurance, gate, or decision use-position is being used, cite the governing pattern for that position; [[E.10 - Unified Lexical Rules for FPF|E.10]] detects the wording-use problem and does not replace the selected ontology.

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:10.4 - Pass 3 — *Stitch and publish*

3.1 Add **safe rewrites** for any anti‑patterns you found (use § 9.2 quick table).
3.2 If sameness is needed across Contexts, create a **Bridge** ([[F.9 - Alignment & Bridge across Contexts|F.9]]) with explicit kind, direction, congruence level, loss, and scope; apply **[[A.6.9 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR‑XCTX)|A.6.9]] (RPR‑XCTX)** when quoted or imported source wording uses umbrella language such as “same”, “equivalent”, “align”, or “map”.
3.3 Publish a one‑page **UTS** ([[F.17 - Unified Term Sheet (UTS)|F.17]]) for the Context (columns: Context, Tech label, Plain label, Kernel anchor, Warnings).
3.4 Log a short **DRR** when renames or aliases occur ([[F.13 - Lexical Continuity & Deprecation|F.13]]), linking to grep results that motivated the change.

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:11 - [[E.10 - Unified Lexical Rules for FPF|E.10]] conformance prompts *(normative, concept-only questions)*
...
14. **Naming-procedure prompt.** If one durable reusable name is needed because no admissible existing token carries the needed meaning beyond one local repair, was the full **[[F.18 - Local‑First Unification Naming Protocol|F.18]] `MintNew` or `DocumentLegacy`** procedure completed rather than picking a label by intuition and filling a partial Name Card afterward?
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:11a - SoTA-Echoing for lexical governance

[[E.10 - Unified Lexical Rules for FPF|E.10]] lexical governance is not a private FPF style preference. It is a compact authoring discipline for communication, comprehension, term formation, discoverability, and error prevention. These external practice rows are admitted only where they change what an author or reviewer does in a wording repair.

| Practice source | Use of source and source-currentness claim | What [[E.10 - Unified Lexical Rules for FPF|E.10]] adopts | What [[E.10 - Unified Lexical Rules for FPF|E.10]] rejects |
| --- | --- | --- | --- |
...
* **A declarative representation starts to sound imperative** (graph path, path slice, evidence path, query, predicate, table, dashboard, publication face, mathematical representation, method-description representation, source-chain relation, carrier path, or FPF pattern relation "runs", "routes", "calls", "dispatches", "authorizes", or "flows" without a recovered kind) → apply [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] or the direct governing pattern such as [[E.18 - Transformation Flow Structure|E.18]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[E.17 - Multi‑View Publication Kit|E.17]], [[C.29 - Mathematical Lens Use|C.29]], [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]], [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.1 - U.Work|A.15.1]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], or [[F.19 - Ontology-First Plain Technical Rewriting|F.19]].
...
* **Cross-Context reuse by label** appears → require a **Bridge** ([[F.9 - Alignment & Bridge across Contexts|F.9]]) or split senses.
* **A guarded head needs a new label** → prefer a guarded-head note first; if no admissible existing token remains for one durable reusable name, handle the naming question with full **[[F.18 - Local‑First Unification Naming Protocol|F.18]] `MintNew` or `DocumentLegacy`**.

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:13 - Teaching deck — the [[E.10 - Unified Lexical Rules for FPF|E.10]] quick card *(reusable in any Context)*
...
• **No suitcase nouns:** avoid the words `and`, `plus`, and `&` in names; use **bundles** ([[A.2 - Role Taxonomy|A.2]]) or separate roles.
• **Acronyms:** first expansion + register; short‑form registered per **§ 7.7**.

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:14 - Three worked micro-examples — [[E.10 - Unified Lexical Rules for FPF|E.10]] across domains *(informative)*

### [[E.10 - Unified Lexical Rules for FPF|E.10]]:14.1 - Healthcare (OR context)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:14.2 - Manufacturing (assembly line)
...
### [[E.10 - Unified Lexical Rules for FPF|E.10]]:14.3 - Cloud and SRE (production Context)
...
## [[E.10 - Unified Lexical Rules for FPF|E.10]]:15 - Closing notes *(governance and purity)*

* **Notation-agnostic.** [[E.10 - Unified Lexical Rules for FPF|E.10]] is a wording-use governance pattern, not a scanner or template. Apply it in prose, sketches, or formal models.
* **Where checks belong.** Convenience checks belong to Tooling; [[E.10 - Unified Lexical Rules for FPF|E.10]] itself stays notation-agnostic. Conformance code belongs in **SCR-LEX** or **RSCR-LEX** as referenced above.
...
* **Reserved “plane”.** Only **`CHR:ReferencePlane`** uses the bare word *plane*. [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] is the EntityOfConcern and Description-episteme boundary plus specification-use gates, with publication lanes kept separate; all other category talk is expressed as **Characteristics** in a **CharacteristicSpace** when scale semantics are declared.

> **One-line memory:** *“[[E.10 - Unified Lexical Rules for FPF|E.10]] keeps words honest so ideas stay composable.”*

## [[E.10 - Unified Lexical Rules for FPF|E.10]]:End
