...
related:
  ...
  - "[[E.13 - Pragmatic Utility and Value Alignment|E.13]]"
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:1 - Problem frame
...
- `service situation`: an [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]] facet-binding lens that identifies access point, delivery system, provider principal, promise content, commitment, delivery work, and evidence; it is not itself a new root bearer unless the relevant system facet is declared.
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:2 - Problem
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:3 - Forces
...
| Ordinary control vs QL lens | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], `U.Dynamics`, [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] remain primary patterns; QL enters only for probe, frame, export, or coarsening cue. |
| Light use vs dynamics detail | Rate, inertia, damping, actuator latency, and effort matter only when load-bearing. |

## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4 - Solution

Use [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] / `U.Dynamics` alone for ordinary envelope work. Use [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] only when the viability-envelope reading is distorted or constrained by probe, frame, export, coarsening, or incompatible representation cue. Otherwise use ordinary viability, quality-bundle, dynamics, measurement, boundary, and work patterns.
...
| Viability bearer | Which `U.System`, collective system, delivery system, role configuration, organism-as-system, or explicitly declared bearer is being kept viable? |
| Protected promise / function | Which `U.PromiseContent`, stakeholder value, function, operating regime, commitment payload, or delivery promise is protected? |
| Service situation facets, if used | Which [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]] facets are involved: access point, delivery system, provider principal, promise content, commitment, delivery work, and evidence? |
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.1 - Homeostasis and allostasis reading
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.2 - Finish conditions
...
| Ordinary neighboring-pattern application | Use [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], `U.Dynamics`, [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], or [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] when the QL cue is not load-bearing. |
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.3 - Metric-induced distortion
...
| Goodharted viability | Actors optimize measured slots while damaging unmeasured survivor relations or future adaptability. | Route probe-caused behavior through [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]]; add evidence for unmeasured envelope dimensions. |
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.4 - Conditional dynamics detail
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.5 - Primary EntityOfConcern and operational sequence
...
1. Name the viability bearer and the promise or function being preserved; if service or market language is used, declare whether the bearer is a collective `U.System`, delivery system, trace population, evidence set, or relevant [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]] facet-binding before treating the situation as a bearer.
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.6 - Viability envelope record
...
- service-situation language identifies its [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]] facets rather than treating the situation label as a root bearer by itself;
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.7 - Sensor, probe, actuator, and metric split
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.8 - Homeostasis, allostasis, and architecture work
...
| --- | --- | --- |
| Scalar quality repair | One characteristic or Q-bundle dimension is enough. | Apply [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], measurement patterns, or evidence patterns as appropriate. |
...
| Probe-coupled viability | The measurement, dashboard, review, or readiness check changes the envelope it reports. | Coordinate with [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]]. |
| Enacted viability state | Coordinated work evidences the envelope state better than one report. | Coordinate with [[C.26.2 - Enacted Distributed State Evidence|C.26.2]]. |
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.9 - Case bank and near misses

| Case | Supported [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] reading | Near miss / reroute |
| --- | --- | --- |
...
| Incident staffing | Adding responders preserves recovery time but increases coordination overhead and error risk. | If staffing is merely a work allocation issue, use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] / planning patterns. |
| Compliance exposure | A fast remediation path lowers outage time but increases evidence gaps and audit risk. | If audit evidence is primary, apply [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; keep [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] only for envelope trade-off. |
| Service boundary split | Splitting a service reduces deployment coupling but increases bridge loss and operational support transfer cost. | If the issue is only semantic bridge loss, use [[F.9 - Alignment & Bridge across Contexts|F.9]]; if the split changes the envelope, use [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]. |
...
### [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:4.10 - Source-to-pattern translation
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:5 - Archetypal Grounding
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:6 - Bias-Annotation
...
The pattern may feel too broad if it is applied to every quality concern. It is not for every quality concern. Use [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] alone when one quality bundle or metric can be handled without envelope, disturbance, boundary condition, actuator, adaptation cost, or viability failure mode.

## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:7 - Conformance Checklist
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Passive sensor assumption | A dashboard is treated as neutral even after it changes behavior. | Use [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] and evidence patterns. |
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:9 - Consequences
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:10 - Rationale

Ordinary quality-bundle work does not always show boundary conditions, actuators, disturbances, adaptation cost, and failure modes together. [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] coordinates those elements while preserving ordinary FPF patterns.
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:11 - SoTA-Echoing
...
| Platform and software engineering already treats many quality concerns as trade-off bundles. | Reliability, incident, platform, compliance, energy, support, operator-load practice, and [Google SRE SLO / error-budget practice](https://sre.google/workbook/implementing-slos/), coordinated with [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]. | Make the quality bundle explicit and state actuator authority, latency, adaptation cost, and failure mode. | Adopt through FPF quality-bundle routes. |

Worked-slice discipline from these rows:

- state the envelope before importing source terminology;
- translate source terms into selected structures, `ArchitectureOf@Context` relations, architecture descriptions, structural views, or named [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] subcases;
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:12 - Relations
...
- [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] may flag: braking, throttling, cadence, recovery, or stabilization moves in claims such as slow rollout protecting support capacity, request throttling preventing collapse, or cadence change preserving attention/team health.
...
- Non-admissible use: stabilization wording is not a viability envelope, and [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] is not the pattern for all stability-through-change claims.
- Exit: if the claim being made is only better quality, healthier team, or more resilient service without a declared viability envelope, use [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[E.13 - Pragmatic Utility and Value Alignment|E.13]], or the relevant quality/proxy/value pattern rather than [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] or a [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] profile.

- Builds on: [[C.26 - Quantum-Like Modeling Lens|C.26]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], `U.Dynamics`, [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.3 - Transformer Constitution (Quartet)|A.3]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]].
- Coordinates with: [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] when sensors, probes, dashboards, or metrics change represented state; [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] when coordinated work evidences the envelope state.
...
## [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]:End
