...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:1 - Problem frame
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:2 - Problem
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:3 - Forces
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:4 - Solution — the Four Guard‑Rails
...
Concrete rules for each rail live in patterns **[[E.5.1 - DevOps Lexical Firewall|E.5.1]] – [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]**.

## [[E.5 - Four Guard‑Rails of FPF|E.5]]:5 - Archetypal Grounding (System / Episteme)
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:6 - Conformance Checklist
...
| **CC‑GR.3** | A revision to any guard‑rail pattern **REQUIRES** a Design‑Rationale Record that (a) states the reason, and (b) includes a Pillar‑impact analysis per [[E.3 - Principle Taxonomy & Precedence Model|E.3]] precedence model. | Aligns evolution with higher‑level principles. |
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:7 - Consequences
...
## [[E.5 - Four Guard‑Rails of FPF|E.5]]:8 - Rationale
...
and reinforce the precedence order defined in **[[E.3 - Principle Taxonomy & Precedence Model|E.3]]**.

## [[E.5 - Four Guard‑Rails of FPF|E.5]]:9 - Relations

* **Comprises:**
  * `pat:guard/devops‑firewall` ([[E.5.1 - DevOps Lexical Firewall|E.5.1]]) – GR‑1
  * `pat:guard/notational‑independence` ([[E.5.2 - Notational Independence|E.5.2]]) – GR‑2
  * `pat:guard/unidirectional‑dependency` ([[E.5.3 - Unidirectional Dependency|E.5.3]]) – GR‑3
  * `pat:guard/bias‑audit` ([[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]) – GR‑4
* **Depends on:**
  * `pat:constitution/pillars` ([[E.2 - The Eleven Pillars|E.2]])
  * `pat:constitution/principle‑taxonomy` ([[E.3 - Principle Taxonomy & Precedence Model|E.3]])
* **Constrains:** every Core, Tooling, and Pedagogy artefact; all DRRs.

## [[E.5 - Four Guard‑Rails of FPF|E.5]]:End
