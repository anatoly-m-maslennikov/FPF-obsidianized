...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:1 - Problem frame
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:2 - Problem
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:3 - Forces
| Force | Tension |
|---|---|
...
| **Framing revision vs repair-pattern boundary** | Allow route-specification or framing-scaffold revision without letting [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] swallow slot-explicit epistemic precision repair from governing patterns. |

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:4 - Solution
This pattern defines the retreat, reframing, and retirement side of the [[A.16 - Language-State Move Coordination|A.16]] move family.

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:4.1 - Move family
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:4.3 - Authority discipline
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:5 - Archetypal Grounding
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:6 - Bias-Annotation
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:7 - Conformance Checklist
- `CC-[[A.16 - Language-State Move Coordination|A.16]].2-1` Retreat or retirement moves **SHALL** cite the trigger or counter-evidence that justifies them.
- `CC-[[A.16 - Language-State Move Coordination|A.16]].2-2` A retreat or retirement move **SHALL NOT** silently preserve endpoint authority if the target form no longer supports it.
- `CC-[[A.16 - Language-State Move Coordination|A.16]].2-3` Reopen / backoff / respecify / retire moves **SHOULD** preserve witnesses and trace links whenever still valid.
- `CC-[[A.16 - Language-State Move Coordination|A.16]].2-4` The target articulation, closure, and route-authority state **SHALL** be explicit when the move substantively changes any of them.
- `CC-[[A.16 - Language-State Move Coordination|A.16]].2-5` `respecify` **SHALL NOT** be used to smuggle slot-explicit epistemic precision repair out of governing patterns.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:9 - Consequences
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:10 - Rationale
Language-state history is not one-way tightening. Without retreat and retirement discipline, [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] and endpoint forms would encode only one-way progress and would hide the real cost of over-commitment.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:11 - SoTA-Echoing
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:12 - Relations
- Builds on: [[A.16 - Language-State Move Coordination|A.16]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]].
- Coordinates with: [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[B.5.2 - Abductive Loop|B.5.2]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]].
- Constrains: admissible retreat, respecification, and retirement paths.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:13 - Worked Retreat Trajectories

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:13.1 - Reopen within the same family
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:13.2 - Sketch-backoff to cue pack
An over-specified [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]-governed invitation may later prove premature. The admissible retreat is:

`actionInvitation -> sketchBackoff -> U.PreArticulationCuePack`

with explicit withdrawal of route authority that no longer holds.

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:13.3 - Respecify without repair-pattern drift
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:13.4 - Retire an obsolete branch
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:14 - Authoring and Review Guidance

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:14.1 - Author prompt
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:14.2 - Review prompt
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:14.3 - Boundary reminder
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:15 - Migration Notes

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:15.1 - Migration from regression language
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:15.2 - Integration reminder
When retreat affects governing patterns such as [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], or [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], those governing patterns should be updated explicitly rather than left to drift on stale authority.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:16 - Retreat Package Discipline

A retreat is trustworthy only when it makes visible what changed, what survived, and what authority no longer holds.

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:16.1 - Minimal retreat note
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:16.2 - Retreat is not erasure
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:16.3 - Partial retreat
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:17 - Retained vs Withdrawn Authority

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:17.1 - Reopen
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:17.2 - Sketch-backoff
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:17.3 - Respecify
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:17.4 - Retire
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:18 - Worked Recovery Cases

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:18.1 - Reopening a routed evaluative note
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:18.2 - Sketch-backoff from prompt to cue pack
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:18.3 - Respecifying a route specification
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:18.4 - Retiring a route branch
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:19 - Review Matrix for Retreat Integrity
...
The matrix is intentionally small: [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] should keep retreat legible, not surround it with decorative procedure.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:20 - Required Downstream Repairs

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:20.1 - Stale downstream publication/work-target rule
A retreat or retirement often leaves stale downstream publications or work targets behind: prompts, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]-governed invitations, evaluative notes, requirement candidates, or work hooks that were admissible only under the prior state with higher closure state, route authority state, or endpoint authority claim. A conforming retreat should therefore name which downstream publications or work targets remain valid, which must be revised, and which must be withdrawn.

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:20.2 - Narrow retreat propagation
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:20.3 - Retreat timestamping and witness continuity
...
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:21 - Comparative Retreat Rule

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:21.1 - Retreat kinds are not interchangeable
...
### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:21.2 - Honest recovery over softening prose
A context may prefer softening language such as "refined further" or "adjusted slightly" even when a real retreat or retirement occurred. [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] rejects that habit. If authority fell, closure dropped, framing was withdrawn, or a branch was retired, the move should be named directly.

### [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:21.3 - Boundary to silent editing
If a publication is simply rewritten and no continuity or authority story is preserved, that is editing, not [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]. Retreat is a reviewable move only when the earlier high-closure form or form with endpoint authority claim remains part of the visible history.

## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:22 - Review Addendum for Retreat Integrity
...
These checks keep [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] tied to explicit recovery and retirement rather than narrative smoothing.
## [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]]:End
