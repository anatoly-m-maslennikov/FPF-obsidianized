...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:1 - Problem frame

* **Universal composition ([[B.1 - Universal Algebra of Aggregation (Γ)|B.1]])** provides Γ‑flavours for structure (**Γ\_sys**, **Γ\_epist**), order (**Γ\_ctx/Γ\_method**), and time (**Γ\_time**). These flavours preserve **WLNK** and **MONO** and—except for order/time cases—assume **local commutativity**.
* **Mereology ([[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]])** distinguishes **ComponentOf / ConstituentOf** (structure), **SerialStepOf / ParallelFactorOf** (order), and **PhaseOf** (temporal parts of the **same** carrier).
* **Strict Distinction ([[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]])** separates **structure**, **order**, **time**, **cost**, and **values**; we must not disguise emergence as arithmetic “optimism” or as a type error.
...
FPF does **not** force a metaphysical choice; it requires **clear declarations** so Γ‑proofs and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]‑assurance remain unambiguous.

## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:2 - Problem
...
2. **Identity drift:** A system changes boundary, objective, or supervisory structure, yet the model silently treats it as the “same holon,” corrupting histories (**Γ\_time**) and claims (**[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]**).
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:3 - Forces

| Force                                       | Tension                                                                                                                                                     |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Parsimony vs. Expressivity**              | Keep the core algebra small ([[A.11 - Ontological Parsimony (C‑5)|A.11]]) ↔ Admit real emergence when closure or supervision appears.                                                              |
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4 - Solution — **Part 1: What an MHT is, when to declare it, and how it relates to Γ**

### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.1 - Definition (normative)
...
After MHT, the Γ‑invariants apply **afresh** to `H⁺` and its parts. Prior assurance ([[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) remains valid for **pre‑MHT** claims; **post‑MHT** claims are assessed for `H⁺` under its own boundary, objective, and context.
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.2 - Triggers for declaring MHT (BOSC‑A‑T‑X)
...
* **A — Agency threshold crossing ([[A.13 - The Agential Role & Agency Spectrum|A.13]]).** The holon begins to **play AgentialRole** with an **agency grade** sufficient to maintain objectives autonomously; this lifts the system into a supervisory regime.
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.3 - Identity stance: 4D vs. 3D+1 (FPF’s ecumenical Standard)
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.4 - Event taxonomy for MHT (small, reusable set)
...
4. **Role‑Lift** — the holon starts **playing AgentialRole** at or above a declared grade threshold ([[A.13 - The Agential Role & Agency Spectrum|A.13]]), enabling supervision.
...
These are **Transformer events** ([[A.12 - External Transformer & Reflexive Split|A.12]]). They do **not** imply toolchains or storage; they are conceptual commitments with audit fields.

### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.5 - How MHT relates to Γ‑flavours and bounded contexts
...
* **With bounded contexts (DDD intuition):**
  ...
  * Use **Context Reframe** MHT to re‑anchor `H⁺` in the new context and declare the mappings; [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]’s congruence penalty `Φ(CL)` now refers to the **new** baseline.

### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:4.6 - What MHT is *not* (didactic contrasts)

* **Not a shortcut around WLNK/Φ.** If synergy is explainable by raising `CL` or improving parts, stay within Γ and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].
...
* **Not “agent = new type.”** Agency is **a role** ([[A.13 - The Agential Role & Agency Spectrum|A.13]]); MHT only when role enactment **changes closure/supervision** at the system level.

## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:5 - Promotion Record & proof obligations (normative)

To declare an MHT you MUST create a **Promotion Record** that makes identity, boundary, objective, supervision, and context shifts explicit. This record extends the general proof kit in **[[B.1.1 - Dependency Graph & Proofs|B.1.1]]**.

### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:5.1 - Promotion Record — minimal fields
...
MHT.PromotionRecord
  ...
  preConfig:
    ...
    edges:           list of relations & their types ([[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]), including CL on integration edges
    Γflavour:        active Γ-flavour(s) prior to MHT
    assurance:       Assurance tuples for relevant claims before MHT ([[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]])
  ...
  triggers:
    ...
    A?               Agency-CHR grade & context ([[A.13 - The Agential Role & Agency Spectrum|A.13]])
    T?               Γ\_time phase boundary details (coverage, carrier identity/continuation)
    X?               context mapping summary (old↔new)
  postHolon (H⁺):
    boundary:        explicit BIC or equivalent boundary statement ([[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]])
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:5.2 - Proof obligations specific to MHT
...
* **MHT‑ASS‑REBAS.** Provide **before/after** assurance tuples ([[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) for the same typed claim(s) or justify claim changes; do not fuse design-time and run-time scopes.
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6 - Archetypal cases (worked, didactic)

### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6.1 - System — **Closed‑loop regulation emerges from components** (Fusion / Role‑Lift)
...
* **After:** Γ‑invariants re‑start for `H⁺`. **[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]** assurance uses a new cutset; congruence on controller–plant mapping is part of `CL_min`.
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6.2 - Episteme — **From compendium to theory** (Fusion / ContextReframe)
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6.3 - Temporal — **Commissioning → Operations** (PhasePromotion)
...
### [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6.4 - Context — **Prototype → Certified product** (ContextReframe)
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:6.5 - Certification Interface Example *(Informative)*
...
**Sketch.** `snapshot` contains coordinates over the Role’s RCS ([[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]). `options` may reference named **NormalizationMethod(s)**/**NormalizationMethodInstance(s)** and overlays used in evaluation. The resulting **StateAssertion** states the target state (by name), the checklist applied (by name), the verdict, the window, and (if used) the **declared** **Bridge** or **NormalizationMethodInstance** employed for translation.
**Intent.** This example aids implementers; **normative constraints** on comparability, normalization, and evidence live in **[[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]** and **[[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]**, not here.

## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:7 - Conformance Checklist (normative)
...
| **CC‑B2.4** | Pre‑ and post‑assurance MUST be reported as **separate** tuples ([[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]).                                                          | No DesignRunTag chimeras or context chimeras.                 |
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:8 - Anti‑patterns & repairs
...
| **Agency as type**         | Introduce `U.Agent` and claim new identity              | Keep agency as role ([[A.13 - The Agential Role & Agency Spectrum|A.13]]); MHT only if supervision/closure changes the whole.      |
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:9 - Consequences
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:10 - Rationale (informative)

* **Systems & control:** Closing feedback creates **new closed‑loop properties** not attributable to parts alone; treating this as an MHT avoids “synergy by arithmetic” and aligns with classical supervisory control and contemporary active‑inference views ([[A.13 - The Agential Role & Agency Spectrum|A.13]]).
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:11 - Relations

* **Builds on:** [[A.12 - External Transformer & Reflexive Split|A.12]] (Transformer), [[A.13 - The Agential Role & Agency Spectrum|A.13]] (AgentialRole & Agency‑CHR), [[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (Mereology Extension), [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Strict Distinction); B.1.x (Γ flavours), [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] (Assurance).
* **Used by:** [[B.4 - Canonical Evolution Loop|B.4]] (Evolution Loops: MHT as macro‑steps on the loop), KD‑CAL action patterns (when re‑framing models/theories).
* **Complements:** [[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] (Γ\_ctx/Γ\_time) by distinguishing **order/phase** corrections from **emergence**; [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]].2/B.1.3 by restarting compositional invariants at the new level.
...
## [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]:End
