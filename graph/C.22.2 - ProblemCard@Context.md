...
builds_on:
  ...
  - "[[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]"
  - "[[C.2.P - Epistemic Precision Restoration|C.2.P]]"
  - "[[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]"
...
coordinates_with:
  ...
  - "[[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]]"
  - "[[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]]"
  - "[[C.22.1 - Task-family adaptation signature|C.22.1]]"
  - "[[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]]"
  ...
  - "[[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]"
...
**Builds on.** [[E.2 - The Eleven Pillars|E.2]], [[E.9 - Design‑Rationale Record (DRR) Method|E.9]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.29 - Mathematical Lens Use|C.29]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], and [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].

**Coordinates with.** [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[C.22.1 - Task-family adaptation signature|C.22.1]], [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[F.9 - Alignment & Bridge across Contexts|F.9]], and [[E.18 - Transformation Flow Structure|E.18]].

**Boundary summary.** [[C.22.2 - ProblemCard@Context|C.22.2]] use starts from messy problem-side signals and yields one reviewable `ProblemCard@Context`, a `P2W-ready` problem-side input for downstream [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]], or a stop with a governing-pattern cue for the claim being made, relation, or boundary outside the card.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:1 - Problem Frame
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:2 - Thin First Use and Output Kind

### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.1 - Thin First-Use Form
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.2 - Required Solution Moves

The [[C.22.2 - ProblemCard@Context|C.22.2]] Solution is organized around practitioner moves from signal to reviewable problem to one governed next move, not around schema completion.
...
6. Close by the honest next move rather than by a completed form. A filled card without a truthful next move is not a successful [[C.22.2 - ProblemCard@Context|C.22.2]] result.

Cheap-stop rule: the smallest card that gives a truthful next move is sufficient. A conforming [[C.22.2 - ProblemCard@Context|C.22.2]] use does not require heavier fields merely because the full field list exists.
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.3 - Relation Boundary Aid
...
|---|---|---|
| Characterization, measurement, indicator, Q-bundle, comparison, acceptance, or parity | Characterization cue, acceptance probe, candidate criterion, comparator cue or window cue, and the current reason the relation changes the next move. | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]], [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]], or [[G.9 - Parity and Benchmark Harness|G.9]] according to the relation named by value. |
| Archive, pool, front, shortlist, selected set, retained candidate, or set-return source | `setContextRef`, source-set kind, selection or retention criterion, budget or window when current, and non-scalar next move. | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], `A.6.P:7a`, or [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] according to the relation named by value. |
| Method family, work planning, performed work, result record, evidence, provenance, assurance, gate, or autonomy | Problem-side cue, source reference when it changes formulation, and stop condition before that outside use. | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] according to the claim named by value. |
| Temporal, causal-use, representation-transition, retargeting, bridge, structural-reinterpretation, or wording-use relation | Relation reference plus the inheritance boundary: what can be reused from the old card and what relation is reopened. | [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[E.18 - Transformation Flow Structure|E.18]], or [[E.10 - Unified Lexical Rules for FPF|E.10]] according to the relation named by value. |
| First-principles or mathematical structure cue | Candidate structure, preserved and lost structure when current, practical payoff for problem formulation, problem-formulation next-move reason, and stop condition. | [[C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use; [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] for a `FormalSubstrate` `U.Signature` declaration when that signature declaration is current. |
| Agentic safe probe or world-affecting next move | Probe need, risk condition, bounded next move, and the safety named by value, autonomy, gate, work, evidence, or assurance claim kind that blocks local action. | [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] according to the relation named by value. |
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.4 - Use Boundaries and Record Budgets

Use [[C.22.2 - ProblemCard@Context|C.22.2]] when a signal is not yet a problem-side record and downstream task typing, P2W, method-family selection, work planning, evidence use, gate passage, autonomy control, or selected-set use depends on such a record. A known method does not close this pattern when the problem signal, scope, acceptance probe, or EntityOfConcern remains unstable.

Use another pattern directly when the question under repair is already that pattern's `EntityOfConcern` or governed relation: [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for work planning or performed work; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence, provenance, or assurance; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gate decision; [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] for autonomy; [[C.11 - Decision Theory (Decsn-CAL)|C.11]] for a local choice among explicit options; and [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], or [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] for archive, pool, front, or selected-set governance. [[C.22.2 - ProblemCard@Context|C.22.2]] may still preserve the problem-side cue or reference that explains why that pattern is now current.
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.5 - Field Labels and Current-Use Conditions
...
- governing-pattern cue when a claim outside [[C.22.2 - ProblemCard@Context|C.22.2]] changes the problem-card move: governing pattern for that claim, relation, or boundary; claim kind named by value; project-side reference when known; and stop condition;

Field current-use conditions for [[C.22.2 - ProblemCard@Context|C.22.2]] are determined as follows:
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.6 - Anti-Pattern Checks and Worked Slices
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:2.7 - Conformance Checklist Requirements
...
| Check | Required test |
|---|---|
| Name and kind identity | The pattern output is `ProblemCard@Context`: a compact problem-side record shape under [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]; it is not a downstream selector record, work record, evidence record, gate record, or autonomy record. |
...
| Governing-pattern cue | Claims outside [[C.22.2 - ProblemCard@Context|C.22.2]] are recorded only as source cues or references when they change the card. The next move names the governing pattern and claim kind named by value for that use. |
...
| First-principles and mathematical cue payoff | A first-principles or mathematical cue states practical payoff, preserved and lost structure when current, problem-formulation next-move reason, and stop condition; [[C.29 - Mathematical Lens Use|C.29]] governs mathematical-lens use. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:3 - Problem-Kind Recovery
...
| FPF-governed use | Current FPF recovery | [[C.22.2 - ProblemCard@Context|C.22.2]] disposition |
|---|---|---|
...
| Framed problem representation | Problem-side representation of a selected EntityOfConcern under context and acceptance constraints | Center of `ProblemCard@Context`; representation-change claims apply [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], or [[E.18 - Transformation Flow Structure|E.18]] when current. |
...
| Selected problem from a set-return treatment | Selected set member or emitted problem-side record under a selection criterion | `ProblemCard@Context` may carry the selected problem, but selected-set semantics remain with [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], `A.6.P:7a`, and [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]. |
| Problem ready for selector-facing use | Problem-side record sufficient to emit or bind `TaskSignature` or `TaskKind` | [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] uses the typed selector reference; [[C.22.2 - ProblemCard@Context|C.22.2]] does not expand `TaskSignature` into a problem-card dump. |
...
| [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] pattern `Problem frame` | Practitioner-recognition section inside a pattern | Not the [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] problem-side representation. |
| [[E.9 - Design‑Rationale Record (DRR) Method|E.9]] DRR `Problem frame` | Decision-rationale section in a design-rationale record | Not the [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] problem-side representation. |

Local interpretation rule: `ProblemCard@Context` is the problem-side record shape before downstream typing or work. It may name candidate `ProblemProfile`, candidate `TaskSignature`, `setContextRef`, source cue, governing-pattern cue, or first-principles cue material only when those references change the problem-card move. It does not promote those references into local kinds or claims outside [[C.22.2 - ProblemCard@Context|C.22.2]].

## [[C.22.2 - ProblemCard@Context|C.22.2]]:4 - Problem, Task, Method, Work, and Result Split

`ProblemCard@Context` remains usable while the method is unknown, contested, not yet selected, or not yet specific enough for downstream work. A known method does not by itself make the problem ready: if the proposed method is known but the problem signal, scope, acceptance probe, or EntityOfConcern remains unstable, [[C.22.2 - ProblemCard@Context|C.22.2]] remains current. If both the problem representation and the method are already accepted and the remaining question is planned execution, apply [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]. The card may carry method-family cues and reasons for method search, but it does not present downstream work as already known task execution.

Use this split:

| Term or local name | Current FPF recovery | Local disposition |
|---|---|---|
| `Problem` | Problem-side representation of the selected EntityOfConcern under context | Center of [[C.22.2 - ProblemCard@Context|C.22.2]] only after problem-kind recovery. |
| ProblemCard@Context | Compact problem-side record before P2W | [[C.22.2 - ProblemCard@Context|C.22.2]]-governed record shape under [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]; stabilizes a problem-side representation under declared context. |
...
| `TaskKind` | Selector-facing task kind in [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] | Downstream typed selector reference; not a work-plan entry. |
| `TaskFamilyRef` | Reference to a family of task kinds or method-consumption classes | Used only when current [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] selector logic requires it. |
...
| Method-family selection claim | Comparison or selection among method families | Governing pattern [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]]; not a problem-card field. |
| `U.Method`, `U.MethodDescription` | Method and method description | Governing pattern family [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and related method-description anchors. |
| `U.WorkPlan`, `SlotFillingsPlanItem` | Planned work and work-plan entry | Governing pattern family [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]; not a [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] task signature. |
| `U.Work` | Performed work | Governing pattern family [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]; if the attempted claim is evidence, provenance, or assurance, use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for that relation. |
| Result record and result measurement | Evidence, provenance, measurement characterization, assurance, or refresh material according to the attempted claim | Use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], or [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] according to the claim kind being made. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:5 - Relation to [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:6 - Characterization, Indicators, and Comparability
...
- [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] carries measurement characterization, backing, and comparability discipline;
- [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] carries characteristic, scale, unit, polarity, and indicator-use discipline;
- [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] carries Q-bundles and quality-like multi-characteristic bundles;
- [[G.9 - Parity and Benchmark Harness|G.9]] carries parity, comparison-window, comparator, budget, unit, repeatability, and reproducibility pins;
- [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]] carries comparison-frame and CG-Spec governance;
- [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]] carries acceptance clauses and threshold predicates;
- [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] governs selected-set publication when the problem enters a selected set.
...
The [[C.22.2 - ProblemCard@Context|C.22.2]] candidate acceptance criterion separates functional check, constraint compliance, risk or safety boundary, parity or comparison relation, and freshness window when those relations are current. Comparison frame, CG-Spec, or comparability governance is governed by [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]]. Acceptance clauses and acceptance threshold predicates apply [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]]; [[C.22.2 - ProblemCard@Context|C.22.2]] may name only the needed relation, cue, or reference. Passing a test, improving one observed indicator value, or naming an acceptance phrase is not by itself sufficient for P2W use.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:7 - Source Record-Form Recovery

Source record names are recovered by use, not by label shape. This section prevents source prose from becoming local [[C.22.2 - ProblemCard@Context|C.22.2]] subobjects.

| Source form family | [[C.22.2 - ProblemCard@Context|C.22.2]] preservation | Governing pattern named by value for outside use |
|---|---|---|
| Problem card, problematization passport, problem-side note, or ordinary source signal | Carry the problem signal, context grounding, scope cut, improvement check or acceptance probe, and next move. | [[C.22.2 - ProblemCard@Context|C.22.2]] governs only the problem-side record shape; downstream selector-facing use remains with [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]. |
| Archive, portfolio, palette, front, shortlist, selected set, `LivePool`, set-return, or retained candidate | Preserve `setContextRef`, source-set kind, selection or retention criterion, budget or window when current, and non-scalar next move. | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], `A.6.P:7a`, and [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] according to the relation named by value. |
| Characterization passport, characteristic card, parity plan, comparison note, rule-of-choice card, or acceptance-looking row | Preserve the cue, candidate criterion, comparator cue or window cue, and current reason the relation changes formulation. | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]], [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]], [[G.9 - Parity and Benchmark Harness|G.9]], or [[C.11 - Decision Theory (Decsn-CAL)|C.11]] according to the relation named by value. |
| Evidence pack, provenance note, assurance row, gate log, autonomy budget, runbook, rollback plan, method selection, work plan, performed-work note, result record, or result measurement | Preserve only the problem-side cue, risk or validation boundary, source reference, and stop condition before that use. | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], or [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] according to the claim named by value. |
| Candidate solution, described system, ordinary log, budget, ledger, protocol, plan, pack, or factory wording | Recover the use under repair: problem-side source, selected-set material, work, evidence, gate, or autonomy material, or ordinary example. | Apply the governing pattern for the recovered relation; do not mint a local [[C.22.2 - ProblemCard@Context|C.22.2]] kind from the label. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:8 - Portfolio, Archive, and Set-Return Treatment
...
|---|---|---|
| Problem archive | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]] | Preserve source set or reference, retention criterion, candidate status, and provenance relation. |
| Problem portfolio | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] | Preserve selection or retention criterion, budget or window, review cadence, and selected-set or `LivePool` relation. |
| Palette | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] | Preserve candidate-family or option-set interpretation without turning it into evidence or approval. |
| Front | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] | Preserve declared characteristics and non-dominated set interpretation. |
| Shortlist | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], with [[G.9 - Parity and Benchmark Harness|G.9]] when comparison pins matter | Preserve selected-set criterion and downstream use. |
| Ranked shortlist | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] only when a declared order is declared | Preserve ranking criterion or narrow to selected set with tie notes. |
| Selected set | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] | Preserve selected-set output, selection pins, and unknown handling. |
| `LivePool` | [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] | Preserve pool policy, current treatment, and change trigger. |
| Set-return | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], declared comparison records | Preserve set-valued result when no total order is declared. |
...
When multiple plausible problem formulations remain current, [[C.22.2 - ProblemCard@Context|C.22.2]] does not bind one `TaskSignature` prematurely. Each optional `rivalProblemFormulationRef` states the rival formulation, EntityOfConcern, context, preserved concern, lost concern, reason not selected yet, and next discrimination move. It is not a `CG-Frame`, not the [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] `Problem Frame`, and not a representation-frame kind.
...
The current governing family is [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], `A.6.P:7a`, and [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]. The relation to `C.22:14` is a role and timing relation inside the same family: [[C.22.2 - ProblemCard@Context|C.22.2]] uses the family before P2W, while `C.22:14` uses it downstream when candidate solutions for a `TaskKind` make `TaskSignature` informative.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:10 - Structure Cue That Improves Formulation

[[C.29 - Mathematical Lens Use|C.29]] carries mathematical-lens use for first-principles or mathematical structure cues used by `ProblemCard@Context`.

`firstPrinciplesCue` is a local cue label for a formulation-changing structure and a cue to apply [[C.29 - Mathematical Lens Use|C.29]]; it is not a local mathematical-lens kind or a substitute for a [[C.29 - Mathematical Lens Use|C.29]] lens-use result.
...
| Source-side cue | Current FPF pattern or relation | [[C.22.2 - ProblemCard@Context|C.22.2]] use |
|---|---|---|
| Zero-principles and first-principles invariants, constraints, symmetry, composition, multi-scale description, variational structure, probability or information, and resource limits | [[C.29 - Mathematical Lens Use|C.29]], with [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], and [[G.9 - Parity and Benchmark Harness|G.9]] when characteristics, measurement characterization, quality bundles, or parity are current | Carry a first-principles or mathematical structure cue and apply the governing pattern for the claim being made, relation, or boundary. |
| Second-principles method-family implications | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[E.18 - Transformation Flow Structure|E.18]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] as applicable | Name the method-family cue; do not perform method selection in the problem card. |
| Third-principles reproducibility, checks, templates, records, logs, rollback, evidence | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]] as applicable | Name the reproducibility or evidence cue and apply the governing pattern for the claim kind named by value before relying on that claim. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:11 - Validation, Reliance, AI-Agent Cues, and Safe Probing
...
| Source, validation, or currentness is stale, conflicted, uncalibrated, or untied to the current relation. | Choose `abstainOrNoChange`, `refresh`, or `reopen`; name the missing relation, evidence-needed cue when current, and decision point. | Use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], or [[E.18 - Transformation Flow Structure|E.18]] according to the reopened relation. |
| The proposed next move can affect the world, spend resources, call tools, delegate to agents, change operational state, or make safety, release, gate, or work claims. | Block local use or name the governing relation; keep only the problem-side cue inside the card. | Apply [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] when the corresponding controlled-EntityOfConcern relation is current. |

Cause-theory cues may focus problem formulation inside `ProblemCard@Context`. Association, intervention, counterfactual, responsibility, expected-effect, or causal-evidence claims are governed by [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] plus evidence, provenance, or assurance patterns when those claims are being made.
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:12 - Freshness, Expiry, and Unknown Handling
...
| governing-pattern cue | A claim, relation, or boundary outside [[C.22.2 - ProblemCard@Context|C.22.2]] changes the current problem-card move; the card names the governing FPF pattern and claim kind named by value to use next without claiming that use inside [[C.22.2 - ProblemCard@Context|C.22.2]]. |
...
- refresh the problem card or its characterization or comparison relation under [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], or [[G.9 - Parity and Benchmark Harness|G.9]];
...
| Pattern or pattern family | When it matters for the card | [[C.22.2 - ProblemCard@Context|C.22.2]] use |
|---|---|---|
| [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] | Problem-side record, `ProblemProfile`, and `TaskSignature` are being related. | Keep `TaskSignature` minimal and apply representation-transition, bridge, retargeting, structural-reinterpretation, or wording-use patterns only when a current relation claim or use-boundary appears. |
| [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[G.9 - Parity and Benchmark Harness|G.9]], and [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] | Characterization, characteristic, Q-bundle, parity, or freshness representation changes the selected entity or comparison relation. | Preserve only the problem-card cue and apply the characterization, parity, bundle, or refresh relation named by value when that relation is being made. |
| [[C.29 - Mathematical Lens Use|C.29]] | A mathematical representation preserves, coarsens, or retargets the EntityOfConcern or the problem-side representation. | Use [[C.29 - Mathematical Lens Use|C.29]] output and representation or wording-use relation references when structure changes entity interpretation. |
| [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], and [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] | Archive, pool, front, shortlist, selected set, method-family, or selected-set output uses transformed representations. | Preserve source-set reference, criterion, and downstream use; keep selection semantics outside the card. |
| [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[E.18 - Transformation Flow Structure|E.18]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] | Source wording, quality wording, multi-view, bridge, structural reinterpretation, evidence, provenance, assurance, gate, autonomy, method, or work relation is current. | Keep the local cue only; apply the governing pattern for the claim being made, relation, or boundary before reusing readiness or relying on the transformed material. |

[[C.22.2 - ProblemCard@Context|C.22.2]] may not treat changed-problem examples as governed relations unless the appropriate accepted FPF relation is named.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:14 - Source and P2W Carry-Forward

The source presentation is not compressed into a generic problem-card summary. The following source details become carry-forward constraints for [[C.22.2 - ProblemCard@Context|C.22.2]] use and for the P2W-facing relation from [[C.22.2 - ProblemCard@Context|C.22.2]].

| Source detail | Current FPF recovery | [[C.22.2 - ProblemCard@Context|C.22.2]] carry-forward relation |
|---|---|---|
...
| Engineering language for reproducibility and management language for coordination, rights, resources, and responsibility | Verification and reproducibility, coordination, right, resource, and responsibility claims are different FPF relations | [[C.22.2 - ProblemCard@Context|C.22.2]] may name reproducibility, role, budget, right, or responsibility cue only as a field or relation reference; claims outside the problem-side record stay with their governing patterns. |
| Problem factory, solution factory, and factory-of-factories | Source exposition for three related work families, not FPF process kinds | [[C.22.2 - ProblemCard@Context|C.22.2]] covers only the problem-side output. Solution and P2W relations use [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[E.18 - Transformation Flow Structure|E.18]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], and [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]; organizational-development or platform-capability questions are outside this pattern. |
| Characterization protocol: context or slice, compared set, role or viewpoint characteristics, scale, polarity, measurement method, freshness, repeatability, budget, missing data, and comparison rules | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], and [[G.9 - Parity and Benchmark Harness|G.9]] governing patterns | `ProblemCard@Context` cites characterization and comparability relation when that relation is being made; it does not treat available measurement as an accepted indicator-use relation. |
| Indicator roles: mandatory constraints, optimization objectives for the current cycle, and risk signals | Characteristic and Q-bundle use under selected comparison or acceptance | [[C.22.2 - ProblemCard@Context|C.22.2]] preserves whether an indicator is a mandatory constraint, an optimization objective, or a monitored risk signal when that distinction affects acceptance. |
| Problem portfolio as period-bounded selected set with budget, role assignment, review cadence, and not-selected disposition | [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], `A.6.P:7a`, and [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] | `ProblemCard@Context` preserves source set or reference, selection or retention criterion, budget or window, review cadence, and not-selected or stepping-stone disposition when the set-source relation is current. |
| Goldilocks as zone-of-growth selection calibrated to current capability and context | Problem-side entry to current NQD, OEE, and set-return family | [[C.22.2 - ProblemCard@Context|C.22.2]] does not turn Goldilocks into one global difficulty scale or scalar readiness score. |
| Stepping stones as option value: new actions, tools, data, interfaces, environments, or experiment modes that may expand downstream search | Retained archive, front, or pool member, or selected-set reason | [[C.22.2 - ProblemCard@Context|C.22.2]] may record stepping-stone value only with a governing set-return, archive, or pool pattern and a retention or tie-break criterion. |
| P2W chain: signatures and principles help select formalism, ontology, characterization, and method-family material | [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.29 - Mathematical Lens Use|C.29]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[E.18 - Transformation Flow Structure|E.18]] | [[C.22.2 - ProblemCard@Context|C.22.2]] supplies problem-side cues and relation references; it does not select the formalism, ontology, mechanism, or method family by itself. |
| P2W chain: condition measurement and comparison help select a concrete method | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] | State the comparison-and-acceptance cue or acceptance-criterion reference and parity and characterization relations needed by downstream method selection. |
| P2W chain: work planning makes planned work inspectable | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.15.3 - SlotFillingsPlanItem|A.15.3]], and `SlotFillingsPlanItem` | [[C.22.2 - ProblemCard@Context|C.22.2]] may emit or bind `TaskSignature`, but planned work stays in work-planning patterns. |
| P2W chain: performed work produces work-result records | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] | [[C.22.2 - ProblemCard@Context|C.22.2]] does not treat performed work or result records as problem-card fields beyond problem-side cues or named relation references. |
| P2W chain: result measurement can trigger refresh or return to earlier source material | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], and [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] | [[C.22.2 - ProblemCard@Context|C.22.2]] states freshness or expiry and unknown-handling dispositions that let downstream result measurement refresh, retire, or re-open the problem-side record. |
| Runbook, rollback plan, canary, SafeStop, error budget, and override protocol | Work, gate, autonomy, evidence, and control records | These source forms are not [[C.22.2 - ProblemCard@Context|C.22.2]] subobjects; apply [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when the corresponding claim is current. |
...
This carry-forward preserves detail, not broader scope. [[C.22.2 - ProblemCard@Context|C.22.2]] remains the problem-side output; P2W uses it with enough source cues and project-side references to select method families, plans, performed work, and result measurement without making the problem card a P2W pattern.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:15 - SoTA Decision-Use Source Material
...
| First-principles or mathematical structure can improve formulation. | A named formalism or mathematical or ontological prestige is treated as adequacy or rigor. | Record the candidate structure, either its relation to the problem-side EntityOfConcern or the [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens-use relation, preserved and lost structure when current, practical formulation payoff, problem-formulation next-move reason, and stop condition. | Reopen when candidate structure, preserved or lost structure, problem-formulation next-move reason, stop condition, or [[C.29 - Mathematical Lens Use|C.29]] result changes. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:16 - Rationale
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:17 - Problem-Card Use Invariants
...
| Claims outside [[C.22.2 - ProblemCard@Context|C.22.2]] stay outside the card | Evidence, provenance, assurance, gate, autonomy, work, archive, selected-set, comparison, acceptance, representation, temporal, causal, and mathematical-lens claims remain with the pattern that governs each claim being made. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:18 - Misuse Modes and Repairs
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:19 - Use-Quality Checks
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:20 - Worked Slices and Anti-Cases

### [[C.22.2 - ProblemCard@Context|C.22.2]]:20.1 - Five-Case Worked Slices
...
| Musical mastery tempo drift | Practice tempo drifts away from the intended mastery band. | State the temporal claim, practice context, acceptance probe, and [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] relation when tempo, rhythm, recovery, or learning rate changes the next move. | A trend line is not an intervention model or evidence of mastery. |
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:20.1a - Compact P2W-ready Disposition Slice
...
| Exported governing-pattern cues | [[A.6 - Signature Stack & Boundary Discipline|A.6]] for policy or interface wording, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for role-method-work alignment, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence and currentness, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only if a gate claim later becomes current. |
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:20.2 - Anti-Cases
...
| A mathematical phrase is added because it sounds rigorous. | Use [[C.29 - Mathematical Lens Use|C.29]] only when the candidate structure, preserved and lost structure, payoff, next-move reason, and stop condition are recoverable. |
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:21 - Machine-Assisted Drafting Boundary

Machine-assisted `ProblemCard@Context` drafting is only a drafting aid. Before the draft is used for P2W or selector-facing work, a practitioner checks the card's local fields and any governing-pattern cues for claims outside [[C.22.2 - ProblemCard@Context|C.22.2]].
...
- governing-pattern cues for claims being made, relations, or boundaries outside [[C.22.2 - ProblemCard@Context|C.22.2]].

## [[C.22.2 - ProblemCard@Context|C.22.2]]:22 - First Practical Entry Aid

This section is a discoverability aid only. It helps a practitioner or assistant find a candidate pattern; it does not prescribe a transition sequence and does not require opening [[C.22.2 - ProblemCard@Context|C.22.2]] for every problem-sounding text.

These likely practitioner entry phrases point to [[C.22.2 - ProblemCard@Context|C.22.2]]:
...
Direct-entry cues that are not [[C.22.2 - ProblemCard@Context|C.22.2]]:

- accepted method or work planning: use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]];
- proof, provenance, reliability, or assurance claim: use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]];
- local choice among explicit options: use [[C.11 - Decision Theory (Decsn-CAL)|C.11]], or [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] when set publication or selected-set semantics are current;
- agent tool-call, gate, or autonomy claim: use [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; `ProblemCard@Context` may only name the problem-side cue or relation named by value;
- ordinary discussion with no downstream project-side move: no [[C.22.2 - ProblemCard@Context|C.22.2]] use.
...
The entry relation is local: [[C.22.2 - ProblemCard@Context|C.22.2]] is introduced under [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]], and [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] names the `ProblemCard@Context` relation. The [[C.22.2 - ProblemCard@Context|C.22.2]] body carries the Problem frame, first-entry phrases, tempting-wrong-pattern boundaries, and first-use Thin-card test needed for ordinary discovery.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:23 - Downstream Cue Export
...
For P2W carry-through, use [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] with the accepted problem-side material and the current relation named by the card. For selector-facing readiness and candidate `TaskSignature` relation, use [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]]. For selected-set or search cues, use [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] only when that relation is current. For work need, use the [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] family only after work planning, performed work, or work-relevant source restoration is current. For any other claim being made, apply the pattern that governs it; do not treat the whole card as carrying that claim.

## [[C.22.2 - ProblemCard@Context|C.22.2]]:24 - Consequences

### [[C.22.2 - ProblemCard@Context|C.22.2]]:24.1 - Benefits
...
- Current archive, pool, front, shortlist, set-return, parity, refresh, evidence, and [[C.29 - Mathematical Lens Use|C.29]] patterns are reused instead of duplicated.
...
### [[C.22.2 - ProblemCard@Context|C.22.2]]:24.2 - Costs of Use
...
## [[C.22.2 - ProblemCard@Context|C.22.2]]:25 - Relations

- Builds on: [[E.2 - The Eleven Pillars|E.2]], [[E.9 - Design‑Rationale Record (DRR) Method|E.9]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.29 - Mathematical Lens Use|C.29]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], and [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
- Coordinates with: [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[C.22.1 - Task-family adaptation signature|C.22.1]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.16 - RoC‑Autonomy Budget & Enforcement|E.16]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[E.18 - Transformation Flow Structure|E.18]], and [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]].

## [[C.22.2 - ProblemCard@Context|C.22.2]]:End
