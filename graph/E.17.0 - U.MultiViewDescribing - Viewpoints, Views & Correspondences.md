...
**Builds on:** [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.EpistemeSlotRelation` (EntityOfConcern, Viewpoint, and View slots), [[A.6.2 - U.EffectFreeEpistemicMorphing - Effect‑free morphisms of epistemes|A.6.2]] `U.EffectFreeEpistemicMorphing`, [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] `U.EpistemicViewing`, [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] `U.EpistemicRetargeting`, [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] (Strict Distinction; EntityOfConcern and Description-episteme boundary and specification-use gate versus publication-form and carrier lanes), [[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] (Context), [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary and specification use/refinement discipline).
**Used by:** [[E.17 - Multi‑View Publication Kit|E.17]] (MVPK — publication as a specialisation of multi‑view describing for morphisms), [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] `U.ViewpointBundleLibrary`, [[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]] `TEVB`, [[E.18 - Transformation Flow Structure|E.18]]:5.12 (transformation-flow viewpoint-family map), domain‑specific description schemes (architecture, safety cases, governance, research).
...
* `U.View` is an alias of `U.EpistemeView`, i.e. an **episteme-lane view**, not a document or file. Views are epistemes; `publication face/form` and `interop publication form` are publication-face/form discipline `publication-face kind` values; concrete renderings and carriers remain [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], SCR, and RSCR concerns.
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:1 - Problem frame  *(informative)*
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:2 - Problem  *(informative, but sharp)*
...
3. **Each domain reinvents multi‑view semantics.**
   ...
   * [[E.18 - Transformation Flow Structure|E.18]], MVPK, and discipline packs introduce their own “view” rules and invariants, duplicating work;
...
| **Slot discipline vs approachability** | [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] give a clean SlotKind, ValueKind, and RefKind discipline ↔ working users need to talk about “functional view” and “safety view” without carrying all slot jargon in didactic explanatory text. |
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4 - Solution — `U.MultiViewDescribing` as the universal multi‑view scaffold  *(normative core)*

### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.1 - Overview
...
* a `BoundedContextRef` ([[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]]) forming a **DescriptionScope** together with the entity.
...
### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2 - Core constructs

#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.1 - `EntityOfConcernClass` and DescriptionScope
...
#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.2 - `U.Viewpoint` (viewpoint specification)

`U.Viewpoint` is already introduced in [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] as the ValueKind of `ViewpointSlot`; [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] fixes its **internal structure** for describing families.
...
#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.3 - `U.View` (episteme-lane views)
...
* `EntityOfConcernSlot`,
* `ViewpointSlot`,
* `ReferenceSchemeSlot` (and usually a `RepresentationSchemeSlot` in [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]]+).
...
#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.4 - `U.CorrespondenceModel` (view–view correspondence)
...
`CorrespondenceModel` is **used, but not defined, by [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]**: species of `U.CorrespondenceEpistemicViewing` reference it when computing views that depend on multiple epistemes or representation regimes.

### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3 - Multi‑view families and their rules/invariants (MVD‑0…MVD‑7)  *(normative)*

We now fix the rules and invariants that any `U.MultiViewDescribing[EntityOfConcernClass]` instance must satisfy.

#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.0 - MVD‑0 - Family objects
...
#### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.1 - MVD-1 - Viewpoint locality and totality for Description-episteme and specification-use cases
...
1. **Viewpoint-totality for Description-episteme and specification-use cases.**
   ...
   * deterministically derived from a `U.ViewpointBundle` the family declares (see [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]).
...
### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.2 - MVD‑2 - Views are EpistemicViewing results
...
3. Views **do not introduce new EntityOfConcern commitments** about `T` beyond what is licensed by EFEM & EpistemicViewing invariants (no new atomic claims about the same EntityOfConcern). Upgrading the EntityOfConcern-side commitment requires a new Description episteme or Description episteme admitted for specification use under [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] and [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], not a view.

### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.3 - MVD‑3 - Applicability profiles for viewings
...
### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.4 - MVD‑4 - CorrespondenceModel for cross‑view correspondences
...
### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.5 - MVD‑5 - Separation from publication (MVPK)
...
* MVPK ([[E.17 - Multi‑View Publication Kit|E.17]]) sits **on top**:
...
MultiViewDescribing therefore **does not re‑define EntityOfConcern-to-Description or specification-use refinement** (`Describe_EoC_DescEp` plus `specificationUseRef` when a neighbouring gate grants specification force) and does not introduce any `U.Work` on carriers; [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] carries the describing boundary, [[A.6.2 - U.EffectFreeEpistemicMorphing - Effect‑free morphisms of epistemes|A.6.2]] and neighboring pattern governing the claiming gates carry specification-use refinement, and [[E.17 - Multi‑View Publication Kit|E.17]] carries publication.
...
### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.6 - MVD‑6 - EntityOfConcern and Description-episteme boundary and specification-use alignment

For any `U.MultiViewDescribing` instance:

1. Every `…Description` and `…Spec` episteme in the family must satisfy [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:
...
2. Viewings and correspondence operations **must not**:
   ...
   * reinterpret EntityOfConcern without going through [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] retargeting.

### [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.7 - MVD‑7 - Slot discipline

All constructs in this pattern **SHALL** respect `U.RelationSlotDiscipline`:

* SlotKinds (`EntityOfConcernSlot`, `ViewpointSlot`, `ViewSlot`, `GroundingHolonSlot`, `ClaimGraphSlot`, `ReferenceSchemeSlot`) and their ValueKinds/RefKinds follow [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] and [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]].
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:5 - Archetypal grounding  *(informative)*

1. **Engineering holon (TEVB).**
   * `EntityOfConcernClass = U.Holon` (restricted to `U.System`/`U.Episteme`).
   * TEVB ([[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]) supplies a viewpoint bundle with canonical engineering viewpoints: Functional, Structural, Role‑Enactor, Module‑Interface, etc.
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:6 - Conformance checklist (author’s quick use)  *(normative)*
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:7 - Consequences  *(informative)*
...
* **Slot-specific interoperability.**
  [[C.2 - Epistemic holon composition (KD-CAL)|C.2]].1/A.6.5 slot discipline applies uniformly; new domains can introduce viewpoint bundles and multi‑view families without inventing new ontologies for view positions or relation positions.

## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:8 - Rationale & SoTA‑echoing  *(informative)*
...
## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:9 - Relations  *(informative summary)*

* **Builds on [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.EpistemeSlotRelation`.**
...
* **Builds on [[A.6.2 - U.EffectFreeEpistemicMorphing - Effect‑free morphisms of epistemes|A.6.2]]–[[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].**
...
* **Constrains [[E.17 - Multi‑View Publication Kit|E.17]] (MVPK).**
...
* **Constrains [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] / [[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]].**
...
* **Coordinates with [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary and specification use) and [[E.10 - Unified Lexical Rules for FPF|E.10]] LEX‑BUNDLE.**
...
* **Coordinates with [[B.5 - Canonical Reasoning Cycle|B.5]].* / F‑cluster.**
  Viewpoints’ stakeholder families and concerns link naturally with RoleEnactment ([[B.5 - Canonical Reasoning Cycle|B.5]].\*) and Part F role descriptions, assignments, harnesses — without overloading `U.Role` as a slot value in EntityOfConcern and Description-episteme boundary and specification use or episteme slot relations.

## [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:End
