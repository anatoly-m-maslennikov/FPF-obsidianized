...
builds_on:
  ...
  - "[[E.7 - Archetypal Grounding Principle|E.7]]"
coordinates_with:
  ...
  - "[[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]"
...
**Builds on.**
`A.6.2-[[A.6 - Signature Stack & Boundary Discipline|A.6]].4` (episteme morphism classes), `A.6.5 U.RelationSlotDiscipline`, [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.7 - Archetypal Grounding Principle|E.7]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]], [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], `E.17.0 U.MultiViewDescribing`.

**Used by.**
[[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]] (TEVB engineering viewpoint bundles), `E.18:5.12`, and domain-specific viewpoint families for architecture, governance, safety, research, or assurance.

## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:1 - Problem frame
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:2 - Problem
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:3 - Forces
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4 - Solution - `U.ViewpointBundleLibrary`

[[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] introduces `U.ViewpointBundleLibrary` as the reusable catalogue `U.Episteme` for reusable viewpoint families. The library is an episteme-record species: it packages named bundles of `U.Viewpoint` values and related metadata, but it does not define new kernel episteme kinds, new publication forms, or new publication carriers. A published library is a `U.EpistemePublication`, publication unit, publication form, face, or carrier only through the usual [[E.17 - Multi‑View Publication Kit|E.17]] publication lane.

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4.1 - Core role
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4.2 - `U.ViewpointBundleLibrary` (catalogue episteme)
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4.3 - `U.ViewpointBundle` and `ViewFamilyId`
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4.4 - Import discipline into `U.MultiViewDescribing`
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:4.5 - Guard and naming discipline
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:5 - Archetypal Grounding
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:6 - Bias-Annotation
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:7 - Conformance Checklist
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| **Bundle equals view collection** | A folder or report pack is called a viewpoint bundle even though no `U.Viewpoint` family is declared. | [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] defines the bundle as a declared family of viewpoints, not a file grouping. |
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:9 - Consequences
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:10 - Rationale

`U.MultiViewDescribing` already assumes that viewpoint plurality exists. [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] supplies the governing pattern for that plurality, including cases where viewpoints are used to re-express positions in `U.LanguageStateSpace` or trajectories in `U.LanguageStateMoveTrajectory`. Without it, every domain can only improvise locally, and long-term correspondence between viewpoint families remains fragile.

## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:11 - SoTA-Echoing
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:12 - Relations
- **Builds on:** [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] slot discipline through `ViewpointSlot` / `ViewSlot`, `A.6.2-[[A.6 - Signature Stack & Boundary Discipline|A.6]].4`, [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.7 - Archetypal Grounding Principle|E.7]], and [[E.10 - Unified Lexical Rules for FPF|E.10]].
- **Constrains:** `E.17.0 U.MultiViewDescribing` whenever it imports viewpoint families from reusable bundles.
- **Coordinates with:** [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]], `E.18:5.12`, [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.9.1 - Bridge Stance Overlay|F.9.1]], and any domain-specific viewpoint family that needs stable reuse.
- **Protects:** lexical and ontological separation between viewpoint families, concrete views, and publication faces/forms.
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:12.1 - Typed annex manifests for thin bundles
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:13 - Bundle Anatomy and Member Discipline
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:13.1 - What a viewpoint member should make explicit
...
[[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] does not redefine the internals of `U.Viewpoint`. It states what must remain visible if a viewpoint is to be reused as part of a bundle rather than as an undocumented local label.

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:13.2 - Bundle-level coherence
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:13.3 - Thin bundles, rich annexes

[[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] intentionally allows bundles to stay thin. Rich companion material such as:
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:14 - Import, Subset, and Multi-Bundle Coordination
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:14.1 - Subset selection
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:14.2 - Local overlays vs new bundles

A local project often wants a small adaptation: one extra concern note, one narrower stakeholder emphasis, one local naming convention. [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] prefers explicit overlays or new editions over silent mutation.
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:14.3 - Multi-bundle coordination
...
In such cases, [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] expects the family to preserve the provenance of each member viewpoint rather than flattening everything into one unnamed `Sigma`. Cross-family correspondence should then cite both the participating viewpoint ids and their `ViewFamilyId` origins.

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:14.4 - Engineering vs publication families

Some contexts need both engineering viewpoints and publication viewpoints. [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] permits both, but it does not allow one family id to erase the distinction. A family that imports both kinds must keep the namespaces and bundle origins explicit so that authors do not confuse *how the holon is being understood* with *how a publication face/form chooses to expose that understanding*.

## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:15 - Worked Bundle Families

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:15.1 - TEVB engineering family
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:15.2 - Governance and risk family
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:15.3 - Research-method family
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:15.4 - Cross-family description stack

A serious project may use TEVB engineering viewpoints for the design family, a governance bundle for program oversight, and a publication-oriented family for public publication faces/forms. [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] keeps this stack admissible for review by preserving which bundle each viewpoint came from and by preventing the final publication face/form from masquerading as the viewpoint library itself.

## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:16 - Authoring and Review Guidance

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:16.1 - For bundle authors
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:16.2 - For reviewers
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:16.3 - For integrators and librarians
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:17 - Edition and Migration Notes

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:17.1 - Rename vs semantic change
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:17.2 - Migration from local `Sigma` lists
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:17.3 - Migration from publication-face/form-bound naming
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:17.4 - Boundary to annex growth
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:18 - Import Collision and Alias Discipline

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:18.1 - Family id is not a synonym bag
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:18.2 - Import collision rule
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:18.3 - Alias boundary
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:19 - Bundle Projection and Comparative Use

### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:19.1 - Projection to local subsets
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:19.2 - Comparative bundle use
...
### [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:19.3 - Boundary to publication-face design
A publication face may render one composite presentation of several viewpoints, but the face is not the bundle. [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] therefore requires the underlying member structure to remain recoverable even when a public-facing document flattens it for readability.

## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:20 - Review Matrix and Library Governance
...
## [[E.17.1 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]:End
