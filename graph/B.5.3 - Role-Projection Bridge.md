...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:1 - **Problem Frame**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:2 - **Problem**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:3 - **Forces**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:4 - **Solution**
...
### [[B.5.3 - Role-Projection Bridge|B.5.3]]:4.1 - The `Role` Concept
...
### [[B.5.3 - Role-Projection Bridge|B.5.3]]:4.2 - The `refinesType` Relation**
...
### [[B.5.3 - Role-Projection Bridge|B.5.3]]:4.3 - The `plays_role_of` Relation**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:5 - **Archetypal Grounding**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:6 - **Consequences**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:7 - **Rationale**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:8 - **Relations**
...
## [[B.5.3 - Role-Projection Bridge|B.5.3]]:End
