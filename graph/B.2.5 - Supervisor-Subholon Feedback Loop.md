...
> **Status:** Stable
> **Normativity:** Normative for FPF use that claims a supervisor-subholon feedback-loop relation.
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:1 - Problem frame
...
What goes wrong if [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] is missed: the supervised holon, supervisor transformer, shared medium, returned influence, and loop-closure condition remain unnamed; then layer labels, diagrams, publication channels, or supervisor words start carrying claims that belong elsewhere.

What [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] buys in practice: the practitioner can keep useful supervisor/subholon language while naming the acting role, medium, returned influence, and governing pattern for any stronger claim being made.
Not this pattern when the issue under repair is only a control-structure view, reusable dynamics law, rate/timing claim, causal intervention claim, evidence or assurance claim, gate decision, or module-interface relation. Use [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]/[[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]/[[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or [[A.6.M - Module Relation Repair|A.6.M]] as appropriate.
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:2 - Problem
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:3 - Forces
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:4 - Solution
...
**Control-structure view boundary.** When the loop appears in an architecture description as planner/controller/observer/plant/supervisor structure, use [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] to record the control-structure view. [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] supplies the supervisor-subholon relation; [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] records the broader control-structure view.

**Proof boundary.** A conforming [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] loop is a relation, not proof. Stability and reusable state-evolution claims use [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]; rate and timing claims use [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]; causal-use claims use [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]; evidence claims use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[G.6 - Evidence Graph & Provenance Ledger|G.6]]; assurance claims use [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; gate and constraint-validity claims use [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]/[[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; mathematical-lens transfer uses [[C.29 - Mathematical Lens Use|C.29]].
...
**Worked slice A - robotic swarm.** A drone fleet has individual drones, a shared communication medium, and a fleet-scope controller or distributed consensus method. [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] records each drone as supervised holon, the controller or consensus system as supervisor transformer, telemetry as observation side, and waypoint or mode commands as influence side. Claims about exponential convergence, delay tolerance, or disturbance damping use [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], and the evidence or assurance pattern governing the claim being made.

**Worked slice B - scientific theory.** A scientific theory is revised when labs publish findings and a research community reviews anomalies and accepted revisions. [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] records the theory or its constituent epistemes as supervised objects and the community/review practice as transformer-bearing supervisor. Journals, conferences, datasets, and review records are publication or interaction channels. The theory does not perform the sensing or judging; the acting systems and practices do.

**Worked slice C - product supervisor loop.** A product platform constrains component teams through published interface rules and release gates. [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] records the supervising platform policy role, component/subproduct holons, report channels, and constraint returns. Work authority uses [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]; gate passage uses [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; interface commitments use [[A.6.M - Module Relation Repair|A.6.M]].

## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:5 - Archetypal Grounding

| Archetype | Without [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] | With [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] |
|---|---|---|
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:6 - Bias-Annotation
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:7 - Conformance Checklist
...
| CC-B2.5-7 | If a control-structure view is being claimed, the control-structure-view claim is governed by [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]]. | Keeps relation-level feedback claims and view-level architecture claims aligned. |

## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Perfect communication | The loop assumes instant, complete, or lossless access to subholon state. | Add interaction/publication medium limits and assign timing or information claims to [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], or evidence claim. |
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:9 - Consequences
...
The cost is that [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] no longer lets a layered-control diagram establish stronger proof or project-reliance claims. That cost is intentional: the loop relation is useful because it tells the practitioner what to inspect next, not because it silently certifies stability, safety, evidence, or assurance.

## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:10 - Rationale
...
## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:11 - SoTA-Echoing
...
| Cyber-physical systems and feedback-control practice. | Shared medium limits, observation channels, actuation, delay, disturbance, and plant dynamics affect whether a loop is adequate. | Adopt: require loop closure and medium visibility; assign reusable dynamics claims to [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]. | If communication delay matters, it is not solved by the [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] label. |
...
| FPF architecture-description discipline under [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] and [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]]. | A supervisor loop can be one relation inside a control-structure view. | Reuse: [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] supplies relation recovery; [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] supplies view recovery. | Use the pattern that governs the claim kind being made, then add the related pattern only when a second claim being made is present. |

## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:12 - Relations

* Builds on [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]], [[A.1 - U.Holon, U.System, and U.Episteme|A.1]], [[A.2 - Role Taxonomy|A.2]], [[A.3 - Transformer Constitution (Quartet)|A.3]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[A.12 - External Transformer & Reflexive Split|A.12]], and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]].
* Coordinates with [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] for control-structure view adequacy.
* Applies [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for reusable dynamics or stability claims, [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal/rate adequacy, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use claims, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]/[[G.6 - Evidence Graph & Provenance Ledger|G.6]] for evidence claim, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]/[[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for constraint validity and gate decisions, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for work authority, and [[C.29 - Mathematical Lens Use|C.29]] for mathematical-lens transfer.

Neighboring claim governance: use [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] for control-structure view adequacy, [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for dynamics claims, [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal/rate adequacy, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use claims, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[G.6 - Evidence Graph & Provenance Ledger|G.6]] for evidence claims, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gate and constraint-validity records, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for work authority, [[A.6.M - Module Relation Repair|A.6.M]] for module-interface relation repair, and [[C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use.

## [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]]:End
