...
**Not this pattern when.** Not this pattern when the honest need is only one dated work occurrence ([[A.15.1 - U.Work|A.15.1]]), only planning or schedule baseline ([[A.15.2 - U.WorkPlan|A.15.2]]), only a cue note that has not yet become an enactment-alignment question ([[A.16 - Language-State Move Coordination|A.16]] or [[A.16.1 - U.PreArticulationCuePack|A.16.1]]), only boundary wording or policy wording without a role-method-work question under repair ([[A.6 - Signature Stack & Boundary Discipline|A.6]] or [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]), or work-relevant source restoration for an encountered source-looking carrier or display ([[A.15.4 - Work-Relevant Source Restoration|A.15.4]]).

**Related project records and governing patterns.** [[A.15.1 - U.Work|A.15.1]] governs dated execution records, [[A.15.2 - U.WorkPlan|A.15.2]] schedule or baseline planning records, [[A.15.3 - SlotFillingsPlanItem|A.15.3]] slot-filling plan items, [[A.15.4 - Work-Relevant Source Restoration|A.15.4]] work-relevant source restoration, [[B.5.1 - Explore → Shape → Evidence → Operate|B.5.1]] Explore -> Shape -> Evidence -> Operate for project progression, [[F.11 - Method Quartet Harmonisation|F.11]] method and work vocabulary alignment across contexts, and [[F.17 - Unified Term Sheet (UTS)|F.17]] the human-facing work sheet.
...
*   **[[A.4 - Temporal Duality & Open‑Ended Evolution Principle|A.4]] (Temporal Duality):** Provides the strict separation between `design-time` and `run-time`.
