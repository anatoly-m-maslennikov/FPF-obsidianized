...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:1 - Problem frame
[[B.5.2 - Abductive Loop|B.5.2]] needs an entry form that can accept lawful language-state trajectories after cue preservation and routing, without pretending that anomaly is the only admissible starting form.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:2 - Problem
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:4 - Solution
`U.AbductivePrompt` is a narrow supertype for the prompt forms that may admissibly seed [[B.5.2 - Abductive Loop|B.5.2]] after admissible cue preservation and governing-pattern selection under [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], and [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]. [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] is used only when the cue-to-prompt history itself has governance value as an explicit trajectory account. When rendered, a prompt uses ordinary MVPK faces; prompt status is a property of the publication form, not a rival face ontology.

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:4.1 - Starter canonical species and conditional extension species
...
#### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:4.1.1 - Specialization-sensitive prompt species
...
### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:4.2 - Core shape
...
A prompt is not yet a hypothesis. Prompt legality usually presupposes articulation high enough to publish a stable open question and closure low enough that rival answers remain live; those articulation and closure thresholds remain governed by [[C.2.4 - U.ArticulationExplicitness|C.2.4]] and [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], typically reached through cue or route provenance from [[A.16.1 - U.PreArticulationCuePack|A.16.1]] and [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]. It is the initiating publication form that licenses entry into the abductive loop.

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:4.3 - Boundary rule
`U.AbductivePrompt` is an entry form, not an excuse to let arbitrary prose count as abductive input. Only declared prompt species may enter [[B.5.2 - Abductive Loop|B.5.2]] through this form.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:5 - Archetypal Grounding
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:6 - Bias-Annotation
The pattern broadens the entry form to abduction, but still keeps it typed and auditable.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:7 - Conformance Checklist
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-1` Every `U.AbductivePrompt` **SHALL** declare its prompt species.
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-2` A prompt **SHALL NOT** be confused with a finished hypothesis.
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-3` Cue-derived prompts **SHOULD** preserve route provenance.
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-4` Prompt publication **SHALL** include the open question that makes abduction appropriate.
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-5` A publication that already fixes the answer or suppresses plausible rivals **SHALL NOT** remain in prompt status.
- `CC-[[B.5.2 - Abductive Loop|B.5.2]].0-6` When a specialization-sensitive prompt species is used, the prompt package **SHALL** make explicit the declared task family or utility target, the threshold or success condition being probed, the current budget window, and the route or cue provenance that made the prompt lawful.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:9 - Consequences
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:10 - Rationale
This keeps admissible cue preservation and trajectory publication able to dock into [[B.5.2 - Abductive Loop|B.5.2]] through a typed prompt form without anomaly inflation and without making [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] mandatory.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:11 - SoTA-Echoing
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:12 - Relations
- Builds on: [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[C.2.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]].
- Coordinates with: [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]], [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]], [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[B.5.2 - Abductive Loop|B.5.2]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[F.9.1 - Bridge Stance Overlay|F.9.1]].
- Constrains: lawful prompt entry into abduction.
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:13 - Worked Prompt Species

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:13.1 - Anomaly statement as canonical prompt
...
### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:13.2 - Opportunity-style prompt
...
### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:13.3 - Probe-style prompt
...
### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:13.4 - Specialization-sensitive prompt set
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:14 - Prompt package discipline

A prompt becomes reusable in [[B.5.2 - Abductive Loop|B.5.2]] only when its initiating question is explicit enough to remain stable across later hypothesis work.

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:14.1 - Minimal prompt package
...
### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:14.2 - Prompts are questions, not claims

A prompt may cue one explanation, but it remains a question-bearing entry form. If the text already asserts the answer, it has moved past prompt status and should be treated under [[B.5.2 - Abductive Loop|B.5.2]] or another governing pattern that carries the asserted answer.

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:14.3 - Prompt provenance remains load-bearing

Route provenance, cue provenance, and witness provenance are part of prompt legality, not optional history.

### [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:14.4 - Review prompt against silent promotion
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:15 - Species boundary reminders
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:16 - Handoff, deferral, and invalid drift

A prompt should enter [[B.5.2 - Abductive Loop|B.5.2]] only when the question is explicit enough that rival hypotheses can now be compared against it. If the question is still underspecified, the lawful continuation is further stabilization or routing, not premature abduction.
...
A common failure mode is drift from cue -> prompt -> hypothesis without anyone naming the boundary crossings. [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]] blocks that drift by keeping the prompt package distinct from both the earlier cue pack and the later prime hypothesis.

## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:17 - Scope, rival-set, and comparative-validity discipline
...
3. **Could rival hypotheses now be compared against this prompt?** If not, the prompt candidate probably needs more stabilization before entering [[B.5.2 - Abductive Loop|B.5.2]].
...
## [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]:End
