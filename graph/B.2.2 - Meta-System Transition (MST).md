...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:1 - **Problem Frame**

The universal pattern for emergence, **Meta-Holon Transition (MHT, Pattern [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]])**, describes how a collection of holons can become a new, coherent whole. This sub-pattern, `MST (Sys)`, details the specific case where the constituent parts are **physical or cyber-physical systems (`U.System`)**. This is the classic scenario of emergence in engineering and nature: a collection of robots forming a swarm, a group of servers becoming a self-healing cloud platform, or a set of components assembling into a functioning engine.
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:2 - **Problem**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:3 - **Forces**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:4 - **Solution**
...
### [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:4.1 - The B-O-S-C Triggers for Systems
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:5 - **Archetypal Grounding**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:6 - **Conformance Checklist**

*   **CC-B2.2.1 (Trigger Mandate):** An `emergesAs` relation for a set of `U.System`s **MUST** be justified by a **Promotion Record** (Pattern [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]) that provides evidence for all four B-O-S-C triggers.
...
*   **CC-B2.2.3 (Supervisor Mandate):** The emergent meta-system **MUST** contain an identifiable **supervisory component** or mechanism that implements the feedback loop. The architecture of this loop is further detailed in Pattern [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]].
*   **CC-B2.2.4 (Boundary Inheritance):** The boundary of the new meta-system **MUST** be formally derived from the boundaries of its constituent systems, following a declared **Boundary-Inheritance Standard** (Pattern [[B.2.3 - Meta-Epistemic Transition (MET)|B.2.3]], forthcoming).

## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:7 - **Common Anti-Patterns and How to Avoid Them**
...
| **The "Hidden God-Controller"** | A system appears to be a self-organizing swarm, but its behavior is actually dictated by a hidden, external, centralized controller that is not part of the model. | The FPF's **Transformer Principle ([[A.12 - External Transformer & Reflexive Split|A.12]])** and **Boundary rules ([[A.1 - U.Holon, U.System, and U.Episteme|A.1]])** require that all external influences are made explicit. The controller must either be modeled as part of the meta-system (and thus inside its new boundary) or as an external `Transformer`. |

## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:8 - **Consequences**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:9 - **Rationale**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:10 - **Relations**
...
## [[B.2.2 - Meta-System Transition (MST)|B.2.2]]:End
