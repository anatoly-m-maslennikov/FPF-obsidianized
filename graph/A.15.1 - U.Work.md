...
3. Decide whether the encountered record, trace, or source-looking carrier is performed `U.Work`, only a plan ([[A.15.2 - U.WorkPlan|A.15.2]]), only a method ([[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]), only a method description ([[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), only evidence for work ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]), only a publication-use relation ([[E.17 - Multi‑View Publication Kit|E.17]]), only a declarative representation ([[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] or the direct representation pattern), or a work-relevant source-restoration case ([[A.15.4 - Work-Relevant Source Restoration|A.15.4]]).
...
**Not this pattern when.** Not this pattern when the current claim is only a method ([[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]), only a method description ([[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), only a plan or schedule ([[A.15.2 - U.WorkPlan|A.15.2]]), only a `SlotFillingsPlanItem` ([[A.15.3 - SlotFillingsPlanItem|A.15.3]]), only a visible source cue that must be restored before reliance ([[A.15.4 - Work-Relevant Source Restoration|A.15.4]]), only evidence or assurance ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), only publication-use behavior ([[E.17 - Multi‑View Publication Kit|E.17]]), or only a declarative representation overread as a work-control or method claim ([[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] or the direct representation pattern).

## [[A.15.1 - U.Work|A.15.1]]:1 - Problem Frame
...
## [[A.15.1 - U.Work|A.15.1]]:2 - Problem (what breaks without a clean notion of Work)
...
## [[A.15.1 - U.Work|A.15.1]]:3 - Forces (what the definition must balance)
...
## [[A.15.1 - U.Work|A.15.1]]:4 - Solution — define `U.Work` as the accountable, dated occurrence

### [[A.15.1 - U.Work|A.15.1]]:4.1 - Definition
...
### [[A.15.1 - U.Work|A.15.1]]:4.2 - Core reference descriptors (conceptual descriptors; not a data schema)
...
9. **Context** — the bounded context under which this run is judged, normally inherited from the method-description source and `U.RoleAssignment`; see [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for cross-checks.
...
12. **Evidence and telemetry (optional)** — if the run feeds **[[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]** refresh or QD and OEE archives, cite **PathId** or **PathSliceId** and the current declared **policy-id** used for illumination; do not elevate telemetry into dominance without CAL policy.

### [[A.15.1 - U.Work|A.15.1]]:4.3 - Clear distinctions (the four‑slot grammar in action)
...
### [[A.15.1 - U.Work|A.15.1]]:4.4 - Publication-use boundary for `U.Work`
...
### [[A.15.1 - U.Work|A.15.1]]:4.5 - Crossing visibility for work publications
...
## [[A.15.1 - U.Work|A.15.1]]:5 - Work mereology (how runs form holarchies)
...
### [[A.15.1 - U.Work|A.15.1]]:5.1 - Parts and wholes of Work (design‑neutral, run‑time facts)
...
### [[A.15.1 - U.Work|A.15.1]]:5.2 - Key relations among Work
...
### [[A.15.1 - U.Work|A.15.1]]:5.3 - Operators for roll‑ups (Γ\_time and Γ\_work)
...
### [[A.15.1 - U.Work|A.15.1]]:5.4 - Identity of a Work (extensional criterion, pragmatically framed)
...
### [[A.15.1 - U.Work|A.15.1]]:5.5 - Interruptions, retries, resumptions (episode policy)
...
### [[A.15.1 - U.Work|A.15.1]]:5.6 - Compositionality of effects (Δ)
...
## [[A.15.1 - U.Work|A.15.1]]:6 - Archetypal grounding (parallel domains)

### [[A.15.1 - U.Work|A.15.1]]:6.1 - Surgical case (overlap and episodes)
...
### [[A.15.1 - U.Work|A.15.1]]:6.2 - ETL pipeline (parallelism and retries)
...
### [[A.15.1 - U.Work|A.15.1]]:6.3 - Thermodynamic cycle (work as a state-space path)
...
## [[A.15.1 - U.Work|A.15.1]]:7 - Bias‑Annotation (as in E‑cluster)
...
* **Rationale:** Gives FPF a clean, actionable notion of **occurrence** compatible with `U.RoleAssignment` and **Role Enactment** ([[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]]; [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]) and with 4D extensional thinking, so that costing, quality, and audit rest on **runs**, not on plans or recipes.

## [[A.15.1 - U.Work|A.15.1]]:8 - Conformance Checklist (normative)
...
**CC-A15.1-29 (Telemetry-reference pins, when applicable).** If a Work instance feeds **[[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]** or QD and OEE portfolios, it **SHALL** cite `PathId` or `PathSliceId` and the current declared **policy-id** in its evidence; illumination remains **report-only telemetry** unless CAL explicitly promotes it.

## [[A.15.1 - U.Work|A.15.1]]:9 - Temporal & Aggregation Semantics (normative operators & invariants)

### [[A.15.1 - U.Work|A.15.1]]:9.1 - Temporal coverage `Γ_time`
...
### [[A.15.1 - U.Work|A.15.1]]:9.2 - Resource aggregation `Γ_work`
...
## [[A.15.1 - U.Work|A.15.1]]:10 - Cross-Context Checks (MethodDescription, RoleAssignment, and Work)
...
## [[A.15.1 - U.Work|A.15.1]]:11 - Anti‑patterns (and the right move)
...
## [[A.15.1 - U.Work|A.15.1]]:12 - Legacy work-log repair moves
...
## [[A.15.1 - U.Work|A.15.1]]:13 - Consequences
...
## [[A.15.1 - U.Work|A.15.1]]:13a - SoTA Alignment
...
## [[A.15.1 - U.Work|A.15.1]]:14 - Relations

* **Builds on:** [[A.1 - U.Holon, U.System, and U.Episteme|A.1]] Holonic Foundation; [[A.1.1 - U.BoundedContext Semantic Frame|A.1.1]] `U.BoundedContext`; **U.System**; [[A.2 - Role Taxonomy|A.2]] `U.Role`; [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`; [[A.2.2 - U.Capability|A.2.2]] `U.Capability`; [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]] `U.Method`; [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] `U.MethodDescription`.
* **Coordinates with:** [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role-Method-Work Alignment (the "four-slot grammar"); [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]] Γ (aggregation) for resource and time operators; E-cluster lexical rules (L-PROC and L-FUNC).
...
## [[A.15.1 - U.Work|A.15.1]]:15 - Didactic quick cards
...
## [[A.15.1 - U.Work|A.15.1]]:15a - P2W Performed-Work Use Relation

When [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] reaches performed work, `U.Work` states the dated occurrence: performer, method-description source, parameters, resources, time window, pre-state, post-state, outputs, outcome, and audit trace.
...
## [[A.15.1 - U.Work|A.15.1]]:16 - Lowering, Repair, and Refresh Conditions
