...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:1 - Problem frame
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:2 - Problem
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:3 - Forces
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:4 - Solution — Principle‑Taxonomy‑Guided Bias Audit

1. **Bias‑Lens set**
   Every normative pattern is assessed through **five lenses** that match the
   Principle classes from **[[E.3 - Principle Taxonomy & Precedence Model|E.3]]**:
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:5 - Archetypal Grounding (System / Episteme)
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:6 - Conformance Checklist
...
| **CC‑BA.4 (QD‑triad evidence for “universal”).** | Any pattern that labels itself **“universal”** SHALL cite **[[A.8 - Universal Core Principle (C‑1)|A.8]] CC‑UC 1 + CC‑UC 2** and attach the **QD evidence** (Diversity_P + IlluminationSummary, with edition and binning) or else **scope** the claim to its declared `U.BoundedContext`. | preserves domain quality diversity |

## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:7 - Consequences
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:8 - Rationale
...
## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:9 - Relations
* **Parent umbrella:** `pat:constitution/guard‑rails` ([[E.5 - Four Guard‑Rails of FPF|E.5]])
* **Depends on:** `pat:constitution/principle‑taxonomy` ([[E.3 - Principle Taxonomy & Precedence Model|E.3]])
* **Constrains:** All normative patterns claiming universality

## [[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]:End
