...
builds_on:
  ...
  - "[[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]]"
  - "[[C.26.2 - Enacted Distributed State Evidence|C.26.2]]"
  - "[[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]]"
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:1 - Problem frame
...
| Best | Apply [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] to ordinary metric issues and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] to release assurance. Retain [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] only for the residual false passive-read issue: dashboard publication changed readiness behavior in window W. Decision diff: do not use the dashboard as sole release evidence; add independent work traces and record non-admissible use. |
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:2 - Problem
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:3 - Forces

| Force | Tension |
| --- | --- |
| Ordinary FPF patterns first | [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], and [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] already do real work. QL wording must add only the remaining state, probe, or export cue. |
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:4 - Solution
...
5. Emit one practical result: use ordinary pattern only, add QL-lite note, select one [[C.26 - Quantum-Like Modeling Lens|C.26]] child pattern as the applicable pattern body, add evidence and assurance, or drop the QL wording.
...
[[C.26 - Quantum-Like Modeling Lens|C.26]] ordinary output: produce one of these, then stop or select the neighboring applicable pattern body:

- no [[C.26 - Quantum-Like Modeling Lens|C.26]] pattern selection because the ordinary FPF pattern carries the case;
...
| Assurance or audit reader | Full evidence record with [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] integration. |
...
| "Everything with feedback is QL." | Apply [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], or [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] first to ordinary feedback, control, and metric-gaming cases. |
...
Pattern-local-note dependency rule: when an existing FPF pattern cites [[C.26 - Quantum-Like Modeling Lens|C.26]] or a `C.26.*` child, the pattern's ordinary action guidance and conformance text remain primary. The citation means only: if a residual QL cue remains after the ordinary FPF pattern has carried its part, use this lens for that residue. It does not make every citing-pattern case depend on the full [[C.26 - Quantum-Like Modeling Lens|C.26]] record or on every child-pattern semantic.

QL boundary selection:

| Gate question | Applicable FPF pattern |
| --- | --- |
| Is this ordinary boundary, interface, API, or protocol ambiguity? | [[A.6 - Signature Stack & Boundary Discipline|A.6]] and boundary/interface patterns. |
| Is this ordinary bridge, export, substitution, or loss across contexts? | [[F.9 - Alignment & Bridge across Contexts|F.9]] / [[F.9.1 - Bridge Stance Overlay|F.9.1]]. |
| Is this ordinary measurement, metric gaming, scale, coordinate, or noise? | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]. |
| Is this ordinary evidence, provenance, method, or carrier issue? | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and, when assurance-bearing, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. |
| Is this ordinary work, routine, incentive, alignment, or authority issue? | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and neighboring work/authority patterns. |
| Is this ordinary quality-bundle, viability, feedback, or dynamics tuning? | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], `U.Dynamics`, and measurement or work patterns. |
| Is this ordinary representation-scheme transition or controlled coarsening? | [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], and ordinary representation patterns. |
| Does residual false passive read, false shared frame, false faithful export, unsupported state reading, or QL-specific coarsening remain? | Use [[C.26 - Quantum-Like Modeling Lens|C.26]] or the relevant `C.26.*` child with the minimum sufficient field set. |
...
```text
Ordinary patterns: [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] + [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]].
...
Use the [[C.11 - Decision Theory (Decsn-CAL)|C.11]] mini-output discipline across the cluster: finish with one next move, not with an interesting label.
...
Retire QL when the residual cue disappears. If [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], or another ordinary FPF pattern now carries the claim without a false passive read, false shared frame, false faithful export, unsupported distributed-state reading, or QL-specific coarsening residue, remove QL wording from the active working note or pattern prose.

Use the lens only after the activation test survives both sides. QL remains active only when the ordinary FPF pattern cannot admissibly treat the output as a passive read, a shared-frame comparison, a faithful-enough export, or a use-scope-preserving state representation. Bridge loss, feedback, coupling, openness, compression, and coarsening are not QL cues unless they change the admissible state, probe, frame, or export reading for the current use. [[C.26 - Quantum-Like Modeling Lens|C.26]] carries the full negative activation catalog; child and citing patterns should repeat only the local non-trigger that is frequent enough to matter for that pattern.
...
### [[C.26 - Quantum-Like Modeling Lens|C.26]]:4.1 - Inherited QL boundary
...
redirect the claim/question to [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] before retaining QL-lite or QL-NQ.
```
...
What this does not authorize: [[C.26 - Quantum-Like Modeling Lens|C.26]] does not become a causal-use pattern and does not treat counterfactual material as a quantum-like subcase; it keeps quantum-like modeling discipline and sends causal-use support to [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]].
...
1. Measurement, metric, scale, method, evidence, or assurance load goes first to measurement and evidence patterns: [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].
2. Bridge, translation, publication, rendering, or exported-loss question goes first to bridge and publication patterns: [[F.9 - Alignment & Bridge across Contexts|F.9]], [[E.17 - Multi‑View Publication Kit|E.17]], or [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]].
3. Causal intervention, command, work enactment, role alignment, or routine question goes first to work and authority patterns: [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and the relevant neighboring pattern.
4. Boundary/interface wording, service-interface typing, bridge endpoint, relation precision, or lexeme-collision question goes first to boundary and language patterns: [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.10 - Unified Lexical Rules for FPF|E.10]], or [[F.18 - Local‑First Unification Naming Protocol|F.18]].
5. Quality, viability, feedback, or control-tuning question goes first to quality, dynamics, and measurement patterns: [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], `U.Dynamics`, and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]].
6. Suspect option menu, unknown alternative, local plateau, basin movement, or candidate-generation question goes first to search and regime patterns: [[B.5.2 - Abductive Loop|B.5.2]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], or [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]].
7. Retain QL only for the remaining declared state, probe, export, frame, open-information-system, or coarsening cue.

[[C.26 - Quantum-Like Modeling Lens|C.26]] does not choose among options, generate missing alternatives, or settle [[C.11 - Decision Theory (Decsn-CAL)|C.11]] decision quality. It can mark that the available readings sit in non-shared comparison frames or lack a declared admissible joint comparison route; the choice/search output still belongs to [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[B.5.2 - Abductive Loop|B.5.2]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], or [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]].

| If the question under repair is mainly... | First FPF pattern | Add QL only when... |
| --- | --- | --- |
| Choice, comparison, or question order | [[C.11 - Decision Theory (Decsn-CAL)|C.11]] | incompatible probes, order effects, non-shared comparison frames, or no declared admissible joint comparison route change the choice-state reading. |
| Boundary interaction or interface reading | [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] | the probe or interaction changes the represented state, export validity, or viability decision. |
| Cross-context bridge or publication export | [[F.9 - Alignment & Bridge across Contexts|F.9]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] | the exported state is not faithful under the current probe and bridge conditions. |
| Work enactment or coordinated behavior | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], with [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] / [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence | coordinated work evidences a low-recoverability distributed-state reading not faithfully exportable as one representation. |
| Measurement, metric, score, or dashboard | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] | the measurement regime, publication act, or operational use functions as a probe interaction that updates the represented state. |
| Viability or quality bundle | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], `U.Dynamics`, [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] | envelope regulation depends on probe, boundary condition, actuator, export, or coarsened state representation. |
| Candidate generation or option-menu suspicion | [[B.5.2 - Abductive Loop|B.5.2]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] | QL wording only marks that the current frame may be suspect; search patterns generate alternatives. |
...
### [[C.26 - Quantum-Like Modeling Lens|C.26]]:4.3 - Escalation by evidence or authority demand
...
| --- | --- | --- |
| Classical Bayesian, nonparametric Bayesian, or ordinary probabilistic update | [[C.11 - Decision Theory (Decsn-CAL)|C.11]], measurement and evidence patterns, and model-expansion patterns | incompatible sample spaces, contextual probability, order-sensitive query structure, or failure of ordinary total-probability composition remains active. |
| Causal intervention or ordinary world-state change model | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], boundary patterns, and evidence patterns | the intervention is also being used as a read, export, comparison, or optimization of the state it changes. |
| Performative prediction, strategic response, or dashboard-induced behavior | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]], and viability/work patterns | instrument-like state update, incompatible probes, or non-faithful state export remains after the ordinary behavior account is written. |
| POMDP, active sensing, active inference, or experimental design | [[A.3 - Transformer Constitution (Quartet)|A.3]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], `U.Dynamics`, and action-cost patterns | the formal claim also involves incompatible probe frames, contextual probability, or state-representation loss. |
| State abstraction, representation learning, surrogate modeling, sketching, or ordinary compression | [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[F.9 - Alignment & Bridge across Contexts|F.9]], and ordinary representation patterns | the shortcut depends on contextual, instrument-like, open-information-system update/probe/export-admissibility, or incompatible-probe structure rather than ordinary abstraction engineering. |
...
Most [[C.26 - Quantum-Like Modeling Lens|C.26]] use should stay at M0 or M1.
...
| `QLP-3` assurance or reusable guidance use | The claim is used for assurance, audit, durable pattern action guidance or conformance text, reusable relation/name/measure, or high-stakes decision support. | `QLP-2` content plus [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance result, [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] template if measured, documented bridge and loss path, source-support role, and explicit local stop or inherited-boundary note. |

### [[C.26 - Quantum-Like Modeling Lens|C.26]]:4.4 - Recognition case matrix

| Case | First applicable pattern body | QL cue to test | Local stop |
| --- | --- | --- | --- |
| Domain workshop changes the split | [[A.1.1 - U.BoundedContext Semantic Frame|A.1.1]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] | The workshop is both evidence and intervention; question order or facilitation frame changes split recommendation, team alignment, and local meaning. | Do not replace DDD with QL; keep bounded-context law and bridge fields active. |
| Same label across bounded contexts | [[F.9 - Alignment & Bridge across Contexts|F.9]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] | API extraction or team alignment changes operational state, or export loses the relation that matters. | Same label is not same entity; ordinary bridge may be enough. |
| Organization acts from a latent decision | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] | Coordinated role-work, records, commitments, traces, and routines evidence a low-recoverability state no participant faithfully reports. | Do not infer a group mind or timeless culture. |
| Survey, dashboard, policy, or API read of culture | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]], [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] | The probe may change the state it evidences, and the export may lose load-bearing structure. | Treat the output as carrier/probe, not as the state itself. |
| Service boundary under load | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] | Viability depends on changing caching, throttling, routing, staffing, protocol, bridge, or context split. | Do not reduce viability to one green metric. |
...
| Glass memory / hysteresis | [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]], [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]], `U.Dynamics` | Prior state constrains current response; state history or retained trace changes admissible reading. | Do not force dynamics variables unless load-bearing. |
...
| Suspect option menu | [[B.5.2 - Abductive Loop|B.5.2]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] | Current options may be products of the current measurement frame. | QL only marks suspicion; search patterns generate alternatives. |

### [[C.26 - Quantum-Like Modeling Lens|C.26]]:4.5 - State-representation coarsening card
...
[[C.26 - Quantum-Like Modeling Lens|C.26]] does not carry ordinary coarsening. [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] carries controlled coarsened rendering; [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] carries same-selected-entity representation-scheme transition; [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], `U.Dynamics`, modeling patterns, and ordinary abstraction patterns carry ordinary state abstraction. [[C.26 - Quantum-Like Modeling Lens|C.26]] carries only the residual QL cue plus the loss/use boundary for this shortcut.

Question-to-pattern map:

| Main question | First FPF pattern or relation |
| --- | --- |
| Coarsened rendering of source episteme or source publication for narrower use | [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] |
| Same-selected-entity representation-scheme or reasoning-medium transition | [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] |
| Cross-context equivalence, substitution, projection, export, or loss | [[F.9 - Alignment & Bridge across Contexts|F.9]] / [[F.9.1 - Bridge Stance Overlay|F.9.1]] |
| Measurement coordinate, scale, score, result, or dashboard reading | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] |
| Evidence carrier, provenance, method, support, or time window | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] |
| Assurance claim, release support, audit, readiness, or compliance use | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] |
| Search-space pruning, option generation, or missing alternatives | [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] |
| Residual QL state, probe, frame, export, or coarsening cue after those patterns act | [[C.26 - Quantum-Like Modeling Lens|C.26]] |
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:5 - Archetypal Grounding
...
Show, Episteme side: the QL-lite card says the ordinary FPF patterns are [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], and [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]. The QL cue is an instrument-like metric publication that changes readiness behavior. The minimal admissible output is "treat the dashboard as probe-coupled evidence, not release proof." The local stop is release approval without fuller evidence.
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:6 - Bias-Annotation
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:7 - Conformance Checklist
...
| Passive dashboard | A metric or score is used as a neutral fact after its publication or operational use changed behavior. | Use measurement and evidence patterns and, if needed, [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]]. |
| Faithful-copy export | A survey, report, API response, or context map is treated as the live state itself. | Use bridge/export loss, [[C.26.2 - Enacted Distributed State Evidence|C.26.2]], or ordinary publication patterns. |
...
| Compression | [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], modeling, or implementation pattern first; QL only for state-representation residue. |
| DDD bounded context | [[A.6 - Signature Stack & Boundary Discipline|A.6]] / [[F.9 - Alignment & Bridge across Contexts|F.9]] first; QL only if workshop, probe, or export changes state reading. |
| Low-bit or quantized implementation | Engineering representation first; not QL because it is "quantized". |
| Collective behavior | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], distributed cognition, routines, and evidence patterns first; QL only for low-recoverability state-reading residue. |

### [[C.26 - Quantum-Like Modeling Lens|C.26]]:8.1 - Cluster conformance scenarios

Use these as quick applicability tests. A good [[C.26 - Quantum-Like Modeling Lens|C.26]] use leaves one practical output, not just a clever label.

| Scenario | Expected route | Avoid | Expected output |
| --- | --- | --- | --- |
| Dashboard readiness improves because teams optimize the displayed metric. | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] / [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] first; [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] only if the output is reused as a passive readiness read after state-shaping publication. | Treating the dashboard value as release evidence by itself. | Redesign metric publication or add independent work traces before release use. |
| Workshop "discovers" a boundary but also creates alignment and local meaning. | [[A.6 - Signature Stack & Boundary Discipline|A.6]] / [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] first; [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] for false pre-probe discovery reading. | Exporting the workshop result as a timeless domain fact. | Record window, participants, carriers, unresolved rivals, and bridge/export limits. |
| API read warms cache and changes downstream timing. | Interface semantics, [[A.6 - Signature Stack & Boundary Discipline|A.6]], and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] first; [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] if the read result is reused as passive state export. | Saying the API read simply copied state. | Mark the read as non-neutral for that timing window or redesign the read path. |
| Two service health reports use different measurement frames. | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] / [[F.9 - Alignment & Bridge across Contexts|F.9]] first; [[C.26 - Quantum-Like Modeling Lens|C.26]] only if no admissible shared comparison frame remains. | Averaging the scores as one posterior-looking value. | Name the frame difference and either build an admissible comparison route or stop comparison. |
| Team survey says "aligned", but incident behavior contradicts it. | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] / [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] / [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] first; [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] if coordinated work traces support a low-recoverability distributed-state reading. | Treating survey output as the team state. | State a low-recoverability carrier/window-bound reading and the rival explanations. |
| Market "expects" a feature because many actors change behavior. | Declare bearer/traces; ordinary market, incentive, and evidence explanation first; [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] only for residual low-recoverability state reading. | Inventing a market mind. | Name actor traces, window, rivals, and the least-supported behavior-based reading. |
| Latency is green while support load and customer promise degrade. | [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] / [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] first; [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]] if viability reading is probe/export/frame/coarsening-distorted. | Calling one green metric viability. | Add envelope variables, actuators, costs, and failure mode. |
| Summary compresses an architecture decision for executives. | [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] first; no QL unless a state-representation shortcut has QL residue. | Treating the summary as full architecture state. | Use for orientation only; return to source for release or design lock. |
| Diagram translates the same system into graph form. | [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] first; no QL unless incompatible representation, probe, or export cue remains. | Calling any diagram a QL state model. | Declare representation-scheme change, reasoning-medium change, and source tether. |
...
### [[C.26 - Quantum-Like Modeling Lens|C.26]]:8.2 - AI and LLM work-cycle route examples

LLM-mediated work cycles often create the same representational mistakes [[C.26 - Quantum-Like Modeling Lens|C.26]] repairs: false passive read, false faithful summary, false shared comparison frame, and shortcut without loss/use declaration. This does not make LLMs quantum-like.

| AI case | Route |
| --- | --- |
| LLM summary of an architecture record | [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], and [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] first; [[C.26 - Quantum-Like Modeling Lens|C.26]] coarsening only if a state-representation shortcut is being overused. |
| Prompted model evaluation changes model or prompt behavior | [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] / [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] first; [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] only if the eval output is treated as a passive model-state read. |
| Agent work cycle "discovers" requirements | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] / [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] / [[A.6 - Signature Stack & Boundary Discipline|A.6]] first; [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] only if the interaction created the requirement framing. |
| Synthetic personas "represent market state" | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] / [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] first; [[C.26.2 - Enacted Distributed State Evidence|C.26.2]] only if a low-recoverability state-reading claim is carefully bounded with non-admissible use visible. |

## [[C.26 - Quantum-Like Modeling Lens|C.26]]:9 - Consequences
...
| Better bridge records | [[F.9 - Alignment & Bridge across Contexts|F.9]] records more often include admissible export use and non-admissible export use. |
| Better release/evidence discipline | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] / [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] are invoked only when the claim’s evidence or authority demand requires them. |
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:10 - Rationale
...
Evidence is not prestige. Literature supports the modeling move; local evidence supports the local state, export, or probe claim. A source anchor can justify why order effects, contextual probability, instrument-like readings, or open-system modeling are legitimate modeling patterns. It does not prove that this dashboard changed this team's state, that this workshop changed a boundary, or that this export lost the live coordination. That proof or evidence still belongs under [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], and the ordinary pattern for the local claim.

## [[C.26 - Quantum-Like Modeling Lens|C.26]]:11 - SoTA-Echoing
...
### [[C.26 - Quantum-Like Modeling Lens|C.26]]:11.1 - Selected operational source anchors
...
## [[C.26 - Quantum-Like Modeling Lens|C.26]]:12 - Relations

**[[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use relation.**
...
- Exit: when the question under repair is causal, cite [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] before retaining QL-lite or QL-NQ.
...
- [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] may flag: ordinary state/rate/rate-change, effort-window, rhythm, braking, coasting, or intervention-timing claims before any quantum-like cue is considered.
...
- Exit: use [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] and ordinary FPF patterns first; use [[C.26 - Quantum-Like Modeling Lens|C.26]] only where residual probe, frame, order, export, or coarsening cue remains after those relations are named.

- Builds on: [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], [[E.9 - Design‑Rationale Record (DRR) Method|E.9]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.3 - Transformer Constitution (Quartet)|A.3]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]].
- Constrains: QL wording in [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]], [[C.26.2 - Enacted Distributed State Evidence|C.26.2]], and [[C.26.3 - Viability-Envelope Boundary Regulation|C.26.3]].
