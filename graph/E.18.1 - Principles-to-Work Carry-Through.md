...
related:
  ...
  - "[[A.15.3 - SlotFillingsPlanItem|A.15.3]]"
  - "[[A.15.4 - Work-Relevant Source Restoration|A.15.4]]"
  - "[[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]]"
  - "[[A.19.UNM - Unified Normalization Mechanism (UNM)|A.19.UNM]]"
  ...
  - "[[C.22.2 - ProblemCard@Context|C.22.2]]"
  ...
  - "[[F.17 - Unified Term Sheet (UTS)|F.17]]"
...
> **Builds on:** [[E.18 - Transformation Flow Structure|E.18]] Transformation Flow Structure, [[C.22.2 - ProblemCard@Context|C.22.2]] ProblemCard@Context, [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] `U.Signature`, [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] `U.Mechanism`, the [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work family, [[C.29 - Mathematical Lens Use|C.29]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], and Part G comparison, selection, and refresh patterns.
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:1 - Problem frame
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:1.1 - Use this when
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:1.2 - What goes wrong if missed
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:1.3 - What this buys
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:1.4 - Not this pattern when

- there is no accepted problem-side record; use [[C.22.2 - ProblemCard@Context|C.22.2]] or the problem-side pattern named by value first;
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:2 - Problem
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:3 - Forces
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4 - Solution
...
| `TransformationTemporalAspect` | Is the next issue a bounded transformation under conditions, a temporal aspect of a governed object or claim, or the adequacy of an authored temporal claim? | [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], or [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] application. |
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.1 - Carry-through record
...
P2W carry-through record:
  ...
  SelectedApplication: [[C.29 - Mathematical Lens Use|C.29]] for preserved and lost structure; [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] for `U.Signature(profile=FormalSubstrate)` and `PrincipleFrame` when the declaration is written.
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.2 - Positive move table
...
| Bounded transformation or temporal-aspect cue | Separate bounded transformation, temporal aspect, and temporal-claim adequacy. | [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]] for bounded transformation, [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] for temporal aspect, or [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] when authored temporal-claim adequacy or currentness-use is being made. |
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.3 - Locus Use Details
...
When mathematical wording points both to a formal declaration and to a mathematical lens, P2W does not decide by vocabulary. Use the slot discipline in `A.6.0:10a.1`: [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] owns `U.Signature(profile=FormalSubstrate)` declaration, [[C.29 - Mathematical Lens Use|C.29]] owns mathematical-lens use, [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] owns mechanism consumption or realization, and [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] owns only the carry-through cue and next-relation selection.
...
Transformation and temporal aspects: a problem-side distinction may point to a bounded transformation, a temporal aspect, and a temporal-claim adequacy question at once. Do not fold these into method, mechanism, plan, or work. [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]] owns bounded transformation under conditions, including transformed object, pre-state, post-state, condition set, and admissible effect claim. [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] owns temporal aspects such as interval, deadline, cadence, rhythm, synchronization, currentness window, recovery timing, or stabilization timing when the aspect itself is being named. [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] owns adequacy, supported use, unsupported use, or source-currentness use of authored temporal claims.
...
Structure, publication, function, module-interface, and integration cues: a transformation-flow structure, mathematical graph description, diagram, or publication can help classify the P2W move. Function wording continues only as an [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] function or functional-relation claim; interface, port, protocol, connection, resource limit, or integration wording continues only as a module-interface, signature-slot, reusable-structure, or architecture relation named by value through [[A.6.M - Module Relation Repair|A.6.M]], [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]], [[C.31 - Modularity and Reusable Structure Characteristics|C.31]], or the [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] family. Otherwise the wording remains classification material for the P2W record.

### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.4 - Boundary and relation discipline
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.5 - Return and refresh rule
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.6 - Relation selection aid
...
| bounded transformation, temporal aspect, dynamics episteme, or temporal supported-use claim | [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], or [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] relation according to the claim being made | Split one phrase when it carries several of these relations. |
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.7 - Lowering and reopen block
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:4.8 - Replay and currentness record
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:5.1 - Worked slices
...
6. **Interface split before P2W use.** A source says a port-throughput limit makes a solution feasible after integration. P2W first splits the phrase: module-interface relation ([[A.6.M - Module Relation Repair|A.6.M]]), [[E.18 - Transformation Flow Structure|E.18]] transformation-flow relation or [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] function/throughput relation when function use is being claimed, WorkPlan constraint ([[A.15.2 - U.WorkPlan|A.15.2]]), dated `U.Work` occurrence ([[A.15.1 - U.Work|A.15.1]]), evidence or gate claim ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]), or architecture and structural-view claim ([[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] family). The carry-through record writes only the relation that changes the P2W move being made and leaves the other readings as stopped cues.
...
### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:5.2 - Additional worked situations

| Situation | P2W move | What changes |
|---|---|---|
| First-minute use | A practitioner has only an accepted `ProblemCard@Context` and the sentence "the cooling fixture violates the heat-flow invariant." Fill `ProblemCardRef`, `CarriedDistinction`, `NextFPFUseQuestion`, and `RecoveredFPFKindOrRelation` or `StopCondition`. | The next action becomes a [[C.29 - Mathematical Lens Use|C.29]] and [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] application, not method selection or evidence writing. |
...
| Principle story without accepted problem-side material | A source has an inspiring principle story but no accepted `ProblemCard@Context`. | P2W stops before it begins; the material remains a reduced-use cue until [[C.22.2 - ProblemCard@Context|C.22.2]] or the problem-side pattern named by value accepts problem-side material. |
...
| Near-sameness under a formal declaration | A mathematical near-sameness claim preserves heat-flow structure but loses deformation factors outside the model. | P2W uses [[C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use and [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] for `U.Signature(profile=FormalSubstrate)`, names preserved and lost structure, and prevents the lens from settling empirical truth or work authorization. |
...
| Relation selection would over-select from one phrase | A source says "the new port contract proves integration readiness." P2W splits module-interface relation, [[E.18 - Transformation Flow Structure|E.18]] transformation-flow relation, dated `U.Work` occurrence, evidence cue, gate cue, and architecture-description cue. | Only the relation that changes the P2W move being made is written; the remaining readings stop as named cues until their governed relations are being made. |
| Formal claim loses payoff | A `U.Signature(profile=FormalSubstrate)` declaration preserves a neat invariant, but no practical payoff or downstream stop condition can be stated for the accepted problem-side material. | The mathematical phrase lowers to a reduced-use cue; P2W does not open method selection, evidence, gate, or [[A.15.2 - U.WorkPlan|A.15.2]] planning from mathematical prestige alone. |
| Result source becomes stale | A result-looking source is later replaced by a fresher source with a different artifact reference and measurement reference. | P2W uses [[A.15.4 - Work-Relevant Source Restoration|A.15.4]]-style source restoration before result carry-through; stale result wording cannot continue as evidence, acceptance, or quality evaluation. |

### [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:5.3 - Pilot examples for coupled transformation-flow slices
...
| TAMP and MPC robotics | Method selection and [[A.15.2 - U.WorkPlan|A.15.2]] planning records may be revised under a declared progress or budget condition before performed work. | Branching and cycle use without imposing one mandatory work procedure, and no launch-value binding before performed work. |
...
P2W output record:
  ...
  SelectedApplication: [[C.29 - Mathematical Lens Use|C.29]] for preserved and lost structure; [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] for the formal-substrate declaration.
...
P2W output record:
  ...
  CarriedDistinction: the port-throughput phrase may carry module-interface, [[E.18 - Transformation Flow Structure|E.18]] transformation-flow, work-plan, performed-work, evidence, gate, and architecture relations, but only one relation changes this P2W move.
  NextFPFUseQuestion: which relation is being written now?
  RecoveredFPFKindOrRelation: [[A.6.M - Module Relation Repair|A.6.M]] module-interface relation plus [[E.18 - Transformation Flow Structure|E.18]] transformation-flow relation; [[A.15.2 - U.WorkPlan|A.15.2]] planning constraint is written only if the planning record is being made.
  SelectedApplication: [[A.6.M - Module Relation Repair|A.6.M]] for the port contract; [[E.18 - Transformation Flow Structure|E.18]] for the selected transformation-flow relation; [[A.15.2 - U.WorkPlan|A.15.2]] only for the planned constraint.
  WrittenRecordOrApplication: write the module-interface constraint and [[E.18 - Transformation Flow Structure|E.18]] transformation-flow relation; stop evidence and gate cues until their governing relations are being made.
  LocalStop: no readiness proof or work authorization follows from the port phrase by itself.
```

## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:6 - Bias-Annotation
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:7 - Conformance Checklist
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:9 - Consequences
...
| P2W stays non-procedural. | The pattern can be used in many project situations without prescribing one local procedure. | Teams that want a work procedure must add method material or [[A.15.2 - U.WorkPlan|A.15.2]] planning material outside P2W. |
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:10 - Rationale

[[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] is a child of [[E.18 - Transformation Flow Structure|E.18]] because P2W uses a selected transformation-flow structure as its setting when the carry-through relation spans several transformation-flow slices, loci, or returns. It does not define graph law or prescribe performed-work order. It defines a local carry-through pattern for turning accepted problem-side material into a next FPF use whose governing relation is named.
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:11 - SoTA-Echoing
...
## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:12 - Relations

- [[E.18 - Transformation Flow Structure|E.18]] governs selected `TransformationFlowStructure`, transfer annotations, flow valuation, `ConstraintValidity`, `GateFit`, gate profile, design tags, and run tags.
- [[C.22.2 - ProblemCard@Context|C.22.2]] governs the accepted problem-side record and problem-side claims related to the carried distinction.
- [[C.29 - Mathematical Lens Use|C.29]], [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[E.14 - Human‑Centric Working‑Model|E.14]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19.UNM - Unified Normalization Mechanism (UNM)|A.19.UNM]], and Part G govern mathematical-lens use, `U.Signature(profile=FormalSubstrate)`, principle-frame, ontology, UTS, bridge, measurement, normalization, and comparison relations.
- [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[E.20 - Mechanism Introduction Protocol|E.20]] govern mechanism and mechanism-method stabilization relations. [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], and [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] govern bounded transformation, temporal aspect, temporal-claim adequacy, and dynamics-episteme relations.
- [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], and [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]] govern candidate-set, comparison, selector, retained-set, and selected-record relations.
- [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.15.1 - U.Work|A.15.1]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.3 - SlotFillingsPlanItem|A.15.3]], and [[A.15.4 - Work-Relevant Source Restoration|A.15.4]] govern role-method-work alignment, performed work, planning, planned baselines, and work-relevant source restoration.
- [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], and [[C.11 - Decision Theory (Decsn-CAL)|C.11]] govern evidence, assurance, provenance, conformance, gate, release, work-entry, and decision claims.
- [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[C.30.AD - Architecture Description Adequacy|C.30.AD]], [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[A.6.M - Module Relation Repair|A.6.M]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.17 - Multi‑View Publication Kit|E.17]], and [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] govern architecture, architecture-description, structural-view, reusable-structure, module-interface, function, wording-use, publication, and publication-use claims.

## [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]:End
