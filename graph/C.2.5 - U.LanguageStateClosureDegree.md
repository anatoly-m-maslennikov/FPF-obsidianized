...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:1 - Problem frame
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:2 - Problem
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:4 - Solution
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:4.1 - Characteristic specification
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:4.2 - Starter anchor set
...
| `CD5` | strongly fixed | relaxation requires an explicit [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] move and governance note |

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:4.3 - Non-collapse rules
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:4.4 - Change discipline
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:5 - Archetypal Grounding
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:6 - Bias-Annotation
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:7 - Conformance Checklist
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].5-1` Closure **SHALL** be declared independently from `F` and `AE` when it matters for routing, docking, or reopening.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].5-2` Reopen/backoff moves **SHALL** cite the prior closure state they are relaxing.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].5-3` Strong-closure states **SHOULD** name the guard, `governingPatternRef`, or `authoritySourceRef` that makes the closure binding.
- `CC-[[C.2 - Epistemic holon composition (KD-CAL)|C.2]].5-4` Endpoint authority **SHALL NOT** survive a closure drop silently when the supporting route or publication form no longer holds.

## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:8 - Common Anti-Patterns and How to Avoid Them
- **Closure by mood.** A sentence sounds decisive, so teams assume high closure. Publish `CD` explicitly.
- **Irreversible drift.** Closure rises informally but no reopen path exists. Use [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]].
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:9 - Consequences
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:10 - Rationale
Closure is the route-governance basis slot that complements articulation within the declared language-state chart over `U.CharacteristicSpace`. [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] and its seam species need both.

## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:11 - SoTA-Echoing
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:12 - Relations
...
- Coordinates with: [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]].
- Constrains: reopen, backoff, and endpoint docking guards.

## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:13 - Worked Examples and Retreat Cases

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:13.1 - Explicit but still open
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:13.2 - Strong closure under policy guard
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:13.3 - Reopen case
A route may move from `CD4` back to `CD2` when counter-evidence appears. A conforming publication does not hide this as embarrassment; it records the retreat as an admissible [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] move.

## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:14 - Authoring and Review Guidance

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:14.1 - Author prompt
To assign `CD`, ask:
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:14.2 - Review prompt
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:14.3 - Governance note
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:15 - Extension and Migration Notes

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:15.1 - Local anchor refinement
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:15.2 - Migration from readiness language
Words such as "settled", "closed", "final", or "open" should be treated as migration prompts into explicit `CD` claims and, where needed, into named [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]] moves.

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:15.3 - Boundary reminder
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:16 - Closure Publication Package Discipline

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:16.1 - Minimal closure package
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:16.2 - Narrowing-source rule
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:16.3 - Partial-closure rule
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:17 - Retained and Withdrawn Authority Handling

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:17.1 - Authority retention rule
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:17.2 - Admissible retreat record
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:17.3 - Closure versus obligation boundary
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:18 - Review Matrix and Reopen Tests

### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:18.1 - Review matrix
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:18.2 - False-finality test
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:18.3 - Cross-facet reminder
...
### [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:18.4 - Split-closure review case
...
## [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]]:End
