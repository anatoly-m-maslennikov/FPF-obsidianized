...
* **Status and witness lexicon ([[E.10 - Unified Lexical Rules for FPF|E.10]] discipline).** In CV scope, publications use **Status and Witness** terminology; **GateDecision…** lexemes belong to GateFit ([[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]) and do **not** apply to CV.
* **EntityOfConcernRef = KindBridge.** Any CV mention of selected-entity retargeting is interpreted through **`KindBridge (CL^k)`** on **UTS** under [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.18 - Transformation Flow Structure|E.18]], and [[C.3.3 - KindBridge & CL^k - Cross‑context Mapping of Kinds|C.3.3]] when the retargeting or bridge claim is present. CV **does not** declare or translate planes, units, or comparators.
...
### [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]:4.4 - GateChecks (table) — CV only
...
CV **SHALL NOT** declare or translate `Units`, `ReferencePlane`, or `ComparatorSet`. Gate-mediated crossings and gate-consumed CSLC checks use [[E.18 - Transformation Flow Structure|E.18]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] with UNM declaration and bridge discipline. Comparator use, ranking, selection, set-return, archive semantics, and refresh remain with [[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only when those claims are present.
...
* **CV‑to‑refresh triggers (normative).** A **SliceRefresh(PathSliceId)** SHALL be scheduled when any of the following occurs:
  ...
  (`CVRefreshTrigger.AdjacentFactUpdate`) updates to adjacent **UTS** or **Bridge** facts for the slice (e.g., `CL^k`, `BridgeId`, `Φ` and `Ψ` policy ids) under [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.17 - Multi‑View Publication Kit|E.17]], or [[E.18 - Transformation Flow Structure|E.18]];
  (`CVRefreshTrigger.ReferencedEditionChange`) edition changes referenced by comparator or selection loci on the slice ([[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], or [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] when the comparator or selection claim is present) (`ComparatorSetRef.edition`, `DescriptorMapRef.edition`, `DistanceDefRef.edition`, …);
...
## [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]:6 - Bias‑Annotation
...
## [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]:7 - Conformance Checklist  ✱
...
* CC-TFS‑09: MVPK faces present; edition & Γ pins where expected; no new numeric claims on faces ([[E.17 - Multi‑View Publication Kit|E.17]]).
...
* **Open‑world species.** Any locus **species** binds to one of the minimal kinds; adding a new **locus kind** is out of scope for [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] and belongs in an [[E.18 - Transformation Flow Structure|E.18]] locus-baseline update.
...
* Any edition citation on faces includes `Bridge+UTS` through [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.17 - Multi‑View Publication Kit|E.17]], and [[E.18 - Transformation Flow Structure|E.18]]; comparator or set-return implications use [[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], or [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] when those claims are present.
...
*Replayability.* With valuation plus MVPK pins, re-runs under fixed `E⃗` are comparable and slice-scoped through [[E.18 - Transformation Flow Structure|E.18]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], and [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] when refresh wiring is present.
...
* **[[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.17 - Multi‑View Publication Kit|E.17]], and [[E.18 - Transformation Flow Structure|E.18]] (Bridge+UTS loci).** Boundary-publication requirement whenever faces cite editions.
* **[[A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]].** Comparability, set-return, archive, and refresh discipline; CV does not compare; it only checks internal readiness for declared comparison.
...
* **[[E.10 - Unified Lexical Rules for FPF|E.10]] (LEX).** Token classes and ASCII Tech names; twin labels and aliasing for Γ, CL, and Φ as per LEX‑BUNDLE.

## [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]:Appendix A — CV Class Gloss (normative)
...
### [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]:Appendix B — LEX discipline (summary)
