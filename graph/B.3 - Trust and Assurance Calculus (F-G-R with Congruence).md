...
fpf_id: "B.3"
title: "Trust and Assurance Calculus (F-G-R with Congruence)"
...
> [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] defines how assurance or trust is assigned, aggregated, and reused for physical systems, epistemes, and publication or evidence records that are used to claim assurance. It uses one typed assurance tuple, F-G-R: `F` and `R` as characteristics, `G` as the scope value, plus edge-scoped `CL`; the aggregation rules stay conservative, respect the Gamma invariants, and keep the [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] EntityOfConcern and description strict distinction. It treats the [[E.14 - Human‑Centric Working‑Model|E.14]] Working-Model layer as the publication-facing assertion layer for claims, with assurance inputs attached downward from Mapping, Logical, Constructive, and Empirical Validation layers.

**Use this when.** Use [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when a claim, label, dashboard, evidence bundle, model, report, gate decision, or assurance-input package is being used to raise assurance, trust, readiness, compliance, safety, release confidence, `F`, `G`, `R`, or `CL` for a named claim.
...
**Not this pattern when.** If the encountered source or publication face is only a cue, action invitation, boundary wording, evidence question, currentness question, gate decision, release decision, role assertion, status-value assertion, commitment, or work occurrence, use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]], [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]], [[A.2.9 - U.SpeechAct (Communicative Work Object)|A.2.9]], or [[A.15.1 - U.Work|A.15.1]] as appropriate.

**Assurance result selection.** Use the lightest assurance result that can decide the assurance use being claimed. A cue or source pointer gets no [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] tuple. A local, non-release, non-compliance, non-safety, non-reused claim may be written as a compact bounded assurance claim statement that names claim, assurance use carried by the assurance tuple or relying context, evidence pointer, limit, and stop or reopen condition. Reserve a full typed `Assurance(H, C | K, S)` claim for readiness, compliance, safety, release confidence, trust, `F`, `G`, `R`, `CL`, or reused assurance input.
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:1 - Problem frame
...
To make such claims comparable and auditable across domains, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] introduces a **Trust and Assurance Calculus** that:
...
* accounts for **integration quality** via **Congruence Level (CL)** along the edges of a `DependencyGraph` ([[B.1.1 - Dependency Graph & Proofs|B.1.1]], [[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]),
...
[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] is **conceptual and normative**: it defines *which assurance components must be published and how they propagate*. How those components improve (for example by formalizing, replicating, reconciling, or widening or narrowing scope under declared operation rules) is handled by KD-CAL improvement moves; those knowledge-dynamics references are descriptive, not required to read here.

**Mechanism linkage.** For law-governed operation families (for example **USM** and **UNM**) authored as **mechanisms**, use [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] — U.Mechanism to publish **OperationAlgebra**, **LawSet**, **AdmissibilityConditions**, and the **Transport** clause (Bridge-only; `CL`, `CL^k`, and `CL^plane`). All such penalties reduce `R_eff` only; `F` and `G` remain invariant.

**Working-Model handshake (alignment with [[E.14 - Human‑Centric Working‑Model|E.14]], [[B.3.5 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]], and [[C.13 - Constructional Mereology (Compose‑CAL)|C.13]]).**
Assurance consumes two inputs declared in the **Working-Model** assertion layer (CT2R-LOG, [[B.3.5 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]]): the **justification declaration** `validationMode ∈ {postulate, inferential, axiomatic}` and, where present, the **grounding link** `tv:groundedBy`. Structural claims that aspire to the strongest guarantees rely on **Constructive** grounding as a **Gamma-m** (Compose-CAL) narrative referenced via `tv:groundedBy`. No assurance record or publication **defines** Working-Model wording or layout; dependence remains downward-only under [[E.14 - Human‑Centric Working‑Model|E.14]].

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:2 - Problem
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:3 - Forces

| Force                                    | Tension                                                                                                                             |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Conservatism vs. Synthesis**           | Avoid overclaiming (WLNK) ↔ recognize real gains from better integration (raise CL) or true emergence ([[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]]).                            |
...
| **Simplicity vs. Fidelity**              | Keep the assurance tuple small and typed ([[A.11 - Ontological Parsimony (C‑5)|A.11]]) ↔ capture enough structure to be informative and improvable by KD-CAL moves.           |
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4 - Solution — **Part 1: The assurance tuple and the universal aggregation skeleton**

[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] defines **what** the assurance components are, **where** they are assigned on nodes and edges of the dependency graph, and the **shape** of the aggregation that any Γ-flavour must honor when producing an *assurance result*.

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.1 - The F-G-R assurance components (typed; `F` and `R` as CHR, `G` as USM)
...
2. **ClaimScope (G)** — *the declared set of `U.ContextSlice` values where the result applies.*
   ...
   * **Type:** **set-valued USM scope value** ([[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]), **not** a CHR characteristic.
...
> **EntityOfConcern and description strict distinction ([[A.7 - Strict Distinction (Clarity Lattice)|A.7]]).**
>
...
> **Mapping** raises **TA** (typing, fit, and CL). **Logical** and **Constructive** contribute to **VA** (intended relation semantics; Gamma-m extensional identity for structure). **Empirical Validation** contributes to **LA** (evidence in a bounded context). These assurance inputs attach **downward** from the Working-Model assertion layer ([[E.14 - Human‑Centric Working‑Model|E.14]]).

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.2 - Assurance as a typed claim

[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] speaks about **assurance of a specific typed claim** `C` over a holon `H` under context `K` and scope `S ∈ {design, run}`:
...
* `Notes` include the **SCR** (all sources, [[B.1.3 - Γepist - Knowledge‑Specific Aggregation|B.1.3]]), **OrderSpec** or **TimeWindow** where applicable ([[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]]), cutsets, and evidence citations ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]).
...
Each published Working-Model assertion declares **`validationMode ∈ {postulate, inferential, axiomatic}`** ([[E.14 - Human‑Centric Working‑Model|E.14]]).
...
* *axiomatic* -> constructive identity; **structural** edges provide a Gamma-m narrative and a **`tv:groundedBy`** pointer ([[C.13 - Constructional Mereology (Compose‑CAL)|C.13]], [[B.3.5 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]]).

**Design versus run (no chimeras).** Assurance tuples for **design-time** and **run-time** are reported **separately** and are not composed into a single score; see the *Scope drift* hazard in [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:2 and the obligations in [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.6.

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.2a - Authority-looking labels and dashboard tiles
...
[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] dispositions for such a source or publication face are:

| Disposition | Use when | Output |
| --- | --- | --- |
| No assurance use | The encountered source or publication face is only a cue, source pointer, evidence question, currentness question, gate decision, role assertion, status-value assertion, commitment, boundary wording, or work occurrence. | Use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.6 - Signature Stack & Boundary Discipline|A.6]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]], [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]], [[A.2.9 - U.SpeechAct (Communicative Work Object)|A.2.9]], or [[A.15.1 - U.Work|A.15.1]]; no tuple is needed. |
...
Build a [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim only when the next work move or reliance move depends on a typed assurance claim. The typed assurance claim names:
...
| Evidence relation and evidence refs | The [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, scoped evidence refs, source-maintenance role assignments, windows, verifier rule, relying-party rule, and proof results or status-value results that evidence the assurance tuple. |
...
| Audit role | Which evidence path, argument, limitation, decay condition, reopen condition, and relying context must be recoverable? |
| Manager or release role | Which desired decision or work or reliance use is outside [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] and must instead use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], or another named source? |
...
Contestability and redress relation: when the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold is met, the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] result should name the claim being contested, evidence path, limitation or decay condition, contest forum or decision forum, safe interim disposition, and what evidence or scope change would reopen the assurance claim.

If those fields are missing, the encountered publication face, rendering, or cue remains an orientation label, source pointer, evidence pointer, documentation record, or unsubstantiated confidence cue. Use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] when the question is whether that lane may guide work or reliance, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when the question is evidence, currentness, or provenance, and [[A.6 - Signature Stack & Boundary Discipline|A.6]] when the question is mixed policy, API, or schema wording.
...
| --- | --- | --- |
| Source-backed release dashboard tile | If the tile is a current view of [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision` or `DecisionLogRef` plus an [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, it may carry gate-passage reliance outside [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for the named release and environment. [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] is used only when the tile is also asked to raise readiness, safety, compliance, trust, or release-confidence assurance. | Release approval by display, compliance proof, rollback success, work occurrence, or assurance increase without a typed assurance claim. |
...
Model cards, datasheets, data cards, assurance documents, and assurance-looking notes are external documentation records or source records unless they are mapped into existing `FPF` claims and publication faces. They do not add MVPK face kinds and do not bypass [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when the use under repair is an assurance claim.

**Lint trigger.** A model card, datasheet, or data card cited as readiness, safety, compliance, release confidence, or assurance proof requires documented intended-use match, evaluation condition, limitations, an [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, and one typed `Assurance(H, C \| K, S)` claim for the named assurance claim. Without those, classify the use as `no assurance use` or as a rejected or downgraded assurance claim.

Positive repaired example: a model card plus documented bounded-use statement or external intended-use field, evaluation condition, version, window, limitations, an [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, and a typed `Assurance(H, C \| K, S)` claim may carry assurance for that named model claim in that evaluated context. The same documentation still does not carry another deployment context, gate passage, release work occurrence, or compliance proof unless those sources are separately present.

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.2b - Minimum reliance safety assurance record

Use this [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] section when the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold is met: reliance on a visible source may materially change behavior, safety, release, compliance, public or protocol behavior, access, resource allocation, people or team status value, operational action, or controlled-entity regulation. The first [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] move is to decide whether an assurance claim is being made; if it is, write the minimum reliance safety assurance record for the named reliance use. Mere attention shift, learning, orientation, source-finding, or source-wording correction is not enough.

`RelianceSafetyCase` is the local Tech label for this [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance-record form. The plain phrase is **minimum reliance safety assurance record**. The label is not a new FPF pattern, Core kind, safety authority, gate, policy source, approval, certificate, compliance method, or general safety-case ontology.

Assurance-record role: the trigger and non-trigger table is a [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] recognition aid, the minimum assurance-record table is a minimum local record aid, and the worked reliance-threshold slices are examples for users of the pattern. They are not a universal project checklist, sign-off sequence, untyped status vocabulary, or replacement for `Assurance(H, C | K, S)`; use them only when the named material reliance trigger is met. This local section keeps the attempted reliance inside the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance relation; it does not create an extra SEMIO authority or cross-pattern relation vocabulary.

Affordability card: orientation or source-finding stays outside [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; bounded local reliance stays with the local evidence, explanation, CV, gate, or pattern-quality relation unless an assurance claim is being made; threshold reliance uses the minimum reliance safety assurance record only when the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold is met. Plain wording remains ordinary unless it changes bounded use, source relation, evidence, gate, assurance, work, decision, or selected governing pattern.

Common wrong first classification: a safety-looking note, safety case, compliance-looking label, or dashboard warning is a certificate, approval, or gate. First honest entry: state one typed [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim with [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, assumptions, limitations, defeaters, residual uncertainty, monitoring or stop condition, contest and redress relation, bounded assurance use, and unsupported attempted use.

First [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] move: name the reliance use, the assurance claim, the affected context or audience, the trigger that meets the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold, the [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, the argument, limitations, defeaters, contest and redress relation, stop or monitoring condition, bounded assurance use, and unsupported attempted use. If those pieces are absent, use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], or the local relation that actually governs the source use rather than inventing assurance by label.

Trigger and non-trigger cases:

| Encountered source use | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] disposition | Minimum response |
| --- | --- | --- |
| Ordinary source-backed report, citation, model card, datasheet, data card, or documentation record with no assurance use and no met [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold | No [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance use. | Stay in [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] with claim, source record or publication face, evidence path, window, bounded evidence use, unsupported attempted use, and reopen trigger. |
| Generated explanation, generated summary, or didactic reconstruction used only for source-finding or learning | No [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance use. | Stay in [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] unless operative claims are relied on through [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence paths or another source relation that evidences the operative claim. |
| Local conformance label, `CV.Status`, benchmark result, or score near a release conversation but not used to raise assurance | No [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance use. | Keep `CV.Status` in [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], gate-decision publication in [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], pattern-quality result in [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], measurement or marker relation in [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] or [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], and no assurance tuple unless an assurance claim is being made. |
| Confidence, calibration, prediction interval, or abstention reason tied to one reversible local act | Compact bounded assurance claim only when the act depends on assurance; otherwise no [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] use. | State act, context, window, calibration condition, stop condition, bounded evidence use, and unsupported attempted use; use [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] or [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] when time, expiry, refresh, or monitoring changes the move. |
| Safety-looking note, compliance-looking label, public warning, dashboard value, generated operational explanation, or status-value display is intended or reasonably foreseeable to meet the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold: reliance materially changes behavior, safety, release, compliance, public or protocol behavior, access, resource allocation, people or team status value, operational action, or controlled-entity regulation. | Minimum reliance safety assurance record is required. | Build the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance record with [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path and any relevant [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]], or representation and retargeting dependency. |
...
| [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path | Claim, source record or source relation, producer or method trace, currentness and window, source-maintenance role assignment, evidence relation, rival explanation, bounded evidence use, unsupported attempted use, and reopen trigger. |
| Argument and assurance relation | Why this evidence path carries the assurance claim under the context; include assumptions, limitations, defeaters, residual uncertainty, and unacceptable-harm or risk-tolerance condition when relevant. |
| Dependencies | Any relevant [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] CV status, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate decision, [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] pattern-quality result, [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] temporal claim, [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] refresh and decay relation, [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] control relation, or representation and retargeting relation. |
| Monitoring, rollback, or stop condition | What observation, incident, drift, contest, expiry, changed [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] identification or realizability profile, changed [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate profile, changed evaluation condition, changed source record, or failed check stops, narrows, reopens, or withdraws the reliance. |
...
Misuse guard: an incoming or attempted-reliance `RelianceDisposition=safety-case-required` must name the trigger that meets the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold. A source producer, dashboard-value publisher or maintainer, model producer, documentation producer, or status-value label issuer cannot self-clear a threshold-bearing reliance by attaching the label. Where the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold is met, the assurance record must expose an accountable review role and a contest relation capable of changing the disposition.
...
| Slice | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] move | Boundary |
| --- | --- | --- |
...
| An SRE dashboard changes incident behavior or resource allocation. | Use [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] only when the dashboard is asked to raise assurance or safety-bearing reliance; keep ordinary evidence and currentness in [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]. | Use [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] only for a control relation being claimed and [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only for a gate decision being claimed. |
| A public warning or synthetic-content label changes perceived meaning but there is no evidence that it changed the behavior claimed to change, release risk, safety claim, or control relation. | Keep the label as [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence or source-finding and orientation cue; require audience-effect or behavior-effect evidence before [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] reliance. | Do not infer safety, compliance, behavior change, or control effect from label presence alone. |
| A manufacturing conformance label appears near release. | Keep local CV or conformance evidence in [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], or [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; use [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] only when assurance, safety, compliance, or release-confidence reliance is being claimed. | Conformance presence is not safety acceptance or release permission. |
| A software supply-chain attestation is cited as runtime safety. | Use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for origin, build, and process claims and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] only for the named assurance claim with argument, limitations, defeaters, and stop condition. | Build provenance is not runtime safety or operational permission. |
| A people or team status-value badge changes permissions, resources, or review priority. | Require an assurance record that names affected role, relying role, evidence path, contest relation, and disposition change condition. | The badge issuer cannot self-clear the people or team-status-value-changing reliance by issuing the badge. |
| A standards-document clause is reused as approval. | Use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence of the clause; use the named approval, commitment, gate, or assurance relation only when that relation is being claimed by value. | A cited clause is not project approval, gate passage, or assurance by quotation. |

Do not treat the assurance record as a graded scale, standalone status value, universal assurance checklist, release certificate, or new safety-case disposition family. [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] consumes the assurance record only as typed assurance input for the named claim and reliance use.

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.3 - Where the numbers are assigned (and where they are not)
...
* **Not inside Γ:** Γ consumes `D` and produces a composed holon; [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] governs how `F, G, R, CL` **propagate** to the **Assurance** tuple for that composed holon. This keeps Γ algebra and assurance calculus **separable** and reviewable.
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.4 - Universal aggregation skeleton (domain‑neutral)
...
2. **ClaimScope (G):**
   ...
   * Across independent evidence lines for the same claim, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] may publish a `SpanUnion` of the path scopes, but only when the independence assumption and evidence relation are explicit.
...
4. **SCR and Notes:**
   * The aggregate produces an SCR listing all contributing nodes and edges, with their F, G, R, CL, scopes, and evidence links ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]).
   * The SCR also displays the **EntityOfConcernRef** (`entityOfConcernRef and groundingHolonRef`) and the **ReferencePlane** for the claim, and presents a separable TA, VA, and LA table of evidence contributions with valid-until or decay marks and the **Epistemic-Debt** per § [[B.3.4 - Evidence Decay & Epistemic Debt|B.3.4]].
   * If order or time mattered for the claim, attach the OrderSpec or TimeWindow identifiers ([[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]]).
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.5 - System vs. Episteme - same shape, different interpretations
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.6 - Scale discipline (CHR guard‑rails)
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.7 - What improves the tuple (improvement-pattern overview)

[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] remains neutral about *how* improvement happens, but for didactic clarity:
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.8 - Prohibition (normative) — F–G–R is not a CharacteristicSpace
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:4.9 - Assurance consequence for unsupported causal-use claims

[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] consumes `CausalUseSupportVerdict`, `CausalEvidenceSupportBasis`, and relevant profile refs from [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] and [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when an assurance claim depends on a [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use verdict:

```text
CausalUseSupportVerdict = supported | bounded | unsupported | abstain
```

`CausalAssuranceTupleTrigger` is narrower than local causal-use repair. A local [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] downgrade, redirection to a relation governing the asserted use, or abstain disposition does not require a new [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance tuple by itself. Create or update a [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] tuple only when the causal-use claim is assurance-bearing, publication-bearing, release-bearing, or reused as an input to assurance, trust, certification, risk acceptance, or downstream selection. Exploratory causal wording, local causal wording repair, or a [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] cheap stop remains outside [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] until it changes assurance or publication use.

An unsupported causal-use shift lowers, blocks, or abstains from `R` for the affected causal-use claim. If `CounterfactualSamplingRealizabilityProfile.verdict = nonrealizable`, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] lowers or blocks `R` for claims that require direct counterfactual-comparison sampling evidence. If `CounterfactualSamplingRealizabilityProfile.verdict = unknown`, direct-realization claims are unsupported, while identified, bounded, or simulation-only bounded use may remain available when [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] declares the bounded use and unsupported use.
...
What this does not authorize: [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] does not determine the [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] target `CausalityLadderRung`, estimand, causal identification, evidence design, or realizability profile; it applies assurance consequences to the `CausalUseSupportVerdict` supplied by [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] and the evidence path supplied by [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]].

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5 Proof obligations (attach these when producing an Assurance tuple)

These obligations refine the generic Proof Kit from **[[B.1.1 - Dependency Graph & Proofs|B.1.1]] §6** for **assurance** outputs. Each Γ-flavour that emits an *Assurance(H, C | K, S)* tuple attaches the applicable obligations below.

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5.1 - Common obligations (all Γ‑flavours)
...
* **ASS‑MAN (SCR).**
  Produce a **SCR** listing all contributing nodes and edges with `(F, G, R)` and `CL` values, their **DesignRunTag**, and Evidence Graph Ref ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]). If order or time affect the claim, include the **OrderSpec** or **TimeWindow** identifiers from **[[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]]**.

* **ASS‑MONO (Declared monotone characteristics).**
  List the characteristics along which local improvement cannot reduce the aggregate (this is used by future evolution, [[B.4 - Canonical Evolution Loop|B.4]]).

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5.2 - Γ\_sys (systems) — additional obligations

* **CORE‑BIC (Interface congruence).**
  Reference the **Boundary‑Inheritance Standard** (BIC) from **[[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]** and record any interface mismatches; these contribute to `CL_min`.
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5.3 - Γ\_epist (epistemes) — additional obligations
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5.4 - Γ\_ctx and Γ\_method (order‑sensitive) — additional obligations

* **CTX‑ORD (OrderSpec).**
  Attach the partial or total order `σ` and any **join-soundness** conditions (types, preconditions, and postconditions).
  (See [[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] for NC‑1..3 invariants; [[B.1.5 - Γmethod - Order‑Sensitive Method Composition & Work Enactment|B.1.5]] adds duration/capability typing.)

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:5.5 - Γ\_time (temporal) — additional obligations
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:6 - Archetypal grounding (worked examples)

### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:6.1 - System archetype — **Battery pack safety claim**
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:6.2 - Episteme archetype — **Meta-analysis claim**
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:6.3 - Order and process-sequence archetype - **Manufacturing process-sequence assurance**
...
### [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:6.4 - Temporal archetype — **Versioned model credibility**
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:7 - Conformance checklist
...
| **CC-B3.6** | An Assurance SCR lists node and edge values, Evidence Graph Ref, and any OrderSpec or TimeWindow identifiers; it also displays the `describe(EntityOfConcernRef->GroundingHolonRef)` binding for the claim, the declared ReferencePlane value of world, concept, or episteme, a separable TA, VA, and LA evidence breakdown per **CC-KD-08**, decay or valid-until indicators on empirical bindings, and the Epistemic-Debt tally from **[[B.3.4 - Evidence Decay & Epistemic Debt|B.3.4]]**. | Provide auditability through [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] without collapsing evidence families. |
| **CC-B3.7** | Agency-CHR values ([[A.13 - The Agential Role & Agency Spectrum|A.13]]) do not override WLNK or `Φ(CL)` penalties; if agency grade change alters capabilities, model it as a Meta-Holon Transition. | Preserve safety; keep agency separate. |
...
| **CC-B3.9** | If an assurance claim depends on a [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use verdict, it consumes `CausalUseSupportVerdict`, `CausalEvidenceSupportBasis`, and relevant profile refs from [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] or [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; a causal-use claim whose [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] verdict is unsupported degrades, blocks, or abstains rather than raising `R`. | Prevent assurance prose from certifying unsupported causal claims. |
| **CC-B3.10** | A local [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] downgrade, redirection to the relation governing the asserted use, or abstain disposition is not a new assurance tuple trigger unless the claim is assurance-bearing, publication-bearing, release-bearing, or reused as an assurance input. | Keeps cheap causal triage from becoming assurance ceremony. |
| **CC-B3.11** | A conforming [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] use does not treat a label, badge, dashboard tile, credential display, provenance mark, compliance-looking mark, model card, datasheet, data card, assurance document, attestation label, or generated confidence phrase as raising `F`, `G`, `R`, `CL`, readiness, safety, compliance, trust, release confidence, or assurance unless a typed `Assurance(H, C &#124; K, S)` claim and [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path name the claim, assurance use stated by the assurance tuple or relying context, scope, evaluation condition, evidence refs, argument and assurance rationale, limitations, decay condition, reopen condition, and relying context. | Blocks visible authority-looking labels from supplying false assurance relation. |
| **CC-B3.12** | When reliance on a source may materially change behavior, safety, release, compliance, public or protocol behavior, access, resource allocation, people or team status value, operational action, or controlled-entity regulation, the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] result provides a minimum reliance safety assurance record or explicitly rejects, narrows, degrades, abstains, or reopens the attempted assurance use. The local Tech label `RelianceSafetyCase` is not a certificate, approval, gate, policy source, Core kind, release permission, or general safety-case ontology. | Keeps safety-bearing reliance relation concrete without turning every source or publication face into a dossier or a new authority system. |

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:8 - Anti-patterns and repairs
...
| **False assurance relation** | Badge, dashboard color, credential display, compliance mark, provenance label, model card, datasheet, data card, assurance document, attestation label, or generated confidence phrase is used as an assurance claim. | Keep it as orientation or source pointer unless a typed assurance claim and [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path make the intended assurance use bounded and evidenced. |
| **Minimum reliance safety assurance record inflation** | Ordinary evidence, source-finding explanation, local CV, documentation, or reversible local calibration use is forced into a safety assurance record; or the assurance record is used as approval, release permission, gate passage, safety acceptance, or compliance proof. | State the trigger that meets the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] material-reliance threshold. If the trigger is absent, use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], or the local relation that actually governs the use. If the threshold is met, write only the minimum assurance record and contest and redress relation needed for the named reliance use. |

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:9 - Consequences
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:10 - Rationale (informative)

[[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] distills mature post‑2015 practice across several fields into a single, small calculus:
...
* **Assurance documentation, provenance, and release-status practice** treats labels, model cards, datasheets, C2PA provenance marks, SLSA and in-toto attestations, credential displays, generated confidence phrases, and dashboards as scoped documentation or source pointers, not automatic assurance claims. [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] adopts claim, argument, and evidence discipline and scoped assurance-documentation use, adapts model cards, datasheets, data cards, attestations, provenance marks, dashboards, and generated confidence phrases as possible documentation or evidence inputs for a named assurance claim, and rejects visible-label promotion into readiness, compliance, safety, trust, `R`, `F`, `G`, `CL`, or release confidence without a typed tuple and [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path.

Practical result from that safety-case and assurance-documentation practice: safety notes, compliance-looking labels, assurance documents, dashboards, provenance marks, model cards, datasheets, data cards, and generated confidence phrases do not become certificates, approvals, gates, safety acceptance, or assurance by appearance. The local [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] result is one typed assurance claim or minimum reliance safety assurance record for the named reliance use, with [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, assumptions, limitations, defeaters, residual uncertainty, monitoring or stop condition, contest and redress relation, bounded assurance use, unsupported attempted use, and reopen when evidence, source record, context, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] identification or realizability profile, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate profile, evaluation condition, monitoring, or challenge evidence admitted by the contest relation materially changes the disposition.

This arrangement preserves **[[A.11 - Ontological Parsimony (C‑5)|A.11]] Parsimony** (few characteristics), aligns with **[[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]**, **[[A.7 - Strict Distinction (Clarity Lattice)|A.7]]**, and **[[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** (clear separation of structure, order, time, cost, values), and leaves Context for domain-specific refinements that do not break the invariants.

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:11 - Relations

* **Builds on:** [[B.1 - Universal Algebra of Aggregation (Γ)|B.1]] (Universal Γ), [[B.1.1 - Dependency Graph & Proofs|B.1.1]] (Proof Kit), [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]] (Γ_sys and BIC), [[B.1.3 - Γepist - Knowledge‑Specific Aggregation|B.1.3]] (Γ_epist and SCR), [[B.1.4 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] (Γ_ctx and Γ_time), [[A.12 - External Transformer & Reflexive Split|A.12]] (Transformer), [[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (Mereology), [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] (EntityOfConcern and Description strict distinction) and [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (role, method, and work alignment), **[[C.13 - Constructional Mereology (Compose‑CAL)|C.13]] (Compose-CAL)**.
* **Coordinates with:** **[[E.14 - Human‑Centric Working‑Model|E.14]] (Human‑Centric Working‑Model)** for publication-facing assertion discipline and **[[B.3.5 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]] (CT2R‑LOG)** for Working‑Model relation aliasing and grounding (`tv:*`, `validationMode`).
* **Coordinates with:** [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for `CausalUseSupportVerdict`, `CausalityLadderRung`, `CausalEvidenceSupportBasis`, identification profile refs, realizability profile refs, supported causal use, and unsupported causal use; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for the evidence graph path carrying causal-evidence refs.
* **Coordinates with:** [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for work disposition and reliance disposition, [[A.6 - Signature Stack & Boundary Discipline|A.6]] for mixed authority wording, [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for `OperationalGate(profile)`, `GateDecision`, and `DecisionLogRef`, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] for `ConstraintValidity` status or witness, and [[A.15.1 - U.Work|A.15.1]] for release or deployment work occurrence. [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] only handles typed assurance use; labels and evidence pointers stay with the source relation that governs them when assurance is not being claimed.
* **Used by:** KD-CAL improvement patterns (to plan improvements), [[B.4 - Canonical Evolution Loop|B.4]] (Evolution loops that raise `F`, `G`, `R`, or `CL` over time).
* **Triggers:** [[B.2 - Meta‑Holon Transition (MHT)- Recognizing Emergence and Re‑identifying Wholes|B.2]] (Meta‑Holon Transition (MHT): Recognizing Emergence and Re‑identifying Wholes) when genuine new capabilities emerge that change the applicable cutsets or envelopes.
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:11a - Assurance relation for quantum-like claims

Quantum-like wording does not raise the claim-assurance requirement by default. A local [[C.26 - Quantum-Like Modeling Lens|C.26]] modeling note can remain lightweight when it only prevents a representational mistake and is not used for a work-guiding use, reliance use, audit-closure claim, readiness-certification claim, or empirical-superiority claim.
...
4. If the claim is used for release, readiness, audit, compliance, assurance, or threshold-bearing work or reliance, build the [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim over named evidence refs and scope.
...
| Claim-use requirement | [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] expectation | Output |
| --- | --- | --- |
...
- no [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance use when QL is only a local representational lens;
...
## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:11b - [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> If a mathematical lens is used as input to assurance, readiness, reliability, release confidence, safety, trust, or engineering justification, write the assurance relation in [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] with the relevant evidence path and residual-use limits. A [[C.29 - Mathematical Lens Use|C.29]] output may be cited only as a lens-use result; mathematical elegance, validation regime, or a declared structure-preserving mapping does not raise assurance by itself. Evidence paths remain [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; measurement construction and comparability remain [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]].

## [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]:End
