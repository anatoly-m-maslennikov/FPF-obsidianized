...
**Primary hooks.** [[G.Core - Part G Core Invariants|G.Core]] (Part‑G core invariants + trigger catalogue + Default Governing Definition Index), [[G.2 - SoTA Harvester & Synthesis|G.2]] (SoTA Synthesis Pack), [[G.3 - CHR Authoring for a CG‑Frame- Characteristics, Scales, Levels, Coordinates|G.3]] (CHR Pack), [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]] (CAL Pack), [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] (selector & registries), [[G.6 - Evidence Graph & Provenance Ledger|G.6]] (EvidenceGraph + PathId/PathSliceId), [[G.7 - Cross‑Tradition Bridge Calibration Kit (BridgeMatrix → BridgeCards + BCT-Sentinels)|G.7]] (BridgeMatrix + CL/planes), [[G.8 - SoS‑LOG Bundles & Maturity Ladders|G.8]] (SoS‑LOG bundle surfaces), [[G.9 - Parity and Benchmark Harness|G.9]] (parity harness), [[G.10 - SoTA Pack Shipping|G.10]] (shipping), [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] (refresh orchestration), [[G.12 - DHC Dashboards (Discipline‑Health time‑series; admissible telemetry; generation‑first)|G.12]] (dashboards), [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] (CN‑Spec), [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]] (CSLC legality), [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]] (CG‑Spec), [[F.17 - Unified Term Sheet (UTS)|F.17]] (UTS), [[F.9 - Alignment & Bridge across Contexts|F.9]] (BridgeCard / CL), [[E.17 - Multi‑View Publication Kit|E.17]] (publication faces), [[E.5.2 - Notational Independence|E.5.2]] (notation independence), `E.18/A.21` (GateCrossing/CrossingBundle checks).

**Status.** Stable (Phase‑2 universalized; [[G.Core - Part G Core Invariants|G.Core]] linkage explicit)
**Normativity.** Normative when used (when any [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] surface is authored/emitted/consumed); informative otherwise.

**Non‑duplication note (Phase‑2 universalization).** This pattern **does not restate** Part‑G‑wide invariants (CN/CG spec-ref governing-definition assignment, crossing visibility, penalty routing, set‑return discipline, typed RSCR triggers, Default Governing Definition Index, Δ‑discipline). Those are governed in [[G.Core - Part G Core Invariants|G.Core]] and referenced here via the linkage manifest and CC delegations (*cite, don’t duplicate*).

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:1 - Problem frame
...
[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] provides the missing kit: **conceptual registration, alignment, and telemetry hooks** that let external sources be wired into the Part‑G pipeline (**[[G.2 - SoTA Harvester & Synthesis|G.2]] → [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] → [[G.9 - Parity and Benchmark Harness|G.9]] → [[G.10 - SoTA Pack Shipping|G.10]] → [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]**, and optionally **[[G.12 - DHC Dashboards (Discipline‑Health time‑series; admissible telemetry; generation‑first)|G.12]]**) while preserving Part‑G invariants via [[G.Core - Part G Core Invariants|G.Core]].

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:2 - Problem
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:3 - Forces
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:4 - Solution — Conceptual interop kit: registered sources, alignment cards, feature derivations, and RSCR‑wired telemetry

### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:4.1 - [[G.Core - Part G Core Invariants|G.Core]] linkage (normative)

**Builds on:** [[G.Core - Part G Core Invariants|G.Core]].
...
`GCoreLinkageManifest := ⟨
  ...
  CorePinsRequired := {
    // Interop pins ([[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑specific; avoid duplicating `GCorePinSetId.PartG.CrossingVisibilityPins`)
...
### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:4.2 - Interop kit objects & surfaces (pattern-governed; notation‑independent)
...
* **`ClaimMapperCard@Context`** — a conceptual “mapping recipe” that yields FPF‑native artefacts from an external source.
  ...
  * This is **not** a shadow legality gate. It is an interop surface that **cites** governing definitions ([[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]], [[G.3 - CHR Authoring for a CG‑Frame- Characteristics, Scales, Levels, Coordinates|G.3]], [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]]) and publishes the required pins for downstream audit/refresh.
  * When cross‑plane or cross‑context reuse is implicated, the alignment outputs must use the existing crossing bundles (see [[G.Core - Part G Core Invariants|G.Core]] linkage).
...
* **`ScaleEmbeddingSpec@Context`** — optional constraints for representation/space alignment used inside an alignment recipe.
  ...
  **LEX/UTS note (informative).** `ScaleEmbeddingSpec` is a new LEX head; when it mints a public id it must be published to UTS with twin labels (see [[G.Core - Part G Core Invariants|G.Core]] / UTS profile).
...
* **`IndexTelemetryPin`** — an emitted refresh input that makes interop changes RSCR‑visible.
  ...
  **Publication.** Emitted to [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] as refresh input; recorded with canonical `RSCRTriggerKindId` causes.
...
### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:4.3 - Generation‑first interop flow (notation‑independent; governing-definition delegating)
...
3. **Produce FPF‑native inputs.** Use the alignment recipe outputs as inputs to:
   ...
   * [[G.2 - SoTA Harvester & Synthesis|G.2]] harvesting (ClaimSheets / operator & object inventories / candidate bridge hints),
   * [[G.3 - CHR Authoring for a CG‑Frame- Characteristics, Scales, Levels, Coordinates|G.3]] CHR typing (when numeric signals are formalized as CHR characteristics/scales/coordinates),
   * [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]] acceptance/threshold policies (when a downstream decision requires explicit CAL policy rather than telemetry),
   * [[G.12 - DHC Dashboards (Discipline‑Health time‑series; admissible telemetry; generation‑first)|G.12]] dashboards (when derived SoS features are used as DHC slots).
4. **Feed selection/parity/shipping without smuggling semantics.**

   * [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] consumes the produced artefacts under its own governing spec refs and returns set‑valued outcomes (selector semantics remain governed by [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] + [[G.Core - Part G Core Invariants|G.Core]]).
   * [[G.9 - Parity and Benchmark Harness|G.9]] parity consumes pinned editions/windows and produces traceable parity reports.
   * [[G.10 - SoTA Pack Shipping|G.10]] shipping may include interop surfaces **as cited publications or records**; [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] does not govern shipping.
5. **Emit telemetry and refresh causes.** Any change in external editions, alignment policies, plane maps, or embedding specs emits:
   ...
   * a canonical `RSCRTriggerKindId` (per [[G.Core - Part G Core Invariants|G.Core]]),
   * a scope (`PathSliceId[]` and/or `PatternScopeId`),
   * payload pins (editions/policies/UTS rows),
     enabling [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] to plan slice‑scoped refresh.

### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:4.4 - Interfaces — minimal I/O standard (conceptual; kit‑only)

| ID   | Interface   | Consumes  | Produces   |
| ---- | ----------- | --------- | ---------- |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑1 `Register_ExternalIndex`**  | Register `ExternalIndexCard@Context` | Provider metadata, scope, **ExternalEdition**, freshness, entityOfConcern anchor   | `ExternalIndexCard@Context` (+ UTS row when published)   |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑2 `Map_ClaimsToFPF`**   | Apply `ClaimMapperCard@Context`   | `ExternalIndexCard@Context`, `MappingPolicyRef`, optional `PlaneMapRef`/`ScaleEmbeddingSpecRef`, optional EvidenceGraph hooks | `ClaimSheet@Context`, `BridgeHints`, optional `SoSFeatureSet@Context`, optional UTS proposals |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑3 `Derive_SoSFeatures`**  | Produce CHR‑typed SoS features  | ClaimSheets / external signals refs, CHR typing refs, legality proof hooks | `SoSFeatureSet@Context` (CHR‑typed; provenance pinned)   |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑4 `Publish_InteropSurface`**  | Publish interop summary | outputs of [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑2/‑3, UTS refs | `InteropSurface@Context` (+ UTS rows/twins) |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑5 `Emit_IndexTelemetryPin`** | Emit refresh input  | edition/policy changes + scope + payload pins  | telemetry to [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] (typed causes + payload pins)   |
| **[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]‑6 `Wire_To_SoTA_Pack`** | Provide shipping hook  | `InteropSurface@Context` + citations to upstream artefacts  | [[G.10 - SoTA Pack Shipping|G.10]] pack hooks (as cited payload; no serialisation mandated)  |

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:5 - Extensions (pattern‑scoped; non‑core)

[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] keeps provider/method specifics out of the kit core. Any such specificity appears as `GPatternExtension` blocks with stable **PatternScopeId**s. These modules are **wiring‑only**: they bind pins/editions/policies and cite the governing pattern rather than redefining semantics.

### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:5.1 - `G.13:Ext.ExternalIndexProviderWiring` *(Phase‑3 seed)*
...
### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:5.2 - `G.13:Ext.EmbeddingBasedAlignment` *(Phase‑3 seed; method‑specific wiring stub)*
...
**Uses:** `{[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[E.5.2 - Notational Independence|E.5.2]]}`
**⊑/⊑⁺:** `∅`
**RequiredPins/EditionPins/PolicyPins (minimum):**
...
### [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:5.3 - `G.13:Ext.EntityResolutionAndAliasDocking` *(interop‑specific; Phase‑3 seed)*
...
**Uses:** `{[[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.10 - Unified Lexical Rules for FPF|E.10]]}`
**⊑/⊑⁺:** `∅`
**RequiredPins/EditionPins/PolicyPins (minimum):**
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:6 - Archetypal grounding (informative; SoTA‑oriented)

**System.** *Software architecture portfolio design.*
Register an external scholarly index edition for “software architecture” concept neighborhoods. Align extracted technique/tactic claims into ClaimSheets and derive a CHR‑typed feature set (e.g., evidence depth, maturity). Use [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] to select a **set** of tactics under multi‑objective tradeoffs, and ship a SoTA pack that cites the interop surface.
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:7 - Bias‑Annotation (informative)
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:8 - Conformance Checklist (CC‑G13; applies when [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] surfaces are used)

1. **CC‑G13‑CoreRef.** *(normative)* [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] implementations **MUST** satisfy the *effective* [[G.Core - Part G Core Invariants|G.Core]] obligations declared by `G.13:4.1` (`GCoreLinkageManifest`), including trigger typing, Default Governing Definition Index citation, and crossing‑visibility pin discipline.
...
7. **CC‑G13‑EditionDisciplineForInteropCards.** *(local)* `ExternalIndexCard@Context` and `ClaimMapperCard@Context` **MUST** expose edition pins (`ExternalIndexRef.edition`, `ClaimMapperRef.edition`). Any interop surface published to UTS **MUST** cite the relevant `…Ref.edition` values (incl. `PlaneMapRef.edition?`, `ScaleEmbeddingSpecRef.edition?`) when present.
   ...
   In particular, interop transforms **MUST NOT** perform illicit arithmetic on ordinal/compare‑only scales (e.g., averaging or subtraction); any aggregation must be via lawful CAL operators with explicit scale legality (cite [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]] / `CC‑G0‑CSLC`).

8. **CC‑G13‑SoSFeaturesAreCHRTypedAndLegal.** *(local; governing-definition citing)* If `SoSFeatureTransform@Context` is used, produced SoS features **MUST** be CHR‑typed via `FeatureTypingRefs{CharacteristicId/ScaleId/CoordinateId}` (governed by [[G.3 - CHR Authoring for a CG‑Frame- Characteristics, Scales, Levels, Coordinates|G.3]]) and any legality/units obligations must be satisfied via CSLC/CG governing definitions (cite [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]] / [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]] / [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]]; do not invent interop‑local legality gates).
...
11. **CC‑G13‑NotationIndependence.** *(local)* Conformance is judged on the conceptual objects in `G.13:4.2`. Any serialisation is non‑normative and must not redefine semantics.
   *(Cites [[E.5.2 - Notational Independence|E.5.2]] for notation independence.)*

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:9 - Common Anti‑Patterns and How to Avoid Them
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:10 - Consequences
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:11 - Rationale
...
[[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]] resolves the tension by turning “interop” into **first‑class conceptual wiring**: cards/surfaces that pin editions, cite governing patterns, expose provenance hooks, and produce typed refresh causes, while leaving domain/tool specifics in `Extensions` (or Phase‑3 governing definitions).

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:12 - SoTA‑Echoing (post‑2015, for orientation; non‑normative)
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:13 - Relations

**Builds on:** [[G.Core - Part G Core Invariants|G.Core]].
**Imports:** [[G.2 - SoTA Harvester & Synthesis|G.2]], [[G.3 - CHR Authoring for a CG‑Frame- Characteristics, Scales, Levels, Coordinates|G.3]], [[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[G.7 - Cross‑Tradition Bridge Calibration Kit (BridgeMatrix → BridgeCards + BCT-Sentinels)|G.7]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.10 - SoTA Pack Shipping|G.10]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]], [[G.0 - Frame Standard and Comparability Governance - CG‑Spec|G.0]], [[F.17 - Unified Term Sheet (UTS)|F.17]], [[E.5.2 - Notational Independence|E.5.2]], [[E.18 - Transformation Flow Structure|E.18]].
**Publishes to:** UTS (twin labels where applicable); refresh inputs to [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]; shipping hook surfaces to [[G.10 - SoTA Pack Shipping|G.10]] (as cited publications or records).
**Relates to:** [[G.12 - DHC Dashboards (Discipline‑Health time‑series; admissible telemetry; generation‑first)|G.12]] (dashboards), [[G.8 - SoS‑LOG Bundles & Maturity Ladders|G.8]] (SoS-LOG bundle surfaces) when interop-derived publications or records are consumed there.

## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:14 - Author’s quick checklist (informative)
...
## [[G.13 - External Interop Hooks for SoTA Discipline Packs (conceptual)|G.13]]:End
