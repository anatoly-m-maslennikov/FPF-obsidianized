...
related:
  ...
  - "[[I.2 - Expanded Entry Disambiguation Cases|I.2]]"
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:1 - Problem Frame

FPF has many patterns. New users do not usually arrive saying "I need [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]" or "I need [[C.30.AD - Architecture Description Adequacy|C.30.AD]]." They arrive with project questions:
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:2 - Problem
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:3 - Forces
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:3.1 - Practice Grounding

| Practice family | Rule impact in [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] |
| --- | --- |
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4 - Solution - Assign Each Entry Publication Unit One Job
...
| [[I.2 - Expanded Entry Disambiguation Cases|I.2]] or other expanded cases | Longer entry-disambiguation cases only when compact first-entry scenarios and pattern Problem frames are insufficient. | Tutorial obligation for every pattern or replacement for pattern bodies. |
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.1 - readme First-Entry Scenario Rule
...
### [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.1.1 - First-Time Engineer Readability Rule
...
### [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.1.2 - Public Value Claim And Grounding Rule
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.2 - Preface Principle Rule
...
- first-principles-to-work through [[E.18 - Transformation Flow Structure|E.18]] transformation-flow structure and [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] P2W;
- mathematical lenses, formal-substrate declarations, mechanism import, and first-principles carry-through as distinct claims;
- ontology-first wording repair through [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[F.18 - Local‑First Unification Naming Protocol|F.18]], and [[F.19 - Ontology-First Plain Technical Rewriting|F.19]];
...
### [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.2.1 - Preface Plain-Engineering Narrative Rule
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.3 - Pattern Problem-Frame Rule
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.4 - First-Entry Terminology
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.5 - Public readme Section Single-Source Rule
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:4.6 - Projection and Authority Boundary
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:5 - Worked Slices

### [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:5.1 - Public Entry From A Project Question
...
The first governing pattern family is not a wording-repair pattern. It is [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] for architecture, with [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] applied when the project question narrows to comparison, local choice, evidence, or assurance. [[E.10 - Unified Lexical Rules for FPF|E.10]] is used only if the text hides the kind of architecture, evidence, decision, or publication claim being made.

### [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:5.2 - Duplicate First-Entry Row Discharge

A compact first-entry index row says:

```text
Architecture and diagrams:
  start with [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[C.30.AD - Architecture Description Adequacy|C.30.AD]], evidence, and dashboard patterns;
...
| "Diagrams" as publication or rendering use | `readme` scenario for descriptions, explanations, dashboards, or views of the same entity; `E.17.*`, [[A.15.4 - Work-Relevant Source Restoration|A.15.4]], or [[C.30.AD - Architecture Description Adequacy|C.30.AD]] when the claim is being governed. |
...
| "Evidence" | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or the evidence/assurance scenario when the project question is evidence or commitment. |
| "Dashboard" as same-entity or rendering concern | Publication-use or dashboard pattern material, not architecture itself. |
| "Compare alternatives" | Comparison and selected-set scenario plus [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], or [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]]. |
...
| A hard ambiguity between architecture, description, evidence, and comparison | [[I.2 - Expanded Entry Disambiguation Cases|I.2]] expanded entry-disambiguation case only if `readme`, ToC, and local Problem frames are insufficient. |
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:6 - Conformance Checklist
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:7 - Common Anti-Patterns
...
## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:8 - Relations
...
- [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] governs pattern form and pattern-local Problem-frame discipline.
- [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] checks entry, projection, and pattern-use discoverability during review and refresh.
- [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] evaluates whether corpus entry and projection material preserve quality without becoming pattern content.
- [[F.17 - Unified Term Sheet (UTS)|F.17]], [[F.18 - Local‑First Unification Naming Protocol|F.18]], [[F.19 - Ontology-First Plain Technical Rewriting|F.19]], [[E.10 - Unified Lexical Rules for FPF|E.10]], and [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] govern lexical, naming, and wording precision when entry cues hide FPF kinds or relations.
- [[I.2 - Expanded Entry Disambiguation Cases|I.2]] carries expanded entry-disambiguation cases only when compact public first-entry scenarios and local Problem frames are insufficient.
- ToC rows provide query and dependency cues; they do not replace public first-entry scenarios or governing pattern bodies.

## [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]]:End
