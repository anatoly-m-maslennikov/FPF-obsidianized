...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:1 - Problem frame
...
**Not this pattern when.** Not this pattern when only wording changes (`ConservativeRetextualization`), explanation becomes primary (`ExplanationFaithfulnessProfile`), the EntityOfConcern changes ([[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]), carrier work such as rendering, export, or OCR-style extraction is the current claim, or the receiving representation stays honest only by carrying its own narrower admissible use, non-admissible downstream use, declared source-loss mode, and source-bearing reopen card. In that last case, use `A.6.3.CSC Controlled Semantic Coarsening`.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:2 - Problem
...
5. representation factors governed near [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]] are discussed rhetorically rather than as explicit deltas.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:3 - Forces
...
- **Governing-pattern restraint.** This pattern must stay under [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], not swallow explanation governance, retargeting, bridge work, or carrier work.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4 - Solution — entityOfConcernRef-preserving representation-scheme transition under [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1 - Informal definition
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1.a - Pattern, case, and published rendering distinction

`RepresentationSchemeTransition` is a **pattern description** and a named specialization under [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]. Concrete entityOfConcernRef-preserving representation changes are passive episteme cases or published renderings reviewed under this pattern; the pattern itself does not act, decide, or publish.
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1.b - Local working vocabulary
...
**Recoverability-for-use rule.** If the declared admissible use is inspection, source-finding, comparison, or technical review, `RepresentationSchemeTransition` can close with entityOfConcernRef-preserving preservation, source-relation chain, representation-scheme delta, and loss or recoverability notes. If the declared admissible use is work-planning preparation, this pattern is admissible only for reversible preparation until [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] supplies the role, method, plan, and work source relation. If the declared admissible use is evidence or currentness, gate or release, assurance, commitment, bridge or substitution, or engineering justification, the case must name the downstream governing source relation; otherwise the receiving representation remains orientation or review use only.
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.2 - Scope and exclusions
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.2.a - User guidance
...
- If same-EntityOfConcern continuity fails, apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
- If the receiving representation stays honest only by carrying its own narrower-use card, declared source-loss mode, non-admissible downstream-use line, and source-bearing reopen, apply [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] Controlled Semantic Coarsening; do not keep the case here as ordinary representation-scheme transition.

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.2.b - What the user checks first
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.3 - Working-model first; explicit decision block only when the case is claim-bearing

Most entityOfConcernRef-preserving representation shifts stay human-usable and reviewable without turning every table, diagram, or structured rendering into a giant metadata block. This pattern therefore follows **[[E.14 - Human‑Centric Working‑Model|E.14]]'s working-model-first discipline**: ordinary non-latent cases need enough explicitness to show what stayed the same, what changed in representation and reasoning medium, what was lost or foregrounded, and when another governing pattern governs the case.
...
| `preservedEntityOfConcernRef` | The one [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] `entityOfConcernRef` preserved across the representation shift. |
| `receivingRepresentationOrRendering` | The receiving representation, diagram, table, functional description, decoded rendering, or publication rendering over that same `entityOfConcernRef`; if `entityOfConcernRef` changes, apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]. |
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.3.a - Working admissibility defaults
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4 - Direct and correspondence-mediated profiles
...
- the result remains under [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] only if same-entity conservativity is still reviewable by continuity witness and the correspondence does not silently import extra claims.
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4.a - Recurring same-entity representation moves
...
These are recurring move shapes under one specialization relation. They are not separate governing patterns and they do not override [[E.17 - Multi‑View Publication Kit|E.17]] face discipline.

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4.b - How the user states representation-factor and reasoning-medium change
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5 - Shared representation rule bundle

#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.a. Preservation rule
...
#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.a.1. Local conservativity witness
...
#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.b. Loss and reliability rule
...
#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.c. Governing-pattern boundary rule
...
#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.c.1. Decode-mediated entry condition
...
#### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.d. Composition and reopen rule
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.6 - Boundary trigger table
...
| --- | --- |
| `entityOfConcernRef`, EntityOfConcern kind, ontology frame, admissible predicate set, or invariant-bearing receiving rendering changes | Apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] or the ontology-facing governing pattern. |
| The receiving rendering is only a textual rewrite | Apply `ConservativeRetextualization`. |
| The primary job is teaching, narration, or explanation-facing rendering | Apply `ExplanationFaithfulnessProfile` unless EntityOfConcern or ontology-frame change makes [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] primary. |
| The work is rendering, export, upload, serialization, OCR-style extraction, parsing-style extraction, or other carrier work | Keep carrier work outside RT; start with the pattern governing carrier or extraction use, such as [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] when source extraction is the current question. |
...
| Problem formulation, temporal claim, dynamics claim, control claim, or transformation-flow claim becomes primary | Apply [[B.5.2 - Abductive Loop|B.5.2]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[E.18 - Transformation Flow Structure|E.18]], or the governing pattern for that claim. |
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5 - Archetypal grounding

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.1 - Same-entity text-to-table shift
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2 - Same-entity table-to-diagram shift
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.a - Correspondence-mediated text-to-table shift
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.b - Same-entity diagram-to-structured-notation shift
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.c - Functional-description diagram, table, or screen shift
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.3 - Boundary to textual rewrite
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4 - Boundary to explanation-facing renderings
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.a - Boundary to bridge-bearing comparison
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.b - Boundary to carrier work and export work
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.c - Boundary to coarsened dashboard view
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.5 - Boundary to decode-mediated latent cases
A user or decoding relation tries to restate a latent region or distributed feature cluster as explicit entity content or relation content. This stays outside the admissible entityOfConcernRef-preserving case under [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] unless the pinned source claim or publication, decoding relation or access relation, recoverability evidence, admissible-use value, and remaining user action are already present. Readable decoded output alone is not enough.

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.5.a - Guarded decode-mediated rendering
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:6 - Bias-Annotation
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7 - Conformance Checklist
...
### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7.1 - RT-Core ordinary checks
...
4. **CC-RT-8 — Preserve-vs-retarget governing pattern is explicit.**
   If the case fails the ordinary checks, the governing pattern for the changed claim is named explicitly ([[A.6.3.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], carrier work under [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], or another governing pattern).
5. **CC-RT-14 — Functional-description publication overread is blocked.**
   Functional diagrams, tables, screens, exports, parser results, and OCR results are kept separate from performed `U.Work`, gate passage, evidence, engineering justification, supervisory architecture, control architecture, and carrier work. OCR-style extraction and parsing-style extraction start with [[A.7 - Strict Distinction (Clarity Lattice)|A.7]]; same-entity representation work stays here only when source-relation chain, same EntityOfConcern, representation-scheme change, and loss notes remain visible.

### [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7.2 - RT-Conditional checks
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Hiding retargeting under representation language | a changed EntityOfConcern is mislabeled as same-entity representation work | apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] whenever `EntityOfConcernRef` changes |
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:9 - Consequences
...
- The pattern remains safely bounded by [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], explanation governance, and carrier work.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:10 - Rationale

This pattern is worth splitting out because representation changes are already happening in practice and they are not well served by treating every such case as either mere rewriting or full retargeting. Keeping the family under [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] preserves governing-pattern boundary while making representation-factor and recoverability evidence needs explicit.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:11 - SoTA Alignment: Adopted Invariants, Adapted Invariants, and Rejected Shortcuts
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12 - Relations

- **Builds on:** [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[A.6.2 - U.EffectFreeEpistemicMorphing - Effect‑free morphisms of epistemes|A.6.2]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.18 - Local‑First Unification Naming Protocol|F.18]]
- **Coordinates with:** `ConservativeRetextualization`, `A.6.3.CSC Controlled Semantic Coarsening`, `ExplanationFaithfulnessProfile`, `E.17.ID.CR ComparativeReviewUnit`, [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.9.1 - Bridge Stance Overlay|F.9.1]], [[E.18 - Transformation Flow Structure|E.18]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[B.5.2 - Abductive Loop|B.5.2]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], explicit decoding-access review
- **Impact radius:** primary touch [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]; selected edit companion [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; secondary review relation [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[E.17 - Multi‑View Publication Kit|E.17]], [[F.9 - Alignment & Bridge across Contexts|F.9]], decode-mediated recoverability review, transformation-flow interpretation under [[E.18 - Transformation Flow Structure|E.18]], and project-side governing patterns for claims not governed by this pattern
- **Boundary notes:** textual same-regime rewrites stay with `ConservativeRetextualization`; explanation-facing renderings stay with `ExplanationFaithfulnessProfile`; bounded comparative review cases apply `E.17.ID.CR ComparativeReviewUnit`; EntityOfConcern changes apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; coarsened source renderings apply [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]; bridge, work, evidence, assurance, gate, abductive, temporal, dynamics, and transformation-flow consequences remain bounded by explicit evidence and by the downstream governing pattern for the claim being made.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12a - Boundary with quantum-like state-representation shortcuts
...
1. Confirm that the EntityOfConcern stays the same. If it changes, RT no longer governs; apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
8. If yes, coordinate with the [[C.26 - Quantum-Like Modeling Lens|C.26]] state-representation coarsening admissibility section and state admissible use, non-admissible use, and return condition.
...
Use a fuller [[C.26 - Quantum-Like Modeling Lens|C.26]] coarsening record only when the shortcut becomes reusable, formal, empirical, high-stakes, or tied to comparative performance or tractability claims. In that fuller record, add the mechanism, baseline relation, non-admissible use, and QL cue needed for the additional-admissibility claim.
...
## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12b - [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When an entityOfConcernRef-preserving representation-scheme transition imports a contested or claim-bearing mathematical lens, [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] still governs the source and receiving representation schemes, entityOfConcernRef-preserving relation, preserved and lost scheme features, and representation-scheme-transition boundary. The applicable [[C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) may be cited only for adequacy of the mathematical lens used in that transition. It does not replace the representation-scheme-transition record or broaden the transition into bridge, evidence, or causal-claim-kind.

## [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:End
