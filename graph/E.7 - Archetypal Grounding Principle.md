...
## [[E.7 - Archetypal Grounding Principle|E.7]]:1 - Problem frame
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:2 - Problem
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:3 - Forces
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:4 - Solution — mandatory *Archetypal Grounding* subsection
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:5 - Archetypal Grounding (of this pattern itself)
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:6 - Conformance Checklist
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:7 - Consequences
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:8 - Rationale
...
## [[E.7 - Archetypal Grounding Principle|E.7]]:9 - Relations

* **Implements macro flow:** `pat:authoring/didactic‑architecture` ([[E.6 - Didactic Architecture of the Specification|E.6]])
* **References base types:** `pat:kernel/holon` ([[A.1 - U.Holon, U.System, and U.Episteme|A.1]]) (`U.System`, `U.Episteme`)
* **Interacts with bias guard‑rail:** `pat:guard/bias‑audit` ([[E.5.4 - Cross‑Disciplinary Bias Audit|E.5.4]]) via CC‑AG.3
* **Constrains:** Authoring template in `pat:authoring/pattern‑template` ([[E.8 - FPF Authoring Conventions & Style Guide|E.8]])

## [[E.7 - Archetypal Grounding Principle|E.7]]:End
