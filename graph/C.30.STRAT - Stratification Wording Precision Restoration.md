...
related:
  ...
  - "[[A.19.SPR - State-Family Precision Restoration|A.19.SPR]]"
  - "[[A.2 - Role Taxonomy|A.2]]"
  ...
  - "[[C.30.P - Architecture and Structure Precision Restoration|C.30.P]]"
  - "[[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]"
  - "[[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]]"
...
> **Type:** Architectural precision-restoration subpattern under [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]]
> **Status:** Stable
> **Normativity:** Normative unless explicitly marked informative

**Plain-name.** Stratification and architecture-operation source-label repair.

**Intent.** Recover source wording such as `layer`, `level`, `tier`, `stack`, `ladder`, `rung`, `block`, `expert`, `cache`, `router`, and `gate` by completing the [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] recovery row for that wording use: `semanticAreaBaseConcept`, `semanticAreaSenseFamily`, selected `ontologicalNeighborhood`, primary `EntityOfConcern` kind, encountered FPF kind or reference, relation to the primary `EntityOfConcern`, recovered kind, relation, or claim-use, source-use disposition, governing pattern, admissible use, non-admissible use, and remaining reader move. No conforming [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] use mints `U.Layer`, `U.Level`, `U.Tier`, `U.Stack`, `U.Ladder`, `U.Rung`, `U.Block`, `U.Expert`, `U.Cache`, or one universal `U.Stratification`.

**Builds on.** [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], [[F.18 - Local‑First Unification Naming Protocol|F.18]], [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]], [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]], and [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]].

**Coordinates with.** [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[C.30.ILC - Cross-Scope Architecture Residual Triage|C.30.ILC]], [[A.6.M - Module Relation Repair|A.6.M]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17 - Multi‑View Publication Kit|E.17]], [[C.29 - Mathematical Lens Use|C.29]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.2 - Role Taxonomy|A.2]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[C.11 - Decision Theory (Decsn-CAL)|C.11]].

**[[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] governing relation.** When [[E.10 - Unified Lexical Rules for FPF|E.10]] encounters a stratification or architecture-operation source label whose `ontologicalNeighborhood`, primary `EntityOfConcern` kind, recovered kind, relation, claim-use, source-use disposition, or governing pattern is hidden, [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] selects [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] only until those row fields are recovered or the wording is lowered to ordinary source label, quote-only wording, reduced-use cue, blocked use, or incomplete rewrite. [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] then stops at the source-label repair row; the governing pattern carries any recovered non-source-label claim or relation.

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:0 - Use this when
...
**Not this pattern when.** If the governing pattern is already recoverable by value, use it directly. Do not use [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] merely because a familiar word appears. If the wording is only ordinary source prose with no FPF-governed use, keep ordinary prose or quote-only wording and stop.

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:1 - Problem frame
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:2 - Problem
...
- making [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] govern all structure-like wording;
- making [[A.6.M - Module Relation Repair|A.6.M]] or [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] carry a duplicate local trigger registry;
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:3 - Forces
...
| Pattern placement vs ontological neighborhood | The placement is in the [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] pattern nest because the recurring first confusion is architecture or structure wording, but recovered claims and relations are governed by the pattern named in `C.30.STRAT:4.2`. |
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4 - Solution

Produce a `StratificationSourceLabelRepairNote` or an equivalent local rewrite. The note records the recovered [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] row fields for this source-label use. It is not itself the selected structure, relation, source publication, neighboring claim record, or governing-pattern result.
...
### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.1 - Recovery sequence
...
2. **Check cheap closure.** If there is no FPF-governed use, keep ordinary prose or quote-only wording and stop. If one small local rewrite restores the intended non-FPF use, close locally under [[E.10 - Unified Lexical Rules for FPF|E.10]].
...
6. **Project back to wording.** Produce the repaired wording, compact note, direct governing-pattern application, or non-use disposition. The replacement candidate is accepted only after it passes [[E.10 - Unified Lexical Rules for FPF|E.10]].
...
### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.2 - Ontological-neighborhood governing-pattern applications
...
| --- | --- | --- | --- |
| Control-structure neighborhood | `layer`, `level`, `tier`, sometimes `gate` | Control role, control relation, rate band, bounded context, and, when a supervisor-subholon relation is being made, [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]] supervisor-subholon relation. | [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] for control-structure view; [[B.2.5 - Supervisor-Subholon Feedback Loop|B.2.5]], dynamics, temporal, evidence, assurance, or gate patterns only when those claims are being made separately. |
| Selected-structure or structural-view neighborhood | `layer`, `level`, `stack`, `block`, `view` | Selected structure, hidden structure, lost structure, preserved structure, structural-view selection, correspondence or source-return boundary, and `ArchitectureOf@Context` relation when that relation is being made. | [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]], [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], or named [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] subpattern. |
| Module-interface and substitution neighborhood | `block`, `cache`, `router`, `expert`, sometimes `layer` or `stack` | Module boundary, interface specification, substitutability relation, variation point, conformance relation, or module-interface reliance boundary. | [[A.6.M - Module Relation Repair|A.6.M]]; not [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] once the module-interface relation is recovered. |
| Function-like or transformation-flow neighborhood | `block`, `expert`, `cache`, `router`, `gate`, sometimes `layer` | Transformation or effect claim, path-selection relation, graph node, graph path, graph crossing, architecture-to-transformation-flow relation, or flow valuation under [[E.18 - Transformation Flow Structure|E.18]]. | [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], or [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]]. |
| Characteristic, scale, or mathematical-lens neighborhood | `level`, `tier`, `ladder`, `rung`, `layer`, `stack`, `block` | Characteristic, scale, coordinate, value plus declared scoring method, comparison criterion or declared comparability relation, scale window, resolution, coarse-graining, preserved structure, lost structure, [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens result, and stop condition when the lens-use claim is being made. | [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], characterization pattern governing the claim, or [[C.29 - Mathematical Lens Use|C.29]]. |
| Episteme, publication, view, or source-use neighborhood | `stack`, `layer`, `section`, `view`, `cache`, `gate` | Description episteme, publication unit, publication face, publication form, carrier, source-currentness relation, source-use disposition, source-return condition, or publication label. | [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17 - Multi‑View Publication Kit|E.17]], or the publication or source-use pattern governing the claim. |
| State, currentness, temporal, or dynamics neighborhood | `cache`, `stable`, `level`, `readiness`, sometimes `gate` | Bearer kind, state frame, value set, validity window, currentness relation, dynamics claim, temporal-aspect or rate-band claim, authored temporal-claim adequacy, or reopen condition. | [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], or a state pattern or temporal pattern named by value. |
| Evidence, assurance, gate, work, decision, or causal-use neighborhood | `gate`, `proof`, `safety`, `decision`, `work`, `effect`, sometimes any source label used as authority | Evidence path, assurance argument, constraint-validity record, gate decision, work occurrence, decision record, causal-use record, and non-admissible overread. | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], or neighboring pattern governing that claim. |
...
| `ladder` and `rung` | Test ordinal or classification scale, declared maturity or readiness progression, [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use ladder or rung, publication taxonomy, or ordinary source-label non-use. Do not use ladder wording for an undeclared progression scale. |
...
| `expert` | In MoE-like prose, test submodel, subholon, specialized transformation, path-selection relation, candidate-selection relation, or actual role or enactment only when an [[A.2 - Role Taxonomy|A.2]] or [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] role or work claim is being made. |
...
### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.4 - Placement discipline
...
The pattern nest is `C.30.*` because the recurring first failure is architecture or structure wording in architecture-operation prose. That placement does not make [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] the governing pattern for non-source-label claims named in `C.30.STRAT:4.2`. The selected `ontologicalNeighborhood` and governing-pattern row decide which pattern governs the case.

### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.5 - Worked cases

| Wording | Repair |
| --- | --- |
| `The module layer is stable.` | Copy `layer` as source label. Test whether the selected neighborhood is module-interface, scale or comparison, publication or view, or state or temporal. Use [[A.6.M - Module Relation Repair|A.6.M]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] or [[C.29 - Mathematical Lens Use|C.29]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], or [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] only after the neighborhood and apparatus are recovered. |
| `The expert routes the token.` | In MoE prose, `expert` is not a human role by default. Test submodel or subholon, specialized transformation, path-selection relation, architecture-to-transformation-flow relation, candidate selection, or actual role or enactment. Use [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[A.2 - Role Taxonomy|A.2]], or [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] only for the recovered neighborhood. |
...
| `The LCA upper layer guarantees safety.` | Use [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] only to recover whether `layer` belongs to the control-structure neighborhood. Then [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] records control roles, relations, rate band, and bounded context. Safety proof or assurance is governed by [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[G.6 - Evidence Graph & Provenance Ledger|G.6]], dynamics, temporal, and gate patterns. |
| `This gate selects the winning architecture.` | If `gate` is a neural-network gating function or router, use [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] or [[E.18 - Transformation Flow Structure|E.18]]; if it is a project gate decision, use [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; if it is candidate selection, use [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] or [[C.11 - Decision Theory (Decsn-CAL)|C.11]]. The label alone decides none of these. |

### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.5a - Filled repair note
...
StratificationSourceLabelRepairNote:
  ...
  governingPatternRef: [[A.6.M - Module Relation Repair|A.6.M]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], or [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for cache apparatus when recovered; [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.29 - Mathematical Lens Use|C.29]], or [[C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]] for scale or lens use when recovered; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], or [[G.6 - Evidence Graph & Provenance Ledger|G.6]] for evidence or assurance only when that claim is being made
...
A compact local rewrite can therefore say: `The response cache is a candidate state-bearing architecture structure. Architecture scaling, mathematical-lens use, proof, and assurance claims are separate claims; apply [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.29 - Mathematical Lens Use|C.29]], [[C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], or [[G.6 - Evidence Graph & Provenance Ledger|G.6]] only when one of those claims is being made.`

### [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:4.6 - Lowering and reopen conditions
...
- a direct governing pattern becomes recoverable and [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] no longer buys action guidance;
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:5 - Archetypal Grounding
...
| Admissible move | Apply [[A.6.M - Module Relation Repair|A.6.M]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], or [[C.11 - Decision Theory (Decsn-CAL)|C.11]] only after the ontological neighborhood is recovered by value. | Apply [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17 - Multi‑View Publication Kit|E.17]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[A.3.3 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], or [[C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] only after the publication named by value, episteme, state, temporal-aspect/rate-band claim, or authored temporal-claim adequacy is recovered. |

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:6 - Bias-Annotation
...
This pattern intentionally biases away from lexical replacement and toward ontology-first recovery. The mitigation is the cheap-closure rule: ordinary source prose stays ordinary, quote-only wording stays quote-only, and already recovered cases skip [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]].

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:7 - Conformance checklist
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:8 - Common Anti-Patterns and How to Avoid Them
...
| [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] takeover | Any structure-like word is treated as governed by [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] because it sounds architectural. | Choose by selected `ontologicalNeighborhood`; non-source-label claims are governed by the patterns named in `C.30.STRAT:4.2`. |
| Local trigger fanout | [[A.6.M - Module Relation Repair|A.6.M]], [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], [[C.31 - Modularity and Reusable Structure Characteristics|C.31]], or another subject pattern copies a growing label table. | Keep one thin pointer to [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] and keep the subject pattern to its own invariant. |
| Expert-as-role false positive | `expert` in MoE prose becomes an [[A.2 - Role Taxonomy|A.2]] role-enactor claim by word alone. | Treat as source label for submodel, transformation, path selection, or candidate selection unless an [[A.2 - Role Taxonomy|A.2]] or [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] role or work claim is actually being made. |
| Gate-as-gate-decision false positive | A gating function, UI label, or source word becomes gate passage. | Use [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only for actual constraint-validity or gate-decision claims; otherwise use the function, flow, publication, or ordinary-label disposition named by value. |

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:9 - Consequences
...
| Subject patterns avoid copied trigger registries. | Subject patterns need accurate thin pointers to [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] and still keep their own invariants precise. |
...
## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:10 - Rationale
...
The pattern is placed under [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] because architecture and structure prose is the recurring entry point. The placement does not make [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] the governing pattern for every recovered case. If the recovery result is outside source-label repair, the governing pattern named in `C.30.STRAT:4.2` carries the recovered claim content.

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:11 - SoTA-Echoing
...
Internal FPF current practice is the governing source here: [[E.10 - Unified Lexical Rules for FPF|E.10]] supplies trigger handling, [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] supplies the recovery architecture, [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] supplies architecture and structure wording repair, [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] supplies apparatus-vs-usability discipline, and governing patterns carry recovered cases. The `Solution`, checklist, worked cases, and relations in this pattern change because that source-use disposition rejects lexical replacement and trigger-table fanout.

**Currentness front.** Recheck this pattern when [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] changes the recovery row fields, [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] changes architecture or structure wording repair, [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] changes apparatus policy, or a more source-label realization pattern now governs a label family currently repaired here. The smallest changed locus is the affected row field, Relations entry, worked case, or subject-pattern thin pointer; do not rebuild a local trigger registry.

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:12 - Relations

- [[E.10 - Unified Lexical Rules for FPF|E.10]] catches the trigger and selects this pattern only when stratification or architecture-operation source-label recovery is needed.
- [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] supplies the recovery architecture, placement rule, and anti-fanout discipline.
- [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] remains the broader architecture and structure wording repair. [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] is the narrower stratification source-label realization when those labels recur with stable recovery apparatus.
- [[A.6.M - Module Relation Repair|A.6.M]] governs only recovered module-interface relation and interface-specification cases.
- [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] governs only recovered control-structure view cases with control roles, relations, rate bands, control-layer labels, and bounded context.
- [[C.31 - Modularity and Reusable Structure Characteristics|C.31]] and [[C.31.RSA - Reusable Structure Accounting|C.31.RSA]] govern only recovered characteristic, reusable-locus, bespoke-residue, `accountingBasisRef`, or report-only share cases.
- [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[E.17 - Multi‑View Publication Kit|E.17]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[E.18 - Transformation Flow Structure|E.18]], [[C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[C.29 - Mathematical Lens Use|C.29]], [[C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[G.6 - Evidence Graph & Provenance Ledger|G.6]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.2 - Role Taxonomy|A.2]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], and [[C.11 - Decision Theory (Decsn-CAL)|C.11]] carry their recovered cases when the case is named by value.

Neighboring claims stay with their governing patterns: [[A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] for selected-structure EntityOfConcern, [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] for grounded architecture and selected-structure adequacy, [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]] for architecture and structure precision restoration, [[C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] for structural-view adequacy, [[C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]] for control-structure view adequacy, [[A.6.M - Module Relation Repair|A.6.M]] for module-interface repair, [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] for function-use repair, [[E.18 - Transformation Flow Structure|E.18]] for graph, path, crossing, and flow-valuation discipline, [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] for characterization, [[C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use, [[C.2.P - Epistemic Precision Restoration|C.2.P]] for source and publication relation repair, and the non-source-label governing patterns named in `C.30.STRAT:4.2`. [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] governs stratification wording and architecture-operation source-label repair only.

## [[C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]]:End
