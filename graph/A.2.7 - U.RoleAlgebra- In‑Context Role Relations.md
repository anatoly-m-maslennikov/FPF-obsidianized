...
**Builds on:** [[A.1.1 - U.BoundedContext Semantic Frame|A.1.1]] **`U.BoundedContext`**, [[A.2 - Role Taxonomy|A.2]] **Role Taxonomy**.
**Coordinates with:** [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] **`U.RoleAssignment`**, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] **Role–Method–Work Alignment**.

## [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:1 - Problem frame
...
* No cross‑Context equivalence by label; cross‑Context reuse is **Bridge‑only** ([[F.9 - Alignment & Bridge across Contexts|F.9]]).
...
## [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:2 - Solution (the three operators)

Role algebra relates **role types** inside **one** `U.BoundedContext`. It is **not** mereology.

### [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:2.1 - Specialization (narrower assignment)
...
### [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:2.2 - Incompatibility (conceptual role incompatibility)
...
### [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:2.3 - Bundles (conjunctive requirement)
...
## [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:3 - Relations

**Builds on / depends on**

* **[[A.1.1 - U.BoundedContext Semantic Frame|A.1.1]] `U.BoundedContext`** — the locality boundary within which the algebra holds.
* **[[A.2 - Role Taxonomy|A.2]] Role Taxonomy** — role families and context‑local naming.

**Used by**

* **[[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`** — avoids chained assignments; uses `≤/⊥/⊗` for checking and validation.
* **[[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role–Method–Work Alignment** — expands `requiredRoles` and enforces SoD requirements.
* **D.2** ethics/governance patterns — encode SoD and independence via `⊥`.

## [[A.2.7 - U.RoleAlgebra- In‑Context Role Relations|A.2.7]]:End
