...
**Not this pattern when.** Not this pattern when the current claim is a dated performed work occurrence ([[A.15.1 - U.Work|A.15.1]]), a `SlotFillingsPlanItem` ([[A.15.3 - SlotFillingsPlanItem|A.15.3]]), a visible source cue needing work-relevant restoration ([[A.15.4 - Work-Relevant Source Restoration|A.15.4]]), a method ([[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]), a method description ([[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), evidence or assurance ([[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), a gate or constraint decision ([[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]), publication-use behavior ([[E.17 - Multi‑View Publication Kit|E.17]]), or a declarative representation overread as a work-control or method claim ([[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]).

## [[A.15.2 - U.WorkPlan|A.15.2]]:1 - Context (plain‑language motivation)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:2 - Problem (what breaks without `WorkPlan`)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:3 - Forces (what we must balance)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:4 - Solution - `U.WorkPlan` as the time-bound intention for `U.Work`

### [[A.15.2 - U.WorkPlan|A.15.2]]:4.1 - Definition
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:4.2 - `PlanItem` values (what a `WorkPlan` is made of)
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:4.3 - Clear distinctions for schedule, process, and workflow wording
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:4.4 - Plan mereology (composition of plans ≠ composition of methods or runs)
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:4.5 - How `WorkPlan` Meets `Work` (Fulfilment and Variance)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:5 - What a good `WorkPlan` states (review checklist)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:6 - Archetypal grounding (parallel domains)

### [[A.15.2 - U.WorkPlan|A.15.2]]:6.1 - Hospital OR day plan (shift rota + cases)
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:6.2 - Fab maintenance weekend (asset reservations)
...
### [[A.15.2 - U.WorkPlan|A.15.2]]:6.3 - Data‑center rollout (multi‑context plan)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:7 - Bias‑Annotation (as in E‑cluster)
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:7a - Conformance Checklist
...
| CC-A15.2-3 | Proposed `U.RoleAssignment`s remain intended assignments until checked for the performed-work interval by [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and [[A.15.1 - U.Work|A.15.1]]. | The plan does not accept the role assignment for that interval by publication alone. |
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:7b - Common Anti-Patterns and How to Avoid Them
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:7c - Consequences
...
| P2W carry-through can prepare work without pretending work already happened. | Use [[A.15.1 - U.Work|A.15.1]], [[A.15.3 - SlotFillingsPlanItem|A.15.3]], [[A.15.4 - Work-Relevant Source Restoration|A.15.4]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only when the performed-work, planned-baseline, source-restoration, evidence, assurance, gate, or constraint relation becomes current. |

## [[A.15.2 - U.WorkPlan|A.15.2]]:7d - SoTA Alignment
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:7e - Relations

* **Builds on:** [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role-Method-Work Alignment, [[A.15.1 - U.Work|A.15.1]] `U.Work`, [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`, `U.Method`, and `U.MethodDescription`.
* **Coordinates with:** [[A.15.3 - SlotFillingsPlanItem|A.15.3]] for `SlotFillingsPlanItem` values, [[A.15.4 - Work-Relevant Source Restoration|A.15.4]] for work-relevant source restoration, [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence-provenance relations, [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] and [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gates and constraint decisions, and [[E.17 - Multi‑View Publication Kit|E.17]] for publication-use questions.
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:8 - P2W WorkPlanning Use Relation

When [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] reaches WorkPlanning, `U.WorkPlan` states intended work occurrences, planned windows, intended role requirements, planned constraints, resource budgets, acceptance targets, evidence-reference notes, source-currentness requests, and `PlanItem` values.
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:9 - Launch-Value Boundary For P2W
...
## [[A.15.2 - U.WorkPlan|A.15.2]]:10 - Lowering, Repair, and Refresh Conditions
