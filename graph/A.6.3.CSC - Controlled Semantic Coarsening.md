...
**Builds on.** [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[A.6.3.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], and [[F.18 - Local‑First Unification Naming Protocol|F.18]].

**Coordinates with.** [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[F.9 - Alignment & Bridge across Contexts|F.9]], [[F.9.1 - Bridge Stance Overlay|F.9.1]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], and [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].

## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:1 - Problem frame

**EntityOfConcern preservation discipline.** Controlled coarsening stays under entityOfConcernRef-preserving viewing only when the [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] `entityOfConcernRef` remains stable. When the source-bearing side is a declared source set, its membership, loss account, and reopen condition must also be bounded; that source-set discipline does not substitute for same-EntityOfConcern preservation. Any `entityOfConcernRef` shift leaves this pattern for [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
**Neighboring project records and governing patterns.** Ordinary same-entity wording belongs under [[A.6.3.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]; representation-scheme change belongs under [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]; explanation-facing class discipline belongs under [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]; bounded comparison belongs under [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]; bridge or substitution use belongs under [[F.9 - Alignment & Bridge across Contexts|F.9]] or [[F.9.1 - Bridge Stance Overlay|F.9.1]]; changed EntityOfConcern belongs under [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; work authority requires [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]-governed selected method, `U.WorkPlan`, performed `U.Work`, work-result record, or result-measurement record; gate or adjudication authority requires [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]-governed project records.
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:2 - Problem
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:3 - Forces
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4 - Solution
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.1 - Ordinary mini-card
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.2 - First check
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.3 - Ordinary vs claim-bearing
...
- `sourceBearingSideRef` and `coarsenedRenderingRef` when the source-bearing side, coarsened rendering, `PublicationUnit`, publication face, [[E.17 - Multi‑View Publication Kit|E.17]] publication-face kind value `publication face/form`, [[E.17 - Multi‑View Publication Kit|E.17]] publication-face kind value `interop publication form`, or carrier could be confused;
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.4 - Branch and admissible-use discipline
...
Aggregation or quotient-like coarsening remains inside this pattern only while the coarsened rendering keeps one bounded selected set, slice, case bundle, or alternative bundle explicit as the EntityOfConcern or selected set. If several entities, alternatives, or slices become one new class-level EntityOfConcern or proxy EntityOfConcern, apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].

### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.6 - Neighbor exits

| If the primary question is now... | Use this governing FPF pattern or `authoritySourceRef` destination |
| --- | --- |
| Same-entity textual rewording without a separate narrower-use card | [[A.6.3.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] |
| Representation scheme or reasoning-medium shift | [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] |
| Explanation-facing class over existing source `U.Episteme` or `U.EpistemePublication` | [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] |
| Bounded comparison over already pinned source epistemes or source publications | [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] |
| Equivalence, substitution, interop row, or bridge or substitution use | [[F.9 - Alignment & Bridge across Contexts|F.9]] |
| Stance over an already published bridge card | [[F.9.1 - Bridge Stance Overlay|F.9.1]] |
| Changed EntityOfConcern or proxy EntityOfConcern | [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] |
| Carrier, export, OCR or parsing, or front-end behavior is primary | [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] first; then [[A.6.3.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], or interpretation sources only if meaning-bearing structure, loss, retargeting, or interpretive lift is live |
| Briefing treated as work plan, work authority, or execution cue | [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] |
| Gate, approval, assurance, or adjudication authority | [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] |
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.7 - Well-formedness constraints
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:5 - Archetypal Grounding
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:5.1 - Worked slices
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7 - Conformance Checklist
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7.1 - CSC-Core
...
### [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7.2 - CSC-Conditional
...
| **CC-CSC-13 (Source, rendering, and publication separation).** | Claim-bearing cases SHALL separate source-bearing side, coarsened rendering, `PublicationUnit`, publication face, [[E.17 - Multi‑View Publication Kit|E.17]] publication-face kind value `publication face/form`, [[E.17 - Multi‑View Publication Kit|E.17]] publication-face kind value `interop publication form`, and carrier when those could be confused. | Keeps `PublicationUnit`, publication face, and carrier roles distinct. |
...
| **CC-CSC-15 (Interop simplification).** | Exceptional interop-facing simplifications SHALL name the operative relation kind and hand bridge or equivalence pressure to [[F.9 - Alignment & Bridge across Contexts|F.9]] or [[F.9.1 - Bridge Stance Overlay|F.9.1]]. | Prevents simplified relation language from carrying bridge or substitution use. |
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Stance cure | `projection` or `nonEquivalent` is used instead of a bridge card or source return. | Apply [[F.9 - Alignment & Bridge across Contexts|F.9]] or [[F.9.1 - Bridge Stance Overlay|F.9.1]] for the bridge claim. |
| Briefing-as-work | A summary becomes work plan, action cue, gate, or approval. | Use [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for the work, constraint, or gate claim. |
...
| Aggregation EntityOfConcern shift | A quotient or bundle turns several entities or alternatives into one new proxy EntityOfConcern. | Apply [[A.6.4 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] rather than treating EntityOfConcern shift as a same-lineage source-to-rendering case. |

## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:9 - Consequences
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:10 - Rationale
...
## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:11 - SoTA Alignment: Adopted Or Adapted Invariants And Rejected Shortcuts
...
- **Governing-pattern relation wording:** this pattern is a `specialization under [[A.6 - Signature Stack & Boundary Discipline|A.6]].3`, not a bundle, suite, profile, overlay, or review pack. Its governing role is limited to the controlled-coarsening relation itself.

## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:12a - Boundary with quantum-like state-representation coarsening
...
8. If yes, coordinate with the [[C.26 - Quantum-Like Modeling Lens|C.26]] state-representation coarsening admissibility section while leaving CSC as the controlled-use boundary for the coarsened version.
...
Use a fuller CSC and [[C.26 - Quantum-Like Modeling Lens|C.26]] coarsening boundary record only when the coarsened state representation will be reused, formalized, empirically compared, used in a high-stakes decision, or tied to a comparative performance claim:
...
- a fuller [[C.26 - Quantum-Like Modeling Lens|C.26]] coarsening admissibility record only when a QL cue remains and the claim is reusable, formal, empirical, high-stakes, or comparative-performance-bearing;
- no QL wording when the case is only summary, anonymization, diagramming, audience adaptation, or ordinary coarsening.

## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:12b - [[C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When controlled semantic coarsening depends on mathematical abstraction, quotienting, coarse-graining, or a learned coarse representation, [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] still governs the source-bearing return condition, narrowed admissible use, non-admissible downstream claim, and coarsened rendering. The applicable [[C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) may be cited only for adequacy of the mathematical abstraction or coarse-graining lens. It does not make the coarsened rendering a bridge, replacement source, evidence record, or causal-use admissibility.

## [[A.6.3.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:End
