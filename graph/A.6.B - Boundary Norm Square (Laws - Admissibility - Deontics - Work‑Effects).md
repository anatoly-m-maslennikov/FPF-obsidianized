...
> **Status:** Stable
> **Normativity:** Normative (unless explicitly marked informative)
> **Placement:** Part A → [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]] (matrix module; referenced by [[A.6 - Signature Stack & Boundary Discipline|A.6]] cluster overview)
> **Builds on:** [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] (authoring template), [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] (`U.Signature`), [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (`U.Mechanism`), [[A.6.3 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] (`U.EpistemicViewing`), [[E.17 - Multi‑View Publication Kit|E.17]].0/E.17 (MVPK + “no new semantics” faces), [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] (EntityOfConcern and Description-episteme boundary; specification-use and publication-carrier distinction), [[F.18 - Local‑First Unification Naming Protocol|F.18]] (promise/utterance/commitment), [[E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary; specification-use/refinement discipline), [[E.10 - Unified Lexical Rules for FPF|E.10]] publication face, form, unit, and carrier discipline
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:0 — Conventions
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:1 — Problem frame
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:2 — Problem
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:3 — Forces
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:4 - Solution — the Boundary Norm Square

### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:4.1 - Two independent distinctions
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:4.2 — The square
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:4.3 — Canonical placements in the Signature Stack
...
A published view **MUST NOT** introduce new semantic claims outside this L/A/D/E-classified claim set. **[[E.17 - Multi‑View Publication Kit|E.17]] (MVPK)** is a specialization that enforces this rule for a fixed set of publication face kinds.

## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:5 — Quadrant specifications

This section is the normative “API” of the square: what each quadrant is for, how it is written, and what it must not contain.

### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:5.1 — Quadrant L: Laws & Definitions
...
**[[A.7 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `L-*` claims are **Descriptions**: they specify semantics of the signature/mechanism description, not work.
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:5.2 — Quadrant A: Admissibility & Gates
...
**[[A.7 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `A-*` claims are **Descriptions** of a mechanism gate. They are not “what a client must do”; they are “what the mechanism admits”.
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:5.3 — Quadrant D: Deontics & Commitments
...
**Canonical payload (recommended; lintable).** When a `D-*` claim is intended to be lintable/reusable, it **SHOULD** be representable as a `U.Commitment` record ([[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]]). Default fields to make explicit:
...
* A `D-*` statement **MUST NOT** use “the system/service/interface/spec” as the grammatical subject unless the accountable role/party is explicitly named (so the statement is representable as a `U.Commitment` with an explicit `subject`, [[A.2.8 - U.Commitment (Deontic Commitment Object)|A.2.8]]). (**[[F.18 - Local‑First Unification Naming Protocol|F.18]]** is a lexical anchor only.)
...
**[[A.7 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `D-*` claims are primarily **about Objects** (roles/agents and their duties) or **about Carriers** (retention/exposure duties), but they are still written as **Descriptions**.
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:5.4 — Quadrant E: Work‑Effects & Evidence
...
2. **Carrier class/schema reference** ([[A.7 - Strict Distinction (Clarity Lattice)|A.7]] Carrier) that bears the evidence
...
**[[A.7 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `E-*` claims are primarily **Carrier‑anchored**: they assert what carriers exist and how they relate to observed work.
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6 — Cross‑quadrant link discipline
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.1 — Explicit reference rule
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2 — Canonical cross‑quadrant dependency patterns

These patterns are valid (and common). The square becomes operational when these links are used systematically.

#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2.1 - (D → A) Duty-to-gate linkage
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2.2 - (E → A) Evidence-for-gate linkage
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2.3 - (D → E) Duty-to-evidence linkage
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2.4 - (A/E → L) Semantic grounding linkage
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.2.5 - (D → L) Governance-to-definition linkage
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.3 — The “triangle decomposition” for mixed sentences
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:6.4 — Dependency direction (no “upward” imports)
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:7 — Mini-register: Claim Register (informative, recommended)
...
| ID | Quadrant | Statement (verbatim) | Canonical location (section or publication unit) | Stack layer | [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] primary layer | viewRef | viewpointRef | References | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
* **[[A.7 - Strict Distinction (Clarity Lattice)|A.7]] primary side** is the claim’s primary referent (`EntityOfConcern`, Description episteme, or publication carrier), even though the claim is always written as a Description episteme.
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8 - Archetypal Grounding (Tell–Show–Show)

> **Informative.** Examples for learning the square; they do not add requirements beyond [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:10.

### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.1 - Tell (universal rule)
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.2 - Show #1: Effect signature vs handler (post‑2015 effect systems)
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.3 - Show #2: ML evaluation protocol boundary (reproducibility discipline)
...
### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4 — Worked Rewrite Kit (informative, recommended)

> **Informative.** This kit is a worked, copy‑pasteable restatement of [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]’s rules (atomicity, L/A/D/E routing, explicit references, triangle decomposition, and no‑upward dependencies). If anything here conflicts with [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]], **[[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]] is authoritative**.

#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.0 - Goal
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.1 - Micro-procedure (Atomize → Route → Triangle → Link → Anchor → Recompose)
...
**Step 5 — Anchor (minimal [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] discipline).**
...
**Optional drift-control.** Add each L/A/D/E-classified claim verbatim to a Claim Register row ([[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:7) with canonical location + references so faces can cite by ID without paraphrase.
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.2 - Anti-pattern (quick)
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.3 - Example 1 — Software engineering (SLO-ish API latency)

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.3.1 - Draft sentence (non-conformant)

> “This API guarantees p95 latency < 200ms.”

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.3.2 - Atomize + Route (L/A/D/E)
...
##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.3.3 - Triangle decomposition (explicit)
...
##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.3.4 - Readable recomposition
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.4 - Example 2 — Mechanical engineering (fit / coaxiality)

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.4.1 - Draft sentence (non-conformant)

> “This fit ensures coaxiality.”

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.4.2 - Atomize + Route
...
##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.4.3 - Readable recomposition
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.5 - Example 3 — Management (project “approved/aligned”)

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.5.1 - Draft sentence (non-conformant)

> “The project is approved.”

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.5.2 - Atomize + Route
...
##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.5.3 - Readable recomposition
...
#### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.6 - A compact “recomposition pattern” you can reuse verbatim

##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.6.1 - Tech register (2–5 lines)
...
##### [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:8.4.6.2 - Plain register (1 paragraph)
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:9 — Bias‑Annotation
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:10 — Conformance Checklist
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:11 - Common Anti‑Patterns and How to Avoid Them
...
| **Interface‑as‑promiser**    | “The API promises/guarantees …”                    | Category error ([[F.18 - Local‑First Unification Naming Protocol|F.18]]): epistemes don’t promise              | Identify committing role (`D-*`), measured property (`E-*`), and metric definition (`L-*`). |
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:12 — Consequences
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:13 — Rationale
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:14 — SoTA‑Echoing (post‑2015 practice alignment)

> **Informative.** Alignment notes; not normative requirements.

**Representative sources (post‑2015; illustrative).** See also [[A.6 - Signature Stack & Boundary Discipline|A.6]]:11 for a fuller list.
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:15 — Relations

* **Used by [[A.6 - Signature Stack & Boundary Discipline|A.6]]:** supplies the canonical matrix and cross‑quadrant link discipline that [[A.6 - Signature Stack & Boundary Discipline|A.6]] references as “Boundary Discipline Matrix”.
* **Constrains [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] (`U.Signature`):** enforces that `L-*` laws are truth‑conditional and do not include admissibility predicates.
* **Constrains [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (`U.Mechanism`):** enforces that admissibility lives in `AdmissibilityConditions` (`A-*`) and that evidence semantics are routed as `E-*` with carrier anchors.
* **Requires [[A.7 - Strict Distinction (Clarity Lattice)|A.7]]:** anchors quadrants to `EntityOfConcern`, Description episteme, or publication carrier so agency and evidence are not misattributed.
...
## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:15a - Probe-coupled boundary claim routing
...
5. Apply [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] and [[F.18 - Local‑First Unification Naming Protocol|F.18]] to reusable relation words; apply [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] to evidence; apply [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] to assurance; apply [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] to measurement; apply [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] to the remaining probe-coupled support load.
...
- an ordinary [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]] L/A/D/E-classified claim set when no QL support load remains;
- a [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] route only for the remaining probe-coupled state-reading part;
- an A.10/B.3/C.16/F.9 route when evidence, assurance, measurement, or bridge work is the real entry load.

Do not write "the boundary is quantum-like" as one unL/A/D/E-classified claim. The action is: split the claim, classify the pieces, then decide whether [[C.26.1 - Probe-Coupled Boundary Interaction|C.26.1]] still has a remaining job.

## [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]:End
