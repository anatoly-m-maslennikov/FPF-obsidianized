...
builds_on:
  ...
  - "[[B.4 - Canonical Evolution Loop|B.4]]"
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:1 - Problem frame
Observation rarely yields a ready anomaly, [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] invitation, or hypothesis in one step. Between low-articulation cue preservation and endpoint governance through governing patterns, the cluster needs one explicit route-bearing seam that can publish route plurality or route selection without pretending that the cue already belongs to a governing pattern.

That seam begins **after** `U.PreArticulationCuePack`. Cue preservation may exist before routing. [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]] begins only when route publication itself becomes worth making explicit.

## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:2 - Problem
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:4 - Solution
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:4.1 - `RoutedCueSet` shape
...
`RoutedCueSet` is not itself the late endpoint. `articulationThresholdStatus` and `closureStatus` report guard state only; their governance remains with [[C.2.4 - U.ArticulationExplicitness|C.2.4]] and [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], and route discrimination may additionally cite [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]] or [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]] when anchoring or representation-factor differences are load-bearing.
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:4.2 - Starter route family and conditional extension species
...
#### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:4.2.1 - Specialization-sensitive extension route family
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:4.3 - Projection discipline
...
- `U.AbductivePrompt` under [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]],
- a later typed endpoint-entry publication under [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], or [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]],
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:5 - Archetypal Grounding
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:6 - Bias-Annotation
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:7 - Conformance Checklist
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-1` Observe output **SHALL NOT** be forced directly into `AnomalyStatement` when articulation threshold is not yet met.
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-2` A routed cue set **SHALL** name its `candidateRouteSet`.
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-3` When route selection occurs, `routeDecision`, `selectedRoute`, and `routeRationale` **SHALL** be explicit.
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-4` `publicationFaceRefs` **MAY** be named, but route-bearing form and publication face **SHALL NOT** be collapsed.
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-5` `RoutedCueSet` **SHALL NOT** silently masquerade as a late endpoint governing pattern.
- `CC-[[B.4 - Canonical Evolution Loop|B.4]].1-6` When a specialization-sensitive route is kept live, the route package **SHALL** name the declared task family or utility target, the current budget window if known, the missing discriminator still needed, and the downstream governing pattern that would become admissible if the discriminator is satisfied.

## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:9 - Consequences
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:10 - Rationale
[[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]] provides the route-bearing seam between cue preservation and endpoint or abductive entry. It keeps route publication explicit without forcing cue packs to become route records.

## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:11 - SoTA-Echoing
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:12 - Relations
- Builds on: [[B.4 - Canonical Evolution Loop|B.4]], [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[C.2.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]].
- Coordinates with: [[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]], [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]], [[B.5.2 - Abductive Loop|B.5.2]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[F.9.1 - Bridge Stance Overlay|F.9.1]].
- Constrains: pre-abductive route publication.

## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:13 - Worked Route Sets

### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:13.1 - Multi-route operator case
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:13.2 - Inquiry case
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:13.3 - Invalid direct jump
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:13.4 - Specialization-route and nonhuman-utility split
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:14 - Keeping route plurality useful
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:14.1 - Minimal route package
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:14.2 - Selected route is not endpoint governance
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:14.3 - Review prompt and threshold reminder
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:14.4 - Deferred selection and route splitting
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:15 - Migration and worked continuation boundaries

[[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]] governs route publication, not abductive reasoning, lexical repair, deontic commitment, or work execution. Those belong to governing patterns once the next publication is explicit enough to carry them.

### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:15.1 - Migration from anomaly-first prose
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:15.2 - Intervention vs inquiry split
...
[[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]] preserves both without forcing one to swallow the other.

### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:15.3 - Requirement-route overreach
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:15.4 - Leaving the seam
...
- explicit evaluative family selection for [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]],
- explicit [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] family selection,
- explicit prompt question for [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]],
- explicit requirement or commitment head for requirement-facing governing patterns,
- or explicit [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] hook for method, work-plan, or work-occurrence use.
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20 - Route Evidence and Discrimination Package

### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20.1 - Evidence-per-route rule
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20.2 - Discriminator publication
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20.3 - Multi-route state is not yet a lineage fork
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20.4 - Projection restraint
...
### [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:20.5 - Review test for false single-route certainty
...
## [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]:End
