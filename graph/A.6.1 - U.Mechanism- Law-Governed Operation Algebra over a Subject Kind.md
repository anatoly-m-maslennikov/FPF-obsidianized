...
fpf_id: "A.6.1"
title: "U.Mechanism: Law-Governed Operation Algebra over a Subject Kind"
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:1 - Problem frame
...
**First useful move.** Write the mechanism as an [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] Signature Block, then add only the mechanism-specific fields: `OperationAlgebra`, `LawSet`, `AdmissibilityConditions`, `Transport`, `GammaTimePolicy`, `PlaneRegime`, and `Audit`. If cross-context use is current, name the Bridge and the Reliability penalty relation before any reuse claim is made.
...
**Not this pattern when.** If the claim is only a reusable declaration with no operation algebra and no admissibility predicates, use [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]]. If the claim is a semantic way of doing, use [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]. If the claim is an episteme describing that way, use [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]. If the claim is planned or dated work, use [[A.15.2 - U.WorkPlan|A.15.2]] or [[A.15.1 - U.Work|A.15.1]]. If the claim is evidence, assurance, gate authority, publication use, or result acceptance, use the governing pattern for that claim.

## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:2 - Problem
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4 - Solution

### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.1 - Definition
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.2 - Mechanism declaration
...
`SlotIndex` is a derived index over SlotSpecs used by `OperationAlgebra` and guard-only SlotSpecs used by `AdmissibilityConditions`. It does not replace per-operator SlotSpecs and does not relax [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] argument discipline.
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.3 - Kernel-token declarations
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.4 - Method and mechanism positions
...
A solver-selection scheme can be a `U.Method` in one bounded context; a selector mechanism can declare operations over candidate methods; a selected method can fill a mechanism slot; and a mechanism realization can be implemented through a method description and enacted in dated work. Those links do not make [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]] sufficient for a mechanism claim or [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] sufficient for a method claim.
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.5 - Morphisms and constructors
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.6 - Description records
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.7 - Defaults
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.8 - USM and UNM as mechanism instances
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5 - Archetypal Grounding

### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.1 - Selector mechanism
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.2 - Scope mechanism
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.3 - Normalization mechanism
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.4 - Publication mechanism
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:6 - Bias-Annotation
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:7 - Conformance Checklist

**CC-UM.0 ([[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] alignment).** A conforming `U.Mechanism` publication includes the four-row `U.Signature` Block. `OperationAlgebra` is the Vocabulary row, `LawSet` is the Laws row, and `Applicability` is the Applicability row. `SlotIndex` is a derived index, not a fifth Signature row.
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Method label treated as mechanism law | Recover the current use-position first; use [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] only when operation algebra, laws, admissibility predicates, transport, audit, or realization relation are current. |
| Tool configuration treated as mechanism declaration | Keep tool settings in the direct tooling, publication, work, or evidence pattern; put only mechanism semantics in [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]. |

## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:9 - Consequences
...
| Method, mechanism, work, evidence, and gate claims stay separated. | Source labels often need [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] recovery before typed assignment. |
...
### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:9.1 - Quick use cards
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:10 - Rationale
...
Binding mechanisms to [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] Signature discipline keeps declaration and realization separate. The Signature carries boundary semantics; realization varies under monotonicity. Bridge-only transport and Reliability-only penalties keep cross-context losses visible without mutating Formality or Guarantee.

## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:11 - SoTA-Echoing
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12 - Relations
...
* **Coordinates with:** `A.3.1 U.Method`; `A.3.2 U.MethodDescription`; `A.15.2 U.WorkPlan`; `A.15.1 U.Work`; [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]; [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]; [[C.29 - Mathematical Lens Use|C.29]]; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; [[E.18 - Transformation Flow Structure|E.18]]; [[E.20 - Mechanism Introduction Protocol|E.20]].
...
* **Uses for precision restoration:** [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], and [[F.18 - Local‑First Unification Naming Protocol|F.18]]; use `E.10.ARCH:3.1` when source labels such as `algorithm`, `program`, `workflow`, `process`, `procedure`, `recipe`, `solver`, or `control strategy` hide the current relation position.

### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12.1 - P2W mechanism-use relation

When [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] reaches a mechanism cue, [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] carries the mechanism meaning: operation algebra, LawSet, AdmissibilityConditions, realization relation when declared, transport, and mechanism descriptions. P2W may name the cue and governing pattern, but it does not define these mechanism relations locally.

If the issue under repair is new mechanism introduction, mechanism stabilization, or method-related mechanism use, use [[E.20 - Mechanism Introduction Protocol|E.20]] when mechanism-governing-definition assignment is current. A P2W citation of a mechanism does not select a method, execute work, pass a gate, prove evidence, or certify a result.

### [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12.2 - Lowering, repair, and refresh conditions

A `U.Mechanism` remains usable while its MechanismDeclaration, imported signatures, SlotSpecs, LawSet, AdmissibilityConditions, Applicability, Transport, GammaTimePolicy, PlaneRegime, and Audit relations remain recoverable and monotone with respect to [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]].
...
## [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:End
