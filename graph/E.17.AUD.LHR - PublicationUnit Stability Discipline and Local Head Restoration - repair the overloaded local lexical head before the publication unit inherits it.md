...
fpf_id: "E.17.AUD.LHR"
title: "PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it"
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:1 - Problem frame
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:2 - Problem
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3 - Solution
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.1 - Pairwise plain glosses
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.2 - Ordinary working card
...
- if rows 1-5 stabilize locally and the remaining question is one bounded comparative review move over already pinned source epistemes or publications, apply [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] rather than thickening this local lexical-head repair pattern;
- if rows 2-5 still cannot stay stable because the same publication unit keeps borrowing a different object, move, or outside-work boundary from the same local lexical head, apply [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] instead of pretending one more qualifier will rescue the same unit.
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.3 - Load-bearing extension
...
It is for the stay-local repair disposition, not for re-deciding whether the case really belongs in [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] or [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]].
If the ordinary card now shows one stable local repair plus one bounded comparative review question, apply [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] before opening the extension.
If the ordinary card still shows publication-unit reading instability after local repair, apply [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] before adding declaration weight here.
Do not use it to rescue a unit whose publication-unit reading still shifts, and do not turn it into a second rule sheet.

### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.4 - Ordinary repair order
...
If step 6 keeps reopening because the same unit still cannot hold one stable primary entity of concern, one carried move, and one outside-work boundary, stop local repair and apply [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]].
If the local lexical head is now honest and the only remaining question is one bounded contrast over already available source epistemes or publications, apply [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] instead of escalating the local card into a heavier record by habit.
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:4 - Quick worked-slice starter
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5 - Worked slices
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.1 - `review` is really carrying two jobs
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.2 - `text` quietly shifts into carrier or document status
...
**Recovery reading.** Stay in [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]: the local lexical head is now honest, the same local unit no longer shifts, and no neighboring reading has become primary.

### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.3 - Semio-heavy family name does too much work
...
### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.4 - Local repair selects bounded comparison
...
Once that local lexical head is repaired, do not keep thickening this pattern by habit. The admissible next pattern application is [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] for the now-stable unit, because the remaining question is one bounded contrast rather than publication-unit EntityOfConcern instability.

**Recovery reading.** This is the honest bounded-comparison disposition: finish the local repair here, then let [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] carry the remaining bounded contrast over the now-stable unit.

### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.5 - Local repair exposes publication-unit reading instability and must apply whole-unit discipline
...
**Recovery reading.** This is the admissible publication-unit stabilization move case: stop thickening the local repair, keep the restored local lexical head as the last honest local result, and apply [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] because the same unit still has unstable reading after one honest repair.

### [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.6 - Outside observation changes what the same head can honestly carry
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:6 - Boundary dispositions
...
Treat those as neighboring recoveries, not as a required sequence. Some cases will stop after one local repair, some will apply bounded comparison under [[E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], and some will apply publication-unit stabilization under [[E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] once the honest question changes.

## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:7 - Consequences
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:8 - SoTA-Echoing
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:9 - Relations
...
## [[E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:End
