...
> **Builds on:** [[E.18 - Transformation Flow Structure|E.18]] Transformation Flow Structure, [[C.29 - Mathematical Lens Use|C.29]] Mathematical Lens Use, [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.Episteme`, [[E.17 - Multi‑View Publication Kit|E.17]] publication machinery, [[A.3.4 - U.Transformation- Bounded Change Under Conditions|A.3.4]] `U.Transformation`, [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] `U.Signature`, [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] slot discipline, [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work family, [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], and [[C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] architecture family.
...
- the claim is a publication face or view publication; use [[E.17 - Multi‑View Publication Kit|E.17]] and the relevant view or architecture-description pattern;
...
| tuple, record, slot relation, or typed relation expression | slot positions, relation arity, locus typing, and value placement | not a new U-kind and not a replacement for [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] slot discipline |
...
If the claim publishes a view, diagram, card, table, or equation face, use [[E.17 - Multi‑View Publication Kit|E.17]] and the governing view or architecture-description pattern.
```
...
| publication face or publication use | [[E.17 - Multi‑View Publication Kit|E.17]] or [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] |
...
- `CC-E18.2-8` Publication faces are separated from mathematical description and handled through [[E.17 - Multi‑View Publication Kit|E.17]] when publication is current.
...
| Anti-pattern | Repair |
|---|---|
| **Graph-as-world.** A graph-shaped expression is treated as the project-world structure because it is visually convincing. | Name whether the current EoC is [[E.18 - Transformation Flow Structure|E.18]] selected structure, [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]] mathematical description, [[E.17 - Multi‑View Publication Kit|E.17]] publication, or [[C.29 - Mathematical Lens Use|C.29]] lens-use adequacy. |
...
| **Algebra-as-mechanism.** An operation law or equation system is treated as a realized mechanism. | Use [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] for formal substrate and [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] for mechanism claims; keep [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]] to the expression relation. |
...
- [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[E.17 - Multi‑View Publication Kit|E.17]] govern description episteme and publication faces.
- [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]], and [[E.20 - Mechanism Introduction Protocol|E.20]] govern formal substrate, mechanism, slot discipline, and mechanism placement.
