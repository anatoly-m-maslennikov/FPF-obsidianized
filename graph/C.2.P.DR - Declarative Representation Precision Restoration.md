...
> **Type:** [[C.2.P - Epistemic Precision Restoration|C.2.P]] precision-restoration child pattern for declarative-representation overread
> **Status:** Stable
> **Normativity:** Normative unless a section is explicitly informative

## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:0 - Use this when
...
- an [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path is overread as approval, permission, release, gate passage, or assurance;
...
- If the graph path, `PathSlice`, or flow valuation is already current as graph structure, use [[E.18 - Transformation Flow Structure|E.18]] directly.
- If the evidence relation or provenance relation for a claim is already current, use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] directly.
- If the publication face or source-use relation is already current, use [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], or the direct publication pattern.
- If the current claim concerns a semantic way of doing, use [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]; if it concerns the description of that way, use [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]].
- If the current claim concerns operation algebra, laws, admissibility predicates, transport, audit, or governing-definition assignment, use [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] or [[E.20 - Mechanism Introduction Protocol|E.20]].
- If the current claim concerns planned work or dated work, use [[A.15.2 - U.WorkPlan|A.15.2]] or [[A.15.1 - U.Work|A.15.1]].
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:1 - Problem frame
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:2 - Problem

Without this repair:

1. **Graph path becomes work route.** A path or path slice in [[E.18 - Transformation Flow Structure|E.18]] is treated as an ordered work narrative, even when no work occurrence, work plan, or method description is current.
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:3 - Forces
...
| Legitimate path words and metaphor repair | `A.10 evidence path`, [[E.18 - Transformation Flow Structure|E.18]] graph path, and carrier file paths may be legitimate; `path` becomes a defect only when it carries a stronger action or authority claim by metaphor. |
...
| Direct governing pattern and local repair | When [[E.18 - Transformation Flow Structure|E.18]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]], [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.1 - U.Work|A.15.1]], [[E.17 - Multi‑View Publication Kit|E.17]], or another pattern already governs the current claim, this pattern names only the overread and leaves the next claim to that pattern rather than duplicating it. |

## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4 - Solution
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.1 - DeclarativeRepresentationRepair note
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.2 - Direct governing-pattern selection

| If recovery shows... | Use this governing pattern | Keep this boundary |
| --- | --- | --- |
| graph object, graph path, `PathSlice`, crossing, flow valuation, transformation-flow structure relation, or graph expression over that structure | [[E.18 - Transformation Flow Structure|E.18]], [[E.18.2 - Transformation Flow Mathematical Description|E.18.2]], or [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]] when P2W carry-through is current | Graph structure or path structure is not work route, method narrative, evidence result, or pattern dispatch by layout. |
| evidence relation or provenance relation for a claim, effect, or reliance use | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] | Evidence path is not approval, permission, gate passage, release, safety, work occurrence, or assurance by itself. |
| state, status value, readiness, validity, or predicate-like value whose bearer and value frame is hidden | [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]] or the direct status-value or state-value pattern | A predicate or state-like value is not a workflow, gate, or proof unless the governing pattern says so. |
| publication face, source expression, generated explanation, dashboard face, publication unit, or source-chain relation | [[E.17 - Multi‑View Publication Kit|E.17]], [[E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[A.15.4 - Work-Relevant Source Restoration|A.15.4]], or source-use pattern named by value | Publication and source visibility do not create work, evidence, authority, release, or gate passage. |
| mathematical representation, formal object, formal substrate, invariant, or mathematical-lens output | [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[C.29 - Mathematical Lens Use|C.29]], or direct mathematical pattern | Mathematical representation is not method, mechanism, proof of project result, or work execution until that claim is separately recovered. |
...
| law-governed operation algebra, laws, admissibility predicates, transport, audit, realization, or governing-definition assignment | [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[E.20 - Mechanism Introduction Protocol|E.20]] | Mechanism meaning is not selected by saying "algorithm" or "method"; it needs mechanism fields. |
...
| FPF pattern application, pattern relation, neighboring-pattern relation, or placement cue | [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], [[F.19 - Ontology-First Plain Technical Rewriting|F.19]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], or the direct pattern relation named by value | Pattern relations are declarative references or applications, not exits, receivers, routes, calls, owners, homes, or dispatches. |
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.4 - Method, algorithm, mechanism, and work-slot settlement
...
| formal substrate, signature, postulates, laws, or mathematical declaration | [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]]; use [[C.29 - Mathematical Lens Use|C.29]] when mathematical-lens use is current |
| operation algebra, admissibility predicates, transport, audit, realization, or mechanism-governing-definition assignment | [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[E.20 - Mechanism Introduction Protocol|E.20]] |
| planned work | `A.15.2 U.WorkPlan` |
| dated performed work | `A.15.1 U.Work` |
| evidence relation or provenance relation for a claim | [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] |
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.5 - Programming-paradigm and process-model settlement
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5 - Worked slices

### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.1 - Graph path in a transformation-flow structure
...
DeclarativeRepresentationRepair:
  ...
  RepresentationKind: graph path or PathSlice candidate under [[E.18 - Transformation Flow Structure|E.18]] and [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]]
  ...
  RecoveredGoverningPattern: [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]], with [[A.15.2 - U.WorkPlan|A.15.2]] or [[A.15.1 - U.Work|A.15.1]] only if planned or dated work is current
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.2 - Evidence path near release

Wording: "The evidence path authorizes release."

Repair: [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] can state an evidence path for the claim or effect. Release, permission, or gate passage requires the authority, gate, or release pattern that governs that claim. This pattern is used only if `path` wording itself is causing the representation to be overread as a permission route.

### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.3 - Query plan and access path

Wording: "The query plan calls the production work sequence."

Repair: recover whether the query plan is an optimizer representation, method description, formal substrate, source cue, evidence relation, work plan, or actual work trace. If it only represents query evaluation choices, do not treat it as `U.WorkPlan` or `U.Work`. If the current claim concerns method semantics, use [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]]; if it concerns a method description, use [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]; if it concerns a performed query run, use [[A.15.1 - U.Work|A.15.1]] and the evidence pattern or source-use pattern.

### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.4 - Dashboard predicate
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.5 - Pattern relation

Wording: "This pattern exits to [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]."

Repair: if the current relation is "use [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when an evidence relation or provenance relation is current", write that declarative boundary. Do not use exit, receiver, route, owner, home, dispatch, or call language unless the pattern is actually about an action occurrence, work plan, control mechanism, or communication relation that has those semantics.

### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.6 - Solver algorithm

Wording: "The solver algorithm is the mechanism."

Repair: recover the current slot or use-position. The solver configuration may be `U.MethodDescription`; the accepted semantic way of solving may be `U.Method`; the MILP formulation may expose formal substrate and mathematical-lens use; a reusable operation algebra with laws and admissibility predicates may be `U.Mechanism`; a solver run may be `U.Work`; a run result may be evidence for another claim. Select [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[E.20 - Mechanism Introduction Protocol|E.20]] only when mechanism fields are present in the current claim.

### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.7 - Reactor-cooling flow graph
...
DeclarativeRepresentationRepair:
  ...
  RepresentationKind: graph path or flow relation representation under [[E.18 - Transformation Flow Structure|E.18]] and [[C.29 - Mathematical Lens Use|C.29]] when mathematical-lens use is current
  ...
  RecoveredGoverningPattern: [[E.18 - Transformation Flow Structure|E.18]] and [[C.29 - Mathematical Lens Use|C.29]] for graph and lens use; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.15.2 - U.WorkPlan|A.15.2]], and [[A.15.1 - U.Work|A.15.1]] only if gate, evidence, work plan, or dated work is current
...
### [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.8 - CRISPR guide-selection table
...
DeclarativeRepresentationRepair:
  ...
  RecoveredGoverningPattern: [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] or [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]] for characteristics when current; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence; [[A.15.2 - U.WorkPlan|A.15.2]] for experimental work plan; [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] or authority pattern only if approval or gate claim is current
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:6 - Conformance checklist
...
| `CC-C2PDR-5` | Legitimate `A.10 evidence path`, [[E.18 - Transformation Flow Structure|E.18]] graph path, `PathSlice`, carrier file path, URL, or mathematical path use is preserved when that kind is current. |
| `CC-C2PDR-6` | Method-like and algorithm-like wording recovers the current slot or use-position before replacement: [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]], [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[C.29 - Mathematical Lens Use|C.29]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[E.20 - Mechanism Introduction Protocol|E.20]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.1 - U.Work|A.15.1]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], direct governing pattern, or quote-only source wording. |
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:7 - Common anti-patterns

| Anti-pattern | Symptom | Repair |
| --- | --- | --- |
| Path word deletion | Every `path` is replaced or avoided. | Preserve legitimate [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[E.18 - Transformation Flow Structure|E.18]], carrier, mathematical, URL, and quoted-source path uses; repair only hidden stronger claims. |
...
| Algorithm as method by default | Code, solver model, proof script, or workflow is called the method without slot recovery. | Use [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]] only for semantic way of doing; use [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[C.29 - Mathematical Lens Use|C.29]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[E.20 - Mechanism Introduction Protocol|E.20]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.1 - U.Work|A.15.1]], or [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when those claims are current. |
...
| Pattern dispatcher | Pattern relations are written as routes, exits, receivers, calls, owners, or homes. | Write declarative neighboring-pattern boundary or application relation; use [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] and [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] together when both publication-form and phrase-apparatus claims are live, or use the one governing pattern when only one claim is live. |
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:8 - Relations

- **Builds on:** [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[E.17 - Multi‑View Publication Kit|E.17]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], and [[F.19 - Ontology-First Plain Technical Rewriting|F.19]].
- **Coordinates with:** [[E.18 - Transformation Flow Structure|E.18]], [[E.18.1 - Principles-to-Work Carry-Through|E.18.1]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]], [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[C.29 - Mathematical Lens Use|C.29]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[E.20 - Mechanism Introduction Protocol|E.20]], [[A.15.2 - U.WorkPlan|A.15.2]], [[A.15.1 - U.Work|A.15.1]], [[A.15.4 - Work-Relevant Source Restoration|A.15.4]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], and direct publication, gate, authority, release, evidence, method, work, and assurance patterns when those claims are being made.
- **Specializes:** [[C.2.P - Epistemic Precision Restoration|C.2.P]] for one recurring case: declarative representation and imperative-metaphor overread.
- **Used by:** [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] applicability-row distribution and full-pattern text precision restoration when route, path, workflow, call, or dispatch wording hides representation use.

## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:9 - Consequences
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:10 - SoTA-Echoing
...
| --- | --- | --- |
| [[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], and [[C.2.P - Epistemic Precision Restoration|C.2.P]] | Current FPF precision-restoration architecture. | This pattern is a bounded child realization under [[C.2.P - Epistemic Precision Restoration|C.2.P]], not a new umbrella pattern. |
| [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[E.18 - Transformation Flow Structure|E.18]] | Local FPF direct governing patterns for evidence paths, provenance paths, transformation-flow graph paths, and path slices. | Path wording is legitimate when those kinds are current; the defect is stronger overread. |
| [[A.3.1 - U.Method- Context-Defined Way of Doing|A.3.1]], [[A.3.2 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]], [[C.29 - Mathematical Lens Use|C.29]], [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[E.20 - Mechanism Introduction Protocol|E.20]], [[A.15.2 - U.WorkPlan|A.15.2]], and [[A.15.1 - U.Work|A.15.1]] | Local FPF slot chain for method-like and algorithm-like wording. | The repair recovers slot or use-position before choosing method, method description, formal substrate, mechanism, work plan, or work occurrence. |
...
## [[C.2.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:End
