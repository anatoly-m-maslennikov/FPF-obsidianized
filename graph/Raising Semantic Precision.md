...
This is why [[E.10 - Unified Lexical Rules for FPF|E.10]] is a trigger scan rather than a synonym list. [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] distributes repair to the pattern that can recover the ontology. [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[C.30.P - Architecture and Structure Precision Restoration|C.30.P]], [[A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[F.18 - Local‑First Unification Naming Protocol|F.18]], and [[F.19 - Ontology-First Plain Technical Rewriting|F.19]] carry major repair families. [[C.29 - Mathematical Lens Use|C.29]] helps when a mathematical lens is needed. [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]] governs formal-substrate declarations when a formal signature is the right object.
