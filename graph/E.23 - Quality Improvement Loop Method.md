...
## [[E.23 - Quality Improvement Loop Method|E.23]]:1 - Problem frame

Use [[E.23 - Quality Improvement Loop Method|E.23]] when an object version will be improved through repeated passes under a declared object-under-improvement evaluation. The object can be a pattern, `DRR`, FPF corpus object, engineering quality object, naming candidate, OEE/NQD candidate, archive/front member, selected set, parity report, refresh report, or declared transformation result, if an exact evaluation supplies values and stop meanings for that object kind.

Not this pattern when one direct quality evaluation is enough. Use [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] to frame one evaluation and then run the named object-under-improvement evaluation. Use [[A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] first if the needed evaluation characteristic space does not exist.
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:2 - Problem
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:3 - Forces
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:4 - Solution
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.1 - Local names and kind settlement
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.2 - Loop method
...
3. Use [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] to frame the first quality evaluation when the purpose is not already explicit.
4. Run the object-under-improvement evaluation in its required result form. For one FPF pattern version, this is an [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] result with every required coordinate, every `ShortRationale`, the `PrecisionRestorationProfile`, evidence basis, coordinate-specific payloads, and status. A loop record, profile pass, blocker summary, two-column table, or "no blockers" note is not a substitute.
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.3 - Stop, continue, and reopen
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.4 - Method-family selection
...
| `RalphLikeGeneralAdaptiveFamily` | A broadly capable agent can improve the object through repeated specification, feedback, memory, and verification under [[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] cost/risk discipline. |
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.5 - Operation-family selection
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.6 - Cost and BLP discipline

[[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] governs the preference for broad, scale-amenable methods when safety, legality, and practical fitness are comparable. [[E.23 - Quality Improvement Loop Method|E.23]] uses that preference but still evaluates end-to-end accepted-work cost:
...
### [[E.23 - Quality Improvement Loop Method|E.23]]:4.7 - Source-bearing and OEE/NQD improvement

Accepted `SoTA` is the working external front only when assigned by the object-under-improvement evaluation, accepted source-use decision, or declared comparison set. [[E.23 - Quality Improvement Loop Method|E.23]] can govern a loop that reaches, maintains, or improves relative to that front; it does not self-assign `SoTA`.
...
For NQD/OEE, [[E.23 - Quality Improvement Loop Method|E.23]] can change one object version or candidate to improve declared `Q` movement. [[C.17 - Characterising Generative Novelty & Value (Creativity‑CHR)|C.17]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], and [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] keep authority over novelty, diversity, descriptors, distances, archive/front insertion, pool policy, selected-set publication, parity, and refresh.

## [[E.23 - Quality Improvement Loop Method|E.23]]:5 - Worked slices

**Affordable floor evaluation.** A pattern needs admission readiness. [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] frames `floorEvaluation`; [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] evaluates all required coordinates. If the result is admissible and no improvement aim is requested, [[E.23 - Quality Improvement Loop Method|E.23]] stays closed. If an admission, refresh, landing, or release crossing is claimed, [[E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] and the release named by value/admission process still check the gate conditions; the [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] status is necessary quality evidence, not the gate itself.

**Pattern exceptional improvement.** A pattern already passes floor but lacks worked slices and source-currentness. [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] frames optional exceptional improvement for named coordinates. [[E.23 - Quality Improvement Loop Method|E.23]] searches for substantive non-dominated content moves, applies proposal rows, re-evaluates by [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], checks what became worse, and stops locally only when no worthwhile content improvement remains under the declared use. The loop may stop at `4`, but only after the missing-exceptional opportunity has been searched and discharged by value; it is not a proof-building run toward all-`5`.

**DRR improvement.** A `DRR` needs drafting adequacy for multi-locus authoring. [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] supplies coordinates; [[E.23 - Quality Improvement Loop Method|E.23]] applies decision repairs and re-evaluates. The improved object is still a decision record, not prewritten pattern prose.

**NQD quality-side improvement.** A generated candidate has declared `Q` components and a comparison set. [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] returns proposal rows. [[E.23 - Quality Improvement Loop Method|E.23]] may change the candidate and re-evaluate `Q`; archive/front insertion, selected-set publication, parity, and refresh remain under the pattern that governs each claim and are not quality-loop decisions.

## [[E.23 - Quality Improvement Loop Method|E.23]]:6 - Bias annotation
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:7 - Conformance checklist

| Check | Requirement |
|---|---|
| `CC-E23-1` | Name object version and object-under-improvement named by value evaluation before claiming quality movement. |
| `CC-E23-2` | Use [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] or an equivalent frame when the evaluation purpose is not already explicit. |
...
| `CC-E23-8a` | When the evaluation names a precision-restoration defect, apply the selected restoration or governing pattern named by that evaluation. For [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], use its `PrecisionRestorationProfile` to decide whether the repair is word/head/use precision ([[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[F.18 - Local‑First Unification Naming Protocol|F.18]]), phrase-level plain rewriting ([[F.19 - Ontology-First Plain Technical Rewriting|F.19]]), or a governing-pattern repair. The repair row is not closed until it includes a `KindRestorationCheck`: pre-repair kind/relation/slot-or-use-position/admissible use/scope, post-repair kind/relation/slot-or-use-position/admissible use/scope, or `not triggered`/`ordinary prose`/`already satisfied`/`blocker` disposition with loci. |
| `CC-E23-9` | Apply [[E.10 - Unified Lexical Rules for FPF|E.10]] to load-bearing loop names, status values, examples, stop conditions, and result wording introduced or repaired by the loop. |
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:8 - Common anti-patterns and repairs
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:9 - Consequences
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:10 - Rationale
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:11 - SoTA-Echoing
...
| Broad adaptive loops are useful but costly. | Ralph-like current technique signal, Reflexion/Self-Refine/ReAct/LATS/SWE-agent lineage. | General adaptive methods are selectable under [[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] cost/risk and re-evaluation discipline. |
...
| Multi-coordinate improvement needs trade-offs. | MCDA, Pareto, ATAM, and current proxy-failure work. | Re-evaluation includes what became worse, rejects dominated changes, and applies [[E.13 - Pragmatic Utility and Value Alignment|E.13]] when the visible value under optimization starts replacing the intended value. |
| Measures and specifications can be gamed under optimization pressure. | Goodhart/Campbell, surrogation, specification-gaming, and reward-hacking lines. | The loop forbids all-`5` targeting, separates floor repair from substantive exceptional proposals, rejects apparatus-only proof as dominated change, and opens [[E.13 - Pragmatic Utility and Value Alignment|E.13]] when the loop target becomes a proxy for value. |
...
## [[E.23 - Quality Improvement Loop Method|E.23]]:12 - Relations

| Pattern | Relation |
|---|---|
| [[A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] | Constructs or repairs an object-under-improvement evaluation when none exists. |
| [[E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] | Frames each quality evaluation and can return finding or proposal rows. |
| [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] | Supplies pattern-quality values for pattern-improvement loops. |
| [[E.9.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] | Supplies `DRR` decision-adequacy values for `DRR` loops. |
| [[E.2.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] | Supplies FPF Pillar-adequacy values for corpus-level loops. |
| [[E.13 - Pragmatic Utility and Value Alignment|E.13]] | Governs pragmatic utility and proxy-to-value alignment when loop targets, quality values, metrics, or review results become substitutes for the intended value. |

| [[F.18 - Local‑First Unification Naming Protocol|F.18]] | Supplies durable-name evaluation for naming loops. |
| [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] | Govern engineering quality bundles and quality-word precision repair. |
| [[C.19.1 - Bitter‑Lesson Preference (BLP)|C.19.1]] | Governs BLP and cost/risk comparison for method-family choice. |
| [[C.22.1 - Task-family adaptation signature|C.22.1]], [[C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] | Govern durable task-family adaptation and tool-call planning when the loop makes those claims. |
| [[C.17 - Characterising Generative Novelty & Value (Creativity‑CHR)|C.17]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]], [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]], [[G.9 - Parity and Benchmark Harness|G.9]], [[G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] | Govern OEE/NQD candidate characteristics, archive/front, pool, selected set, parity, and refresh. |
| [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] | Govern decision, evidence, assurance, work, gate, and release claims when a loop result is reused beyond quality improvement. |
| [[E.10 - Unified Lexical Rules for FPF|E.10]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[F.18 - Local‑First Unification Naming Protocol|F.18]] | Repair load-bearing wording and names introduced by loop records. |

## [[E.23 - Quality Improvement Loop Method|E.23]]:End
