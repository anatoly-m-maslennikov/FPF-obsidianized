...
**Builds on.** **[[C.2 - Epistemic holon composition (KD-CAL)|C.2]] KD‑CAL** (F–G–R & CL routing), **A.19/G.0 CG‑Spec** (comparability), **[[F.9 - Alignment & Bridge across Contexts|F.9]] Bridges** (cross‑Context alignment), **[[E.10 - Unified Lexical Rules for FPF|E.10]] LEX** (registers & twin labels). **Coordinates with.** **[[C.21 - Field Health & Structure (Discipline-CHR)|C.21]]** (Discipline‑CHR, field health), **[[C.23 - MethodFamily Evidence & Maturity (Method‑SoS‑LOG)|C.23]]** (Method‑SoS‑LOG), **[[F.17 - Unified Term Sheet (UTS)|F.17]]–[[F.18 - Local‑First Unification Naming Protocol|F.18]]** (UTS).

## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:1 - Problem Frame
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:2 - Problem
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:4 - Solution — the **Discipline holon** and Γ_disc

### [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:4.1 - U.Types (minting & registers)
...
**Placement/LEX.** `U.Discipline` and its subtypes are **Kernel U‑types** introduced under the **Open‑Ended Kernel** & **Ontological Parsimony** guards (**[[A.5 - Open‑Ended Kernel & Extension Layering|A.5]]**, **[[A.11 - Ontological Parsimony (C‑5)|A.11]]**) and registered per **E.10/F.17**. This CAL **uses** them, it does not redefine them. If not yet present in A‑cluster, mark as **“provisionally minted”** and open a DRR to finalize placement ([[E.10 - Unified Lexical Rules for FPF|E.10]] strata).

All are **UTS‑published** with **twin labels**; minting follows **[[E.10 - Unified Lexical Rules for FPF|E.10]]** registers/prefix policy and **[[A.11 - Ontological Parsimony (C‑5)|A.11]]** parsimony.

### [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:4.2 - What a `U.Discipline` is / is not
* A `U.Discipline` is **not** a `U.BoundedContext` and **not** a **Domain**. **Domain** remains a *catalog label* (stitched to D.CTX + UTS): **Discipline ≠ Domain** is enforceable via **[[E.10 - Unified Lexical Rules for FPF|E.10]] LexicalCheck**; any cross‑Domain/Context reuse **MUST** cite a **Bridge ([[F.9 - Alignment & Bridge across Contexts|F.9]]) + CL + loss notes**; penalties to **R** only; **F/G invariant** (USM/KD‑CAL).
...
### [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:4.3 - Constructor **Γ_disc** (CAL export)
*Signature.*
...
*Obligations.*
1) **Provenance & lanes.** Each imported episteme/standard declares **[[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] anchors** and lane tags **{TA, VA, LA}**; freshness windows are recorded.
...
4) **Scale/Unit/Polarity legality.** Before any comparison/aggregation, **prove legality via MM‑CHR/CSLC** and cite **CG‑Spec characteristic ids** used in the fold ([[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]]–[[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]]).
...
### [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:4.4 - Discipline ESG (state graph, informative surface)

Export a **Discipline.ESG** with named states and guarded transitions (e.g., *Emerging → Consolidating → Codified → Fragmenting*), where **guards reference [[C.21 - Field Health & Structure (Discipline-CHR)|C.21]] metrics** (CHR‑typed; **Scale/Unit/Polarity + freshness windows**) and cite **CG‑Spec ids**; **all thresholds live only in AcceptanceClauses** ([[G.4 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring|G.4]]). ESG is **descriptive**; all gating remains in CHR/CAL/LOG packs.

## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:5 - Archetypal Grounding *(Tell–Show–Show)*
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:6 - Bias‑Annotation
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:7 - Conformance Checklist (normative)
...
| **CC‑C20‑7 (Crossing visibility hooks).** | Any **cross‑stance / cross‑Context / cross‑plane** reference in Discipline materials **SHALL** publish a **CrossingBundle** for the crossing (**[[E.18 - Transformation Flow Structure|E.18]]**; Bridge+UTS through **[[F.9 - Alignment & Bridge across Contexts|F.9]]**, **[[F.17 - Unified Term Sheet (UTS)|F.17]]**, **[[E.17 - Multi‑View Publication Kit|E.17]]**, and **[[E.18 - Transformation Flow Structure|E.18]]**) and expose it via `Expose_CrossingHooks` (**[[G.10 - SoTA Pack Shipping|G.10]]‑3**). Published crossings **MUST** be checkable for **LanePurity** (CL→R only; F/G invariant; Φ tables present) and **Lexical SD** (**[[E.10 - Unified Lexical Rules for FPF|E.10]]**) under the active GateProfile / GateChecks (**[[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]**). | Prevents implied crossings; makes provenance auditable & replayable. |
...
| **CC‑C20‑9 (Lexical firewall).** | Normative sections remain **notation/tool‑neutral**; vendor/tool tokens are avoided (see **[[E.5.1 - DevOps Lexical Firewall|E.5.1]]**). |  |

### [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:7.1 - Canonical rewrites (anti‑ambiguity)
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:8 - Consequences
...
## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:9 - Rationale
The calculus keeps **entityOfConcern local**, **comparability lawful**, and **assurance explicit**. It aligns with KD‑CAL’s weak‑link folds and CL routing, with CG‑Spec’s **ScaleComplianceProfile (SCP)** and **Γ‑fold** rules, and with LEX twin‑label governance. It avoids “phlogiston disciplines” by tying fields to measurable CHRs ([[C.21 - Field Health & Structure (Discipline-CHR)|C.21]]) and evidence lanes.

## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:10 - Relations
**Builds on.** KD‑CAL ([[C.2 - Epistemic holon composition (KD-CAL)|C.2]]); CG‑Spec (A.19/G.0); Bridges ([[F.9 - Alignment & Bridge across Contexts|F.9]]); LEX ([[E.10 - Unified Lexical Rules for FPF|E.10]]).
**Coordinates with.** [[C.21 - Field Health & Structure (Discipline-CHR)|C.21]] (field‑health CHRs), [[C.22 - Problem Typing & TaskSignature Assignment (Problem-CHR)|C.22]] (Problem‑CHR), [[C.23 - MethodFamily Evidence & Maturity (Method‑SoS‑LOG)|C.23]] (Method‑SoS‑LOG).
**Constrains.** [[G.2 - SoTA Harvester & Synthesis|G.2]] **MUST** publish **TraditionCards**/**BridgeMatrix** sufficient for `Γ_disc` to assemble **≥2 Traditions** and **≥3 `U.BoundedContext`** per SoTA synthesis to avoid monoculture. [[G.5 - Multi‑Method Dispatcher & MethodFamily Registry|G.5]] selector **SHALL** cite Discipline **CG‑Spec ids** and **EvidenceGraph** rows when admitting families.

## [[C.20 - Composition of U.Discipline (Discipline‑CAL)|C.20]]:End
