...
This pattern lives in the [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] characterization pattern nest. It rewrites bare evaluative prose either into one explicit endpoint-pattern-governed evaluative form or, when endpoint selection is still being stabilized, into one explicit transitional quality-term repair form with a declared sense family, admissible normal form (`SignalPack | Characteristic | Bundle | Objective`), reference-plane accountability, and lexical guardrails.

It allows philosophical, neuro-symbolic, control-theoretic, engineering, and open-ended-search uses to coexist without false identity by label. It does not treat quality-term or evaluative characterization as relation construction by default. When the found problem is relation construction, bridge, basedness, action-invitation relation, endpoint mismatch, or another relation-shaped claim, use [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] or the relation named by value specialization.

**Placement.**
Part C > [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]] characterization pattern nest > precision-restoration pattern for overloaded quality and evaluative-characterization wording.

**Builds on.**
[[E.10 - Unified Lexical Rules for FPF|E.10]], [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]], [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]], [[A.19 - CharacteristicSpace & Dynamics Hook (A.CHR‑SPACE)|A.19]], [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], [[F.9 - Alignment & Bridge across Contexts|F.9]], and [[F.18 - Local‑First Unification Naming Protocol|F.18]].

**Coordinates with.**
[[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] for relation-construction exits; [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] for action-invitation exits; [[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]] for language-state chart positions, admissible moves, early cue handling, responsibility handoff, and admissible retreat when an evaluative publication must be reopened; [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]] when the admissible continuation is still an open explanatory probe rather than a stable endpoint characterization; [[C.2.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]], and [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]] for articulation, closure, anchoring, and representation-factor facets referenced but not governed here; [[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[E.17 - Multi‑View Publication Kit|E.17]], and [[E.18 - Transformation Flow Structure|E.18]] for viewpoint publication; [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence and assurance; [[A.19.CN - CN‑frame (comparability & normalization)|A.19.CN]] for comparability governance; [[F.9.1 - Bridge Stance Overlay|F.9.1]] for bridge-stance annotations; [[C.3.3 - KindBridge & CL^k - Cross‑context Mapping of Kinds|C.3.3]] for explicit kind-bridge repair when endpoint kind mismatches appear.

**[[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] governing-pattern relation.**
When [[E.10 - Unified Lexical Rules for FPF|E.10]] encounters `quality`, `good`, `fit`, `high-quality`, `quality metric`, `quality score`, `quality characteristic`, `quality requirement`, `model quality`, `architecture quality`, `solution quality`, or evaluative `-ility` wording whose quality sense, bearer, evaluation frame, endpoint normal form, or governing pattern is hidden, [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] assigns the repair to [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] only until those values are recovered or the claim being made exits to [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[C.29 - Mathematical Lens Use|C.29]], [[A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B.3 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[C.11 - Decision Theory (Decsn-CAL)|C.11]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], or another pattern governing the recovered claim. [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] does not keep evidence, assurance, gate, decision, work, release, relation, action-invitation, mathematical-lens, source-use, or publication invariants after that exit is recoverable.
...
It also does not assert that every trigger use of "quality" is admissibly repaired by the transitional quality-term repair form: where the repaired statement is primarily about an action invitation under [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], relation construction under [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]], or a requirement or commitment over explicit heads, the admissible move is to exit to the pattern governing the recovered claim rather than assigning a quality-term or evaluative characterization.

## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:0 - Use this when
...
- If the issue under repair is hidden characteristic, scale, score, metric, coordinate, threshold, or comparison construction, use [[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] first.
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:1 - Problem frame
...
* **Plane confusion.** Quality of the EntityOfConcern being described, quality of the description, quality of the carrier, and quality of the publication face are silently collapsed across `ReferencePlane` values and [[A.7 - Strict Distinction (Clarity Lattice)|A.7]] lanes.
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:2 - Problem
...
* ecological affordance discourse, including source-tradition `affordance` cases that must leave quality-term restoration for [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] or another action-invitation governing pattern?

## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:3 - Forces
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4 - Solution

**Stable repair frame > Sense Family > Slots > Normal Form > Change Lexicon > Guardrails**

### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.0 - Trigger rule

A use of **quality** is in scope for [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] when any of the following holds:
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.0a - Operational repair sequence

When the trigger fires, follow the [[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] recovery order specialized to quality-term or evaluative characterization:
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1 - Transitional repair frame: evaluative classification anchored by `qualityTermAscription(...)`

[[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] stabilizes the ambiguity cluster by treating every in-scope quality statement as explicit evaluative content that must name the endpoint governing pattern or publication with named authority-reference relation that carries it, not as a bare adjective.
...
Entry into [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] presupposes enough articulation explicitness to name the bearer, evaluation frame, and at least one candidate evaluative family. Closure degree may remain low while `qualityTermAscription(...)` is serving as a transitional repair form, but if the content is still only a cue pack, forwarded cue, or open explanatory probe, keep it in [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]], or [[B.5.2.0 - U.AbductivePrompt|B.5.2.0]] rather than publishing it here prematurely. If a previously published evaluative record later loses the evidence, witness, or authority-reference relation needed to keep even that transitional status live, retreat via [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]].
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1b - Polarity discipline (bearer-centred; no silent inverse)
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1c - Endpoint-first discipline
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.2 - Core construct: `QualitySense`
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.4 - Required slots for a conforming `qualityTermAscription`
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.5 - Normal-form discipline
...
The normal forms in this section are endpoint or evaluative forms. They are not publication forms by themselves. Publication face, publication form, publication unit, carrier, rendering, export, and front-end questions remain with [[E.17 - Multi‑View Publication Kit|E.17]], [[E.8 - FPF Authoring Conventions & Style Guide|E.8]], or the endpoint-governing publication pattern named by value.
...
This uses **[[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]], [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]], and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]** and inherits full scale legality.
...
**Engineering note.**
For engineering `-ility` families, the preferred bundle endpoint is **`Q-Bundle`** ([[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]), because it keeps **Measures[CHR]** distinct from **ClaimScope and WorkScope** and from **Mechanisms and Status**.
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.6 - Functional vs quality-family discipline

[[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] SHALL prevent the collapse of **function or capability** claims into **quality-family** claims.

* A statement about **what a system does** uses [[A.6.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] first when function-like wording hides the FPF kind named by value, relation, or claim, then the pattern governing the recovered capability, method, work, role, [[A.6.M - Module Relation Repair|A.6.M]] module-interface, architecture, mathematical, evidence, assurance, gate, decision, or release claim whose primary `EntityOfConcern`, bearer, relation record, or characteristic-space construction is recovered.
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.7 - Bridge discipline across traditions
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.8 - Change lexicon

A conforming quality-term repair publication SHALL narrate changes with a stable change lexicon aligned to [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]]:
...
`reviseSense(...)`, `reArticulate(...)`, `reProxy(...)`, `reBundle(...)`, `reScale(...)`, `reFrame(...)`, and `reView(...)` are family-specific refinements of `reviseByValue(...)` and SHALL preserve the [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] distinction between ref retargeting and by-value edits.

### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.8a - [[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]] boundary classification template for quality-term repair
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.9 - Lexical guardrails
...
* if the occurrence is primarily **action-invitation** talk, the text MUST NOT assign a `QualitySense`; it SHALL exit to [[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] or another action-invitation governing pattern, with source-tradition `affordance` wording kept only as a quoted cue when needed;
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.10 - Progressive elaboration

[[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] permits monotone elaboration:
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5 - Archetypal Grounding

### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.1 - Tell
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.2 - Show (System lane)
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.3 - Show (Episteme lane)
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.3a - Show (Architecture description lane)
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.4 - Show (QD or selector lane)
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:6 - Bias-Annotation
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:7 - Conformance Checklist (CC-C16Q)

A text or pattern conforms to [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] iff:
...
19. **CC-C16Q-19 - Family-specific change verbs dock cleanly with [[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]] and [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]].**
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:9 - Consequences
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:10 - Rationale

[[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] makes one strategic move:
...
That is exactly where semantic drift usually starts; [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] turns that drift into an auditable design choice.

## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:11 - SoTA-Echoing
...
**Historical-lineage note.** Earlier touchstones such as Pirsig, Popper, and Deutsch remain useful as lineage and local-gloss resources, but [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] does not use them as formal SoTA anchors here because [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] requires post-2015 primary sources for Architectural patterns unless the row is explicitly lineage or local-gloss material.

This SoTA alignment backs the pattern’s central move: *quality* is not one universal evaluative noun. In contemporary practice, the relevant work is already distributed across explicit characteristics, objectives, viewpoints, world-model criteria, explanatory virtues, felt signals, and action invitations; [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] makes that distribution first-class and auditable.

## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:11a - Refresh and reopen conditions

Reopen or narrow [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]] when any of these current-pattern-language conditions becomes live:
...
* [[A.7 - Strict Distinction (Clarity Lattice)|A.7]], [[C.2.P - Epistemic Precision Restoration|C.2.P]], [[C.2.1 - U.Episteme - Epistemes and their slot relation|C.2.1]], or bridge-policy vocabulary changes the admissible lane, EntityOfConcern, publication-face, carrier, or `ReferencePlane` wording used by this pattern;
...
* README, ToC, [[E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], retrieval, or local Problem-frame first-entry cues change for quality, characteristic, action-invitation, architecture-description, selector, or explanation wording;
...
## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12 - Relations

* **Lives in:** **[[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]** characterization pattern nest as the quality-term realization of **[[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]** and **[[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]**.
* **Builds on:** **[[E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]** for shared wording-use restoration architecture; **[[C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]** for characteristic and scale exits; **[[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]** for explicit scope and `Γ_time`; **[[A.17 - Canonical “Characteristic” (A.CHR‑NORM)|A.17]], [[A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC‑KERNEL)|A.18]], and [[C.16 - Measurement & Metrics Characterization (MM‑CHR)|C.16]]** for admissible measurable characteristics; **[[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]** for engineering `Q-Bundle` publication.
* **Coordinates with:** **[[A.6.P - Relational Precision Restoration (RPR) - Kind‑Explicit Qualified Relation Discipline|A.6.P]]** when the recovered content is relation construction rather than quality-term or evaluative characterization; **[[A.6.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]** or another action-invitation governing pattern when the trigger invites action rather than evaluates a bearer; **[[C.2.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A.16 - Language-State Move Coordination|A.16]], [[A.16.1 - U.PreArticulationCuePack|A.16.1]], [[A.16.2 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[B.4.1 - Observe -- Notice -- Stabilize -- Route|B.4.1]]** for language-state chart positions, admissible moves, early cue handling, responsibility handoff, and admissible retreat or reopen; use **[[A.16.0 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or handoff history itself must be published as an explicit trajectory account; **[[B.5.2.0 - U.AbductivePrompt|B.5.2.0]]** for prompt-shaped continuations that are not yet stable endpoint publication; **[[C.2.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]], and [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for language-state facet governance; **[[C.17 - Characterising Generative Novelty & Value (Creativity‑CHR)|C.17]], [[C.18 - Open‑Ended Search Calculus (NQD‑CAL)|C.18]], and [[C.19 - Explore-Exploit Governor (E-E‑LOG)|C.19]]** for `QS.UseValue`, novelty and diversity discipline, and selector policy; **[[E.17.0 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]** and **[[E.17.2 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]** for architecture-description and viewpoint bundles; **[[F.9 - Alignment & Bridge across Contexts|F.9]]** and **[[F.9.1 - Bridge Stance Overlay|F.9.1]]** for Bridges, CL, and bridge-stance annotations; **[[A.6.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work‑Effects)|A.6.B]]** when repaired ascriptions become boundary-bearing.
* **Publishes vocabulary through:** **[[E.10 - Unified Lexical Rules for FPF|E.10]], [[F.17 - Unified Term Sheet (UTS)|F.17]], and [[F.18 - Local‑First Unification Naming Protocol|F.18]]** when the `qualityTermAscription` repair-form skeleton, the `QualitySense` starter set, and the red-flag rewrites become stable shared vocabulary.

### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.1 - Language-space refactor note
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.2 - Explicit endpoint selection
Admissible endpoints after repair include:
- a single `Characteristic`,
- a `Q-Bundle`,
- an `E.21 PatternQualityQBundle`, when the bearer is one FPF pattern version and the evaluative claim asks whether the pattern is good enough for a declared reader, use, and scope. In this case, do not assign the claim to general [[C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] unless the bearer is a non-pattern engineering quality family,
- an `Objective`,
...
### [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.3 - Endpoint-governance boundary
This pattern does not govern articulation-state characteristics, bridge stances, or representation factors. Those remain governed by [[A.16 - Language-State Move Coordination|A.16]], [[C.2.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C.2.4 - U.ArticulationExplicitness|C.2.4]], [[C.2.5 - U.LanguageStateClosureDegree|C.2.5]], [[C.2.6 - U.LanguageStateAnchoringMode|C.2.6]], [[C.2.7 - U.LanguageStateRepresentationFactorBundle|C.2.7]], and [[F.9.1 - Bridge Stance Overlay|F.9.1]].

## [[C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:End
