...
**[[A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] compliance —** Treat **PortionOf** as Σ‑additive stocks; **ComponentOf** must respect boundary integration (BIC); **PhaseOf** is *not* aggregated here (handled by Γ\_time); mapping/representations are *not* parthood.

### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:1 - Purpose
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:2 - Context
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:3 - Problem (seen on real projects)
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:4 - Forces
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:5 - Solution (conceptual core)

#### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:5.1 - Operator signature
...
#### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:5.2 - Three attribute classes
...
#### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:5.3 - Boundary‑Inheritance Standard (BIC)
...
#### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:5.4 - Cut‑Stable Boundary Axiom (reminder)
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:6 - Step‑by‑Step Aggregation Recipe
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:7 - Worked Example — Battery‑Electric Bus Pack (2025 model year)
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:8 - Conformance Checklist (author‑facing)
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:9 - Consequences
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:10 - Rationale (link to modern practice)
...
### [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:11 - Relations

* **Builds on:** Dependency Graph (B .1.1); Transformer Principle ([[A.3 - Transformer Constitution (Quartet)|A.3]]).
...
## [[B.1.2 - System‑specific Aggregation Γ-sys|B.1.2]]:End
