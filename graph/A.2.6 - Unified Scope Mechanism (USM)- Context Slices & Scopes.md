...
**Cross‑references.**
— **[[C.2.3 - Unified Formality Characteristic F|C.2.3]]** (Unified Formality **F**) and **[[C.2.2 - Reliability R in the F-G-R triad|C.2.2]]** (F–G–R): this pattern **defines G** as `U.ClaimScope`.
— **[[A.2.2 - U.Capability|A.2.2]]** (Capabilities): capability gating now **SHALL** use `U.WorkScope`.
— **Part B** (Bridges & CL): Cross‑context transfers **MUST** declare a Bridge with **CL**; CL affects **R**, not **F/G**.
— **Part E** (Publication discipline; e.g., **[[E.17 - Multi‑View Publication Kit|E.17]] MVPK**): publication views, cards, and lanes MAY declare `U.PublicationScope` to bound **where** a publication is admissible; `U.PublicationScope` MUST NOT widen the underlying `U.ClaimScope`/`U.WorkScope`. (USM supplies the scope calculus; Part E supplies publication discipline.)

## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:1 - Purpose & Audience
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2 - Context

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.1 - Cross‑disciplinary pressures
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.2 - context‑local reasoning
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.3 - Minimal, composable trust math

In **F–G–R**:

* **F** (formality) is “how strictly a claim is expressed” ([[C.2.3 - Unified Formality Characteristic F|C.2.3]]).
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:3 - Problem
...
5. **Overloaded words.** *Validity* clashed with **Validation Assurance (LA)**; *operation/operational* clashed with **Work/Run** in [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], producing governance ambiguity.

## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:4 - Forces
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:5 - Solution — Overview (preview; full definitions in Part 2)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6 - Normative Definitions

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.0 - USM as a `U.Mechanism.Intension` (normalization for [[A.6 - Signature Stack & Boundary Discipline|A.6]].1/A.6.5)

**Intent.** This subsection makes the **USM** definition in [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] explicitly conform to the
`U.Mechanism` *intension* requirements ([[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]) and the `…Slot` / `…Ref` lexical discipline ([[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]]),
without changing USM’s meaning.

**USM Mechanism.Intension (normative; [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] decomposition).**
...
**SlotIndex (USM) for operators/guards (normative; [[A.6.0 - U.Signature - Universal, law‑governed declaration for a SubjectKind on a BaseType|A.6.0]]:4.1.1 + [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]]).**
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.2 - `U.Scope` — the abstract set‑valued scope property (USM kind; **not** a CSLC measurement)
...
* **SpanUnion** (parallel, independently supported coverage) **only when an explicit named independence assumption is declared** (features or characteristics named, validity window stated, evidence class cited). See **[[A.6 - Signature Stack & Boundary Discipline|A.6]].1/USM LawSet** for the normative template.
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.3 - `U.ClaimScope` (nick **G**) — scope of a claim (episteme)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.4 - `U.WorkScope` — scope of doing Work (capability)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.5 - `U.PublicationScope` — scope of a publication view or publication form
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7 - Scope Algebra

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.1 - Membership & Coverage
...
**Tri‑state admissibility under unknowns (normative; aligns [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]).**
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.2 - Serial Composition (Intersection)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.3 - Parallel Support (SpanUnion)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.4 - Why a **G-ladder/levels/scales** is not needed (and **must not** be introduced)
...
**Normative directive.**
`U.ClaimScope (G)` **SHALL** remain a **set‑valued USM scope object**; **no ordinal or numeric ladder SHALL be defined** for G. If a profile needs scalar reporting, it MAY publish an explicit **report‑only** proxy **`CoverageMetric(G)`**, but **`CoverageMetric(G)` MUST NOT substitute for `G`** in norms, gates, bridge semantics, or CL routing. Authoring and gating **SHOULD** use **F thresholds** ([[C.2.3 - Unified Formality Characteristic F|C.2.3]]) and **explicit guard predicates** ([[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]) rather than pseudo‑levels of G.

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.5 - Translation across Contexts (Bridge & CL)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.6 - Δ‑Operations (Widen, Narrow, Refit)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.7 - Invariants
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.8 - Empty & Partial Scopes
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8 - Locality, Time & Version Semantics

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.1 - context‑locality
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.2 - Time selector `Γ_time`
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.3 - Standards, versions & notations
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.4 - Determinism of evaluation
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.5 - Interaction with R (freshness & decay)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:9 - Lexical Discipline (Part E compliance)
...
**L‑USM‑2 (Work/Run).** Prefer **Work/Run** vocabulary from [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for system execution contexts. Do not introduce “operation/operating” as characteristic names; use **Work scope**.
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10 - Guard Patterns (ESG & Method–Work)

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.1 - Common guard shape
...
**Admissibility note (normative; [[A.6.1 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] alignment).** If `ScopeCoverage` is **unknown** (due to unknown slice keys, unmappable translation, missing `Γ_time`, etc.), the guard MUST NOT silently treat this as `false`. It MUST either abstain (fail closed) or apply an explicit R‑lane degradation policy.
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.2 - ESG guard families (epistemes)
...
When rigor is gated, the guard MUST reference [[C.2.3 - Unified Formality Characteristic F|C.2.3]]:
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.3 - Method–Work guard families (capabilities)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.4 - Bridge‑aware guard macro (reusable)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.5 - Selector policy (Γ\_time)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:11 - Conformance Checklist (USM)
...
| **CC‑USM‑14 (Slot discipline).**      | Where USM operations/guards are referenced in signatures or templates, they **SHALL** use explicit SlotSpecs and obey the [[A.6.5 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n‑ary relations (with slot‑operation lexicon)|A.6.5]] lexical discipline (`…Slot` for SlotKinds; `…Ref` only for RefKinds/refs). |
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12 - Worked Examples
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.1 - Research claim (controlled narrative → predicate)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.2 - Cross‑context use of the research claim
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.3 - Capability: robotic weld Work scope
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.4 - Serial intersection (API + dataset compatibility)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.5 - Parallel support (SpanUnion) in a safety case
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.6 - ML model deployment across Contexts
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13 - Playbooks (Informative)

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.1 - Manager’s 6‑step adoption checklist
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.2 - Architect’s design rubric for scopes
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.3 - Review anti‑patterns & fixes
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.4 - Minimal DSL snippet for scope blocks (illustrative)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.5 - Profiles as Scope configurations (informative)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14 - Governance Hooks & Audits

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.1 - Governance metadata (normative)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.2 - USM compliance levels (informative)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.3 - Audit checklist (informative)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.4 - Risk controls (informative)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15 - Cross‑Pattern Coordination

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.1 - With F–G–R ([[C.2.2 - Reliability R in the F-G-R triad|C.2.2]])

* **G is Claim scope.** Use set algebra (∩ / SpanUnion).
* **F** remains the expression rigor ([[C.2.3 - Unified Formality Characteristic F|C.2.3]]); **R** captures evidence freshness and CL penalties.
* **Weakest‑link.** On dependency paths: **F\_composite = min(F)**, **R\_composite = min(R)**; **G** follows §7.2–§7.3 (set rules).

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.2 - With Formality ([[C.2.3 - Unified Formality Characteristic F|C.2.3]])
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.3 - With Work & Run ([[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]])
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.4 - With Bridges & CL (Part B)
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.5 - With Capability governance ([[A.2.2 - U.Capability|A.2.2]])
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:16 - Extended FAQ (informative)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17 - Annexes (informative)

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.1 - Deprecated wording -> USM dictionary
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.2 - Minimal data model hints
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:18.3 - Pseudocode membership (illustrative)
...
## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17. 4 Rationale - F‑Cluster Unification for [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] ([[F.17 - Unified Term Sheet (UTS)|F.17]] and [[F.18 - Local‑First Unification Naming Protocol|F.18]])

> **Intent.** This annex applies the **F‑cluster method** to triangulate **USM** terms against a diverse set of post‑2015 sources and communities (“Contexts”), and then fixes the **Unified Tech** and **Plain** names used in [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]. Results are ready for downstream lexicon entries (Part E) and guard templates (ESG / Method–Work).

### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.1 - [[F.17 - Unified Term Sheet (UTS)|F.17]] Unified Term Survey (UTS) — Method & Scope
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.2 - UTS Table ([[F.17 - Unified Term Sheet (UTS)|F.17]]) — Cross‑context term mapping
...
### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3 - [[F.18 - Local‑First Unification Naming Protocol|F.18]] Term Selection — Unified Tech & Plain names

#### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.1 - Selected names (normative)

| Concept in [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]                | **Unified Tech** (lexicon)                      | **Unified Plain** (manager‑friendly) | Allowed short form   | Deprecated / avoid                                                    |
| ------------------------------- | ----------------------------------------------- | ------------------------------------ | -------------------- | --------------------------------------------------------------------- |
...
#### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.2 - Phrasebook (for editors, normative)
...
#### [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.3 - Rosetta summary (informative, for rationale box)
...
**Outcome.** The UTS shows clear convergence across SoTA Contexts on **addressable context** and **set‑valued applicability**. [[F.18 - Local‑First Unification Naming Protocol|F.18]] therefore fixes: **Context slice**, **Scope**, **Claim scope (G)**, **Work scope**, **Publication scope** with the algebra and guard clauses mandated in [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]. This closes synonym drift while remaining readable for engineering managers and precise for assurance tooling.

## [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:End
