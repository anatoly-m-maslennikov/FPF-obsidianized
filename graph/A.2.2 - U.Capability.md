...
## [[A.2.2 - U.Capability|A.2.2]]:1 - Context (plain‑language motivation)
...
## [[A.2.2 - U.Capability|A.2.2]]:2 - Problem (what goes wrong without this concept)
...
## [[A.2.2 - U.Capability|A.2.2]]:3 - Forces (what we must balance)
...
## [[A.2.2 - U.Capability|A.2.2]]:4 - Solution — define the ability explicitly

### [[A.2.2 - U.Capability|A.2.2]]:4.1 Definition
...
* **`U.WorkScope`** (*Work scope*) — the set of `U.ContextSlice` under which the capability can deliver the intended `U.Work` (see **[[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] §6.4**);
...
### [[A.2.2 - U.Capability|A.2.2]]:4.2 Conceptual descriptors (not a data schema)
...
### [[A.2.2 - U.Capability|A.2.2]]:4.3 Shorthand for everyday speech
...
## [[A.2.2 - U.Capability|A.2.2]]:5 - Clear distinctions (litmus tests managers can apply)
...
## [[A.2.2 - U.Capability|A.2.2]]:6 - Archetypal grounding (parallel structural and organizational examples)

### [[A.2.2 - U.Capability|A.2.2]]:6.1 Physical system on a line (structural example)
...
### [[A.2.2 - U.Capability|A.2.2]]:6.2 Software service in operations (structural, cyber-physical)
...
### [[A.2.2 - U.Capability|A.2.2]]:6.3 Organizational unit (enterprise sense)
...
## [[A.2.2 - U.Capability|A.2.2]]:7 - Bias‑Annotation (as in cluster‑E patterns)
...
## [[A.2.2 - U.Capability|A.2.2]]:8 - Conformance Checklist (normative)
...
## [[A.2.2 - U.Capability|A.2.2]]:9 - Capability thresholds on steps (how [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] uses this concept)
...
## [[A.2.2 - U.Capability|A.2.2]]:10 - Time and change (calibration, drift, upgrades)
...
## [[A.2.2 - U.Capability|A.2.2]]:11 - Composition and Γ (how assembled systems “can do”)
...
## [[A.2.2 - U.Capability|A.2.2]]:12 - Interaction with Service Promise Clauses (external promise content)
...
> **Note.** The bare head noun *service* is polysemic; in normative prose it is treated as an **always‑unpack** token. Use [[A.6.8 - Service Polysemy Unpacking (RPR‑SERV)|A.6.8]] (RPR‑SERV) to name the intended facet (promise clause vs endpoint vs work vs commitment).
...
## [[A.2.2 - U.Capability|A.2.2]]:13 - Interaction with Dynamics (laws vs. abilities)
...
## [[A.2.2 - U.Capability|A.2.2]]:14 - Anti‑patterns (and the right move)
...
## [[A.2.2 - U.Capability|A.2.2]]:15 - Migration notes (quick wins for existing texts)
...
## [[A.2.2 - U.Capability|A.2.2]]:16 - Consequences
...
## [[A.2.2 - U.Capability|A.2.2]]:17 - Relations

* **Builds on:** [[A.1 - U.Holon, U.System, and U.Episteme|A.1]] Holonic Foundation; [[A.1.1 - U.BoundedContext Semantic Frame|A.1.1]] `U.BoundedContext`; [[A.2 - Role Taxonomy|A.2]] Role; [[A.2.1 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`.
* **Coordinates with:** [[A.3 - Transformer Constitution (Quartet)|A.3]] (Transformation & role masks); [[A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role–Method–Work Alignment).
...
## [[A.2.2 - U.Capability|A.2.2]]:18 - Didactic quick cards (reuse in specs and slides)
