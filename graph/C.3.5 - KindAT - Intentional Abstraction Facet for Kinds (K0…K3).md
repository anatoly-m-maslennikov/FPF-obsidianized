...
**Placement.** Part C (Kinds), identifier **[[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]**. Audience: engineering managers, architects, editors, assurance leads.

**Depends on.**
— **[[C.3.1 - U.Kind & SubkindOf (Core)|C.3.1]]** (`U.Kind`, `U.SubkindOf (⊑)`), **[[C.3.2 - KindSignature (+F) & Extension-MemberOf|C.3.2]]** (`KindSignature` + F, `Extension/MemberOf`), **[[C.3.3 - KindBridge & CL^k - Cross‑context Mapping of Kinds|C.3.3]]** (KindBridge + `CL^k`), **[[C.3.4 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]]** (RoleMask).
— **[[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] USM** (Claim/Work scope over `U.ContextSlice`), **[[C.2.2 - Reliability R in the F-G-R triad|C.2.2]] F–G–R**, **[[C.2.3 - Unified Formality Characteristic F|C.2.3]] U.Formality (F)**.
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:1 - Purpose (manager’s view)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2 - Context & Rationale

### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.1 - The orthogonality we preserve

* **G (Claim scope)** is **where** a claim holds ([[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).
* **Kinds** give **what** a claim is about ([[C.3 - Kinds, Intent-Extent, and Typed Reasoning (Kind‑CAL)|C.3]].1/3.2).
* **R** is assurance (evidence, freshness, penalties).
* **F** is expression rigor ([[C.2.3 - Unified Formality Characteristic F|C.2.3]]).
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.2 - Why a facet, not a Characteristic
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.3 - Design choice recap (moved from [[C.3 - Kinds, Intent-Extent, and Typed Reasoning (Kind‑CAL)|C.3]] §15.2)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3 - **Anchors K0…K3** (informative)
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.1 - **K0 — Instance‑level**
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.2 - **K1 — Behavioral Pattern**
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.3 - **K2 — Formal Kind/Class**
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.4 - **K3 — Up‑to‑Iso**
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:4 - Manager Heuristics (informative)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:5 - Misuse & Antidotes (informative)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:6 - **Usage Rules (normative)**
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7 - Authoring & Review Guidance (informative)

### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.1 - How to tag (fast rubric)
...
### [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.2 - Review checklist (5 minutes)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:8 - Integration Notes (informative)

* **With [[C.3 - Kinds, Intent-Extent, and Typed Reasoning (Kind‑CAL)|C.3]].1/3.2 (Kinds, Signature, Extension).** AT guides *how* to evolve signature **F** and *what* R coverage is sensible; it **does not** change membership semantics.
* **With [[C.3.3 - KindBridge & CL^k - Cross‑context Mapping of Kinds|C.3.3]] (KindBridge).** AT hints at likely **bridge style** (instance‑map / pattern‑map / type‑map / up‑to‑iso), but **`CL^k`** is still computed from signature/order preservation; penalties route to **R**.
* **With [[C.3.4 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]] (RoleMask).** Persistent K1‑style masks often warrant **promotion to K2 subkinds**.
* **With [[A.2.6 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] (USM).** All scope decisions remain under **G**. AT text should never be used to infer coverage.
* **With [[C.2.3 - Unified Formality Characteristic F|C.2.3]] (F).** AT does not raise/lower **F**; it **suggests** where raising F is cost‑effective.

## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:9 - Worked Mini‑Examples (informative)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:10 - Conformance Checklist (normative)
...
## [[C.3.5 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:End
