...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:1 - Intent
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:2 - Problem & Context
...
[[E.14 - Human‑Centric Working‑Model|E.14]] resolves the impasse by **separating concerns**:
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:3 - Forces
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:4 - Solution

### [[E.14 - Human‑Centric Working‑Model|E.14]]:4.1 - Human-Centric principles

#### [[E.14 - Human‑Centric Working‑Model|E.14]]:4.1.1 - Recognition text and assurance text
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.1 – Working‑Model first, stance explicit.**  **
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.2 – Downward‑only dependency.**
...
>
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.3 – Small working text, big proof.**
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.4 – Human registers first.**
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.5 – Justification modes are explicit.**
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.6 – Parsimony in the working text.**
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.7 – Evidence is a first‑class support.**
...
> **[[E.14 - Human‑Centric Working‑Model|E.14]]‑P.8 – Working-model-first is not explanation-thin.**
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:5 - Layer Standard & Downward Flow (Working‑Model → Assurance)

This section defines **what each layer is for**, **what it guarantees**, and **how a single Working‑Model statement is carried down**.

### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.1 - Working‑Model (what humans see)
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.2 - Assurance‑1: Mapping (from words to kinds)
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.3 - Assurance‑2: Logical (from Working‑Model relations to alias semantics)
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.4 - Assurance‑3: Constructive (from meanings to generative traces)
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.5 - Assurance‑4: Empirical Validation (from claims to observed world)
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:5.6 - The downward grounding for a single Working-Model statement
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:6 - Archetypal Grounding *(System / Episteme)*
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:6.1 - `U.System` — Working‑Model first, Constructive grounding available
...
### [[E.14 - Human‑Centric Working‑Model|E.14]]:6.2 - `U.Episteme` — Working‑Model first; Logical/Mapping preferred; Empirical evidence as appropriate
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:7 - Bias‑Annotation *(what to watch for, and the counter‑moves)*

| Bias (name)                       | Symptom in drafts                                                                           | Conceptual counter‑move                                                                                                                        | Where this is governed                                               |
| --------------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **Formalism capture**             | Treating a constructive narrative as “the real thing,” with **ut:\*Of** reduced to a label. | Re‑assert Working‑Model primacy: publish in **ut:\*Of**; attach assurance **downwards** only when needed.                                      | [[E.8 - FPF Authoring Conventions & Style Guide|E.8]] template; Notational‑Independence guard‑rail.                    |
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:8 - Conformance Checklist *(normative; author‑facing duties for thought and prose)*
...
|**CC-E14-10 (Structural grounding handshake).** | For **structural** edges on the Working-Model, authors **SHALL** set `validationMode=axiomatic` and provide **Constructive** grounding with `tv:groundedBy → Γₘ.sum|set|slice` (see **Compose-CAL** and **CT2R-LOG**). Exactly **one** Γₘ trace is permitted per edge (CI rule alignment). | Aligns [[E.14 - Human‑Centric Working‑Model|E.14]] with CT2R-LOG and Compose-CAL; ensures extensional identity. |
...
| **CC-E14-12 (F-declaration).**             | Normative Working-Model publications **SHALL** declare `U.Formality = Fk` per **[[C.2.3 - Unified Formality Characteristic F|C.2.3]]** (**recommended F ≥ F3** for readable publications). Assurance publications or records **MAY** carry higher F; **min-F** applies to composites. | Aligns [[E.14 - Human‑Centric Working‑Model|E.14]] with the unified Formality characteristic; avoids legacy “tiers/modes”. |
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:9 - Consequences
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:10 - Rationale
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:11 - Relations

**Builds on:**

* **[[E.8 - FPF Authoring Conventions & Style Guide|E.8]] Authoring Conventions & Style Guide** — section order, style principles, and mandatory safety subsections used here.
* **[[E.7 - Archetypal Grounding Principle|E.7]] Archetypal Grounding** — the Tell‑Show‑Show rule applied in this pattern’s own Grounding section.
* **[[C.2.3 - Unified Formality Characteristic F|C.2.3]] Unified Formality Characteristic (F)** — declares the **F** scale and **ΔF** moves for progressive rigor; Working-Model publications **SHALL** declare **F** and remain notation-agnostic.
...
* **[[E.10 - Unified Lexical Rules for FPF|E.10]] Lexical Discipline & Stratification** — ensures naming discipline and register hygiene when the human layer is published.

**Constrains:**

* All architectural patterns that publish relations **SHALL** present them in the Working‑Model layer and **MAY** attach assurance only as needed, preserving plane separation and notational independence. (Template conformance as per [[E.8 - FPF Authoring Conventions & Style Guide|E.8]].)
...
## [[E.14 - Human‑Centric Working‑Model|E.14]]:End
