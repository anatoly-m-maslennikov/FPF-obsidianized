...
**Use this when.** Use this pattern when a holon, model, metric, decision system, policy, or authored FPF claim may create unfair, biased, or ethically unsafe effects for people or groups. If the fairness claim is causal — for example "this intervention is fair", "this policy would have prevented harm", "this model is counterfactually fair", or "this practice causally reduces disparity" — keep the ethical audit in [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] and cite [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use question, causality-ladder rung, estimand, causal evidence support basis, identification, realizability, evidence design, support record, and support verdict.

**Not this pattern when.** If the question under repair is only measurement construction, use [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]; if it is only causal-use support without fairness or ethical audit, use [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]; if it is only an assurance claim or assurance input/result, use [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. Metric disparity alone is not yet causal fairness.

**Causal-fairness boundary.** A local [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-fairness repair, such as adding a causal-use question, estimand, support basis, support record, or supported-fairness-use and unsupported-fairness-use pair, is not by itself the Bias-Audit Cycle. It remains a local support repair until the claim, model, metric, policy, or decision system is in a [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] project, release, assurance, or human/group-impact audit condition.

## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:1 - **Problem Frame**
...
A fairness claim can also be unsafe by causal overclaim. "This policy is fair because a metric improved" is not the same claim as causal fairness, counterfactual fairness, or path-specific fairness. [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] therefore brings causal fairness into the audit entry section: the audit must distinguish metric disparity, associative fairness evidence, interventional fairness proxy, and counterfactual fairness claim before the ethical assurance record is treated as supported.

## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:2 - **Problem**
...
## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:3 - **Forces**
...
## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:4 - **Solution**
...
### [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:4.1 - The Bias-Audit Cycle: Four Phases
...
### [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:4.2 - The Bias Taxonomy: A Shared Language for Critique
...
### [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:4.3 - Normative Artifacts
...
### [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:4.4 - Causal fairness use audit

When a fairness claim is causal rather than metric-only, [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] records the ethical-audit question and cites [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use support:
...
Metric-only fallback: if only a metric disparity is claimed and no causal fairness use is made, record it as metric/evaluation use, not [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]-heavy causal fairness.

Local causal-fairness repair does not by itself trigger the full Bias-Audit Cycle, a panel review, or release-cycle duties. It may only downgrade causal wording, add the missing [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support reference, or mark unsupported causal fairness use.

The full [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] duties activate under [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] project or release conditions: the holon, model, metric, decision system, policy, or authored claim may materially affect people or groups; the fairness/ethical claim is release-bearing; or the local causal-fairness repair becomes an input to audit, assurance, deployment, publication, or risk acceptance.
...
What this does not authorize: [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] does not replace [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use question, causality-ladder rung, estimand, identification, realizability, or `CausalUseSupportVerdict`; it keeps ethical audit and fairness assurance, while [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] keeps assurance claim support and non-admissible-use consequences.

## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:5 - **Conformance Checklist**
...
*   **CC-D5-CF-4:** A causal fairness audit MUST cite [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use question, causality-ladder rung, causal estimand, causal evidence support basis, identification, realizability, evidence design, `causalUseSupportRecordRef` when one is consumed, and `CausalUseSupportVerdict`; [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] keeps ethical audit and fairness assurance.
*   **CC-D5-CF-5:** A local causal-fairness wording repair or support-reference repair does not trigger the full Bias-Audit Cycle unless [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] project, release, assurance, or human/group-impact audit conditions are live.

## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:6 - **Common Anti-Patterns and How to Avoid Them**
...
## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:7 - **Consequences**
...
## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:9 - **Relations**

*   **Implements:** The `Cross-Disciplinary Bias Audit` Guard-Rail ([[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]).
...
*   **Coordinates with:** [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal fairness use, causality-ladder rung, causal estimand, causal evidence support basis, identification, realizability, evidence design, causal-use support record, and causal-use support verdict; [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance claim support and unsupported-use consequences.
*   **Operationalizes:** The conceptual roles of `Ethicist`, `Domain Sociologist`, and `UX Design Critic` from the Intellect Stack.

## [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]:End
