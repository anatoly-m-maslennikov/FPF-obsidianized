...
builds_on:
  - "[[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]"
  ...
  - "[[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]"
  - "[[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]"
  ...
  - "[[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]"
...
coordinates_with:
  ...
  - "[[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]"
  - "[[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]"
  - "[[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]"
  ...
  - "[[00_C.26 - Quantum-Like Modeling Lens|C.26]]"
  - "[[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]"
  - "[[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]]"
  ...
  - "[[00_F.09 - Alignment & Bridge across Contexts|F.9]]"
  - "[[00_G.10 - SoTA Pack Shipping|G.10]]"
  - "[[00_G.02 - SoTA Harvester & Synthesis|G.2]]"
...
**Primary EntityOfConcern.** [[00_C.29 - Mathematical Lens Use|C.29]] concerns a declared mathematical-lens use for a stated phenomenon, EntityOfConcern, relation, claim, or structure-bearing situation. The use names the mathematical object, formalism, learned representation, simulation object, local formal role, or mathematical family; the mapping mode; the preserved structure; the lost structure; the visible payoff or obstruction; the declared lens use; the blocked overread; and the stop condition. FPF-governed wording, pattern examples, method notes, review records, `PublicationUnit`s, decision-facing text, comparison-facing text, bridge-facing text, and assurance-input text can contain or cite that use, but they are not the primary EntityOfConcern of [[00_C.29 - Mathematical Lens Use|C.29]].

**Slot discipline.** [[00_C.29 - Mathematical Lens Use|C.29]] uses `CandidateMathObject` for the mathematical object, formalism, learned representation, simulation object, local formal role, or family in a declared mathematical-lens-use relation. `U.Signature(profile=FormalSubstrate)` in [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] is a different relation position: it declares vocabulary, laws, imports, and applicability for a formal-deductive profile. [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] governs mechanism import or realization when that `U.Signature(profile=FormalSubstrate)` declaration is used in a mechanism; [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] governs P2W carry-through when accepted problem-side material needs that formal declaration for later work. The same mathematical object may appear in several of these positions, but the governing pattern is selected by relation position and claim being made, not by a source-local head word.

**Output boundary.** [[00_C.29 - Mathematical Lens Use|C.29]] outputs are lens-use notes, one-line entries, mini-cards, full cards, and neighboring-pattern notes. They state which declared mathematical-lens use is bounded as usable, what remains blocked, and which neighboring FPF pattern governs any non-lens claim being made. Project approval, work, evidence, assurance, decision, or release use must be recorded through the governing pattern for that use.

**No new `U.*` from [[00_C.29 - Mathematical Lens Use|C.29]] local lens-use outputs.** `MathLensUse.OneLine`, `MathLensUse.MiniCard`, `MathLensUse.FullCard`, `MathLensUse.Card@Context`, `MathLensUseOutputRef`, and `CC-C29-*` are C.29-local instruments. They do not mint `U.MathLens`, `U.MathLensUseRecord`, `LensKind`, `MathLensUseCompliance`, or a durable record family. Durable names, kinds, or records require an accepted FPF naming and kind decision through [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]], [[00_F.08 - Mint or Reuse- (U.Type vs Concept-Set vs Role Description vs Alias)|F.8]], and [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]].

## [[00_C.29 - Mathematical Lens Use|C.29]]:0 - First-use card
...
| What tempting inference does this lens not license? | Name `StopCondition`; no stop condition means no [[00_C.29 - Mathematical Lens Use]] result can carry a declared lens use. |

Start with the useful lens decision: choose, apply, bound, replace, or remove a mathematical lens when the mathematical structure changes explanation, decision, prediction, comparison, publication, bridge, assurance input, reusable transfer, or the next lens-use repair. If no next lens-use move changes, keep ordinary prose or write `NoMathLensUseNeededNote`. If state, transition, measurement, causal use, bridge semantics, temporal adequacy, assurance, selector, benchmark, or release is the claim being made, apply the governing FPF pattern and keep [[00_C.29 - Mathematical Lens Use|C.29]] to the mathematical-lens use part.

## [[00_C.29 - Mathematical Lens Use|C.29]]:1 - Problem frame

FPF already uses mathematical structures in several local patterns. [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] asks for stable relation-precision structure during relation precision restoration; [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] governs dynamics; [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] governs characteristic spaces and structural overlays; [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]] govern scale-law and Bitter-Lesson claims; [[00_C.26 - Quantum-Like Modeling Lens|C.26]] contains the separation of a quantum-like lens from physical quantum ontology; [[00_F.09 - Alignment & Bridge across Contexts|F.9]] governs cross-context bridges and loss.
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:1.1 - First-minute working situation
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:1.2 - Minimum scenario and anti-case set
...
**Anti-case.** “The organization is a quantum system” is written without a candidate mathematical object, probe distinction or readout distinction, preserved structure, lost structure, `LensUseBoundaryValue`, or stop condition. The [[00_C.29 - Mathematical Lens Use|C.29]] result is either a downgrade to local metaphor or a repaired use through [[00_C.29 - Mathematical Lens Use|C.29]] and, where relevant, [[00_C.26 - Quantum-Like Modeling Lens|C.26]].
...
**False-positive scenario.** A Markov kernel appears inside accepted local reliability modeling. If no contested lens-transfer, publication, assurance, bridge, or reusable explanation claim is being made, the claim stays under [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] and does not require a [[00_C.29 - Mathematical Lens Use|C.29]] output.

### [[00_C.29 - Mathematical Lens Use|C.29]]:1.3 - Intended FPF use-value

[[00_C.29 - Mathematical Lens Use|C.29]] gives a cheap-output choice before any full card or boundary table. Its first job is to help the working reader introduce, choose, repair, bound, or decline a mathematical lens by selecting the cheapest honest output: no [[00_C.29 - Mathematical Lens Use|C.29]] output, a candidate note, a one-line repair, a mini-card, a full card when high-reliance use requires it, or a neighboring-pattern note when the claim being made is outside declared mathematical-lens use. Use it only when the mathematical lens affects a claim or next move; ordinary local math and decorative prose stay outside [[00_C.29 - Mathematical Lens Use|C.29]]. A successful [[00_C.29 - Mathematical Lens Use|C.29]] result makes useful mathematical compression available to FPF as a disciplined modeling move while reducing ontology smuggling, prestige vocabulary, loss-free transfer, causal laundering, bridge duplication, evidence laundering, and assurance laundering.

## [[00_C.29 - Mathematical Lens Use|C.29]]:2 - Problem

Accepted FPF mathematical-lens use criteria are distributed and local:

- [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] governs relation precision restoration, but not every mathematical-object transfer.
- [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] governs state, transition, observation, validity, constraints, and calibration for dynamics, but not all mathematical representation choices.
- [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] governs characteristic spaces, structural overlays, comparability, normalization, and bridge-aware state comparison, but not the adequacy of all mathematical lenses.
- [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]] govern scale-law and BLP claims, but not non-scale mathematical lenses.
- [[00_C.26 - Quantum-Like Modeling Lens|C.26]] is the local precedent for mathematical-lens detachment, but only for quantum-like modeling.
- [[00_F.09 - Alignment & Bridge across Contexts|F.9]] governs cross-context semantic bridges, but does not decide whether a mathematical object, formalism, or learned representation is adequate inside one context or as a domain-transferring lens.
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:3 - Forces
...
| **General pattern vs local precision** | [[00_C.29 - Mathematical Lens Use]] stays non-duplicative with [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_F.09 - Alignment & Bridge across Contexts]], [[00_C.26 - Quantum-Like Modeling Lens]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], and [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]]; its contribution is coordination around declared mathematical-lens use. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:4 - Solution and selected answer

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.1 - Selected answer in one paragraph
...
Register policy: **Tech exactness below, Plain metaphor above.** Plain phrases such as “structures that survive transfer,” “what the lens makes visible,” and “where the lens stops” are acceptable as recognition aids. When a sentence makes an FPF-kind, relation, evidence, use-boundary claim, causal, assurance, bridge, gate, work, decision, or pattern-application commitment, the corresponding [[00_C.29 - Mathematical Lens Use|C.29]] output recovers the fields named by value and governing patterns.

Zero and first-principles compatibility note: [[00_E.01 - Vision & Mission- “Operating System for Thought”|E.1]] and [[00_E.02 - The Eleven Pillars|E.2]] govern the mission and pillar authority. [[00_C.29 - Mathematical Lens Use|C.29]] serves them by making mathematical first-principles lens use inspectable for one declared use: candidate mathematical object, preserved structure, lost structure, visible payoff, bounded move, neighboring-pattern boundary, and stop condition. It does not replace pillar authority, neighboring governing patterns, ordinary FPF reasoning, or the [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]] design-rationale record for normative changes.

Mathematics is not a prerequisite for FPF use. Ordinary prose is enough when no mathematical structure changes the next lens-use move. [[00_C.29 - Mathematical Lens Use|C.29]] earns its place only when a mathematical object, formalism, learned representation, simulation object, or mathematical family changes explanation, decision, prediction, comparison, publication, bridge, assurance input, reusable transfer, or the next lens-use repair.
...
State and transition semantics stay with [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]; temporal aspects stay with [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]]; characteristic spaces and overlays stay with [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]; temporal-use adequacy stays with [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]; scale-law and general method-scale preference claims stay with [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]]; architecture scale-preference claims stay with [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]]; causal-use question and verdict stay with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]].

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.2a - Mathematicalization Utility Principle
...
- a causal, intervention, or counterfactual preservation question governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]];
- a bridge or export loss governed by [[00_F.09 - Alignment & Bridge across Contexts|F.9]];
- a measurement or comparability condition governed by [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]].

If no next lens-use move changes, keep the text as ordinary prose, downgrade it to a didactic metaphor, or return `NoMathLensUseNeededNote`. A lens that merely makes prose more impressive is not a successful [[00_C.29 - Mathematical Lens Use|C.29]] result.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.2b - First-principles lens-family use

[[00_C.29 - Mathematical Lens Use|C.29]] admits first-principles use only when the principle family changes what the working reader can derive, inspect, compare, observe, or honestly block. The family name is never enough. Each row below is a discovery and recovery discipline: it tells the reader what must be named before claim-bearing mathematical-lens use is bounded for use.

| First-principles family | Use when the working problem asks | Required [[00_C.29 - Mathematical Lens Use]] recovery | Stop or neighboring-pattern application |
|---|---|---|---|
| Boundary, exterior derivative, Stokes-like local-to-global relation | How local increments, flows, sources, interfaces, or balances compose into a global claim. | Name the domain, boundary, field, form, or flow, derivative, divergence, or curl-like operator, boundary condition, and what is conserved, sourced, or lost at the boundary. | Does not make all boundary language one mechanism; measurement, evidence, and bridge claims are governed by [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], or [[00_F.09 - Alignment & Bridge across Contexts]]. |
| Cohomology, closed relation and relation named by value split, topological obstruction | Why a local rule cannot be made global, or why a transfer or composition is blocked. | Name the cycle or cocycle-like object, equivalence class or obstruction, local closure condition, failed exactness witness or failed global witness, and the blocked claim. | Useful obstruction is a `LostStructure` or `StopCondition`; it is not a causal explanation without [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] and evidence. |
...
P2W and formal-declaration boundary: when one of these families is used in a P2W carry-through from accepted problem-side material into later work, [[00_C.29 - Mathematical Lens Use|C.29]] still records only the declared mathematical-lens use. A declared formal relation can make mathematical-to-mathematical exactness or near-sameness visible; it does not by itself declare a `FormalSubstrate` signature, `PrincipleFrame`, mechanism, observation-bound world claim, evidence path, causal-use relation, Bridge-declared lens use, or work. Use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] for the `U.Signature(profile=FormalSubstrate)` declaration, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] when mechanism import or realization is being claimed, and [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] when accepted problem-side material needs a formal declaration for later FPF use.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.2c - Bounded-observer structural-information lens
...
When the target is a physical, organizational, or project-world situation, the record must say whether the structural-information claim is observational, postulated, simulated, or only a description-local compression. When the lens is used in architecturing, [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] governs architecture as EntityOfConcern, [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]] governs structural-view adequacy, [[01_C.30.AD - Architecture Description Adequacy|C.30.AD]] governs architecture descriptions, and [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] or [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] governs modularity or reusable-structure accounting. [[00_C.29 - Mathematical Lens Use|C.29]] records only the declared lens use: what recoverable structure the mathematical lens makes visible, what it loses, and where that use stops.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.2d - Architecture-local lens descriptions

Architecture work may use C.29-local descriptions for graph, flow, control, structural-information, RG or coarse-graining, and multilevel-learning or frustration lenses. These names are [[00_C.29 - Mathematical Lens Use|C.29]] output descriptions, not architecture ontology, not proof, and not durable FPF kinds by themselves.

| Local [[00_C.29 - Mathematical Lens Use]] description | Candidate mathematical object | Visible payoff | Stop condition |
| --- | --- | --- | --- |
...
`MLU.Description@RGArchitecture` applies only when the use names a declared aggregation scope, scale variable or scale window, coarse-graining rule, preserved structure, lost structure, source-return condition, and the overread named by value that the lens does not license. If the claim becomes a scale-preference claim, [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]] governs the architecture preference side; [[00_C.29 - Mathematical Lens Use|C.29]] keeps only the declared mathematical-lens use.
...
The index `_l` is a declared aggregation-scope index inside this [[00_C.29 - Mathematical Lens Use|C.29]] lens, not a generic level, tier, layer, or ladder. Each use names the aggregation scope, the coarse-graining rule, the lost structure, and the source-return condition.
...
Declared lens use: triage, explanation, candidate generation, rival-lens comparison, scale-window reasoning, source-return triggers, and architecture-decision rationale only when the neighboring pattern governs any non-[[00_C.29 - Mathematical Lens Use|C.29]] claim. Blocked overread: no proof that the project literally optimizes one global function, no causal proof, no assurance score, no claim that complexity necessarily grows, and no replacement for [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or stakeholder and ethics patterns.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.3 - Use boundary

This boundary prevents [[00_C.29 - Mathematical Lens Use|C.29]] from being over-applied.

**Use [[00_C.29 - Mathematical Lens Use|C.29]] when** a mathematical object, formalism, learned representation, simulation object, or mathematical family is used as a lens for explanation, decision, prediction, publication, comparison, assurance input, bridge, or reusable transfer over a physical, organizational, epistemic, social, computational, scientific, or methodological phenomenon, or when a phenomenon, decision, explanation, comparison, model-selection, diagnosis, or method-choice problem is stable enough that the first useful move is to choose a cheap candidate lens that makes relevant structure visible.

**Do not use [[00_C.29 - Mathematical Lens Use|C.29]] as the governing pattern when:**
...
- the question under repair is causal-use question, causal-use justification, or verdict, which is governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]];
- the question under repair is measurement construction, scale construction, direct comparability, or evidence-stub adequacy, which is governed by [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]];
- the question under repair is cross-context meaning or substitution safety, which is governed by [[00_F.09 - Alignment & Bridge across Contexts|F.9]];
- the question under repair is dynamics semantics without a separate lens-transfer claim, which is governed by [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]];
- the question under repair is a `CharacteristicSpace` overlay with no domain-transfer, prediction, assurance, publication, or reusable explanation claim, which stays under [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]].
- the use under repair is a `ChoiceResult`, local choice record, selected-set publication, selected method, `U.WorkPlan`, performed `U.Work`, work-result record, or work-relevant source restoration; those claims stay with [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] or [[00_G.09 - Parity and Benchmark Harness|G.9]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], or [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] as appropriate.
- the use under repair is an explanation-facing rendering, bounded comparative review unit, same-EntityOfConcern representation-scheme transition, or controlled semantic coarsening; those claims stay with [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], or [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], with [[00_C.29 - Mathematical Lens Use|C.29]] fields carrying only mathematical-lens use when the mathematical lens affects the stated declared lens use.
- the claim being made is about forecast, rate, trajectory, rhythm, recovery, convergence, stabilization, speed, temporal window, or rate-change as sufficient for use; temporal-claim adequacy stays with [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]].
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4 - Output choice before the full card
...
Memory hook: a successful [[00_C.29 - Mathematical Lens Use|C.29]] application can raise or lower the mathematical claim-bearing use. It can introduce a first candidate lens, keep ordinary domain prose, remove a mathematical lens, repair relation wording through [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], declare a `CharacteristicSpace` through [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], use [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for measurement and comparability, apply [[00_F.09 - Alignment & Bridge across Contexts|F.9]] for bridge semantics, ask the [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] causal-use question, restore work or source responsibility through [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], or apply [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal-use adequacy.
...
| Claim-bearing question | Govern there first | [[00_C.29 - Mathematical Lens Use]] remainder |
|---|---|---|
| relation-precision structure, relation kind, or structure-preserving relation wording | [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] and local relation patterns | mathematical-lens use only if a mathematical object changes the stated use |
| state variables, transition law, observation map, constraints, or calibration | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] and [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | preserved structure and lost structure and lens stop condition |
| measurement construction, scale, unit, polarity, or comparability | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] | lens-use boundary value for measurement-dependent use |
| scale law, universality, knee, exponent, general method-scale preference, or architecture scale preference | [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] for scale-law and general method BLP claims; [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] for architecture scale-preference claims over a declared alternative set, scale variable, and scale window | scale-bounded mathematical-lens use |
| cross-context meaning, bridge use, or substitution use | [[00_F.09 - Alignment & Bridge across Contexts]] | mathematical structure used inside the bridge claim |
| causal, intervention, policy, or counterfactual use | [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] | whether the lens preserves, approximates, or blocks causal-use structure |
| evidence, provenance, source currentness, assurance, release, selector, or benchmark use | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], or relevant `G.*` pattern | declared mathematical-lens use as one input only |

Governing-pattern boundary: [[00_C.29 - Mathematical Lens Use|C.29]] coordinates the declared mathematical-lens use across relation-precision structure, state spaces, characteristic spaces, measurement, dynamics, scale, bridge, causal, evidence, assurance, selector, and benchmark patterns. It does not replace any one of them.
...
4. **State the lens mapping mode.** Use the least committing honest [[00_C.29 - Mathematical Lens Use|C.29]]-local lens mapping mode: analogy-only prompt, representation, empirical fit, simulation, quotient, abstraction, coarse-graining, embedding, homomorphism, isomorphism, functor-like transfer, cross-context lens-transfer candidate, or accepted local theory. If cross-context meaning, substitution, CL, sense cells, or bridge or substitution use is being claimed, [[00_F.09 - Alignment & Bridge across Contexts|F.9]] governs that claim; the [[00_C.29 - Mathematical Lens Use|C.29]] fields record only mathematical-lens use for the declared transfer.
...
| `NeighborGoverningPatternNote` | `NeighborGoverningPatternNote` | The claim being made is causal use, bridge or substitution, measurement construction, scale construction, direct comparability, evidence-stub adequacy, dynamics semantics, temporal adequacy, decision result, selected method, work plan, performed work, evidence trust, assurance, explanation rendering, comparative review, representation transition, coarsening, scale law, release, selector, or benchmark. | Name the governing FPF pattern and apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_F.09 - Alignment & Bridge across Contexts]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[00_C.11 - Decision Theory (Decsn-CAL)]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[01_A.15.01 - U.Work]], [[04_A.15.04 - Work-Relevant Source Restoration]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[01_A.06.03.CSC - Controlled Semantic Coarsening]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]], or a relevant G pattern. The [[00_C.29 - Mathematical Lens Use]] application keeps only the declared lens-use result. |
...
MathLensUse.LensCandidateNote@ArchitectureP2W := {
  ...
  ExpectedVisiblePayoff: decide whether the next honest output is a [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] one-line lens use, an [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] FormalSubstrate signature declaration, or an [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] P2W carry-through use of the accepted problem-side distinction,
  ObservableOrControllableCue?: boundary temperatures, heat-flow observations, reference-plane assignment, deformation readout,
  NextLensUseMove: write `MathLensUse.OneLine` only after mapping, preserved structure, lost structure, and stop condition are nameable; apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] only when `U.Signature(profile=FormalSubstrate)` must be declared; apply [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] only when the accepted problem-side distinction must be used in later FPF work,
  OrdinaryRivalOrFallback: ordinary deformation narrative plus local measurement note,
  StopCondition: no method is selected, no work plan is created, no evidence-relation claim is made, and no causal-use verdict or assurance claim follows from this [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] note,
  NextMathLensUseOutput: MathLensUse.OneLine or NeighborGoverningPatternNote
}
```

This filled slice is a [[00_C.29 - Mathematical Lens Use|C.29]] first-use output. It does not declare the formal signature, complete P2W carry-through by itself, select the method, or create work. Those claims are governed by [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when those claims are being made.
...
Name guard for this note: `ProblemStructureCue` is a recognition cue, not a FPF signature; `CandidateLensFamily` is a family prompt, not a kind; `NextLensUseMove` is action guidance, not a work record; `NextMathLensUseOutput` is the next [[00_C.29 - Mathematical Lens Use|C.29]] output class, not a new record family.
...
Cheap stop: if the mathematical phrase does not affect any claim beyond orientation, do not use the full card. If the first honest output is `NoMathLensUseNeededNote`, that is a successful [[00_C.29 - Mathematical Lens Use|C.29]] result, not an underfilled card.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.1 - Output set and declared-use boundary

After applying [[00_C.29 - Mathematical Lens Use|C.29]], the output is one of these:
...
| `NeighborGoverningPatternNote` | A named neighboring FPF pattern governs the causal, bridge, evidence, scale, dynamics, temporal, decision, work, explanation, comparison, representation, measurement, or assurance claim being made; the [[00_C.29 - Mathematical Lens Use]] application records only the declared lens-use result. |

Positive warning: a successful [[00_C.29 - Mathematical Lens Use|C.29]] output makes the mathematical lens honest for its declared use. Any empirical truth, causal-use, bridge, assurance, release, decision, or benchmark claim still needs its governing FPF pattern.
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.2 - From lens to local action

Local action change from a mathematical lens is limited to these cases unless a neighboring pattern governs the needed non-[[00_C.29 - Mathematical Lens Use|C.29]] use:
...
Each item closes either as a local [[00_C.29 - Mathematical Lens Use|C.29]] output or as a named neighboring-pattern application. If the needed result is a work plan, choice result, selector output, benchmark, or evidence record, publish that neighboring result in its governing pattern rather than from this list.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.3 - No-lens entry: choosing a first candidate lens

Use this when the next lens-use move can benefit from a mathematical lens but no adequate mathematical object has been named. The output is `MathLensUse.LensCandidateNote`, not `MathLensUse.OneLine` and not a full card. State the `ProblemStructureCue`, choose one cheap `CandidateLensFamily`, say what it could make visible, name the `ObservableOrControllableCue?` when available, state the `NextLensUseMove`, compare it with the `OrdinaryRivalOrFallback`, and stop if no action changes. If the cue is still pre-articulation and no stable `ProblemStructureCue` can be named, do not mathematize it; preserve cue plurality through [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]], or the relevant language-state pattern before applying [[00_C.29 - Mathematical Lens Use|C.29]].
...
| state change, trajectory, stabilization, or control pressure | state-space, dynamics, Markov, ODE, or control lens | Name state, transition law, observation map, and validity window; return dynamics semantics to [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], temporal aspects to [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]], and temporal-use claims to [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] when those claims are being made. |
| dependency, interface, composition, or transfer failure | graph, hypergraph, category, operad, or compositional lens | Expose edges, edge meaning, slots, interfaces, composition law, and failed transfer; use [[00_F.09 - Alignment & Bridge across Contexts]] when cross-context meaning or substitution is being claimed. |
...
| comparison, similarity, distribution shift, population movement, or shape change | metric-space distance, topology, embedding, or optimal-transport lens | Declare what distance, neighborhood, order, embedding, coupling, or transport cost preserves and what it loses; use [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] for comparability and measurement construction when those claims are being made. |
| scale transition, coarse behavior, universality, knee, fixed point, or basin-of-attraction cue | coarse-graining, RG, fixed-point, or scaling-law lens | Name scale variable, scale window, coarse-graining rule, fixed point or attractor, basin condition or regularity condition, and invariants; use [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] for scale-law adequacy, [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] when general method scale-preference or BLP preference is being claimed, and [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made. |
...
| intervention, policy effect, or counterfactual question | SCM, causal graph, or causal abstraction lens | Name the causal object, intervention or assignment, outcome readout, and whether counterfactual structure is preserved, approximated, or not claimed; keep causal-use question and verdict with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]. |
...
| probe effects, order effects, context effects, incompatible frames, or measurement-as-intervention | quantum-like or contextual-probability lens | Use [[00_C.26 - Quantum-Like Modeling Lens]] for quantum-like adequacy when order effects, probe effects, or context effects are actually being made; block physical quantum ontology unless separate physics evidence is supplied. |

`MathLensUse.LensCandidateNote` is local first-candidate guidance. It does not replace [[00_G.02 - SoTA Harvester & Synthesis|G.2]] SoTA synthesis, tradition mapping, or broad lens-family review. Use [[00_G.02 - SoTA Harvester & Synthesis|G.2]] when the work being done is tradition-scale source synthesis; use [[00_C.29 - Mathematical Lens Use|C.29]] when the local need is to choose one cheap candidate lens that changes the next lens-use move. The cheap observation and control check does not apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] or [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] by default; it only asks what the user can observe, read out, assign, vary, or validate now. Measurement construction, evidence relation, intervention-use claim, or validation is still governed by the governing pattern when that claim is being made.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.4 - First honest [[00_C.29 - Mathematical Lens Use|C.29]] entry cases

For E.11-style first-entry recognition, distinguish the working entry case before choosing an output:

| First honest entry case | What the working reader met | First [[00_C.29 - Mathematical Lens Use]] answer |
|---|---|---|
| Pre-articulation cue | Something feels structurally wrong, but it is not yet a claim and no stable `ProblemStructureCue` can be named. | Do not impose a mathematical lens. Use [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets]], [[00_A.16 - Language-State Move Coordination]], [[02_A.16.01 - U.PreArticulationCuePack]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route]], [[01_B.05.02.00 - U.AbductivePrompt]], or the relevant language-state pattern first; apply [[00_C.29 - Mathematical Lens Use]] only when the problem structure is stable enough. |
...
| Wrong first pattern | The reader reaches for [[00_C.26 - Quantum-Like Modeling Lens]], [[00_F.09 - Alignment & Bridge across Contexts]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], or [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] before knowing whether mathematical-lens use is being made, or reaches for [[00_C.29 - Mathematical Lens Use]] when a neighbor already governs. | Name the first governing pattern and state what [[00_C.29 - Mathematical Lens Use]] contributes, if anything. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.5 - False-positive bank and entry stops

Do not use a [[00_C.29 - Mathematical Lens Use|C.29]] output for these non-use cases unless a separate lens-transfer, publication, assurance, bridge, comparison, or reusable-explanation claim is being made:
...
- metric-space distance, topology, order, product, subspace, or embedding declared inside [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace` with no domain-transfer claim;
...
False-negative bank: use [[00_C.29 - Mathematical Lens Use|C.29]] even when no polished mathematical buzzword appears if the working problem has a structure that changes an next lens-use move and ordinary prose is currently hiding it.

| False-negative situation | Why [[00_C.29 - Mathematical Lens Use]] applies | Cheap move |
|---|---|---|
| “Something is off, but we cannot yet say whether it is flow, priority, meaning, or evidence.” | The cue is not stable enough for `ProblemStructureCue`. | Stay in language-state work first; do not make [[00_C.29 - Mathematical Lens Use]] create a mathematical lens from an unstable cue. |
...
| “We transfer a structure between contexts because it looks the same.” | Mathematical-lens use and bridge loss are being claimed. | Name preserved structure and lost structure and use [[00_F.09 - Alignment & Bridge across Contexts]] when cross-context meaning or substitution is being claimed. |
...
| “The method scales because the mathematics is elegant.” | Scale-law adequacy or BLP preference claim is being made. | Name scale variable or scale window; use [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] for scale-law adequacy, [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] for general method scale-preference or BLP preference, and [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] for architecture scale preference. |

Entry guidance states when [[00_C.29 - Mathematical Lens Use|C.29]] is the first governing pattern and when another pattern is first:

| Entry situation | First governing pattern | Tempting wrong first pattern |
|---|---|---|
| mathematical-lens use inside a phrase such as "market is a field" | [[00_C.29 - Mathematical Lens Use]] | [[00_C.26 - Quantum-Like Modeling Lens]], [[00_F.09 - Alignment & Bridge across Contexts]], or [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] before declared lens use is checked |
| explanation-facing rendering that uses a mathematical lens | [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]]; [[00_C.29 - Mathematical Lens Use]] only for the mathematical-lens use part when that lens affects explanation use | [[00_C.29 - Mathematical Lens Use]] as the first pattern for every explanation |
| bounded comparative review unit with a mathematical comparison construction | [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]]; [[00_C.29 - Mathematical Lens Use]] only for declared lens use or rival-lens relation | [[00_C.29 - Mathematical Lens Use]] as the comparison or adjudication record |
| same-EntityOfConcern representation-scheme transition | [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]]; [[00_C.29 - Mathematical Lens Use]] only if the transition imports a contested or use-affecting mathematical lens | [[00_C.29 - Mathematical Lens Use]] for every table, diagram, geometry, or notation shift |
| coarsened rendering useful only under narrower declared lens use and source-bearing reopen | [[01_A.06.03.CSC - Controlled Semantic Coarsening]]; [[00_C.29 - Mathematical Lens Use]] only if the coarsening depends on mathematical abstraction or coarse-graining | [[00_C.29 - Mathematical Lens Use]] as source-bearing return or bridge relation |
| within-context representation adequacy | [[00_C.29 - Mathematical Lens Use]] | [[00_F.09 - Alignment & Bridge across Contexts]] when no cross-context meaning claim is being made |
| quantum-like dashboard or probe-order claim | [[00_C.26 - Quantum-Like Modeling Lens]] plus [[00_C.29 - Mathematical Lens Use]] compatibility | physical quantum ontology |
| graph state space | [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] or [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] unless lens transfer is explicit | [[00_C.29 - Mathematical Lens Use]] for every graph word |
| category bridge across contexts | [[00_F.09 - Alignment & Bridge across Contexts]] plus [[00_C.29 - Mathematical Lens Use]] lens-use relation | duplicate bridge semantics inside [[00_C.29 - Mathematical Lens Use]] |
| prediction, rate, trajectory, recovery, convergence, or rhythm claim | [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] when temporal adequacy is being claimed; [[00_C.29 - Mathematical Lens Use]] only for declared lens use | treating a mathematical prediction cue as enough for temporal-use adequacy |
| decorative scale language | no [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] unless scale behavior is being claimed | scale-law review for every scale word |

[[00_C.29 - Mathematical Lens Use|C.29]] entry stops are: no [[00_C.29 - Mathematical Lens Use|C.29]] output needed, `MathLensUse.OneLine` used, or a neighboring governing pattern applied.

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.4.6 - Governing-pattern boundary table

A [[00_C.29 - Mathematical Lens Use|C.29]] application uses this governing-pattern discipline so mathematical-lens use stays in the [[00_C.29 - Mathematical Lens Use|C.29]] discipline rather than becoming a second authority over neighboring claims.

Positive claim kind:

> A [[00_C.29 - Mathematical Lens Use|C.29]] application gives a pattern-local adequacy discipline for claims that use a mathematical object, formalism, learned representation, simulation object, or mathematical family as a mathematical lens for a stated use. The application asks for candidate mathematical object, lens mapping mode, preserved and lost structure, visible invariant or distinction, `LensUseBoundaryValue` or validation regime, declared lens use, blocked overread, and stop condition.

Boundary application rule: when the claim being made is a choice result, work plan, evidence path, assurance tuple, explanation rendering, comparative review unit, representation shift, temporal claim, bridge, causal-use claim, measurement claim, scale-law claim, selector, or benchmark, the `NeighborGoverningPatternNote` names the governing FPF pattern and project-side record. A [[00_C.29 - Mathematical Lens Use|C.29]] application can contribute a lens-bounded prediction, distinction, obstruction, diagnostic boundary, or rival-lens note that the governing record can cite; it does not create that neighboring record.

| Object or claim being made | Governing FPF pattern | [[00_C.29 - Mathematical Lens Use]] contribution |
|---|---|---|
| mathematical-lens use | [[00_C.29 - Mathematical Lens Use]] | Names the [[00_C.29 - Mathematical Lens Use]] discipline: candidate mathematical object, lens mapping mode, preserved structure and lost structure, invariant or distinction, `LensUseBoundaryValue`, declared lens use, blocked overread, and stop condition. |
| durable reusable names beyond pattern-local fields | [[00_F.18 - Local-First Unification Naming Protocol]] | Cite when `MathLensUse` names become durable beyond C.29-local use. |
| broad wording and epistemic precision restoration | [[00_E.10 - Unified Lexical Rules for FPF]], [[00_C.02.P - Epistemic Precision Restoration]] | Obey head-kind, register, and epistemic precision-restoration discipline. |
| relation precision, arity, polarity, and slot structure | [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]] | Apply only if relation-precision structure becomes a representation affecting the stated use. |
| object, description, and carrier distinction | [[00_A.07 - Strict Distinction (Clarity Lattice)]] | Do not identify the phenomenon directly with the mathematical object. |
| dynamics state space and transition law | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] | Assess imported or contested lens use; do not govern dynamics semantics. |
| `CharacteristicSpace`, slots, topology, order, and metric-space distance overlays | [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | Apply only when an overlay becomes a domain-transferring or publication-bearing lens. |
| `ChoiceResult`, local choice record, selected-set publication, option-selection claim, or selector or benchmark result | [[00_C.11 - Decision Theory (Decsn-CAL)]]; [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_G.09 - Parity and Benchmark Harness]] when selected-set or benchmark publication use is being made | Can contribute a lens-bounded prediction, distinction, obstruction, diagnostic boundary, or rival-lens note for the decision or selector record. |
| selected method, method-family selection, `U.WorkPlan`, performed `U.Work`, work-result record, or work-relevant source restoration | [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[01_A.15.01 - U.Work]], [[04_A.15.04 - Work-Relevant Source Restoration]] | Can contribute method-relevant lens use; method, plan, performed-work, and source-restoration records stay with the [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] family. |
| evidence path, source currentness, provenance, evidence carrier, or model card or datasheet used as evidence | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] | States `LensUseBoundaryValue` only; evidence paths and provenance remain [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] matters. |
| assurance, readiness, reliability, release confidence, safety, trust, or engineering justification | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] plus relevant G patterns when the corresponding claim is being made | Treats declared lens use as possible input only; mathematical elegance does not raise assurance. |
| measurement construction, scale, unit, or comparability, or evidence-stub adequacy | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] | States measurement-dependent `LensUseBoundaryValue` only; measurement construction, scale, unit, or polarity, direct comparability, and evidence-stub adequacy stay with [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]]. |
| explanation-facing rendering or generated explanation use | [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]] | States mathematical-lens use for the mathematical explanation used inside the rendering; explanation-use discipline stays with [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]]. |
| bounded comparative review unit | [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]] | States declared lens use for a mathematical comparison construction or rival lens when that construction affects the comparative review use. |
| same-EntityOfConcern representation-scheme transition | [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]] | Applies only if the representation shift imports a contested or use-affecting mathematical lens. |
| coarsened rendering with narrower declared lens use and source-bearing reopen | [[01_A.06.03.CSC - Controlled Semantic Coarsening]] | Applies only if the coarsening depends on mathematical abstraction, quotienting, or coarse-graining. |
| cross-context meaning, bridge kind, direction, CL, loss, and substitution | [[00_F.09 - Alignment & Bridge across Contexts]] | Reference Bridge; do not duplicate Bridge Card semantics. |
| causal-use question or verdict | [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] | Block causal overread or cite a [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] application or `CausalUseSupportRecordRef`. |
| forecast, rate, trajectory, rhythm, recovery, convergence, stabilization, temporal window, or rate-change used as sufficient for a use | [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] | Can state a prediction-relevant or distinction-relevant mathematical-lens use; temporal-claim adequacy stays with [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]]. |
| scale-law and Bitter-Lesson preference claims | [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] | Cite scale-window, scale-law, BLP, or architecture scale-preference evidence when scale behavior, general method scale preference, or architecture scale preference is being claimed. |
| quantum-like modeling | [[00_C.26 - Quantum-Like Modeling Lens]] | Treat [[00_C.26 - Quantum-Like Modeling Lens]] as C.29-compatible specialization, not as full-card inheritance for every QL-lite note. |
| selectors, benchmarks, parity, SoTA packs, and model-selection publications | [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.09 - Parity and Benchmark Harness]], [[00_G.02 - SoTA Harvester & Synthesis]], [[00_G.10 - SoTA Pack Shipping]] | Selector or benchmark records govern publication and evaluation; a `MathLensUse.*` card can contribute declared lens use for a selector or benchmark input only. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.5 - `MathLensUse.Card@Context` shape

`MathLensUse.Card@Context` is a pattern-local card in [[00_C.29 - Mathematical Lens Use|C.29]]. It is not `U.MathLensUseCard`, `U.LensUseRecord`, or any universal `U.*` kind.

Namespace note: `MathLensUse.Card@Context`, `MathLensUseOutputRef`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, `MathLensUse.FullCard`, and `CC-C29-*` are [[00_C.29 - Mathematical Lens Use|C.29]]-local instruments unless they cite existing FPF kinds or refs. `MathLensUseOutputRef` references the applicable [[00_C.29 - Mathematical Lens Use|C.29]] output for the stated use; it is not a demand for `MathLensUse.FullCard`. Do not mint generic suffixes such as `SystemMathLensUse`, `MathLensUseQuality`, or `MathLensUseCompliance`. Durable cross-pattern `MathLensUse.*` names, records, or refs require explicit minting or reuse plus naming, kind, and design-rationale decisions through [[00_F.08 - Mint or Reuse- (U.Type vs Concept-Set vs Role Description vs Alias)|F.8]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]], and [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]]; otherwise they remain pattern-local labels.

Read `MathLensUse.Card@Context` through three aspects:

| Aspect | Fields or refs | Boundary |
|---|---|---|
| Mathematical object in lens-use position | `CandidateMathObject`, `LensMappingMode`, `PreservedStructure`, `LostStructure`, `InvariantsExposed` | Names the representation used by [[00_C.29 - Mathematical Lens Use]]; does not identify the phenomenon with the mathematical object and does not replace an [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] FormalSubstrate signature. |
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:4.5a - Conditional overlays

The base card stays light. These overlays are used only when their corresponding use is being made. Ordinary [[00_C.29 - Mathematical Lens Use|C.29]] use does not fill this block; it escalates here only when the claim is already publication-facing, assurance-input, benchmark, bridge, model-selection, prediction, scientific or model, learned-lens, or causal-use facing.
...
| causal mechanism | no causal mechanism claim without [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] and evidence path |
...
| assurance or release use | no assurance, release, or reliability use without [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], and relevant G-pattern result |
...
| causal, intervention, policy, or counterfactual overread | Apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] or block causal use. |
| cross-context meaning, export, or substitution overread | Apply [[00_F.09 - Alignment & Bridge across Contexts]] or block export and substitution. |
| scale, universality, knee, exponent, or scale-advantage claim | Apply [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]], or keep the lens local and bounded by stop condition. |
| assurance or release use | Apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], or relevant G patterns, or block assurance use. |
| `StopCondition` is generic | Name the most tempting nearby overread the lens does not license. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:4.6 - Field meanings

| Field | Meaning selected for [[00_C.29 - Mathematical Lens Use]] | Boundary guard |
|---|---|---|
...
| `BoundedContext` | Context in which the lens is claimed to work. | Cross-context use cites [[00_F.09 - Alignment & Bridge across Contexts]]. |
...
| `LensMappingMode` | [[00_C.29 - Mathematical Lens Use]]-local lens mapping mode. | Stays separate from [[00_F.09 - Alignment & Bridge across Contexts]] BridgeKind, [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] `RelationKind`, [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)]] kind, and domain relation kinds; cross-context transfer uses [[00_F.09 - Alignment & Bridge across Contexts]] when bridge semantics are being claimed. |
...
| `ObservableOrControllableCue?` | Cheap cue naming what can be observed, read out, assigned, varied, or validated before a candidate lens can change action. Examples include arrivals, work in progress, service time, wait time, edge meaning, intervention assignment, outcome readout, observation map, validation slice, scale variable, or scale point. | Not a measurement construction, evidence record, causal-use result, or validation verdict. Apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], or [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] when those claim types are being made. |
...
| `DynamicsRef?`, `TransitionLawRef?` | References to [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]]-owned dynamics when dynamics semantics are being claimed. | [[00_C.29 - Mathematical Lens Use]] does not own dynamics. |
...
| `ScaleWindow?`, `CoarseGrainingRule?` | Scale range and coarse-graining or compression rule when scale behavior, macro description or effective description, universality, coarse behavior, latent compression, or renormalized description is being claimed. | [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] govern scale-law and BLP evidence; the [[00_C.29 - Mathematical Lens Use]] output states only how the lens remains adequate inside the declared window. |
...
| `OutputChangeCondition?` | Condition under which this [[00_C.29 - Mathematical Lens Use]] output must be narrowed, demoted, replaced, retired from claim-bearing use, or handed to a neighboring FPF pattern. | Not a process log or standing state-family record; it states a result boundary for the lens use being made. |
...
| `RivalLensSet?` | Broader comparison set only when publication, selection, or claim-bearing comparison is being made. | Not a [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] selector, benchmark harness, or parity result. |
| `RivalLensRelation?` | Declared relation between the lens in this use and the principal rival or rival set being compared. Allowed local relation values include `ordinaryFallback`, `complementary`, `sameUseLowerCost`, `morePreservedStructureHigherCost`, `lowerErrorOnDeclaredEvaluationCriterion`, `clearerExplanationForDeclaredReader`, `bridgeNeedsF9`, `causalUseNeedsC28`, `differentScaleWindow`, `differentLossProfile`, `incomparableForCurrentUse`, `blockedByStopCondition`, and `unresolved`. Examples: a queueing lens and a causal lens can be complementary for different moves; a latent manifold and a causal graph can conflict when latent axes are read causally; an RG-like lens and a micro-dynamics lens can have different scale windows. | Names disagreement only; a [[00_C.29 - Mathematical Lens Use]] output is not a winning-lens choice, literature review, selector result, benchmark result, or parity result. Any superiority claim names the evaluation criterion, reader, cost, scale window, or governing pattern that makes the comparison bounded for use. |
| `LensUseBoundaryValue` | Local finite lens-use boundary field. | Not evidence, an EvidenceGraph, a PathId, or an assurance score. |
| `BridgeRefSet?` | Reference to [[00_F.09 - Alignment & Bridge across Contexts]] Bridge material when context crossing is being claimed. | Bridge semantics stay with [[00_F.09 - Alignment & Bridge across Contexts]]. |
| `CausalUseDisposition?` | One of `noCausalUseClaim`, `causalUseBlocked`, `C28ApplicationRef`, or `CausalUseSupportRecordRef`. | No causal-reference shortcut; no causal verdict from [[00_C.29 - Mathematical Lens Use]]. |
...
| `declaredLensUse` | Declared lens use in this [[00_C.29 - Mathematical Lens Use]] application. | Matches evidence and validation regime. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:5 - Neighboring-pattern boundaries

Neighboring patterns remain necessary and are not displaced. A retained neighboring-pattern application note answers the working question for the neighboring pattern being used: what does the reader do with the mathematical lens now? State the neighboring-pattern trigger and the first bounded move for that neighboring pattern. If a note only repeats that [[00_C.29 - Mathematical Lens Use|C.29]] does not replace a neighbor, keep that boundary in the [[00_C.29 - Mathematical Lens Use|C.29]] governing-pattern table instead of copying generic boundary prose into the neighboring pattern:

- [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] handles relation precision restoration.
- [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] handles dynamics semantics.
- [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] handles characteristic spaces, overlays, normalization, and comparability.
- [[00_F.09 - Alignment & Bridge across Contexts|F.9]] handles cross-context semantics and Bridge loss.
- [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]] handle scale-law and BLP claims.
- [[00_C.26 - Quantum-Like Modeling Lens|C.26]] handles one specific quantum-like lens family.
- [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] handles causal-use question and verdict.
- [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] handle evidence and assurance.
- [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], and [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] handle choice results, method and work separation, work plans, performed work, and work-relevant source restoration.
- [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], and [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] handle explanation-facing renderings, bounded comparative review units, same-EntityOfConcern representation-scheme transitions, and controlled semantic coarsening.
- [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] handles temporal aspects; [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] handles temporal-claim adequacy.

Use the [[00_C.29 - Mathematical Lens Use|C.29]] discipline when the question under repair is: **Is this mathematical lens adequate for this declared use, and where does it stop?**

## [[00_C.29 - Mathematical Lens Use|C.29]]:6 - Naming, ontology, and epistemic precision-restoration account

### [[00_C.29 - Mathematical Lens Use|C.29]]:6.1 - Name
...
The stable name is `Mathematical Lens Use` because [[00_C.29 - Mathematical Lens Use|C.29]] governs a declared use and its use boundary, not intensity on an unnamed scale. Plain prose can still say that a useful mathematical lens compresses many cases while preserving declared distinctions; claim-bearing use is recovered through `CandidateMathObject`, `LensMappingMode`, `PreservedStructure`, `LostStructure`, `LensUseBoundaryValue`, and `StopCondition`.

### [[00_C.29 - Mathematical Lens Use|C.29]]:6.1a - C.29-local naming guard

`MathLensUse.*` instruments are [[00_C.29 - Mathematical Lens Use|C.29]]-local unless separately admitted. They are not `U.*` kinds, not durable FPF record families, and not substitutes for `U.Kind`, `KindSignature`, `KindBridge`, `BridgeCard`, `EvidenceGraph`, `ChoiceResult`, `U.WorkPlan`, `U.Work`, or assurance records.

Do not mint `LensKind`, `MathLensKind`, `MathLensUseQuality`, `MathLensUseCompliance`, or `MathLensUseRecord` from [[00_C.29 - Mathematical Lens Use|C.29]] use.

When one [[00_C.29 - Mathematical Lens Use|C.29]] application needs a mathematical-lens name to become reusable outside that application, use [[00_F.18 - Local-First Unification Naming Protocol|F.18]] local-first naming; when it quantifies over a class of described entities, use [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]] Kind-CAL; when it creates or reuses a durable concept or record family, use [[00_F.08 - Mint or Reuse- (U.Type vs Concept-Set vs Role Description vs Alias)|F.8]] minting or reuse and [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]] design-rationale discipline.

### [[00_C.29 - Mathematical Lens Use|C.29]]:6.2 - Tempting wrong names rejected

| Tempting name | Reason rejected |
|---|---|
| `Mathematical Ontology Principle` | Smuggles the metaphysical claim [[00_C.29 - Mathematical Lens Use]] rejects. |
| `Single-Foundation Math Stance` | Would collapse plural lens families into one foundation claim; [[00_C.29 - Mathematical Lens Use]] instead tests each selected family by declared mapping, local use, and recoverable loss. |
...
| `Category-Theoretic Bridge Pattern` | Over-privileges category theory; [[00_C.29 - Mathematical Lens Use]] is broader. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:6.3 - Ontology guard selected for FPF
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:6.4 - [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] recoveries applied

| Earlier wording risk | Recovered wording in [[00_C.29 - Mathematical Lens Use]] |
|---|---|
...
| Causal or assurance implications | Recovered as `CausalUseDisposition?` and `AssuranceUseDisposition?`, with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], and G-patterns as neighboring governors. |

## [[00_C.29 - Mathematical Lens Use|C.29]]:7 - Rationale

### [[00_C.29 - Mathematical Lens Use|C.29]]:7.1 - Why this improves FPF

The selected first-principles position in [[00_C.29 - Mathematical Lens Use|C.29]] is operational, not metaphysical. It treats first-principles mathematical thinking as local construction discipline: declare the smallest structure, rule, invariant, resource condition, observation, or consistency boundary from which the next move follows or is blocked. In that sense, a [[00_C.29 - Mathematical Lens Use|C.29]] application puts mathematical construction before adequacy control: the reader can introduce a queue, graph, state space, measure, topology, algebraic structure, variational quantity, simulation object, or learned representation when that structure improves the work, and then record the mapping, preserved structure, lost structure, lens-use boundary value, and stop condition.
...
[[00_C.29 - Mathematical Lens Use|C.29]] makes an existing discipline explicit: when FPF uses a `CandidateMathObject`, local formalism, learned representation, simulation object, or mathematical family as a mathematical lens for a stated use, the [[00_C.29 - Mathematical Lens Use|C.29]] application declares what that use preserves, what it loses, what it makes visible, which rival lenses still change the next lens-use move, and where its declared lens use stops.
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:7.2 - Alternatives rejected

| Alternative | Why rejected |
|---|---|
| Keep only local math-lens hooks | Leaves no general conformance pattern; [[00_C.26 - Quantum-Like Modeling Lens]]-style guardrails do not transfer to non-QL lenses. |
| Add only a paragraph to [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] | Overloads relational precision restoration with general modeling adequacy. |
| Add only a paragraph to [[00_F.09 - Alignment & Bridge across Contexts]] | Bridge discipline is about cross-context semantics; [[00_C.29 - Mathematical Lens Use]] also governs within-context mathematical representation. |
...
| Make mechanized proof mandatory for every [[00_C.29 - Mathematical Lens Use]] output | Too narrow. Mechanized proof can be one `LensUseBoundaryValue` value, but adequacy can also rest on accepted domain theory, formal derivation, simulation, or empirical fit. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:7.3 - Pillar impact analysis
...
| `P‑5 FPF Layering` | Positive: [[00_C.29 - Mathematical Lens Use]] becomes a modular parent pattern or coordinator for specific mathematical lenses while neighboring patterns keep their own authority. |
...
| `P-9 State Explicitness` | Positive: state, observation, dynamics, measurement, lens-use boundary value, and stop-condition fields cite [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], and [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] when those claims are being made. |
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:7.4 - Principle-taxonomy balance

| Pillar | [[00_C.29 - Mathematical Lens Use]] effect |
|---|---|
| `Gov` | New mathematical-lens use norms require [[00_E.09 - Design-Rationale Record (DRR) Method]] design-rationale discipline and SoTA discipline when they alter FPF norms. |
| `Arch` | Wrong governing-pattern assignment is blocked; [[00_C.29 - Mathematical Lens Use]] coordinates but does not replace neighboring patterns. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:8 - Consequences and validation harness
...
| Existing specialized lenses such as [[00_C.26 - Quantum-Like Modeling Lens]] become easier to explain as special cases. | [[00_C.26 - Quantum-Like Modeling Lens]] needs only relation wording, not a rewrite of its core. |
...
| [[00_C.29 - Mathematical Lens Use]] can stay readable rather than becoming a dry ontology form. | Requires a Plain and Tech discipline: Plain metaphors can guide recognition, but Tech fields govern claim-bearing uses. |

### [[00_C.29 - Mathematical Lens Use|C.29]]:8.1 - Validation harness for stable-pattern review and material refresh

For stable-pattern review or material refresh of [[00_C.29 - Mathematical Lens Use|C.29]], run a small [[00_C.29 - Mathematical Lens Use|C.29]] validation harness. The harness is not a benchmark mandate and not a tool requirement. It is a repeatable validation check that the pattern yields correct first outputs, avoids false positives, preserves neighboring-pattern writing boundaries, and keeps the first useful move visible.

This subsection governs steward-side validation, not the ordinary [[00_C.29 - Mathematical Lens Use|C.29]] user application. A working user applies the output-choice discipline and chooses the cheapest honest output; they do not run the harness merely to decide between ordinary prose, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `NeighborGoverningPatternNote`.

[[00_C.29 - Mathematical Lens Use|C.29]] output-change conditions:
...
| bridge, causal, measurement, scale, temporal, evidence, assurance, selector, or benchmark claim is being made | Name the governing neighboring pattern and keep [[00_C.29 - Mathematical Lens Use]] to the declared lens-use part. |
...
|---|---|
| source material or a source family changes the lens family, validation boundary, limitation, or stated use used by this [[00_C.29 - Mathematical Lens Use]] output | Update `SourceUseRole`, `LensUseBoundaryValue`, and `OutputChangeCondition?`; narrow, replace, or retire claim-bearing use when the new source-use row no longer fits the declared use. |
...
| a neighboring governing pattern changes the declared lens-use boundary for measurement, evidence, causal use, assurance, Bridge semantics, scale law, selector, benchmark, decision, or work | Keep [[00_C.29 - Mathematical Lens Use]] only for the declared lens-use part and apply the changed governing pattern to the neighboring claim before the [[00_C.29 - Mathematical Lens Use]] output is reused. |
| the same lens family starts carrying validation, causal-use, evidence, assurance, selector, benchmark, release, or work claim | Add the governing-pattern application, or narrow the [[00_C.29 - Mathematical Lens Use]] result to lens-bounded prediction, distinction, obstruction, diagnostic boundary, or stop condition only. |
...
|---|---|
| `field-like`, `quantum-like`, `category-like`, `manifold`, `entropy`, `RG`, `graph`, `embedding`, or another mathematical prestige head appears alone | Do not answer from the family label. First name the use under repair or state that no [[00_C.29 - Mathematical Lens Use]] use is being made. |
| claim being made is causal, measurement, bridge, evidence, temporal, work, assurance, selector, or benchmark-facing | Name the governing FPF pattern before any [[00_C.29 - Mathematical Lens Use]] output. |
| [[00_C.29 - Mathematical Lens Use]] still applies after the governing-pattern check | Return at least `CandidateMathObject`, `PreservedStructure`, `LostStructure`, `NextLensUseMove`, and `StopCondition`, or downgrade to `LensCandidateNote` or `NoMathLensUseNeededNote`. |

[[00_C.29 - Mathematical Lens Use|C.29]] edge-case boundary results:

| Edge case | Required result |
|---|---|
| mechanized proof of a model property | State assumptions and proven property; empirical evidence or assurance use stays with [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], or relevant G patterns. |
...
| lens becomes accepted domain theory | Keep local domain theory with the domain pattern; durable FPF naming or kind change needs [[00_F.18 - Local-First Unification Naming Protocol]], [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)]], [[00_F.08 - Mint or Reuse- (U.Type vs Concept-Set vs Role Description vs Alias)]], and [[00_E.09 - Design-Rationale Record (DRR) Method]]. |
| mathematical notation shift only | Use [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]] unless mathematical-lens use changes the declared use. |
| coarsened explanation | Use [[01_A.06.03.CSC - Controlled Semantic Coarsening]] for source-bearing return, narrowed use, and coarsened rendering; cite [[00_C.29 - Mathematical Lens Use]] only for abstraction adequacy. |
...
| `ExpectedFirstPattern` | [[00_C.29 - Mathematical Lens Use]], a neighboring pattern, or no [[00_C.29 - Mathematical Lens Use]] output needed. |
...
|---|---|
| “organization is quantum” | [[00_C.26 - Quantum-Like Modeling Lens]] plus [[00_C.29 - Mathematical Lens Use]] compatibility only if order or probe effects are being claimed; otherwise downgrade to metaphor; physical quantum ontology blocked. |
| Markov kernel in accepted local reliability model | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]]; no full `MathLensUse.FullCard` unless lens-transfer, publication, assurance, bridge, or reusable explanation is being claimed. |
| category-like research field | [[00_C.29 - Mathematical Lens Use]] mini-card and possibly [[00_F.09 - Alignment & Bridge across Contexts]]; semantic truth and evidence relation explicitly lost. |
| RG-like scale law | [[00_C.29 - Mathematical Lens Use]] plus [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]]; scale window and coarse-graining rule required. |
...
| same graph formalism in two contexts | [[00_F.09 - Alignment & Bridge across Contexts]] governs Bridge semantics; [[00_C.29 - Mathematical Lens Use]] governs declared lens use. |
...
| FPF steward | Can identify the governing pattern for causal, evidence, bridge, scale, measurement, dynamics, temporal, decision, work, explanation, comparison, representation, or assurance claim before accepting a [[00_C.29 - Mathematical Lens Use]] claim. |
...
| AI-assisted reader | Recovers [[00_C.29 - Mathematical Lens Use]] or the neighboring governing pattern from the query, and does not answer from a thin echo such as `field-like`, `quantum-like`, or `category-like` alone. |

## [[00_C.29 - Mathematical Lens Use|C.29]]:9 - Archetypal grounding
...
| Research field as citation graph or category-like network | Graph or categorical structure | adjacency, composition, interface, failed transfer, citation or transformation patterns | semantic truth, evidence relation, social meaning | First inspect adjacency, composition, interface, or failed transfer; `MathLensUse.MiniCard` plus [[00_F.09 - Alignment & Bridge across Contexts]] when contexts cross; never substitute graph proximity for truth or evidence. |
| Quantum-like dashboard | Quantum-like probe and order lens | order effects, probe effects, incompatible frames when actually present | physical quantum ontology | [[00_C.26 - Quantum-Like Modeling Lens]] with C.29-compatible stop condition `QL-NQ`; not a full-card cost for QL-lite notes. |
| RG-like scale-law claim | Coarse-graining or fixed-point lens | scale variable, coarse-graining rule, invariants across scales | micro-mechanism identity and universal applicability | [[00_C.29 - Mathematical Lens Use]] plus [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]]; stops outside scale window. |
...
| Failure mode | Reader sees | [[00_C.29 - Mathematical Lens Use]] repair |
|---|---|---|
...
| Wrong-neighbor repair | "The same graph appears in two contexts, so the meanings are the same." | Apply [[00_F.09 - Alignment & Bridge across Contexts]] for Bridge semantics; keep [[00_C.29 - Mathematical Lens Use]] only for mathematical-lens use. |
| Local-math non-use | Accepted Markov kernel inside local dynamics. | Stay in [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]]; return `NoMathLensUseNeededNote` if useful; do not use [[00_C.29 - Mathematical Lens Use]] merely because local mathematics appears. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:10 - Bias annotation

| Bias risk | [[00_C.29 - Mathematical Lens Use]] correction |
|---|---|
...
| **Scale blindness** | Require `ScaleWindow?`; coordinate scale claims with [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]]. |
| **Causal laundering** | If the lens licenses causal claims, apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]; MathLensUse cannot supply causal use by itself. |
| **Assurance laundering** | Mathematical elegance does not raise `R`; evidence and assurance use apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], and relevant G patterns. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:11 - Conformance checklist

[[00_C.29 - Mathematical Lens Use|C.29]] checklist verifies the output-choice discipline without replacing the `Solution`. Candidate-lens guidance belongs in `C.29:4.4.3` or worked grounding, not in this checklist; the checklist verifies only that the cheapest honest output and next lens-use move remain visible.

| ID | Requirement | Purpose |
|---|---|---|
| `CC-C29-0 Use condition` | Use [[00_C.29 - Mathematical Lens Use]] only when a mathematical object, formalism, family, learned representation, or simulation object is used for explanation, decision, prediction, publication, comparison, assurance input, bridge, or reusable transfer. | Keeps local analogies lightweight. |
...
| `CC-C29-2a Intervention preservation` | If `LensMappingMode` is abstraction, quotient, coarse-graining, macro-model, or simulation and causal use is being claimed, state whether intervention and counterfactual structure is preserved, approximated, or not claimed, then apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] for causal-use question and verdict. | Prevents causal abstraction laundering. |
| `CC-C29-3 Lens mapping mode` | State the [[00_C.29 - Mathematical Lens Use]]-local lens mapping mode and do not use it as [[00_F.09 - Alignment & Bridge across Contexts]] BridgeKind, [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] `RelationKind`, or domain ontology. If bridge semantics are being claimed, apply [[00_F.09 - Alignment & Bridge across Contexts]]. | Prevents hidden bridge, relation-kind, or ontology conversions. |
...
| `CC-C29-8 State, observation, and evidence separation` | If state, observation, probe, readout, or evidence is being claimed, apply [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], or [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] as needed. | Prevents passive-read and dashboard mistakes. |
| `CC-C29-8a Neighboring claim distribution` | If the output being made is a choice result, method or work record, evidence path, assurance claim, explanation rendering, comparative review unit, representation shift, coarsened rendering, temporal claim, selector, benchmark, or publication-facing use, name the governing FPF pattern and project-side record. | Prevents [[00_C.29 - Mathematical Lens Use]] from absorbing neighboring claims. |
| `CC-C29-9 Scale window` | If scale, universality, knees, exponents, or coarse-graining are being claimed, declare the scale range and coordinate with [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] and [[01_C.19.01 - Bitter-Lesson Preference (BLP)]]. | Prevents universalization. |
| `CC-C29-9a Temporal use boundary` | If the claim being made is about forecast, rate, trajectory, rhythm, recovery, convergence, stabilization, speed, temporal window, or rate-change as sufficient for a use, cite [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] or state that temporal adequacy is not being claimed. | Prevents mathematical prediction cues from replacing temporal-claim adequacy. |
...
| `CC-C29-10b Source-use role` | If a source changes [[00_C.29 - Mathematical Lens Use]] declared lens use, name its `SourceUseRole`; do not let source prestige silently become evidence, causal-use verdict, bridge semantics, assurance, release, selector, benchmark, or accepted law. | Separates the source-use role from source-use disposition. |
| `CC-C29-10c Source-currentness and return condition` | If source material, source-use family, source-use decision, or a neighboring governing pattern changes the declared lens-use boundary for this output, state `SourceReturnCondition?` or `OutputChangeCondition?` and narrow, demote, replace, retire, or block the claim-bearing use. | Keeps SoTA currentness and neighboring-pattern currentness tied to the declared [[00_C.29 - Mathematical Lens Use]] output rather than to source prestige or process evidence. |
...
| `CC-C29-14 Bridge discipline` | Cross-context mathematical transfer cites [[00_F.09 - Alignment & Bridge across Contexts]]; Bridge and [[00_C.29 - Mathematical Lens Use]] fields agree without duplicate writing. | Keeps semantics bounded. |
| `CC-C29-15 Causal-use discipline` | Causal-use claims apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]; [[00_C.29 - Mathematical Lens Use]] cannot carry a causal-use verdict by itself. | Blocks causal laundering. |
| `CC-C29-16 Assurance discipline` | Assurance, release, reliability, and engineering-justification claims apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], and relevant G patterns. | Prevents elegance from raising assurance directly. |
| `CC-C29-17 [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/00_C.02.P - Epistemic Precision Restoration]] recovery` | Broad heads, source wording or target wording, mapping wording, pattern-application wording, and Plain metaphors are recovered to FPF kinds named by value, fields, neighboring patterns, or explicit non-transfer dispositions. | Keeps the pattern from minting parallel ontology. |
...
| `CC-C29-19 Non-use and false-positive bank` | The pattern includes non-use examples for ordinary local domain equations, local graph data structures, [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] overlays, local category proofs, and one-off metaphors. | Prevents C.29-everywhere. |
| `CC-C29-20 Repair matrix` | Failed checks map to repair outputs: downgrade, narrow, add loss, add evidence, choose rival lens, apply neighbor, or block overread. | Keeps [[00_C.29 - Mathematical Lens Use]] as a repair pattern. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:12 - Common anti-patterns
...
| **C.29-everywhere** | Every measurement template, score, graph, kernel, ODE, equation, or local formal object is treated as requiring [[00_C.29 - Mathematical Lens Use]]. | Require lens-transfer, publication, assurance, bridge, comparison, or reusable-explanation use. |
...
| **Local-theory over-escalation** | Accepted local dynamics or domain equations are treated as needing [[00_C.29 - Mathematical Lens Use]] by default. | Keep them under the local domain pattern or [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] unless a separate lens-transfer claim, publication use, assurance input, bridge, comparison, or reusable-explanation use is being made. |
...
| **Elegant-math override** | A specialized or elegant mathematical lens is selected over a more general or scale-amenable alternative because of elegance or prestige while a general method scale-preference claim or architecture scale-preference claim is being made. | Use BLP scale-audit when a general method scale-preference claim is being made; use [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made; otherwise mark the lens as local and bounded by [[00_C.29 - Mathematical Lens Use]] stop condition. |
...
| **Loss-free bridge** | Mathematical structure is exported across contexts without [[00_F.09 - Alignment & Bridge across Contexts]], loss notes, counter-example, or declared lens use. | Use [[00_F.09 - Alignment & Bridge across Contexts]] Bridge plus MathLensUse `LostStructure` and `StopCondition`. |
| **Duplicate bridge writing** | [[00_C.29 - Mathematical Lens Use]] repeats sense cells, CL, substitution scope, and Bridge-declared lens use. | Let [[00_F.09 - Alignment & Bridge across Contexts]] write Bridge semantics; cite Bridge from the [[00_C.29 - Mathematical Lens Use]] output. |
| **LensMappingMode as BridgeKind** | A local `LensMappingMode` value is used to skip [[00_F.09 - Alignment & Bridge across Contexts]]. | Do not define a bridge-valued `LensMappingMode`; use a local transfer class only for declared lens use and apply [[00_F.09 - Alignment & Bridge across Contexts]] to cross-context meaning, substitution, CL, sense cells, or Bridge-declared lens use. |
| **Causal laundering** | Lens fit is treated as proof of intervention effect. | Apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] and evidence design, or block causal use. |
| **Assurance laundering** | Elegant formalism is treated as release confidence. | Use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]]; [[00_C.29 - Mathematical Lens Use]] can be evidence input only when `LensUseBoundaryValue` and validation regime are declared. |
...
| **Neighbor absorption** | [[00_C.29 - Mathematical Lens Use]] repeats [[00_F.09 - Alignment & Bridge across Contexts]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.11 - Decision Theory (Decsn-CAL)]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[01_A.06.03.CSC - Controlled Semantic Coarsening]], or assurance semantics. | Apply the governing-pattern table and cite the neighboring pattern. |
| **Plain metaphor carrying law** | “What survives transfer” becomes an unstated Tech claim. | Recover the commitment through [[00_C.02.P - Epistemic Precision Restoration]] fields or keep it as ordinary Plain recognition only. |
| **[[00_C.29 - Mathematical Lens Use]] local-kind inflation** | `MathLensUse.Card` is treated as a universal `U.*` object or durable FPF record. | Keep it pattern-local; durable cross-pattern records require explicit minting or reuse, naming, kind, and design-rationale decision through [[00_F.08 - Mint or Reuse- (U.Type vs Concept-Set vs Role Description vs Alias)]], [[00_F.18 - Local-First Unification Naming Protocol]], [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)]], and [[00_E.09 - Design-Rationale Record (DRR) Method]]. |

## [[00_C.29 - Mathematical Lens Use|C.29]]:13 - SoTA-echoing account

SoTA source use for [[00_C.29 - Mathematical Lens Use|C.29]] is accepted only when it changes action guidance. A citation that only decorates the file does not establish [[00_C.29 - Mathematical Lens Use|C.29]] use.

[[00_C.29 - Mathematical Lens Use|C.29]] separates source-use roles from source-use disposition. `Adopt`, `Adapt`, `Reject`, and candidate-stress-test disposition say what FPF does with the source; `SourceUseRole` says what work the source may perform inside a [[00_C.29 - Mathematical Lens Use|C.29]] application.

| `SourceUseRole` | Declared [[00_C.29 - Mathematical Lens Use]] use | Blocked [[00_C.29 - Mathematical Lens Use]] use |
|---|---|---|
...
| `adequacyControlSource` | Discipline preserved structure, lost structure, stop condition, validation regime, or neighboring-pattern application. | Replace the [[00_C.29 - Mathematical Lens Use]] fields or the neighboring governing pattern. |
...
| `acceptedDomainTheory` | Permit local use inside a domain where the theory is already the governing local formalism. | License cross-context ontology import or broader transfer without [[00_F.09 - Alignment & Bridge across Contexts]], evidence, and stop condition. |
...
| Model reporting and responsible modeling practice | Intended use, evaluation conditions, limitations, validation regime, failure cases, uncertainty, and domain of applicability become [[00_C.29 - Mathematical Lens Use]] validation fields for prediction, publication, assurance-input, benchmark, model-selection, and scientific or model uses. | **Adapt.** Turns reporting practice into fields and repair moves. |
| Causal and approximate causal abstraction | When abstraction, quotient, coarse-graining, simulation, or macro-modeling is being claimed, ask whether intervention and counterfactual structure is preserved, approximated, or not claimed; use [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] for causal-use question and verdict. Approximate abstraction is a source-backed lens-use note, not a softened causal-use grant. | **Adapt.** No [[00_C.29 - Mathematical Lens Use]] output is causal authority. |
| Causal representation learning | Use causal-representation work as a discovery guard for latent variables, learned factors, interventions, assignments, and invariance across environments. If a latent lens is being read causally, keep causal-use question and verdict with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]. | **Adapt as lens-discovery source.** Blocks “latent means causal”; does not make representation learning a causal verdict. |
| Scientific machine learning as hybrid first-principles and data-driven modeling | Treat first-principles structures as plural and domain-bound: conservation laws, constitutive relations, boundary conditions, symmetries, known dynamics, numerical stability, uncertainty, and data-driven approximation can each discipline a lens. Require the [[00_C.29 - Mathematical Lens Use]] user to name the concrete structure and validation boundary rather than saying "science says so." | **Adapt.** Reinforces the first-principles position without making any one SciML family the FPF foundation. |
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:13.1 - Sandberg Thread and Structural Sameness Examples
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:13.2 - Vanchurin 2026 as candidate lens
...
### [[00_C.29 - Mathematical Lens Use|C.29]]:13.3 - Plural foundations source-use decision
...
Source-use role: Rodin supplies source material for the positive decision that several structurally useful families recur across domains. [[00_C.29 - Mathematical Lens Use|C.29]] records this as local adequacy discipline: select the family that fits the declared use, state the mapping, and publish recoverable loss.
...
MathLensUse.OneLine@RodinP2W:
  ...
  NextLensUseMove: apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] if a `U.Signature(profile=FormalSubstrate)` declaration is needed; apply [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] if accepted problem-side material must be used through P2W in later FPF work
...
Read the slice by relation position. [[00_C.29 - Mathematical Lens Use|C.29]] records preserved and lost structure for the mathematical-lens use. [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] declares vocabulary, laws, imports, and applicability when a `U.Signature(profile=FormalSubstrate)` declaration must be written. [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] governs P2W carry-through of the accepted problem-side distinction into the next declared FPF use. If the claim becomes measurement, evidence, causal use, Bridge semantics, mechanism realization, or work, apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], or [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] to that claim being made.

### [[00_C.29 - Mathematical Lens Use|C.29]]:13.4 - Applied category theory
...
In [[00_C.29 - Mathematical Lens Use|C.29]], category-theoretic material is used through the same local adequacy fields as any other lens: stated use, named structure, preserved composition or interface, lost structure, failed transfer, and neighboring-pattern applications. It is especially useful when composition, interfaces, views, transformations, or bridges matter to the bounded move.

### [[00_C.29 - Mathematical Lens Use|C.29]]:13.5 - Obstructions to compositionality
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:13a - Source locators and source-use guard
...
| Source id | Source item | What it contributes | Use in [[00_C.29 - Mathematical Lens Use]] |
|---|---|---|---|
| `FPF-CORE-2026` | Current FPF Core Specification, especially [[00_E.09 - Design-Rationale Record (DRR) Method]], [[00_E.10 - Unified Lexical Rules for FPF]], [[00_C.02.P - Epistemic Precision Restoration]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[01_A.15.01 - U.Work]], [[04_A.15.04 - Work-Relevant Source Restoration]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_C.11 - Decision Theory (Decsn-CAL)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]], [[00_C.26 - Quantum-Like Modeling Lens]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[01_A.06.03.CSC - Controlled Semantic Coarsening]], [[00_F.09 - Alignment & Bridge across Contexts]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.09 - Parity and Benchmark Harness]]. | Governs [[00_C.29 - Mathematical Lens Use]] adequacy, lexical precision repair, epistemic precision repair, pattern placement, bridge discipline, decision boundaries, work boundaries, evidence boundaries, assurance boundaries, explanation boundaries, comparison boundaries, representation boundaries, state boundaries, measurement boundaries, dynamics boundaries, temporal boundaries, causal-use boundary, and evidence and assurance escalation. | **Governing inheritance.** [[00_C.29 - Mathematical Lens Use]] applications satisfy [[00_E.09 - Design-Rationale Record (DRR) Method]] and phrase-local episteme material, publication material, and source-use material through [[00_C.02.P - Epistemic Precision Restoration]]. |
...
| `ROBUST-GBOED-2025` | Barlas, Sloman, and Kaski, **Robust Experimental Design via Generalised Bayesian Inference**, arXiv:2511.07671. | Contributes robustness prompts for model misspecification, outliers, and incorrect noise assumptions through generalized Bayesian OED or Gibbs Bayesian OED and Gibbs expected information gain. | **Adapt as robustness source.** If model misspecification is plausible, the [[00_C.29 - Mathematical Lens Use]] output records the robustness note; it does not turn robustness into evidence or assurance by itself. |
...
| Source id | Locator(s) | Recoverability and use in [[00_C.29 - Mathematical Lens Use]] |
|---|---|---|
...
| `CAUSAL-CONSISTENCY-2017` | `https://arxiv.org/abs/1707.00819` | **Causal-abstraction source.** Contributes a check for whether SEM descriptions at different granularities agree about intervention effects; feeds the intervention-preservation question without giving [[00_C.29 - Mathematical Lens Use]] causal authority. |
| `CAUSAL-ABSTRACTION-2019` | `https://arxiv.org/abs/1812.03789`; AAAI page: `https://ojs.aaai.org/index.php/AAAI/article/view/4117` | **Causal-abstraction source.** Contributes distinctions among transformations, abstractions, and named abstraction classes; used only to require explicit [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] application when causal use is being claimed. |
| `APPROX-CAUSAL-ABSTRACTION-2019/2020` | `https://arxiv.org/abs/1906.11583`; PMLR page: `https://proceedings.mlr.press/v115/beckers20a.html` | **Approximate causal-abstraction source.** Contributes `approximated` intervention and counterfactual preservation value in the lightweight causal-abstraction check; does not let [[00_C.29 - Mathematical Lens Use]] decide causal-use question and verdict without [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]. |
| `CAUSAL-ABSTRACTION-JMLR-2025` | `https://jmlr.org/beta/papers/v26/23-0058.html` | **Current causal-abstraction source.** Contributes generalized mechanism-transformation and graded-faithfulness checks for learned systems; keeps causal-use question and verdict with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]. |
| `SCHOLKOPF-ETAL-2021` | `https://arxiv.org/abs/2102.11107`; DOI `10.1109/JPROC.2021.3058954` | **Causal-representation discovery source.** Contributes the question whether a learned latent representation has intervention, assignment, outcome, and environment-invariance evidence path before causal use; causal-use question and verdict are governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] when causal use is being claimed. |
...
| `MODERN-OED-2024/2026` | `https://arxiv.org/abs/2407.16212`; Cambridge Core DOI `10.1017/S0962492924000023` | **Modern optimal experimental design source.** Contributes broad OED formulations and computations for complex models; [[00_C.29 - Mathematical Lens Use]] uses it only to ask what acquisition would make a candidate lens usable. |
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:13b - Source-use boundary notes
...
2. Vanchurin-style physical or biological interpretations remain source-side claims unless a local [[00_C.29 - Mathematical Lens Use|C.29]] output and neighboring evidence, causal-use, validation, or assurance pattern bound the use. [[00_C.29 - Mathematical Lens Use|C.29]] does not promote those interpretations to FPF law.
...
## [[00_C.29 - Mathematical Lens Use|C.29]]:14 - Informative taxonomy seed

Use this recognition menu only to identify a possible lens family and likely neighboring-pattern applications. After selecting a row, state the local [[00_C.29 - Mathematical Lens Use|C.29]] fields that make the lens adequate or stop the use.

| Lens family | What it catches | FPF use | Common stop condition | Likely neighboring patterns |
|---|---|---|---|---|
| **Boundary, Stokes, and cohomology** | Boundary operators, exterior-derivative or divergence-like local-to-global relations, flows, closed relation and relation named by value splits, and topological obstructions. | Use when local rules, interfaces, flows, or balances must be related to a global claim or blocked global extension. | Does not license all boundary phenomena as the same physical mechanism; evidence, measurement, and bridges remain neighboring work. | [[00_F.09 - Alignment & Bridge across Contexts]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] |
| **Obstruction-first and failed-transfer lens** | Impossibility, incompatibility, failed composition, blocked transfer, missing invariant, or diagnostic boundary. | Use when the useful mathematical result marks where a transfer, comparison, model, or simplification stops. | Does not make the rival claim true or the failure cause known without the neighboring-pattern result named by value. | [[00_F.09 - Alignment & Bridge across Contexts]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]] |
| **Symmetry, invariance, equivariance, and Noether** | Group actions, invariants, equivariant representations, conservation-like constraints, and geometric-deep-learning regularities. | If the problem depends on sameness under transformations or a conservation-like claim, ask which transformations are declared as preserved or invariant, what remains invariant, and which distinctions are lost. | Does not transfer physical conservation law, causal mechanism, or coordinate-free truth without domain evidence. | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], domain pattern |
| **Variational, action, optimization, and Legendre** | Action, energy, free-energy, loss, value, entropy, or resource functionals; stationarity, extrema, dual variables, potentials, and Legendre or convex duality. | Use when the useful lens is an extremal condition, constrained variation space, boundary condition, dual view, or trade-off. | Does not imply the target literally optimizes unless dynamics and evidence-path claims are governed by their neighboring patterns. | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] |
| **Diagonal, self-reference, and no-go** | Self-application, universal evaluators, closure limits, diagonal constructions, and impossibility boundaries. | Use when the payoff is to block a tempting universal claim or expose a closure boundary. | Does not prove every recursive-looking case is a diagonal or no-go case. | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]], local domain pattern |
| **RG, coarse-graining, fixed point, and universality** | Why different micromodels yield one macropattern; fixed points, basins, scale windows, universality classes, or stable-law-like alternatives. | Use for scale transitions, abstraction, domain compression, and macropattern claims that require a declared scale variable and coarse-graining rule. | Does not assert micro-mechanism identity or universal applicability outside `ScaleWindow`. | [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] |
| **Category, compositionality, optics, and semiring-limit** | Composition, interfaces, views, transformations, algebraic laws, limit transforms, and cases where changing algebra changes what is preserved. | Multi-view architecture, bridges, system composition, and classical or tropical or Fourier-Laplace or Legendre-style transform cues. | Does not imply all target objects are categories or that every functor-like transfer preserves the needed structure. | [[00_F.09 - Alignment & Bridge across Contexts]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] |
| **Information geometry and learning dynamics** | Update, curvature, optimization trajectory. | Adaptive systems, learning agents, epistemic dynamics. | Does not license “everything is learning” ontology. | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] |
| **Optimal transport and distribution geometry** | Transport plans, Wasserstein-like geometry, couplings, costed movement between distributions, populations, shapes, or allocations. | Use when the question is how one distribution, population, shape, or allocation can move toward another under declared costs and losses. | Does not license causality, fairness, mechanism, or policy effect by itself. | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_D.05 - Bias-Audit & Ethical Assurance]] |
| **Operator learning, SciML, and latent representations** | Learned function-to-function operators, neural operators, surrogate solvers, embeddings, and world-model representations. | Use when the first useful lens is an operator over functions, states, or fields; name the observation map, training or simulation regime, validation slice, and generalization boundary. | Does not license out-of-domain solver replacement, causal mechanism, or unobserved state truth without validation and the neighboring-pattern result named by value. | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] |
| **Koopman and operator-theoretic dynamics** | Observables or coordinates where nonlinear dynamics can be represented by an operator, often approximately linear. | Use when nonlinear dynamics need a tractable forecast, control, or diagnostic representation; name the observable or readout and the forecast or control use being tested. | Does not prove a real linear mechanism or temporal-use adequacy; dynamics semantics, evidence, and temporal claims stay with [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], and [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]]. | [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] |
| **Causal representation and causal abstraction** | Causal graphs, SCMs, causal representation learning, micro-to-macro mappings, quotient models, and intervention-preservation questions. | If the user asks what to change to get an effect, test causal graph, SCM, or causal abstraction as the candidate lens, not correlation graph or latent manifold by default. | [[00_C.29 - Mathematical Lens Use]] can state declared lens use only; causal-use question and verdict, intervention claims, and counterfactual reliance stay with [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]. | [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] |
| **Quantum-like and contextual probability** | Probe effects, incompatible frames, order effects. | Dashboards, workshops, surveys, measurement-as-intervention. | Quantum-like is not physical quantum unless separate physics evidence is supplied. | [[00_C.26 - Quantum-Like Modeling Lens]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_F.09 - Alignment & Bridge across Contexts]] |

## [[00_C.29 - Mathematical Lens Use|C.29]]:15 - Relations

- **Builds on:** [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]].
- **Constrained by:** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]].
- **Design-rationale input:** [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]] design-rationale discipline and the source-use rows in `C.29:13a`.
- **Contributes to:** [[00_E.02 - The Eleven Pillars|E.2]] pillar-impact analysis when a pillar argument relies on mathematical first-principles structure; only declared mathematical-lens use is in scope, with no amendment to pillar content, priority, or constitutional authority.

- **Coordinates with:** [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]], [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[01_A.15.01 - U.Work|A.15.1]], [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]], [[00_C.26 - Quantum-Like Modeling Lens|C.26]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.09 - Parity and Benchmark Harness|G.9]], [[00_G.02 - SoTA Harvester & Synthesis|G.2]], [[00_G.10 - SoTA Pack Shipping|G.10]].
- **Specialization relation:** [[00_C.26 - Quantum-Like Modeling Lens|C.26]] is selected as a C.29-compatible specialization for quantum-like modeling, with affordability qualifications.
- **Neighboring claims stay with their governing patterns.** Use [[00_F.09 - Alignment & Bridge across Contexts|F.9]] for bridges; [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal use; [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for dynamics semantics; [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for characteristic-space and measurement construction; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence and assurance; [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], and [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] for decision, method, and work records; `E.17.*` for explanation and comparative-review publication use; [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] and [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] for representation transition and coarsening; [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)|C.18.1]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]], and [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]] for temporal-aspect, temporal-claim adequacy, scale-law, method scale-preference, and architecture scale-preference claims; and Part G for selector and benchmark work. [[00_C.29 - Mathematical Lens Use|C.29]] records only the declared mathematical-lens use and the governing-pattern boundary for the claim being made.

## [[00_C.29 - Mathematical Lens Use|C.29]]:End
