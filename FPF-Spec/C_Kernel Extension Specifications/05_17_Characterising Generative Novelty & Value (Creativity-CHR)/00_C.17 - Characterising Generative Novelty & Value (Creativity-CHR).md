...
**Depends on.** A‑kernel ([[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]]–[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]), **A.17/A.18/A.19** characteristic-space discipline, **MM‑CHR** measurement infrastructure ([[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]), **KD‑CAL** and **Sys‑CAL** for carriers and holons, **Decsn‑CAL** (utility), and declared must-constraint owners such as [[E_The FPF Constitution and Authoring Guides/04_05_Four Guard-Rails of FPF/00_E.05 - Four Guard-Rails of FPF|E.5]], D.1-D.5, or service-acceptance patterns.
**Coordinates with.** **[[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/02_B.05.02.01 - Creative Abduction with NQD|B.5.2.1]] NQD** (abductive generator) for search instrumentation, **C.9 Agency Characteristic Profile** for agential capacity, B-cluster trust/assurance ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), Canonical Evolution Loop ([[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/00_B.04 - Canonical Evolution Loop|B.4]]), Role Assignment & Enactment Cycle (Six-Step) ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]]) and Naming Discipline for U-kinds, role names, and local term sheets ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]]).
...
This pattern exports **Characteristics** and measurement templates **only**. It **does not** export any Γ\_\* operators, retained-set composition rules, `Front`/`Archive`/`Shortlist` heads, or selection/scalarization policies; those live in **[[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship|C.18]] NQD-CAL**, **[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]] E/E-LOG**, and **[[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]]** (or **Decsn-CAL** for decision lenses). A Context _publishes_ the measurement space and admissible policies; later choice using that space is attributed to a declared `DecisionSubject` at explicit `DecisionSubjectGranularity` under a named lens.
...
10. **`U.DomainDiversitySignature (dSig)`** — 5‑tuple over discrete characteristics **[Sector, Function, Archetype, Regime, MetricFamily]**  attached to each `U.BoundedContext`. Used for **Near‑Duplicate** diagnostics and `AliasRisk`. Policy: flag as Near‑Duplicate when ≥3 characteristics match; see [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey|F.1]] invariants and SCR‑F1‑S08..S09.
...
* **Relations (informative; not exported):** dominance relation (partial order in the space), frontier predicate (Pareto set), retained-set composition view. *[[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] exports no operators and does not mint public set-result family heads; these are mathematical relations only.*
*
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:1 - Motivation & Intent (manager’s read‑first)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:2 - Forces
...
| **Local truth vs. Cross‑context reuse** | Meaning is context‑local ([[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - U.BoundedContext Semantic Frame]]); yet we need Bridges to compare across organisations/disciplines.                                         |
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:3 - Solution Overview — The context‑local CreativitySpace
...
* A **system** (person, team, service) performs **`U.Work`** under a role ([[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]]).
...
with **scale**/**unit** metadata from **MM‑CHR** ([[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]), and Context‑specific **measurement methods** bound by **MethodDescription**.

**DesignRunTag split ([[A_Kernel Architecture Cluster/04_Temporal Duality & Open-Ended Evolution Principle/00_A.04 - Temporal Duality & Open-Ended Evolution Principle|A.4]]):**

* **Design‑time**: score **concepts** or **specs** against **surrogate value models** and **priors**; record **assumptions** (USM scopes; [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:4 - Vocabulary (CHR terms & D‑stubs)

> Names are **context‑local**; below are kernel terms. Roles like “Designer/Reviewer” are contextual ([[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]]). **Documents don’t act** (A.7/A.12); they are **evaluated**.
...
6. **`U.CreativityProfile`** *(D).* The **coordinate tuple** in `U.CreativitySpace` with provenance to the above inputs and **USM scopes**.
   **Conformance (CP‑1):** profile **must** include **scales/units**, **scopes**, **confidence bands** ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), and the **edition** of space definitions.

## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5 - The Core Characteristics (kernel nucleus)

Each characteristic is specified per **MM‑CHR ([[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]])** with: **name**, **intent**, **carrier**, **polarity**, **scale type**, **measurement template**, **evidence**, **scope (USM)**, and **didactic cues**. *Context profiles MAY add characteristics; kernel characteristics MAY NOT be removed without a Bridge.*

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.1 - `Novelty@context` — “How unlike the known set is this?”
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.2 - `Use‑Value` *(alias: `ValueGain`)* — “What good did this add under our objective?”
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.3 - `Surprise` — “How improbable under our learned world?”
...
* **Scope.** Training slice declared as **ContextSlice**; Bridges penalise **R** (trust), not the value itself ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).
* **Didactic cues.**

  * **Novelty vs Surprise:** high novelty under one kernel may be low surprise under a broad prior; publish both.

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.4 - `ConstraintFit` — “Did it honour the non‑negotiables?”
...
* **Scope.** Constraints are **context‑local**; Cross‑context requires **Bridge**; waivers are **SpeechAct Work** with RSG gates ([[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]]).
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.5 - `Diversity_P` *(declared retained-set / portfolio-level)* — “Are we exploring the space?”
...
* **Alignment note.** The **illumination/coverage** view corresponds to *IlluminationScore* used by **[[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/02_B.05.02.01 - Creative Abduction with NQD|B.5.2.1]] NQD‑Generate**; no separate characteristic is introduced here—measure it as part of `Diversity_P`.
...
**Lexical special case ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] naming).**
For **lexical CandidateSets** used by Name Cards ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]), **Diversity_P SHALL be computed over head-term families, not over raw strings**. Variants that share the same lexical head (e.g., “Reference plane”, “Plane of reference”, “Planar reference”) **MUST** be treated as one family for coverage and distance; only candidates with distinct heads contribute to lexical Diversity_P. This aligns lexical use of Diversity_P with `FamilyCoverage` / `AliasRisk` and prevents inflating diversity by near-synonyms of a single head.

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.6 - `AttributionIntegrity` — “Did we credit sources and licences correctly?”
...
* **Default role.** `AttributionIntegrity` is **measurable but non‑dominant**. It MAY serve as a **policy filter/tie‑break** ([[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]). If certain attribution duties are **must‑constraints**, they belong to **ConstraintFit** under the declared constraint owner and act as **eligibility gates**. It is **not** part of the default dominance set.
* **Dominance & gating note (normative).** `AttributionIntegrity` is a measurable **Characteristic**; it is **not** in the default dominance set. Contexts MAY use it as a **filter** or **tie‑break** via policy ([[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]). Legal/ethical **must‑fit** checks live in **ConstraintFit** under the declared constraint owner; failing those blocks eligibility **before** dominance.

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:5.7 - `EffortCost` *(advisory)* — “What did it take?”
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:6 - Conformance Checklist (first tranche)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:7 - Manager’s Quick‑Start (apply in 5 steps)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:8 - Archetypal Grounding (three domains)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:9 - Anti‑Patterns (fast fixes)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:10 - Relations

* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] Role & [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Run‑alignment.** Creative **Work** is performed by **systems in roles**; outcomes are **epistemes**. Creativity is **measured by `U.Evaluation`**, not “done by a document.”
* **[[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] Trust/Assurance.** Coordinates carry **confidence bands**; Bridges lower **R** by **CL**. [[A_Kernel Architecture Cluster/02_Role Taxonomy/04_A.02.04 - Episteme Evidence-Use and Status-Use Relations|A.2.4]] evidence-use relations bind datasets and benchmarks used in measurements.
...
* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] USM (Scope).** All measurements sit on **ContextSlices**; `G‑ladder` is explicitly **not** used ([[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] follows [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]’s set‑valued scopes).
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:11 - Authoring Aids (didactic cards)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12 - CSLC recap and the Creativity CharacteristicSpace
...
> **Strict Distinction ([[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]) reminders.**
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.1 - The Creativity CharacteristicSpace (CHR‑SPACE)
...
| **Use‑Value**            | Benefit vs a **declared objective**                          | `U.Episteme` value or `U.Evaluation` | Ordinal (Fail/Partial/Pass) or scalar KPI          | [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] Evidence & `U.Evaluation`      |
...
> **Locality.** **Every characteristic is context‑local** (e.g., **Novelty\@context**). Cross‑context claims **must** use a **Bridge** and record **CL** penalties ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]). No global novelty.

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.2 - Context extensions & policy‑level characteristics (non‑kernel)
...
> **Compatibility note.** This split removes duplicate “core lists” and aligns [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] with **[[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/02_B.05.02.01 - Creative Abduction with NQD|B.5.2.1]] NQD** and **C.16/A.17–[[A_Kernel Architecture Cluster/18_Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)/00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]]**: the **kernel nucleus** captures creativity *qualities*; the items above instrument Work, policy, or declared retained-set shaping without renaming `Front`, `Archive`, or `Shortlist`.

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.3 - Scale choices (CSLC discipline)
...
* *Novelty\@context.*
  Coordinate = `1 − max_similarity(candidate, corpus)` with a declared encoder (text, graph, CAD). Unitless in \[0..1]. Document encoder & corpus freeze ([[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] Evidence Graph Ref).
* *Use‑Value.*
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.4 - Metric templates (normative kernels + manager‑ready variants)
...
#### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.4.1 - Templates (kernel definitions)
...
* **scale:** ratio \[0..1].
* **EvidencePin:** `{ReferenceSetId, EncoderId, Version}`; frozen by [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]].
...
#### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:12.4.2 - Manager’s quick checks (plain‑language adapters)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:13 - Novelty & transfer are **context‑local** (Bridges mandatory)

**Rule N‑1 (Locality).** `Novelty@context` is defined **only** within its `U.BoundedContext`. **Never** compare scores across Contexts without an **Alignment Bridge** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]]).
...
**Rule N‑3 (Penalty to R, not to G).** Cross‑context novelty **does not** change scope **G**; it **reduces R** (reliability) by the **CL penalty** ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), unless validated by pilot Work in the target Context.
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:14 - Anti‑Goodhart guard (use creativity metrics safely)
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:14.1 - Guard‑rails (normative)

* **G‑1 Paired appraisal.** **Never** assess **Novelty** in isolation; pair it with **Use‑Value** or **ConstraintFit** to avoid proxy myopia
* **G‑2 Frozen references.** Novelty requires **frozen corpus + encoder**; changes create a **new edition** and **RSCR** rerun. Portfolio-publication heuristics and selection heuristics are **policy-level** (see **[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]**); do not “reward” Illumination beyond its role as a report-metric.
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:14.2 - Conformance Checklist — **CC‑C17‑M (metrics & guards)**

| ID             | Requirement                                                                                                                            | Practical test                                                              |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **CC‑C17‑M.1** | Each metric instance **MUST** cite its **Context**, **edition**, and **evidence hooks** (corpus/encoder, acceptanceSpec, constraint set). | Scorecard lists `ContextId`, `Edition`, and hook ids resolvable via [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]]. |
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:15 - Worked mini‑cases (engineer‑manager focus)
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:15.1 - Case A — Hardware ideation sprint (manufacturing design)
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:15.2 - Case B — Data‑science hypothesis generation (health analytics)
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:15.3 - Case C — Product squad reframing (software UX)
...
### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:15.4 What these cases illustrate (tie‑backs)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:16 - Working examples

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:16.1 - Software (algorithmic/architectural ideation)
...
* Evidence prior at **L0** ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) until benchmarks exist; regression tests act as **ObserverRole** evidence.

**Context card (one screen).**

* Γ\_bundle: Cost = sum; ConstraintFit = AND; Novelty = subadditive; Evidence = min (chain) / SpanUnion (indep).

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:16.2 - Hardware (mechanical/electro‑mechanical concepting)**
...
**Context card.**
* Γ\_bundle: Hazard = max; ConstraintFit = AND; Cost = sum+coupling; Evidence = min on chain; Scope via **WorkScope** ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).

### [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:16.3 - Policy design (rules/standards/programs)
...
**Context card.**
* Γ\_bundle: EthicalRisk = max; ConstraintFit = AND (legal & operational); Cost = sum; Evidence = min/SpanUnion; Scope = ClaimScope ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).

## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:17 - Consequences & fit (for engineer‑managers)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:17.1 - Cross-scale characteristics need one visible distortion account
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:17.2 - `Use-Value` is not the whole `Q-set` by default
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:18 - Relations

* **Builds on**: [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/00_B.01 - Holon Aggregation and Part-Whole Construction|B.1]] Γ‑algebra (WLNK/COMM/IDEM/MONO), [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] Trust & Assurance (F–G–R, CL), [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] USM (Claim/Work scopes), [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] Evidence Graph Referring.
* **Coordinates with**: [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] Role suite (Observer/Evidence roles for probes), [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Work & plans for probes), [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] MM‑CHR (scale polarity & units). **[[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship|C.18]] NQD-CAL** (generation/illumination operators Γ_nqd.\*) and **[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]] E/E-LOG** (policies, selection, and declared retained-set rules). This CHR remains measurement-only.
* **Defers to**: [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]] Bridges for Cross‑context transfers; D‑cluster for ethical/speech‑act gates.

## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:19 - Quick reference cards (tear‑out)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:20 - Conformance Checklist (pattern‑level, normative)
...
Exploration/exploitation **MUST** be expressed as a **dynamics on the declared retained-set measure(s)** (e.g., exploration share as a function of marginal value of information), *not* as a prescriptive budget recipe. Objective, constraint, and decision-policy statements belong to Decsn‑CAL / [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]; [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] may cite them, but does not own or restate them.
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:21 - Worked‑Context Handbooks (concept cards, not runbooks)
...
These cards are *conceptual fixtures*; **Tooling** may implement them, **Pedagogy** may teach them, but **[[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]** only standardises their content as **thinking supports**.

## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:22 - Placement sanity‑check across the pattern language *(avoid scope creep)*

* **MM‑CHR ([[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]):** defines **Characteristic/Scale/Unit/Measure** and the *characterisation discipline*. **All** CS dimensions live there; [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] **uses** them, never re‑defines scales.
* **A.CHR‑SPACE ([[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]):** exports **CharacteristicSpace & Dynamics hooks**; [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] is a **Contexted specialisation** for creative reasoning (profiles / retained sets / selection).
* **Decsn‑CAL ([[C_Kernel Extension Specifications/02_11_Decision Theory (Decsn-CAL)/00_C.11 - Decision Theory (Decsn-CAL)|C.11]]):** defines **objective functions, constraints, preference orders, utility proofs**, and the **search–exploit dynamics** as decision policies. [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] only **names** the hooks (objective, rule), keeps policy math out.
* **KD‑CAL ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/00_C.02 - Epistemic holon composition (KD-CAL)|C.2]]) & [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] (Trust):** carry **evidence provenance**, **assurance** and **congruence penalties (CL)** for Cross‑context reuse. [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] requires anchors; it does not invent confidence calculus.
* **Compose‑CAL ([[C_Kernel Extension Specifications/03_13_Constructional Mereology (Compose-CAL)/00_C.13 - Constructional Mereology (Compose-CAL)|C.13]]):** governs **set/union/slice** aggregation; a declared retained set is a **Γ\_m.set** over profiles; frontier is derived **without** ad‑hoc geometry.
* **[[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/00_B.04 - Canonical Evolution Loop|B.4]] Canonical Evolution Loop:** where *Run→Observe→Refine→Deploy* sits. [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]] supplies the **view** in which refinement is judged.
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:23 - Anti‑patterns & canonical rewrites (conceptual hygiene)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:24 - Minimal didactic cards (one screen each)
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:25 - Consequences (informative)
...
| **Method independence**    | Any tooling can implement the cards; [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]] remains a conceptual API for thought.                                                   |
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:26- Open questions (non‑normative, research hooks)**
...
## [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]:End
