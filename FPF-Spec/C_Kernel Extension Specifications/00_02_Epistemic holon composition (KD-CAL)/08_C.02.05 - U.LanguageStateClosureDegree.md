...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:1 - Problem frame
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:2 - Problem
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:3 - Forces
| Force | Tension |
|---|---|
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:4 - Solution
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:4.1 - Characteristic specification
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:4.2 - Starter anchor set
...
| `CD5` | strongly fixed | relaxation requires an explicit [[03_A.16.02 - Reopen - SketchBackoff - Respecify]] move and governance note |

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:4.3 - Non-collapse rules
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:4.4 - Change discipline
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:5 - Archetypal Grounding
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:6 - Bias-Annotation
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:7 - Conformance Checklist
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:8 - Common Anti-Patterns and How to Avoid Them
- **Closure by mood.** A sentence sounds decisive, so teams assume high closure. Publish `CD` explicitly.
- **Irreversible drift.** Closure rises informally but no reopen path exists. Use [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]].
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:9 - Consequences
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:10 - Rationale
Closure is the route-governance basis slot that complements articulation within the declared language-state chart over `U.CharacteristicSpace`. [[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] and its seam species need both.

## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:11 - SoTA-Echoing
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:12 - Relations
...
- Coordinates with: [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]].
- Constrains: reopen, backoff, and endpoint docking guards.

## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:13 - Worked Examples and Retreat Cases

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:13.1 - Explicit but still open
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:13.2 - Strong closure under policy guard
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:13.3 - Reopen case
A route may move from `CD4` back to `CD2` when counter-evidence appears. A conforming publication does not hide this as embarrassment; it records the retreat as an admissible [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]] move.

## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:14 - Authoring and Review Guidance

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:14.1 - Author prompt
To assign `CD`, ask:
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:14.2 - Review prompt
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:14.3 - Governance note
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:15 - Extension and Migration Notes

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:15.1 - Local anchor refinement
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:15.2 - Migration from readiness language
Words such as "settled", "closed", "final", or "open" should be treated as migration prompts into explicit `CD` claims and, where needed, into named [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]] moves.

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:15.3 - Boundary reminder
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:16 - Closure Publication Package Discipline

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:16.1 - Minimal closure package
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:16.2 - Narrowing-source rule
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:16.3 - Partial-closure rule
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:17 - Retained and Withdrawn Authority Handling

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:17.1 - Authority retention rule
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:17.2 - Admissible retreat record
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:17.3 - Closure versus obligation boundary
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:18 - Review Matrix and Reopen Tests

### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:18.1 - Review matrix
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:18.2 - False-finality test
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:18.3 - Cross-facet reminder
...
### [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:18.4 - Split-closure review case
...
## [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]]:End
