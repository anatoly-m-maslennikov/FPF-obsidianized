...
**What this buys.** The practitioner can keep the episteme, its described object, grounding holon, claim graph, viewpoint, view, reference scheme, carrier, publication, and evidence relation separate while still using one compact slot relation across [[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]], A.6.2-A.6.4, [[03_E.17 - Multi-View Publication Kit|E.17]], and related description/specification-use patterns.

**Not this pattern when.** Use the direct governing pattern when the current question is the described system or holon ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and system/holon patterns), a publication face or carrier ([[03_E.17 - Multi-View Publication Kit|E.17]]), evidence or assurance ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_G.06 - Evidence Graph & Provenance Ledger|G.6]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), mathematical-lens use ([[00_C.29 - Mathematical Lens Use|C.29]]), a method or method description ([[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), or a wording-use repair ([[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]). [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] governs the episteme slot relation itself.

## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:1 - Context
...
KD‑CAL ([[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]]) needs a precise notion of **what an episteme is** and **how it mediates** between:
...
* is compatible with **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]].0/A.6.5** signatures (`SlotKind`/`ValueKind`/`RefKind`),
* can be used uniformly by A.6.2-A.6.4 (epistemic morphisms) and [[03_E.17 - Multi-View Publication Kit|E.17]].* (views & publication),
...
In this pattern:
* `U.Episteme` is the **holon genus** for epistemes ([[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]]), with components and identity governed by A.1/A.6.0/A.7.
* `U.EpistemeSlotRelation` names the **internal slot relation** of `U.Episteme`: the small, typed n-ary relation over episteme positions (`EntityOfConcernSlot`, `GroundingHolonSlot`, `ClaimGraphSlot`, `ViewpointSlot`, `ViewSlot`, `ReferenceSchemeSlot`) on which KD-CAL, A.6.2-A.6.4 and [[03_E.17 - Multi-View Publication Kit|E.17]].* rely.
...
**Adopted EntityOfConcern family.** [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] uses `EntityOfConcernSlot`, `entityOfConcernRef`, `EntityOfConcernRef`, `EntityOfConcernChangeMode`, and `EntityOfConcernClass` as the adopted slot/ref/class family. These names are the current [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] vocabulary and must not be shadowed by a second episteme ontology.

## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:2 - Problem
...
3. **Viewpoints are not first‑class.**
   ...
   * organize multi‑view descriptions ([[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]), or
...
5. **No explicit signature discipline.**
   The triangle speaks of “Object/Concept/Symbol” but not of **slots** and **references** in the sense of [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline`. In episteme this leads to:
...
* **Broken modularity.**
  As soon as we add KD-CAL, LOG-CAL, MVPK, and [[00_E.18 - Transformation Flow Structure|E.18]], multiple **implicit triangles** appear, each with slightly different semantics, instead of a single shared `U.EpistemeSlotRelation`.
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:3 - Forces
...
| **EntityOfConcern vs. Description episteme and specification use/refinement** | The `EntityOfConcern` value is not the Description episteme produced by this describing, viewing, or morphing use; however, the EntityOfConcern value may itself be a `U.Episteme` when an episteme is the current `EntityOfConcern`. Specification is not a third peer class in [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]]; it is a gated use or refinement of a Description episteme selected by neighbouring formality plus checkable constraint, harness, acceptance, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] measurement criterion, suffix, verification, or publication-expression discipline for an already admitted specification use. |
| **Viewpoint locality vs. reuse**               | Viewpoints should be **local** to families of descriptions, yet we want reusable **viewpoint bundles** across domains ([[03_E.17 - Multi-View Publication Kit]].1/E.17.2). |
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4 - Solution - `U.EpistemeSlotRelation` as the normative episteme ontology

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.0 - Overview

For `U.Episteme`, `U.EpistemeSlotRelation` is the normative **small, typed n-ary relation with SlotSpecs** over the core episteme positions. It is not a graph object and not a tuple object. Under [[00_C.29 - Mathematical Lens Use|C.29]], the same slot relation may be viewed as a tuple for filled-value reasoning or as a graph/hypergraph diagram for dependency reasoning, but those are mathematical-lens views. Graph-valued fillers such as `U.ClaimGraph` remain real graph-kinds inside the relation.

**Positions / slots.**
  Minimal **kernel SlotKinds** (with their ValueKinds) that every episteme can refer to, following [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]:
...
* **Slots and signatures.**
  These positions are realised as **SlotKinds** with associated **ValueKinds** and **RefKinds** under `U.RelationSlotDiscipline` ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]). An **episteme kind** (`U.EpistemeKind`) is a **signature** over these slots.

* **Episteme as n-ary relation and as holon.**
  Each concrete episteme instance can be seen both as:

  * a **filled value assignment** over this slot relation; when [[00_C.29 - Mathematical Lens Use|C.29]] tuple reasoning is current, the assignment may be viewed as a tuple view without becoming a second episteme kind, and
  * a **holon with components** (`U.EpistemeCard`, `U.EpistemeView`, `U.EpistemePublication`) whose fields correspond to those slots.

`U.Episteme` is thus the holon type whose components are *disciplined* by the `U.EpistemeSlotRelation`; [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] fixes that discipline.
...
The rest of this pattern fixes the **minimal core** needed by KD-CAL, A.6.2-A.6.4 and [[03_E.17 - Multi-View Publication Kit|E.17]].*. The representational nodes (`U.RepresentationScheme`, `U.RepresentationToken`, `U.PresentationCarrier`, `U.RepresentationOperation`) are introduced as an **extension [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+**, preserving the interface defined here.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1 - Minimal epistemic positions (nodes & slots)

This section defines the **minimal position set** for `U.EpistemeSlotRelation` and the associated **SlotKinds**. These are the positions that A.6.2-A.6.4 and [[03_E.17 - Multi-View Publication Kit|E.17]].* can rely on.

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.1 - `EntityOfConcernSlot` — “what this episteme is about”
...
1. `EntityOfConcernSlot` is a **SlotKind** in the sense of [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline`.

   * Its **ValueKind** is `U.Entity`.
   * Its **RefKind** is `U.EntityRef` (or a species thereof) and **MUST** be realised in data as a field named `entityOfConcernRef : U.EntityRef` ([[00_E.10 - Unified Lexical Rules for FPF|E.10]] discipline).
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.2 - `GroundingHolonSlot` — “where / in what holon this is grounded”
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.3 - `U.ClaimGraph` and `ClaimGraphSlot` — claim content
...
1. `U.ClaimGraph` is the **ValueKind** for `ClaimGraphSlot`:
   ...
   * edges: logical/derivational/refinement relations, as already defined in [[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]].
2. `ClaimGraphSlot` is a **SlotKind** whose instances are always **stored by value** in core patterns:
   ...
   * [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] **MUST NOT** introduce `U.ClaimGraphRef` as a ValueKind. Any reference type for ClaimGraphs, if needed, is a **RefKind** defined by discipline packs on top of `U.ClaimGraph`.
3. `ClaimGraphSlot` is **mandatory**: every `U.EpistemeKind` that uses [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] **SHALL** have exactly one `ClaimGraphSlot`.

**Didactic cue.**
“Ask: *What is actually being claimed, defined, required, proved?* That is the ClaimGraph.”

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.4 - `U.Viewpoint` and `ViewpointSlot` — perspective of concerns and validators
...
**Intent.** Provide a **first-class reusable catalogue** for ISO-style viewpoints and their generalisations, as used by [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] `U.MultiViewDescribing`, MVPK, and TEVB.
...
1. `U.Viewpoint` is the type of **viewpoint specifications**:
   ...
   * and **conformance rules** for views under this viewpoint.
     (The internal structure of `U.Viewpoint` is fixed in [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], not here.)
...
3. For Description epistemes, including Description epistemes admitted for specification use, under [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], `viewpointRef` is a **mandatory part of `DescriptionContext`**; [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] treats that as a **species-level constraint**, not as a universal requirement for all epistemes.
4. `ViewpointSlot` may be unset in purely internal, pre‑viewpoint epistemes (e.g., raw formal developments), but any episteme that participates in **MultiViewDescribing** ([[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]) **MUST** set it or be deterministically associated to it via a `ViewpointBundle`.

**Didactic cue.**
“Ask: *Who is this for, and what do they need to see to accept it?* That is the Viewpoint.”

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.5 - `U.EpistemeView` / `U.View` and `ViewSlot` — episteme‑level views
...
* the MVPK `publication face/form`/`interop publication form` `publication-face kind` values and the external carriers/renderings on which views are made available ([[03_E.17 - Multi-View Publication Kit|E.17]], publication-face/form discipline, SCR/RSCR).
...
2. `U.View` is an **alias** for `U.EpistemeView` in E‑cluster patterns (especially [[03_E.17 - Multi-View Publication Kit|E.17]].\*), used where the word “view” is conventional.
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.6 - `U.ReferenceScheme` and `ReferenceSchemeSlot` — interpreting ClaimGraph as claims about entities
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.7 - Minimal slot relation and extension [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+

The **minimal `U.EpistemeSlotRelation` core** for [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] consists of positions (the episteme core SlotKinds of [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] CC-A.6.5-5):
...
The **extension [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+** (second step of the refactor) adds:
...
* or the assumptions A.6.2-A.6.4 / [[03_E.17 - Multi-View Publication Kit|E.17]].* make about episteme components.

In [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+ `U.PresentationCarrier`, publication face/form values, MVPK face, carrier, and rendering relations remain **publication-side carriers, faces, forms, units, or rendering relations**, not semantic parts of the episteme:
`U.PresentationCarrier` values are linked to `U.Episteme` and `U.View` via MVPK and publication-face/form discipline relations, such as `isCarriedBy` and MVPK face relations, and **MUST NOT** be counted as components when reasoning about episteme identity, EntityOfConcernSlot filling, GroundingHolonSlot filling, or KD-CAL morphisms. Changing carriers, publication faces/forms, units, or renderings alone **never** changes the `U.Episteme` instance determined by [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]; it only produces `U.Work` occurrences that publish or republish the same `U.Episteme`.

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.1.8 - Attached epistemic structures (non-slot components)
...
* **`EditionSeries`** - the `PhaseOf` chain of episteme editions ([[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]) with change-class annotations (symbol-only vs ClaimGraph vs ReferenceScheme changes).
* **`ScopeCard` and `U.ClaimScope`** - USM scope values ([[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]) describing where the episteme's claims hold.

These attached structures are **not extra positions** of `U.EpistemeSlotRelation`; they hang off the `U.ClaimGraph` and `U.ReferenceScheme` pair and are governed by KD-CAL ([[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]]), [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] only requires that an episteme which participates in KD-CAL exposes them in a way that keeps **ClaimGraph, ReferenceScheme, Evidence, EditionSeries, and `ClaimScope`** clearly distinguishable.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2 - Episteme as n‑ary relation and as holon

To prevent confusion between **EntityOfConcern values**, their **descriptions**, and the **slots they fill in an episteme**, [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] explicitly treats epistemes both as:

1. **n‑ary relations with a signature** (slots & values), and
2. **holons with components** (fields & parts).

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2.1 - `U.EpistemeKind` — episteme as a typed n‑ary relation

**Tech:** `U.EpistemeKind` (kernel type).

**Intent.** Provide a **signature‑level** description of an episteme as an n‑ary relation whose arguments are governed by `SlotKind`/`ValueKind`/`RefKind` triples per [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]].
...
1. `U.EpistemeKind` is a **special case** of `U.Signature` ([[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]]), with its slots governed by `U.RelationSlotDiscipline` ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]). [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] **MUST NOT** define an alternative slot discipline.
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2.2 - Filled episteme value assignment and [[00_C.29 - Mathematical Lens Use|C.29]] tuple view

**Tech:** filled episteme value assignment over `U.EpistemeSlotRelation`; [[00_C.29 - Mathematical Lens Use|C.29]] tuple view when tuple reasoning is current.
...
3. Under [[00_C.29 - Mathematical Lens Use|C.29]], the same filled assignment may be viewed as a tuple when tuple reasoning is the selected mathematical lens. That tuple view is a mathematical-lens representation of the filled SlotRelation, not a second episteme kind and not a replacement for graph-valued fillers such as `U.ClaimGraph`.
...
**Didactic cue.**
"A filled episteme assignment says *what fills which slots*; if [[00_C.29 - Mathematical Lens Use|C.29]] asks for tuple reasoning, read that assignment as a tuple view."

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2.3 - `U.EpistemeCard`, `U.EpistemePublication`, `U.EpistemeView` — holonic realisations
...
1. **`U.EpistemeCard`.**
   ...
   * optionally `representationSchemeRef? : U.RepresentationSchemeRef` ([[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+),
   * `meta : Edition/Provenance/Status…`.
     Minimal episteme identity is the pair `⟨content, entityOfConcernRef⟩` within a `U.BoundedContext`; all other fields are optional at the genus level but may be mandatory in species. Changes that alter `content` or the effective `referenceScheme` (or that intentionally re-identify `entityOfConcernRef`) **SHALL** be realised as new phases in an `U.EditionSeries` (PhaseOf chain) under [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] and [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]. Changes confined to `U.PresentationCarrier`, publication-side values, MVPK face, carrier, or rendering relations **do not** create a new episteme; they are captured as publication work over the same `U.Episteme`.
2. **`U.EpistemePublication`.**
   ...
   * plus references to MVPK `U.View`, face identity, `publication face/form` and `interop publication form` `publication-face kind` values, publication-scope fields, profile fields, and external carrier or rendering refs as required by [[03_E.17 - Multi-View Publication Kit|E.17]] and publication-face/form discipline,
...
This ensures that [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] can treat any `U.Episteme*` uniformly as both:
* a category-theory object in the category **Ep**, and
* a structured holon with components.

#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2.3a - Episteme, publication, view, carrier, cue, and authority-reference lanes  *(normative)*

[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] is the default FPF pattern for claim-bearing units. Do not mint a generic `U.SemioObject`, `U.SemioticObject`, `U.SignObject`, `U.WorkingObject`, or `U.SourceMaterial` when the claim-bearing unit in question should be modeled as an episteme. Use `U.Episteme` or a declared species of `U.Episteme`.
...
#### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.2.4 - SlotKind / ValueKind / RefKind discipline for EntityOfConcern & GroundingHolon

[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] adopts **[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline`** wholesale. For the two key positions:
...
Any episteme that previously mixed slot/value/ref concepts (e.g., using `EntityOfConcernRef` as if it were a type) **MUST** be migrated to this discipline over time; [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] provides the normative reference, and [[00_F.18 - Local-First Unification Naming Protocol|F.18]] / discipline packs provide the migration guide.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:4.3 - Minimal epistemic morphisms (informal schema)

> **Note.** The full mathematical treatment (categories Ep and Ref, entityOfConcern functor `α : Ep → Ref`, and effect‑free morphisms) lives in [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]. Here we fix only the **episteme-slot relations** that [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] expects to exist between its positions.
...
4. **`satisfies / evaluatesTo : (U.ClaimGraph, U.ReferenceScheme, U.Holon) → TruthProfile/SuccessProfile`**
   ...
   * Forms the bridge to KD‑CAL’s `F, G, R` evaluation; details are given in [[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].

5. **View-related morphisms** (to be connected with [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]):
...
These are **not yet laws**; they are the **hooks** that [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] will formalise into:
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:5 - Legacy semantic triangle as didactic view  *(informative)*
...
* **"Symbol" corner** ~= {`U.RepresentationToken`, `U.RepresentationScheme`, `U.PresentationCarrier`} when [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+ is in use; in the minimal core this is collapsed into whichever external carrier bears the `U.ClaimGraph` publication.
...
All **viewpoints, operations, carriers and reference planes** are suppressed in the classical diagram. The cost of this suppression is precisely the confusion that motivates [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:
* describing becomes a single unlabeled arrow,
* inference regimes disappear,
* measurement and grounding are invisible.

**Didactic use.** [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] allows the triangle **only** in the following cases:
...
2. As a **quotient diagram**: an explicit note that "this figure ignores viewpoint, grounding, carrier, and operationality; see [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] for the full structure".
...
* explicitly state "this is a didactic projection of [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.EpistemeSlotRelation`", or
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:6 - Interaction with EntityOfConcern and Description-episteme boundary, specification use/refinement, and DescriptionContext  *(normative)*

[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] is the **episteme-side slot schema** that `EntityOfConcern` / Description-episteme discipline ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]) relies on. The link is made via `DescriptionContext`, not by treating EntityOfConcern value, Description epistemes, and specification use/refinement as layers, carriers, or peer ontology classes.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:6.1 - DescriptionContext over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] components

For any episteme that is a **Description** in the sense of [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], including a Description episteme admitted for specification use, the field `subjectRef : U.SubjectRef` is interpreted as a **DescriptionContext triple**:
```
...
* `BoundedContextRef : U.BoundedContextRef` — points to the context that fixes vocabulary, units, and legal inferences for this description ([[03_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]]).
...
* **Describing (`Describe_EoC_DescEp : EntityOfConcern -> DescriptionEpisteme`).**
  ...
  * `viewpointRef` selects the describing viewpoint.
  ...
  `Describe_EoC_DescEp` is **conformant** to [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] but not an Ep→Ep morphism (domain is the `EntityOfConcern` value, codomain is a Description-side `U.Episteme`). [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] provides the **codomain schema** and ensures that the resulting Description has a valid DescriptionContext.

[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] does not decide that a Description episteme has become a Specification. If a bounded use formalises, constrains, test-harnesses, accepts, or publishes a Description episteme as a specification, the governing pattern must name the exact specification-use gate: [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] for effect-free episteme refinement, [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] for formality and checkability, [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] or the relevant gate/acceptance pattern for harness and acceptance force, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for measurement criteria, [[03_E.17 - Multi-View Publication Kit|E.17]] for publication expression, and [[00_E.10 - Unified Lexical Rules for FPF|E.10]] for suffix discipline. The [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] requirement is only that the Description episteme keeps the same `entityOfConcernRef`, `BoundedContextRef`, and `ViewpointRef` unless an retargeting or viewing pattern named by value declares otherwise.

[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] does **not** define the full `EntityOfConcern` / Description-episteme boundary or the specification-use gates; it only insists that any `...Description` episteme, and any `...Spec` use admitted by neighbouring gates, must:
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:7 - Alignment with [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] (episteme morphisms)  *(normative)*
`U.EpistemeSlotRelation` is the **slot-relation substrate** for the episteme morphism patterns:
* [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] `U.EffectFreeEpistemicMorphing`
* [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] `U.EpistemicViewing`
* [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] `U.EpistemicRetargeting`

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:7.1 - Effect‑free episteme morphisms ([[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]) over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]
...
* **Typed episteme values.**
  ...
  Any additional [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+ components (RepresentationScheme, Tokens, Carriers, Operations) are visible to [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] only through their declared SlotKinds ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]).
* **EntityOfConcernChangeMode characteristic.**
  ...
  * `retarget` — permitted only for [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] species; see below; in this case the characteristic records an intentional change in the pair `<entityOfConcernRef, groundingHolonRef>` under a declared `KindBridge` in the appropriate ReferencePlane.

  This **EntityOfConcernChangeMode** is a CHR-style *characteristic* ([[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]]) on episteme morphisms, which points directly to `EntityOfConcernSlot`. Avoid introducing a separate “entityOfConcern” term alongside `EntityOfConcern`.

* **Component discipline.**
  P0–P5 from [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] are read **directly** in terms of [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] components:
  * purity ⇒ only [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] components of Y may change; no Work/Mechanism side‑effects;
...
Any Ep→Ep pattern that operates on `U.Episteme` **MUST** state which [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slots it reads and which it may write, in terms of SlotKinds/ValueKinds/RefKinds ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]), and then declare itself a species of [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].2/3/4 as appropriate.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:7.2 - EpistemicViewing ([[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]) as entityOfConcern‑preserving projections

`U.EpistemicViewing` is the **EntityOfConcern-preserving** species of [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]. Over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] this means:
...
* `viewpointRef` is either:
  ...
  * replaced by another `U.ViewpointRef` *within* a `U.MultiViewDescribing` family ([[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]), with invariants enforced by a CorrespondenceModel.
...
In terms of SoTA, EpistemicViewing behaves like a **lens** or **optic** over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]: a focus (SlotKinds for content/representation) is manipulated while the EntityOfConcern is fixed.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:7.3 - EpistemicRetargeting ([[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]) as EntityOfConcern-bundle retargeting on episteme morphisms

`U.EpistemicRetargeting` is the species of [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] where **`entityOfConcernChangeMode = retarget`**.
It is always a **morphism between epistemes** (`f : X → Y` in `U.Episteme`), but the adjective “retargeting” refers **not** to the fact that an episteme is mapped to another episteme (this is true for all [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] species), and **not** to a separate entityOfConcern, but specifically to the **change in the EntityOfConcern-bundle** classified by [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:
...
[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] ensures that these retargetings have a **clear domain `EntityOfConcernSlot` value and codomain `EntityOfConcernSlot` value** and that any such move is expressed as a morphism over well-typed slots, not as an unstructured rewrite of “subject” or “object” labels.

## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:8 - Alignment with [[03_E.17 - Multi-View Publication Kit|E.17]].* (Multi‑View Describing & Publication)  *(normative)*

`U.EpistemeSlotRelation` underpins the [[03_E.17 - Multi-View Publication Kit|E.17]] cluster:
* [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] `U.MultiViewDescribing`
* [[01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] `U.ViewpointBundleLibrary`
* [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]] `TEVB — Typical Engineering Viewpoints Bundle`
* [[03_E.17 - Multi-View Publication Kit|E.17]] `MVPK — Multi‑View Publication Kit`

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:8.1 - Multi‑View Describing ([[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]])
...
* The **EntityOfConcernClass** parameter of [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] is a species constraint on the ValueKind of `EntityOfConcernSlot` (`EntityOfConcernClass ⊑ U.Entity`).
...
Within this pattern:
* `U.Viewpoint` is **exactly** the ValueKind of `ViewpointSlot` in [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]].
...
[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] thus supplies the **per‑episteme** structure that [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] rearranges into multi‑view families.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:8.2 - Viewpoint bundles ([[03_E.17 - Multi-View Publication Kit|E.17]].1/E.17.2)
...
From the [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] perspective:
...
### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:8.3 - MVPK ([[03_E.17 - Multi-View Publication Kit|E.17]]) as publication over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] views

MVPK treats `U.View` (i.e. `U.EpistemeView`) as its primary input:
* it uses `U.EpistemicViewing` species ([[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]) to generate publication‑oriented views from engineering or logical views;
...
[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]’s distinction between:

* `U.Viewpoint` (epistemic perspective specification) and
* `U.PresentationCarrier` (carrier in [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+ and publication-face/form discipline)
...
Any MVPK species that claims to be [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑conformant **MUST**:
* treat `U.View` as a `U.EpistemeView` with a valid [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] core,
* document which [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slots it reads/writes (typically only representation/carrier‑related ones, leaving `EntityOfConcernSlot` and `GroundingHolonSlot` untouched),
* refrain from introducing new claims about the EntityOfConcern value beyond what is in the source `U.View`’s ClaimGraph.

## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:9 - Bias‑annotation  *(informative)*
...
[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+ anticipates that certain RepresentationSchemes are **operational** in Novaes’ sense (admitting direct syntactic inference, like pen-and-paper arithmetic or proof states) while others are **purely notational**. The pattern remains neutral on which schemes are used but bakes in a place for operations and carriers so that:
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:10 - Conformance checklist  *(normative)*

**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑1 - Minimal core components for episteme species.**
Any species of `U.Episteme` that participates in `EntityOfConcern` / Description-episteme boundary discipline, specification use/refinement, or [[03_E.17 - Multi-View Publication Kit|E.17]] multi-view/publishing **MUST** be representable as `U.EpistemeCard`/`U.EpistemeView` with at least:
...
and corresponding SlotSpecs consistent with [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] (`EntityOfConcernSlot`, `GroundingHolonSlot`, `ClaimGraphSlot`, `ViewpointSlot`, `ReferenceSchemeSlot`).

**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑2 - No kernel type for “EntityOfConcern” or “GroundingHolon”.**
...
**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑3 - SlotKind/ValueKind/RefKind discipline.**
All episteme‑related slots, including `EntityOfConcernSlot`, `GroundingHolonSlot`, `ClaimGraphSlot`, `ViewpointSlot`, `ViewSlot`, `ReferenceSchemeSlot` (and any extensions in [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+), **MUST**:
* follow the naming discipline of [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] (`*Slot` for SlotKinds, `*Ref` only for RefKinds/fields),
...
**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑4 - DescriptionContext wiring.**
Any episteme species whose name or pattern claims to be a `…Description` or `…Spec` in the sense of [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] **MUST**:
...
**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑5 - Morphism declarations over slots.**
Any pattern in [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.18 - Transformation Flow Structure|E.18]], or discipline packs that defines morphisms between epistemes **SHALL**:
...
* normative laws are stated in terms of [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slots, graph-valued fillers such as `ClaimGraph`, and morphisms, not in terms of triangle corners.
...
**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑8 - Context locality and Bridges.**
Any `U.Episteme` species that is consumed by KD‑CAL / LOG‑CAL / CHR‑based patterns **SHALL** declare a `U.BoundedContextRef`; all F–G–R computations and [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slot interpretations are **context‑local**.  Cross‑context use **MUST** proceed via an explicit Bridge with CL / Φ‑policy (F.9/B.3), with penalties routed to R‑lanes only; F and the slot structure from [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] remain unchanged.

**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑9 - Carriers and Work outside episteme content.**
[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] **inherits** [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and [[00_A.12 - External Transformer & Reflexive Split|A.12]] separation obligations: `U.PresentationCarrier` values, publication-side values, and `U.Work` occurrences **MUST NOT** be treated as parts of `U.Episteme` or as values of any SlotKind in `U.EpistemeSlotRelation`. Episteme content stays in `U.ClaimGraph` and `U.ReferenceScheme`; evidence enters only via `U.EvidenceRole` bindings that point to external `U.Work` occurrences and carriers ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]). Changing carriers or re-publishing work alone does **not** change the episteme determined by the filled `content`, `entityOfConcernRef`, and effective `referenceScheme` positions in its `U.BoundedContext`.

**CC‑[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑10 - Reflexive entityOfConcern guard.**
When an episteme uses [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] to speak **about** another episteme (ReferencePlane = episteme), or about itself (self-describing or meta-specification cases), patterns **SHALL** ensure that the resulting JustificationGraph / evaluation chains are **acyclic** along justification paths. Reflexive `describe` / citation edges may exist as literature references, but they MUST NOT form minimal justification cycles for acceptance or KD-CAL assurance decisions; the trust calculus MUST always bottom out in external evidence (`U.Work` with `U.EvidenceRole`) rather than in purely self-referential claims.

## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:11 - Consequences  *(informative)*

**Benefits**
* **Single, extensible episteme core.**
  [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] gives a small, stable set of positions (EntityOfConcern, GroundingHolon, ClaimGraph, Viewpoint, View, ReferenceScheme) and components (`U.EpistemeCard`, `U.EpistemeView`, `U.EpistemePublication`) on which all higher‑level patterns depend. This avoids the proliferation of “epistemic objects” and “facets” with overlapping semantics.
**Transparent EntityOfConcern & grounding discipline.**
  The pair (`EntityOfConcernSlot`, `GroundingHolonSlot`) is no longer hidden inside ad-hoc “SubjectRef” fields or semantic triangles: both are explicit, typed slots. This makes retargeting, viewing and correspondence laws ([[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]) easier to state and check.
* **Better fit for contemporary representation practice.**
  By distinguishing ClaimGraph, RepresentationScheme, Tokens, Carriers and Operations (in [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+), the pattern matches contemporary SoTA views of notation and formalism:
...
* **Migration effort.**
  Legacy uses of “EpistemicObject”, “Facet”, “Subject”/“Object”, and raw `…Ref` fields will need refactoring into [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slots + [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] SlotSpecs. Current prose uses the selected [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slots and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] SlotSpecs directly; old wording is source/input material for repair, not a current alternate vocabulary.
* **Exposure of representation biases.**
  Being explicit about RepresentationSchemes and Operations may surface disagreements about which representations are “primary” in a team or discipline. [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] does not resolve these disagreements; it only makes them visible and therefore debatable.

### [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:12 - Relations  *(overview)*

**Builds on**
* [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] `U.Holon` — for treating episteme as a holon with components.
* [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] `U.Signature` — for interpreting episteme kinds as n‑ary relations over slots.
* [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline` — for SlotKind/ValueKind/RefKind discipline over episteme slots.
* [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] — for `EntityOfConcern` / Description-episteme boundary discipline, specification use/refinement gates, and the interpretation of `subjectRef` as DescriptionContext.
* [[00_C.02 - Epistemic holon composition (KD-CAL)|C.2]] (KD‑CAL, LOG‑CAL) — for ClaimGraph semantics, ReferencePlanes, and Bridges.
* [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]] — for pattern authoring discipline and lexical guards.

* **Constrains**
* [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] — by fixing the minimal episteme component set those morphisms operate on and by requiring an explicit **EntityOfConcernChangeMode characteristic** (`entityOfConcernChangeMode ∈ {preserve, retarget}`) over `EntityOfConcernSlot`/`GroundingHolonSlot`.
* [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]–[[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]] — by specifying how `EntityOfConcern`, `Viewpoint`, `View` and ReferenceSchemes are represented at episteme level.
* [[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK) — by separating `U.View` (episteme) from `U.PresentationCarrier` (publication carrier), and by requiring that publication morphisms be `U.EpistemicViewing` species over [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]‑conformant views.
* [[00_F.18 - Local-First Unification Naming Protocol|F.18]] (LEX‑BUNDLE) — by providing the episteme‑specific name cards and guards for EntityOfConcern/GroundingHolon/Viewpoint/View/ReferenceScheme and their SlotKinds.

**Used by**
* [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] `U.EffectFreeEpistemicMorphing` — as the default episteme slot/value structure for episteme-to-episteme transforms.
* [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] `U.EpistemicViewing` — as the substrate for entityOfConcern‑preserving projections (views).
* [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] `U.EpistemicRetargeting` — as the substrate for EntityOfConcern-bundle retargeting transforms between epistemes (Ep→Ep with `entityOfConcernChangeMode = retarget`).
* [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] `U.MultiViewDescribing`, [[01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]], [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]] — to organise families of Description epistemes, including Description epistemes admitted for specification use, under Viewpoints and `EntityOfConcernClass` constraints.
* [[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK) — to publish episteme views through publication faces/forms and carriers.
* [[00_E.18 - Transformation Flow Structure|E.18]] - to interpret StructuralReinterpretation and other engineering projections as episteme morphisms over a well-typed `U.EpistemeSlotRelation`.
...
## [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]:End
