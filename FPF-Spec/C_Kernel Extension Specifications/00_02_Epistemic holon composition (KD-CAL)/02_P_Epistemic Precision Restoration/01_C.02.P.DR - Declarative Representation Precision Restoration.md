...
> **Type:** [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] precision-restoration child pattern for declarative-representation overread
> **Status:** Stable
> **Normativity:** Normative unless a section is explicitly informative

## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:0 - Use this when
...
- an [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path is overread as approval, permission, release, gate passage, or assurance;
...
- If the graph path, `PathSlice`, or flow valuation is already current as graph structure, use [[00_E.18 - Transformation Flow Structure|E.18]] directly.
- If the evidence relation or provenance relation for a claim is already current, use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] directly.
- If the publication face or source-use relation is already current, use [[03_E.17 - Multi-View Publication Kit|E.17]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], or the direct publication pattern.
- If the current claim concerns a semantic way of doing, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]; if it concerns the description of that way, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]].
- If the current claim concerns operation algebra, laws, admissibility predicates, transport, audit, or governing-definition assignment, use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] or [[00_E.20 - Mechanism Introduction Protocol|E.20]].
- If the current claim concerns planned work or dated work, use [[02_A.15.02 - U.WorkPlan|A.15.2]] or [[01_A.15.01 - U.Work|A.15.1]].
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:1 - Problem frame
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:2 - Problem

Without this repair:

1. **Graph path becomes work route.** A path or path slice in [[00_E.18 - Transformation Flow Structure|E.18]] is treated as an ordered work narrative, even when no work occurrence, work plan, or method description is current.
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:3 - Forces
...
| Legitimate path words and metaphor repair | `A.10 evidence path`, [[00_E.18 - Transformation Flow Structure]] graph path, and carrier file paths may be legitimate; `path` becomes a defect only when it carries a stronger action or authority claim by metaphor. |
...
| Direct governing pattern and local repair | When [[00_E.18 - Transformation Flow Structure]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[01_A.03.01 - U.Method- Context-Defined Way of Doing]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], [[02_A.15.02 - U.WorkPlan]], [[01_A.15.01 - U.Work]], [[03_E.17 - Multi-View Publication Kit]], or another pattern already governs the current claim, this pattern names only the overread and leaves the next claim to that pattern rather than duplicating it. |

## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4 - Solution
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.1 - DeclarativeRepresentationRepair note
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.2 - Direct governing-pattern selection

| If recovery shows... | Use this governing pattern | Keep this boundary |
| --- | --- | --- |
| graph object, graph path, `PathSlice`, crossing, flow valuation, transformation-flow structure relation, or graph expression over that structure | [[00_E.18 - Transformation Flow Structure]], [[02_E.18.02 - Transformation Flow Mathematical Description]], or [[01_E.18.01 - Principles-to-Work Carry-Through]] when P2W carry-through is current | Graph structure or path structure is not work route, method narrative, evidence result, or pattern dispatch by layout. |
| evidence relation or provenance relation for a claim, effect, or reliance use | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] | Evidence path is not approval, permission, gate passage, release, safety, work occurrence, or assurance by itself. |
| state, status value, readiness, validity, or predicate-like value whose bearer and value frame is hidden | [[02_A.19.SPR - State-Family Precision Restoration]] or the direct status-value or state-value pattern | A predicate or state-like value is not a workflow, gate, or proof unless the governing pattern says so. |
| publication face, source expression, generated explanation, dashboard face, publication unit, or source-chain relation | [[03_E.17 - Multi-View Publication Kit]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]], [[00_C.02.P - Epistemic Precision Restoration]], [[04_A.15.04 - Work-Relevant Source Restoration]], or source-use pattern named by value | Publication and source visibility do not create work, evidence, authority, release, or gate passage. |
| mathematical representation, formal object, formal substrate, invariant, or mathematical-lens output | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], or direct mathematical pattern | Mathematical representation is not method, mechanism, proof of project result, or work execution until that claim is separately recovered. |
...
| law-governed operation algebra, laws, admissibility predicates, transport, audit, realization, or governing-definition assignment | [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] and [[00_E.20 - Mechanism Introduction Protocol]] | Mechanism meaning is not selected by saying "algorithm" or "method"; it needs mechanism fields. |
...
| FPF pattern application, pattern relation, neighboring-pattern relation, or placement cue | [[00_E.08 - FPF Authoring Conventions & Style Guide]], [[00_F.19 - Ontology-First Plain Technical Rewriting]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], or the direct pattern relation named by value | Pattern relations are declarative references or applications, not exits, receivers, routes, calls, owners, homes, or dispatches. |
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.4 - Method, algorithm, mechanism, and work-slot settlement
...
| formal substrate, signature, postulates, laws, or mathematical declaration | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]]; use [[00_C.29 - Mathematical Lens Use]] when mathematical-lens use is current |
| operation algebra, admissibility predicates, transport, audit, realization, or mechanism-governing-definition assignment | [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] and [[00_E.20 - Mechanism Introduction Protocol]] |
| planned work | `A.15.2 U.WorkPlan` |
| dated performed work | `A.15.1 U.Work` |
| evidence relation or provenance relation for a claim | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] |
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:4.5 - Programming-paradigm and process-model settlement
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5 - Worked slices

### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.1 - Graph path in a transformation-flow structure
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.2 - Evidence path near release

Wording: "The evidence path authorizes release."

Repair: [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] can state an evidence path for the claim or effect. Release, permission, or gate passage requires the authority, gate, or release pattern that governs that claim. This pattern is used only if `path` wording itself is causing the representation to be overread as a permission route.

### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.3 - Query plan and access path

Wording: "The query plan calls the production work sequence."

Repair: recover whether the query plan is an optimizer representation, method description, formal substrate, source cue, evidence relation, work plan, or actual work trace. If it only represents query evaluation choices, do not treat it as `U.WorkPlan` or `U.Work`. If the current claim concerns method semantics, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]; if it concerns a method description, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]; if it concerns a performed query run, use [[01_A.15.01 - U.Work|A.15.1]] and the evidence pattern or source-use pattern.

### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.4 - Dashboard predicate
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.5 - Pattern relation

Wording: "This pattern exits to [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]."

Repair: if the current relation is "use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when an evidence relation or provenance relation is current", write that declarative boundary. Do not use exit, receiver, route, owner, home, dispatch, or call language unless the pattern is actually about an action occurrence, work plan, control mechanism, or communication relation that has those semantics.

### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.6 - Solver algorithm

Wording: "The solver algorithm is the mechanism."

Repair: recover the current slot or use-position. The solver configuration may be `U.MethodDescription`; the accepted semantic way of solving may be `U.Method`; the MILP formulation may expose formal substrate and mathematical-lens use; a reusable operation algebra with laws and admissibility predicates may be `U.Mechanism`; a solver run may be `U.Work`; a run result may be evidence for another claim. Select [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] only when mechanism fields are present in the current claim.

### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.7 - Reactor-cooling flow graph
...
### [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:5.8 - CRISPR guide-selection table
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:6 - Conformance checklist
...
| `CC-C2PDR-5` | Legitimate `A.10 evidence path`, [[00_E.18 - Transformation Flow Structure]] graph path, `PathSlice`, carrier file path, URL, or mathematical path use is preserved when that kind is current. |
| `CC-C2PDR-6` | Method-like and algorithm-like wording recovers the current slot or use-position before replacement: [[01_A.03.01 - U.Method- Context-Defined Way of Doing]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], [[00_E.20 - Mechanism Introduction Protocol]], [[02_A.15.02 - U.WorkPlan]], [[01_A.15.01 - U.Work]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], direct governing pattern, or quote-only source wording. |
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:7 - Common anti-patterns

| Anti-pattern | Symptom | Repair |
| --- | --- | --- |
| Path word deletion | Every `path` is replaced or avoided. | Preserve legitimate [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_E.18 - Transformation Flow Structure]], carrier, mathematical, URL, and quoted-source path uses; repair only hidden stronger claims. |
...
| Algorithm as method by default | Code, solver model, proof script, or workflow is called the method without slot recovery. | Use [[01_A.03.01 - U.Method- Context-Defined Way of Doing]] only for semantic way of doing; use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], [[00_E.20 - Mechanism Introduction Protocol]], [[02_A.15.02 - U.WorkPlan]], [[01_A.15.01 - U.Work]], or [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] when those claims are current. |
...
| Pattern dispatcher | Pattern relations are written as routes, exits, receivers, calls, owners, or homes. | Write declarative neighboring-pattern boundary or application relation; use [[00_E.08 - FPF Authoring Conventions & Style Guide]] and [[00_F.19 - Ontology-First Plain Technical Rewriting]] together when both publication-form and phrase-apparatus claims are live, or use the one governing pattern when only one claim is live. |
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:8 - Relations

- **Builds on:** [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], and [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]].
- **Coordinates with:** [[00_E.18 - Transformation Flow Structure|E.18]], [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[02_A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[00_C.29 - Mathematical Lens Use|C.29]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[00_E.20 - Mechanism Introduction Protocol|E.20]], [[02_A.15.02 - U.WorkPlan|A.15.2]], [[01_A.15.01 - U.Work|A.15.1]], [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], and direct publication, gate, authority, release, evidence, method, work, and assurance patterns when those claims are being made.
- **Specializes:** [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] for one recurring case: declarative representation and imperative-metaphor overread.
- **Used by:** [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] applicability-row distribution and full-pattern text precision restoration when route, path, workflow, call, or dispatch wording hides representation use.

## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:9 - Consequences
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:10 - SoTA-Echoing
...
| --- | --- | --- |
| [[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], and [[00_C.02.P - Epistemic Precision Restoration]] | Current FPF precision-restoration architecture. | This pattern is a bounded child realization under [[00_C.02.P - Epistemic Precision Restoration]], not a new umbrella pattern. |
| [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] and [[00_E.18 - Transformation Flow Structure]] | Local FPF direct governing patterns for evidence paths, provenance paths, transformation-flow graph paths, and path slices. | Path wording is legitimate when those kinds are current; the defect is stronger overread. |
| [[01_A.03.01 - U.Method- Context-Defined Way of Doing]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], [[00_E.20 - Mechanism Introduction Protocol]], [[02_A.15.02 - U.WorkPlan]], and [[01_A.15.01 - U.Work]] | Local FPF slot chain for method-like and algorithm-like wording. | The repair recovers slot or use-position before choosing method, method description, formal substrate, mechanism, work plan, or work occurrence. |
...
## [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]]:End
