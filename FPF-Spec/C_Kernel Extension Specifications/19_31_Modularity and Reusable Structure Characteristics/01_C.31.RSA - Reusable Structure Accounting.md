...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:1 - Problem frame
...
Claim-use boundary: comparison, publication, evidence validity, assurance or safety-case reliance, gate use, architecture scale preference, causal-use, selected-set publication, candidate-synthesis, and local decision are outside-RSA uses. [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] may state the reusable locus, bespoke residue, accounting basis, report-only share, repair direction, and source-return condition. Add those other claims only under their governing patterns when those claims are being made.
...
What goes wrong if [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] is missed: a reusable share is treated as a proof of modularity; one-off work is hidden under a reuse label; evidence reuse is counted without validity context; hidden residual uncertainty is averaged with reusable templates; and "more reusable structure" is treated as always better.

What [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] buys in practice: the practitioner can state where structure is reusable, where it is bespoke, what source-side distinctions must remain reachable, and when the result is only report-only accounting.

Not this pattern when the question under repair is source-label recovery, module-interface relation repair, modularity-characteristic selection, measurement or comparability legality, architecture scale preference, mathematical-lens use, or any outside-RSA use named above. Use [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], [[12_A.06.M - Module Relation Repair|A.6.M]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_G.06 - Evidence Graph & Provenance Ledger|G.6]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]], [[00_C.29 - Mathematical Lens Use|C.29]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] as appropriate; do not treat [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] as the synthesis or selector pattern.

## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:2 - Problem
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:3 - Forces
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4 - Solution

[[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] governs reusable-structure accounting as a typed description over declared structures and structural aspects. It starts with `ReusableStructureTriage`; it uses `ReusableStructureAccountingDescription@Context` only when the accounting basis is declared.

### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.1 - Typed accounting description
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.2 - Explanatory slot labels
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.3 - Report-only shares
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.4 - Pseudo-sum boundary
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.5 - Structure-relocation moves
...
| Repeated interface exceptions are handled one by one. | Add or revise interface grammar, variability slots, or substitution policy under [[12_A.06.M - Module Relation Repair]]. |
...
| Regulatory or safety-case residue remains one-off. | Split reusable argument structure from context-specific exception; apply [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] or [[00_G.06 - Evidence Graph & Provenance Ledger]] for assurance or safety-case reliance. |
| Compression hides needed distinctions. | Reduce compression, add source-return condition, or apply [[00_C.29 - Mathematical Lens Use]] for lens-governed compression or reduction claims. |
...
| Compression or lens-backed accounting | Lost source distinction, observer-budget dependency, or [[00_C.29 - Mathematical Lens Use]] stop-condition breach. |
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.6 - Triage and accounting use boundary
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:4.7 - Reopen and lowering conditions
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:5 - Archetypal Grounding
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:5.1 - Worked case: reusable evidence package, bespoke delivery work
...
relatedClaimGovernanceIfClaimed:
  [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[G_Discipline SoTA Patterns Kit/07_06_Evidence Graph & Provenance Ledger/00_G.06 - Evidence Graph & Provenance Ledger|G.6]] for evidence validity; [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance reliance; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.M - Module Relation Repair|A.6.M]] for interface grammar; [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] if comparison is being made
stopCondition:
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:5.2 - Anti-case: high share hides a bad architecture move
...
This is not a successful RSA result. The accounting basis counts template instances but hides interface relation cost, lost variation, hidden bespoke work, and evidence decay. The repair is to mark the share as report-only, add the missing bespoke-residue slots, and apply [[12_A.06.M - Module Relation Repair|A.6.M]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], or an characteristic pattern governing the claim to the interface relation cost before any comparison or decision use.

Lowering replay: the team tries to use the 85 percent share to rank this template architecture above another product-line variant and approve the template program. The use is lowered to local report-only accounting because the comparator set, accounting-basis alignment, interface-cost measure, source-return condition, and decision record are absent. Before comparison or decision use, [[12_A.06.M - Module Relation Repair|A.6.M]] must repair the interface grammar, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] or [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] must govern comparability and characteristic space, and [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] must govern the local decision claim.
...
### [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:5.3 - Transfer case: neural-network block replacement
...
RSA can transfer from product-line architecture to neural-network architecture only after [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] has treated `block`, `cache`, and related terms as source labels unless the reusable locus is already recovered. Then RSA names the declared structures and accounting basis:
...
- evidence claims apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_G.06 - Evidence Graph & Provenance Ledger|G.6]]; causal claims apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]; mathematical-lens or compression claims apply [[00_C.29 - Mathematical Lens Use|C.29]].
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:6 - Bias-Annotation

| Bias risk | [[01_C.31.RSA - Reusable Structure Accounting]] repair |
| --- | --- |
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:7 - Conformance Checklist
...
| `CC-C31.RSA-7` | Evidence reuse and assurance reuse apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], or [[00_G.06 - Evidence Graph & Provenance Ledger]] when validity, assurance, or safety-case reliance is being claimed. |
| `CC-C31.RSA-8` | RSA does not duplicate the [[00_C.31 - Modularity and Reusable Structure Characteristics]] characteristic taxonomy; it uses [[00_C.31 - Modularity and Reusable Structure Characteristics]] only when a modularity characteristic under evaluation, such as bespoke residue, evidence reuse, or residual uncertainty, must govern the accounting interpretation. |
...
| `CC-C31.RSA-12` | Source labels such as block, layer, expert, cache, router, gate, or pruning mask use [[03_C.30.STRAT - Stratification Wording Precision Restoration]] before they become `structureRefs`, `structuralAspectRefs`, accounting-basis fields, repair moves, or source-return conditions. |

## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:8 - Common Anti-Patterns and How to Avoid Them
...
| `EvidenceReuseAsAssurance` | Evidence reuse share is treated as assurance. | Apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], or [[00_G.06 - Evidence Graph & Provenance Ledger]] for validity and assurance reliance. |
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:9 - Consequences
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:10 - Rationale

[[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] is separate from [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] because accounting over reusable structure has a different reusable-structure accounting question from choosing modularity characteristics. [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] asks which characteristic changes action. [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] asks where reusable structure and bespoke residue are located under a declared accounting basis.
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:11 - SoTA-Echoing

| Source or practice | Currentness or lineage use | Adopt and adapt for [[01_C.31.RSA - Reusable Structure Accounting]] | Rejected overread | Governing-pattern use and action consequence |
| --- | --- | --- | --- | --- |
| [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] Q-Bundle discipline inside FPF | Landed FPF-local governing discipline for quality-family claims. | Adopt separation of scope, measures, mechanisms, windows, evidence, and admissible use. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes `ReusableStructureShare`: the share is report-only accounting under declared `accountingBasisRef` until the relevant outside-RSA use is governed by its governing pattern. | A reusable-structure share does not replace the underlying Q-Bundle, description, evidence relation, or decision record. | Apply [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] when reuse becomes a quality claim or measurement claim; the practitioner may report a share locally but must not use it as proof without the governing pattern for that use. |
| ISO/IEC/IEEE 42010:2022 architecture-description, viewpoint, model-kind, and correspondence discipline (`https://www.iso.org/standard/74393.html`; `https://www.iso-architecture.org/ieee-1471/cm/`) | Current international standard and conceptual-model source for architecture-description and view discipline for this source-use decision. | Adopt explicit architecture description, source view, viewpoint, model-kind, correspondence, and conformance pressure. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes source-return use: reusable-structure accounting names the structure refs, source view or architecture-description refs, correspondence refs, and source-return condition before any cross-view share is used. | A view, diagram, model kind, or correspondence label is not the reusable structure itself and does not make a share comparable, admissible for decision use, or assurance-bearing. | Apply [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], or [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences]] when source views or architecture descriptions are being used; RSA may count only after the selected structure refs and accounting basis are recoverable. |
| Modular Open Systems Approach (MOSA) and open-system acquisition or engineering practice (`https://www.cto.mil/sea/mosa/`; `https://www.cto.mil/wp-content/uploads/2025/03/MOSA-Implementation-Guidebook-27Feb2025-Cleared.pdf`) | Current engineering and acquisition practice family for modular interfaces, conformance, replacement, and supplier-diversity pressure. | Adopt the pressure to make reusable interface, conformance, substitution, and supplier-diversity structure explicit. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes interface reuse: reusable interface accounting remains report-only until [[12_A.06.M - Module Relation Repair]] has repaired interface grammar, substitution policy, version or change policy, conformance work, source or evidence relation, and the supplier-diversity relation when that relation is being made. | Open interface label, API label, platform label, or supplier-diversity goal is not reusable structure, procurement suitability, assurance, gate passage, or decision authority by itself. | Apply [[12_A.06.M - Module Relation Repair]] for interface grammar, substitution policy, version or change policy, conformance expectations, source or evidence relation, and supplier-diversity relation before RSA comparison or decision use; use [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_C.11 - Decision Theory (Decsn-CAL)]] for supplier-set selection or procurement decision use when that use is being made. |
| DSM, dependency, and product-architecture practice, including Eppinger and Browning DSM lineage | Mature architecture-analysis lineage still used for dependency and product-architecture reasoning; lineage, not a complete current standard. | Adopt typed dependency structures as possible source for reusable loci and bespoke-residue diagnosis. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes dependency use: dependency counts, partitions, and clusters become candidate source fields only when declared `structureRefs`, structural aspects, and accounting basis are present. | Dependency count, cluster count, or DSM modularity score is not architecture amount, quality proof, or decision verdict. | Apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] and [[00_C.31 - Modularity and Reusable Structure Characteristics]] for characteristic and scale legality; apply [[00_C.29 - Mathematical Lens Use]] when graph, partition, compression, or [[00_C.29 - Mathematical Lens Use]] lens-use result changes action. |
| Goodhart and Campbell proxy-pressure laws | General proxy-risk lineage for report-only shares, reuse scores, and benchmark-like accounting. | Adopt proxy-risk discipline for reusable-share use. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes share use: a reusable-structure share remains report-only until the relevant outside-RSA use is governed by governing patterns. | Reusable-share improvement, coverage improvement, or benchmark improvement is not value, assurance, evidence sufficiency, gate passage, or architecture decision by itself. | Apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]], or the evidence and assurance patterns before a reuse number can guide selection or reliance. |
| System-evolution, information-hiding, and effective-interface lineage | General holon-architecture lineage for reusable structure that changes over time and hides variation-prone structure. | Adopt evolution and hidden-change discipline. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes residue interpretation: reusable loci, bespoke residue, hidden interface behavior, source-return conditions, and bounded exceptions are reopened when the structure edition, accounting rule, implicit interface, or reliance relation changes. | One-time reusable-share accounting is not sustainable fitness; a stable-looking interface or template does not prove future substitutability. | Reopen or lower the RSA result when hidden variation, implicit dependency, source distinction, or continuing adaptation changes the accounting meaning. |
| Software product-line engineering and variability-management practice, including Pohl, Boeckle, and van der Linden lineage plus current product-line and variability work (`https://www.sei.cmu.edu/library/variability-in-software-product-lines/`; `https://arxiv.org/abs/2605.21353`) | Mature product-line variability lineage plus current SPLE-review cues for variability slots, product-line reuse, platform extension rules, and reuse-rule discipline. | Adopt variability-slot and reuse-rule pressure. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes product-line use: reusable structure may be located in template, interface, work, evidence, and exception loci, and bespoke residue must name repair direction, bounded exception, or source-return condition instead of being averaged into one share. | Product-line label, shared code base, feature model, or platform name is not enough to infer reusable structure or architecture scale-preference evidence. | Apply [[12_A.06.M - Module Relation Repair]] for platform claims or interface claims, [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] for architecture scale preference, and [[00_C.11 - Decision Theory (Decsn-CAL)]] or [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] for choice or candidate-set use. |
| GSN Community Standard v3 and assurance-case reuse and safety-case reuse practice (`https://scsc.uk/gsn`; `https://arxiv.org/abs/2506.11023`) | Current assurance-case standard family plus current formalization work for this source-use decision; assurance validity remains context-sensitive. | Adopt the distinction between reusable assurance argument structure, reusable evidence structure, and context-specific validity witnesses. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes evidence and assurance reuse: reuse remains accounting until evidence validity, safety-case use, or assurance reliance is governed by its own pattern. | Evidence reuse share or assurance-argument template reuse does not infer assurance, safety-case success, gate passage, or release permission. | Apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] and [[00_G.06 - Evidence Graph & Provenance Ledger]] for evidence validity and safety-case use, and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] for assurance reliance; add source-return condition and validity-window check before reliance. |
| Architecture-operation language, with neural-network and software-system discussions as source examples, including the GonzoML architecture-operation intake | Current practitioner-language source for structural substitution, gating, memory placement, cache placement, routing, ablation, pruning, distillation, and architecture search; not used as a current standard by itself. | Adopt the recognition that replacement and search expose reusable and bespoke structural loci. In [[01_C.31.RSA - Reusable Structure Accounting]] this changes architecture-operation use: source labels such as block, layer, expert, cache, router, gate, or pruning mask remain source labels until [[03_C.30.STRAT - Stratification Wording Precision Restoration]] and the governing pattern for the claim being made recover `structureRefs`, aspect refs, accounting basis, repair moves, and source-return conditions. | Block, layer, expert, cache, router, gate, benchmark, ablation, pruning mask, or distillation success is not RSA slot ontology, architecture decision, evidence sufficiency, gate passage, assurance, or architecture adequacy by itself. | Apply [[03_C.30.STRAT - Stratification Wording Precision Restoration]] first where source-label recovery is needed, then [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] or [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] for architecture claim and structural view, [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]] for flow changes, [[00_C.29 - Mathematical Lens Use]] for mathematical-lens or compression claims, [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] or [[00_G.06 - Evidence Graph & Provenance Ledger]] for benchmark or evidence use, and [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] for causal claims. |
...
## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:12 - Relations

| Pattern | Relation |
| --- | --- |
| [[03_C.30.STRAT - Stratification Wording Precision Restoration]] | Recovers source labels such as layer, level, tier, stack, block, expert, cache, router, gate, and pruning mask before RSA uses recovered reusable loci, bespoke-residue loci, accounting-basis fields, repair moves, or source-return conditions. |
| [[00_C.31 - Modularity and Reusable Structure Characteristics]] | Supplies modularity characteristics under evaluation; RSA does not duplicate the characteristic taxonomy. |
| [[12_A.06.M - Module Relation Repair]] | Supplies module-interface relation repair for reusable interface and platform-grammar claims. |
| [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] and [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] | Supply architecture claim and structural-view context for the structures being accounted over. |
| [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | Govern measurement, scale, unit, comparability, score, and characteristic legality when RSA shares are used beyond report-only. |
| [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] | Governs broader quality-family bundles when reusable structure is used in a quality claim. |
| [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_G.06 - Evidence Graph & Provenance Ledger]] | Govern evidence, assurance, and safety-case reliance. |
| [[00_C.29 - Mathematical Lens Use]] | Governs compression, epiplexity, RG, or other mathematical-lens claims when accounting depends on a lens. |
| [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] | Govern temporal, causal, architecture scale-preference, scale-law, and BLP claims derived from residue growth or reuse movement. |
| [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]] | Govern set-return selection and local decision claims. Candidate-synthesis and selected-set publication claims are governed by [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] when set-return or candidate-set publication is being claimed; local decision claims are governed by [[00_C.11 - Decision Theory (Decsn-CAL)]]; RSA does not govern candidate-synthesis, selected-set, or decision use. |

## [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]]:End
