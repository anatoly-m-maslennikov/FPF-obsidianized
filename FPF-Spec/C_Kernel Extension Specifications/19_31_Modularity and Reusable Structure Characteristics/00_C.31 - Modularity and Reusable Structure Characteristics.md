...
## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:1 - Problem frame
...
Claim-use boundary: comparison, publication, evidence, assurance, gate, decision, benchmark, causal-use, cross-case reuse, selection, procurement, and architecture scale-preference are beyond-local-repair uses in [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]. Add their fields only when that use is being made and recoverable by value and the governing pattern can be named.

What goes wrong if [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] is missed: "modular" becomes a binary label; a single modularity score hides incompatible characteristics; interface publication is confused with substitutability; internal cohesion is improved while evidence reuse gets worse; bespoke residue moves from templates into work or assurance; and complexity language becomes a commensurable score without a declared characteristic, scale, measurement basis, comparison basis, or admissible-use boundary.

What [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] buys in practice: the practitioner can see which modularity characteristic changes the next move, which false use is blocked, which repair is plausible, and which governing pattern governs measurement, evidence, causal, scale, selection, or accounting claims.

Not this pattern when the question under repair is only source-label recovery, module-interface relation repair, reusable-structure accounting, general measurement legality, quality-family claim, architecture scale-preference claim, mathematical-lens use, candidate architecture synthesis, or selection. Use [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], [[12_A.06.M - Module Relation Repair|A.6.M]], [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]], [[00_C.29 - Mathematical Lens Use|C.29]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] as appropriate; do not treat [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] as the synthesis or selector pattern.

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:2 - Problem
...
[[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] turns modularity talk into a small characteristic vector plus repair direction. It does not promise that every characteristic is measurable now, comparable across cases, causal, admissible for decision use, or evidence-backed.

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:3 - Forces
...
| Local repair vs cross-case publication | A local diagnosis can stop at report-only use; cross-case comparison needs [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]], [[00_G.02 - SoTA Harvester & Synthesis]], and possibly [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_C.11 - Decision Theory (Decsn-CAL)]] claim-governance assignment. |
...
The vector is complete enough when it states what can be done next and what cannot be inferred. If a characteristic is used beyond local repair, use the appropriate card and governing pattern; architecture scale-preference claims are governed by [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]].

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.1a - Filled `ModularityVectorLite`
...
Near miss: a high interface-standardization count alone is not a [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] improvement. If field-service work, source-return events, or variant-specific evidence increase, the vector records that proxy divergence and returns to repair rather than treating the count as architecture quality.

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.2 - Characteristic classes

Every [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] head is classified before use:
...
| `LensBackedCharacteristic` | The head depends on a model description or mathematical lens, such as compression or RG or coarsening lens. | Apply [[00_C.29 - Mathematical Lens Use]] for lens use that changes action. |
| `TemporalOrScaleCharacteristic` | The head depends on time window, repeated instance, scale variable, aggregation scope, or source-return condition. | Apply [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] for architecture scale preference, [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] for temporal adequacy, and [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]] or [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] when scale-law or general BLP preference claims are being made. |
| `CausalUseSensitiveCharacteristic` | The interpretation is used to claim effect or intervention success. | Apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] before relying on the claim causally. |
...
In [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], `declared basis` and `comparability basis` name C.16-compatible measurement or comparison fields. They are not generic reason words and are not substitutes for evidence, assurance, cause, source, decision, or architecture-description relations.

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.3 - Measurement-head mapping
...
### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.4 - [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] characteristic card
...
Each card states its own [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] well-formedness fields: characteristic, scale, unit or unitless interpretation, declared measurement basis, comparability basis, evidence path or evidence-claim-absent reason, non-admissible use, and repair move. When source material is used as evidence, the source relation is named. A source checklist, source-discharge slice, dashboard label, or inherited score is not enough.

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.5 - Seed characteristic heads and repair moves
...
| `TemplateCompressionGain` | Description saving from template plus parameters compared with instance-by-instance descriptions. | ratio or bits under declared method | corpus or model-description method | compression erases safety, legal, or source distinctions | add source-return condition, split template, or apply [[00_C.29 - Mathematical Lens Use]] | lens-characteristic or effect claim, publication, or decision use |
...
| `FlowModuleBoundaryAlignmentCharacteristic` | Flow topology crosses declared interfaces rather than hidden channels. | vector, ordinal, or bundle description | transformation-flow path and interface refs | flows bypass declared module boundaries | expose crossing, revise interface, or apply [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]] for the architecture-flow claim | architecture-flow publication or assurance claim |
| `ControlStructureSeparationCharacteristic` | Control responsibilities, rates, and boundaries are explicit enough for the architecture move. | ordinal or vector | LCA or control description and temporal adequacy basis | control relation is hidden inside module label | apply [[05_C.30.LCA - Control Structure View Adequacy (LCA)]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] when a control, temporal, dynamics, or assurance claim kind is being made | stability, assurance, or gate use |
...
| `LearningTransferCoefficient` | Improvement transfer from one instance or run to subsequent instances. | slope or elasticity | repeated work data and learning curve records | improvement claim hides time or causal assumptions | apply [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] for temporal adequacy and [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] for causal use | causal, benchmark, or scale-preference use |
| `BespokeResidueShare` | Share of structure not covered by reusable templates or rules. | report-only share unless [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] measurement basis is declared | RSA description and exception register | residue is hidden under reuse score | use [[01_C.31.RSA - Reusable Structure Accounting]] and source-return condition | accounting, comparison, or decision claim |
| `RGFlowStability` | Stability of characteristic vector across declared coarse-graining scopes. | vector or ordinal | declared multi-scope architecture graphs | coarse-graining hides lower-scope hazards | apply [[00_C.29 - Mathematical Lens Use]] for lens use and [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made | RG, scale, or lens transfer use |
| `ExceptionCurveSlope` | Change in one-off exceptions over a scale variable. | slope | exception records against scale variable | exceptions grow with scale | apply [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] or accept bounded exception | scale preference, publication, or decision claim |

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.6 - Claim-scoped residual heads

[[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] uses residual heads only as qualitative repair cues. These heads do not create one complexity characteristic.

| Head | Meaning | Related claim governance | Risk | Repair direction |
| --- | --- | --- | --- | --- |
| ComplexityGrowthPressure | Pressure to add, split, mediate, or stabilize a declared aggregation scope, interface grammar, control relation, evidence scope, work-method scope, abstraction scope, or source-return condition. | [[06_C.30.ILC - Cross-Scope Architecture Residual Triage]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made, [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]] | treating more apparatus as progress | name the pressure and the repair direction; use set-return or decision patterns when the corresponding claim is being made |
| `FrustrationResidual` | Persistent cross-scope residual after local repair. | [[06_C.30.ILC - Cross-Scope Architecture Residual Triage]], C.29-local cross-scope lens claim | turning a lens-backed interpretation into proof | keep as residual cue or apply [[00_C.29 - Mathematical Lens Use]] or [[06_C.30.ILC - Cross-Scope Architecture Residual Triage]] |
| `ConflictResidualSlope` | Residual grows or shrinks over declared scale variable, scale window, or coarse-graining scale. | [[02_C.31.ASAP - Architecture Scale-Amenability Preference]], [[00_C.29 - Mathematical Lens Use]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] | treating two points as universal law | declare window, lens-use boundary, and measurement basis or stop at report-only |
| `DeclaredScopeAdditionCost` | Added work, evidence, change-policy, latency, observability, accountability, or interface cost from a new declared aggregation or control scope. | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_C.31 - Modularity and Reusable Structure Characteristics]], [[05_C.30.LCA - Control Structure View Adequacy (LCA)]] | ignoring the cost of added structure | identify cost bearer and apply the measurement pattern if used for comparison |
| `BespokeResidueGrowth` | One-off exceptions grow with deployment spread, regulation, or project repetition. | [[01_C.31.RSA - Reusable Structure Accounting]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made | assuming all bespoke work is bad | split useful exception from repairable residue |
| `InterfaceAlphabetGrowth` | Interface variants grow faster than reuse, substitutability, or integration payoff. | [[12_A.06.M - Module Relation Repair]], [[00_C.31 - Modularity and Reusable Structure Characteristics]] | premature standardization | add platform grammar, split context, or accept bounded variation |
| `SourceReturnCost` | Frequency or cost of returning from a compressed, indexed, coarse, extracted, or accounting view to source-side structure records. | [[00_C.29 - Mathematical Lens Use]], source-return discipline, [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] | over-compression | add source-return condition or reduce compression |
| `ControlNestingDepthRisk` | Nested control relations create latency, accountability, observability, stability, or assurance cost. | [[05_C.30.LCA - Control Structure View Adequacy (LCA)]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] | LCA-as-proof | apply control, temporal, assurance, or dynamics governing patterns when the corresponding claim is being made |

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.7 - Proxy-risk discipline

Every decision-facing [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] card includes `ProxyRisk` and `AuditQuestion`. If the proxy diverges from the value it was meant to represent, the card stops at report-only use or returns to repair.
...
### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.8 - Rejected shortcut

The expression `ModularityScore = average(all measures)` is not admissible as a [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] result. A local score is admissible only when the scoring method, codomain, polarity, characteristic basis, comparability basis, and use boundary are disclosed through the governing scoring or comparator pattern. Without that, keep the result as report-only or return to `ModularityVectorLite`.

### [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:4.9 - Lowering and currentness conditions
...
- [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference|C.31.ASAP]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[00_C.29 - Mathematical Lens Use|C.29]], [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], [[12_A.06.M - Module Relation Repair|A.6.M]], [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] changes the boundary for the neighboring claim being made.

Admissible repair results are: keep the result report-only, split or rename the characteristic head, update basis or evidence fields, revise the repair direction, change `relatedClaimGovernanceIfClaimed`, lower a score to a local proxy, or stop [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] use for the beyond-local-repair claim and use the governing pattern.

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:5 - Archetypal Grounding

**Tell.** Modularity is a vector of action-guiding characteristics, not a magic scalar. A good [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] interpretation says what to repair next.
...
Holon and episteme: architecture and modules are selected structures of described holons; the described holon may be a system, episteme, method, organization, publication family, or another structured holon. [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]] heads, cards, vectors, and report-only proxies are characteristic records, declared-measurement-basis records, comparability-basis records, or report-only records about those structures.

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:6 - Bias-Annotation

| Bias risk | [[00_C.31 - Modularity and Reusable Structure Characteristics]] repair |
| --- | --- |
...
| Source-label bias | Treat software, neural-network, chiplet, safety-case, product-line, block, layer, expert, cache, router, and gate labels as source examples until [[03_C.30.STRAT - Stratification Wording Precision Restoration]] and the governing pattern recover the FPF characteristic subject, structure, scale, and admissible use. |

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:7 - Conformance Checklist
...
| `CC-C31-7` | Complexity, residual, and growth heads remain claim-scoped cues; apply [[00_C.29 - Mathematical Lens Use]], [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] when an architecture scale-preference claim is being made, [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]], [[06_C.30.ILC - Cross-Scope Architecture Residual Triage]], [[01_C.31.RSA - Reusable Structure Accounting]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], or [[00_C.11 - Decision Theory (Decsn-CAL)]] when the corresponding claim kind is being made. |
| `CC-C31-8` | No [[00_C.31 - Modularity and Reusable Structure Characteristics]] text treats modularity as a single quality proof, assurance proof, gate result, causal proof, or architecture decision. |
...
| `CC-C31-10` | SoTA seeds for DSM, modularity-index, empirical modularity, platform, evidence-reuse, Conway and mirroring, Amdahl, queueing, coordination-overhead, information-hiding, abstraction-leakage, or Goodhart and Campbell proxy-risk sources are converted into pattern-local [[00_G.02 - SoTA Harvester & Synthesis]] rows before [[00_C.31 - Modularity and Reusable Structure Characteristics]] uses them for practitioner guidance being relied on. |
| `CC-C31-11` | Source labels such as block, layer, expert, cache, router, or gate use [[03_C.30.STRAT - Stratification Wording Precision Restoration]] before they become [[00_C.31 - Modularity and Reusable Structure Characteristics]] characteristic subjects, scale cues, repair moves, or proxy-risk rows. |
...
## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:8 - Common Anti-Patterns and How to Avoid Them
...
| `OpenInterfaceEqualsModular` | Interface publication is treated as modularity. | Apply relation repair through [[12_A.06.M - Module Relation Repair]] and characterize only the interface or substitutability head under evaluation. |
...
## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:9 - Consequences
...
- Cross-case comparison requires additional [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[00_G.02 - SoTA Harvester & Synthesis|G.2]], comparator, evidence, or decision claim.
...
## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:11 - SoTA-Echoing

| Source or practice | Currentness or lineage use | Adopt and adapt for [[00_C.31 - Modularity and Reusable Structure Characteristics]] | Rejected overread | Practitioner implication |
| --- | --- | --- | --- | --- |
| DSM and dependency-structure practice (`https://dsmweb.org/design-structure-matrix-dsm/`; `https://dsmweb.org/introduction-to-dsm/`) | Mature and still-used architecture-analysis practice for dependency representation, clustering, and compact dependency communication. | Adopt typed dependency analysis as a possible declared measurement or comparison basis for specific [[00_C.31 - Modularity and Reusable Structure Characteristics]] heads such as `InternalCohesionDensity`, `ExternalCouplingDensity`, `InterfaceAlphabetSize`, and `HiddenCouplingDiscoveryRate`. | A dependency matrix is not architecture, proof, complete modularity, assurance, or decision by itself. | A dependency graph helps only after dependency kind, subject, scale, repair direction, and non-admissible use are declared. |
...
| MOSA and open systems practice (`https://www.cto.mil/sea/mosa/`; `https://www.cto.mil/wp-content/uploads/2025/03/MOSA-Implementation-Guidebook-27Feb2025-Cleared.pdf`) | Current engineering and acquisition practice family for modular interfaces, conformance, severable components, replacement, and supplier diversity. | Adopt the pressure to make interface standards, conformance, substitutability, and supplier-diversity relations explicit; adapt by applying [[12_A.06.M - Module Relation Repair]] before [[00_C.31 - Modularity and Reusable Structure Characteristics]] characterizes `InterfacePublicness`, `SubstitutabilityWidth`, or related heads, and by applying [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_C.11 - Decision Theory (Decsn-CAL)]] to supplier-set selection or procurement decision use when that use is being made. | `Open`, public, platform, API, conformance, or supplier-diversity label is not modularity, procurement suitability, or a beyond-local-repair claim by itself. | Open-system conformance and substitution claims may change [[00_C.31 - Modularity and Reusable Structure Characteristics]] repair only after the module-interface relation is repaired; procurement and other beyond-local-repair uses require their governing pattern. |
| Platform and product-line engineering practice (`https://tag-app-delivery.cncf.io/fr/whitepapers/platform-eng-maturity-model/`; `https://www.sei.cmu.edu/library/variability-in-software-product-lines/`; `https://arxiv.org/abs/2605.21353`) | Mature product-line variability lineage plus current platform-engineering maturity-model and current SPLE-review cues; used for variability-slot, extension-rule, reuse, and exception-residue characteristic discipline. | Adopt variability slots, extension rules, template records, product-line records, allowed variation, and exception-residue tracking as possible [[00_C.31 - Modularity and Reusable Structure Characteristics]] characteristic subjects or declared measurement bases. | A platform or product-line label is not modularity value, reusable-structure proof, architecture scale-preference evidence, procurement suitability, or decision authority. | The practitioner names which characteristic changes action: interface standardization, module-type reuse, template compression, bespoke residue, exception curve, or the governing pattern for a beyond-local-repair claim being made. |
...
| Amdahl, queueing, and coordination-overhead laws (`https://www.cs.cmu.edu/~18742/papers/Amdahl1967.pdf`; `https://arxiv.org/abs/1306.3302`; `https://arxiv.org/abs/2603.20654`) | Mature mathematical law and queueing lineage plus current extension sources for communication, synchronization, and scalable-workload-fraction limits. | Adopt serial fraction, synchronization, communication overhead, WIP, waiting, bottleneck, and partitionability as possible [[00_C.31 - Modularity and Reusable Structure Characteristics]] defect signals; apply [[00_C.29 - Mathematical Lens Use]], [[00_E.18 - Transformation Flow Structure]], or [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]] when mathematical speedup or flow claims are being made. | More modules, teams, services, paths, processors, accelerators, or work partitions are not improvement by count. | A module split is evaluated by changed characteristics and bottlenecks, not by decomposition count. |
...
## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:12 - Relations

| Pattern | Relation |
| --- | --- |
| [[03_C.30.STRAT - Stratification Wording Precision Restoration]] | Recovers source labels such as layer, level, tier, stack, block, expert, cache, router, and gate before [[00_C.31 - Modularity and Reusable Structure Characteristics]] uses any recovered characteristic subject, scale cue, repair move, or proxy-risk row. |
| [[12_A.06.M - Module Relation Repair]] | Repairs module-interface relations before [[00_C.31 - Modularity and Reusable Structure Characteristics]] characterizes modularity. |
| [[01_C.31.RSA - Reusable Structure Accounting]] | Governs reusable-structure accounting, bespoke residue, and report-only shares. |
| [[02_C.31.ASAP - Architecture Scale-Amenability Preference]] | Governs architecture scale-preference claims after [[00_C.31 - Modularity and Reusable Structure Characteristics]] names the scale-sensitive characteristic, scale variable or window, and repair direction. |
| [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | Govern characteristic, scale, coordinate, score, unit, comparability, and measurement legality. |
| [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] | Governs broader quality-family Q-Bundles when modularity is used in a quality claim. |
| [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] and [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] | Govern architecture claims and structural views that supply [[00_C.31 - Modularity and Reusable Structure Characteristics]] subjects. |
| [[06_C.30.ILC - Cross-Scope Architecture Residual Triage]] | Governs cross-scope residual and frustration recognition when architecture move triage is being made. |
| [[00_C.29 - Mathematical Lens Use]] | Governs mathematical-lens use such as compression, RG, epiplexity, or graph-lens transfer. |
| [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[01_C.18.01 - Scaling-Law Lens Binding (SLL)]], [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] | Govern temporal and set-dynamic claims such as learning transfer, exception slope, and scale-window movement. |
| [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] | Governs causal-use claims. |
| [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] | Govern evidence, assurance, gate, safety, and release claims. |
| [[00_G.02 - SoTA Harvester & Synthesis]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]] | Govern SoTA basis, set-return selection, and local decision claims. Candidate-generation or architecture-synthesis claims stay outside [[00_C.31 - Modularity and Reusable Structure Characteristics]] unless [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]], or a named architecture-synthesis governing pattern governs that claim; [[00_C.31 - Modularity and Reusable Structure Characteristics]] records only modularity or reusable-structure characteristic use and report-only boundaries. |

## [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]]:End
