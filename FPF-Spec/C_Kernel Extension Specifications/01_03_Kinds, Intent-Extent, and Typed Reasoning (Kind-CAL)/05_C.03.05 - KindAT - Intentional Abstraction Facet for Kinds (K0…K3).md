...
**Placement.** Part C (Kinds), identifier **[[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]**. Audience: engineering managers, architects, editors, assurance leads.

**Depends on.**
— **[[01_C.03.01 - U.Kind & SubkindOf (Core)|C.3.1]]** (`U.Kind`, `U.SubkindOf (⊑)`), **[[02_C.03.02 - KindSignature (+F) & Extension-MemberOf|C.3.2]]** (`KindSignature` + F, `Extension/MemberOf`), **[[03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]** (KindBridge + `CL^k`), **[[04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]]** (RoleMask).
— **[[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] USM** (Claim/Work scope over `U.ContextSlice`), **[[03_C.02.02 - Reliability R in the F-G-R triad|C.2.2]] F–G–R**, **[[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] U.Formality (F)**.
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:1 - Purpose (manager’s view)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2 - Context & Rationale

### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.1 - The orthogonality we preserve

* **G (Claim scope)** is **where** a claim holds ([[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]).
* **Kinds** give **what** a claim is about ([[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]].1/3.2).
* **R** is assurance (evidence, freshness, penalties).
* **F** is expression rigor ([[05_C.02.03 - Unified Formality Characteristic F|C.2.3]]).
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.2 - Why a facet, not a Characteristic
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:2.3 - Design choice recap (moved from [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]] §15.2)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3 - **Anchors K0…K3** (informative)
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.1 - **K0 — Instance‑level**
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.2 - **K1 — Behavioral Pattern**
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.3 - **K2 — Formal Kind/Class**
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:3.4 - **K3 — Up‑to‑Iso**
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:4 - Manager Heuristics (informative)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:5 - Misuse & Antidotes (informative)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:6 - **Usage Rules (normative)**
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7 - Authoring & Review Guidance (informative)

### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.1 - How to tag (fast rubric)
...
### [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:7.2 - Review checklist (5 minutes)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:8 - Integration Notes (informative)

* **With [[00_C.03 - Kinds, Intent-Extent, and Typed Reasoning (Kind-CAL)|C.3]].1/3.2 (Kinds, Signature, Extension).** AT guides *how* to evolve signature **F** and *what* R coverage is sensible; it **does not** change membership semantics.
* **With [[03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] (KindBridge).** AT hints at likely **bridge style** (instance‑map / pattern‑map / type‑map / up‑to‑iso), but **`CL^k`** is still computed from signature/order preservation; penalties route to **R**.
* **With [[04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]] (RoleMask).** Persistent K1‑style masks often warrant **promotion to K2 subkinds**.
* **With [[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] (USM).** All scope decisions remain under **G**. AT text should never be used to infer coverage.
* **With [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] (F).** AT does not raise/lower **F**; it **suggests** where raising F is cost‑effective.

## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:9 - Worked Mini‑Examples (informative)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:10 - Conformance Checklist (normative)
...
## [[05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]]:End
