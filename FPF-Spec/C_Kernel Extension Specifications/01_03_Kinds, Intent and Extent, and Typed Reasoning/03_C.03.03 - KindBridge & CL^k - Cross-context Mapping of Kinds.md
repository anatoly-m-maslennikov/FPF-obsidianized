...
**Status.** Normative in **Part C**. Identifier **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]**.
**Audience.** Engineering managers, architects, assurance leads, editors.

**Depends on.**

* **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/01_C.03.01 - U.Kind and U.SubkindOf Core|C.3.1]] — U.Kind & SubkindOf (Core):** kinds are context-local `U.Kind` records; `⊑` is a partial order; kinds **do not carry Scope**.
* **[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - KindSignature (+F) & Extension-MemberOf|C.3.2]] — KindSignature (+F) & Extension/MemberOf:** signature declares its own **F**; membership `MemberOf(e,k,slice)` is **deterministic** per `U.ContextSlice`.
* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] — USM (Context slices & Scopes):** Claim scope (**G**) and Work scope live on claims/capabilities; scope bridging and **CL** penalties are defined there.
* **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/03_C.02.02 - Reliability R in the F-G-R triad|C.2.2]] — F–G–R:** weakest‑link; penalties land in **R**, not **F/G**.
* **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]] — U.Formality (F):** signature rigor.
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:1 - Purpose & Audience
...
**[[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]** gives managers an explicit, auditable channel for **(2)**, so a team can say, with evidence: *“`Vehicle` in Lab maps to `TransportUnit` in Plant with `CL^k=2`; the EV subkind collapses; here’s what we lost.”* Guards stay deterministic; assurance math stays clean (penalties in **R** only).

## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:2 - Context
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:3 - Problem
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:4 - Forces
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:5 - Solution — The **KindBridge** object (overview)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6 - Norms & Invariants (normative)

> The following formalize the **KB‑01…KB‑12** rules announced in [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning|C.3]].

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.1 - Subject & Scope of a KindBridge
...
**KB‑02 (No Scope).** A KindBridge **MUST NOT** map Claim/Work scope (**G**). Scope translation uses the **USM Bridge + CL** channel ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]], Part B).

**No blended score.** Congruence for Scope (**CL**) and for Kind (**CL^k**) **MUST NOT** be aggregated into a single “interoperability” score in guards; each channel is assessed and penalized **separately**. See **Annex [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]] §5 (E‑06)**.

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.2 - Declaration & Shape
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.3 - Order & Monotonicity
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.4 - Congruence & Assurance

**KB‑08 (Anchor reuse & AT neutrality).** **`CL^k`** reuses the **ordinal anchor semantics** of CL (Part B) but applies **to kinds**. Editors **SHALL** label it explicitly as **kind‑congruence** to avoid confusion with Scope CL. **KindBridge records MUST NOT compute or alter KindAT ([[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/05_C.03.05 - KindAT - Intentional Abstraction Facet for Kinds (K0…K3)|C.3.5]] AT‑04); AT is editorial and independent of `CL^k`.**
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:6.5 - Loss Notes & Definedness
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7 - Interactions (informative)

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7.1 - With USM Scope bridges (two channels)
...
**Discipline:** compute both; **do not** collapse them into one “interoperability score.”
 ...
 See **Annex [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]] §5 (E‑01)** for the normative evaluation order in guards.

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7.2 - With membership ([[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/02_C.03.02 - KindSignature (+F) & Extension-MemberOf|C.3.2]])
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7.3 - With Role masks ([[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/04_C.03.04 - RoleMask - Contextual Adaptation of Kinds (without cloning)|C.3.4]])
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:7.4 - With guards (Annex [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]])

Use the **`Guard_XContext_Typed`** macro (Annex [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/06_C.03.A - Typed Guard Macros for Kinds + USM (Annex)|C.3.A]]), which requires **both bridges** and applies **both penalties** to **R**:
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:8 - Authoring, Review & Rating Guidance (informative)

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:8.1 - Authoring a KindBridge
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:8.2 - Review playbook (10 minutes)
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:8.3 - Rating `CL^k` (rules of thumb)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:9 - Worked Examples (informative)

### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:9.1 - Vehicle → TransportUnit (manufacturing)
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:9.2 - AuthenticatedRequest across services (software)
...
### [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:9.3 - AdultPatient across jurisdictions (clinical)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:10 - Anti‑patterns & Remedies (informative)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:11 - Conformance Checklist (normative)
...
## [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]:End
