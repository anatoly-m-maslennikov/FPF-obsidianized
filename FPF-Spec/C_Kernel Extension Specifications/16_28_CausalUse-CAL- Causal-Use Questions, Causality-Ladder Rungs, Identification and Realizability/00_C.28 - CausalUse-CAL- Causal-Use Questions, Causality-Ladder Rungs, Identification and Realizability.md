...
related:
  ...
  - "[[04_A.02.04 - U.EvidenceRole|A.2.4]]"
  - "[[00_A.06 - Signature Stack & Boundary Discipline|A.6]]"
  - "[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]"
  - "[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]"
  ...
  - "[[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]]"
  ...
  - "[[00_D.05 - Bias-Audit & Ethical Assurance|D.5]]"
...
**Not a physical ontology.** [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs how FPF authors, reviewers, and operators use causal models, evidence, and counterfactual reasoning in records, policy claims, fairness claims, method comparisons, and work plans. It does not define physical causality in general and does not replace local domain science.

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0 - Use This When

Use [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] when a claim is being used causally:
...
Use [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] especially when the claim must distinguish:
...
**Not this pattern when.** If no causal use is claimed, keep the work in the neighboring pattern: [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for measurement, [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal trend or rate-change adequacy, [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance result, [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence graph reference, [[00_G.09 - Parity and Benchmark Harness|G.9]] for ordinary parity, [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] for local choice, [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] for pool policy, [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] for call planning, or [[00_C.26 - Quantum-Like Modeling Lens|C.26]] for a surviving quantum-like modeling cue after ordinary causal explanations have been tried.

**Activation boundary.** [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates at `CausalUseActivation`: causal wording changes what the claim makes admissible for publication, choice, deployment, assurance, audit, benchmark, or support treatment. The trigger is admissible downstream use, not the presence of a causal-looking word. If the wording is only exploratory prose and no causal use governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] is made, rewrite to association, trend, measurement, or simulation-only wording and stop.

Exploratory causal-looking prose is not a `CausalUseActivation` by itself. A note may say that a relation is plausible, worth probing, or suggested by traces and still remain in [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or [[00_G.09 - Parity and Benchmark Harness|G.9]] until the text makes a causal use governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] admissible. The moment the text makes publication, choice, deployment, assurance, audit, benchmark, or support treatment depend on causal support, [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs the causal-use boundary.

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.1 - What Goes Wrong If Missed

A causal-looking phrase backed only by association, proxy, simulation-only, or rhetorical support gets promoted into a causal use that requires a named [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis and verdict.
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.2 - What This Buys

[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] gives FPF one cheap first stop for causal use.
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.3 - First-Minute Questions

[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] in 60 seconds is the operational entry into `CausalUseTriageRecord`:
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:0.4 - First Output
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:1 - Problem Frame
...
[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] exists because causal use cuts across those neighbors. The same sentence can be:

- a measurement description handled by [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]];
- a temporal trend handled by [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]];
- an assurance claim handled by [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]];
- an evidence graph reference handled by [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]];
- a decision record handled by [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]];
- a pool-policy record handled by [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]];
- a call-planning record handled by [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]];
- a fairness audit handled by [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]];
- a parity report handled by [[00_G.09 - Parity and Benchmark Harness|G.9]];
- a quantum-like residual handled by [[00_C.26 - Quantum-Like Modeling Lens|C.26]];
- or a causal-use claim governed here.

The first pattern task is therefore not to classify wording for its own sake. It is to recover the live causal question, the target causality-ladder rung, the support basis currently available, and the cheapest truthful next move. Sometimes that move is to downgrade the claim to association, temporal change, metric-only fairness, or simulation-only use. Sometimes it is to open identification, realizability, evidence-design, fairness, policy-evaluation, or benchmark-parity work. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] exists to keep those moves distinct and to stop teams from acting as if an identification, realizability, or intervention-support basis had already been earned.

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:2 - Problem
...
[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] prevents those collapses by making rung, support, and use explicit before claims requiring higher causal support are admitted.

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:3 - Forces
...
| Domain plurality vs one FPF pattern | SCM/PCH, potential outcomes, target-trial emulation, causal ML, transportability, causal representation learning, causal RL, and causal fairness must all remain recognizable without making [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] a one-school vocabulary. |
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4 - Solution
...
| Assurance consequence | `CausalUseSupportVerdict` as causal-use action grammar | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] degrade/block/abstain consequences for `F-G-R/CL` assurance | Let assurance prose certify causal identification, realizability, or fairness |
| Fairness, policy, and parity specialization | Causal-use question/rung/estimand/support basis/support verdict for fairness, policy, and causal method comparison | [[00_D.05 - Bias-Audit & Ethical Assurance]] ethical/fairness audit card, [[00_C.11 - Decision Theory (Decsn-CAL)]] choice result, [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]] pool policy, [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] call plan, [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] method dispatch spec, [[00_G.09 - Parity and Benchmark Harness]] parity report with local refs to consumed [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] support | Collapse metric disparity, policy replay, method dispatch, or benchmark score into a causal-use verdict |

A neighbor may quote the [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] values it consumes for by-value readability. Quoting the values does not transfer governing authority. A neighbor pattern governs only its local record and must cite [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] when the causal-use question or causal-support basis is live.
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.1 - Causality-Ladder Rung
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.1a - Causal-Use Claim Kind
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.2 - Causal-Use Cards
...
The durable card is not the default. It is the record used when a causal note without the required [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] support basis would be unsafe.

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.3 - Causal Evidence Support Basis
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.4 - Identification Profile
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.5 - Counterfactual Sampling Realizability Profile
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.6 - Applied Causal-Inference Profiles
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.7 - Causal Graph Representation Names
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.8 - Causal Use Evidence Design
...
This record does not replace [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]. It gives them causal-use structure.
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.9 - Verdicts
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.10 - Causal Action Policy Class
...
This distinction matters for [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], and [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]]; it does not make those patterns the authority for causal evidence, identification, or realizability.

`CausalActionPolicyClass` is a classification value for policy-use class: natural behavior, interventional action, counterfactual policy, mixed policy, or unknown policy. It is not the policy object, not `U.Policy`, not [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] pool policy, and not the executable policy used by an agent.

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.10a - Local `U.*` Docking
...
| --- | --- |
| "causal evidence" | name `CausalEvidenceSupportBasis`, [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] evidence path refs, `CausalUseSupportRecordRef`, and `CausalUseSupportStatement` / `CausalUseUnsupportedStatement` |
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.11 - Neighbor Routing Table

| If the issue under repair is... | Use... | [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] role |
| --- | --- | --- |
| measured value, score, scale, indicator, or metric definition | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] | Only active when the measure is used causally. |
| temporal trend, rate, acceleration, inertia, or rhythm wording | [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] | Active when temporal wording is used as causal effect or intervention evidence. |
| evidence graph reference or provenance | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] | Carries evidence/provenance path and [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] support-basis refs, not causal-use support authority. |
| assurance level, degrade, abstain, or trust or assurance result | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] | Consumes [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] support verdicts and applies assurance consequences. |
| local decision among options | [[00_C.11 - Decision Theory (Decsn-CAL)]] | Provides causal action-policy hooks when value/regret/optimality depends on causal rung. |
| exploration/exploitation over live pools | [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]] | Provides causal data-collection or causal policy-learning hooks when live. |
| tool/call/enactment plan | [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] | Provides optional causal action use spec when the call selects observation, intervention, counterfactual-rung evidence collection, or counterfactual policy conditioning. |
| bias and fairness audit | [[00_D.05 - Bias-Audit & Ethical Assurance]] | Provides causal fairness rung and supported fairness use. |
| method dispatch or selector-facing registry | [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] | Provides causal method/policy class declarations when causal methods are compared. |
| benchmark or method parity | [[00_G.09 - Parity and Benchmark Harness]] | Provides causal method rung parity. |
| quantum-like modeling cue | [[00_C.26 - Quantum-Like Modeling Lens]] | Receives only the residual QL cue after causal-use explanation has been tried. |

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.12 - Non-Goals

[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] does not:
...
- replace [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] measurement and metrics characterization, including metric construction, calibration, and non-causal score interpretation;
- replace [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence graph referring, provenance paths, evidence-role carriers, or evidence graph path discipline;
- replace [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] trust and assurance calculus, assurance tuples, `F-G-R/CL` consequences, or assurance publication use;
- replace [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] bias audit and ethical assurance, causal-fairness audit responsibility, or human/group-impact review;
- replace [[00_G.09 - Parity and Benchmark Harness|G.9]] parity benchmark harness, causal-rung parity screen, or benchmark report structure;
- replace [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] choice, [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] exploration/exploitation policy, or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] call-planning patterns; it only supplies causal-use support boundaries consumed by those patterns.

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.13 - Cheap Downgrade Library
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.14 - CausalUseBureaucracySniffTest
...
| Did it block a concrete causal overclaim by naming the causal use governed by [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] as unsupported? | Use association, trend, simulation-only, or metric-only wording and stop. |
...
### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.15 - PublicationUnit Stability Relation

When the live problem is only local wording pressure inside one `PublicationUnit`, local lexical-head repair under [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]], whole-unit primary entity-of-concern stabilization under [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]], relational precision restoration, explanation faithfulness, or conservative retextualization, apply the governing publication-side FPF pattern rather than [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] opens at `CausalUseActivation`, when the wording makes publication, choice, deployment, assurance, audit, fairness, policy, or benchmark use depend on causal support.

### [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:4.16 - Causal-Laundering Golden Cases

| Case | Expected [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] output |
| --- | --- |
...
| Cross-rung benchmark: "method A beats method B as a causal method." | claim kind = `causalBenchmarkParityClaim`; use [[00_G.09 - Parity and Benchmark Harness]] `CausalRungParityScreen`; supported use = within-rung parity or declared bridge and loss; unsupported use = one scalar causal winner when rungs/support bases differ. |
| Temporal-cause wording: "after launch, recovery got faster, so launch caused resilience." | supported use = [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] temporal/rate adequacy; unsupported use = causal-effect claim until [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] names intervention timing, outcome window, assumptions, rival causes, and support basis. |
| QL escape: "ordinary probability is hard here, so the effect is quantum-like." | supported use = causal-use triage and ordinary-neighbor explanation first; unsupported use = bypassing [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] with quantum-like vocabulary; [[00_C.26 - Quantum-Like Modeling Lens]] is retained only for residual quantum-like probe, frame, order, export, or coarsening issue. |
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:5 - Archetypal Grounding
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:8 - Common Anti-Patterns and How to Avoid Them
...
| QL escape | Causal confusion is rebranded as quantum-like because ordinary probability feels hard. | Use [[00_C.26 - Quantum-Like Modeling Lens]] only after causal-use explanation and ordinary FPF neighbors have done their work. |

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:9 - Consequences

[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] makes causal use slower only when the claim commitment, consequence risk, or evidence demand warrants it. Cheap causal triage remains cheap.
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:10 - Rationale
...
[[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] therefore uses a semantic-authority split:

- [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs causal-use question, rung, estimand, identification, realizability, causal evidence support basis, and causal-use verdict.
- Neighbor patterns keep their own authority and cite [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] only when causal use is live.
- [[00_C.26 - Quantum-Like Modeling Lens|C.26]] receives a causal exit: intervention, causal effect, causal fairness, causal policy, and counterfactual-rung-data realizability are ordinary causal-use questions before they are quantum-like modeling questions.
...
## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:11 - SoTA-Echoing
...
| Causal fairness is not only metric choice. | Fairness claims must declare causal rung, path/estimand where live, and supported fairness use. | Plecko and Bareinboim: [Fairness-Accuracy Trade-Offs: A Causal Perspective](https://causalai.net/r107.pdf). | Adopted through [[00_D.05 - Bias-Audit & Ethical Assurance]] relation and `CausalFairnessUseAuditCard`. |

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:12 - Relations

- [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] governs measurement and metrics. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates only when a measurement is used causally.
- [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] governs temporal claim adequacy. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] activates when temporal change is used as causal effect, intervention evidence, or counterfactual comparison.
- [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] governs evidence graph referring. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal evidence support basis and causal-use support refs for evidence paths.
- [[04_A.02.04 - U.EvidenceRole|A.2.4]] governs evidence roles. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] requires the evidence-role distinctions that keep `simulationOnlyCounterfactualOutputBasis`, `identifiedCounterfactualEstimateSupportBasis`, interventional evidence, and `realizedCounterfactualSampleSupportBasis` from being confused.
- [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] / [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] / [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] govern boundary, deontic, promise, commitment, utterance, contract-language, and L/A/D/E-classified claim language. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies only causal-use support when mixed boundary sentences claim causal effect or counterfactual support.
- [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] governs role, method, plan, and work alignment. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies the causal-use semantics for intervention assignment, target-trial emulation, counterfactual sampling work, and causal evidence collection.
- [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] governs trust and assurance. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies the causal-use verdict that [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] can degrade, bound, or abstain over.
- [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] governs decision theory. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal-use question and causal action-policy class when value, utility, regret, or optimality depends on causal rung.
- [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] governs explore/exploit pool policy. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal rung and policy/regime fields when exploration collects causal data or learns causal policy.
- [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] governs agentic tool use and call planning. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies `causalActionUseSpec` when calls select observation, intervention, counterfactual-rung evidence collection, or counterfactual policy conditioning.
- [[00_D.05 - Bias-Audit & Ethical Assurance|D.5]] governs bias audit and ethical assurance. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal fairness rung, estimand, support, and supported fairness use.
- [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] governs method dispatch and MethodFamily registry. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal method or policy class declarations when method dispatch compares causal methods.
- [[00_G.09 - Parity and Benchmark Harness|G.9]] governs parity and benchmarks. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal method rung parity.
- [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] governs refresh orchestration. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] supplies causal-use support records whose realizability, identification, fairness, representation, off-policy, target-trial, and simulation-validation shifts can trigger refresh.
- [[00_C.26 - Quantum-Like Modeling Lens|C.26]] governs quantum-like modeling. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] is a required causal exit before QL retention when the question under repair is intervention, causal effect, causal fairness, causal policy, counterfactual comparison, or counterfactual-rung-data realizability.

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:13 - Footer Marker

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:12a - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> [[00_C.29 - Mathematical Lens Use|C.29]] may document that a mathematical mapping appears abstraction-like, quotient-like, coarse-graining-like, simulation-like, or macro-model-like. It does not decide causal-use support. When the supported use includes intervention, policy, counterfactual, causal explanation, or causal decision, apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]; otherwise record `CausalUseDisposition = noCausalUseClaim` or `causalUseBlocked`.

## [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]]:End
