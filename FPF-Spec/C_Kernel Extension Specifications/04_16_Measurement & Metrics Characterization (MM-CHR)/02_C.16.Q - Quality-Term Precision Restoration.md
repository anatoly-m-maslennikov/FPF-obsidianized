...
This pattern lives in the [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] characterization pattern nest. It rewrites bare evaluative prose either into one explicit endpoint-pattern-governed evaluative form or, when endpoint selection is still being stabilized, into one explicit transitional quality-term repair form with a declared sense family, admissible normal form (`SignalPack | Characteristic | Bundle | Objective`), reference-plane accountability, and lexical guardrails.

It allows philosophical, neuro-symbolic, control-theoretic, engineering, and open-ended-search uses to coexist without false identity by label. It does not treat quality-term or evaluative characterization as relation construction by default. When the found problem is relation construction, bridge, basedness, action-invitation relation, endpoint mismatch, or another relation-shaped claim, use [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] or the relation named by value specialization.

**Placement.**
Part C > [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] characterization pattern nest > precision-restoration pattern for overloaded quality and evaluative-characterization wording.

**Builds on.**
[[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]].

**Coordinates with.**
[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] for relation-construction exits; [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] for action-invitation exits; [[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] for language-state chart positions, admissible moves, early cue handling, responsibility handoff, and admissible retreat when an evaluative publication must be reopened; [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]] when the admissible continuation is still an open explanatory probe rather than a stable endpoint characterization; [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]] for articulation, closure, anchoring, and representation-factor facets referenced but not governed here; [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[03_E.17 - Multi-View Publication Kit|E.17]], and [[00_E.18 - Transformation Flow Structure|E.18]] for viewpoint publication; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence and assurance; [[05_A.19.CN - CN-frame (comparability & normalization)|A.19.CN]] for comparability governance; [[01_F.09.01 - Bridge Stance Overlay|F.9.1]] for bridge-stance annotations; [[03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] for explicit kind-bridge repair when endpoint kind mismatches appear.

**[[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] governing-pattern relation.**
When [[00_E.10 - Unified Lexical Rules for FPF|E.10]] encounters `quality`, `good`, `fit`, `high-quality`, `quality metric`, `quality score`, `quality characteristic`, `quality requirement`, `model quality`, `architecture quality`, `solution quality`, or evaluative `-ility` wording whose quality sense, bearer, evaluation frame, endpoint normal form, or governing pattern is hidden, [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] assigns the repair to [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] only until those values are recovered or the claim being made exits to [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[00_C.29 - Mathematical Lens Use|C.29]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], or another pattern governing the recovered claim. [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] does not keep evidence, assurance, gate, decision, work, release, relation, action-invitation, mathematical-lens, source-use, or publication invariants after that exit is recoverable.
...
It also does not assert that every trigger use of "quality" is admissibly repaired by the transitional quality-term repair form: where the repaired statement is primarily about an action invitation under [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], relation construction under [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], or a requirement or commitment over explicit heads, the admissible move is to exit to the pattern governing the recovered claim rather than assigning a quality-term or evaluative characterization.

## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:0 - Use this when
...
- If the issue under repair is hidden characteristic, scale, score, metric, coordinate, threshold, or comparison construction, use [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]] first.
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:1 - Problem frame
...
* **Plane confusion.** Quality of the EntityOfConcern being described, quality of the description, quality of the carrier, and quality of the publication face are silently collapsed across `ReferencePlane` values and [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] lanes.
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:2 - Problem
...
* ecological affordance discourse, including source-tradition `affordance` cases that must leave quality-term restoration for [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] or another action-invitation governing pattern?

## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:3 - Forces
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4 - Solution

**Stable repair frame > Sense Family > Slots > Normal Form > Change Lexicon > Guardrails**

### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.0 - Trigger rule

A use of **quality** is in scope for [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] when any of the following holds:
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.0a - Operational repair sequence

When the trigger fires, follow the [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] recovery order specialized to quality-term or evaluative characterization:
...
4. **Exit when the claim being made is not quality-term or evaluative characterization.**
   If the occurrence is primarily action invitation, relation construction, bridge, basedness, endpoint mismatch, evidence, assurance, gate, work, decision, causal-use, release, mathematical-lens use, characteristic and scale construction, or source-use, do not assign a `QualitySense`. Apply [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[00_C.29 - Mathematical Lens Use|C.29]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], or the pattern governing the recovered claim.
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1 - Transitional repair frame: evaluative classification anchored by `qualityTermAscription(...)`

[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] stabilizes the ambiguity cluster by treating every in-scope quality statement as explicit evaluative content that must name the endpoint governing pattern or publication with named authority-reference relation that carries it, not as a bare adjective.
...
Entry into [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] presupposes enough articulation explicitness to name the bearer, evaluation frame, and at least one candidate evaluative family. Closure degree may remain low while `qualityTermAscription(...)` is serving as a transitional repair form, but if the content is still only a cue pack, forwarded cue, or open explanatory probe, keep it in [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], or [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]] rather than publishing it here prematurely. If a previously published evaluative record later loses the evidence, witness, or authority-reference relation needed to keep even that transitional status live, retreat via [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]].
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1b - Polarity discipline (bearer-centred; no silent inverse)
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.1c - Endpoint-first discipline
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.2 - Core construct: `QualitySense`
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.4 - Required slots for a conforming `qualityTermAscription`
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.5 - Normal-form discipline
...
This uses **[[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]], and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]** and inherits full scale legality.
...
**Engineering note.**
For engineering `-ility` families, the preferred bundle endpoint is **`Q-Bundle`** ([[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]), because it keeps **Measures[CHR]** distinct from **ClaimScope and WorkScope** and from **Mechanisms and Status**.
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.6 - Functional vs quality-family discipline

[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] SHALL prevent the collapse of **function or capability** claims into **quality-family** claims.

* A statement about **what a system does** uses [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] first when function-like wording hides the FPF kind named by value, relation, or claim, then the pattern governing the recovered capability, method, work, role, [[12_A.06.M - Module Relation Repair|A.6.M]] module-interface, architecture, mathematical, evidence, assurance, gate, decision, or release claim whose primary `EntityOfConcern`, bearer, relation record, or characteristic-space construction is recovered.
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.7 - Bridge discipline across traditions
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.8 - Change lexicon

A conforming quality-term repair publication SHALL narrate changes with a stable change lexicon aligned to [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:
...
**[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] rewrite note.**
`retargetBearer(...)` is the family-specific form of `retargetParticipant(BearerSlot, …)`.
`reviseSense(...)`, `reArticulate(...)`, `reProxy(...)`, `reBundle(...)`, `reScale(...)`, `reFrame(...)`, and `reView(...)` are family-specific refinements of `reviseByValue(...)` and SHALL preserve the [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] distinction between ref retargeting and by-value edits.

### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.8a - [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] boundary classification template for quality-term repair
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.9 - Lexical guardrails
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:4.10 - Progressive elaboration

[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] permits monotone elaboration:
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5 - Archetypal Grounding

### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.1 - Tell
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.2 - Show (System lane)
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.3 - Show (Episteme lane)
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.3a - Show (Architecture description lane)
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:5.4 - Show (QD or selector lane)
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:6 - Bias-Annotation
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:7 - Conformance Checklist (CC-C16Q)

A text or pattern conforms to [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] iff:
...
19. **CC-C16Q-19 - Family-specific change verbs dock cleanly with [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]].**
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:9 - Consequences
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:10 - Rationale

[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] makes one strategic move:
...
That is exactly where semantic drift usually starts; [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] turns that drift into an auditable design choice.

## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:11 - SoTA-Echoing
...
**Historical-lineage note.** Earlier touchstones such as Pirsig, Popper, and Deutsch remain useful as lineage and local-gloss resources, but [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] does not use them as formal SoTA anchors here because [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] requires post-2015 primary sources for Architectural patterns unless the row is explicitly lineage or local-gloss material.

This SoTA alignment backs the pattern’s central move: *quality* is not one universal evaluative noun. In contemporary practice, the relevant work is already distributed across explicit characteristics, objectives, viewpoints, world-model criteria, explanatory virtues, felt signals, and action invitations; [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] makes that distribution first-class and auditable.

## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:11a - Refresh and reopen conditions

Reopen or narrow [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] when any of these current-pattern-language conditions becomes live:
...
* [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], or bridge-policy vocabulary changes the admissible lane, EntityOfConcern, publication-face, carrier, or `ReferencePlane` wording used by this pattern;
...
* README, ToC, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], retrieval, or local Problem-frame first-entry cues change for quality, characteristic, action-invitation, architecture-description, selector, or explanation wording;
...
## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12 - Relations

* **Lives in:** **[[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]** characterization pattern nest as the quality-term realization of **[[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]** and **[[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]**.
* **Builds on:** **[[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]** for shared wording-use restoration architecture; **[[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]** for characteristic and scale exits; **[[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]** for explicit scope and `Γ_time`; **[[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]], and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]** for admissible measurable characteristics; **[[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]]** for engineering `Q-Bundle` publication.
* **Coordinates with:** **[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** when the recovered content is relation construction rather than quality-term or evaluative characterization; **[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]** or another action-invitation governing pattern when the trigger invites action rather than evaluates a bearer; **[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]]** for language-state chart positions, admissible moves, early cue handling, responsibility handoff, and admissible retreat or reopen; use **[[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or handoff history itself must be published as an explicit trajectory account; **[[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]** for prompt-shaped continuations that are not yet stable endpoint publication; **[[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for language-state facet governance; **[[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], and [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]]** for `QS.UseValue`, novelty and diversity discipline, and selector policy; **[[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]** and **[[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]** for architecture-description and viewpoint bundles; **[[00_F.09 - Alignment & Bridge across Contexts|F.9]]** and **[[01_F.09.01 - Bridge Stance Overlay|F.9.1]]** for Bridges, CL, and bridge-stance annotations; **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** when repaired ascriptions become boundary-bearing.
* **Publishes vocabulary through:** **[[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_F.17 - Unified Term Sheet (UTS)|F.17]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]]** when the `qualityTermAscription` repair-form skeleton, the `QualitySense` starter set, and the red-flag rewrites become stable shared vocabulary.

### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.1 - Language-space refactor note
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.2 - Explicit endpoint selection
Admissible endpoints after repair include:
- a single `Characteristic`,
- a `Q-Bundle`,
- an `E.21 PatternQualityQBundle`, when the bearer is one FPF pattern version and the evaluative claim asks whether the pattern is good enough for a declared reader, use, and scope. In this case, do not assign the claim to general [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] unless the bearer is a non-pattern engineering quality family,
- an `Objective`,
...
### [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:12.3 - Endpoint-governance boundary
This pattern does not govern articulation-state characteristics, bridge stances, or representation factors. Those remain governed by [[00_A.16 - Language-State Move Coordination|A.16]], [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]], and [[01_F.09.01 - Bridge Stance Overlay|F.9.1]].

## [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]:End
