...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:1 - Problem frame
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:2 - Problem
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:3 - Forces
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:4 - Solution

The FPF ecosystem is formally stratified into three canonical **FPF ecosystem families**. Each family has a distinct purpose and is governed by different rules, ensuring a clear separation of concerns. The interaction between these families is governed by the **Unidirectional Dependency Principle** (see Guard-Rail [[03_E.05.03 - Unidirectional Dependency|E.5.3]]).
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:5 - Archetypal Grounding (System / Episteme)
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:6 - Conformance Checklist
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:7 - Consequences
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:8 - Rationale
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:9 - Relations

*   **Instantiates:** **P-5 (FPF Layering)** at a macro-level.
*   **Is Constrained by:** **[[03_E.05.03 - Unidirectional Dependency|E.5.3]] (Unidirectional Dependency)**.
...
## [[00_E.04 - FPF Ecosystem Family Architecture|E.4]]:End
