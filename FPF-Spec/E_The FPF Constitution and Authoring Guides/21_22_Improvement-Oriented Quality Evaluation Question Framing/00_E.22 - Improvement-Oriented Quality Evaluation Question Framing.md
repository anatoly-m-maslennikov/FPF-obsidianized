...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:1 - Problem frame

Use [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] when someone is about to ask for a quality evaluation, quality review, returned-finding absorption, improvement proposal, or next-move hypothesis over an object version named by value, and the question needs to say what kind of evaluation is wanted before the evaluator starts.

[[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] frames the question. It does not evaluate the object. The values, coordinates, statuses, and stop meanings come from the named object-under-improvement evaluation: for example [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] for one pattern version, [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] for one `DRR`, [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] for an FPF-level object, [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] for an engineering quality bundle, or another declared characteristic space, scale set, rubric, or review profile. [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] is different: it supplies an admission or refresh review gate and findings profile. Use [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] as the object-under-improvement evaluation only when the object being evaluated is an [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] review-profile result itself. For one FPF pattern version, [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] supplies the coordinate values and `PatternQualityStatus`; [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] may later check that the [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] result is valid, sufficient for the release seam, and not overread as project evidence, release, gate, assurance, or work.

Not this pattern when the question is already scoped and one direct evaluation is enough. Run the object-under-improvement evaluation directly. Use [[00_E.23 - Quality Improvement Loop Method|E.23]] when repeated improvement across passes is needed.
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:2 - Problem
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:3 - Forces
...
| Multi-coordinate gain vs Goodhart risk | Raising one visible value can damage usability, affordability, locality, source preservation, or corpus ecology; use [[00_E.13 - Pragmatic Utility and Value Alignment]] when the visible value or metric is being treated as the intended value itself. |
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4 - Solution

[[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] gives one compact declaration for improvement-oriented quality evaluation questions. It keeps the question from replacing the evaluation and keeps the evaluation result from becoming a decision or work product beyond its authority.

### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.1 - Local names and kind settlement
...
| `ExpectedQualityEvaluationResultForm` | The result-row shape required by the named evaluation, including coordinate/value/short-rationale rows, mandatory attention-discharge profiles such as [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] `PrecisionRestorationProfile`, and any evidence-locus or coordinate-specific payload fields. For [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]], this profile collapses word/head/use, phrase-apparatus, repetition/distribution, role-carrier, and pattern-application layers into affected-coordinate effects. |
...
### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.2 - Quality evaluation purposes
...
### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.3 - Question frame
...
### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.4 - Finding and proposal rows
...
### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.5 - Absorption impact values
...
### [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:4.6 - OEE/NQD and proposal portfolios

When the object is a candidate, archive/front member, selected set, parity report, refresh report, or declared transformation result, [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] can frame the quality question and return proposal rows. [[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.09 - Parity and Benchmark Harness|G.9]], and [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] keep authority over candidate characteristics, archive/front semantics, pool policy, selected-set publication, parity, and refresh.

## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:5 - Worked slices

**Floor evaluation.** A reviewer is asked whether one pattern is ready for ordinary use. The frame names [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], purpose `floorEvaluation`, the declared floor, and the expected [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] result form. The result is a complete [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] coordinate table with `ShortRationale` and `EvaluationEvidenceBasis`, not a narrative "looks fine."
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:6 - Bias annotation
...
The bias is bounded. [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] does not supply quality values, run repeated improvement, publish selected sets, decide work, or certify project claims.

## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:7 - Conformance checklist
...
| `CC-E22-9` | Name the expected evidence basis and result-row shape from the object-under-improvement evaluation; [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] cannot authorize omitted coordinates, missing rationales, missing mandatory attention-discharge profiles, missing `PrecisionRestorationProfile` when [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] is used, unchecked loci, inactive/triggered-coordinate shortcuts, scope narrowing, or a weaker result form. |

## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:8 - Common anti-patterns and repairs
...
| **Goodharted improvement.** Visible values rise while protected qualities worsen, or a `5` target makes the evaluator add apparatus instead of improving content. | Frame the expected movement as a substantive content move, add trade-off protection, reject dominated changes, apply [[00_E.13 - Pragmatic Utility and Value Alignment]] when a visible value is replacing the intended value, and require checked `no proposal` dispositions when no worthwhile content move remains. |
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:9 - Consequences
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:10 - Rationale
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:11 - SoTA-Echoing
...
## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:12 - Relations

| Pattern | Relation |
|---|---|
| [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Supplies pattern-quality values and required coordinates. |
| [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] | Supplies `DRR` decision-adequacy values and required coordinates. |
| [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] | Supplies FPF Pillar-adequacy values. |
| [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]] | Supplies admission or refresh review profiles when that is the evaluation. |
| [[00_E.23 - Quality Improvement Loop Method]] | Governs repeated improvement after framed evaluations return findings or proposal rows. |
| [[00_E.13 - Pragmatic Utility and Value Alignment]] | Governs pragmatic utility and proxy-to-value alignment when framed values, visible measures, proposal counts, or all-`5` posture are being used as the intended improvement value. |

| [[00_E.10 - Unified Lexical Rules for FPF]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], [[00_F.18 - Local-First Unification Naming Protocol]] | Repair load-bearing wording and names introduced by frames or findings. |
| [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] | Govern characteristics, scales, measurements, characteristic spaces, and quality bundles. |
| [[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.09 - Parity and Benchmark Harness]], [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator]] | Govern OEE/NQD candidate, archive/front, pool, selected-set, parity, and refresh claims. |
| [[00_C.11 - Decision Theory (Decsn-CAL)]], [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] | Receive decision, call-planning, work, gate, release, evidence, and assurance claims when a quality result is reused beyond evaluation. |

## [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]:End
