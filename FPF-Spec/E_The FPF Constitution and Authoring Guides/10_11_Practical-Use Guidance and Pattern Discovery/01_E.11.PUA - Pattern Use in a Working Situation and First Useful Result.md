...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:1 - Problem frame

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:1.1 - Use this when
...
**Not this pattern when.** Use [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] while several public practical-use cards are still being compared. Use [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] when applicability, recommendation, or coordination among several candidate uses is the current question. Use [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - P2W Problem-to-Work Carry-Through|E.18.1]] when a wider method, plan, work, interpretation, and return flow depends on preservation of accepted problem-side distinctions. Use the [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] family for intended or performed work.

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4 - Solution
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.0 - Kind-preserving dependency spine
...
`TaskSignature` remains a pre-method-selection signature. It can constrain method search; it is not the task, plan, or work occurrence. OEE and NQD may retain method or architecture candidates before selection. [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]] publishes a selected set; [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] settles method identity; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] governs planning and work.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.1 - The ordinary seven-step use
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.2 - Reliance profiles
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.2.1 - Admitted support species and governing patterns
...
PUA governs the practical question, optional compact trace, candidate basis, candidate support episteme, candidate rationale, and actual-result closure. [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] governs public card comparison rationale. [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] governs fit, applicability, recommendation, coordination rationale, coordination, and ordering. These relations consume [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] SlotSpec discipline; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] does not govern their identity.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.3 - Question, boundary, and expectation
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.4 - Candidate basis under named reliance
...
CandidatePatternUseBasisRelation@Context <: U.Relation:
  ...
  directSolutionSectionRef: U.EntityRef, referencing the [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] PublicationUnit containing the direct pattern's Solution
  boundedContextRef: U.BoundedContextRef
  entityOfConcernRef: U.EntityRef
  entityOfConcernKindRef: U.KindRef
...
Candidate rationale has one candidate subject. [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] owns the coordination-rationale schema over a declared candidate set. [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] owns the public-card comparison-rationale schema over one public guidance episteme before a project candidate is constructed. No rationale episteme is a universal bag.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.5 - Actual result and receiving-use disposition
...
Candidate, expectation, actual result kind, conditional relation signature, and flow position agree. Path slice and `DesignRunTag` are both present when cross-flow provenance is asserted and both absent otherwise. A result from one flow may become an input, tool, context, or constraint in another flow without changing kind; [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] carries its new relation position, transfer or crossing relation, and the current `DesignRunTag` boundary.
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.6 - Pre-existing and not-yet-produced results
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.7 - Reliance-bearing final-practice test
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:4.8 - Replay and currentness
...
Recheck the smallest affected claim or relation when the concern, candidate basis, direct Solution, expected result, result grounding, flow position, receiving-use condition, or boundary changes. Reopen pattern selection only when that change alters candidate fit; a new measurement of the same result does not by itself select another pattern. [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] governs edition, telemetry, currentness-window, and decay orchestration; PUA supplies the use-specific values and change conditions that orchestration inspects.

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5 - Archetypal Grounding

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.1 - Episteme result: a usable problem card

A team has a vague recurring pump-failure concern and asks whether it can be articulated well enough to guide later method selection. In ordinary conversation the team says: "Use [[C_Kernel Extension Specifications/10_22_Problem Typing & TaskSignature Assignment (Problem-CHR)/02_C.22.02 - ProblemCard@Context|C.22.2]] to make the pump-failure concern into a usable problem card." It inspects [[C_Kernel Extension Specifications/10_22_Problem Typing & TaskSignature Assignment (Problem-CHR)/02_C.22.02 - ProblemCard@Context|C.22.2]], applies the Solution, obtains the card, and stops once the current question is answered.

The card's `ProblemCard@Context` kind and application-flow position remain recoverable from [[C_Kernel Extension Specifications/10_22_Problem Typing & TaskSignature Assignment (Problem-CHR)/02_C.22.02 - ProblemCard@Context|C.22.2]] when a later distinction needs them; the team need not state or record those fields during this cheap use. A durable closure or receiving-use relation is created only when the later P2W use or another named receiving use relies on replay.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.1a - Evaluation specification without a ProblemCard

An architecture team already has a bounded comparison question but no accepted `ProblemCard@Context` is needed for this use. It applies [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] and produces an `EvaluationCharacteristicSpaceSpec` with declared coordinates, scales, comparators, and evidence rules. The optional `problemCardRef` remains absent. The exact episteme is the `selectedPatternApplicationFlowResult`; when the later comparison actually uses it, the receiving-use relation records that realized use without opening P2W.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.1b - A selection result can support later planning

Pattern-selection work under [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] produces a `PatternUseRecommendation@Context`. That recommendation is a `patternSelectionFlowResult`. A later PUA use applies the recommended planning pattern and produces a `U.WorkPlan` as a separate `selectedPatternApplicationFlowResult`. [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] may relate the recommendation to the later use through an explicit crossing, but neither the recommendation nor the plan becomes the machined component expected from downstream subject work.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.1c - AI-assisted ordinary use returns the subject result

An engineer asks an AI assistant to apply an already selected [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] pattern to a pump-comparison question. The needed result is an `EvaluationCharacteristicSpaceSpec` with admitted coordinates, scales, comparators, and evidence rules. No later use asks for a durable pattern-selection trace.

The assistant returns that specification as the `selectedPatternApplicationFlowResult` and keeps the concern, pattern fit, and stop condition recoverable in the conversation. It does not add candidate, fit, applicability, rationale, or closure records merely because an AI assisted the use. If the available basis cannot support the specification, it names the unresolved coordinate, scale, comparator, or evidence-rule position, returns the use to [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]], and leaves the completed-specification expectation open. Materialize that return as `PatternUseBoundaryCondition@Context` only when a named reliance needs an addressable boundary; do not emit a complete meta-record stack.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.2 - Physical result: work is still future
...
The plan is an honest `selectedPatternApplicationFlowResult`. The component remains an expected `downstreamSubjectWorkFlowResult` until dated machining work occurs. The team may continue with the [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work patterns; it cannot fill the component result position with the plan, simulation, inspection checklist, or generated prose.
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.3 - Clinical result: a state and its note stay separate
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.3a - Learned capability and assessment remain separate

Teaching work is performed under its direct educational and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] patterns. A later assessment may support a claim that the learner has demonstrated a bounded capability or skill. The capability result and the assessment episteme keep different kinds and governing relations: a completed lesson, assessment plan, or filled assessment record cannot occupy the learned-capability result position by itself.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.4 - Pre-existing result: inspection does not reproduce it
...
### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.5 - Repair a plan-as-component closure locally
...
Repair the expectation and actual-result closure: name `U.WorkPlan` as the `selectedPatternApplicationFlowResult`, remove the claimed component actual result and any realized receiving-use relation that depended on it, and keep the component as an open downstream expectation. The next current use enters the [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work family. No new candidate selection or reconstruction of the WorkPlan is needed.

### [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:5.6 - Complete trace, absent result
...
- **Plan-as-work bias.** Intended work or a generated plan is reported as performed work. Return to [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and ground the dated occurrence before asserting `U.Work`.
- **Flow-collapse bias.** A selection result, application result, and downstream-work result are merged because each is called "result". Restore the flow-local result position and any current [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] crossing.
...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:7 - Conformance Checklist
...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Copy a result between flows | The same entity may occupy a new relation position, but its kind and provenance do not change by narration. | Use [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure]] transfer or crossing relations and keep each flow-local result position. |

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:9 - Consequences
...
**Costs.** A success claim is complete only after the result kind and stop condition are named. Reliance-bearing use adds addressable epistemes and relations. Cross-flow uses are represented through explicit [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] positions instead of one narrative chain.

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:10 - Rationale
...
## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:11 - SoTA-Echoing
...
| Current FPF [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation]], and [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator]] evidence, assurance, flow, support-episteme, and currentness practices | Keep basis, result kind, receiving use, and flow provenance addressable when another participant or system will rely on them later. | Adapt conditionally through `relianceBearing`; reject universal trace production for cheap reversible use and keep evidence, assurance, and currentness claims with their governing patterns. |
| Current FPF [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery]], [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] | Separate public discovery, one selected-pattern use, recommendation or coordination, intended work, and performed work. | Adopt as the governing ontology for those boundaries. PUA adds only the user-side use method and its dependent relations. |
...
The 2026 navigation study is a current preprint anchor rather than settled consensus. Reopen its wrong-turn and return adaptation when peer review, replication, or use evidence changes the observed value of inspection, memory, or backtracking. Reopen the `ordinaryBounded` and `relianceBearing` split when real receiving uses repeatedly lose needed distinctions or pay trace cost without later use. [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] orchestrates that evidence and currentness; PUA changes the profile boundary or exact support relations.

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:12 - Relations

- **Builds on:** [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] for public practical-use guidance, [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] for action-guiding pattern form, [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] for coupled-flow positions, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for planning and work, [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] for support epistemes, and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] for slot discipline.
- **Coordinates with:** [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] for applicability, recommendation, and coordination; [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - P2W Problem-to-Work Carry-Through|E.18.1]] for accepted problem-to-work carry-through; [[E_The FPF Constitution and Authoring Guides/21_22_Improvement-Oriented Quality Evaluation Question Framing/00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] and [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method|E.23]] for evaluation and repeated improvement; [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] for currentness orchestration; and each direct pattern that governs the selected result.
- **Returns to:** [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] when no direct pattern is yet selected, [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/02_E.11.PUR - Pattern-Use Applicability, Recommendation, and Coordination|E.11.PUR]] when recommendation or ordering among several candidate uses is current, and the exact subject pattern when the result or work claim leaves PUA's boundary.

## [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/01_E.11.PUA - Pattern Use in a Working Situation and First Useful Result|E.11.PUA]]:End
