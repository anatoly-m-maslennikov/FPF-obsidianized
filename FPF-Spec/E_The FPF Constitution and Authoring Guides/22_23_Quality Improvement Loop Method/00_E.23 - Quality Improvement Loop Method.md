...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:1 - Problem frame
...
Not this pattern when one direct quality evaluation is enough. Use [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] to frame one evaluation and then run the named object-under-improvement evaluation. Use [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] first if the needed evaluation characteristic space does not exist.
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:2 - Problem
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:3 - Forces
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:4 - Solution
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.1 - Local names and kind settlement
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.2 - Loop method
...
3. Use [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] to frame the first quality evaluation when the purpose is not already explicit.
4. Run the object-under-improvement evaluation in its required result form. For one FPF pattern version, this is an [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] result with every required coordinate, every `ShortRationale`, the `PrecisionRestorationProfile`, evidence basis, coordinate-specific payloads, and status. A loop record, profile pass, blocker summary, two-column table, or "no blockers" note is not a substitute.
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.3 - Stop, continue, and reopen
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.4 - Method-family selection
...
| `RalphLikeGeneralAdaptiveFamily` | A broadly capable agent can improve the object through repeated specification, feedback, memory, and verification under [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] cost/risk discipline. |
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.5 - Operation-family selection
...
### [[00_E.23 - Quality Improvement Loop Method|E.23]]:4.6 - Cost and BLP discipline

[[01_C.19.01 - Bitter-Lesson Preference (BLP)|C.19.1]] governs the preference for broad, scale-amenable methods when safety, legality, and practical fitness are comparable. [[00_E.23 - Quality Improvement Loop Method|E.23]] uses that preference but still evaluates end-to-end accepted-work cost:
...
For NQD/OEE, [[00_E.23 - Quality Improvement Loop Method|E.23]] can change one object version or candidate to improve declared `Q` movement. [[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.09 - Parity and Benchmark Harness|G.9]], and [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]] keep authority over novelty, diversity, descriptors, distances, archive/front insertion, pool policy, selected-set publication, parity, and refresh.

## [[00_E.23 - Quality Improvement Loop Method|E.23]]:5 - Worked slices

**Affordable floor evaluation.** A pattern needs admission readiness. [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] frames `floorEvaluation`; [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] evaluates all required coordinates. If the result is admissible and no improvement aim is requested, [[00_E.23 - Quality Improvement Loop Method|E.23]] stays closed. If an admission, refresh, landing, or release crossing is claimed, [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] and the release named by value/admission process still check the gate conditions; the [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] status is necessary quality evidence, not the gate itself.

**Pattern exceptional improvement.** A pattern already passes floor but lacks worked slices and source-currentness. [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] frames optional exceptional improvement for named coordinates. [[00_E.23 - Quality Improvement Loop Method|E.23]] searches for substantive non-dominated content moves, applies proposal rows, re-evaluates by [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], checks what became worse, and stops locally only when no worthwhile content improvement remains under the declared use. The loop may stop at `4`, but only after the missing-exceptional opportunity has been searched and discharged by value; it is not a proof-building run toward all-`5`.

**DRR improvement.** A `DRR` needs drafting adequacy for multi-locus authoring. [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] supplies coordinates; [[00_E.23 - Quality Improvement Loop Method|E.23]] applies decision repairs and re-evaluates. The improved object is still a decision record, not prewritten pattern prose.

**NQD quality-side improvement.** A generated candidate has declared `Q` components and a comparison set. [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] returns proposal rows. [[00_E.23 - Quality Improvement Loop Method|E.23]] may change the candidate and re-evaluate `Q`; archive/front insertion, selected-set publication, parity, and refresh remain under the pattern that governs each claim and are not quality-loop decisions.

## [[00_E.23 - Quality Improvement Loop Method|E.23]]:6 - Bias annotation
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:7 - Conformance checklist

| Check | Requirement |
|---|---|
| `CC-E23-1` | Name object version and object-under-improvement named by value evaluation before claiming quality movement. |
| `CC-E23-2` | Use [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] or an equivalent frame when the evaluation purpose is not already explicit. |
...
| `CC-E23-8a` | When the evaluation names a precision-restoration defect, apply the selected restoration or governing pattern named by that evaluation. For [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]], use its `PrecisionRestorationProfile` to decide whether the repair is word/head/use precision ([[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[00_F.18 - Local-First Unification Naming Protocol]]), phrase-level plain rewriting ([[00_F.19 - Ontology-First Plain Technical Rewriting]]), or a governing-pattern repair. The repair row is not closed until it includes a `KindRestorationCheck`: pre-repair kind/relation/slot-or-use-position/admissible use/scope, post-repair kind/relation/slot-or-use-position/admissible use/scope, or `not triggered`/`ordinary prose`/`already satisfied`/`blocker` disposition with loci. |
| `CC-E23-9` | Apply [[00_E.10 - Unified Lexical Rules for FPF]] to load-bearing loop names, status values, examples, stop conditions, and result wording introduced or repaired by the loop. |
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:8 - Common anti-patterns and repairs
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:9 - Consequences
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:10 - Rationale
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:11 - SoTA-Echoing
...
| Broad adaptive loops are useful but costly. | Ralph-like current technique signal, Reflexion/Self-Refine/ReAct/LATS/SWE-agent lineage. | General adaptive methods are selectable under [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] cost/risk and re-evaluation discipline. |
...
| Multi-coordinate improvement needs trade-offs. | MCDA, Pareto, ATAM, and current proxy-failure work. | Re-evaluation includes what became worse, rejects dominated changes, and applies [[00_E.13 - Pragmatic Utility and Value Alignment]] when the visible value under optimization starts replacing the intended value. |
| Measures and specifications can be gamed under optimization pressure. | Goodhart/Campbell, surrogation, specification-gaming, and reward-hacking lines. | The loop forbids all-`5` targeting, separates floor repair from substantive exceptional proposals, rejects apparatus-only proof as dominated change, and opens [[00_E.13 - Pragmatic Utility and Value Alignment]] when the loop target becomes a proxy for value. |
...
## [[00_E.23 - Quality Improvement Loop Method|E.23]]:12 - Relations

| Pattern | Relation |
|---|---|
| [[01_A.19.ECS - Evaluation CharacteristicSpace Construction]] | Constructs or repairs an object-under-improvement evaluation when none exists. |
| [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] | Frames each quality evaluation and can return finding or proposal rows. |
| [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Supplies pattern-quality values for pattern-improvement loops. |
| [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] | Supplies `DRR` decision-adequacy values for `DRR` loops. |
| [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] | Supplies FPF Pillar-adequacy values for corpus-level loops. |
| [[00_E.13 - Pragmatic Utility and Value Alignment]] | Governs pragmatic utility and proxy-to-value alignment when loop targets, quality values, metrics, or review results become substitutes for the intended value. |

| [[00_F.18 - Local-First Unification Naming Protocol]] | Supplies durable-name evaluation for naming loops. |
| [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]], [[02_C.16.Q - Quality-Term Precision Restoration]] | Govern engineering quality bundles and quality-word precision repair. |
| [[01_C.19.01 - Bitter-Lesson Preference (BLP)]] | Governs BLP and cost/risk comparison for method-family choice. |
| [[01_C.22.01 - Task-family adaptation signature]], [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] | Govern durable task-family adaptation and tool-call planning when the loop makes those claims. |
| [[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.09 - Parity and Benchmark Harness]], [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator]] | Govern OEE/NQD candidate characteristics, archive/front, pool, selected set, parity, and refresh. |
| [[00_C.11 - Decision Theory (Decsn-CAL)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] | Govern decision, evidence, assurance, work, gate, and release claims when a loop result is reused beyond quality improvement. |
| [[00_E.10 - Unified Lexical Rules for FPF]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], [[00_F.18 - Local-First Unification Naming Protocol]] | Repair load-bearing wording and names introduced by loop records. |

## [[00_E.23 - Quality Improvement Loop Method|E.23]]:End
