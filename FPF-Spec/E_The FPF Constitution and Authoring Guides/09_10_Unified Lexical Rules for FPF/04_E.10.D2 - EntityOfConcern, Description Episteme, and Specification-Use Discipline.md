...
**Builds on:** [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] **Strict Distinction (Clarity Lattice)**; [[03_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] **D.CTX (Context is U.BoundedContext)**; [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] **U.EpistemeSlotRelation**; [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] **Unified Formality Characteristic (F)**; [[00_F.15 - SCR-RSCR Harness for Unification|F.15]] **SCR/RSCR Harness**.
**Coordinates with.** [[00_F.04 - Role Description (RCS + RoleStateGraph + Checklists)|F.4]] **Role Description**; [[00_F.05 - Naming Discipline for U.Types & Roles|F.5]] **Naming Discipline**; [[00_F.12 - Service Acceptance-Work Evidence Link|F.12]] **Service Acceptance Binding**; [[00_F.09 - Alignment & Bridge across Contexts|F.9]] **Alignment & Bridge across Contexts**; [[01_F.09.01 - Bridge Stance Overlay|F.9.1]] **Bridge Stance Overlay**; [[00_F.10 - Status Families Mapping (Evidence • Standard • Requirement)|F.10]] **Status Families Mapping**.
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:1 - Problem frame
...
Not this pattern when the question under repair is already an evidence path named by value, assurance claim, gate decision, commitment, work occurrence, bridge, representation transition, source relation, or state-family field. Use the neighboring pattern governing that claim for that claim and use [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] only to keep the EntityOfConcern, Description episteme, and specification-use boundary readable.
...
What goes wrong if [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] is missed: specification-looking words become authority, a publication becomes the thing described, a file becomes the method, an approval state over an episteme becomes a runtime state, or two descriptions with the same label are treated as the same EntityOfConcern across contexts.

What [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] buys in practice: the practitioner can name the item under concern, keep the Description episteme inspectable, admit specification use only when checkability exists, and send every other claim being made to the governing FPF pattern that carries it.
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:2 - Problem
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:3 - Solution
...
5. **Exit to the neighboring pattern when another claim becomes live.** Evidence goes to evidence patterns; assurance to assurance patterns; gate decisions to gate patterns; commitments and promises to [[00_F.18 - Local-First Unification Naming Protocol|F.18]] and related patterns; work to work and P2W patterns; publication and view mechanics to E.17/A.6.3/C.2.P; retargeting to [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:4 - Core field discipline

### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:4.1 - EntityOfConcern
...
### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:4.2 - Description episteme
...
### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:4.3 - Specification-use admission
...
### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:4.4 - Publication, carrier, and work boundary
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:5 - Naming discipline
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:6 - Invariants
...
**D2-7 (No label-only cross-context sameness).** Identical labels in two bounded contexts or viewpoints do not establish sameness. Use [[00_F.09 - Alignment & Bridge across Contexts|F.9]] bridges, [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] views, or [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] retargeting as appropriate.
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:7 - Reasoning primitives
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:8 - Anti-patterns and repairs
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9 - Worked examples

### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9.1 - Role
...
### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9.2 - Method
...
### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9.3 - Architecture
...
If a structural view uses a mathematical lens, [[00_C.29 - Mathematical Lens Use|C.29]] carries the declared mathematical-lens use question. If an architecture description is used to guide work, [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] and P2W-related patterns carry the work-relevance relation.

### [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9.4 - Episteme as EntityOfConcern
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:9.5 - Source-use and SoTA-echoing
...
| FPF episteme, publication, view, carrier, and source-use machinery ([[01_C.02.01 - U.Episteme - Epistemes and their slot relation]], [[03_E.17 - Multi-View Publication Kit]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences]], [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism]], [[00_C.02.P - Epistemic Precision Restoration]]) supplies the ontology named by value. | Reuse existing episteme slots, DescriptionContext, views, publication faces/forms/units, carrier separation, source relation, bridge, and retargeting exits. | [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline]] does not mint a rival description ontology and does not replace source, evidence, bridge, work, or state-family patterns. |
| Andrey Rodin-style near-sameness and postulate-theory concerns motivate explicit same-EntityOfConcern and bridge checks across descriptions. | Same label, similar description, or shared formal substrate is not enough; use [[00_F.09 - Alignment & Bridge across Contexts]], [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]], or same-EntityOfConcern recovery by value. | [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline]] names the boundary; it does not decide all cross-context sameness or mathematical-substrate adequacy. |
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:10 - Relations

**Builds on:**

* **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] - Strict Distinction (Clarity Lattice).** Supplies the general distinction between an EntityOfConcern and the epistemes, publications, carriers, work, decisions, evidence, and assurance claims around it.
* **[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] - U.EpistemeSlotRelation.** Supplies `DescriptionContext`, `subjectRef`, and episteme slot discipline.
* **[[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] - Unified Formality Characteristic.** Supplies formality levels used by specification-use admission.
* **[[00_F.15 - SCR-RSCR Harness for Unification|F.15]] - SCR/RSCR Harness.** Supplies check and regression-check harness discipline.

**Coordinates with:**

* **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]].2/A.6.3/A.6.4.** Description epistemes can be transformed, viewed, or retargeted only under their episteme-morphism laws.
* **[[03_E.17 - Multi-View Publication Kit|E.17]] and [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]].** Publication, view, face, form, unit, and carrier relations remain separate from the EntityOfConcern and Description episteme.
* **[[00_F.09 - Alignment & Bridge across Contexts|F.9]].** Cross-context relation or near-sameness requires a bridge, not label reuse.
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:11 - Current repair moves
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:12 - Conformance checklist
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:13 - Phrasebook
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:14 - Didactic memory
...
## [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:End
