...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:1 - Problem frame
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:2 - Problem
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:3 - Forces
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:4 - Solution — the Four Guard‑Rails
...
Concrete rules for each rail live in patterns **[[01_E.05.01 - DevOps Lexical Firewall|E.5.1]] – [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]**.

## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:5 - Archetypal Grounding (System / Episteme)
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:6 - Conformance Checklist
...
| **CC‑GR.3** | A revision to any guard‑rail pattern **REQUIRES** a Design‑Rationale Record that (a) states the reason, and (b) includes a Pillar‑impact analysis per [[00_E.03 - Principle Taxonomy & Precedence Model]] precedence model. | Aligns evolution with higher‑level principles. |
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:7 - Consequences
...
## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:8 - Rationale
...
and reinforce the precedence order defined in **[[00_E.03 - Principle Taxonomy & Precedence Model|E.3]]**.

## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:9 - Relations

* **Comprises:**
  * `pat:guard/devops‑firewall` ([[01_E.05.01 - DevOps Lexical Firewall|E.5.1]]) – GR‑1
  * `pat:guard/notational‑independence` ([[02_E.05.02 - Notational Independence|E.5.2]]) – GR‑2
  * `pat:guard/unidirectional‑dependency` ([[03_E.05.03 - Unidirectional Dependency|E.5.3]]) – GR‑3
  * `pat:guard/bias‑audit` ([[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]) – GR‑4
* **Depends on:**
  * `pat:constitution/pillars` ([[00_E.02 - The Eleven Pillars|E.2]])
  * `pat:constitution/principle‑taxonomy` ([[00_E.03 - Principle Taxonomy & Precedence Model|E.3]])
* **Constrains:** every Core, Tooling, and Pedagogy artefact; all DRRs.

## [[00_E.05 - Four Guard-Rails of FPF|E.5]]:End
