...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:1 - Problem frame
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:2 - Problem
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:3 - Forces
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:4 - Solution — Principle‑Taxonomy‑Guided Bias Audit

1. **Bias‑Lens set**
   Every normative pattern is assessed through **five lenses** that match the
   Principle classes from **[[00_E.03 - Principle Taxonomy & Precedence Model|E.3]]**:
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:5 - Archetypal Grounding (System / Episteme)
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:6 - Conformance Checklist
...
| **CC‑BA.4 (QD‑triad evidence for “universal”).** | Any pattern that labels itself **“universal”** SHALL cite **[[00_A.08 - Universal Core Principle (C-1)]] CC‑UC 1 + CC‑UC 2** and attach the **QD evidence** (Diversity_P + IlluminationSummary, with edition and binning) or else **scope** the claim to its declared `U.BoundedContext`. | preserves domain quality diversity |

## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:7 - Consequences
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:8 - Rationale
...
## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:9 - Relations
* **Parent umbrella:** `pat:constitution/guard‑rails` ([[00_E.05 - Four Guard-Rails of FPF|E.5]])
* **Depends on:** `pat:constitution/principle‑taxonomy` ([[00_E.03 - Principle Taxonomy & Precedence Model|E.3]])
* **Constrains:** All normative patterns claiming universality

## [[04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]:End
