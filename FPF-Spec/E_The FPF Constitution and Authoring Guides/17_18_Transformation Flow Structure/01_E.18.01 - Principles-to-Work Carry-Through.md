...
related:
  ...
  - "[[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]"
  - "[[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]"
  - "[[12_A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]]"
  - "[[07_A.19.UNM - Unified Normalization Mechanism (UNM)|A.19.UNM]]"
  ...
  - "[[02_C.22.02 - ProblemCard@Context|C.22.2]]"
...
> **Builds on:** [[00_E.18 - Transformation Flow Structure|E.18]] Transformation Flow Structure, [[02_C.22.02 - ProblemCard@Context|C.22.2]] ProblemCard@Context, [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] `U.Signature`, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] `U.Mechanism`, the [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work family, [[00_C.29 - Mathematical Lens Use|C.29]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], and Part G comparison, selection, and refresh patterns.
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:1 - Problem frame
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:1.1 - Use this when
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:1.2 - What goes wrong if missed
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:1.3 - What this buys
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:1.4 - Not this pattern when

- there is no accepted problem-side record; use [[02_C.22.02 - ProblemCard@Context|C.22.2]] or the problem-side pattern named by value first;
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:2 - Problem
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:3 - Forces
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4 - Solution
...
| `TransformationTemporalAspect` | Is the next issue a bounded transformation under conditions, a temporal aspect of a governed object or claim, or the adequacy of an authored temporal claim? | [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]], or [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] application. |
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.1 - Carry-through record
...
P2W carry-through record:
  ...
  SelectedApplication: [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] for preserved and lost structure; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] for `U.Signature(profile=FormalSubstrate)` and `PrincipleFrame` when the declaration is written.
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.2 - Positive move table
...
| Bounded transformation or temporal-aspect cue | Separate bounded transformation, temporal aspect, and temporal-claim adequacy. | [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions]] for bounded transformation, [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] for temporal aspect, or [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] when authored temporal-claim adequacy or currentness-use is being made. |
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.3 - Locus Use Details
...
When mathematical wording points both to a formal declaration and to a mathematical lens, P2W does not decide by vocabulary. Use the slot discipline in `A.6.0:10a.1`: [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] owns `U.Signature(profile=FormalSubstrate)` declaration, [[00_C.29 - Mathematical Lens Use|C.29]] owns mathematical-lens use, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] owns mechanism consumption or realization, and [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] owns only the carry-through cue and next-relation selection.
...
Transformation and temporal aspects: a problem-side distinction may point to a bounded transformation, a temporal aspect, and a temporal-claim adequacy question at once. Do not fold these into method, mechanism, plan, or work. [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] owns bounded transformation under conditions, including transformed object, pre-state, post-state, condition set, and admissible effect claim. [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] owns temporal aspects such as interval, deadline, cadence, rhythm, synchronization, currentness window, recovery timing, or stabilization timing when the aspect itself is being named. [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] owns adequacy, supported use, unsupported use, or source-currentness use of authored temporal claims.
...
Structure, publication, function, module-interface, and integration cues: a transformation-flow structure, mathematical graph description, diagram, or publication can help classify the P2W move. Function wording continues only as an [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] function or functional-relation claim; interface, port, protocol, connection, resource limit, or integration wording continues only as a module-interface, signature-slot, reusable-structure, or architecture relation named by value through [[12_A.06.M - Module Relation Repair|A.6.M]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], or the [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] family. Otherwise the wording remains classification material for the P2W record.

### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.4 - Boundary and relation discipline
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.5 - Return and refresh rule
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.6 - Relation selection aid
...
| bounded transformation, temporal aspect, dynamics episteme, or temporal supported-use claim | [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], or [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] relation according to the claim being made | Split one phrase when it carries several of these relations. |
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.7 - Lowering and reopen block
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:4.8 - Replay and currentness record
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:5.1 - Worked slices
...
6. **Interface split before P2W use.** A source says a port-throughput limit makes a solution feasible after integration. P2W first splits the phrase: module-interface relation ([[12_A.06.M - Module Relation Repair|A.6.M]]), [[00_E.18 - Transformation Flow Structure|E.18]] transformation-flow relation or [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] function/throughput relation when function use is being claimed, WorkPlan constraint ([[02_A.15.02 - U.WorkPlan|A.15.2]]), dated `U.Work` occurrence ([[01_A.15.01 - U.Work|A.15.1]]), evidence or gate claim ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_G.06 - Evidence Graph & Provenance Ledger|G.6]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]), or architecture and structural-view claim ([[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] family). The carry-through record writes only the relation that changes the P2W move being made and leaves the other readings as stopped cues.
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:5.2 - Additional worked situations

| Situation | P2W move | What changes |
|---|---|---|
| First-minute use | A practitioner has only an accepted `ProblemCard@Context` and the sentence "the cooling fixture violates the heat-flow invariant." Fill `ProblemCardRef`, `CarriedDistinction`, `NextFPFUseQuestion`, and `RecoveredFPFKindOrRelation` or `StopCondition`. | The next action becomes a [[00_C.29 - Mathematical Lens Use]] and [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] application, not method selection or evidence writing. |
...
| Near-sameness under a formal declaration | A mathematical near-sameness claim preserves heat-flow structure but loses deformation factors outside the model. | P2W uses [[00_C.29 - Mathematical Lens Use]] for mathematical-lens use and [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] for `U.Signature(profile=FormalSubstrate)`, names preserved and lost structure, and prevents the lens from settling empirical truth or work authorization. |
...
| Relation selection would over-select from one phrase | A source says "the new port contract proves integration readiness." P2W splits module-interface relation, [[00_E.18 - Transformation Flow Structure]] transformation-flow relation, dated `U.Work` occurrence, evidence cue, gate cue, and architecture-description cue. | Only the relation that changes the P2W move being made is written; the remaining readings stop as named cues until their governed relations are being made. |
| Formal claim loses payoff | A `U.Signature(profile=FormalSubstrate)` declaration preserves a neat invariant, but no practical payoff or downstream stop condition can be stated for the accepted problem-side material. | The mathematical phrase lowers to a reduced-use cue; P2W does not open method selection, evidence, gate, or [[02_A.15.02 - U.WorkPlan]] planning from mathematical prestige alone. |
| Result source becomes stale | A result-looking source is later replaced by a fresher source with a different artifact reference and measurement reference. | P2W uses [[04_A.15.04 - Work-Relevant Source Restoration]]-style source restoration before result carry-through; stale result wording cannot continue as evidence, acceptance, or quality evaluation. |

### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:5.3 - Pilot examples for coupled transformation-flow slices
...
| TAMP and MPC robotics | Method selection and [[02_A.15.02 - U.WorkPlan]] planning records may be revised under a declared progress or budget condition before performed work. | Branching and cycle use without imposing one mandatory work procedure, and no launch-value binding before performed work. |
...
### [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:5.4 - Filled P2W output records
...
P2W output record:
  ...
  SelectedApplication: [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] for preserved and lost structure; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] for the formal-substrate declaration.
...
P2W output record:
  ...
  CarriedDistinction: the port-throughput phrase may carry module-interface, [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] transformation-flow, work-plan, performed-work, evidence, gate, and architecture relations, but only one relation changes this P2W move.
  NextFPFUseQuestion: which relation is being written now?
  RecoveredFPFKindOrRelation: [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.M - Module Relation Repair|A.6.M]] module-interface relation plus [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] transformation-flow relation; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]] planning constraint is written only if the planning record is being made.
  SelectedApplication: [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.M - Module Relation Repair|A.6.M]] for the port contract; [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] for the selected transformation-flow relation; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]] only for the planned constraint.
  WrittenRecordOrApplication: write the module-interface constraint and [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] transformation-flow relation; stop evidence and gate cues until their governing relations are being made.
  LocalStop: no readiness proof or work authorization follows from the port phrase by itself.
```

## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:6 - Bias-Annotation
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:7 - Conformance Checklist
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:9 - Consequences
...
| P2W stays non-procedural. | The pattern can be used in many project situations without prescribing one local procedure. | Teams that want a work procedure must add method material or [[02_A.15.02 - U.WorkPlan]] planning material outside P2W. |
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:10 - Rationale

[[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] is a child of [[00_E.18 - Transformation Flow Structure|E.18]] because P2W uses a selected transformation-flow structure as its setting when the carry-through relation spans several transformation-flow slices, loci, or returns. It does not define graph law or prescribe performed-work order. It defines a local carry-through pattern for turning accepted problem-side material into a next FPF use whose governing relation is named.
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:11 - SoTA-Echoing
...
## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:12 - Relations

- [[00_E.18 - Transformation Flow Structure|E.18]] governs selected `TransformationFlowStructure`, transfer annotations, flow valuation, `ConstraintValidity`, `GateFit`, gate profile, design tags, and run tags.
- [[02_C.22.02 - ProblemCard@Context|C.22.2]] governs the accepted problem-side record and problem-side claims related to the carried distinction.
- [[00_C.29 - Mathematical Lens Use|C.29]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[00_E.14 - Human-Centric Working-Model|E.14]], [[00_F.17 - Unified Term Sheet (UTS)|F.17]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[07_A.19.UNM - Unified Normalization Mechanism (UNM)|A.19.UNM]], and Part G govern mathematical-lens use, `U.Signature(profile=FormalSubstrate)`, principle-frame, ontology, UTS, bridge, measurement, normalization, and comparison relations.
- [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] govern mechanism and mechanism-method stabilization relations. [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], and [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] govern bounded transformation, temporal aspect, temporal-claim adequacy, and dynamics-episteme relations.
- [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.09 - Parity and Benchmark Harness|G.9]], [[12_A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], and [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] govern candidate-set, comparison, selector, retained-set, and selected-record relations.
- [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], [[02_A.15.02 - U.WorkPlan|A.15.2]], [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]], and [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] govern role-method-work alignment, performed work, planning, planned baselines, and work-relevant source restoration.
- [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_G.06 - Evidence Graph & Provenance Ledger|G.6]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], and [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] govern evidence, assurance, provenance, conformance, gate, release, work-entry, and decision claims.
- [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[01_C.30.AD - Architecture Description Adequacy|C.30.AD]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[12_A.06.M - Module Relation Repair|A.6.M]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[03_E.17 - Multi-View Publication Kit|E.17]], and [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] govern architecture, architecture-description, structural-view, reusable-structure, module-interface, function, wording-use, publication, and publication-use claims.

## [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]:End
