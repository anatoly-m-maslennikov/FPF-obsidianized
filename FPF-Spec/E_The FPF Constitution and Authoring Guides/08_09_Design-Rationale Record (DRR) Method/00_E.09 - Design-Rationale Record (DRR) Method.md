...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:0 - Use this when
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:0.2 - What this buys
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:1 - Problem frame
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:4 - Solution — the DRR as a structured argument and temporary convergence record
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:4.1 - Minimum decision-inspection content blocks
...
| **Naming, ontology, and wrong-carrier-confusion account** | Head/branch/object/move/outside-work separation, tempting wrong-pattern assignment or wrong non-pattern FPF kind-reference assignment, and any load-bearing [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] naming obligation needed to keep the selected answer truthful by value. | Problem frame, Decision, and Rationale. |
...
per the Pattern Template, [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]). The full DRR remains external as
provenance.
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:4.1a - Process-source method admission into FPF
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:5 - Archetypal Grounding (System / Episteme)
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:6 - Bias-Annotation
...
Scope: this bias annotation is universal for FPF semantic changes governed by [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]. It does not turn project-management state, helper state, or review logistics into DRR content.

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:7 - Conformance Checklist
...
| **CC‑DRR.1a** | A DRR whose proposed change is expressed as a new or revised pattern written in the standard template ([[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]]) **MAY** satisfy that minimum kernel by **pointing to** the corresponding pattern sections rather than duplicating prose. | Avoids “double writing” while keeping the argument recoverable. |
...
| **CC‑DRR.1h (naming and ontology adequacy)** | A conforming DRR **MUST** make the selected head, branch, object, governed action, and outside-work separation recoverable by value and **MUST** expose any tempting wrong-pattern assignment or wrong non-pattern FPF kind-reference assignment or load-bearing [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] naming obligation that materially affects the decision. | Prevents semantically important naming and typing choices from being rediscovered later during pattern drafting. |
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:10 - Rationale
...
[[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]] sets a **floor, not a ceiling**: every conforming DRR must make
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:11 - SoTA-Echoing
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:12 - Relations

* **Instantiates:** P‑10 Open‑Ended Evolution, P‑2 Didactic Primacy
* **Template governed by:** `pat:authoring/pattern‑template` ([[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]])
* **Interacts with:** `pat:guard/bias‑audit` ([[E_The FPF Constitution and Authoring Guides/04_05_Four Guard-Rails of FPF/04_E.05.04 - Cross-Disciplinary Bias Audit|E.5.4]]) via lens check
* **Complemented by:** [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] when one concrete `DRR` follows [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]] form but its adequacy for downstream drafting, host amendment, accepted-decision carry-through, source-use carry-through, or selected-locus distribution is disputed or materially relevant. [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] reads the `DRR` decision-adequacy claim; it is not a second DRR form, review gate, or mandatory ordinary editorial step. Also complemented by `pat:authoring/code-of-conduct` ([[E_The FPF Constitution and Authoring Guides/11_12_Didactic Primacy & Cognitive Ergonomics/00_E.12 - Didactic Primacy & Cognitive Ergonomics|E.12]]) for etiquette in DRR debate.

* **Coordinates with:** [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method|E.23]] when one `DRR` is being improved through repeated quality-improvement passes. [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]] keeps the `DRR` kind and decision-record form; [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] supplies the decision-adequacy object-under-improvement evaluation when adequacy is being improved; [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method|E.23]] governs the repeated method rather than turning the DRR into final pattern prose.

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]]:End
