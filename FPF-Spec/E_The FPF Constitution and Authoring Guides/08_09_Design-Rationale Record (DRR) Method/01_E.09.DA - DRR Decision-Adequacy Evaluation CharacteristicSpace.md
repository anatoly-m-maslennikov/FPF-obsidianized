...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:1 - Problem frame
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:3 - Forces
...
| Affordability vs completeness | Small editorial decisions stay under [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method]]; opened [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] evaluates every coordinate compactly. |

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4 - Solution

[[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] is the `DRR` decision-adequacy specialization of [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]]. It evaluates whether one `DRR` version carries enough decision content for the declared authoring use.

There is no partial [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result. Once invoked, the evaluator assigns a value, short rationale, and evidence locus to every coordinate in `E.9.DA:4.4`, and states the evidence basis used for the result. If the `DRR` lacks a field, source row, selected-locus map, architecture decision, comparator, or currentness basis needed by a coordinate, the relevant coordinate receives a low value and the status states the repair, split, or hold.

### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.1 - Local names and kind settlement
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.2 - Evaluation record
...
[[E_The FPF Constitution and Authoring Guides/21_22_Improvement-Oriented Quality Evaluation Question Framing/00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] may frame whether the evaluation is floor-only, exceptional-improvement, trade-off, open-question, absorption, or proposal-producing. [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method|E.23]] governs repeated improvement of the `DRR` after evaluation findings exist.

### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.3 - Ordinal coordinate scale
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.4 - Required decision-adequacy coordinates
...
| `LexicalAndNamingClosure` | Are durable names, trigger words, and relation-like heads repaired through [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/00_C.02.P - Epistemic Precision Restoration]], or the pattern that governs the relevant kind, claim, relation, or name? |
...
Coordinate separation is by repair question. One `DRR` section may support several coordinates, but the rationale must state the distinct property supported for each. When two heads always fail and repair together, the `DRR` or the evaluation pattern needs characteristic-space repair through [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]].

### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.4a - Result-row discipline and calibration

An [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result uses this table shape:

| Coordinate | Value | ShortRationale | EvidenceLocus |
|---|---:|---|---|
| `<[[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] coordinate>` | `<0..5>` | `<assigned-value basis; why the lower adjacent value would understate the DRR evidence; why the higher adjacent value would overstate it, or for 5 what would lower or reopen>` | `<DRR section, row, alternative, source-use row, selected-locus row, accepted-decision row, architecture decision, or missing locus named by value>` |

A prose summary, heading checklist, two-column coordinate-and-value table, or table without an `EvidenceLocus` named by value is not an [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result. It is draft evaluation material. Missing or unchecked evidence lowers the coordinate that needs it; it does not make the coordinate inactive.
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.5 - Status and stop condition
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.6 - Compact result form

```text
[[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result:
...
### [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.7 - Finding row

```text
[[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] finding:
  DRR version: <DRRVersionRef>
  Declared authoring use: <DRRDeclaredAuthoringUse>
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:5 - Worked slices

**Weak precision-restoration DRR.** A `DRR` says [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/00_C.02.P - Epistemic Precision Restoration|C.2.P]] are relevant, but does not decide whether a new branch exists, what name it has, which repeated prose moves, or which regression cases test the split. `SelectedAnswerDecisiveness`, `SelectedLocusObligationClosure`, `FPFContentArchitectureSelectionAdequacy`, and `DraftingActionability` fall.
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:6 - Bias annotation
...
The bias is bounded. Small editorial decisions can use [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method|E.9]] directly. Pattern quality remains under [[E_The FPF Constitution and Authoring Guides/20_21_FPF Pattern-Quality Evaluation CharacteristicSpace/00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]; repeated improvement remains under [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method|E.23]]; wording repair remains under [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] and precision-restoration neighboring patterns named by value.

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:7 - Conformance checklist
...
| `CC-E9DA-6` | Apply [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]] to decision-governing names, coordinates, status values, examples, stop conditions, and finding wording introduced or repaired by the evaluation. |
| `CC-E9DA-6a` | Record `DRRPrecisionRestorationProfile` before assigning or accepting values: word-use precision goes to [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]], [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/02_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]], or a governing pattern; phrase apparatus goes to [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/19_Ontology-First Plain Technical Rewriting/00_F.19 - Ontology-First Plain Technical Rewriting]]; repetition-and-distribution, ontic-slot clarity, description-publication-source boundary separation, and pattern-application ontology are classified by their governing pattern; boilerplate stays out of future pattern prose. |
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:8 - Common anti-patterns and repairs
...
| **Apparatus-overwrapped drafting payload.** The `DRR` offers selected-pattern wording wrapped in role, publication-form, locus, flow, state, status, text, package, or process apparatus without changing a recoverable kind, relation, claim kind, admissible use, evidence value, selected locus, user-facing action, or flow role. | Classify the wording under [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/19_Ontology-First Plain Technical Rewriting/00_F.19 - Ontology-First Plain Technical Rewriting]]. If it changes a kind or claim, repair through precision restoration; if not, remove it from the future pattern payload or rewrite it as the positive subject-kind and action spine. |
| **Goodharted DRR adequacy.** A `DRR` is made easier to defend as `4` or `5` by adding source rows, selected-locus tables, boundary catalogues, or review proof, while selected answer, selected-locus obligations, source payload mutation, architecture choice, or first drafting action do not improve. | Reject apparatus-only improvement; apply [[E_The FPF Constitution and Authoring Guides/12_13_Pragmatic Utility and Value Alignment/00_E.13 - Pragmatic Utility and Value Alignment]] when adequacy values or review marks are replacing decision usefulness; repair the decision content, delete or relocate proof material, and record checked no-proposal only when no non-dominated decision-content improvement remains. |
| **Solution architecture evaporates after DRR.** A `DRR` solves a multi-locus unfolding or first-entry problem, but pattern hosts receive only local fragments and the DRR remains the only place where the full problem-solution structure is understandable. | Run `CampaignProblemSolutionUnfoldingCheck`; move the residue into selected pattern bodies, local unfolding blocks, [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery]] entry expansions, or direct governing-pattern relations. |

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:9 - Consequences

| Consequence | Benefit | Cost |
|---|---|---|
| DRR adequacy becomes inspectable before drafting. | Pattern authors get decisions, not source summaries. | Every opened [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] evaluation touches all coordinates. |
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:10 - Rationale
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:11 - SoTA-Echoing
...
| Feedback needs desired condition, current condition, next action, and tactics. | Sadler and Hattie and Timperley feedback traditions, carried through [[E_The FPF Constitution and Authoring Guides/21_22_Improvement-Oriented Quality Evaluation Question Framing/00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method]]. | `ShortRationale`, evidence locus, finding and proposal rows, and checked no-proposal dispositions stay separate. |
| Source evidence must mutate the decision. | Current FPF [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]], [[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]], [[E_The FPF Constitution and Authoring Guides/20_21_FPF Pattern-Quality Evaluation CharacteristicSpace/00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]], and living-source discipline require non-decorative source use. | `SoTAAndEvidenceUseInDecision` checks changed decision payload, not citation presence. |
| Improvement remains multi-coordinate and trade-off sensitive. | MCDA, Pareto, and QD, OEE, and NQD lines inherited through [[E_The FPF Constitution and Authoring Guides/21_22_Improvement-Oriented Quality Evaluation Question Framing/00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method]]. | The evaluation asks what became worse and keeps repeated improvement outside [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]]. |
| Decision-adequacy measures can become targets. | Goodhart and Campbell, management-accounting surrogation, specification-gaming, and reward-hacking lines. | [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] forbids all-`5` or `5-defensible` repair targeting; values rise only when decision content becomes stronger for declared authoring use, and [[E_The FPF Constitution and Authoring Guides/12_13_Pragmatic Utility and Value Alignment/00_E.13 - Pragmatic Utility and Value Alignment]] governs any proxy-to-value claim about those values. |

## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:12 - Relations

| Pattern | Relation |
|---|---|
| [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/00_E.09 - Design-Rationale Record (DRR) Method]] | Defines the `DRR` kind and minimum form. |
| [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]] | Receives authored pattern bodies after accepted decisions. |
| [[E_The FPF Constitution and Authoring Guides/20_21_FPF Pattern-Quality Evaluation CharacteristicSpace/00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Evaluates resulting pattern versions, not `DRR` adequacy. |
| [[E_The FPF Constitution and Authoring Guides/21_22_Improvement-Oriented Quality Evaluation Question Framing/00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] | Frames the evaluation purpose when needed. |
| [[E_The FPF Constitution and Authoring Guides/22_23_Quality Improvement Loop Method/00_E.23 - Quality Improvement Loop Method]] | Runs repeated improvement of a `DRR` after findings or proposal rows exist. |
| [[E_The FPF Constitution and Authoring Guides/12_13_Pragmatic Utility and Value Alignment/00_E.13 - Pragmatic Utility and Value Alignment]] | Governs pragmatic utility and proxy-to-value alignment when `DRR` adequacy values, review marks, source-counts, or discharge evidence become substitutes for decision usefulness. |

| [[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]] | May return findings that expose upstream `DRR` defects. |
| [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/00_C.02.P - Epistemic Precision Restoration]], [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] | Govern wording, relation, episteme, quality-term, and naming repair. |
| [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[A_Kernel Architecture Cluster/17_Canonical “Characteristic” (A.CHR-NORM)/00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[A_Kernel Architecture Cluster/18_Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)/00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[C_Kernel Extension Specifications/13_25_Q-Bundle- Authoring --ilities- as Structured Quality Bundles/00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] | Govern characteristic, scale, measurement, characteristic-space, and quality-bundle claims. |
...
## [[E_The FPF Constitution and Authoring Guides/08_09_Design-Rationale Record (DRR) Method/01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:End
