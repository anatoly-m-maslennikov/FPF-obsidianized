...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:1 - Problem frame

Use [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] when one `DRR` must be reliable enough for a declared FPF authoring use: pattern drafting, host amendment, selected-locus distribution, accepted-decision carry-through, source-use carry-through, scope-boundary decision, split decision, or architecture-hold decision.

Not this pattern when the evaluated object is one authored pattern version, one admission or refresh review, one local wording repair, or a measurement-law problem. Use [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]] and its precision-restoration neighbours, or [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]], and [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] for those objects.
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:3 - Forces
...
| Affordability vs completeness | Small editorial decisions stay under [[00_E.09 - Design-Rationale Record (DRR) Method]]; opened [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] evaluates every coordinate compactly. |

## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4 - Solution

[[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] is the `DRR` decision-adequacy specialization of [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]]. It evaluates whether one `DRR` version carries enough decision content for the declared authoring use.

There is no partial [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result. Once invoked, the evaluator assigns a value, short rationale, and evidence locus to every coordinate in `E.9.DA:4.4`, and states the evidence basis used for the result. If the `DRR` lacks a field, source row, selected-locus map, architecture decision, comparator, or currentness basis needed by a coordinate, the relevant coordinate receives a low value and the status states the repair, split, or hold.

### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.1 - Local names and kind settlement
...
### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.2 - Evaluation record
...
[[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] may frame whether the evaluation is floor-only, exceptional-improvement, trade-off, open-question, absorption, or proposal-producing. [[00_E.23 - Quality Improvement Loop Method|E.23]] governs repeated improvement of the `DRR` after evaluation findings exist.

### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.3 - Ordinal coordinate scale
...
### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.4 - Required decision-adequacy coordinates
...
| `LexicalAndNamingClosure` | Are durable names, trigger words, and relation-like heads repaired through [[00_E.10 - Unified Lexical Rules for FPF]], [[00_F.18 - Local-First Unification Naming Protocol]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], or the pattern that governs the relevant kind, claim, relation, or name? |
...
Coordinate separation is by repair question. One `DRR` section may support several coordinates, but the rationale must state the distinct property supported for each. When two heads always fail and repair together, the `DRR` or the evaluation pattern needs characteristic-space repair through [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]].

### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.4a - Result-row discipline and calibration

An [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] result uses this table shape:
...
### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.5 - Status and stop condition
...
### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.6 - Compact result form
...
### [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:4.7 - Finding row
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:5 - Worked slices

**Weak precision-restoration DRR.** A `DRR` says [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], and [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] are relevant, but does not decide whether a new branch exists, what name it has, which repeated prose moves, or which regression cases test the split. `SelectedAnswerDecisiveness`, `SelectedLocusObligationClosure`, `FPFContentArchitectureSelectionAdequacy`, and `DraftingActionability` fall.
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:6 - Bias annotation
...
The bias is bounded. Small editorial decisions can use [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]] directly. Pattern quality remains under [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]; repeated improvement remains under [[00_E.23 - Quality Improvement Loop Method|E.23]]; wording repair remains under [[00_E.10 - Unified Lexical Rules for FPF|E.10]] and precision-restoration neighboring patterns named by value.

## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:7 - Conformance checklist
...
| `CC-E9DA-6` | Apply [[00_E.10 - Unified Lexical Rules for FPF]] to decision-governing names, coordinates, status values, examples, stop conditions, and finding wording introduced or repaired by the evaluation. |
| `CC-E9DA-6a` | Record `DRRPrecisionRestorationProfile` before assigning or accepting values: word-use precision goes to [[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[00_F.18 - Local-First Unification Naming Protocol]], or a governing pattern; phrase apparatus goes to [[00_F.19 - Ontology-First Plain Technical Rewriting]]; repetition-and-distribution, ontic-slot clarity, description-publication-source boundary separation, and pattern-application ontology are classified by their governing pattern; boilerplate stays out of future pattern prose. |
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:8 - Common anti-patterns and repairs
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:10 - Rationale
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:11 - SoTA-Echoing
...
| Feedback needs desired condition, current condition, next action, and tactics. | Sadler and Hattie and Timperley feedback traditions, carried through [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[00_E.23 - Quality Improvement Loop Method]]. | `ShortRationale`, evidence locus, finding and proposal rows, and checked no-proposal dispositions stay separate. |
| Source evidence must mutate the decision. | Current FPF [[00_E.08 - FPF Authoring Conventions & Style Guide]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]], and living-source discipline require non-decorative source use. | `SoTAAndEvidenceUseInDecision` checks changed decision payload, not citation presence. |
| Improvement remains multi-coordinate and trade-off sensitive. | MCDA, Pareto, and QD, OEE, and NQD lines inherited through [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[00_E.23 - Quality Improvement Loop Method]]. | The evaluation asks what became worse and keeps repeated improvement outside [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]]. |
| Decision-adequacy measures can become targets. | Goodhart and Campbell, management-accounting surrogation, specification-gaming, and reward-hacking lines. | [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] forbids all-`5` or `5-defensible` repair targeting; values rise only when decision content becomes stronger for declared authoring use, and [[00_E.13 - Pragmatic Utility and Value Alignment]] governs any proxy-to-value claim about those values. |

## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:12 - Relations

| Pattern | Relation |
|---|---|
| [[00_E.09 - Design-Rationale Record (DRR) Method]] | Defines the `DRR` kind and minimum form. |
| [[00_E.08 - FPF Authoring Conventions & Style Guide]] | Receives authored pattern bodies after accepted decisions. |
| [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Evaluates resulting pattern versions, not `DRR` adequacy. |
| [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] | Frames the evaluation purpose when needed. |
| [[00_E.23 - Quality Improvement Loop Method]] | Runs repeated improvement of a `DRR` after findings or proposal rows exist. |
| [[00_E.13 - Pragmatic Utility and Value Alignment]] | Governs pragmatic utility and proxy-to-value alignment when `DRR` adequacy values, review marks, source-counts, or discharge evidence become substitutes for decision usefulness. |

| [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]] | May return findings that expose upstream `DRR` defects. |
| [[00_E.10 - Unified Lexical Rules for FPF]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], [[02_C.16.Q - Quality-Term Precision Restoration]], [[00_F.18 - Local-First Unification Naming Protocol]] | Govern wording, relation, episteme, quality-term, and naming repair. |
| [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] | Govern characteristic, scale, measurement, characteristic-space, and quality-bundle claims. |
...
## [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]:End
