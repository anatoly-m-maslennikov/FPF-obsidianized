...
coordinates_with:
  ...
  - "[[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]"
  - "[[00_E.23 - Quality Improvement Loop Method|E.23]]"
  - "[[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]"
  - "[[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]"
related:
  - "[[00_E.12 - Didactic Primacy & Cognitive Ergonomics|E.12]]"
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:0 - Use This When
...
- If the question is whether a measurement scale is legal, use [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]].
- If the question is ordinary pattern quality, use [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]; use [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]] only when a visible quality value is being treated as the practical value.
- If the question is DRR adequacy, use [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]]; use [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]] only when DRR marks become a surrogate for decision usefulness.
- If the question is whole-FPF Pillar adequacy, use [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]; use [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]] only when Pillar values become the target.
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:1 - Problem Frame
...
[[00_E.13 - Pragmatic Utility and Value Alignment|E.13]] governs the proxy-to-value repair. It asks whether the visible measure still serves the intended value in the declared use, and what became worse when the measure improved.

## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:2 - Problem

Without [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:3 - Forces
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4 - Solution
...
### [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4.1 - Name the Value Before the Proxy
...
### [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4.2 - Type the Proxy Use
...
| Measure | Reports one declared characteristic under [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]]. | Treated as the whole objective. |
...
### [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4.3 - Ask What Got Worse
...
### [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4.4 - Require a Minimally Viable Value Slice
...
### [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:4.5 - Repair by Value Movement
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:5 - Archetypal Grounding

| Case | Proxy pressure | [[00_E.13 - Pragmatic Utility and Value Alignment]] repair |
| --- | --- | --- |
| Pattern quality loop | All-`5` pattern-quality posture becomes the target. | Use [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] values as measurements; repair only substantive content movement and record what worsened when apparatus grew. |
| DRR review | Source rows and selected-locus tables grow while the decision remains vague. | Use [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]]; the DRR improves only when selected answer, source payload, or first drafting move improves. |
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:6 - Conformance Checklist
...
| `CC-E13-6` | Stronger claims are sent to their governing patterns: measurement to [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], quality evaluation to [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]]/[[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]]/[[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]], assurance to [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], gate passage to [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], decision authority to [[00_C.11 - Decision Theory (Decsn-CAL)]], and value/proxy alignment here. |
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:7 - Common Anti-Patterns
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:8 - Rationale

FPF needs measurement, evaluation, assurance, and release checks, but those checks remain instruments. They are not the value by themselves. [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]] keeps the visible instrument attached to the intended value and asks whether the value survives optimization pressure.
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:9 - SoTA-Echoing
...
| Useful measures should be derived from goals and questions. | Goal-Question-Metric and GQM+Strategies measurement alignment. | [[00_E.13 - Pragmatic Utility and Value Alignment]] asks for intended value/objective before proxy and asks which decision or work the proxy affects. |
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:10 - Relations

- **Implements:** [[00_E.02 - The Eleven Pillars|E.2]] Pillar `P7 Pragmatic Utility`.
- **Complements:** [[00_E.12 - Didactic Primacy & Cognitive Ergonomics|E.12]] for cognitive ergonomics and [[00_E.14 - Human-Centric Working-Model|E.14]] for human-facing working models.
- **Coordinates with:** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] for authoring practical-payoff claims, [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] for review/admission proxy-to-value checks, [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]]/[[00_E.23 - Quality Improvement Loop Method|E.23]] for improvement framing and repeated improvement loops, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for measurement legality, [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] for engineering quality-family endpoints, [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]] for pattern quality, [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]] for DRR adequacy, [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] for whole-FPF Pillar adequacy, [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gate passage, [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] for decisions, and [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence.
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:11 - Consequences
...
## [[00_E.13 - Pragmatic Utility and Value Alignment|E.13]]:End
