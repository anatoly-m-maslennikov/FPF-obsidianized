...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:0 - Use This When
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:1 - Intent
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:2 - Problem Frame
...
[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]] resolves the impasse by **separating concerns**:
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:2.1 - Problem

A reader may need to decide, design, review, or coordinate with FPF terms before they are ready to inspect mapping tables, constructive traces, evidence records, or proof arguments. If the working text exposes all of that machinery first, the model becomes unusable; if it hides the machinery completely, the model becomes arbitrary. [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]] keeps one human-facing Working-Model visible while making the assurance shoulders recoverable beneath it.

## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:4 - Solution

### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:4.1 - Human-Centric principles

#### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:4.1.1 - Recognition text and assurance text
...
Under [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] local-first naming, the canonical pair here is **recognition text** and **assurance text**.
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.1 – Working‑Model first, stance explicit.**  **
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.2 – Downward‑only dependency.**
...
>
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.3 – Small working text, big proof.**
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.4 – Human registers first.**
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.5 – Justification modes are explicit.**
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.6 – Parsimony in the working text.**
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.7 – Evidence is first-class claim grounding.**
...
> **[[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]‑P.8 – Working-model-first is not explanation-thin.**
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5 - Layer Standard & Downward Flow (Working‑Model → Assurance)

This section defines **what each layer is for**, **what it guarantees**, and **how a single Working‑Model statement is carried down**.

### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.1 - Working‑Model (what humans see)
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.2 - Assurance-1: Mapping (from words to chosen governed values)
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.3 - Assurance‑2: Logical (from Working‑Model relations to label semantics)
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.4 - Assurance‑3: Constructive (from meanings to generative traces)
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.5 - Assurance‑4: Empirical Validation (from claims to observed world)
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:5.6 - The downward grounding for a single Working-Model statement
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:6 - Archetypal Grounding *(System / Episteme)*
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:6.1 - `U.System` — Working‑Model first, Constructive grounding available
...
### [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:6.2 - `U.Episteme` - Working-Model first; Logical and Mapping preferred; Empirical evidence as appropriate
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:7 - Bias-Annotation *(what to watch for, and the counter-moves)*

| Bias (name)                       | Symptom in drafts                                                                           | Conceptual counter‑move                                                                                                                        | Where this is governed                                               |
| --------------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **Formalism capture**             | Treating a constructive narrative as “the real thing,” with **ut:\*Of** reduced to a label. | Re‑assert Working‑Model primacy: publish in **ut:\*Of**; attach assurance **downwards** only when needed.                                      | [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]] template; Notational‑Independence guard‑rail.                    |
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:8 - Conformance Checklist *(normative; author‑facing duties for thought and prose)*
...
|**CC-E14-10 (Structural grounding handshake).** | For **structural** edges on the Working-Model, authors **SHALL** set `validationMode=axiomatic` and provide **Constructive** grounding with `tv:groundedBy → Γₘ.sum|set|slice` (see **Compose-CAL** and **CT2R-LOG**). Exactly **one** Γₘ trace is permitted per edge (CI rule alignment). | Aligns [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model]] with CT2R-LOG and Compose-CAL; ensures extensional identity. |
...
| **CC-E14-12 (F-declaration).**             | Normative Working-Model publications **SHALL** declare `U.Formality = Fk` per **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F]]** (**recommended F ≥ F3** for readable publications). Assurance publications or records **MAY** carry higher F; **min-F** applies to composites. | Aligns [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model]] with the unified Formality characteristic; avoids obsolete “tiers/modes”. |
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:9 - Common Anti-Patterns and How to Avoid Them
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:10 - Consequences
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:11 - Rationale
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:12 - SoTA-Echoing

| Source line | What [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model]] adopts | Boundary |
| --- | --- | --- |
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:13 - Relations

**Builds on:**

* **[[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] Authoring Conventions & Style Guide** — section order, style principles, and mandatory safety subsections used here.
* **[[E_The FPF Constitution and Authoring Guides/06_07_Archetypal Grounding Principle/00_E.07 - Archetypal Grounding Principle|E.7]] Archetypal Grounding** — the Tell‑Show‑Show rule applied in this pattern’s own Grounding section.
* **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]] Unified Formality Characteristic (F)** — declares the **F** scale and **ΔF** moves for progressive rigor; Working-Model publications **SHALL** declare **F** and remain notation-agnostic.
...
* **[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] Lexical Discipline & Stratification** — ensures naming discipline and register hygiene when the human layer is published.

**Constrains:**

* All architectural patterns that publish relations **SHALL** present them in the Working-Model layer and **MAY** attach assurance only as needed, preserving relation-family separation and notational independence. (Template conformance as per [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]].)
...
## [[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]:End
