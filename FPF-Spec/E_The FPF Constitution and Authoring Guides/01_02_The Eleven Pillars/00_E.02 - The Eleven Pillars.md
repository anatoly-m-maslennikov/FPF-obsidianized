...
## [[00_E.02 - The Eleven Pillars|E.2]]:2 - Problem
...
## [[00_E.02 - The Eleven Pillars|E.2]]:3 - Forces
| Force                          | Tension                                                |
| ------------------------------ | ------------------------------------------------------ |
...
## [[00_E.02 - The Eleven Pillars|E.2]]:4 - Solution
...
| **CC‑P‑6** | A pillar-impact analysis that relies on mathematical structure, scale behavior, optimization, uncertainty, invariance, obstruction, or other first-principles modeling support is complete only when that support is ordinary accepted local theory, a cited [[00_C.29 - Mathematical Lens Use]] output, or a named neighboring-pattern output for evidence, causal, bridge, assurance, measurement, work, decision, publication, or admission claims. | Keeps mathematical support for pillars inspectable without letting [[00_C.29 - Mathematical Lens Use]] revise pillar authority. |

## [[00_E.02 - The Eleven Pillars|E.2]]:6 - Policy — Bitter‑Lesson Preference (BLP)
...
* (c) **Slopes & uncertainty**: report ∂quality/∂compute, ∂quality/∂data, and (where applicable) ∂coverage/∂**freedom‑of‑action** and **∂novelty/∂budget**; include **error bars/CI** from multi‑seed trials; publish edition pins and policy‑IDs in SCR/telemetry (**[[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]**).
* (d) **Resources**: publish **Resrc‑CAL** accounts (time/energy/FLOPs) and assurance deltas ([[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]).
...
## [[00_E.02 - The Eleven Pillars|E.2]]:7 - Conformance Checklist — BLP
...
| **CC‑BLP.6**  | Resource accounts (time/energy/FLOPs) and assurance deltas are reported via **Resrc‑CAL** and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]].             | Avoids “free heuristic” illusions.            |
...
## [[00_E.02 - The Eleven Pillars|E.2]]:8 - Relations
* **Instantiates pillars:** P‑10, P‑11, P‑7, P‑1.
* **Depends on:** **G.5/G.9** (admission/comparator/selector & parity harness), **[[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]** (refresh telemetry), **C.5** (Resrc‑CAL), **[[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]]** (NQD‑CAL), **[[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]]** (E/E‑LOG), **F.7/F.9** (Bridges, CL/Φ/Ψ).
* **Constrained by:** **[[00_E.05 - Four Guard-Rails of FPF|E.5]]** Guard‑Rails (DevOps Lexical Firewall; Notational Independence; Cross‑Disciplinary Bias Audit) and **[[00_E.03 - Principle Taxonomy & Precedence Model|E.3]]** precedence.

## [[00_E.02 - The Eleven Pillars|E.2]]:9 - Definitions
**α (budget tolerance)** may be relative or absolute; declare units (e.g., % cost, wall‑time, energy). **δ (assurance tolerance)** is the permissible delta in assurance under **[[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]**; declare measure and floor(s).

## [[00_E.02 - The Eleven Pillars|E.2]]:10 - Consequences
...
## [[00_E.02 - The Eleven Pillars|E.2]]:11 - Rationale
...
[[00_C.29 - Mathematical Lens Use|C.29]] is a downstream support pattern for this constitution when mathematical first-principles structure is part of an argument about pillar support. It makes the structure, loss, and stop condition explicit while [[00_E.02 - The Eleven Pillars|E.2]] remains authority over what counts as a pillar.

## [[00_E.02 - The Eleven Pillars|E.2]]:12 - Relations
...
* **Mathematical support path:** [[00_C.29 - Mathematical Lens Use|C.29]] supports pillar-impact arguments only for adequacy of mathematical lenses used to express first-principles structure. It does not amend pillar content, priority, or conformance.
...
## [[00_E.02 - The Eleven Pillars|E.2]]:End
