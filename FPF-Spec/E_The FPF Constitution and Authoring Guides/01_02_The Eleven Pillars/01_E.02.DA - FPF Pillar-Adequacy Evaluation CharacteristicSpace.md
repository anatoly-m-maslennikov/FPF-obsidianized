...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:1 - Problem frame

Use [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] when the object under improvement is an FPF-level object and the question is whether it realizes the [[00_E.02 - The Eleven Pillars|E.2]] Pillars adequately for a declared use. The object can be a monolith edition, selected pattern host set, pattern family, projection set, release candidate, or whole-FPF edition.
...
Not this pattern when the evaluated object is one authored pattern version, one `DRR`, one local wording repair, or one pattern-use entry problem. Use [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]] and its precision-restoration neighbours, or [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] for those objects.
...
Primary EntityOfConcern in plain terms: the scoped FPF object under improvement as an [[00_E.02 - The Eleven Pillars|E.2]] Pillar-realizing language object.

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:2 - Problem

[[00_E.02 - The Eleven Pillars|E.2]] gives the Pillars and their constitutional meaning. It does not by itself evaluate whether a concrete FPF object realizes those Pillars well enough for a concrete use. Without [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]], corpus-level reviews tend to collapse into local pattern scores, process state, review praise, or broad claims that "FPF improved."
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:3 - Forces

| Force | Tension |
|---|---|
| Constitutional meaning vs evaluation | Pillar meanings stay in [[00_E.02 - The Eleven Pillars]]; values over realized adequacy are evaluated here. |
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4 - Solution

[[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] is the Pillar-adequacy specialization of [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]]. It evaluates one FPF object under improvement against all eleven [[00_E.02 - The Eleven Pillars|E.2]] Pillars for a declared use.

There is no smaller [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] evaluation. If the caller only needs local pattern quality, `DRR` adequacy, or wording repair, that is a different object-under-improvement evaluation. Once [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] is invoked, every Pillar coordinate receives a value, short rationale, evidence locus, and shared evidence basis for the FPF object being evaluated.

### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.1 - Local names and kind settlement
...
| `FPFPillarAdequacyEvidenceBasis` | Checked loci named by value in the scoped FPF object: pattern bodies, host or monolith sections, projections, README scenarios, ToC rows, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]] entry-distribution loci, [[00_I.02 - Expanded Entry Disambiguation Cases]] expanded entry-disambiguation cases, source rows, relation rows, companion files, evaluation results, and missing or unchecked loci that affect values. |
...
These names are local to the evaluation unless [[00_F.18 - Local-First Unification Naming Protocol|F.18]] promotes a durable name. They name FPF content objects and evaluation fields, not release state, review state, or project evidence.

### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.2 - Evaluation record
...
[[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]] may frame the evaluation purpose when the caller needs floor evaluation, exceptional improvement, trade-off inspection, open-question discovery, absorption, or proposal portfolios. [[00_E.23 - Quality Improvement Loop Method|E.23]] governs repeated improvement after the evaluation returns findings or candidate proposals.

### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.3 - Ordinal coordinate scale
...
### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.4 - Required Pillar coordinates
...
### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.5 - Evidence and coordinate separation
...
| `P10` vs [[00_E.23 - Quality Improvement Loop Method]] | evolvability of the FPF object vs repeated improvement method. |
...
### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.6 - Status and stop condition
...
| `holdForPillarDecision` | The defect requires an [[00_E.02 - The Eleven Pillars]] Pillar amendment or precedence decision. |
...
### [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:4.7 - Compact result form
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:5 - Worked slices
...
**Ontic architecture repair.** A campaign adds [[01_E.24.CD - Ontic Candidate Detection|E.24.CD]], [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]], or a new ontic host. Pillar values rise only if the change reduces duplicate ontology, type explosion, or shadow authority and improves FPF entry, authoring, review, or project use. Extra ontic terminology, score proof, or publication-boundary prose without better action lowers `P1`, `P2`, `P5`, `P6`, and `P7`.
...
**Projection repair.** README scenarios, ToC rows, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] entry-distribution loci, and [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]] expanded entry-disambiguation cases improve search but can start carrying pattern semantics. `P5` and `P9` fall because projections become shadow authority. The repair moves durable semantics back to governing patterns and leaves thin echoes in projections.
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:6 - Bias annotation
...
The bias is bounded by the object-under-improvement declaration. [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]] does not replace [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace|E.9.DA]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], or [[00_E.23 - Quality Improvement Loop Method|E.23]]; it evaluates their FPF-level Pillar effect when the scoped FPF object includes their results.

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:7 - Conformance checklist

| Check | Requirement |
|---|---|
| `CC-E2DA-1` | Name `FPFObjectUnderImprovementRef`, use scope, reader scope, and qualification window. |
| `CC-E2DA-2` | Preserve [[00_E.02 - The Eleven Pillars]] as the source of Pillar meaning. |
...
| `CC-E2DA-7` | Treat [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] and [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] as evidence loci only where they change Pillar realization. |
| `CC-E2DA-8` | State what became worse when visible coordinates improved. |
| `CC-E2DA-9` | State the `FPFPillarAdequacyEvidenceBasis`; if host or monolith parity, projection, README, ToC, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]], [[00_I.02 - Expanded Entry Disambiguation Cases]], source-currentness, relation, companion, or evaluation-result evidence is missing or unchecked, lower the Pillar coordinate that needs it. |
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:8 - Common anti-patterns and repairs

| Anti-pattern | Repair |
|---|---|
| **Pillar essay.** A review names Pillars without values or evidence. | Produce the complete [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] result form. |
| **Local-quality averaging.** Several [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] values are averaged into FPF adequacy. | Re-evaluate Pillar effects over the FPF object. |
...
| **Goodharted Pillar adequacy.** FPF-level values rise because more projection, source, review, or parity evidence was added, while entry recognition, layering, semantic authority, pragmatic utility, source use, or open-ended evolution becomes worse. | Reject apparatus-only improvement; apply [[00_E.13 - Pragmatic Utility and Value Alignment]] when Pillar values become targets replacing Pillar realization; repair the FPF-level content effect, delete or relocate proof material, and record checked no-proposal only when no non-dominated Pillar-content move remains. |

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:9 - Relations

| Pattern | Relation |
|---|---|
| [[00_E.02 - The Eleven Pillars]] | Supplies Pillar names and meanings. |
| [[01_A.19.ECS - Evaluation CharacteristicSpace Construction]] | Supplies construction discipline for object-under-improvement evaluation characteristic spaces. |
| [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Evaluates one pattern version; may supply evidence loci. |
| [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] | Evaluates one `DRR`; may supply evidence loci. |
| [[00_E.24 - U.Ontic and Ontic Introduction Discipline]], [[01_E.24.CD - Ontic Candidate Detection]], [[02_E.24.PUB - Ontic Description and Publication Discipline]] | Govern ontic concept introduction, candidate detection, ontic-description and publication discipline, and publication-boundary repairs whose FPF-level Pillar effect may be evaluated here. |
| [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] | Frames the quality-evaluation purpose when needed. |
| [[00_E.23 - Quality Improvement Loop Method]] | Runs repeated improvement after values or proposal rows exist. |
| [[00_E.13 - Pragmatic Utility and Value Alignment]] | Governs pragmatic utility and proxy-to-value alignment when Pillar values, corpus indicators, review result, or projection evidence become substitutes for realized FPF value. |

| [[00_E.10 - Unified Lexical Rules for FPF]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], [[02_C.16.Q - Quality-Term Precision Restoration]], [[00_F.18 - Local-First Unification Naming Protocol]] | Govern local precision and naming repair. |
| [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]], [[03_E.17 - Multi-View Publication Kit]], [[00_I.02 - Expanded Entry Disambiguation Cases]] | Govern entry, projection, publication, description, and expanded entry-disambiguation roles that may affect Pillar adequacy. |
| [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.09 - Parity and Benchmark Harness]], [[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator]] | Govern OEE, NQD, pool, selected-set, parity, and refresh semantics when those semantics are claimed. |
| [[00_C.29 - Mathematical Lens Use]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)]], [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | Govern mathematical-lens, characteristic, scale, measurement, and characteristic-space legality when those claims are being made. |

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:10 - Rationale
...
## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:11 - SoTA-Echoing

| Claim | Practice basis | Local adoption |
|---|---|---|
| Pillar meanings stay constitutional, while evaluation checks realized adequacy. | [[00_E.02 - The Eleven Pillars]] constitutional source plus [[01_A.19.ECS - Evaluation CharacteristicSpace Construction]] evaluation-characteristic construction. | [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] evaluates one scoped FPF object without redefining the Pillars locally. |
| Whole-language adequacy needs aim, evidence, change, and learning. | Model for Improvement, PDSA, and PDCA lineage carried through [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[00_E.23 - Quality Improvement Loop Method]]. | The evaluation names declared FPF use, evidence basis, first repair or stop, and reopen condition rather than treating release result as improvement. |
| Feedback needs current state, desired state, next action, and tactics. | Sadler and Hattie and Timperley feedback traditions carried through [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[00_E.23 - Quality Improvement Loop Method]]. | Values, short rationales, evidence loci, proposal rows, and checked no-proposal dispositions stay distinct. |
| Local pattern quality is not whole-FPF adequacy. | Pattern-language entry and projection discipline from `README`, ToC, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]], and [[00_I.02 - Expanded Entry Disambiguation Cases]], plus current [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] and [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] source lines. | [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] and [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]] are evidence loci only when they change Pillar realization; they are not averaged into corpus adequacy. |
| Precision repair can improve wording while damaging use. | [[00_E.10 - Unified Lexical Rules for FPF]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_C.02.P - Epistemic Precision Restoration]], [[02_C.16.Q - Quality-Term Precision Restoration]], [[00_F.18 - Local-First Unification Naming Protocol]], and [[00_F.19 - Ontology-First Plain Technical Rewriting]] precision-restoration lines. | Broad cleanup must show pre-repair and post-repair kind, relation, admissible use, and FPF-level Pillar effect; lexical disappearance is not closure. |
| Multi-coordinate improvement needs trade-offs and non-dominated alternatives. | MCDA, Pareto, ATAM, and QD, OEE, and NQD lines carried through [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]] and [[00_E.23 - Quality Improvement Loop Method]]. | [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] asks what became worse and treats front-like vocabulary as governed semantics, not praise. |
| Pillar-adequacy measures can become targets. | Goodhart and Campbell, management-accounting surrogation, specification-gaming, and reward-hacking lines. | [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace]] forbids all-`5` or `5-defensible` repair targeting; values rise only when the scoped FPF object better realizes Pillars for declared use, and [[00_E.13 - Pragmatic Utility and Value Alignment]] governs any proxy-to-value claim about those values. |

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:12 - Consequences
...
| Local evaluation patterns keep their authority. | [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]], [[01_E.09.DA - DRR Decision-Adequacy Evaluation CharacteristicSpace]], and [[00_E.10 - Unified Lexical Rules for FPF]] are evidence or repair neighbours, not substitutes. | Users must choose the right object under improvement before evaluating. |

## [[01_E.02.DA - FPF Pillar-Adequacy Evaluation CharacteristicSpace|E.2.DA]]:End
