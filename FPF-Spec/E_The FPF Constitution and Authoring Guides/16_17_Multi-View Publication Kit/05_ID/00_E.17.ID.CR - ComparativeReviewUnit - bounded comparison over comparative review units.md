...
builds_on:
  ...
  - "[[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]]"
  - "[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]]"
  - "[[00_E.14 - Human-Centric Working-Model|E.14]]"
  - "[[00_F.09 - Alignment & Bridge across Contexts|F.9]]"
  - "[[01_F.09.01 - Bridge Stance Overlay|F.9.1]]"
coordinates_with:
  ...
  - "[[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]"
  ...
  - "[[00_B.05.02 - Abductive Loop|B.5.2]]"
  - "[[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]"
  - "[[00_C.11 - Decision Theory (Decsn-CAL)|C.11]]"
  - "[[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]"
  - "[[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]]"
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:1 - Problem frame
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:2 - Problem
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:3 - Forces
...
| **Explanation restraint** | Interpretation does not become a shadow face-use discipline system next to [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]]. |
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4 - Solution - comparative review units with bounded comparison, escalation, and boundary rules

### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.1 - Ordinary comparative review-unit move
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.1.b - Compact placement
...
Use [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], `ID.CR`, or `ComparativeReviewUnit` when this bounded comparison unit is the current object. Use the neighboring pattern when the crossed claim becomes primary.

### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.1.c - Why the comparative-review-unit specialization needs its own discipline
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.1.d - Local working vocabulary
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.2 - Scope and exclusions
...
**Out of scope**
- same-entity restatement, conservative rewrite, or representation shift whose main question stays with [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], or [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]];
- bridge-stance overlay that only clarifies an already-declared bridge stance over an existing Bridge Card ([[01_F.09.01 - Bridge Stance Overlay|F.9.1]]);
- explanation-face use discipline, bounded-use boundary, or added-link review on existing faces ([[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]);
- abductive-prompt or action-selection cases ([[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]] or [[00_B.05.02 - Abductive Loop|B.5.2]]);
- ontology-facing reframing or changed EntityOfConcern (`OntologicalReframing` or [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]);
- policy, gate, adjudication, assurance, or work-facing use ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]).

### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.2.a - Working-fit test
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.2.b - Nearest neighboring work
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3 - Working-model first; plain questions first, ordinary minimum second, full declaration third

Most working users do not have to start with a long declaration block.
This pattern therefore follows [[00_E.14 - Human-Centric Working-Model|E.14]]'s working-model-first discipline: the first usable block is a small set of plain questions that helps an engineer-manager keep the review unit bounded to the work it can honestly carry.
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.a - Five plain working questions
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.b - Ordinary minimum block
...
- `baseCasePattern` when the review unit is a mixed case layered over `A.6.3.*` or [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]].
...
`readerFitComparativeClass` by itself does not create an interpretation claim. Bounded correspondence wording that starts implying bridge relation is bridge-mediated comparative relation: it requires an explicit `bridgeCardRef`, or the case applies [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]] before the comparison unit can carry that bridge-mediated source relation. When cross-context bridge semantics govern the case, the actual bridge kind and Bridge Card remain governed by [[00_F.09 - Alignment & Bridge across Contexts|F.9]]. If bridge-mediated comparative relation governs the case, `bridgeCardRef` is required and any `bridgeStanceRef` remains optional and subordinate.
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.e - Interpretant-side block
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.f - Static note versus interactive aid
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.g - Representation ontology and modeling lens (informative)
...
- one bounded-use boundary, one overread-risk line, and one `worldContactPolicy` that remains subordinate to [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] when gate or adjudication claim appears;
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.3.h - Working read-out
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.4 - Branch-discipline summary
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.5 - Neighboring-work boundary glance
...
| --- | --- |
| one local lexical head or qualifier is still doing too much work, but one honest repair would stabilize the same unit | [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it]] (`Local Head Restoration`) |
| the same note is mostly rewriting, reframing, or re-rendering the same EntityOfConcern with no bounded comparative lift | [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism]], [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression]], or [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]] |
| the real job is only to make an already-declared bridge stance explicit over an existing Bridge Card | [[01_F.09.01 - Bridge Stance Overlay]] |
| the comparison wording is now making a relation-precision claim between compared items | [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] |
| the comparison wording is now making sameness, equivalence, alignment, mapping, substitution, or cross-context bridge relation | Part F with [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)]], [[00_F.09 - Alignment & Bridge across Contexts]], or [[01_F.09.01 - Bridge Stance Overlay]] |
...
| the same unit still has unstable reviewed-source, comparative-move identification, or outside-work boundary after local repair | [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern]] (`PublicationUnit Primary EntityOfConcern Discipline`) |
| the real job is explanation-face governance on existing faces | [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]] |
| the comparison now creates an abductive-prompt claim or action-selection question | [[01_B.05.02.00 - U.AbductivePrompt]] or [[00_B.05.02 - Abductive Loop]] |
| the target or ontology is changing and now needs continuity witnesses | `OntologicalReframing` or [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] |
| the unit is now being used as a decision-making claim or decision record | [[00_C.11 - Decision Theory (Decsn-CAL)]] |
| the unit is now being used for execution, gate, or adjudication consequence | [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] |
...
- pressured local lexical head -> [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]] (`Local Head Restoration`);
- stable same-object comparative review unit -> stay with `ComparativeReviewUnit`;
- same unit still unstable after local repair -> [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] (`PublicationUnit Primary EntityOfConcern Discipline`);
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:4.5.a - Ordinary working order for the card
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5 - Archetypal grounding
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.1 - Tell
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.2 - Show (System)
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.3 - Show (Episteme)
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4 - Worked boundary examples

#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.1 - Lower-boundary bridge-stance overlay case
...
Why it stays under [[01_F.09.01 - Bridge Stance Overlay|F.9.1]]:
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.2 - Mixed primary-pattern composition with [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]
...
- [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] still governs the base representation shift;
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.3 - Mixed primary-pattern composition with [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]
...
- [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] still governs explanation class and face bounded use;
- bounded comparison only adds bounded comparative use for one reviewer task;
- [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] still governs explanation-face use; any authority-bearing use must name its governing pattern.

#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.4 - Guided review aid with bounded interaction mode
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.5 - Product and design-review comparison case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6 - Compliance and release-review comparison case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.a - Research-review comparison case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.b - Program and cultural-review comparison case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.c - Exogenous-change stop-and-reopen case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.d - Lighter comparison note with source-return discipline
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.e - Functional versus constructive-description comparison
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.6.f - Method-option comparison without method choice
...
- if the team chooses a method or prepares a work plan, record the selected method as project `U.Method`, record the work plan as `U.WorkPlan` under [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], and use [[01_A.15.01 - U.Work|A.15.1]] only when a dated `U.Work` occurrence is the governed occurrence claim.
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.7 - Upper-boundary prompt-bearing case
...
- the selected governing pattern is [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]] or [[00_B.05.02 - Abductive Loop|B.5.2]] through explicit `U.AbductivePrompt` publication.

#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.8 - Same-entity viewing boundary case
...
- the more precise governing pattern is [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]].

#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.9 - Ontology-boundary anti-case
...
#### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:5.4.10 - Authority and gate misuse anti-case
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:6 - Bias-Annotation
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:7 - Conformance Checklist
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:7.1 - ID.CR-Core ordinary checks
...
### [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:7.2 - ID.CR-Conditional checks

1. **CC-ID-4 - Base-case governing-pattern relation is explicit.**
   A reviewer can tell why the case does not really belong to `A.6.3.*`, [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], `B.5.2(.0)`, `OntologicalReframing`, or [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:8 - Common Anti-Patterns and How to Avoid Them
...
| **Bridge gloss inflation** | A helpful comparative sentence starts acting like a bridge licence the declared bridge card and stance do not allow. | Keep bridge-mediated comparative relation tied to required `bridgeCardRef`; use optional `bridgeStanceRef` only as a subordinate overlay under [[01_F.09.01 - Bridge Stance Overlay]]. |
...
| **Explanation-face laundering** | Interpretation language is used to avoid explicit [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]] class and bounded-use review. | If face class or bounded connective prose is primary, stay with [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]]. |
...
| **EntityOfConcern shift** | A changed target is mislabeled as interpretation because the prose still sounds comparative. | Apply `OntologicalReframing` or [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] once continuity witnesses or changed target govern the claim. |
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:9 - Consequences
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:10 - Rationale
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:11 - SoTA Alignment: Adopted And Adapted Invariants And Rejected Shortcuts
...
## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:12 - Relations
- **Citation.** Cite this pattern as [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], `ID.CR`, or `ComparativeReviewUnit` when the current object is one bounded comparative review unit. Use [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] when the intended pattern is `ConservativeRetextualization`.
...
- **Builds on:** [[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], Part F, [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]], and [[00_E.14 - Human-Centric Working-Model|E.14]].
- **Coordinates with:** [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], Part F, [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]], [[00_B.05.02 - Abductive Loop|B.5.2]], `OntologicalReframing`, [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].
...
- **Local repair neighbors.** Use [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]] only when a local lexical head or qualifier still destabilizes the same unit; use [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] only when the reviewed-source, publication-unit, comparative-move, or outside-work boundary is still unstable after local repair.

## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:12a - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When a bounded comparative review unit uses a mathematical comparison criterion, rival lens, invariant, obstruction, or structural similarity, [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] still works over comparison unit, viewpoint, comparison criterion, review-unit boundary, and bounded-use boundary. The applicable [[00_C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) can be cited only for the mathematical-lens use: candidate mathematical object, lens mapping mode, preserved and lost structure, `LensUseAdmissibilityValue`, bounded use, blocked downstream use, and stop condition. It does not create the comparison record, adjudicate rival publications, or authorize bridge, evidence, selector, or benchmark claims outside the comparative-review-unit record.

## [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]:End
