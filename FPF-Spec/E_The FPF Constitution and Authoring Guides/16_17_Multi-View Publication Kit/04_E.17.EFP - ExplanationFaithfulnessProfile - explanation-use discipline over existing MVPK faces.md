...
| --- | --- | --- |
| A `SourcePinnedExplanation` or `SourceLinkedExplanationReconstruction` helps navigation, bounded restatement, or source inspection with pins and trace visible. | A didactic explanation helps onboarding or helps the team find the source, while operative claims still return to the source-pinned face or [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] evidence path. | A fluent explanation is used as assurance, evidence, approval, gate passage, release permission, or work-occurrence evidence. |

**Neighboring project records and governing patterns.** [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/05_ID/00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] governs bounded comparison over a comparative review unit; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] or [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] govern same-entity rewrite or representation change; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] governs a rendering that stays honest only through narrower bounded claim or effect, blocked downstream claim or effect, and reopen to the source `U.Episteme` or source `U.EpistemePublication`; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] or `OntologicalReframing` govern changed EntityOfConcern; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] govern downstream work or reliance, [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] governs assurance and engineering justification, and [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]] or [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] govern gate-bearing claim or effect.

**Common wrong escalations and boundary transfers.** Do not use this profile to hide new claims, bridge-comparison load, action-selection pressure, or gate-bearing guidance inside helpful prose. If the rendering is really a bounded comparison, apply [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/05_ID/00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]; if it is only same-entity rewriting or representation shift, apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] or [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]; if it is a deliberately coarsened rendering whose narrower bounded claim or effect, blocked downstream claim or effect, and source-bearing reopen now govern the case, apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]; if it is already making world, work or reliance, assurance, or gate-bearing claims, leave [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] for the more exact downstream FPF pattern or project-side record.

**Generated-explanation repaired case.** Use this case when a generated explanation is being relied on beyond reader help. The first [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] move is to classify the rendering as source-pinned rendering, source-linked reconstruction, didactic retelling, or speculative retelling. The profile only states the explanation relation, source-finding state, source references, bounded explanation-reader use, blocked downstream use, and reopen condition for the current rendering. The explanation becomes usable for an operative claim only when an [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]-governed evidence path maps that claim to the exact source passage, carrier path, or project-side FPF kind and reference named by value that carries, supports, or exposes the source basis for it in the relying context. If the operative claim would raise assurance, release confidence, safety, trust, gate passage, work occurrence, work authorization, or approval, apply the governing pattern for that operative claim: [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gate decision, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]/[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] for work, [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]/[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] for commitments or speech acts, or another source relation that carries, supports, or exposes the source basis for the operative claim when asserted for that operative claim. If the map or project-side FPF kind and reference named by value is missing, keep only a prospective repair request, source-gap note, or narrower explanation-use note; if operative reliance is still attempted, the applicable [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or other relation governing the asserted use can return evidence-needed, abstain, or no-bounded-current-use for that attempted reliance. Do not open an [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] path for ordinary reader help; otherwise the generated explanation remains reader help, not approval, authorization, evidence, assurance, gate passage, release reliance, or work-occurrence evidence.

**Common wrong first interpretation.** A fluent, confident, source-linked, or reliable-looking explanation is treated as evidence. First honest entry: classify the explanation rendering and use it for reader help or source-finding; only an operative claim with an [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path or another source relation that carries, supports, or exposes the source basis for the operative claim can carry downstream reliance.

Negative result: if a generated explanation says "reliable" but no operative claim maps to a source relation, the [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] result is source-finding only or reader help only. If an attempted downstream reliance is still raised, the receiving [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or other relation named by value can return evidence-needed or no-bounded-current-use for that attempted reliance. It is not weak evidence by style, confidence, fluency, or citation-like wording.
...
**Placement.** Profile governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] review.
**Builds on.** `E.17.0 U.MultiViewDescribing`; [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] MVPK; [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]; [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/05_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts|F.9]]; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]].
**Coordinates with.** `ConservativeRetextualization`; `RepresentationSchemeTransition`; `E.17.ID.CR ComparativeReviewUnit`; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]]; [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]]; [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:1 - Problem frame
...
FPF already has [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] for viewpoints, views, and correspondences, and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] for typed publication faces. A compact review profile is still needed to say what kind of explanation-facing rendering is being published, how its source tether to the source `U.Episteme` or source `U.EpistemePublication` is stated, and which bounded use it carries.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4 - Solution — review profile for explanation renderings on existing MVPK faces

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.1 - Informal definition

> `ExplanationFaithfulnessProfile` is a review profile governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] for explanation-facing renderings over already available claims, traces, and pins on existing MVPK faces.
>
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.1.a - Profile, case, and published rendering distinction

`ExplanationFaithfulnessProfile` is a **review profile** governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]. Concrete explanation-facing renderings are passive published renderings or reviewed cases classified under this profile; the profile itself does not act, decide, or publish.
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.1.b - How to read this profile
...
- Faces stay governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]; the profile only constrains what sort of explanation is bounded on them.
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.1.c - Local working vocabulary
...
These are review aids, not new governance kinds. Faces remain governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]; this profile only qualifies explanation behaviour on those faces.

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.2 - Core profile fields
...
- `profilePlacementRef = profile governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]].0`;
- `governingPatternRef = [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]].0`;
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.2.a - Working-model first
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.2.b - What a publication-side reviewer checks first
...
4. Has the rendering quietly begun to add new semantic commitments, new face-like behaviour, derivative-source replacement, or a deliberately coarsened source rendering that needs [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]?
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.2.c - Interpretant-side block
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.3 - Explanation class set
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.3.a - Ordinary class-selection guidance
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.3.b - `SourceLinkedExplanationReconstruction` added-link policy
...
Working rule:
- if `addedLinkPolicy` cannot be stated plainly, the rendering drops to a more restricted explanation class, uses a more restricted MVPK face or named `publication-face kind` value, or leaves [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]];
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.4 - Working bounded-use matrix
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.5 - Shared explanation rule set

#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.5.a. Preservation rule
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.5.b. Loss and reliability rule
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.5.c. Downstream-use and boundary rule
This profile stays explanation-facing and episteme-facing. It does not govern bridge stance, retargeting, action selection, executable docking, gate-bearing claim or effect, assurance, engineering justification, or work enactment. If a case starts carrying one bounded comparative review case, rival interpretations, bridge-mediated comparison load, world consequences, work or reliance consequences, gate consequences, assurance, or engineering justification, apply the neighboring FPF pattern and name the project-side FPF kind and reference named by value that governs that claim or effect ([[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/05_ID/00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/00_B.05.02 - Abductive Loop|B.5.2]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]], [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]).
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.5.d. Composition and reopen rule
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:4.6 - Hard boundary rules
...
- it does **not** license new [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] boundary claims on explanation faces: law claims, use-boundary claims, deontic or commitment claims, and effect or evidence claims;
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5 - Archetypal grounding

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.1 - Source-pinned explanation across multiple faces
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.2 - Source-linked reconstruction
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.2.b - Selected-method explanation
...
This can stay within `SourceLinkedExplanationReconstruction` when the explanation keeps its source references visible and only makes the already source-recoverable selection relation easier to inspect. It is bounded to interpretation, source-finding, and selected-method inspection. It is not evidence that work occurred, not a gate decision, and not engineering justification. Evidence or provenance use requires a project evidence path governed by [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; engineering-justification use requires an engineering-justification record governed by [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; method-selection use requires project `U.Method`, work-plan use requires `U.WorkPlan` under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], and work-occurrence use requires a dated `U.Work` occurrence under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]]; gate use requires the project gate or constraint decision governed by [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]] or [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.2.a - Mixed-face bundle with different explanation classes
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.3 - Didactic retelling
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.4 - Speculative retelling
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.4.a - Anti-example: explanation that quietly becomes a new claim
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.4.b - Anti-example: reader help that quietly becomes policy-bearing use
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.4.c - Boundary to lighter explanatory note with source-bearing return
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.5 - Class-specific reopen cues in the worked slices
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:5.6 - Boundary to interpretation and world or gate use
If the rendering starts generating one bounded comparative review case, rival interpretations, bridge-mediated comparative claims, new hypotheses, world consequences, gate consequences, assurance claims, or engineering-justification claims, it leaves this profile and apply the neighboring FPF pattern and project-side FPF kind and reference named by value that govern the claim or effect ([[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/05_ID/00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/00_B.05.02 - Abductive Loop|B.5.2]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]], [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]).

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:6 - Bias-Annotation
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:7.1 - EFP-Core ordinary checks
...
4. **CC-EF-5 — No new [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] boundary claims on explanation faces.**
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:7.2 - EFP-Conditional checks
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Derivative rendering as source replacement | a fork, adaptation, generated explanation, tutorial, or access-format conversion is treated as the original source because it is easier to read or access | keep it as a derivative rendering, publish source links for operative claims, and use [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] or [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/01_A.06.03.CSC - Controlled Semantic Coarsening]] when reliance or narrowed-use discipline is present |
| Explanation as evidence or assurance | a fluent or source-linked explanation is cited as proof, approval, gate passage, release reliance, work authority, or assurance | classify the rendering, keep ordinary reader help inside [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]], and open [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], or another source relation that carries, supports, or exposes the source basis for the operative claim only for the operative claim being relied on |

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:9 - Consequences
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:10 - Rationale

Explanation help already appears on existing faces, and the nearest failure mode is to let helpful prose shift into hidden source claims, bridge-comparison load, or gate-bearing guidance. [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] gives the reader one practical benefit: they can tell whether a rendering is source-pinned, reconstructive, didactic, or speculative, and therefore whether it can stay as explanation help, needs downgraded use, or has left this profile because the rendering has stopped being only explanation-facing help.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:11 - SoTA Alignment: Adopted And Adapted Invariants And Rejected Shortcuts
...
Action result from the explanation-faithfulness and retrieval-evaluation source set: fluent, source-linked, generated, retrieved, didactic, or pedagogically useful explanations do not become evidence, assurance, approval, gate passage, release reliance, work authority, or operative-claim-source relation by fluency, plausibility, citation-like wording, or retrieved context. The local [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] result is explanation class, source reference, bounded explanation use or source-finding state, blocked downstream use, and operative-claim mapping to [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or another pattern governing the recovered claim only when reliance use is being made. Reopen the explanation-use result when the source claim set, pins, provenance, retrieved context, generated rendering, bounded face, use escalation, or source relation for an operative claim changes.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:12 - Relations
...
- **Primary governing-pattern relation and main neighboring-pattern boundaries:** this profile stays governed by [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]; any shift toward new semantics, coarsened narrowed-claim rendering, or gate-bearing claim or effect leaves the profile.
- **Boundary notes:** bounded comparison over a comparative review unit applies `E.17.ID.CR ComparativeReviewUnit`; explanation-like renderings with declared source-loss mode whose narrower bounded claim or effect, blocked downstream claim or effect, and source-bearing reopen are primary apply `A.6.3.CSC Controlled Semantic Coarsening`; retargeting applies [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; work and reliance consequences apply [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]]; assurance and engineering-justification consequences apply [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; gate-bearing consequences apply [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]] or [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:12a - [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When an explanation-facing rendering uses a mathematical lens as part of an explanation, [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] still governs rendering class, source relation, evidence relation, bounded faces, and forbidden downstream uses. The applicable [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) can be cited only for the mathematical-lens use part: candidate mathematical object, lens mapping mode, preserved and lost structure, exposed invariant or distinction, `LensUseAdmissibilityValue`, bounded use, blocked downstream use, and stop condition. It does not make the explanation faithful, evidence-bearing, or bounded for downstream use by itself.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]:End
