...
**At a glance.** Use [[03_E.17 - Multi-View Publication Kit|E.17]] when one source-backed episteme, episteme-lane view, morphism, or functional relation needs several readable publication faces for different readers without changing the underlying claim.
...
> **Episteme lane.** MVPK treats each face as a `U.View` in the sense of [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] (species `U.EpistemeView`). For any MVPK face, the source is a named `U.Episteme` or episteme-lane `U.View`; the face declares a publication `U.Viewpoint` (`PublicationVPId`) drawn from a `U.ViewpointBundle` ([[01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] and [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]). In the morphism profile, every `Emit_s(f)` has `EntityOfConcernSlot` and `DescriptionContext` target `f : U.Morphism`. In a non-morphism publication, the face names the source episteme named by value, episteme-lane view, EntityOfConcern, or claim relation that the face publishes, and no functorial composition claim is present unless the corresponding FPF pattern supplies it. Slot discipline (`ViewSlot` and `ViewRef`) is inherited from [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] and is not redefined in MVPK.

## [[03_E.17 - Multi-View Publication Kit|E.17]]:1 - Intent
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:2 - Problem frame
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:4 - Forces
...
| **Publication-face independence ([[00_A.07 - Strict Distinction (Clarity Lattice)]])** | Publication preserves EntityOfConcern, Description-episteme, and specification-use boundaries ↔ authors expect rich presentations. |
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1 - Terminology (normative)

* **View** (`U.View`): an episteme-lane view (`U.EpistemeView` in the sense of [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] and [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]) produced under a publication viewpoint. In MVPK each face (`PlainView`, `TechCard`, `InteropCard`, `AssuranceLane`) is such a `U.View`. In the morphism profile its `EntityOfConcernSlot` and `DescriptionContext` target is a `U.Morphism`; in a non-morphism publication, the target is the source episteme named by value, episteme-lane view, EntityOfConcern, or claim relation named by the source.
...
* **Publication vs presentation vs rendering vs representation (guard):**
    * **Publication** = typed projection from existing source epistemes or episteme-lane views into a `U.View` governed by a `publication face/form` or `interop publication form` `publication-face kind` via species of `U.EpistemicViewing` ([[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]). In the morphism profile, the source epistemes are Description epistemes about a morphism, possibly under specification use when [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]], [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], or another neighboring pattern governing the claiming gate grants that use. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] supplies the EntityOfConcern and Description-episteme boundary; publication expression does not turn that boundary into a three-member strict-distinction ontology.
    ...
    * **Rendering** = display layout of a carrier, purely graphical formatting; **`U.Work` on carriers** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]), not a `publication-face kind`.
    * **Representation** = episteme↔referent relation ([[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] through [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]); **not** a publication operation and not a `publication-face kind` operation. Use **publication** and **view** here; treat presentation and rendering as **`U.Work` on carriers** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]).
...
* **No‑mechanism equivalence:** MVPK **is not** a mechanism; any operational activity, such as build, render, or upload work, is **separate `U.Work` by a system on carriers** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]; see **Rule 5 — No Γ-leakage** in §6).
* **ViewpointSpec (`U.Viewpoint`)** — a typed specification that declares stakeholders, concerns, conformance rules, declared **Publication Characteristics**, and pinning requirements per profile. The index set `Σ` consists of identifiers of `U.Viewpoint` instances, typically drawn from `U.ViewpointBundle` species ([[01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] or [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]) (see §5.3).
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1a - Episteme-publication lane binding  *(normative)*
...
**Interface and protocol proximity.** When interface, protocol, schema, boundary, or API wording appears beside a functional-flow description, keep the operational boundary, interface, or protocol claim with its own project claim set and typed project-side value named by value and reference, governed by the relevant FPF pattern such as [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]], or [[00_E.18 - Transformation Flow Structure|E.18]]. Do not absorb it into the functional-flow publication by layout proximity.

**Retargeting.** If the publication changes the EntityOfConcern or retargeting target from an already described component, process, material `U.Entity`, or source claim into a functional, control, or flow architecture claim, this is not a same-entity publication-use change. Use [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], `OntologicalReframing`, or [[00_E.18 - Transformation Flow Structure|E.18]] as applicable.
...
- work-relevant source restoration under [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]];
- project `U.Method`, `U.WorkPlan`, or work-result record under [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]];
- evidence and provenance path under [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]];
- engineering-justification record under [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]];
- constraint or gate decision under [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]];
- supervisory or control architecture record under [[04_B.02.05 - Supervisor-Subholon Feedback Loop|B.2.5]];
- carrier, export, OCR, or front-end record under [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]];
- same-entity textual relation under [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]];
- representation relation under [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]];
- reduced-use-rendering relation under [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]].
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1b - Shared source-relation and bounded-use vocabulary
...
| `independent-verification-present` | A separate check makes the local claim or use available independently of the publication-facing unit only through a named governing pattern and record named by value, such as an [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] evidence path, [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] assurance claim, [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] `GateDecision`, [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]] constraint profile, [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] `U.WorkPlan`, [[01_A.15.01 - U.Work]] dated `U.Work` occurrence, or [[00_F.09 - Alignment & Bridge across Contexts]] Bridge Card. |
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1d - Compact boundary aid for the present claim or effect
...
1. If one local head is the only unstable part, apply [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]] or [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] and stop when the repaired sentence names the local kind, relation, and bounded use.
2. If the bounded `PublicationUnit` or its primary EntityOfConcern interpretation is unstable, apply [[00_E.17.AUD - PublicationUnit Stability Discipline - keep one publication unit stable enough to read honestly|E.17.AUD]] or [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] before using [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] or [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]].
3. If the unit is stable and the present problem is comparison overread, apply [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]; use [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] only when equivalence, recommendation, selection, decision, gate, or release claim is actually being made.
4. If the unit is stable and the present problem is explanation overread, apply [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]; use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] only when evidence, engineering-justification, gate, release, work, or reliance claim is actually being made.
5. If the present problem is a durable reusable name, UTS row, Core-facing term, or cross-context naming relation, apply [[00_F.18 - Local-First Unification Naming Protocol|F.18]]; otherwise keep the lighter local repair pattern.

| Present claim or effect question | Apply or recover |
| --- | --- |
| Is the publication-facing unit being used to guide a work or reliance move by appearance, while the acting user still needs the typed project-side value named by value and reference before proceeding? | [[04_A.15.04 - Work-Relevant Source Restoration]] for the restoration step; the recovered value can then be [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[01_A.15.01 - U.Work]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)]], [[09_A.02.09 - U.SpeechAct (Communicative Work Object)]], [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]], or another typed project-side value named by value and reference. If that exact value is already the question under repair, use it directly. |
| Is the publication-facing unit being used as evidence, provenance, attestation, currentness, freshness, or claim-bound evidence relation? | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] evidence, provenance, or currentness path for the claim named by value. |
| Is the publication-facing unit being used as engineering justification, assurance, confidence, readiness, or limitations relation? | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] assurance or engineering-justification claim with evidence, limits, and decay explicit. |
| Is the publication-facing unit being used as gate passage, constraint validity, adjudication, or release decision source? | [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] project records, including gate profile, constraint profile, decision record, log reference, scope, window, replay reference and freshness reference. |
...
| Did the EntityOfConcern, target, ontology frame, or claim or relation record named by value change? | [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]], `OntologicalReframing`, or the retargeting or reframing pattern named by value. |
| Is the publication-facing unit being used as bridge, substitution, equivalence, "same", "equivalent", "align", or "map" wording, or cross-context comparison relation? | Use Part F and [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)]] for repairing "same", "equivalent", "align", or "map" wording into explicit bridge work; use [[00_F.09 - Alignment & Bridge across Contexts]] or [[01_F.09.01 - Bridge Stance Overlay]] for Bridge Cards, bridge kind, direction, `CL`, loss notes, bounded use, and stance overlays. Comparison alone is not a bridge. |
| Is the question under repair carrier, export, OCR, screen, front-end behavior, or work on carriers? | [[00_A.07 - Strict Distinction (Clarity Lattice)]] and the exact carrier relation, front-end relation, or work-on-carrier record. |

**Evidence-path boundary.** An [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence, provenance, attestation, freshness, or currentness path carries only the claim named by value it instantiates. It does not approve or authorize work, pass a gate, perform work, supply release permission, or raise assurance or engineering-justification use unless the typed project-side value named by value and reference that carries that downstream claim is also instantiated, such as [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1e - Local review fields are not FPF kinds
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.1f - Shared anti-overread invariants for publication-facing units
...
**Measure and display overread.** A number, score, percentage, color, rank, confidence value, similarity value, dashboard state, or measurement display is orientation only until the measurement source, aggregation rule, time window, population or scope, calibration or evidence path, and intended use are governed by the typed project-side value named by value and reference. Evidence-like use applies [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; assurance-like use applies [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; gate-like use applies [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; work or reliance use applies [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] and then the recovered typed project-side value named by value and reference; bridge or substitution use applies [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]].
...
**Same publication-facing unit, multiple interpretations.** A green release dashboard can be one MVPK face for source-finding, an [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] currentness path or evidence path when the evidence query is recoverable, an [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate-decision view when the `GateDecisionRef` is recoverable, or an unsupported release cue when those sources are missing. A generated comparative explanation can be an [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] explanation-use case, an [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] comparison case, a [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] generated-summary case, or source-finding only; it is never all of those under one shared evidence-relation class or bounded-use value by fluency alone.
...
- **Generated explanation with source links.** A generated text explains a method and cites sources. The explanation rendering is not source replacement. Source links carry only the pinned operative claims they actually carry. If work or reliance is present, use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for the evidence path named by value or keep the rendering as reader help; if the rendering is deliberately reduced-use, use [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]].
- **Comparison table.** A table compares two methods and places one first. Ordering is not selection. The comparator or sorting relation, source references, shared review frame, and unsupported downstream claim remain visible. Choice or decision needs [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]]; equivalence or bridge relation needs [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]].
- **Unrecovered source wording.** A draft uses source-object wording, undeclared interpretive-view shorthand, or generic unit wording without naming the FPF kind. Recover the FPF kind stack instead of minting source-relation pseudo-kinds or undeclared interpretive-view pseudo-kinds. Use `PublicationUnit` only when a bounded reader-inspected unit inside a publication is present; otherwise use the exact episteme, view, publication, carrier relation, section of a named non-pattern FPF publication form whose reader-help function and reference are recoverable, [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] relation claim, or typed project-side value named by value and reference.
- **Translated tutorial.** A translated tutorial can improve reader access to an FPF pattern. It is a derivative rendering, not the original source. Operative claims need source mapping for reliance, translated heads can need [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]] or [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]] is present only when durable naming, UTS, Core-facing, or cross-context naming work is intended.
...
- A comparison table appears to select option B. Block the selection interpretation when no [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] `ChoiceResult`, decision record, or visible selection relation exists. Useful publication use remains: use the table as a bounded comparison under [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], or apply [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]] when selection is intended.
...
- A generated explanation appears to prove a causal relation. Block the evidence or assurance interpretation when source pins and evidence path are absent or insufficient. Useful publication use remains: use the explanation as reader help or source-finding, then apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] only for the evidence named by value or engineering-justification claim they govern.

- [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] prevents the wrong object from being treated as source, the wrong relation from being treated as source relation, and a loose phrase from being treated as an FPF kind.
...
- [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] prevents a comparison unit from being used as decision, equivalence, bridge, evidence, or release source relation.
- [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] prevents fluent explanation from laundering unsupported claims into reliance, assurance, gate, or evidence use.
- [[03_E.17 - Multi-View Publication Kit|E.17]] MVPK prevents a readable publication face from being treated as evidence, gate, work, authority, or release source relation by display quality.
- [[00_F.18 - Local-First Unification Naming Protocol|F.18]] prevents a local name from becoming global identity without context, kind, lineage, and bridge or cross-context naming relation.

**Anti-escalation examples.** Do not apply a neighboring pattern when its claim being made is absent:

- Do not apply [[00_F.18 - Local-First Unification Naming Protocol|F.18]] when a one-off local phrase repair restores the local kind, relation, and bounded use without minting a durable reusable name.
- Do not apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when the publication-facing unit is not being used for reliance, evidence, provenance, currentness, or claim-bound evidence relation.
- Do not apply [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] when a dashboard tile is merely status orientation and no `GateDecisionRef` or gate profile is present.
- Do not apply [[00_F.09 - Alignment & Bridge across Contexts|F.9]] when a comparison does not claim sameness, substitution, bridge relation, or cross-context equivalence.
- Do not apply [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] when the text is only a same-entity rewrite or representation change governed by [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]] or [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]].
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.2 - Declared `publication-face kind` values at Part E
...
`AssuranceLane` can expose evidence bindings, evidence-carrier references, pins, and presence bits. It is not a [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim, readiness or confidence verdict, engineering-justification record, or evidence-sufficiency result. When a published face is used to raise or lower assurance, readiness, confidence, limitation, or engineering-justification result, the governing source relation is [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; the lane only helps recover the cited evidence bindings.
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.3 - The kit (constructs)
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.4 - EntityOfConcern-side input and output vs publication (normative convention)
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.5 - Pin & Publication characteristics (normative; never "axes")
...
* **CharacteristicSpace** (`U.CharacteristicSpace`): a CHR-typed product of slots used by dynamics and measurement theories ([[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]).
...
* **E17-PC-2 (Lexical discipline - no geometry).** Faces and PCs avoid "axis", "dimension", or geometric metaphors; use **Characteristic**, **slot**, **CharacteristicSpace** where applicable (**[[00_E.10 - Unified Lexical Rules for FPF|E.10]]**; see also [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]).
...
* **E17-PC-Ext-3 (Twin-register names).** Supply **Tech** and **Plain** twins; avoid tokens that collide with [[00_E.10 - Unified Lexical Rules for FPF|E.10]] bans; do not coin "...Space" names for publication forms.
...
3. Update the relevant **GateChecks** or **GateProfiles** ([[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], including GateCrossing checks and crossing-visibility checks from [[00_E.18 - Transformation Flow Structure|E.18]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], and relevant Part G bridge or crossing wiring) to warn or block on invariant violations; never weaken functorial invariants.
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:5.6 - Author ergonomics (non‑normative)
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:6 - Rules and Invariants (normative)
...
3. **Description-source and specification-use sourcing and EpistemicViewing compatibility ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]).**
    ...
    * (b) Each `Emit_s(-)` is realised as a species of `U.EpistemicViewing` ([[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]) over those Description epistemes: entityOfConcern-preserving, effect-free, and conservative in the sense of [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] and [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]. Publication adds no new commitments beyond what is present in the referenced Description episteme.
...
5. **No Γ‑leakage (publication independence).**
    Publication morphisms carry **no** Γ\_method, Γ\_time, or Γ_work semantics. Any build, render, or upload activity is **separate `U.Work` by a system on carriers** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]).
...
6. **Carrier provenance.**
    Every emitted view records its **SCR/RSCR ids** on first occurrence ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] §5.6).
...
8. **Cross‑Context and ReferencePlane bridging.**
    * If a view crosses contexts or reference planes, it cites the **Bridge + CL policy ids** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] §5.8, bridge crossing). Such crossings are explicit on `TechCard` and `AssuranceLane`.
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:7 - Structure & participants
```
                 Σ_viewpoints
                      │
            ┌─────────┴─────────┐
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:8 - Examples (SoTA-aligned Local Tests)
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:9.1 - Core ordinary checks
...
### [[03_E.17 - Multi-View Publication Kit|E.17]]:9.2 - Conditional checks
...
| **CC-MVPK-3b (Boundary claim-set integrity)** | If a published arrow is a boundary, interface, or protocol and an [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]] claim set exists (`L-*`, `A-*`, `D-*`, and `E-*`), then normative text on faces is traceable to that claim set (prefer claim-ID citations); faces do not become a second boundary specification. | Lint flags uncited normative clauses; faces reduce to {claim-ID citations + informative commentary}. |
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:10 - Anti‑patterns (with fixes)
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:11 - Consequences
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:12 - SoTA Alignment: Adopted And Adapted Invariants And Rejected Shortcuts
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:13 - Relations

* **Builds on:** [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] for carrier and front-end discipline plus the EntityOfConcern and Description-episteme boundary and specification-use gates; [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]-[[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] for episteme morphisms, `U.EffectFreeEpistemicMorphing`, and `U.EpistemicViewing`; [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] for `U.MultiViewDescribing`; [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] and [[00_E.10 - Unified Lexical Rules for FPF|E.10]] for authoring and publication-language discipline; Part F and Part G for bridge, terminology, characteristic, and pin discipline.
...
* **Part F bridge wording boundary:** when the publication face uses or invites "same", "equivalent", "align", "map", substitutable, interchangeable, attribute, entity, or profile matching, or other bridge-wording claim pressure across contexts, the wording repair belongs to Part F and [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]]; the bridge relation belongs to [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]]. [[03_E.17 - Multi-View Publication Kit|E.17]] does not create a local bridge taxonomy.
* **Coordinates with:** B-operators for no Gamma-leakage, C-cluster selection or archive patterns where views remain publication faces rather than selections, CHR and UNM for measurement and normalization semantics, [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]] for bridge relation, [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]] for sameness wording, and the neighboring source patterns named above. This section names relation and neighboring-pattern boundaries for publication use; the operative governing claim or effect still comes from the present case and the compact boundary aid in `E.17:5.1d`.

## [[03_E.17 - Multi-View Publication Kit|E.17]]:14 - Minimal authoring template (Part E)
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:15 - Manager’s one‑page review (copy‑paste)
...
## [[03_E.17 - Multi-View Publication Kit|E.17]]:End
