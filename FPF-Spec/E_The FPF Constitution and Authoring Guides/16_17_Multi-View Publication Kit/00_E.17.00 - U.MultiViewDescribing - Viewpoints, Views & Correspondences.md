...
* `U.View` is the selected short form for `U.EpistemeView`, i.e. an **episteme-side view**, not a document or file. Views are epistemes; literal `publication face/form` and `interop publication form` are accepted `publication-face kind` values under publication-face-kind discipline; concrete renderings and carriers remain [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], SCR, and RSCR concerns.
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:1 - Problem frame  *(informative)*
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:2 - Problem  *(informative, but sharp)*
...
3. **Each domain reinvents multi‑view semantics.**
   ...
   * [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]], MVPK, and discipline packs introduce their own “view” rules and invariants, duplicating work;
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4 - Solution — `U.MultiViewDescribing` as the universal multi‑view scaffold  *(normative core)*

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.1 - Overview
...
* a `BoundedContextRef` ([[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/04_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]]) forming a **DescriptionScope** together with the entity.
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2 - Core constructs

#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.1 - `EntityOfConcernClass` and DescriptionScope
...
2. **DescriptionScope (informal).**
   ...
   * all views (`U.View`) attached to this family preserve that `EntityOfConcernRef` and `BoundedContextRef` (for Description-derived or specification-use-derived views).
   ...
   Formal USM treatment of `U.DescriptionScope` is fixed in [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] and publication-face-kind discipline; here we only rely on the intuition “**we are describing this thing, in this context**”.

#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.2 - `U.Viewpoint` (viewpoint specification)

`U.Viewpoint` is already introduced in [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] as the ValueKind of `ViewpointSlot`; [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] fixes its **internal structure** for describing families.
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.3 - `U.View` (episteme-side views)
...
* `EntityOfConcernSlot`,
* `ViewpointSlot`,
* `ReferenceSchemeSlot` (and usually a `RepresentationSchemeSlot` in [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]+).
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.2.4 - `U.CorrespondenceModel` (view–view correspondence)
...
`CorrespondenceModel` is **used, but not defined, by [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/07_03_U.EpistemicViewing - EntityOfConcern-preserving morphism/00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]**: species of `U.CorrespondenceEpistemicViewing` reference it when computing views that depend on multiple epistemes or representation regimes.

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3 - Multi‑view families and their rules and invariants (MVD‑0…MVD‑7)  *(normative)*

We now fix the rules and invariants that any `U.MultiViewDescribing[EntityOfConcernClass]` instance must satisfy.

#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.0 - MVD‑0 - Family objects
...
#### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.1 - MVD-1 - Viewpoint locality and totality for Description-episteme and specification-use cases
...
1. **Viewpoint-totality for Description-episteme and specification-use cases.**
   ...
   * deterministically derived from a `U.ViewpointBundle` the family declares (see [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]]).
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.2 - MVD‑2 - Views are EpistemicViewing results
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.4 - MVD‑4 - CorrespondenceModel for cross‑view correspondences
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.5 - MVD‑5 - Separation from publication (MVPK)
...
* MVPK ([[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]) sits **on top**:
...
MultiViewDescribing therefore **does not re‑define EntityOfConcern-to-Description or specification-use refinement** (`Describe_EoC_DescEp` plus `specificationUseRef` when a neighbouring gate grants specification force) and does not introduce any `U.Work` on carriers; [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] carries the describing boundary, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] and neighboring pattern governing the claiming gates carry specification-use refinement, and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] carries publication.
...
### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.6 - MVD‑6 - EntityOfConcern and Description-episteme boundary and specification-use alignment

For any `U.MultiViewDescribing` instance:

1. Every `…Description` and `…Spec` episteme in the family must satisfy [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/05_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]]:
...
2. Viewings and correspondence operations **must not**:
   ...
   * reinterpret EntityOfConcern without going through [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]] retargeting.

### [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:4.3.7 - MVD‑7 - Slot discipline

All constructs in this pattern **must** respect `U.RelationSlotDiscipline`:

* SlotKinds (`EntityOfConcernSlot`, `ViewpointSlot`, `ViewSlot`, `GroundingHolonSlot`, `ClaimGraphSlot`, `ReferenceSchemeSlot`) and their ValueKinds and RefKinds follow [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]].
* `*Slot` suffix is reserved for SlotKinds; `*Ref` for RefKinds and fields, never for Kinds or objects.
* This pattern reuses [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/00_C.02 - Epistemic holon composition (KD-CAL)|C.2]].1/A.6.5 SlotKind discipline for episteme slots and does not define relation-position discipline for other relations.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:5 - Archetypal grounding  *(informative)*

1. **Engineering holon (TEVB).**
   * `EntityOfConcernClass = U.Holon` (restricted to `U.System`/`U.Episteme`).
   * TEVB ([[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]]) supplies a viewpoint bundle with canonical engineering viewpoints: Functional, Structural, Allocation‑Responsibility, Module‑Interface, etc.
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:6 - Conformance checklist (author’s quick use)  *(normative)*
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:7 - Consequences  *(informative)*
...
* **Slot-specific interoperability.**
  [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/00_C.02 - Epistemic holon composition (KD-CAL)|C.2]].1/A.6.5 slot discipline applies uniformly; new domains can introduce viewpoint bundles and multi‑view families without inventing new ontologies for view positions or relation positions.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:8 - Rationale & SoTA‑echoing  *(informative)*
...
## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:9 - Relations  *(informative summary)*

* **Builds on [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.EpistemeSlotRelation`.**
...
* **Constrains [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] (MVPK).**
...
* **Constrains [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles|E.17.1]] / [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle|E.17.2]].**
...
* **Coordinates with A.2/A.2.1/A.15 and the Part F role-description and role-name cluster.**
  Viewpoints' stakeholder families and concern entries may mention work-facing roles, holders, assignments, responsibilities, or role names, but those claims remain governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]], [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], and Part F. MultiViewDescribing does not overload `U.Role` as a slot value in EntityOfConcern and Description-episteme boundary and specification use or episteme slot relations.

## [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]:End
