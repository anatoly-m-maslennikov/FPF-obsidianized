...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:2 - Problem
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3 - Solution
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.1 - Pairwise plain glosses
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.2 - Ordinary working card
...
- if rows 1-5 stabilize locally and the remaining question is one bounded comparative review move over already pinned source epistemes or publications, apply [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] rather than thickening this local lexical-head repair pattern;
- if rows 2-5 still cannot stay stable because the same publication unit keeps borrowing a different object, move, or outside-work boundary from the same local lexical head, apply [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] instead of pretending one more qualifier will rescue the same unit.
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.3 - Load-bearing extension
...
It is for the stay-local repair disposition, not for re-deciding whether the case really belongs in [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] or [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]].
If the ordinary card now shows one stable local repair plus one bounded comparative review question, apply [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] before opening the extension.
If the ordinary card still shows publication-unit reading instability after local repair, apply [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] before adding declaration weight here.
Do not use it to rescue a unit whose publication-unit reading still shifts, and do not turn it into a second rule sheet.

### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:3.4 - Ordinary repair order
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:4 - Quick worked-slice starter
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.1 - `review` is really carrying two jobs
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.2 - `text` quietly shifts into carrier or document status
...
### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.4 - Local repair selects bounded comparison
...
Once that local lexical head is repaired, do not keep thickening this pattern by habit. The admissible next pattern application is [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] for the now-stable unit, because the remaining question is one bounded contrast rather than publication-unit EntityOfConcern instability.

**Recovery reading.** This is the honest bounded-comparison disposition: finish the local repair here, then let [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]] carry the remaining bounded contrast over the now-stable unit.

### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.5 - Local repair exposes publication-unit reading instability and must apply whole-unit discipline
...
**Recovery reading.** This is the admissible publication-unit stabilization move case: stop thickening the local repair, keep the restored local lexical head as the last honest local result, and apply [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] because the same unit still has unstable reading after one honest repair.

### [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:5.6 - Outside observation changes what the same head can honestly carry
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:6 - Boundary dispositions
...
Treat those as neighboring recoveries, not as a required sequence. Some cases will stop after one local repair, some will apply bounded comparison under [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], and some will apply publication-unit stabilization under [[02_E.17.AUD.OOTD - PublicationUnit Stability Discipline and PublicationUnit Primary EntityOfConcern Discipline - publication-unit stability over one primary EntityOfConcern|E.17.AUD.OOTD]] once the honest question changes.

## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:7 - Consequences
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:8 - SoTA-Echoing
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:9 - Relations
...
## [[01_E.17.AUD.LHR - PublicationUnit Stability Discipline and Local Head Restoration - repair the overloaded local lexical head before the publication unit inherits it|E.17.AUD.LHR]]:End
