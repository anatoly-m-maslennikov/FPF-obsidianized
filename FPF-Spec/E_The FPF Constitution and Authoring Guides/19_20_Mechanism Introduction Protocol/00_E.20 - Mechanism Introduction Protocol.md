...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:1 - Problem frame
...
**Use this when.** Use [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]] when a proposed FPF change introduces or revises mechanism meaning, suite denotation, suite closure, suite obligations, suite pins, suite protocol semantics, planned-baseline pins, wiring semantics, governing-definition assignment, or what a citeable token denotes.
...
**What this buys.** [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]] gives the reader one current authoring move: assign the change to the right governing definition and keep mechanism, suite, planning, wiring, and lexical continuity distinct.
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4 - Solution — the Mechanism Introduction Protocol (MIP)

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.0 - Terminology note (disambiguation)
...
* **Local wording or alias-docking only:** wording clarifies an already-governed mechanism relation, or [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] alias docking preserves citeability of an old token without changing what the token denotes.
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.0.1 - Mint vs reuse
...
**Reuses:**
* `U.Mechanism` definition cards and `MechanismDefinitionRef`, suite descriptions (`MechSuiteDescription` and specializations), WorkPlanning plan items (`SlotFillingsPlanItem` and specializations), alias docking ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]), RSCR triggers ([[G_Discipline SoTA Patterns Kit/00_Core_Part G Core Invariants/00_G.Core - Part G Core Invariants|G.Core]]), and PQG profiles ([[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]).

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.1 - Step 1: Classify the introduction
...
2. **New mechanism definition within an existing [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] mechanism kind** (new `MechanismDefinitionRef`, new canonical card).
...
8. **Deprecation / supersession / retirement** (marking mechanisms/suites/plan items as deprecated, declaring successors, and preserving citeability; apply [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9.1).

**Mechanism kind boundary.** A MIP-run may introduce a new `MechanismDefinitionRef`. It does not introduce a new [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] transformation-flow locus kind or transformation-flow structure unless [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] is explicitly updated, and it does not introduce a new [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning|C.3]] `U.Kind` unless [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning|C.3]] and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] discipline is the current governing question.

**[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] compatibility.** MIP assigns mechanism meaning to A.6.1-governed mechanism definitions: operation algebra, law set, admissibility conditions, `SlotIndex`, per-operation `SlotSpec`s with required input and output `SlotKind`s, transport or bridge regime, applicability, audit, and monotone realization relation when declared. Suites, planned-baseline records, and Part-G wiring modules may cite or bind that meaning; they do not supply or redefine it.

**New mechanism-family criterion.** Treat a change as a new mechanism family, species, or archetypal grounding only when the existing mechanism-governing pattern cannot express the operation algebra, law set, admissibility conditions, `SlotIndex`, per-operation `SlotSpec`s, required input/output `SlotKind`s, transport boundary, audit semantics, or monotone realization relation when declared without changing its kind invariants. Otherwise classify the change as a new mechanism definition or `MechanismDefinitionRef` within an existing [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] mechanism kind.
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.2 - Step 2: Declare the governing-definition assignment map (mandatory)
...
* the change class(es) from [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.1 when needed to disambiguate the assignment,
...
* the best-known Delta-Class (`Δ-0` to `Δ-3`) and impact radius estimate ([[E_The FPF Constitution and Authoring Guides/14_15_Lexical Authoring & Evolution Protocol (LEX-AUTH)/00_E.15 - Lexical Authoring & Evolution Protocol (LEX-AUTH)|E.15]]) when the run is plausibly `Δ-2` or `Δ-3`,
* intended RSCR trigger types when a refresh or regression-wiring claim is present, and
* the PQG ([[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]) profile set when the run crosses an E.19-governed review boundary.
...
| Suite membership, obligations, spec pins, and suite protocols | **Suite-governing pattern** | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms]] or `A.6.7.<FamilyKey>` | SHALL NOT carry mechanism semantics, acceptance thresholds, gate criteria, DecisionLogs, or publication tails into the suite. |
| Planned baseline pins (planned slot fillings, edition-pinned refs, explicit time selector) | **WorkPlanning governing pattern** | [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/03_A.15.03 - SlotFillingsPlanItem]] plus suite-specific specialization when needed | SHALL NOT embed launch values, witnesses, or gate decisions in planning. |
| SoTA method, comparator, or generator **definitions**, including provenance and evaluation semantics | **SoTA-pack governing pattern** | [[G_Discipline SoTA Patterns Kit/03_02_SoTA Harvester & Synthesis/00_G.02 - SoTA Harvester & Synthesis]] (SoTA synthesis packs) | SHALL NOT rephrase SoTA evolution as kernel semantics. |
...
| Token renames and drift management | **Lexical governing pattern** | [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] (alias docking) plus registers per E.10/F.17 | SHALL NOT silently rewrite tokens or break citations. |
| Change-cause taxonomy and regression triggers | **RSCR governing pattern** | [[G_Discipline SoTA Patterns Kit/00_Core_Part G Core Invariants/00_G.Core - Part G Core Invariants]] | SHALL NOT invent ad hoc “reason kinds” scattered in patterns. |
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.3 - Step 3: Card-first canonicalization (eliminate dangling refs)
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.4 - Step 4: Mechanism semantics completion (what “done” means)

**Definition-of-done note (delegated).** MIP uses two completion checkpoints for mechanism cards:

* **Stub done** - a citeability stub for a `MechanismDefinitionRef`: a resolvable canonical target created only to prevent dangling references ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.3), not semantic completion.

 A stub **SHALL** (i) exist at the mechanism-governing pattern's canonical location, (ii) reserve and publish the stable `MechanismDefinitionRef` (and its lexical/register entries), (iii) set `MechanismDefinitionHeader.status = draft`, and (iv) carry an explicit DRR pointer for completing semantics. A stub **SHALL** also list the *[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]* conformance checklist item IDs it does **not** yet satisfy (without duplicating that checklist here). A stub may preserve citeability for suite or protocol enumeration, but it does not authorize suite closure, gate checks, planned baselines, wiring consumption, reuse, or import unless the fields required for that use are present and marked current.

* **Introduced done** - a mechanism card that can be relied upon as a `U.Mechanism` definition. "Introduced done" is defined by *[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]* conformance: the card **SHALL** satisfy the applicable *[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]:7 Conformance Checklist* items (**CC-UM.\***), with the baseline items designated by *[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]* (e.g., **CC-UM.0** and **CC-UM.1**) being the minimum requirement.

The list below is **informative** only (semantic orientation); the normative structure and “done” criteria are delegated to *[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]*’s CC items to avoid drift between this protocol and the canonical mechanism definition.
...
* **Specialisation discipline (when `⊑/⊑⁺` is declared):** explicit parent+morphism kind; SlotKind invariance; monotone ValueKind narrowing; no new mandatory inputs to inherited operations (per [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]:4.2.1 / CC‑UM.8).
...
If the mechanism introduces new slot kinds shared across a family/suite, apply [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.5.

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.5 - Step 5: Suite-scoped slot-token lexicon discipline (prevent slot drift)

If the mechanism belongs to a suite or family where multiple member mechanisms share slot vocabulary:

1. The suite-governing pattern SHALL provide a **suite-scoped slot-token lexicon** referencing [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] SlotSpecs (or update it if already present) in the suite-governing pattern's canonical location ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]] / `A.6.7.<FamilyKey>`), or as a dedicated lexicon card explicitly referenced from there. The lexicon cites and organizes SlotKind tokens; it does not create new SlotKind semantics.

2. Mechanism cards SHALL cite slot kinds from that lexicon (rather than minting local near-duplicates).
3. New slot kinds SHALL be introduced into the lexicon first, then referenced by member mechanisms. If any citeable `SlotKind` tokens are minted/renamed, apply [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9.
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.6 - Step 6: Suite integration (if the mechanism is a suite member)
...
**Kernel stability rule (recommended).** If the suite is a kernel suite, and the change adds a new required stage, prefer creating a **suite variant** rather than mutating the kernel membership. If mutation is unavoidable, pair it with terminology continuity ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9) and RSCR triggers ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.10).

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.7 - Step 7: Planned baseline & P2W planning-to-work boundary (if planning changes)
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.8 - Step 8: Wiring & SoTA updates (keep method evolution out of kernel)

If the introduction involves methods, comparators, selectors, or other SoTA-sensitive choices:

1. Put method/comparator family semantics in **SoTA packs** ([[G_Discipline SoTA Patterns Kit/03_02_SoTA Harvester & Synthesis/00_G.02 - SoTA Harvester & Synthesis|G.2]]) and reference them by edition-pinned refs.
2. Pin the chosen SoTA refs for a baseline in WorkPlanning plan items ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.7); wiring consumes pins rather than silently overriding them.
...
5. If a SoTA update changes a mechanism's signature/laws, that semantic change SHALL be performed in the mechanism-governing pattern, under the [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] mechanism-definition template; the change SHALL emit RSCR triggers ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.10).

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9 - Step 9: Terminology continuity (alias docking)

If the introduction renames any public token or changes canonical naming:

1. Use lexical alias docking ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]) so old tokens remain citeable.
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9.1 - Deprecation / supersession / retirement (preserve citeability)

If the change class includes deprecation/supersession/retirement ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.1 #8), the MIP-run SHALL preserve reference continuity while making the status change explicit:
...
2. **Keep the public token citeable.** The deprecated token (`MechanismDefinitionRef`, suite token, plan-item token, etc.) SHALL remain citeable. If a successor token/name is introduced, the old token SHALL be alias-docked per [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.9).
...
4. **Assign downstream updates to governing definitions.** Any needed suite denotation, closure, obligation, pin, protocol-semantic, WorkPlanning-pin, or wiring-semantic change SHALL be performed in its respective governing definition ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.2), preferably by introducing a suite variant rather than silently swapping kernel membership.
5. **Emit RSCR triggers.** Deprecation/supersession SHALL emit typed RSCR triggers and extend the regression envelope ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.10), including checks for dangling refs and alias coverage.

### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.10 - Step 10: RSCR triggers + regression envelope
...
**Guard (normative).** Trigger kind identifiers (e.g., `RSCRTriggerKindId`) SHALL be selected from the RSCR trigger catalogue governed by [[G_Discipline SoTA Patterns Kit/00_Core_Part G Core Invariants/00_G.Core - Part G Core Invariants|G.Core]]. A MIP-run SHALL NOT mint ad hoc trigger kinds (“reason kinds”) scattered in arbitrary patterns/modules.
...
### [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:4.11 - Step 11: Apply PQG profiles ([[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]) and close the run

Every MIP-run SHALL be reviewed using PQG ([[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]) with:
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:6 - Bias-Annotation
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:7 - Conformance Checklist (normative)
...
**Conformance groups.** Ordinary [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]] use starts with trigger triage and stops at the current governing locus when no denotation or mechanism-meaning change is present. Manifest-core items apply only when a MIP-run is actually triggered. Publication/assurance items apply only when citeability, card stubs, alias docking, RSCR, PQG, or deprecation continuity is part of the current claim. Crossing, launch, and work-enactment checks are not governed by [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]; if those claims become present, use the gate, planning, or work loci and keep [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]] to governing-definition assignment.

| ID | Requirement | Purpose |
|---|---|---|
| **CC-E20-0 (MIP trigger triage).** | Every proposed mechanism, suite, planned-baseline, wiring, governing-definition, or citeable-token edit is classified as `MIP not triggered`, `local wording or alias-docking only`, or `MIP-run manifest required` before [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol]] is cited to start a MIP-run. | Prevents pure currentness cleanup from becoming a false runtime gate or expanded authoring event. |
...
| **CC‑E20‑10 (PQG coverage).** | Every MIP-run **SHALL** be reviewed under PQG ([[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]]) with PCP‑BASE and the triggered profiles implied by the change. | Normalizes review and refresh. |
| **CC‑E20‑11 (Deprecation preserves citeability).** | Any deprecation/supersession/retirement action **SHALL** preserve citeability of the deprecated token (alias docking if renamed), keep the canonical mechanism card, suite description, plan item, or wiring module resolvable, and declare a successor pointer or “no successor” explicitly ([[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol]]:4.9.1). | Prevents broken citations and orphaned semantics during evolution. |

## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:8 - Common Anti-Patterns and How to Avoid Them
...
| **Kernel churn by convenience** | New required stage is added directly to kernel suite membership. | Expands the [[E_The FPF Constitution and Authoring Guides/14_15_Lexical Authoring & Evolution Protocol (LEX-AUTH)/00_E.15 - Lexical Authoring & Evolution Protocol (LEX-AUTH)]] impact radius; destabilizes citations. | Prefer suite variant; if not possible, pair with alias docking and explicit deltas. |
| **Token drift by silent rename** | “Just rename UNM to ...” without aliasing. | Breaks citations and downstream reasoning. | Use [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]] alias docking; update registers explicitly. |
| **MIP as gate surrogate** | A MIP-run manifest is treated as a runtime pass/fail result or gate passage. | Governing-definition assignment is being mistaken for project execution or gate decision. | Keep MIP as authoring-side governing-definition assignment; use [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] for gate decisions and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] for work or enactment claims. |
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:9 - Consequences
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:10 - Rationale
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:11 - SoTA-Echoing

| SoTA source idea | FPF invariant | Reader use | Rejected shortcut |
| --- | --- | --- | --- |
| Mechanism semantics in [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind]], effects-handler practice, and refinement-style signature discipline require an explicit operation/signature/law/admissibility locus. | Mechanism meaning is assigned to A.6.1-governed mechanism definitions: operation algebra, law set, admissibility conditions, `SlotIndex`, required input/output `SlotKind`s, per-operation `SlotSpec`s, transport/bridge regime, applicability, audit, and monotone realization relation when declared. | When a mechanism is introduced or changed, name the mechanism-governing definition that carries those semantic fields before suites, plans, or wiring cite it. | Treating suite text, wiring prose, or a MIP manifest as mechanism semantics. |
| SoTA method evolution is carried by SoTA synthesis packs, shipping boundaries, and refresh wiring rather than silent kernel mutation. | [[G_Discipline SoTA Patterns Kit/03_02_SoTA Harvester & Synthesis/00_G.02 - SoTA Harvester & Synthesis]], [[G_Discipline SoTA Patterns Kit/11_10_SoTA Pack Shipping/00_G.10 - SoTA Pack Shipping]], and [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator]] own method-evolution apparatus: SoTA packs, release/shipping boundary, and refresh wiring. If the SoTA change alters mechanism meaning, the mechanism-governing definition changes. Current-source examples are usable only through named pack refs, such as SLSA v1.2 for provenance and attestation discipline, RO-Crate 1.2 for research-package publication discipline, QDax JMLR 2024 for QD-library practice, or a named current domain survey or source when that domain claim is present. | Tie a mechanism-changing SoTA update to the SoTA pack or source ref named by value and the refresh or shipping locus, then edit the mechanism-governing pattern if semantics changed. | Rephrasing a fashionable method update as kernel semantics or hiding it in wiring. |
| Open-ended and set-valued method evolution may return candidate sets, archives, or selector outputs. | [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]], [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor]], and [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry]] preserve set-return and selection boundaries; MIP must not force one approved mechanism too early. | Keep candidate mechanisms, selected sets, abstain/reject states, and archive semantics in their receiving loci until a mechanism-governing definition is actually selected for introduction. | Collapsing open-ended exploration or selector output into one prematurely approved mechanism. |
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:12 - Relations

**Builds on:**
* **[[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]** (pattern structure and normative authoring discipline)
* **[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]] / [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]]–[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]** (lexical registers, twin labels, alias docking)
* **[[E_The FPF Constitution and Authoring Guides/18_19_Pattern Quality Gates- Review and Refresh Profiles/00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]** (PQG/PCP profile-based review)
* **[[E_The FPF Constitution and Authoring Guides/14_15_Lexical Authoring & Evolution Protocol (LEX-AUTH)/00_E.15 - Lexical Authoring & Evolution Protocol (LEX-AUTH)|E.15]]** (evolution discipline; DRR/edition thinking)

**Coordinates with:**
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]** (`U.Mechanism` definition template governance)
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]** (`MechSuiteDescription` integrity)
* **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/03_A.15.03 - SlotFillingsPlanItem|A.15.3]]** (`SlotFillingsPlanItem` and planned baseline seam)
* **[[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]]** (`TransformationFlowStructure` values that cite planned baselines)
* **[[G_Discipline SoTA Patterns Kit/00_Core_Part G Core Invariants/00_G.Core - Part G Core Invariants|G.Core]]** (RSCR trigger catalogue)
* **[[G_Discipline SoTA Patterns Kit/03_02_SoTA Harvester & Synthesis/00_G.02 - SoTA Harvester & Synthesis|G.2]]** (SoTA synthesis packs)
...
## [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]]:End
