...
coordinates_with:
  ...
  - "[[00_A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]]"
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:0 - Use This When
...
- If the current question is whether a construct deserves a durable ontic, use [[01_E.24.CD - Ontic Candidate Detection|E.24.CD]] and then [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]].
- If the current question is generic multi-view publication or viewpoint packaging, use [[03_E.17 - Multi-View Publication Kit|E.17]] and its dependent patterns.
- If the current question is wording-use repair, use [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]], or the relevant precision-restoration pattern.
- If the current question is an architecture description as its own subject matter, use [[01_C.30.AD - Architecture Description Adequacy|C.30.AD]]; [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] supplies only the boundary between the ontic and its publication-facing description stack.

## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:1 - Problem Frame
...
[[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] governs this distinction for ontic descriptions. It does not replace [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] for epistemes, [[03_E.17 - Multi-View Publication Kit|E.17]] for multi-view publication, [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] for pattern form, or [[00_E.10 - Unified Lexical Rules for FPF|E.10]] for wording-use repair.

## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:2 - Problem
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:3 - Forces
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:4 - Solution
...
### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:4.1 - Minimal Boundary Formula
...
### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:4.2 - Description Claims Stay About the Ontic
...
It should not carry generic warnings about all possible uses of descriptions. Those warnings belong to [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]], source patterns, evidence patterns, gate patterns, decision patterns, or another subject pattern when that subject is current.

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:4.3 - Publication Forms Stay Downstream
...
2. If changing a description claim changes what the ontic is asserted to be, inspect the ontic-description episteme through [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]].
3. If changing a slot relation or identity criterion changes the ontic itself, apply the governing ontic pattern or [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]].
4. If changing viewpoint or publication packaging changes which reader concern is served, use [[03_E.17 - Multi-View Publication Kit|E.17]] or the relevant view or publication pattern.

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:4.4 - Subject Pattern Placement
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:5 - Archetypal Grounding

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:5.1 - [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] Pattern Host and U.Ontic

[[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] is a publication of an ontic-description episteme about `U.Ontic`. The host text is not `U.Ontic`. Its tables, examples, headings, and source rows help publish the description; they do not create the ontic by appearance.

If the issue is whether `U.Ontic` has stable identity and a slot relation, use [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]]. If the issue is whether the [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] host is formatted, sectioned, or published well, use [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[03_E.17 - Multi-View Publication Kit|E.17]], or this pattern as appropriate.

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:5.2 - Characteristic Space and Score Table
...
If the score table is unclear, fix the publication. If the scale meanings are unclear, fix the characteristic-space description through [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] or the relevant evaluation pattern. If the question is how to construct the space, use [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]].

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:5.3 - Architecture Description and ArchitectureOf@Context
...
[[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] stays centered on the `ArchitectureOf@Context` claim and the selected structures that matter for the current architectural question. [[00_A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] stays centered on `U.Structure`. [[01_C.30.AD - Architecture Description Adequacy|C.30.AD]] centers architecture description as its own EoC. [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] supplies the bridge: know which object is being described before deciding whether the publication, view, or source row is current.

### [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:5.4 - Problem Card

A problem card can publish a problematization episteme or a project work record. The card is not automatically `U.Problem`, and the presence of fields does not decide the ontology. If the current question is problem formulation, use the problematization pattern. If it is the card form, use the publication-form pattern. If a reusable problem ontic is proposed, apply [[01_E.24.CD - Ontic Candidate Detection|E.24.CD]] for candidate detection and [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] for the ontic-introduction decision.

## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:6 - Bias-Annotation
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:7 - Conformance Checklist
...
| `CC-E24PUB-5` | Multiple views, diagrams, tables, cards, schemas, or sections do not create duplicate ontics unless an [[00_E.24 - U.Ontic and Ontic Introduction Discipline]] decision selects a distinct ontic. |
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Diagram as architecture claim | A diagram is treated as the `ArchitectureOf@Context` claim or as the selected `U.Structure` itself. | Treat the diagram as a publication form of an architecture-description episteme; use [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] for the `ArchitectureOf@Context` claim or [[00_A.22 - Structure and Structural Views (STRUCT-CAL)]] for selected `U.Structure`. |
...
| View variant as duplicate ontology | Several views of one subject are treated as several subjects. | Use [[03_E.17 - Multi-View Publication Kit]] for view or publication packaging and keep the ontic identity stable. |

## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:9 - Consequences
...
- [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] stays compact because publication discipline sits beside it, not inside it.
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:11 - SoTA-Echoing

| Source family | Current lesson for [[02_E.24.PUB - Ontic Description and Publication Discipline]] | FPF decision |
| --- | --- | --- |
...
| FPF episteme and publication machinery. | [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] and [[03_E.17 - Multi-View Publication Kit]] already govern epistemes and publication kits. | [[02_E.24.PUB - Ontic Description and Publication Discipline]] specializes that machinery only for ontic descriptions and avoids duplicating generic semio doctrine. |
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:12 - Relations

- **Builds on:** [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]], [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], and [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]].
- **Coordinates with:** [[01_E.24.CD - Ontic Candidate Detection|E.24.CD]] for candidate detection, [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] and [[01_A.19.ECS - Evaluation CharacteristicSpace Construction|A.19.ECS]] for characteristic-space descriptions and evaluation construction, [[00_A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] for structure, [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] for architecture, and [[01_C.30.AD - Architecture Description Adequacy|C.30.AD]] for architecture descriptions.
...
## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:13 - Footer Marker

## [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]]:End
