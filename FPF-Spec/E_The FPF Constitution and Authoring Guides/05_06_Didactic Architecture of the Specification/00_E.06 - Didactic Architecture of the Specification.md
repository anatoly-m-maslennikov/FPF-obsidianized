...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:1 - Problem frame
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:2 - Problem
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:3 - Forces
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:4 - Solution — “On‑Ramp to Archetypes first, Authoring last” sequence

### [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:4.0 - Document order is distinct from first-practical entry

The macro-order of the document is a didactic scaffold, not a universal practical workflow. Entry navigation publication units such as `README`, `Preface`, ToC query cues, [[E_The FPF Constitution and Authoring Guides/10_11_Practical-Use Guidance and Pattern Discovery/00_E.11 - Practical-Use Guidance and Pattern Discovery|E.11]] entry-distribution loci, and [[I_Annexes & Extended Tutorials/00_02_Expanded Entry Disambiguation Cases/00_I.02 - Expanded Entry Disambiguation Cases|I.2]] expanded entry-disambiguation cases are informative navigation only: they may cross Parts when that is the first honest entry for the question under repair, and they do not create a second normative process history.
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:5 - Archetypal Grounding (System / Episteme)
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:6 - Conformance Checklist
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:7 - Consequences

| Benefits | Trade‑offs / Mitigations |
|----------|-------------------------|
| Smooth learning curve; readers can stop at their needed depth. | Template discipline required; mitigated by authoring guide ([[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide]]). |
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:8 - Rationale
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:9 - Relations
...
## [[E_The FPF Constitution and Authoring Guides/05_06_Didactic Architecture of the Specification/00_E.06 - Didactic Architecture of the Specification|E.6]]:End
