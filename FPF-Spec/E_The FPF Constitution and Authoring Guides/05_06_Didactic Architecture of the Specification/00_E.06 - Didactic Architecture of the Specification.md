...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:1 - Problem frame
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:2 - Problem
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:3 - Forces
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:4 - Solution — “On‑Ramp to Archetypes first, Authoring last” sequence

### [[00_E.06 - Didactic Architecture of the Specification|E.6]]:4.0 - Document order is distinct from first-practical entry

The macro-order of the document is a didactic scaffold, not a universal practical workflow. Entry navigation publication units such as `README`, `Preface`, ToC query cues, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]] entry-distribution loci, and [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]] expanded entry-disambiguation cases are informative navigation only: they may cross Parts when that is the first honest entry for the question under repair, and they do not create a second normative process history.
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:5 - Archetypal Grounding (System / Episteme)
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:6 - Conformance Checklist
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:7 - Consequences

| Benefits | Trade‑offs / Mitigations |
|----------|-------------------------|
| Smooth learning curve; readers can stop at their needed depth. | Template discipline required; mitigated by authoring guide ([[00_E.08 - FPF Authoring Conventions & Style Guide]]). |
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:8 - Rationale
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:9 - Relations
...
## [[00_E.06 - Didactic Architecture of the Specification|E.6]]:End
