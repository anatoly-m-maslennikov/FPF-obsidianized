...
1) standardises naming via `SuiteObligations.*` ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]:4.2), and
...
| `two_bridge_rule_for_described_entity_change` | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms]] | entityOfConcern retargeting requires an explicit KindBridge (`CL^k`) in addition to any Context/Plane Bridge. |
...
| `penalties_route_to_r_eff_only` | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms]] | Penalties affect the **R lane (R_eff)** only; **F/G invariants** must not be altered by penalties. |
| `no_silent_scalarisation_of_partial_orders` + `no_silent_totalisation` | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms]] | Partial orders stay set‑valued; no silent scalar ranks or “helpful” totalisation. |
...
* [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] CrossingBundle (crossing visibility bundle)
  ...
  * [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/16_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]] SuiteObligations + suite protocol pins (delegation support)
  * [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] SlotFillingsPlanItem (planned baseline anchor)
