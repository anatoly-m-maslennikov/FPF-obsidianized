...
The standard pattern form is governed by [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]. Review and refresh discipline is governed by [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]]. Pattern-quality evaluation is governed by [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]]. Decision-rationale records, or DRRs, are short records explaining why one bounded FPF content decision changed; they are governed by [[00_E.09 - Design-Rationale Record (DRR) Method|E.9]] and its specializations. Those patterns matter because the FPF corpus itself evolves by the same discipline it asks other projects to use: explicit decisions, visible losses, recoverable meanings, and repeated improvement.
