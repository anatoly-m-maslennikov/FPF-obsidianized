...
**Builds on:** [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/04_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] **D.CTX** (Context discipline); A.3/**[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]**/**[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]** (Transformer Constitution; `U.Method`, `U.MethodDescription`); A.15/**[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]]** (`U.Work` as record of occurrence); Sys‑CAL (control/actuation semantics); KD‑CAL (observation).
**Coordinates with.** [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey|F.1]]–[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/03_Intra-Context Sense Clustering/00_F.03 - Intra-Context Sense Clustering|F.3]] (Contexts, Seeds → SenseCells), [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role|F.4]] (Role Description), [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]] (Naming), [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/06_RoleAssignment and Performed-Work Attribution Check/00_F.06 - RoleAssignment and Performed-Work Attribution Check|F.6]] (Role Assignment & Enactment Cycle (Six-Step)), F.7/F.9 (Bridges), [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]] (Status families & Windows).
**Aliases (informative).** *Method/Spec/Work or Actuation split*; *DesignRunTag harmonisation*.

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:1 - Intent & applicability
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:2 - Problem frame
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:3 - Forces
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:4 - Core idea (didactic)
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:5 - Minimal vocabulary (this pattern only)

* **Context** = `U.BoundedContext` (per D.CTX).
* **Local‑Sense** → **SenseCell** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/03_Intra-Context Sense Clustering/00_F.03 - Intra-Context Sense Clustering|F.3]]): the address *(Context × sense)* for a term like *process*, *task*, *activity*, *command*.
* **Concept‑Set** (F.7/F.8): row aligning multiple SenseCells as “what we regard as the same” (after Bridges & losses are declared).
* **Window** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]): temporal/conditional envelope (e.g., *July*, *during test run T42*, *under load ≥ 70%*).
* **StatusCell** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]): laddered status **about** methods/specs/works (e.g., *Approved (spec)*; *Observed/Measured (work)*).

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:6 - Solution — the quartet lens (notation‑free)

> *Not steps for a team—**lenses for a thinker**. Use them to sanity‑check any statement about “how”, “script”, “run”, or “signal”.*

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:6.1 - The **stance split** (design vs run)
...
* **Guard rule.** Never let a conclusion cross stances without (a) an explicit Bridge kind (*interpretation* vs *substitution*), and (b) an acceptable CL (F.7/F.9, [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]).

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:6.2 - The **recipe/idea split**
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:6.3 - The **happening** (Work) with **signal** (Actuation)
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:6.4 - The **Role Assignment & Enactment touch-points**

* **Roles** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role|F.4]]) bind **who enacts** the Method at run‑time (behavioural masks), **not** what permissions they hold (RBAC is a different Context).
* **Statuses** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]) bind to the right box: *Approved* → MethodDescription; *Measured/Observed* → Work; *Satisfied/Violated* → Requirement clause about the Work’s outcomes within a **Window**.

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:7 - Harmonisation map (Context‑first)

> Examples of **local SenseCells** and **safe Bridges**. *You may keep the exact Contexts from your [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey|F.1]] cut.*
...
* `SOSA:Observation` **interprets** `Requirement clause` ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]) about **Work outcomes** (**cross‑StatusModality: epistemic→deontic; never substitution**; declare **Bridge(kind=Interpretation, CL, Loss)**).

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:8 - Invariants (normative)
...
3. **Context locality.** Terms (*process*, *activity*, *task*, *command*) **MUST** be read as **SenseCells** in their Contexts ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/03_Intra-Context Sense Clustering/00_F.03 - Intra-Context Sense Clustering|F.3]]); Cross‑context equivalence is a matter for F.7/F.9 Bridges.
4. **Status placement.** *Approved* attaches to MethodDescription; *Observed/Measured* attach to Work; *Satisfied/Violated* attach to clauses about Work outcomes within a **Window** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]).
...
6. **Naming clarity.** Technical/Plain labels for the quartet **SHOULD** be distinct ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]]); avoid homonymous single‑word labels when Contexts collide.
7. **Bridge guard.** Cross‑context moves **MUST** declare **kind** (≈, ⊑, ⊒, ⋂, ⊥, Interpretation), **CL**, and **Loss** (F.7/F.9).

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:9 - Micro‑examples (didactic)
...
1. **Data pipeline deploy (software).**
   ...
   *Statuses*: Spec **Approved** (governance Context); Work **Measured** (rows processed) → Evidence for SLO ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]).
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:10 - Anti‑patterns & remedies

| #       | Anti‑pattern                   | Symptom in prose/models                                               | Why it harms thinking                                                       | Remedy (conceptual move)                                                                                                                                                                                             |
| ------- | ------------------------------ | --------------------------------------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A1**  | **Design→Run Substitution**    | “The process **achieved** X” while pointing to a design diagram.      | Treats a **MethodDescription** as if it were **Work**; collapses stances.           | Apply the **stance split**: restate as “The **diagram describes** how X **should** be achieved.” To claim it **happened**, reference a **Work** SenseCell in a run‑time Context and, if needed, add a **Window** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status]]). |
...
| **A8**  | **Recipe-as-Role**             | “The Spec assigns responsibility” (mixes MethodDescription with Role constructs — `U.RoleDescription`/`U.RoleAssignment`).  | Conflates the `U.MethodDescription` episteme with behavioural masks.         | Use **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role]] Role Description**; let **MethodDescription** only **describe** a Method.                                                                            |
| **A9**  | **One‑Context Scope**        | A single Context (e.g., BPMN) used as if it covered control/measurement. | Scope mirage; silent cross‑domain generalisation.                           | Re‑cut Contexts ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey]]) to include control and sensing. Re‑express statements with the quartet across those Contexts.                                                                                                        |
...
| **A11** | **Recipe-as-Kind**             | Treating a MethodDescription vocabulary as a method-kind taxonomy.                  | Category error; confuses description wording with method kindhood.                                           | If a stable hierarchy of **kinds** of Methods is needed, use admission under [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Governance and Ontic Settlement Coupling]] and [[C_Kernel Extension Specifications/01_03_Kinds, Intent and Extent, and Typed Reasoning/00_C.03 - Kinds, Intent and Extent, and Typed Reasoning]] with an ontic and bridge record; keep MethodDescription as *description* only.                                                                                   |
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:11 - Worked examples (extended)

> Each scenario names Contexts (from your [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey|F.1]] cut), identifies the quartet boxes, and shows safe Cross‑context moves.

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:11.1 - ML service rollout (software + services + sensing)
...
* **Statuses ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]):** *Spec Approved*; *Work Observed* (latency/err‑rate via SOSA Observations); *SLO clause Satisfied* in Window if measured ≤ thresholds.
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:11.2 - Industrial furnace control (control + sensing + services)
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:11.3 - Clinical assay
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:11.4 Incident response (services + enactment)
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:12 - Reasoning primitives (judgement schemas)
...
7. **Clause evaluation** ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]] handshake)
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:13 - Relations

**Builds on:**
[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/04_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] **D.CTX** (Context ≡ `U.BoundedContext`); A.3/**[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]**/**[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]**/**[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** (Method/Spec/Work foundations); Sys‑CAL (Actuation semantics); KD‑CAL (Observation); [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/01_Domain-Family Landscape Survey/00_F.01 - Domain-Family Landscape Survey|F.1]]–[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/03_Intra-Context Sense Clustering/00_F.03 - Intra-Context Sense Clustering|F.3]] (Contexts → SenseCells); [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]] (Status families & Windows).

**Constrains:**

* **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role|F.4]] Role Description:** Roles or Statuses **must** point to the right box (e.g., *Approved* → MethodDescription; *Observed* → Work).
* **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]] Naming:** Enforce distinct Tech/Plain labels for Method/Spec/Work or Actuation where homonyms threaten.
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:14 - Migration notes (conceptual)
...
5. **Name collisions.** Where *task/activity/process* appear with mixed meanings, prefix with Contexts and relabel per **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]]** (Tech/Plain).
6. **Backfill Bridges.** If earlier text implied Cross‑context equivalence, add explicit Bridges (F.7/F.9) declaring **kind/CL/Loss**.

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:15 - Acceptance tests (SCR/RSCR — concept level)

### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:15.1 - Static conformance checks (SCR)
...
### [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:15.2 - Regression checks (RSCR)
...
## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:16 - Didactic distillation (90‑second script)
...
> For compliance, don’t point at the plan—point at **Work**, show **Observations**, and judge clauses in **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/10_Status Families Mapping- Evidence, Standard, and Requirement Status/00_F.10 - Status Families Mapping- Evidence, Standard, and Requirement Status|F.10]]**.
> Hold this quartet in your head and you’ll stop mixing plans with facts, signals with outcomes, and names across Contexts. Everything else—naming ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/05_Naming Discipline for U-kind Names and RoleDescription Labels/00_F.05 - Naming Discipline for U-kind Names and RoleDescription Labels|F.5]]), `U.RoleDescription` ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/04_Role Description - Description Episteme for U.Role/00_F.04 - Role Description - Description Episteme for U.Role|F.4]]), `U.RoleAssignment`, and performed-work attribution ([[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]].1/F.6)—falls into place.

## [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/11_Method Quartet Harmonisation/00_F.11 - Method Quartet Harmonisation|F.11]]:End
