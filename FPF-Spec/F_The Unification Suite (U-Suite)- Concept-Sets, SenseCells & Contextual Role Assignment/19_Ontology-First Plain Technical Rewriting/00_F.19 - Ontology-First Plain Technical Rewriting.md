...
**Intent.**
Repair technical prose whose object, claim, relation, action, role, or flow is buried under extra apparatus. The repair is not cosmetic plain-language editing. It first separates content from apparatus by ontology, then writes the remaining content in the shortest plain technical form that preserves FPF kinds, slots, claim boundaries, and admissible use. Remaining word, head, naming, or wording-use problems then apply [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], or the governing pattern for the object.

**Builds on.** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[00_E.18 - Transformation Flow Structure|E.18]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], and source-use, evidence, assurance, gate, work, decision, publication, architecture, characteristic, state-family, and relation patterns when those objects carry the repaired span's claim.

**Coordinates with.** [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing|E.22]], [[00_E.23 - Quality Improvement Loop Method|E.23]], [[02_A.19.SPR - State-Family Precision Restoration|A.19.SPR]], [[00_C.02.P - Epistemic Precision Restoration|C.2.P]], [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]], [[02_C.30.P - Architecture and Structure Precision Restoration|C.30.P]], [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]], pattern-quality records, review records, `DRR`s, projection loci, and source-side notes.

## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:0 - Use this when

Use [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]] when a bounded piece of technical prose is trying to say something precise, but the reader must pass through role labels, container words, status words, process traces, quality proof, repeated negative catalogues, reference boilerplate, or pattern-application metaphors before the object and action are visible.
...
- If the problem is only one overloaded word or head after the content is visible, apply [[00_E.10 - Unified Lexical Rules for FPF|E.10]].
- If the problem is a durable reusable name, apply [[00_F.18 - Local-First Unification Naming Protocol|F.18]].
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:1 - Problem frame
...
- "[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] handles the claim" when the text needs to say that [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] applies to a work-planning claim;
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:2 - Problem
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:3 - Forces
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:4 - Solution
...
3. **Remove or move apparatus.** Delete the apparatus or move it to the document, record, note, or publication relation where it belongs: `DRR`, review record, quality result, architecture note, README, ToC, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], or [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]] entry locus, projection record, release or landing evidence document, or source-side note. Do not replace it with a smoother synonym, role label, container word, status word, record, card, table, schema, data-structure wrapper, or publication-form word.
4. **Restore remaining content precision.** Apply [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], or the governing pattern when a remaining word, head, relation, claim, slot or use-position, source-use role, durable name, or admissible-use boundary is still hidden.
...
### [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:4.1 - Result form
...
| `RemainingContentPrecisionRestoration` | `not needed`, [[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[00_F.18 - Local-First Unification Naming Protocol]], governing pattern, or blocker. |
...
### [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:4.2 - Pattern-prose specialization
...
- README, ToC, [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]], [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]], retrieval, card, monolith-parity, or landing evidence;
- repeated boundary doctrine already carried by another pattern.

## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:5 - Archetypal Grounding

| Grounding slice | Before | [[00_F.19 - Ontology-First Plain Technical Rewriting]] repair |
|---|---|---|
| Pattern application | "[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] handles the work-planning claim." | "Apply [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] to the work-planning claim." |
| Pattern vs relation | "The governing relation is [[00_C.29 - Mathematical Lens Use]]." | "Mathematical-lens claims are governed by [[00_C.29 - Mathematical Lens Use]]." |
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:6 - Bias-Annotation
...
[[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]] also protects against two common reviewer biases:
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:7 - Conformance checklist
...
| `CC-F19-4` | Content-bearing wording remains content and is repaired by [[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[00_F.18 - Local-First Unification Naming Protocol]], or the governing pattern rather than deleted as style. |
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:8 - Common anti-patterns and how to avoid them
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:9 - Consequences
...
## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:10 - Rationale
...
Putting [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]] beside wording-use restoration keeps [[00_E.10 - Unified Lexical Rules for FPF|E.10]] from becoming a phrase-style super-pattern. [[00_E.10 - Unified Lexical Rules for FPF|E.10]] catches words and heads whose kind or use is hidden. [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]] catches the earlier phrase-level problem: the content may not even be visible until process, role, status, reference, quality, or negative-catalogue apparatus is removed.

## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:11 - SoTA-Echoing

| Claim disciplined by source | Practice or source | Source-use relation | FPF import |
|---|---|---|---|
| Plain prose serves a reader and task, not a generic style preference. | ISO 24495-1:2023, *Plain language - Part 1: Governing principles and guidelines*. | Current standard reference for plain-language principles and task/readership fit. | [[00_F.19 - Ontology-First Plain Technical Rewriting]] requires declared reader and use and checks loss after rewriting. It adapts plain-language principles to FPF kind preservation. |
| Plain language removes unnecessary complexity while keeping necessary terms. | Federal Plain Language Guidelines and Digital.gov plain-language guidance. | Current government plain-language practice reference for audience-first, direct, organized prose. | [[00_F.19 - Ontology-First Plain Technical Rewriting]] removes apparatus but preserves established FPF terms unless [[00_E.10 - Unified Lexical Rules for FPF]] or [[00_F.18 - Local-First Unification Naming Protocol]] changes them. |
| Legal and technical documents can be clearer without losing controlled terms. | SEC, *A Plain English Handbook: How to Create Clear SEC Disclosure Documents*. | Lineage and practice reference for reducing legalese while retaining disclosure meaning. | [[00_F.19 - Ontology-First Plain Technical Rewriting]] treats "plain" as meaning-preserving repair, not informal paraphrase or synonym churn. |
| FPF precision restoration must preserve ontology before style. | Current FPF patterns [[00_E.08 - FPF Authoring Conventions & Style Guide]], [[00_E.10 - Unified Lexical Rules for FPF]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]], [[00_F.18 - Local-First Unification Naming Protocol]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]]. | Current FPF governing-source relation. | [[00_F.19 - Ontology-First Plain Technical Rewriting]] becomes the phrase-level sibling to word, head, and use restoration and feeds [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] through `PrecisionRestorationProfile`. |

## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:12 - Relations

| Related pattern | Relation |
|---|---|
| [[00_E.08 - FPF Authoring Conventions & Style Guide]] | Applies [[00_F.19 - Ontology-First Plain Technical Rewriting]] to FPF pattern prose and keeps pattern bodies addressed to their intended users. |
| [[00_E.10 - Unified Lexical Rules for FPF]] | Restores remaining wording whose kind, relation, or admissible use is hidden after apparatus removal. |
| [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]] | Provides shared wording-use recovery architecture for remaining content. |
| [[00_F.18 - Local-First Unification Naming Protocol]] | Settles durable reusable names after kind and use are known. |
| [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] | Restores relation construction when the remaining content hides relation kind, endpoint, basedness, anchoring, or slot or use-position. |
| [[02_A.19.SPR - State-Family Precision Restoration]], [[00_C.02.P - Epistemic Precision Restoration]], [[01_C.16.P - Characteristic and Scale Precision Restoration]], [[02_C.30.P - Architecture and Structure Precision Restoration]] | Govern state-family, source or publication, characteristic or scale, and architecture or structure wording when those objects remain as content after apparatus removal. |
| [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace]] | Consumes [[00_F.19 - Ontology-First Plain Technical Rewriting]] findings through `PrecisionRestorationProfile`; it lowers affected quality coordinates without creating one coordinate per apparatus symptom. |
| [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles]], [[00_E.22 - Improvement-Oriented Quality Evaluation Question Framing]], [[00_E.23 - Quality Improvement Loop Method]] | Use [[00_F.19 - Ontology-First Plain Technical Rewriting]] in review, framing, and improvement-loop work while keeping quality-loop records out of pattern prose. |
| [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]] and [[00_I.02 - Expanded Entry Disambiguation Cases]] | Provide first-entry cues and expanded entry-disambiguation cases for phrase-level apparatus repair. |

## [[00_F.19 - Ontology-First Plain Technical Rewriting|F.19]]:End
