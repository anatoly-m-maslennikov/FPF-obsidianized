...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:1 - Problem Frame
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:2 - Problem
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:3 -  Forces
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:4 - Solution — **The Invariant Quintet Standard**
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:4.1 - The Universal Aggregation Operator
...
* **`T`** — an external `U.TransformerRole` (not a node of `D`); see [[00_A.12 - External Transformer & Reflexive Split|A.12]].
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:4.2 - The Five Grounding Invariants
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:4.3 - Why only five?  (A didactic sidebar)
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:4.4 - Emergence Without Cheating

Real redundancy can push a system above the WLNK ceiling (e.g., RAID 6 survives two disk deaths). FPF treats this not as a rule break but as a **Meta-Holon Transition (MHT)**: the redundant set is promoted to a fresh holon at a new scale, and the quintet re-applies there. The algebra stays pure; emergence becomes explicit, auditable design space. Details live in Pattern **[[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]] Meta-Holon Transition (MHT): Recognizing Emergence and Re-identifying Wholes** (next in cluster).

## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:5 - Domain‑Specific “Flavours” of Γ
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:6 - Walkthrough Examples

### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:6.1 - `Γ\_sys` — Offshore Wind Farm (2025 build)
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:6.2 - `Γ_epist` — Living Systematic Review on mRNA Therapies (2024–2025)
...
### [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:6.3 - `Γ\_time` — National Grid Frequency Forecast (2025‑2030)
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:7 - Conformance Checklist (for pattern adopters)
...
A proposal that skips any line of the checklist **fails** pattern [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]] and must iterate before peer review.

## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:8 - Consequences
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:9 - Rationale
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:10 - Anti-Patterns & Conceptual Repairs
...
## [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]]:End
