...
**[[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] compliance —** Treat **PortionOf** as Σ‑additive stocks; **ComponentOf** must respect boundary integration (BIC); **PhaseOf** is *not* aggregated here (handled by Γ\_time); mapping/representations are *not* parthood.

### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:1 - Purpose
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:2 - Context
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:3 - Problem (seen on real projects)
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:4 - Forces
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:5 - Solution (conceptual core)

#### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:5.1 - Operator signature
...
#### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:5.2 - Three attribute classes
...
#### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:5.3 - Boundary‑Inheritance Standard (BIC)
...
#### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:5.4 - Cut‑Stable Boundary Axiom (reminder)
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:6 - Step‑by‑Step Aggregation Recipe
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:7 - Worked Example — Battery‑Electric Bus Pack (2025 model year)
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:8 - Conformance Checklist (author‑facing)
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:9 - Consequences
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:10 - Rationale (link to modern practice)
...
### [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:11 - Relations

* **Builds on:** Dependency Graph (B .1.1); Transformer Principle ([[00_A.03 - Transformer Constitution (Quartet)|A.3]]).
...
## [[02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]]:End
