...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:1 - **Problem Frame**
...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:2 - **Problem**
...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:3 - **Solution**
...
### [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:3.1 - Assurance Subtypes: The Three Pillars of Trust
...
### [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:3.2 - Computed Assurance Levels: Evidence-support progression
...
*   **CC-B3.3.2 (Concept-Bridge Mandate):** A ToA at `AssuranceLevel:L1` or higher **MUST** be supported by **Concept-Bridge Assurance**. This includes, at a minimum, that its core terms are mapped through the Domain-Concept Bridge (Pattern [[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/03_B.05.03 - Domain-Concept Bridge|B.5.3]]) and conform to their declared schemas, slot relations, or bridge records.
...
*   **CC-B3.3.4 (Concept-Bridge Completeness):** For any mechanism used in a model at `AssuranceLevel:L1` or higher, its load-bearing local terms, slots, and governed values **MUST** be mapped to their declared FPF kinds, relations, characteristics, method values, work values, publication-use relations, or evidence-use relations via the Domain-Concept Bridge (Pattern [[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/03_B.05.03 - Domain-Concept Bridge|B.5.3]]).
*   **CC-B3.3.5 (Scope Separation):** Assurance claims **MUST** maintain a strict separation between `design-time` and `run-time` scopes (Pattern [[A_Kernel Architecture Cluster/04_Temporal Duality & Open-Ended Evolution Principle/00_A.04 - Temporal Duality & Open-Ended Evolution Principle|A.4]]). An assurance tuple for a `MethodDescription` (design-time) SHALL NOT be conflated with one for its corresponding `Work`/`Trace` (run-time). The Evidence Graph Ref (`verifiedBy`, `validatedBy`) must point to evidence carriers or records with the appropriate scope.
* **CC-B3.3.6 (CT2R‑LOG Handshake):** If a ToA depends on **structural** claims, those claims **SHALL** be published as **Working‑Model** relations and, when used to justify `L2`, **SHALL** declare `validationMode=axiomatic` and provide **Constructive** grounding with `tv:groundedBy → Γₘ.(sum|set|slice)` (see [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/03_B.03.05 - Working-Model Relations & Grounding (CT2R-LOG)|B.3.5]] and [[C_Kernel Extension Specifications/03_13_Constructional Mereology (Compose-CAL)/00_C.13 - Constructional Mereology (Compose-CAL)|C.13]]).
* **CC-B3.3.7 (Downward‑Only Dependence):** Assurance publications or records (Mapping, Logical, Constructive, and Evidence) **SHALL NOT** impose vocabulary or layout back onto the Working‑Model surface ([[E_The FPF Constitution and Authoring Guides/13_14_Human-Centric Working-Model/00_E.14 - Human-Centric Working-Model|E.14]]).

## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:5 - **Common Anti-Patterns and How to Avoid Them**
...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:6 - **Consequences**
...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:7 - **Rationale**
...
## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:8 - **Relations**
...
*   **Enables:** Objective quality gates in the Canonical Evolution Loop ([[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/00_B.04 - Canonical Evolution Loop|B.4]]) and reliable inputs for [[D_Multi-scale Ethics and Conflict Optimization/03_04_Ethical Mediation and Decision Use/00_D.04 - Ethical Mediation and Decision Use|D.4]] Ethical Mediation and Decision Use.

## [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/01_B.03.03 - Assurance Subtypes & Levels|B.3.3]]:End
