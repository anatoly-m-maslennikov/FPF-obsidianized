...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:1 - **Problem Frame**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:2 - **Problem**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:3 - **Forces**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:4 - **Solution**
...
### [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:4.1 - The B-O-S-C Triggers for Methods/Functions
...
>
> The terms "process," "workflow," "function," and "work process" are notoriously overloaded. FPF resolves this ambiguity by mapping these common terms to its precise, distinct concepts, in alignment with Pattern [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]].
>
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:5 - **Archetypal Grounding**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:6 - **Conformance Checklist**

*   **CC-B2.4.1 (MFT Declaration Mandate):** The emergence of a composite `U.Method` with supervisory properties **MUST** be declared as an MFT and justified with a **Promotion Record** (Pattern [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]) that provides evidence for the B-O-S-C triggers.
...
*   **CC-B2.4.4 (Interface Standard):** The emergent `U.Method` **MUST** have a formally documented interface Standard (`Method Interface Standard` or MIC, see Pattern [[05_B.01.05 - Γmethod - Order-Sensitive Method Composition & Work Enactment|B.1.5]]), which specifies how the external world interacts with it and how the internal methods are encapsulated.

## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:7 - **Common Anti-Patterns and How to Avoid Them**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:8 - **Consequences**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:9 - **Rationale**
...
## [[03_B.02.04 - Meta-Functional Transition (MFT)|B.2.4]]:End
