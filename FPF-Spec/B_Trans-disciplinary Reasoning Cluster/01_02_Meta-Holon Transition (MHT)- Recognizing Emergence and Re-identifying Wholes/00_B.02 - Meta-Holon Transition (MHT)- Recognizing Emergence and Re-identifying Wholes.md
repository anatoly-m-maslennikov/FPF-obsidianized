...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:1 - Problem frame

* **Universal composition ([[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]])** provides Γ‑flavours for structure (**Γ\_sys**, **Γ\_epist**), order (**Γ\_ctx/Γ\_method**), and time (**Γ\_time**). These flavours preserve **WLNK** and **MONO** and—except for order/time cases—assume **local commutativity**.
* **Mereology ([[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]])** distinguishes **ComponentOf / ConstituentOf** (structure), **SerialStepOf / ParallelFactorOf** (order), and **PhaseOf** (temporal parts of the **same** carrier).
* **Strict Distinction ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]])** separates **structure**, **order**, **time**, **cost**, and **values**; we must not disguise emergence as arithmetic “optimism” or as a type error.
...
FPF does **not** force a metaphysical choice; it requires **clear declarations** so Γ‑proofs and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]‑assurance remain unambiguous.

## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:2 - Problem
...
2. **Identity drift:** A system changes boundary, objective, or supervisory structure, yet the model silently treats it as the “same holon,” corrupting histories (**Γ\_time**) and claims (**[[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]**).
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:3 - Forces

| Force                                       | Tension                                                                                                                                                     |
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Parsimony vs. Expressivity**              | Keep the core algebra small ([[00_A.11 - Ontological Parsimony (C-5)]]) ↔ Admit real emergence when closure or supervision appears.                                                              |
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4 - Solution — **Part 1: What an MHT is, when to declare it, and how it relates to Γ**

### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.1 - Definition (normative)
...
After MHT, the Γ‑invariants apply **afresh** to `H⁺` and its parts. Prior assurance ([[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) remains valid for **pre‑MHT** claims; **post‑MHT** claims are assessed for `H⁺` under its own boundary, objective, and context.
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.2 - Triggers for declaring MHT (BOSC‑A‑T‑X)
...
* **A — Agency threshold crossing ([[00_A.13 - The Agential Role & Agency Spectrum|A.13]]).** The holon begins to **play AgentialRole** with an **agency grade** sufficient to maintain objectives autonomously; this lifts the system into a supervisory regime.
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.3 - Identity stance: 4D vs. 3D+1 (FPF’s ecumenical Standard)
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.4 - Event taxonomy for MHT (small, reusable set)
...
4. **Role‑Lift** — the holon starts **playing AgentialRole** at or above a declared grade threshold ([[00_A.13 - The Agential Role & Agency Spectrum|A.13]]), enabling supervision.
...
These are **Transformer events** ([[00_A.12 - External Transformer & Reflexive Split|A.12]]). They do **not** imply toolchains or storage; they are conceptual commitments with audit fields.

### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.5 - How MHT relates to Γ‑flavours and bounded contexts
...
* **With bounded contexts (DDD intuition):**
  ...
  * Use **Context Reframe** MHT to re‑anchor `H⁺` in the new context and declare the mappings; [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]’s congruence penalty `Φ(CL)` now refers to the **new** baseline.

### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:4.6 - What MHT is *not* (didactic contrasts)

* **Not a shortcut around WLNK/Φ.** If synergy is explainable by raising `CL` or improving parts, stay within Γ and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].
...
* **Not “agent = new type.”** Agency is **a role** ([[00_A.13 - The Agential Role & Agency Spectrum|A.13]]); MHT only when role enactment **changes closure/supervision** at the system level.

## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:5 - Promotion Record & proof obligations (normative)

To declare an MHT you MUST create a **Promotion Record** that makes identity, boundary, objective, supervision, and context shifts explicit. This record extends the general proof kit in **[[01_B.01.01 - Dependency Graph & Proofs|B.1.1]]**.

### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:5.1 - Promotion Record — minimal fields
...
MHT.PromotionRecord
  ...
  preConfig:
    ...
    edges:           list of relations & their types ([[A_Kernel Architecture Cluster/14_Advanced Mereology- Components, Portions, Aspects & Phases/00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]]), including CL on integration edges
    Γflavour:        active Γ-flavour(s) prior to MHT
    assurance:       Assurance tuples for relevant claims before MHT ([[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]])
  ...
  triggers:
    ...
    A?               Agency-CHR grade & context ([[A_Kernel Architecture Cluster/13_The Agential Role & Agency Spectrum/00_A.13 - The Agential Role & Agency Spectrum|A.13]])
    T?               Γ\_time phase boundary details (coverage, carrier identity/continuation)
    X?               context mapping summary (old↔new)
  postHolon (H⁺):
    boundary:        explicit BIC or equivalent boundary statement ([[B_Trans-disciplinary Reasoning Cluster/00_01_Universal Algebra of Aggregation (Γ)/02_B.01.02 - System-specific Aggregation Γ-sys|B.1.2]])
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:5.2 - Proof obligations specific to MHT
...
* **MHT‑ASS‑REBAS.** Provide **before/after** assurance tuples ([[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]) for the same typed claim(s) or justify claim changes; do not fuse design-time and run-time scopes.
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6 - Archetypal cases (worked, didactic)

### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6.1 - System — **Closed‑loop regulation emerges from components** (Fusion / Role‑Lift)
...
* **After:** Γ‑invariants re‑start for `H⁺`. **[[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]** assurance uses a new cutset; congruence on controller–plant mapping is part of `CL_min`.
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6.2 - Episteme — **From compendium to theory** (Fusion / ContextReframe)
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6.3 - Temporal — **Commissioning → Operations** (PhasePromotion)
...
### [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6.4 - Context — **Prototype → Certified product** (ContextReframe)
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:6.5 - Certification Interface Example *(Informative)*
...
**Sketch.** `snapshot` contains coordinates over the Role’s RCS ([[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]). `options` may reference named **NormalizationMethod(s)**/**NormalizationMethodInstance(s)** and overlays used in evaluation. The resulting **StateAssertion** states the target state (by name), the checklist applied (by name), the verdict, the window, and (if used) the **declared** **Bridge** or **NormalizationMethodInstance** employed for translation.
**Intent.** This example aids implementers; **normative constraints** on comparability, normalization, and evidence live in **[[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]** and **[[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]**, not here.

## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:7 - Conformance Checklist (normative)
...
| **CC‑B2.4** | Pre‑ and post‑assurance MUST be reported as **separate** tuples ([[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]]).                                                          | No DesignRunTag chimeras or context chimeras.                 |
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:8 - Anti‑patterns & repairs
...
| **Agency as type**         | Introduce `U.Agent` and claim new identity              | Keep agency as role ([[00_A.13 - The Agential Role & Agency Spectrum]]); MHT only if supervision/closure changes the whole.      |
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:9 - Consequences
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:10 - Rationale (informative)

* **Systems & control:** Closing feedback creates **new closed‑loop properties** not attributable to parts alone; treating this as an MHT avoids “synergy by arithmetic” and aligns with classical supervisory control and contemporary active‑inference views ([[00_A.13 - The Agential Role & Agency Spectrum|A.13]]).
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:11 - Relations

* **Builds on:** [[00_A.12 - External Transformer & Reflexive Split|A.12]] (Transformer), [[00_A.13 - The Agential Role & Agency Spectrum|A.13]] (AgentialRole & Agency‑CHR), [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (Mereology Extension), [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Strict Distinction); B.1.x (Γ flavours), [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] (Assurance).
* **Used by:** [[00_B.04 - Canonical Evolution Loop|B.4]] (Evolution Loops: MHT as macro‑steps on the loop), KD‑CAL action patterns (when re‑framing models/theories).
* **Complements:** [[04_B.01.04 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] (Γ\_ctx/Γ\_time) by distinguishing **order/phase** corrections from **emergence**; [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]].2/B.1.3 by restarting compositional invariants at the new level.
...
## [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]:End
