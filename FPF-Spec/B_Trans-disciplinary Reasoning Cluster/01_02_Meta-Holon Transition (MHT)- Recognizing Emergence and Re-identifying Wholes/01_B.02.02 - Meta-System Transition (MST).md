...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:2 - **Problem**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:3 - **Forces**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:4 - **Solution**
...
### [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:4.1 - The B-O-S-C Triggers for Systems
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:5 - **Archetypal Grounding**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:6 - **Conformance Checklist**

*   **CC-B2.2.1 (Trigger Mandate):** An `emergesAs` relation for a set of `U.System`s **MUST** be justified by a **Promotion Record** (Pattern [[00_B.02 - Meta-Holon Transition (MHT)- Recognizing Emergence and Re-identifying Wholes|B.2]]) that provides evidence for all four B-O-S-C triggers.
...
*   **CC-B2.2.3 (Supervisor Mandate):** The emergent meta-system **MUST** contain an identifiable **supervisory component** or mechanism that implements the feedback loop. The architecture of this loop is further detailed in Pattern [[04_B.02.05 - Supervisor-Subholon Feedback Loop|B.2.5]].
*   **CC-B2.2.4 (Boundary Inheritance):** The boundary of the new meta-system **MUST** be formally derived from the boundaries of its constituent systems, following a declared **Boundary-Inheritance Standard** (Pattern [[02_B.02.03 - Meta-Epistemic Transition (MET)|B.2.3]], forthcoming).

## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:7 - **Common Anti-Patterns and How to Avoid Them**
...
| **The "Hidden God-Controller"** | A system appears to be a self-organizing swarm, but its behavior is actually dictated by a hidden, external, centralized controller that is not part of the model. | The FPF's **Transformer Principle ([[00_A.12 - External Transformer & Reflexive Split]])** and **Boundary rules ([[00_A.01 - U.Holon, U.System, and U.Episteme]])** require that all external influences are made explicit. The controller must either be modeled as part of the meta-system (and thus inside its new boundary) or as an external `Transformer`. |

## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:8 - **Consequences**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:9 - **Rationale**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:10 - **Relations**
...
## [[01_B.02.02 - Meta-System Transition (MST)|B.2.2]]:End
