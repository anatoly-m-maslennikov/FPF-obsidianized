...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:1 - **Problem Frame**
...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:2 - **Problem**
...
| :--- | :--- | :--- | :--- | :--- |
| **1. Exploration** | **Generating possibilities.** The focus is on brainstorming, questioning assumptions, and generating multiple, often competing, hypotheses. | "We are in the 'what if' phase. All ideas are on the table. We are looking for a plausible path forward." | **Abduction** (Pattern [[00_B.05.02 - Abductive Loop]]) | `L0` |
...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:4 - **Conformance Checklist**
...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:6 - **Rationale**
...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:7 - **Relations**
...
## [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]]:End
