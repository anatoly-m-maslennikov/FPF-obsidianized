...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:1 - **Problem Frame**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:2 - **Problem**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:3 - **Forces**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:4 - **Solution**
...
### [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:4.1 - The `Role` Concept
...
### [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:4.2 - The `refinesType` Relation**
...
### [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:4.3 - The `plays_role_of` Relation**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:5 - **Archetypal Grounding**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:6 - **Consequences**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:7 - **Rationale**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:8 - **Relations**
...
## [[03_B.05.03 - Role-Projection Bridge|B.5.3]]:End
