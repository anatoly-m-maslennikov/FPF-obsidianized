...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:1 - Problem frame
...
**First useful move.** Name the context-local way of doing, the transformation or enactment it is about, and the `transformedEntityOrStructure` from [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/04_U.Transformation- Bounded Change Under Conditions/00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]: the governed object or structure whose state, result, selection, derivation, control relation, or maintained condition changes or is preserved. The method remains this pattern's primary `EntityOfConcern`.
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4 - Solution
...
| relation or composition among methods, method families, or local method expressions | [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing]] with [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry]], or a direct method-composition pattern such as [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment]] when current; algebraic or graph notation is only [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use]] lens or method-description representation |
...
| source phrase such as practice, technique, school, tradition, or local method label whose current object is unclear | recover the claim kind first through [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]] and this table; use [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - U.BoundedContext Semantic Frame]] when the phrase names a bounded context, and use [[C_Kernel Extension Specifications/24_36_Cultural Evolution and Cultural-Evolution Engineering/01_C.36.P - Cultural-Evolution Wording-Use Precision Restoration]] when the cultural-evolution, tradition, style, canon, recognition, selection, or mediation context is current |
| selected formal substrate or mathematical declaration | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind]] and [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use]] when mathematical-lens use is current |
| mechanism declaration or realization relation | [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind]] and [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol]] |
| role assignment, role relation, responsibility allocation, or holder eligibility hidden under a practice or method phrase | [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy]], [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment]], [[A_Kernel Architecture Cluster/02_Role Taxonomy/07_A.02.07 - RoleRelationStructure@BoundedContext - Context-Local Role Relations and Representation-Lens Boundary]], and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] as applicable |
...
| field-level discipline, bounded context, community tradition, canon or memory episteme, recognition or selection regime, mediation system, variant set, or cultural-evolution intervention | [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - U.BoundedContext Semantic Frame]], [[C_Kernel Extension Specifications/08_20_Composition of U.Discipline (Discipline-CAL)/00_C.20 - Composition of U.Discipline (Discipline-CAL)]], [[C_Kernel Extension Specifications/24_36_Cultural Evolution and Cultural-Evolution Engineering/00_C.36 - Cultural Evolution and Cultural-Evolution Engineering]], [[C_Kernel Extension Specifications/24_36_Cultural Evolution and Cultural-Evolution Engineering/01_C.36.P - Cultural-Evolution Wording-Use Precision Restoration]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts]], [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]], [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor]], [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry]], or [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator]] according to the recovered claim |
| evidence or provenance relation for a claim | [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] |
| graph path, path slice, flow valuation, state predicate, query, table, dashboard, publication face, or pattern relation overread as a method or work sequence | [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration]] first, then the direct governing pattern named by the recovery |

### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.0a - Strategy wording by current position
...
When the current claim selects candidates under criteria or policy pins, use the selector relation and policy values governed by [[A_Kernel Architecture Cluster/19_CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)/12_A.19.SelectorMechanism - Unified Selection Kernel, SelectorMechanism|A.19.SelectorMechanism]] and [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]]. The word `strategy` does not replace `CriteriaSlot`, `PolicyHooksRef`, `InsertionPolicyRef`, `EmitterPolicyRef`, `PromotionPolicy`, or the emitted `SelectorOutcome` when one of those is the actual claim.
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.1 - Thin first-use method identification
...
3. **Structure-bearing use.** Open `MethodRelationStructure@BoundedContext`, [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment|B.1.5]], or another direct composition pattern only when the receiving use relies on relations among methods, method parts, families, descriptions, selectors, or work-facing uses being explicit.
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.1a - Closure and bounded non-use
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.2 - Method and mechanism settlement
...
| Where should new or revised mechanism meaning be governed? | [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol]] | governing-definition assignment for mechanism meaning, suite, plan, wiring, token continuity, or local non-trigger stop |
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.3 - Method, MethodDescription, WorkPlan, Work
...
The same solver model, repository, protocol, diagram, or run packet may participate in several claims, but each claim has its own slot. A solver model can be a `U.MethodDescription`; its mathematical formulation can also expose a formal substrate for [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]]; a solver run can be `U.Work`; a run result can be evidence for a separate claim. Those claims are not interchangeable.

### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.4 - Method statement fields
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.5 - Representation and programming-paradigm discipline

A `U.Method` does not depend on an imperative step structure.

Imperative procedures, functional compositions, logical rule sets, constraint models, object-centric event models, effect-handler programs, process diagrams, SQL queries, equality-saturation graphs, proof scripts, and optimization models may all help describe, represent, or analyze a way of doing. Their representation style does not by itself decide whether the current claim position is a method, a method description, a formal substrate, a mechanism, a work plan, work, evidence, or a declarative representation under [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]].

Use this discipline:

* If the text states the semantic way of doing, use [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]].
* If the text states the representation that describes that way, use [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]].
* If the text states a formal object or mathematical representation used to reason, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind|A.6.0]], [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]], or the direct mathematical pattern.
* If the text states a law-governed operation structure, admissibility predicate set, transport clause, or realization relation, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] or [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]].
* If the text states planned work, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]].
* If the text states dated performed work, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]].
* If the text states an evidence relation or provenance relation, use [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]].
* If the text turns a graph, path, query, table, dashboard, predicate, publication face, or pattern relation into a route, call sequence, dispatch, or work procedure by metaphor, use [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] before choosing the direct governing pattern.
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.6 - Constructor and process-theory settlement
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.7 - Semantic identity and variants
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.8 - Method relation structure, composition, and work enactment
...
By the [[E_The FPF Constitution and Authoring Guides/23_24_U.Ontic and Ontic Introduction Discipline/03_E.24.UK - U-kind Governance and Ontic Settlement Coupling|E.24.UK]] settlement, `MethodRelationStructure@BoundedContext` is a non-U selected relation structure below the whole-method threshold. The suffix states its bounded-context qualification; it does not create a root kind. Its participants are exact method-side values, and its connections are exact composition, refinement, substitution, iteration, decomposition, family-membership, selector, fallback, description, or use relations governed by their direct patterns. The list below is recognition guidance, not a closed relation type or a substitute schema.
...
Method-holon composition is not [[A_Kernel Architecture Cluster/14_Advanced Mereology- Components, Portions, Aspects & Phases/00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] structural component mereology. `SerialStepOf`, `ParallelFactorOf`, guarded choice, iteration, typed joins, adapters, and method-interface exposure are arrangement or constraint relations over recovered `U.Method` submethods. Method-description nodes may describe those relations, but they are not method parts unless the governed object is recovered as a `U.Method`. Use [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment|B.1.5]] when order-sensitive method composition is current, and use [[B_Trans-disciplinary Reasoning Cluster/01_02_Meta-Holon Transition - Whole Reidentification/00_B.02 - Meta-Holon Transition - Whole Reidentification|B.2]] when whole reidentification of the composite method is current.

Work composition is occurrence-side: dated work may interleave, split, merge, retry, fail, recover, or be recorded in traces differently from the method description or method relation structure. Method decomposition and work decomposition are coupled because work enacts method, but they are not isomorphic. A temporal work part may enact the same whole method during a slice. An episode may record continuity under one method or mode while spanning several operational parts, repeating a fragment, or being split by evidence policy. A work part corresponds to a submethod only when the candidate factor is recovered as a `U.Method` with method-level preconditions, effects, interface or boundary, and whole-method relation under [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment|B.1.5]].
...
Algebraic, graph, categorical, process-calculus, effect-calculus, matrix, embedding, distributed, or neural notation may describe or analyze a selected `MethodRelationStructure@BoundedContext`. That notation is a mathematical or representation lens under [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] or a `U.MethodDescription` representation when the description itself is current. Do not name it `U.MethodAlgebra` or treat the lens as the method, method family, work plan, performed work, mechanism, role relation structure, or selector registry.
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5 - Archetypal Grounding
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.1 - Manufacturing recipe
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.3 - Proof or derivation
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.4 - Graph or query overread
...
If the wording says the graph "routes" a project to a pattern, the query "calls" a work sequence, or the table "authorizes" action without a recovered method kind, work kind, gate claim, or authority claim, apply [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] first.

### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.5 - Clinical triage protocol
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:6 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:7 - Conformance Checklist
...
**CC-A3.1-9 (Graph and representation guard).** A graph path, path slice, query, predicate, table, dashboard, publication face, or pattern relation is not a method or work sequence by layout. Use [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when representation wording is overread as imperative action.

**CC-A3.1-10 (Method holon, method relation structure, and work composition distinction).** Method-holon composition, method-family selection, fallback, refinement, substitution, iteration, decomposition, and work-occurrence composition remain separate even when they correspond. When submethods are assembled into a whole method, govern the result as `U.Method` with [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment|B.1.5]] when order-sensitive composition is current. A step label, step description, order edge, work-plan item, event-log segment, telemetry interval, engine stroke label, detector component, or graph node is not a submethod until it is recovered as a `U.Method` with method-level preconditions, effects, interface or boundary, and whole-method relation. A temporal work part may enact the same whole method during a slice, and an episode may split continuity without changing method identity. When method-side relations are current without whole-method assembly, recover `MethodRelationStructure@BoundedContext`. Algebraic, graph, categorical, process-calculus, effect-calculus, matrix, embedding, distributed, or neural notation is a lens or representation over the selected method object or method relation structure unless a governing pattern states a different object by value.
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| "The graph path routes the decision." | If it is graph structure, use [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure]]; if it is overread as route or action, use [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration]]; if a gate or authority claim is current, use the direct gate or authority pattern. |
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:9 - Consequences
...
### [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:9.1 - Lowering and local repair conditions
...
* graph, path, query, table, or predicate wording is treated as ordered execution without [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] recovery;
* a later `U.MethodDescription`, `U.WorkPlan`, `U.Work`, `U.Mechanism`, [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]], [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]], or evidence pattern changes the slot relation on which the method statement relied.
...
## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:11 - SoTA-Echoing
...
Review a project's current `U.Method` identification when its bounded context, transformation or enactment kind, transformed entity or structure, preconditions, effects, bounds, or work-facing acceptance relation changes. Review only the linked description, work, mechanism, representation, or evidence relation when that neighboring value changes without changing a method-identity basis. Review the method family or selector under [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]] only when the available family no longer separates the methods or variants needed for the current use.

When a receiving use relies on the currentness, edition, freshness, telemetry, or decay status of a cited method description or SoTA source, use [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] for that currentness relation. A new paper, source edition, implementation, or run is a reason to inspect the affected relation; it does not change the method merely by being newer. Reconsider the [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] distinction itself only when stronger work on constructor theory, process theory, effect systems, process modeling, practice theory, cultural evolution, graph or equivalence representation, or FPF's direct method neighbors overturns a distinction on which the project relies.

## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:12 - Relations

* **Builds on:** [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/00_A.01 - Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)|A.1]] holonic foundation, `A.1.1 U.BoundedContext`, [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] role, `A.2.1 U.RoleAssignment`, `A.2.2 U.Capability`.
* **Coordinates with:** [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] for method descriptions and method-relation descriptions; [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for dynamics; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind|A.6.0]] for formal-substrate declarations; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] and [[E_The FPF Constitution and Authoring Guides/19_20_Mechanism Introduction Protocol/00_E.20 - Mechanism Introduction Protocol|E.20]] for mechanism claims; [[C_Kernel Extension Specifications/17_29_Mathematical Lens Use/00_C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use; [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]] for method-family registries and selector outcomes; [[G_Discipline SoTA Patterns Kit/12_11_Telemetry-Driven Refresh and Decay Orchestrator/00_G.11 - Telemetry-Driven Refresh and Decay Orchestrator|G.11]] for relied-on source, edition, freshness, telemetry, and decay currentness; direct method-composition patterns such as [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/05_B.01.05 - Gammamethod - Order-Sensitive Method Composition and Work Enactment|B.1.5]] when order-sensitive method composition is current; [[A_Kernel Architecture Cluster/01_Holon Ontic Foundation (U.Holon and Admitted Holon Kinds)/01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] for bounded-context meanings hidden by practice wording; [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]], [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]], and [[A_Kernel Architecture Cluster/02_Role Taxonomy/07_A.02.07 - RoleRelationStructure@BoundedContext - Context-Local Role Relations and Representation-Lens Boundary|A.2.7]] for role values, role assignments, and role relations hidden by practice wording; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]] for work plans; [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] for dated work; [[C_Kernel Extension Specifications/08_20_Composition of U.Discipline (Discipline-CAL)/00_C.20 - Composition of U.Discipline (Discipline-CAL)|C.20]], [[C_Kernel Extension Specifications/24_36_Cultural Evolution and Cultural-Evolution Engineering/00_C.36 - Cultural Evolution and Cultural-Evolution Engineering|C.36]], and [[C_Kernel Extension Specifications/24_36_Cultural Evolution and Cultural-Evolution Engineering/01_C.36.P - Cultural-Evolution Wording-Use Precision Restoration|C.36.P]] for discipline and cultural-evolution practice wording; [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence relations or provenance relations; [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/02_P_Epistemic Precision Restoration/01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] for declarative representations overread as imperative routes or work sequences.
* **Informs:** [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]] and [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - P2W Problem-to-Work Carry-Through|E.18.1]] when transformation-flow-structure or P2W wording keeps flow-structure descriptions, graph or path mathematical expressions, method claims, and work claims separate.

## [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:End
