...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:1 - Problem frame
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:2 - Problem
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:3 - Forces
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4 - Solution
...
| selected formal substrate or mathematical declaration | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] and [[00_C.29 - Mathematical Lens Use]] when mathematical-lens use is current |
| mechanism declaration or realization relation | [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] and [[00_E.20 - Mechanism Introduction Protocol]] |
...
| evidence or provenance relation for a claim | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] |
| graph path, path slice, flow valuation, state predicate, query, table, dashboard, publication face, or pattern relation overread as a method or work sequence | [[01_C.02.P.DR - Declarative Representation Precision Restoration]] first, then the direct governing pattern named by the recovery |

### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.1 - Thin first-use record
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.2 - Method and mechanism settlement
...
* In **mechanism position**, the current claim is a law-governed declaration or revision of operations, laws, admissibility predicates, transport, audit surface, and monotone realizations under [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]].
...
| Where should new or revised mechanism meaning be governed? | [[00_E.20 - Mechanism Introduction Protocol]] | governing-definition assignment for mechanism meaning, suite, plan, wiring, token continuity, or local non-trigger stop |
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.3 - Method, MethodDescription, WorkPlan, Work
...
The same solver model, repository, protocol, diagram, or run packet may participate in several claims, but each claim has its own slot. A solver model can be a `U.MethodDescription`; its mathematical formulation can also expose a formal substrate for [[00_C.29 - Mathematical Lens Use|C.29]]; a solver run can be `U.Work`; a run result can be evidence for a separate claim. Those claims are not interchangeable.

### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.4 - Method statement fields
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.5 - Representation and programming-paradigm discipline

A `U.Method` does not require an imperative step structure.

Imperative procedures, functional compositions, logical rule sets, constraint models, object-centric event models, effect-handler programs, process diagrams, SQL queries, equality-saturation graphs, proof scripts, and optimization models may all help describe, represent, or analyze a way of doing. Their representation style does not by itself decide whether the current claim position is a method, a method description, a formal substrate, a mechanism, a work plan, work, evidence, or a declarative representation under [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]].

Use this discipline:

* If the text states the semantic way of doing, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]].
* If the text states the representation that describes that way, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]].
* If the text states a formal object or mathematical representation used to reason, use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[00_C.29 - Mathematical Lens Use|C.29]], or the direct mathematical pattern.
* If the text states a law-governed operation structure, admissibility predicate set, transport clause, or realization relation, use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] or [[00_E.20 - Mechanism Introduction Protocol|E.20]].
* If the text states planned work, use [[02_A.15.02 - U.WorkPlan|A.15.2]].
* If the text states dated performed work, use [[01_A.15.01 - U.Work|A.15.1]].
* If the text states an evidence relation or provenance relation, use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]].
* If the text turns a graph, path, query, table, dashboard, predicate, publication face, or pattern relation into a route, call sequence, dispatch, or work procedure by metaphor, use [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] before choosing the direct governing pattern.
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.6 - Constructor and process-theory settlement
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.7 - Semantic identity and variants
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:4.8 - Method composition and work enactment
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5 - Archetypal Grounding
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.1 - Manufacturing recipe
...
The SOP, PLC program, calibration recipe, and supplier note are method descriptions when they describe that method. A planned maintenance-window run is a `U.WorkPlan`. Tool run `W-143` with timestamps and logs is `U.Work`. Gas-flow equations may be a formal substrate or mathematical lens input. Evidence for whether the run met a safety or quality claim is governed separately by [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], or a gate pattern.

### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.2 - Optimization model
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.3 - Proof or derivation
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.4 - Graph or query overread
...
If the wording says the graph "routes" a project to a pattern, the query "calls" a work sequence, or the table "authorizes" action without a recovered method kind, work kind, gate claim, or authority claim, apply [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] first.

### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:5.5 - Clinical triage protocol
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:6 - Bias-Annotation
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:7 - Conformance Checklist
...
**CC-A3.1-9 (Graph and representation guard).** A graph path, path slice, query, predicate, table, dashboard, publication face, or pattern relation is not a method or work sequence by layout. Use [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when representation wording is overread as imperative action.
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| "The graph path routes the decision." | If it is graph structure, use [[00_E.18 - Transformation Flow Structure]]; if it is overread as route or action, use [[01_C.02.P.DR - Declarative Representation Precision Restoration]]; if a gate or authority claim is current, use the direct gate or authority pattern. |
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:9 - Consequences
...
### [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:9.1 - Lowering and refresh conditions
...
* graph, path, query, table, or predicate wording is treated as ordered execution without [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] recovery;
* a later `U.MethodDescription`, `U.WorkPlan`, `U.Work`, `U.Mechanism`, [[00_C.29 - Mathematical Lens Use|C.29]], [[00_E.18 - Transformation Flow Structure|E.18]], or evidence pattern changes the slot relation on which the method statement relied.
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:10 - Rationale
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:11 - SoTA-Echoing
...
## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:12 - Relations

* **Builds on:** [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] holonic foundation, `A.1.1 U.BoundedContext`, [[00_A.02 - Role Taxonomy|A.2]] role, `A.2.1 U.RoleAssignment`, `A.2.2 U.Capability`.
* **Coordinates with:** [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] for method descriptions; [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for dynamics; [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] for formal-substrate declarations; [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] for mechanism claims; [[00_C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use; [[02_A.15.02 - U.WorkPlan|A.15.2]] for work plans; [[01_A.15.01 - U.Work|A.15.1]] for dated work; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence relations or provenance relations; [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] for declarative representations overread as imperative routes or work sequences.
* **Informs:** [[00_E.18 - Transformation Flow Structure|E.18]] and [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] when transformation-flow-structure or P2W wording must keep flow-structure descriptions, graph/path mathematical expressions, method claims, and work claims separate.

## [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]:End
