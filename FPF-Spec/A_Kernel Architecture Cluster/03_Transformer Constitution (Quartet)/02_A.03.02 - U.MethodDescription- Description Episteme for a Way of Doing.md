...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:1 - Problem frame
...
**Not this pattern when.** Do not use this pattern merely because the source says `algorithm`, `program`, `proof`, `workflow`, `process`, `procedure`, `recipe`, or `model`. First recover the slot. The current claim may instead be `A.3.1 U.Method`, [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] formal-substrate declaration, [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] or [[00_E.20 - Mechanism Introduction Protocol|E.20]] mechanism meaning, `A.15.2 U.WorkPlan`, `A.15.1 U.Work`, an evidence relation, a publication-use relation, or quote-only source wording.

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:2 - Problem
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:3 - Forces
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4 - Solution

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.1 - Definition
...
| selected formal object, invariant, substrate, or mathematical declaration | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], or another direct mathematical pattern |
| law-governed operation structure, admissibility predicate set, transport, or realization relation | [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], with [[00_E.20 - Mechanism Introduction Protocol]] when mechanism meaning is introduced or revised |
...
| evidence relation or provenance relation for a claim, effect, or use | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_G.06 - Evidence Graph & Provenance Ledger]], or the direct evidence pattern or assurance pattern |

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.2 - Representation-agnostic stance
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.3 - Method-description fields
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.4 - Method-description acceptance and use boundaries
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.5 - Method, mechanism, and formal-substrate boundary
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.6 - Constructor and process-theory note
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:4.7 - Declarative representation boundary
...
If the source turns a graph path, evidence path, query plan, predicate, checklist, publication face, or pattern relation into a route, dispatch, call sequence, receiver path, or work workflow by metaphor, apply [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] before assigning the direct governing pattern.

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5 - Archetypal Grounding
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5.1 - Industrial procedure
...
The scheduled maintenance-window run is `U.WorkPlan`; tool run `W-143` is `U.Work`; metrology output becomes evidence only when an evidence pattern governs the relevant claim or use; gas-flow equations may require [[00_C.29 - Mathematical Lens Use|C.29]] or [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]].

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5.2 - Optimization model
...
The same files may also carry formal-substrate claims: variables, constraints, objective, admissible solution set, and invariants. A solver run with timestamps is work. A selector mechanism, if declared, lives under [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]].

Do not infer that solver search order is the project work sequence.

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5.3 - Proof script
...
### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5.4 - Clinical guideline
...
Regulatory acceptance, authorization to use, patient-specific dated enactment, and causal-use claims are separate. If the resulting work is used for a causal claim, apply [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]].

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:5.5 - Workflow diagram
...
If the diagram is being interpreted as a route that tokens or workers must follow, check whether that route claim is truly part of the method. If it is only a diagrammatic overread of constraints, objects, events, or graph structure, use [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] and the direct governing pattern.

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:6 - Bias-Annotation
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:7 - Conformance Checklist
...
**CC-A3.2-6 (Description not mechanism).** A method description does not close a mechanism claim. If operation algebra, law set, admissibility predicates, applicability, transport, audit, or realization relation is current, use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] as needed.

**CC-A3.2-7 (Description not formal substrate).** A method description does not close a formal-substrate or mathematical-lens claim. If variables, equations, invariants, structure, substrate, or mathematical payoff are current, use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[00_C.29 - Mathematical Lens Use|C.29]], or the direct mathematical pattern.
...
**CC-A3.2-14 (Declarative representation).** If a method description contains declarative representations, do not overread them as ordered work-control claims. Use [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when route, path, call, dispatch, receiver, workflow, or lifecycle language hides the represented object or direct governing pattern.

**CC-A3.2-15 (Causal-use boundary).** A method description may describe intervention assignment, target-trial emulation, realized-counterfactual sampling, simulation, or causal-evidence collection. It does not by itself establish causal use. If causal effect, intervention success, counterfactual comparison, causal fairness, or policy effect is claimed, use [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]].

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:8 - Common Anti-Patterns and How to Avoid Them
...
| "The query plan calls the next step." | Check whether this is a database plan, method description, formal representation, or metaphorical overread; use [[01_C.02.P.DR - Declarative Representation Precision Restoration]] when needed. |
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:9 - Consequences
...
| Declarative representations can be used without being turned into ordered work-control claims. | Route-like language needs [[01_C.02.P.DR - Declarative Representation Precision Restoration]] or a direct governing-pattern assignment. |

### [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:9.1 - Quick use cards
...
* **Mechanism needs laws.** Use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] when operation algebra, laws, admissibility, transport, audit, or realization is current.
* **Math needs its own claim.** Use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] and [[00_C.29 - Mathematical Lens Use|C.29]] when formal substrate or mathematical-lens use is current.
* **No ordered-action overread.** Use [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when declarative representations are overread as ordered action structures.

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:10 - Rationale
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:11 - SoTA-Echoing
...
## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:12 - Relations
...
* **Coordinates with:** `A.15.2 U.WorkPlan`; `A.15.1 U.Work`; [[00_A.02 - Role Taxonomy|A.2]] and [[01_A.02.01 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] for role and role-assignment claims; [[02_A.02.02 - U.Capability|A.2.2]] for capability thresholds; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for evidence and assurance; [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] for causal-use claims.
* **Separates from:** [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] formal-substrate declarations; [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use; `A.6.1 U.Mechanism`; [[00_E.20 - Mechanism Introduction Protocol|E.20]] mechanism-meaning introduction and revision.
* **Uses for precision restoration:** [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], and [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when method-like or representation-like wording hides the governed slot.

## [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]:End
