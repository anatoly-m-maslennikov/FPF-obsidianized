...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:1 - Problem frame
...
**Not this pattern when.** If the source only states a semantic way of doing, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]. If it states an episteme describing that way, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]. If it states bounded transformation under conditions, use [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]. If it states planned work or dated work, use [[02_A.15.02 - U.WorkPlan|A.15.2]] or [[01_A.15.01 - U.Work|A.15.1]]. If it states a mechanism algebra, use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]]. If it states only freshness, rhythm, inertia, delay, window, or currentness as a positive temporal aspect, use [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]]; if it states adequacy or supported use of an authored temporal claim, use [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]. If it states only evidence or assurance, use [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]].

## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:2 - Problem
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:3 - Forces
...
| Mathematical power and transfer risk | Mathematical form can make prediction precise, but transfer across domains, scales, or representations needs [[00_C.29 - Mathematical Lens Use]] and sometimes [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]]. |
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4 - Solution

### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.1 - Definition
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.2 - Dynamics statement
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.3 - Working distinction table
...
| mechanism algebra, admissible operation, or law-governed application over a subject kind | `A.6.1 U.Mechanism` and [[00_E.20 - Mechanism Introduction Protocol]] |
| formal object, invariant, postulate set, or mathematical substrate | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], or the direct mathematical pattern |
| observation, trace, conformance result, source, or provenance used as evidence | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] and direct evidence-related patterns |
| assurance case, trust calculus, or safety argument | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] or the direct assurance pattern |
| gate passage, release, authority, or permission to act | [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], or the direct gate or authority pattern |
| bounded transformation under conditions | `A.3.4 U.Transformation` |
| freshness, delay, rhythm, currentness, inertia, cadence, or validity window as a positive temporal aspect | [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] |
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.4 - State-space and transition-law fields
...
`stateSpace` is the state-space declaration of this `U.Dynamics` episteme. It uses FPF characteristics with units, scales, and comparability rules, and may cite [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] or [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] when characteristic or measurement construction is being made. It is not the same object as a receiving-evaluation `CharacteristicSpace` used to score an object for improvement. The dynamics state space may include topology, geometry, aggregation policy, or coordinate transformations when trajectories or comparisons need them.
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.5 - Evidence, prediction, conformance, drift, and calibration
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.6 - Prediction use in comparison or gating
...
If neither condition is satisfied, prediction does not carry the gate or comparison claim. Use observation, state currentness through [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], use [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] when authored temporal-claim adequacy is the concern, or move the gate claim to [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or the direct authority pattern.
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.7 - [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], and [[00_C.29 - Mathematical Lens Use|C.29]] boundaries

[[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] governs bounded transformation under conditions. A dynamics episteme can model, predict, simulate, or constrain a transformation, but it is not the transformation itself.

[[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] names positive temporal aspects: freshness, delay, rhythm, currentness, inertia, cadence, trajectory, recovery timing, stabilization timing, and validity window. [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] judges adequacy or supported use of authored temporal claims that use those aspects. A `Dyn2TemporalClaimAdequacyCard` or temporal classification is not itself a law of change.

Stay in [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] when `transitionLaw` or `observationRelation` uses accepted local dynamics, Markov kernels, ODEs, simulations, queueing theory, control theory, or domain theory inside one context.

Use [[00_C.29 - Mathematical Lens Use|C.29]] when the law depends on contested transfer, cross-domain analogy, learned or speculative mathematical lens, scale change, abstraction, quotienting, or reusable explanation across contexts. The [[00_C.29 - Mathematical Lens Use|C.29]] output states preserved structure, lost structure, operating-region or scale window, rival lens when current, lens-use boundary value, and stop condition. [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] remains the governing pattern for state space, transition law, observation, constraints, and calibration semantics.

### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:4.8 - Method, mechanism, and governing-pattern constellation boundary

A source label such as `process`, `algorithm`, `dynamics`, `workflow`, `model`, `controller`, or `simulator` may point to linked slot positions under [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], not to one typed value. Recover the relevant slots first, then split the linked values:
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5 - Archetypal Grounding

### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5.1 - Reactor control

A reactor team models temperature and concentration under a nonlinear ODE with disturbances. The ODE, state space, observation relation, and operating region are `U.Dynamics`. The control policy is `U.Method`; the controller code is `U.MethodDescription` when it describes the method, and dated controller runs or mechanism claims stay with their governing patterns. Thermocouple readings become evidence only through [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or the direct evidence pattern.
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5.2 - Reliability and operations
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5.3 - Evolutionary architecture
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5.4 - Knowledge dynamics
...
### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:5.5 - Natural physical evolution
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:6 - Bias-Annotation
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:7 - Conformance Checklist
...
**CC-A3.3-11 (Temporal boundary).** Positive temporal aspects stay with [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]]; temporal-claim adequacy, freshness-use, delay-use, rhythm-use, inertia-use, and currentness-use claims stay with [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]; reusable transition laws stay with [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]].

**CC-A3.3-12 ([[00_C.29 - Mathematical Lens Use|C.29]] boundary).** Contested, cross-domain, learned, speculative, scale-changing, or transferable mathematical-lens use is assigned to [[00_C.29 - Mathematical Lens Use|C.29]]; [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] keeps the dynamics semantics.
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:8 - Common Anti-Patterns and How to Avoid Them
...
| "The simulation approved the release." | Keep simulation as prediction; use [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] for gate, evidence, and assurance claims. |
| "The model works everywhere." | State the applicability window and lowering condition; use [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] for currentness and [[00_C.29 - Mathematical Lens Use]] for transfer. |
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:9 - Consequences
...
| Methods, method descriptions, mechanisms, work, flow structures, and dynamics stop substituting for each other. | Source labels like `process`, `workflow`, and `model` often need [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]] recovery before typed assignment. |
...
| Mathematical-lens transfer is visible rather than hidden inside equations. | [[00_C.29 - Mathematical Lens Use]] may be needed when the dynamics model crosses contexts, scales, or representation regimes. |

### [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:9.1 - Quick use cards
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:10 - Rationale
...
## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:12 - Relations
...
* **Coordinates with:** `A.3.1 U.Method`; `A.3.2 U.MethodDescription`; `A.3.4 U.Transformation`; `A.15.2 U.WorkPlan`; `A.15.1 U.Work`; `A.6.1 U.Mechanism`; [[00_E.20 - Mechanism Introduction Protocol|E.20]]; [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]]; [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]]; [[00_C.29 - Mathematical Lens Use|C.29]]; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]; [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; architecture patterns when dynamics describes architecture-characteristic change.
...
* **Uses for precision restoration:** [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], and [[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] when source labels hide whether the claim is law, method, method description, mechanism, work, evidence, authority, or dynamics.

## [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]]:End
