...
terms:
  ...
  - U.Transformation
builds_on:
  - "[[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]"
  - "[[00_A.03 - Transformer Constitution (Quartet)|A.3]]"
  ...
  - "[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]"
...
coordinates_with:
  ...
  - "[[00_A.03 - Transformer Constitution (Quartet)|A.3]]"
  - "[[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]"
  - "[[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]"
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:0 - Use This When
...
- If the issue is only a semantic way of doing, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]].
- If the issue is a description of that way, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]].
- If the issue is a state-space and transition-law episteme, use [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]].
- If the issue is a law-governed operation algebra with admissibility predicates, use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]].
- If the issue is planned or dated work, use [[02_A.15.02 - U.WorkPlan|A.15.2]] or [[01_A.15.01 - U.Work|A.15.1]].
- If the issue is the selected compound transformation-flow structure, its locus, path, path slice, crossing, or flow valuation, use [[00_E.18 - Transformation Flow Structure|E.18]].
- If the issue is a graph, algebra, category, tuple, morphism, quotient, fold, refinement, factorization, or wiring expression used to describe that structure mathematically, use [[02_E.18.02 - Transformation Flow Mathematical Description|E.18.2]] and [[00_C.29 - Mathematical Lens Use|C.29]].
- If the issue is a positive temporal aspect of an object or claim, use [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]].
- If the issue is adequacy or supported use of a temporal claim, use [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]].

## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:1 - Problem Frame
...
- [[00_A.03 - Transformer Constitution (Quartet)|A.3]] for transformer constitution: acting system bearing `TransformerRole`, method description, method, and actual work;
- [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] for `U.Method`;

- [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] for `U.MethodDescription`;
- [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] for `U.Dynamics`;
- [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] for signatures and slot discipline;
- [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]] for mechanisms;
- [[02_A.15.02 - U.WorkPlan|A.15.2]] and [[01_A.15.01 - U.Work|A.15.1]] for work plans and dated work;
- [[00_E.18 - Transformation Flow Structure|E.18]] for transformation-flow structures;
- [[02_E.18.02 - Transformation Flow Mathematical Description|E.18.2]] for mathematical descriptions of transformation-flow structures;
- [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] for problem-to-principle-to-work carry-through;
- [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] for positive temporal aspects;
- [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] for temporal-claim adequacy;
- [[00_C.29 - Mathematical Lens Use|C.29]] for mathematical-lens use;
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:2 - Problem
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:3 - Forces
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4 - Solution

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.1 - Definition
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.2 - Transformation Core
...
The modularity rule is: the slot belongs to the transformation ontic, while the filler keeps its governing kind and pattern. A `MethodRef?` slot may be filled by `U.Method` under [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]; a `WorkOccurrenceRef?` slot may be filled by `U.Work` under [[01_A.15.01 - U.Work|A.15.1]]; a `MechanismRef?` slot may be filled by `U.Mechanism` under [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]]. This prevents two bad moves at once: it does not collapse method, mechanism, and work into transformation identity, and it also does not pretend that a transformation claim can ignore the way, enactment, evidence, or description that the claim relies on.

When an authored text, dashboard, proof, publication, model, or project record makes claims about the transformation, model that claim-bearing value through [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] rather than duplicating the episteme ontic here:
...
This shorthand is only a [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] application. It does not add a second slot relation to [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]], and it must not make the description, publication, proof, dashboard, source span, or record into the transformation itself.

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.3 - Transformed Object Discipline
...
Use current [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] for the holon, entity, or system source line and the governing subject pattern for the filled object. A `U.System`, `U.Episteme`, architecture-selected structure, work product, organization, physical object, document or specification episteme, formal object, or project-world object can fill the slot. The slot does not make the filler a new kind, and the filler does not become `U.Transformation` merely by occupying the slot.

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.4 - Ontic Slot Relation, Identity Slots, and Participation Checklist

`U.Transformation` uses [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] slot discipline. This section is the type-level `onticSlotRelation` schema expressed through `SlotSpec` rows for `U.Transformation`. It has two slot statuses:
...
| `boundedContext` | `U.BoundedContext` or direct context-governing pattern when current | The context-of-meaning in which this is one transformation; if the context name becomes durable, public, Core-facing, or cross-context, use [[00_F.18 - Local-First Unification Naming Protocol]] and `F.17 UTS`. |
...
| `transformationRelation` | relation, task, transition, operation family, morphism, construction, transformation-flow structural relation via [[00_E.18 - Transformation Flow Structure]] when current, or declared transformation predicate | What makes this one bounded change a transformation rather than an unrelated before-and-after pair. |
...
| `temporalOrOrderingReference?` | [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] temporal aspect, time window, order relation, cadence, duration, or not-triggered | The timing or ordering reference when it changes the transformation claim. |

Participation and check slots:

| Participation and check slot | Filler kind or governing pattern | Consideration rule |
| --- | --- | --- |
| `TransformerRef?` | `U.System`, candidate system, or system-in-role locus bearing `TransformerRole@Context`; use [[00_A.07 - Strict Distinction (Clarity Lattice)]] and the role/work family when role assignment, responsibility, capability, work, or enactment is current | Consider who or what produces, enacts, carries, realizes, or sustains the transformation. A `FunctionalElement@Context` may recover this transformer locus in a functional structure view, but reactors, enzymes, control systems, service organizations, scripts, instruments, manufacturing cells, and document-editing systems can also fill it. If a source cue names the device or system side that performs input-output conversion, map it here plus any current signature, mechanism, capability, method, work, port, interface, or module-allocation claim; do not mint a second transformer kind from the source cue. |
| `InputConditionOrPortRefs?` | input state, material, energy, signal, information, work product, formal object, condition, or functional-port signature; use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]], [[12_A.06.M - Module Relation Repair]], [[00_E.18 - Transformation Flow Structure]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], and the domain pattern when current | Consider inputs when boundary, transfer, conservation, loss, acceptance, port, or functioning claims depend on what enters or is accepted by the transformation. Inputs may constrain identity only when the input boundary distinguishes this transformation; otherwise they are participation/check slots. |
| `OutputConditionOrPortRefs?` | output state, produced flow, result condition, work product, formal object, or functional-port signature; use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]], [[12_A.06.M - Module Relation Repair]], [[00_E.18 - Transformation Flow Structure]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], and result/evidence patterns when current | Consider outputs when the claim depends on produced state, flow, work product, condition, port, transfer, conservation, loss, acceptance, or flow boundary. Keep output distinct from result evidence and publication: an output may identify or constrain the transformation, while evidence/result patterns govern proof, observation, or acceptance claims. |
| `FunctioningRef?` | governed relation/use value linking `FunctionalElement@Context` to `U.Transformation` or `TransformationFlowStructure`; use [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle]], and [[12_A.06.M - Module Relation Repair]] for the functional-view, viewpoint, and allocation sides | Consider when this transformation is functioning of a functional element: the bearer-system's functional behavior in a bounded functional structure view, often located inside a transformation-flow structure. The slot may name functional element, bearer, `TransformerRole`, capability, functional port signatures, flow location, module allocation, and status such as required, possible, intended, observed, degraded, or blocked when those claims are current. It is not a new `U.Functioning` root. |
| `MethodRef?` | `U.Method` via [[01_A.03.01 - U.Method- Context-Defined Way of Doing]] | Consider the way by which the transformation is specified, selected, guided, repeated, or compared. An algorithm may fill this slot only when the current claim is the semantic way of doing under conditions; otherwise recover method description, formal substrate, mechanism, work, or evidence through its governing slot. If no method is recovered, do not infer method absence; mark unknown or not recovered, or lower a method-dependent claim. |
| `MethodDescriptionRef?` | `U.MethodDescription` via [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]]; [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] when the description is claim-bearing | Consider an authored procedure, protocol, solver formulation, proof script, algorithm text, or other description when it is used around the transformation. This is a description episteme or source value, not the transformation and not necessarily the method itself. |
| `MechanismRef?` | `U.Mechanism` via [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] and [[00_E.20 - Mechanism Introduction Protocol]] | Consider a law-governed operation algebra, realization structure, admissibility predicate, or mechanism-method stabilization claim when it governs how the transformation can occur. |
| `WorkPlanRef?` | `U.WorkPlan` via [[02_A.15.02 - U.WorkPlan]] | Consider planned dated work when the transformation is planned, proposed, coordinated, or carries a planned-responsibility claim. Recover role requirements or proposed `U.RoleAssignment`s when planning responsibility, performer eligibility, or cross-role coordination is current. |
| `WorkOccurrenceRef?` | `U.Work` via [[01_A.15.01 - U.Work]] | Consider performed dated work when the transformation is claimed as enacted, observed through work, traced, result-producing, or responsibility-bearing. Recover `performedBy -> U.RoleAssignment`, `enactsMethod -> U.Method`, method-description source when current, affected referent, result, and evidence relation when current. |
| `TransformationFlowStructureRef?` | [[00_E.18 - Transformation Flow Structure]] selected compound transformation-flow structure, transformation locus, path, path slice, substructure, crossing, or flow valuation | Consider when an [[00_E.18 - Transformation Flow Structure]] structure composes, decomposes, constrains, orders, couples, or locates the atomic bounded change itself. Use it to fill or constrain `transformationRelation` or structural context; do not infer method, mechanism, work, publication, gate, or evidence from structural position unless the corresponding slot filler is recovered through its governing pattern. |
| `TransformationFlowMathematicalDescriptionRef?` | [[02_E.18.02 - Transformation Flow Mathematical Description]] graph, algebra, category, tuple, morphism, path, slice, quotient, fold, refinement, factorization, or wiring expression, coordinated with [[00_C.29 - Mathematical Lens Use]] when lens choice matters | Consider when a mathematical description or lens expresses, compares, folds, decomposes, or computes over the selected transformation-flow structure. This slot is about the description/lens; it does not by itself define the in-life transformation relation or enactment. |
| `DynamicsEpistemeRef?` | `U.Dynamics` via [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] | Consider state-space, transition-law, or control-model claims when they model, predict, or bound the transformation. |
| `TemporalAspectRef?` | [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] | Consider time window, rhythm, cadence, duration, synchronization, currentness, recovery, stabilization, effort, inertia, or validity window when it matters to the transformation claim. |
| `TemporalClaimAdequacyRef?` | [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] | Consider temporal-claim adequacy when an authored temporal claim about the transformation is being used for action, comparison, promise, assurance, or source-currentness. |
| `FormalOrMathLensRef?` | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], or direct formal or mathematical pattern | Consider formal substrate, invariant, morphism, construction, state-space, task, or mathematical lens when it states, constrains, or compares the transformation relation. |
| `EvidenceOrSourceRef?` | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_G.06 - Evidence Graph & Provenance Ledger]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], source/currentness patterns, or the direct domain evidence pattern when current | Consider evidence, source use, provenance, measurement, model assumption, or source-currentness. Recover the exact typed value under the governing evidence, source, measurement, provenance, or currentness pattern; these are not one kind. |
...
| `GateDecisionAssuranceRef?` | [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_G.06 - Evidence Graph & Provenance Ledger]], [[00_C.11 - Decision Theory (Decsn-CAL)]], or the direct gate, decision, assurance, permission, or release-authority pattern when current | Consider permission, release, gate passage, assurance, responsibility, or decision. Recover the exact gate, decision, assurance, permission, responsibility, or release-authority value under its governing pattern; these are not one kind. |
| `PublicationOrDescriptionRef?` | [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]], [[03_E.17 - Multi-View Publication Kit]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences]], [[01_E.17.01 - U.ViewpointBundleLibrary - Reusable Viewpoint Bundles]], [[02_E.17.02 - TEVB - Typical Engineering Viewpoints Bundle]], or the direct publication, view, carrier, source, or specification-use pattern when current | Consider description, dashboard, diagram, source span, proof, publication, or view when it is used around the transformation. Use [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] for a claim-bearing transformation description episteme and [[03_E.17 - Multi-View Publication Kit]] family or the direct publication/source/specification-use pattern for publication, view, source-use, or publication-use claims. |
...
[[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] does not duplicate [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] role slots and does not add `RoleAssignmentRef?` as an identity slot. If a transformation claim depends on planned or performed work, recover the role-method-work chain through [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], and [[02_A.15.02 - U.WorkPlan|A.15.2]]. If the required `U.RoleAssignment`, holder, role, context, method, work plan, or work occurrence cannot be recovered, lower or block the work-dependent transformation claim.

[[00_E.18 - Transformation Flow Structure|E.18]] locus labels do not automatically fill [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] slots. A transformation-flow locus labelled as mechanism points to mechanism-governing content under [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] and [[00_E.20 - Mechanism Introduction Protocol|E.20]]; it fills `MechanismRef?` only when that mechanism value is recovered. A locus labelled as work or work enactment fills `WorkOccurrenceRef?` only when a dated performed-work occurrence is current under [[01_A.15.01 - U.Work|A.15.1]]. A signature locus points to [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]]; a check locus points to gate or constraint-validity claims under [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]. Method and method-description slots still use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] and [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]; a readable structure order does not create a method.

This is a weak dependency on [[00_E.18 - Transformation Flow Structure|E.18]], not an identity dependency. Every `U.Transformation` may later receive a one-locus, path-slice, substructure, or containing-flow-structure expression, but [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] does not require such a structure to identify the transformation. When the structure is current, it helps recover method, work, mechanism, publication, evidence, gate, result, or refresh slots by pointing to structure-local loci; the filled values still remain governed by their own patterns.
...
When the current object is a claim-bearing description of the transformation, use [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] explicitly:
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.5 - Neighboring Distinction Table

| Current claim | Governing pattern |
| --- | --- |
| bounded transformation under conditions | `A.3.4 U.Transformation` |
| transformation-flow structure, path, path slice, substructure, crossing, or flow valuation as compound structure, locus, or context | [[00_E.18 - Transformation Flow Structure]]; [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions]] only for the atomic bounded transformation claim |
| graph, algebra, category, tuple, morphism, path, slice, quotient, fold, refinement, factorization, or wiring expression used as mathematical description or lens | [[02_E.18.02 - Transformation Flow Mathematical Description]], coordinated with [[00_C.29 - Mathematical Lens Use]] when lens adequacy matters |
...
| law-governed operation algebra with admissibility predicates | `A.6.1 U.Mechanism` and [[00_E.20 - Mechanism Introduction Protocol]] |
| formal declaration, substrate, invariant, morphism, construction, or postulate set | [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[00_C.29 - Mathematical Lens Use]], or the direct mathematical pattern |
| planned dated work | `A.15.2 U.WorkPlan` |
| dated work occurrence | `A.15.1 U.Work` |
| positive temporal aspect | [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] |
| temporal claim adequacy | [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] |
| problem-to-principle-to-work carry-through | [[01_E.18.01 - Principles-to-Work Carry-Through]] |
| evidence, assurance, gate, decision, source, result, or publication use | the direct governing pattern for that claim |

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.6 - Description And Publication Boundary
...
If the description itself is under concern, use [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.18 - Transformation Flow Structure|E.18]], or the direct publication or source pattern. If the transformation is under concern, keep the description as a neighboring episteme or publication value.

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.7 - Formal Transformation And Project-World Realization
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:4.8 - Typed Bundle Recovery Slice
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:5.2 - Biological Editing
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:5.3 - Specification Repair
...
### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:5.4 - Formal Construction

A mathematical proof constructs an object and shows that a morphism preserves a chosen invariant.

`U.Transformation` may govern the formal transformation when the formal object is the `EntityOfConcern`: initial formal object, constructed object or delta, morphism or construction relation, and admissibility or invariant condition. Formal substrate or mathematical lens fills `FormalOrMathLensRef` unless it is already the context-of-meaning for the formal object; the proof relation fills evidence or source support or a [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] claim-bearing episteme, not core transformation identity. It does not describe project-world work until a separate realization, method, work, or evidence relation is named.

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:5.5 - Architecture Move
...
`U.Transformation` names the structure change and delta condition. The architecture pattern governs the selected structure and characteristic; [[00_C.29 - Mathematical Lens Use|C.29]] may supply a mathematical lens for preserved and lost structure; [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] may govern trajectory, cadence, recovery, inertia, or validity window; work planning and dated work stay with [[02_A.15.02 - U.WorkPlan|A.15.2]] and [[01_A.15.01 - U.Work|A.15.1]].

### [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:5.6 - Functional Transformer In A Flow
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:6 - Bias-Annotation
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:7 - Conformance Checklist
...
| `CC-A34-3` | The transformed object is typed through its governing pattern, with [[00_A.01 - U.Holon, U.System, and U.Episteme]] used for entity, holon, or system source discipline where relevant. |
...
| `CC-A34-5` | A [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] episteme may carry claims about the transformation, one transformation slot, one slot filler, or a relation among those values, but descriptions and publications of a transformation are not treated as the transformation itself. |
| `CC-A34-6` | Time, rate, rhythm, cadence, effort, inertia, freshness, validity-window, or ordering wording uses [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] for positive temporal aspects and [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] for temporal-claim adequacy. |
| `CC-A34-7` | Formal or mathematical structure uses [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]], [[00_C.29 - Mathematical Lens Use]], or the direct mathematical pattern before it is used as a transformation law, formal relation, or evidence relation. |
| `CC-A34-8` | Evidence, assurance, gate, result acceptance, and decision authority are not inferred from `TransformationCore` or from a [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] episteme about the transformation. |
| `CC-A34-9` | The identity-plus-participation slot relation follows [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]] SlotKind/ValueKind/RefKind discipline; dependent patterns may cite `U.Transformation`, filled identity slots, or specific participation and check slots without copying the full slot relation or turning their own values into identity slots. |
| `CC-A34-10` | Functional-transformation uses recover `TransformerRef?`, `InputConditionOrPortRefs?`, `OutputConditionOrPortRefs?`, `FunctioningRef?`, and `TransformationFlowStructureRef?` when those claims are current; none is silently left to [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], or [[00_E.18 - Transformation Flow Structure]] as an outside reference. |
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:8 - Common Anti-Patterns
...
| Process diagram as work | A workflow diagram is treated as enacted work. | Use [[00_E.18 - Transformation Flow Structure]] or [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing]] for the diagram; use [[01_A.15.01 - U.Work]] for dated work. |
| Dynamics model as permission | A transition law is used to approve action. | Keep [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]] for the model; use evidence, gate, decision, and assurance patterns for use authority. |
| Temporal trend as intervention | A rate or rhythm trend is treated as proof of changed behavior under an intervention. | Use [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness]] for the temporal aspect, [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]] for temporal-claim adequacy, and name the transformation relation separately. |
| Formal construction as work | A morphism or proof construction is treated as work performed in a project-world object. | Use [[00_C.29 - Mathematical Lens Use]] or the direct formal pattern for the mathematical relation; name realization and work separately. |
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:9 - SoTA-Echoing

| Source family | Current lesson for [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions]] | FPF decision |
| --- | --- | --- |
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:10 - Consequences
...
- [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]] can carry positive temporal aspects while [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]] stays focused on temporal-claim adequacy and supported use.
- [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]] can stay an episteme pattern for state-space and transition-law claims.
...
## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:11 - Relations

- **Builds on:** [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]], [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]], [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]], [[00_A.03 - Transformer Constitution (Quartet)|A.3]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]].
- **Coordinates with:** [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]], [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]], [[00_E.20 - Mechanism Introduction Protocol|E.20]], [[01_A.15.01 - U.Work|A.15.1]], [[02_A.15.02 - U.WorkPlan|A.15.2]], [[00_E.18 - Transformation Flow Structure|E.18]], [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]], [[01_C.27.TA - Temporal Aspect- Time Windows, Rhythm, Cadence, and Currentness|C.27.TA]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[00_C.29 - Mathematical Lens Use|C.29]], evidence, gate, decision, source, result, assurance, and publication patterns.
- **Specializes:** the [[00_A.03 - Transformer Constitution (Quartet)|A.3]] transformer-constitution family for bounded transformations under declared conditions.

## [[00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]]:End
