...
**Builds on.** [[E_The FPF Constitution and Authoring Guides/01_02_The Eleven Pillars/00_E.02 - The Eleven Pillars|E.2]] (**P‑10 Open‑Ended Evolution; P‑2 Didactic Primacy**), [[A_Kernel Architecture Cluster/05_Open-Ended Kernel & Extension Layering/00_A.05 - Open-Ended Kernel & Extension Layering|A.5]], [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]–[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]] - **Coordinates with.** [[E_The FPF Constitution and Authoring Guides/06_07_Archetypal Grounding Principle/00_E.07 - Archetypal Grounding Principle|E.7]], [[E_The FPF Constitution and Authoring Guides/07_08_FPF Authoring Conventions & Style Guide/00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]]; [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]] (UTS); [[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]], [[G_Discipline SoTA Patterns Kit/10_09_Parity and Benchmark Harness/00_G.09 - Parity and Benchmark Harness|G.9]]–[[G_Discipline SoTA Patterns Kit/13_12_DHC Dashboards (Discipline-Health time-series; admissible telemetry; generation-first)/00_G.12 - DHC Dashboards (Discipline-Health time-series; admissible telemetry; generation-first)|G.12]] - **Constrains.** Any pattern/UTS row that **describes a generator, selector, typed portfolio publication, or set-return publication surface**.
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:1 - Problem Frame
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:4 - Solution - Normative onboarding glossary and publication hooks

### 4.1 Plain one‑liners (normative on‑ramp; formal anchors in [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]–[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]])

| Term                      | Plain definition (on‑ramp)                                                                                                                                   | See        |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| **Novelty (N)**           | *How unlike the known set in your declared **CharacteristicSpace**. **Compute admissibly** (declared `DescriptorMapRef` + `DistanceDefRef`; no ad-hoc normalisation). | [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]], [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]] |
| **Use‑Value (U / ValueGain)** | *What it helps you achieve now under your **CG‑Frame**; tie to acceptance/tests; **publish units, scale kind, polarity, ReferencePlane**.                   | [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]], [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]] |
| **Constraint‑Fit (C)**    | *Satisfies must‑constraints (Resource/Risk/Ethics)*; legality via **CG‑Spec**; **unknowns propagate** (never coerce to zero).                                | [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]], [[G_Discipline SoTA Patterns Kit/05_04_CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring/00_G.04 - CAL Authoring for a CG-Frame- Operators, Acceptance Clauses, Evidence Wiring]]  |
| **Diversity_P (declared retained set)** | *Adds a new niche to the declared retained set or portfolio-publication surface; measured against the **active archive/grid**, not a single list; declare **ReferencePlane** for each head.          | [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)]], [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/00_C.18 - Open-Ended Search Archive and Front Stewardship]] |
| **E/E‑LOG**               | *Named, versioned **explore↔exploit** policy*; governs when to widen space vs refine candidates; **policy‑id is published**.                                   | [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor]]       |
| **ReferencePlane**        | *Where a value lives:* **world** (system), **concept** (definition), **episteme** (about a claim). **Plane‑crossings add CL^plane** (penalties to **R only**); cite policy‑id. | [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/00_F.09 - Alignment and Bridge across Contexts]], [[G_Discipline SoTA Patterns Kit/07_06_Evidence Graph and Provenance Ledger- Citable Evidence-Provenance Paths/00_G.06 - Evidence Graph and Provenance Ledger- Citable Evidence-Provenance Paths]]   |
| **Scale Variables (S)**  | *The **monotone knobs** along which improvement is expected* (e.g., parameterisation breadth, data exposure, iteration budget, resolution). **Declare S** for any generator/selector claimed to scale. | [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/01_C.18.01 - Scaling-Law Lens Binding (SLL)]]       |
| **Scale Elasticity (χ)** | *Qualitative class of improvement when moving along S* (e.g., **rising**, **knee**, **flat** in the declared window). Used as a **selection lens**; numeric laws live in domain contexts.              | [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/01_C.18.01 - Scaling-Law Lens Binding (SLL)]]       |
| **BLP (Bitter‑Lesson Preference)**  | *Default policy that **prefers general, scale‑amenable methods** over domain‑specific heuristics, unless forbidden by deontics or overturned by a scale‑probe.*                                        | [[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/01_C.19.01 - Bitter-Lesson Preference (BLP)]], [[C_Kernel Extension Specifications/12_24_Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)/00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] |
| **Iso‑Scale Parity**  | *Fair comparison across candidates at equalised **scale budgets** along S*; may also include **scale‑probes** (two points) to test elasticity.                                                         | [[G_Discipline SoTA Patterns Kit/10_09_Parity and Benchmark Harness/00_G.09 - Parity and Benchmark Harness]], [[C_Kernel Extension Specifications/06_18_Open-Ended Search Archive and Front Stewardship/01_C.18.01 - Scaling-Law Lens Binding (SLL)]]  |
...
1. **UTS surface (Part F).** When a **UTS row describes a generator, selector, typed portfolio publication, or set-return publication surface**, it **MUST** surface **N, U, C, Diversity_P, E/E‑LOG `policy‑id`, `ReferencePlane`**, with **units, scale, and polarity** typed under **MM‑CHR** and **CG‑Spec**, and admissible references to `DescriptorMapRef` and `DistanceDefRef`. *(Row schema: [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]]; shipping via [[G_Discipline SoTA Patterns Kit/11_10_SoTA Pack Shipping/00_G.10 - SoTA Pack Shipping|G.10]].)*
...
4) Apply **[[G_Discipline SoTA Patterns Kit/06_05_Multi-Method Dispatcher and MethodFamily Registry/00_G.05 - Multi-Method Dispatcher and MethodFamily Registry|G.5]]** selection/dispatch with parity pins; **return a declared set result** (`Front`, `Archive`, `Shortlist`, or `RankedShortlist` as appropriate), not a single score or an unnamed "portfolio".
5) **Publish to UTS** + **PathIds/PathSliceId**; **Illumination Map** is **report‑only telemetry** by default.

## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:5 - Archetypal Grounding
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:6 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:7 - Conformance Checklist (SCR/RSCR stubs)
...
| **CC‑A0‑6** | Apply **E.7/E.8**: include a **U.System** and a **U.Episteme** illustration when claiming generative behaviour; obey **[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF]]** register hygiene; use the exact subsection title **“Archetypal Grounding.”** | Locks didactic primacy; prevents jargon drift.                                  |
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:8 - Consequences
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:9 - Rationale

This pattern **instantiates P‑10 Open‑Ended Evolution** by making *generation‑selection‑publication* **operational** at the on‑ramp: readers get just enough shared vocabulary to run *search as standard practice*. It aligns with **Didactic Primacy (P‑2)** and **LEX‑BUNDLE ([[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]])** by keeping definitions *plain‑first* and scale‑lawful, and with **Patterns Layering (P‑5)** by pointing to [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]–[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]] for formal anchors without tool lock‑in. The post‑2015 line (MAP‑Elites → CMA‑ME/MAE → Differentiable QD/MEGA → QDax; POET/Enhanced‑POET/Darwinian Goedel Machine) normalised **quality‑diversity** and **open‑endedness** as first‑class search objectives; this glossary surfaces those ideas as **publication standards**, not tool recipes.

## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:10 - Relations

**Builds on.** **[[E_The FPF Constitution and Authoring Guides/01_02_The Eleven Pillars/00_E.02 - The Eleven Pillars|E.2]] Pillars** (P-10, P-2, P-6), **[[A_Kernel Architecture Cluster/05_Open-Ended Kernel & Extension Layering/00_A.05 - Open-Ended Kernel & Extension Layering|A.5]]** (Open-Ended Kernel), **B.5/B.5.2.1** (Abductive loops + NQD integration), **[[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]–[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]** (Creativity-CHR, NQD-CAL, E/E-LOG).

**Coordinates with.** **E.7/E.8** (Archetypal Grounding; Authoring template), **[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]]** (LEX‑BUNDLE), **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]]** (UTS), **G.5/G.9–[[G_Discipline SoTA Patterns Kit/13_12_DHC Dashboards (Discipline-Health time-series; admissible telemetry; generation-first)/00_G.12 - DHC Dashboards (Discipline-Health time-series; admissible telemetry; generation-first)|G.12]]** (set‑returning selectors, **iso‑scale** parity, shipping & refresh).
...
**Editor’s cross‑reference.** For agentic orchestration of scalable tool‑calls under **BLP**/**SLL**, see **[[C_Kernel Extension Specifications/12_24_Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)/00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]] (Agent‑Tools‑CAL)**.

## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.0a - Scope of this glossary

This pattern is an **on‑ramp**: it **does not replace** [[C_Kernel Extension Specifications/05_17_Characterising Generative Novelty & Value (Creativity-CHR)/00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]–[[C_Kernel Extension Specifications/07_19_Explore-Exploit Live-Pool Governor/00_C.19 - Explore-Exploit Live-Pool Governor|C.19]]. It binds Plain definitions to **publication/telemetry** expectations so newcomers can *use* NQD/E/E‑LOG immediately while experts follow the formal trails.

## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.1 - Early set-result and metric-kind vocabulary
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.1a - Helper declarations for set-result language
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.2 - First public wording for shortlisted results
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.2a - Set/space reading reading glosses
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.2b - Practitioner-facing reading cue
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.2c - First-use classification check
...
## [[A_Kernel Architecture Cluster/00_Onboarding Glossary (NQD & E-E-LOG)/00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:End
