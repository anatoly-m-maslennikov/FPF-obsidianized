...
- If the current claim is the assignment relation linking holder, role, bounded context, and assignment window, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]].
...
| --- | --- |
| "Assigned, therefore able" | Role assignment in [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment]] plus capability claim in [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]]. |
| "Ready, therefore work happened" | State assertion here plus performed-work claim in [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work]] only if a `U.Work` occurrence is named. |
...
| "`RoleEnactment` occurred" | Use `U.Work` with `performedBy = U.RoleAssignment`; use `RoleEnactmentFact` from [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment]] only as a derived fact when naming the fact helps. |
...
| [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment]] | Governs `U.RoleAssignment`, the relation referenced by `StateAssertion`. |
...
| [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan]] | Govern method, work plan, performed work, and `performedBy = U.RoleAssignment`. |
| [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline]] | Governs SlotSpec discipline used to keep role-state relation slots distinct. |
