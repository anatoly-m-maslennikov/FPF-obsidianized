...
fpf_id: "A.2.1"
title: "U.RoleAssignment - Contextual Work-Role Assignment"
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:0 - Use This When
...
- If the current claim is the role value itself, role taxonomy, or role relation-neighborhood, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]].
...
- If the current claim is role state, role-state predicate, or enactable-state admission, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]].
- If the current claim is role-admission substitution, incompatibility, qualification, or role bundle, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/07_A.02.07 - RoleRelationStructure@BoundedContext - Context-Local Role Relations and Representation-Lens Boundary|A.2.7]].
- If the current claim is method, method description, work plan, performed work, or role-method-work alignment, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and the direct [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] subpattern.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:1 - Problem Frame
...
[[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] therefore defines `U.RoleAssignment` as a typed relation value using [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] SlotSpec discipline. The relation is enactment-facing: its holder is an admitted `U.System` selected as system-like performer by the governing method, work, transformation, or functioning pattern. "Performer" includes physical and operational performance by machines, components, organisms, services, teams, and people; it does not imply consciousness, intention, legal accountability, or ethical responsibility unless a neighboring pattern makes that stronger claim current. Epistemes stay in evidence-use, status-use, source-use, publication-use, requirement-use, definition-use, explanation-use, assurance-use, gate-use, or decision-use relations.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4 - Solution
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.1 - Core SlotSpecs
...
| `RoleValueSlot` | `U.Role` | identity slot | The context-bound role value governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy]]. It is not a SlotKind and not a capability. |
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.2 - Well-Formedness Constraints
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.3 - Open-World Slot Disposition
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.4 - Role State and Role-Description Characterization Hooks
...
- state assertions or evaluations governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] and the relevant evidence or evaluation pattern.

A work attribution claim may depend on those neighboring values. The assignment relation names the holder, role, context, and window; [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] governs whether the assignment is in an enactable state for the current work.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.5 - Role Assignment and Work
...
- the work occurrence is governed by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]];
- the bounded transformation is governed by [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/04_U.Transformation- Bounded Change Under Conditions/00_A.03.04 - U.Transformation- Bounded Change Under Conditions|A.3.4]] when the work is claimed as transformation participation;
- functional wording is restored through [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] when the role is named by what the holder does functionally;
- the selected method is governed by [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]];
- the method description or role-admission declaration is governed by [[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]];
- the work plan is governed by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]];
- role-state admission is governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]];
- capability is governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]].
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.6 - RoleEnactmentFact
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.7 - Episteme Evidence, Status, Source, and Publication Uses
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:4.8 - Shorthand Notation
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5 - Archetypal Grounding

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5.1 - Industrial Inspection Work
...
This does not assert that the robot satisfies the sensor capability-fit condition. Capability stays under [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]]. It does not assert that inspection work already occurred. Performed work stays under [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]]. It only gives later method, plan, role-state, and work-attribution claims a typed assignment relation to cite.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5.2 - Motor Assigned as Drive Motor
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5.3 - Software Deployment
...
The assignment relation admits a candidate performer. The work occurrence still needs the method or method-description relation, the assignment window, and any enactable role-state assertion needed under [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]]. A green test suite, ticket approval, or policy rule may justify the assignment or the work gate, but those are neighboring evidence, gate, or policy relations, not hidden role values.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5.4 - Review Report and Reviewer
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:5.5 - Standard Used in Safety Work
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:6 - Bias-Annotation
...
| Slot-role drift | Holder, role value, context, window, justification, or provenance words become untyped fields. | Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline]] SlotSpec discipline and keep the filled values under their governing patterns. |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:7 - Conformance Checklist
...
| `CC-A2.1-9` | Role state and enactable-state admission are governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission]]; role relation structure is governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/07_A.02.07 - RoleRelationStructure@BoundedContext - Context-Local Role Relations and Representation-Lens Boundary]]; capability is governed by [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]]; method and work are governed by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] subpatterns. |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Assignment as capability | The role assignment is treated as evidence that the holder can perform the work. | Use [[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures]] for capability and connect capability evidence only when the claim depends on it. |
| Assignment as work | The assignment is treated as if work already happened. | Use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work]] for dated work and cite `performedBy = RoleAssignment`. |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:9 - Consequences

[[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] makes work attribution and role admission replayable. A reader can ask: who is the holder, what role value is assigned, which bounded context gives that role meaning, and which window or source is current for the claim?
...
Reopen [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] only when the core assignment relation changes: admitted holder kinds, SlotSpecs, assignment-currentness discipline, direct work-role qualifiers, or the treatment of `RoleEnactmentFact`. Reopen neighboring patterns when the dispute is about capability, role state, method, work, evidence, status, source, publication, assurance, gate, or decision use.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:10 - Rationale

The role `ontologicalNeighborhood` needs both role values and assignment relations. [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] keeps `U.Role` as a compact context-bound value. [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] gives that value a typed relation to a holder and context. [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] then lets work cite the assignment.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:11 - SoTA-Echoing
...
- [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]] relation-slot discipline. [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] uses it for this assignment relation; it does not become a second slot discipline.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]]:End
