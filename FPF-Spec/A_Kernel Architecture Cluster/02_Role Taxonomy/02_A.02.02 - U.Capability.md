...
## [[02_A.02.02 - U.Capability|A.2.2]]:1 - Context (plain‑language motivation)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:2 - Problem (what goes wrong without this concept)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:3 - Forces (what we must balance)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:4 - Solution — define the ability explicitly

### [[02_A.02.02 - U.Capability|A.2.2]]:4.1 Definition
...
* **`U.WorkScope`** (*Work scope*) — the set of `U.ContextSlice` under which the capability can deliver the intended `U.Work` (see **[[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] §6.4**);
...
### [[02_A.02.02 - U.Capability|A.2.2]]:4.2 Conceptual descriptors (not a data schema)
...
### [[02_A.02.02 - U.Capability|A.2.2]]:4.3 Shorthand for everyday speech
...
## [[02_A.02.02 - U.Capability|A.2.2]]:5 - Clear distinctions (litmus tests managers can apply)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:6 - Archetypal grounding (parallel structural and organizational examples)

### [[02_A.02.02 - U.Capability|A.2.2]]:6.1 Physical system on a line (structural example)
...
### [[02_A.02.02 - U.Capability|A.2.2]]:6.2 Software service in operations (structural, cyber-physical)
...
### [[02_A.02.02 - U.Capability|A.2.2]]:6.3 Organizational unit (enterprise sense)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:7 - Bias‑Annotation (as in cluster‑E patterns)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:8 - Conformance Checklist (normative)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:9 - Capability thresholds on steps (how [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] uses this concept)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:10 - Time and change (calibration, drift, upgrades)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:11 - Composition and Γ (how assembled systems “can do”)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:12 - Interaction with Service Promise Clauses (external promise content)
...
> **Note.** The bare head noun *service* is polysemic; in normative prose it is treated as an **always‑unpack** token. Use [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR‑SERV) to name the intended facet (promise clause vs endpoint vs work vs commitment).
...
## [[02_A.02.02 - U.Capability|A.2.2]]:13 - Interaction with Dynamics (laws vs. abilities)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:14 - Anti‑patterns (and the right move)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:15 - Migration notes (quick wins for existing texts)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:16 - Consequences
...
## [[02_A.02.02 - U.Capability|A.2.2]]:17 - Relations

* **Builds on:** [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] Holonic Foundation; [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] `U.BoundedContext`; [[00_A.02 - Role Taxonomy|A.2]] Role; [[01_A.02.01 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`.
* **Coordinates with:** [[00_A.03 - Transformer Constitution (Quartet)|A.3]] (Transformation & role masks); [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role–Method–Work Alignment).
...
## [[02_A.02.02 - U.Capability|A.2.2]]:18 - Didactic quick cards (reuse in specs and slides)
...
## [[02_A.02.02 - U.Capability|A.2.2]]:End
