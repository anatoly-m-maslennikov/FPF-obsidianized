...
**Cross‑references.**
— **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]** (Unified Formality **F**) and **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/03_C.02.02 - Reliability R in the F-G-R triad|C.2.2]]** (F–G–R): this pattern **defines G** as `U.ClaimScope`.
— **[[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]]** (Capabilities): capability gating now **SHALL** use `U.WorkScope`.
— **Part B** (Bridges and CL): Cross‑context transfers **MUST** declare a Bridge with **CL**; CL affects **R**, not **F/G**.
— **Part E** (Publication discipline; e.g., **[[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] MVPK**): publication views, cards, and lanes MAY declare `U.PublicationScope` to bound **where** a publication is admissible; `U.PublicationScope` MUST NOT widen the underlying `U.ClaimScope`/`U.WorkScope`. (USM supplies the scope calculus; Part E supplies publication discipline.)

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:1 - Problem frame - Purpose and Audience
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2 - Context

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.1 - Cross‑disciplinary pressures
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.2 - context‑local reasoning
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:2.3 - Minimal, composable trust math

In **F–G–R**:

* **F** (formality) is “how strictly a claim is expressed” ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]).
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:3 - Problem
...
5. **Overloaded words.** *Validity* clashed with **Validation Assurance (LA)**; *operation* and *operational* clashed with **Work** and **Run** in [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], producing governance ambiguity.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:4 - Forces
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:5 - Solution - Overview
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6 - Normative Definitions

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.0 - USM as a `U.Mechanism.Intension` (normalization for [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]].1/A.6.5)

**Intent.** This subsection makes the **USM** definition in [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] explicitly conform to the
`U.Mechanism` *intension* requirements ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]) and the `…Slot` / `…Ref` lexical discipline ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]]),
without changing USM’s meaning.

**USM Mechanism.Intension (normative; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] decomposition).**
...
**SlotIndex (USM) for operators/guards (normative; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind|A.6.0]]:4.1.1 + [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline|A.6.5]]).**
...
**Mechanism specialisation (USM; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]:4.2.1).** A bounded context MAY publish a specialisation of USM as either a refinement `USM′ ⊑ USM` (tighten LawSet and AdmissibilityConditions) or an extension `USM ⊑⁺ USM′` (add new operators and slots). Any such specialisation SHALL (i) name its parent (`USM`), (ii) declare the morphism kind (`⊑` vs `⊑⁺`), (iii) preserve the same RangedValueKind and SlotKinds for inherited operators (no renaming), (iv) avoid adding new mandatory inputs to inherited signatures. It MAY narrow ValueKinds or refModes monotonically and add admissibility constraints, but MUST remain substitutable for the inherited USM operators.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.1 - `U.ContextSlice` — where scope is evaluated
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.2 - `U.Scope` — the abstract set‑valued scope property (USM kind; **not** a CSLC measurement)
...
* **SpanUnion** (parallel, independently supported coverage) **only when an explicit named independence assumption is declared** (features or characteristics named, validity window stated, evidence class cited). See **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]].1/USM LawSet** for the normative template.
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.3 - `U.ClaimScope` (nick **G**) — scope of a claim (episteme)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.4 - `U.WorkScope` — scope of doing Work (capability)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:6.5 - `U.PublicationScope` — scope of a publication view or publication form
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7 - Scope Algebra

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.1 - Membership & Coverage
...
**Tri‑state admissibility under unknowns (normative; aligns [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]]).**
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.2 - Serial Composition (Intersection)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.3 - Parallel Support (SpanUnion)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.4 - Why a **G-ladder/levels/scales** is not needed (and **must not** be introduced)
...
**Normative directive.**
`U.ClaimScope (G)` **SHALL** remain a **set‑valued USM scope object**; **no ordinal or numeric ladder SHALL be defined** for G. If a profile needs scalar reporting, it MAY publish an explicit **report‑only** proxy **`CoverageMetric(G)`**, but **`CoverageMetric(G)` MUST NOT substitute for `G`** in norms, gates, bridge semantics, or CL routing. Authoring and gating **SHOULD** use **F thresholds** ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]) and **explicit guard predicates** ([[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]) rather than pseudo‑levels of G.

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.5 - Translation across Contexts (Bridge & CL)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.6 - Δ‑Operations (Widen, Narrow, Refit)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.7 - Invariants
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:7.8 - Empty & Partial Scopes
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8 - Locality, Time & Version Semantics

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.1 - context‑locality
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.2 - Time selector `Γ_time`
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.3 - Standards, versions & notations
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.4 - Determinism of evaluation
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:8.5 - Interaction with R (freshness & decay)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:9 - Lexical Discipline (Part E compliance)
...
**L‑USM‑2 (Work and Run).** Prefer **Work** and **Run** vocabulary from [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for system execution contexts. Do not introduce “operation” or “operating” as characteristic names; use **Work scope**.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10 - Guard Patterns (ESG & Method–Work)

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.1 - Common guard shape
...
**Admissibility note (normative; [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] alignment).** If `ScopeCoverage` is **unknown** (due to unknown slice keys, unmappable translation, missing `Γ_time`, etc.), the guard MUST NOT silently treat this as `false`. It MUST either abstain (fail closed) or apply an explicit R‑lane degradation policy.
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.2 - ESG guard families (epistemes)
...
When rigor is gated, the guard MUST reference [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]:
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.3 - Method–Work guard families (capabilities)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.4 - Bridge‑aware guard macro (reusable)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.5 - Selector policy (Γ\_time)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12 - Archetypal Grounding - Worked Examples
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.1 - Research claim (controlled narrative → predicate)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.2 - Cross‑context use of the research claim
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.3 - Capability: robotic weld Work scope
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.4 - Serial intersection (API + dataset compatibility)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.5 - Parallel support (SpanUnion) in a safety case
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:12.6 - ML model deployment across Contexts
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:10.1 - Bias-Annotation
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:11 - Conformance Checklist (USM)
...
| **CC‑USM‑14 (Slot discipline).**      | Where USM operations/guards are referenced in signatures or templates, they **SHALL** use explicit SlotSpecs and obey the [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/14_A.06.05 - U.RelationSlotDiscipline - SlotKind, ValueKind, RefKind, and slot-operation discipline]] lexical discipline (`…Slot` for SlotKinds; `…Ref` only for RefKinds/refs). |
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.3 - Common Anti-Patterns and How to Avoid Them
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:11.1 - Consequences
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13 - Playbooks (Informative)

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.1 - Manager’s 6‑step adoption checklist
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.2 - Architect’s design rubric for scopes
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.4 - Minimal DSL snippet for scope blocks (illustrative)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:13.5 - Profiles as Scope configurations (informative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14 - Governance Hooks & Audits

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.1 - Governance metadata (normative)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.2 - USM compliance levels (informative)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.3 - Audit checklist (informative)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:14.4 - Risk controls (informative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:16 - Extended FAQ (informative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17 - Annexes (informative)

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.1 - Source wording -> USM dictionary
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.2 - Minimal data model hints
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:18.3 - Pseudocode membership (illustrative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4 - Rationale
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.0 - SoTA-Echoing - F-Cluster Unification for [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]] and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]])

> **Intent.** This annex applies the **F‑cluster method** to triangulate **USM** terms against a diverse set of post‑2015 sources and communities (“Contexts”), and then fixes the **Unified Tech** and **Plain** names used in [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]. Results are ready for downstream lexicon entries (Part E) and guard templates (ESG / Method–Work).

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.1 - [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]] Unified Term Survey (UTS) — Method & Scope
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.2 - UTS Table ([[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]]) — Cross‑context term mapping
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3 - [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] Term Selection — Unified Tech & Plain names

#### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.1 - Selected names (normative)

| Concept in [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes]]                | **Unified Tech** (lexicon)                      | **Unified Plain** (manager‑friendly) | Allowed short form   | Avoid / unpack                                                    |
| ------------------------------- | ----------------------------------------------- | ------------------------------------ | -------------------- | --------------------------------------------------------------------- |
...
#### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.2 - Phrasebook (for editors, normative)
...
#### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:17.4.3.3 - Rosetta summary (informative, for rationale box)
...
**Outcome.** The UTS shows clear convergence across SoTA Contexts on **addressable context** and **set‑valued applicability**. [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] therefore fixes: **Context slice**, **Scope**, **Claim scope (G)**, **Work scope**, **Publication scope** with the algebra and guard clauses mandated in [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]. This closes synonym drift while remaining readable for engineering managers and precise for assurance tooling.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15 - Relations - Cross-Pattern Coordination

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.1 - With F–G–R ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/03_C.02.02 - Reliability R in the F-G-R triad|C.2.2]])

* **G is Claim scope.** Use set algebra (∩ / SpanUnion).
* **F** remains the expression rigor ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]); **R** captures evidence freshness and CL penalties.
* **Weakest‑link.** On dependency paths: **F\_composite = min(F)**, **R\_composite = min(R)**; **G** follows §7.2–§7.3 (set rules).

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.2 - With Formality ([[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]])
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.3 - With Work & Run ([[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]])
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.4 - With Bridges & CL (Part B)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:15.5 - With Capability governance ([[A_Kernel Architecture Cluster/02_Role Taxonomy/02_A.02.02 - U.Capability - System Ability Envelope and Measures|A.2.2]])
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]:End
