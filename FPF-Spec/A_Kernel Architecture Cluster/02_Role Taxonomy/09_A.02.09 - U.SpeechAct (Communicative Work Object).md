...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:0.1 - Kind Settlement
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:0 - Use This When
...
**Not this pattern when.** If the question is only what a document says, use A.7/C.2/E.17. If the question is who is accountable under a deontic relation, use [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]. If the question is evidence, use A.10/G.6. If the work has no communicative effect, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] directly.

> **Type:** Definitional (D)
> **Normativity:** Normative (unless explicitly marked informative)
> **Placement:** Part A → **[[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] Roles & Agency Kernel**
> **Refines:** [[A_Kernel Architecture Cluster/02_Role Taxonomy/00_A.02 - Role Taxonomy|A.2]] (Role Taxonomy)
> **Builds on:** [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] (RoleAssignment), [[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] (`Γ_time` and windows), [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] (EntityOfConcern, Description episteme, and carrier), [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] (SCR/RSCR carrier discipline), [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] (`U.Work`)
...
> [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] can name `U.SpeechAct` in the promise/utterance/commitment triad; [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] keeps the ontology and conformance discipline in Part A where communicative work, utterance description, and evidence carrier can be kept distinct.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:1 — Problem frame
...
* Governance patterns and boundary writing ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]] stack) need **provenance**: “this obligation/commitment/permission was instituted by *that* act”.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:2 — Problem
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:3 — Forces
...
| Separation discipline  | Must preserve [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)]] splits: **act object** ≠ **utterance description** ≠ **carriers and traces**.                              |

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4 — Solution
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4.1 — Normative definition
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4.2 — Minimal structure (normative)
...
U.SpeechAct ::=
  ...
  & {
      ...
      utteranceRefs: optional<set<DescriptionRef>>,  // where the utterance description is stated or recorded ([[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]: Description)
      carrierRefs: optional<set<CarrierRef>>,        // evidence carriers/traces ([[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]: Carrier; use [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] when evidentiary)
...
* **(SA‑C0) Work conformance applies.** Because `U.SpeechAct <: U.Work`, a speech‑act record **MUST** satisfy `U.Work` conformance ([[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]]), including the required anchors (`isExecutionOf`, `performedBy`, `executedWithin`, `window`, and state‑plane / judgement‑context anchoring). A speech act **MUST** have at least one `affected` referent (the thing it is *about/updates*), even if it is purely governance‑state.
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4.3 — `SpeechActRef` discipline (normative)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4.4 — Separation rules with `U.Commitment` and `U.PromiseContent` (normative)

1. **Speech act is not the deontic binding.**
   A speech act may **institute** a `U.Commitment`, but the deontic relation itself is the `U.Commitment` object ([[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]). Do not encode obligations/permissions inside `U.SpeechAct` as prose; instead, create/point to `U.Commitment` IDs in `institutes.commitments`.
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:4.5 — Multi-function and multi-party support (normative)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:5 — Archetypal Grounding (Tell–Show–Show)

### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:5.1 — Tell (universal rule)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:5.2 — Show #1 (system archetype: change-control approval gates a deployment)
...
### [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:5.3 — Show #2 (episteme archetype: publishing a spec edition without making the spec an agent)
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:6 — Bias-Annotation
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:7 — Conformance Checklist (normative)

1. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑1 (Accountable performer).** A normative `U.SpeechAct` record **MUST** identify `performedBy` as an accountable `RoleAssignmentRef` and **MUST NOT** use a specification episteme, interface-description episteme, or document-carried episteme as performer.
2. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑2 (ActTypes declared).** A `U.SpeechAct` record **MUST** include at least one `SpeechActTypeRef` recognized in its judgement context.
3. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑3 (Window explicit).** A `U.SpeechAct` record **MUST** have an explicit `window` (or inherit a window from its parent work record) so freshness and gating can be evaluated.
4. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑4 (Observable when used for gate checks or provenance).** If a speech act is cited by a checklist/guard or by `U.Commitment.source.speechActRef`, it **SHALL** have at least one `utteranceRef` or `carrierRef` that allows observation and audit in the given context; evidence-critical uses **SHOULD** cite at least one carrier via SCR/RSCR per [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]].
5. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑5 (Effects by reference).** If the act is intended to institute/update commitments/roles or statuses, those effects **SHOULD** be referenced in `institutes.*` by stable IDs.
6. **CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑6 (Bridge-only cross-context use).** If a `SpeechActRef` is interpreted for gate checks or provenance in a different bounded context than the act’s judgement context, the referencing object **MUST** cite the Bridge/policy that licenses that cross-context interpretation (no “same label implies same force”).

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:8 — Common Anti-Patterns and How to Avoid Them
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:9 — Consequences
...
* Requires recording a small structured object for communicative events; mitigated by allowing minimal stubs that still satisfy CC‑[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]‑1…4.
...
## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:10 — Rationale

FPF already relies on communicative acts (approvals, notices, overrides) as operationally meaningful events, but without a kernel object they blur into examples, naming choices, or prose. [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] anchors speech acts where they belong: as a **Work-kind** with explicit performer, scope, and time, and with disciplined links to utterance descriptions, carriers, and deontic bindings (`U.Commitment`).

This also improves modularity:

* **[[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]** can remain a **lexical entry point** for naming (why “SpeechAct” and “utterance” are useful labels),
* while **[[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]** carries the ontology and conformance discipline for how speech acts behave as objects and how they connect to commitments and evidence.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:11 — SoTA-Echoing (informative; post-2015 alignment)

> **Informative.** Alignment notes; not normative requirements.

* **Adopt — ISO 24617‑2:2020 / multi-dimensional communicative functions.** Modern dialogue‑act standards treat communicative behavior as potentially multi‑functional. [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] mirrors this by allowing `actTypes` to be a **set** and by supporting shared carriers across multiple acts.
* **Adapt — commitment-based semantics for communication (multi-agent/protocol practice, 2015+).** A pragmatic way to avoid mental-state modeling is to track communication by its **social/institutional effects**, especially on commitments and protocol states. [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] reflects this via `institutes.commitments` and explicit links to `U.Commitment` without modeling sincerity or intention.
* **Adopt (warning) — illocutionary pluralism in multiparty discourse (2015+).** One utterance commonly performs multiple recognizable functions. [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] avoids the “single force” trap by permitting multi-type acts, multiple acts sharing the same utterance and carriers, or both.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:12 — Relations

**Uses / builds on**

* Uses **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] (`U.Work`)** for the event/work backbone (performedBy + window + stance).
* Uses **[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]** for the strict act≠description≠carrier split.
* Coordinates with **[[A_Kernel Architecture Cluster/02_Role Taxonomy/06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]]** for scope/window discipline.

**Used by**

* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]] (`U.Commitment`)** as a concrete target for `source.speechActRef` provenance.
* **[[A_Kernel Architecture Cluster/02_Role Taxonomy/05_A.02.05 - RoleStateRelation@BoundedContext - Role State Space and Enactable-State Admission|A.2.5]] (RSG checklists/guards)** when “presence of authorization/approval act” is a criterion.
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] (Contract unpacking)** as the “utterance/instituting act” hook that prevents episteme-as-agent claims and improves provenance.

## [[A_Kernel Architecture Cluster/02_Role Taxonomy/09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]:End
