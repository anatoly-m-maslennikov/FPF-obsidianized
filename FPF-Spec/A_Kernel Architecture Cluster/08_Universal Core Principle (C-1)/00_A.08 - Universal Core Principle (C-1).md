...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:1 - Problem Frame
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:2 - Problem
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:3 - Forces
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:4 - Solution — *The Three‑Domain Falsification Test*
...
(References: **[[00_C.17 - Characterising Generative Novelty & Value (Creativity-CHR)|C.17]]** `Diversity_P` & illumination Summary as telemetry metric; **[[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]]** `U.DescriptorMap`, `U.IlluminationSummary`.)
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:5 - Archetypal Grounding (System / Episteme)
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:6 - Conformance Checklist
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:7 - Consequences
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:8 - Rationale
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:9 - Relations
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:10 - Known Uses
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:11 - Open Questions
...
## [[00_A.08 - Universal Core Principle (C-1)|A.8]]:End
