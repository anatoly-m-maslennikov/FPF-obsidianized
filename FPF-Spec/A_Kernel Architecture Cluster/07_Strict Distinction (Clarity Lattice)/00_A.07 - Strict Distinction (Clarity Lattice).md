...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:1 - Intent
...
It harmonizes [[00_A.12 - External Transformer & Reflexive Split|A.12]] (External Transformer), [[00_A.13 - The Agential Role & Agency Spectrum|A.13]] (Agential Role & Agency Spectrum), [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (Advanced Mereology), [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role-Method-Work Alignment), [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] (`U.EpistemeSlotRelation`), [[03_E.17 - Multi-View Publication Kit|E.17]] (publication and view discipline), and [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_F.17 - Unified Term Sheet (UTS)|F.17]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]] bridge and naming discipline.

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:2 - Problem frame

* **Holons ([[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]) and systems.** All holons are part-whole units; **only systems** can enact behaviour.
* **Externalization ([[00_A.12 - External Transformer & Reflexive Split|A.12]]).** Every change is performed by a **system bearing TransformerRole** across a boundary; there is no “self‑magic”.
* **Quartet backbone ([[00_A.03 - Transformer Constitution (Quartet)|A.3]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]).** We separate **MethodDescription** (description), **Method** (abstract way-of-doing), **Capability** (a system's ability or envelope to enact a Method under conditions), and **Work** (run‑time occurrence), with the **system bearing TransformerRole** as the acting side.
* **Evidence ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]).** Knowledge claims cite **Symbol-Carrier Register (SCR)** carriers; epistemes never “act”; systems inspect, revise, publish, store, or rely on the carriers, publication forms, and project records that make an episteme available.

Practitioner check: if a sentence could be read as “the document decided” or “the process executed itself”, it violates [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]].

Boundary for use from other patterns: [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] restores the `EntityOfConcern`, the admissible describing relation, and the publication boundary, then returns the work to the subject pattern. Do not let [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] turn an architecture, structure, work, method, evidence, characterization, or decision question into a general discussion of descriptions. If the `EntityOfConcern` is itself a Description episteme or view, keep the pattern centered on that episteme as the item under concern; description-of-description or publication-force issues open only when they are the exact claim being made.

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:3 - Problem
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:4 - Forces
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5 - Solution — The **Clarity Lattice** (normative distinctions & safe vocabulary)

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.1 - **Terminology (normative): orthogonal characteristics**
...
• **EntityOfConcern and Description-episteme boundary** — the item under concern is separated from Description epistemes ([[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]). Specification use is a gated use or refinement of a Description episteme; the exact gate must name checkability, formality plus checkable constraint, harness, acceptance condition, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] measurement criterion, verification use, or another specification-granting neighbouring pattern. Specification is not a third member of the strict distinction.
...
• **Typed describing morphism and specification-use exit** — `Describe_EoC_DescEp : EntityOfConcern -> DescriptionEpisteme` describes an `EntityOfConcern` value into a Description episteme under a declared construction/reference trace; it is **not** a mechanism and does not execute work. A later refinement, formalisation, or specification-use claim over that Description episteme is governed by the neighboring pattern governing the claim whose force is live: [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] for effect-free episteme refinement, [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] for formality and checkability, [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] or the relevant gate/acceptance pattern for harness and acceptance force, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] for measurement criteria, [[03_E.17 - Multi-View Publication Kit|E.17]] for publication expression, and [[00_E.10 - Unified Lexical Rules for FPF|E.10]] for suffix discipline. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] keeps those exits visible but does not turn them into a second strict-distinction member.
  **Laws (normative for [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]):** (DESC-1) *Non-extensibility of content* and (DESC-2) *identity and meaning-preserving composition*. Specification-use/refinement laws are enforced by the neighboring pattern governing the claim that selects the gate and value set.

• **EntityOfConcern / episteme / publication boundary** — `EntityOfConcern` wording names the item under concern under the declared construction/reference trace; it does not name a document, publication face, carrier, or unspecified referent. `Describe_EoC_DescEp` yields a Description-side `U.Episteme` about that `EntityOfConcern` value. A Description episteme may later be used as a specification only when a bounded use declares formality plus checkable constraint, harness, acceptance condition, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] measurement criterion, verification use, or another specification-granting gate. Publication faces, cards, views, lanes, records, and carriers remain orthogonal lanes: they can make Description epistemes available, but they do not become the EntityOfConcern value, the Description episteme, specification-use gate/refinement, evidence, gate passage, work, assurance, or decision force by appearing in a publication form.

[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] establishes the following **pairs and triplets**. Use their **names** and **scope** exactly as below.

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.2 - Role vs Function (behaviour)

* **Role (role‑object, mask).** A contextual **position** a holon can bear ([[00_A.02 - Role Taxonomy|A.2]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]). A role is **not behaviour**; it is the **mask** under which behaviour may be enacted. Example: **Cooling‑CirculatorRole** in a thermal loop.
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.3 - MethodDescription vs Method vs Capability vs Work (description vs way-of-doing vs ability envelope vs occurrence)
...
* **Method** — the **abstract order-sensitive way-of-doing** composed with **Γ\_method** ([[05_B.01.05 - Γmethod - Order-Sensitive Method Composition & Work Enactment|B.1.5]]). A Method is not an occurrence and not the system ability itself; **concrete values** are **bound at `U.Work` creation**. Outside executions we **refer to it via MethodDescription** (see [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] CC‑A3.1‑5/‑9; [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] §2.2, §4.1).
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.4 - Holon vs System vs Episteme (who can act)
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.5 - Episteme vs Symbol Carrier (SCR/RSCR)
...
**Normative guard:** When you say “we updated the spec”, detail **which carriers** changed ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]).

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.6 - Collective vs Set, and MemberOf vs Component/Constituent/Portion/Phase ([[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]])
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.7 - Operator alignment (required names)
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.8 - EntityOfConcern and Description-episteme boundary vs publication face, form, unit, and carrier boundary (orthogonal, normative)
* **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] govern the EntityOfConcern-to-description boundary.** What the `EntityOfConcern` value is and how it is described are distinct questions. Description is a `U.Episteme` use with `DescriptionContext`. Specification is a gated use or refinement of a Description episteme, selected by checkability, formality plus checkable constraint, harness, acceptance, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] measurement criterion, verification use, or other neighboring pattern governing the claim force; it is not a peer class beside `EntityOfConcern` and Description.
* **Publication governs availability.** Publication units, publication forms, faces, renderings, and carriers make Description epistemes available to readers or tools, including Description epistemes admitted for specification use. They do not become the `EntityOfConcern` value, the Description episteme, the specification-use gate/refinement, or a symbol carrier by the same relation; physical and digital carriers stay in **SCR/RSCR** ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]).
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.8a - Same or near-same EntityOfConcern across descriptions and views

Different descriptions, views, viewpoints, publication units, or role-method-interest positions may concern the same `EntityOfConcern`, different entities of concern, or an unresolved candidate set. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] does not accept sameness by publication title, view label, carrier continuity, shared ordinary name, or common reader interest.

Use this split when the text needs to say whether two descriptions or views are about the same thing:

| Case | [[00_A.07 - Strict Distinction (Clarity Lattice)]] relation case | Admissible move |
| --- | --- | --- |
...
| preserved by viewing | [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism]] viewing preserves `entityOfConcernRef` while changing content, representation, viewpoint, or other episteme slots | same-`EntityOfConcern` Description, Specification, or view transformation |
...
| bridge-conditional near identity | [[00_F.09 - Alignment & Bridge across Contexts]], [[00_F.17 - Unified Term Sheet (UTS)]], or [[00_F.18 - Local-First Unification Naming Protocol]] admits bounded near-identity or substitution under bridge kind, CL, direction, loss, and bridge-admissible use | bridge-scoped reuse only |
| retargeted under invariant | [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] changes `entityOfConcernRef` under `KindBridge`, invariant, and loss discipline | retargeted use only under stated invariant |
...
If the same or near-same relation needs mathematical or postulate-theory justification, [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] exits rather than pretending to prove it: use [[00_C.29 - Mathematical Lens Use|C.29]] for the mathematical lens, [[00_E.18 - Transformation Flow Structure|E.18]] and [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] where transformation-flow, carry-through, and postulate-theory work supply the required justification, [[00_E.18 - Transformation Flow Structure|E.18]] where a gate crossing is the live relation, or the relevant architecture pattern where the comparison is about structure, graph, flow, or architecture description.

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.9 - Typed describing morphism and specification-use exit (normative)

**What `Describe_EoC_DescEp` means in [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]].** For any `EntityOfConcern` value `X`, *describing X* is the morphism application `Describe_EoC_DescEp(X) : DescriptionEpisteme`. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] does not define a second strict-distinction arrow from Description to Specification. When a Description episteme is formalised, constrained, test-harnessed, accepted, or used as a specification, that is an episteme-refinement or specification-use question handled by [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]], [[05_C.02.03 - Unified Formality Characteristic F|C.2.3]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], or another neighboring pattern governing the claim according to the live force.
...
**Invariants (normative for [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], split by EntityOfConcern kind):**
...
4. **Specification-use exit.** If a Description episteme is refined into specification use, the refinement must name the neighboring pattern governing the claim and gate that grants that use. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] only requires that the refinement remains separate from the `EntityOfConcern`, from publication expression, and from Work.
...
6. **Ontology preservation.** Describing any `EntityOfConcern` value, such as a Calculus, Signature, Mechanism, Structure, Work occurrence, or Episteme, via `Describe_EoC_DescEp` does **not** change its ontology; it yields a Description episteme under [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] rules. Publication through faces, forms, units, and carriers is handled separately in [[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK).

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.10 - Bridge to `U.Work` (normative invariants)

**OUTSPEC‑INV‑1 (No metonymy).**
`promisedOutcomeSpecRef` points to an **OutcomeSpec**, not to `U.Work` and not to an extensional delivered-result referent. The *actuals* live on `U.Work` ([[01_A.15.01 - U.Work|A.15.1]]) and its evidence carriers.
...
#### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:5.10.1 - Canonical examples (didactic)
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:6 - Archetypal Grounding (Tell-Show-Show; System and Episteme)

### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:6.1 - System and Episteme example
...
### [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:6.2 - Didactic examples
...
* **Collective system (team):** boundary, coordination **Method**, supervision **Work**; can bear **AgentialRole** ([[00_A.13 - The Agential Role & Agency Spectrum|A.13]]).
* **Safe phrasing:** *“Team T plays **Cooling‑MaintenanceRole** and executed Work W…”*

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:7 - Conformance Checklist (normative)
...
| **CC‑A7.3 (Episteme non‑agency)**        | An **episteme SHALL NOT** be described as acting. All changes to epistemes must be routed to their **symbol carriers** ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]]) by a **system bearing TransformerRole**.                                                                                                                         | Text contains the acting system + carriers (SCR ids).                                                                                     |
...
| **CC‑A7.11 (Terminology hygiene)**       | Ban **“actor”** in core text. Use **“system bearing TransformerRole”**; bind local shorthand **“Transformer”** only per [[00_A.12 - External Transformer & Reflexive Split]] rules.                                                                                                                                                            | Plain text scan: no “actor”; shorthand is locally bound.                                                                                  |
...
| **CC-A7.14 (Describe_EoC_DescEp laws)** | Any implementation of `Describe_EoC_DescEp` MUST enforce the split DESC-1E/DESC-1N/DESC-2 law family. Episteme EoCs preserve or refine source claims under declared loss; non-episteme EoCs receive claims only through declared construction/reference/measurement/model/witness traces. Specification-use refinement is checked by the neighboring pattern governing the claim that grants the gate, not by [[00_A.07 - Strict Distinction (Clarity Lattice)]] as a third strict-distinction member. | Audit shows whether the EoC is episteme-like or non-episteme, which trace introduces claims, and which relation preserves identity, near-identity, bridge, loss, or retargeting. |
| **CC-A7.15 (Specification-use exit)**         | If text claims that a Description episteme is a specification, formal specification, requirement, acceptance item, harnessed invariant, or measurement-criterion object, it names the exact gate: [[05_C.02.03 - Unified Formality Characteristic F]] formality plus checkable constraint, A.21/gate or acceptance discipline, [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] measurement-criterion discipline, [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes]] episteme refinement, [[03_E.17 - Multi-View Publication Kit]] publication expression of an already admitted specification use/refinement, [[00_E.10 - Unified Lexical Rules for FPF]] suffix discipline, or another neighboring pattern governing the claim. Formal notation alone is insufficient.                                     | The text shows the specification-granting gate and does not make specification a peer ontology class beside EntityOfConcern and Description.                                                     |
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:8 - Canonical rewrites (didactic library)
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:9 - Anti‑patterns (with fixes)
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:10 - Consequences

| Benefit                      | Why it matters                                    | Trade‑off / Mitigation                             |
| ---------------------------- | ------------------------------------------------- | -------------------------------------------------- |
| **Category safety at scale** | Prevents silent logic bugs across holarchies.     | Slight verbosity → use local shorthand per [[00_A.12 - External Transformer & Reflexive Split]].   |
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:11 - SoTA‑Echoing (post‑2015 practice alignment)

* **Digital Twins (ISO 23247, 2021→):** separates the asset (system) from its **digital representation** (episteme) and prescribes governance of twins without attributing *agency* to the twin itself — matching [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]’s “episteme ≠ actor” and carrier discipline. **Adopt.**
* **Observability (OpenTelemetry, 2019-2025):** codifies **semantic conventions** as publication-form discipline over traces, metrics, and logs; semantics are governed by descriptions, not exporters, echoing [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] publication-face and publication-form orthogonality. **Adapt** (terminology).
* **Active Inference (2017→2024):** separates a **generative model** (episteme) from **actions** by the agent (system), with explicit perception–action cycles — mirroring [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]’s “who can act” and stance separation. **Adopt**
...
* **Quality‑Diversity (MAP‑Elites family, 2015-2024):** archives are **sets on typed spaces** (descriptions) whose **occurrences** are runs; selection returns **sets** under admissible orders, consonant with [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]’s set-returning discipline. **Adopt and adapt**.
* **Refinement‑typed specs (2016→):** modern stacks (e.g., Liquid Haskell, Dafny’s post‑2017 refinements, Rust’s `uom` type‑level units) treat formalization as **monotonic refinement with pinned units and scales**. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] uses them only to motivate the specification-use exit; the refinement laws belong to the neighboring pattern governing the claiming specification, formality, measurement-criterion, and publication patterns. **Adapt** (terminology; pinning discipline).

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:12 - Rationale (informal)

* **Engineering cognition:** Large programmes fail less from equations than from category slips (“process vs procedure vs execution”). [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] eliminates these slips by a small, repeatable grammar.
...
* **Why name publication faces and forms in [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]?** Strict Distinction already guards the `EntityOfConcern` value from the Description episteme that makes claims about it. In practice, misreadings happen at the publication face: cards and tables are mistaken for EntityOfConcern values; governance words leak where physics or logic should stand. Naming publication face, form, unit, carrier, and rendering uses as orthogonal closes that gap without entangling semantics with any tool or notation. Specification use or refinement is also named only to keep it orthogonal to `EntityOfConcern`, Description, and publication expression. This preserves **C-1 universality** and **P-1 Cognitive Elegance**, while giving [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] a crisp governing source for multi-face presentation rules.

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:13 - Relations

 **Builds on:** [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] (Holon), [[00_A.02 - Role Taxonomy|A.2]] (Roles), [[00_A.03 - Transformer Constitution (Quartet)|A.3]] (Transformer Quartet), [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] (Evidence & SCR), [[00_A.12 - External Transformer & Reflexive Split|A.12]] (External Transformer), [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (Advanced Mereology), [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Role–Method–Work Alignment).
* **Constrains:** [[00_A.13 - The Agential Role & Agency Spectrum|A.13]] (Agency sits on systems only; epistemes non‑behavioural), Part B operators (**Γ_method**/**Γ_time**/**Γ_work**/**Γ_sys**) and their choice points; **publication is not a Γ‑operator**.
* **Extends:** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] (Authoring conventions), [[00_E.10 - Unified Lexical Rules for FPF|E.10]] (lexical and precision restoration), **Part F and Part G (UTS and CG-Spec or CHR pinning)**, [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] (Assurance routing), C-cluster (selection and archives) by enforcing `EntityOfConcern` and Description-episteme boundary, specification-use exit, publication availability orthogonality, System and Episteme separation, same or near-same EoC discipline across views, and typed EntityOfConcern-to-Description describing discipline (**publication = Description-episteme-to-publication face, form, unit, carrier, and rendering availability in [[03_E.17 - Multi-View Publication Kit|E.17]]**).
* **Coordinates with:** **[[00_E.18 - Transformation Flow Structure|E.18]] (gate crossing and OperationalGate(profile))** for crossing visibility and publication gating, **[[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]** for gate checks, **[[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_F.17 - Unified Term Sheet (UTS)|F.17]], [[03_E.17 - Multi-View Publication Kit|E.17]], and [[00_E.18 - Transformation Flow Structure|E.18]]** for Bridge+UTS pinning discipline, **[[00_E.10 - Unified Lexical Rules for FPF|E.10]]** for lexical SD checks, and **Part F (Bridges and CL)** for explicit cross-Context identity, without embedding any notation dependence.

## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:14 - Practitioner one-page review (copy-paste)
...
## [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:End
