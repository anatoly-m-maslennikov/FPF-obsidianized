...
coordinates_with:
  ...
  - "[[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]]"
...
**Declared relation-and-ref-position stack.** The declared relation-and-ref-position stack that links one recoverable source set to search-side and outcome-side references over [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`, states how those two refs relate, and makes the source-to-outcome relation plus its distortion, uncertainty, or error posture explicit enough to guide use.

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:0 - Use this when
...
- you only need to declare or compare `CharacteristicSpace` itself, with no source-set or source-to-outcome requirement; use [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]];
- you are publishing selector or shipping metadata such as `SelectorOutcomeKind`, `SetResultFamily`, `HandoffKind`, or public shortlist identity; use [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] or [[00_G.10 - SoTA Pack Shipping|G.10]];
- you are building one interpretive view over an already-declared substrate; use [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]] or a local specialization such as [[00_G.02 - SoTA Harvester & Synthesis|G.2]];
- you are deciding live pool policy, frontier retention, or next-move planning; use [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]] or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]].

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:0.1 - What goes wrong if missed
...
- publication metadata in [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] or [[00_G.10 - SoTA Pack Shipping|G.10]] starts standing in for substrate semantics;
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:0.2 - What this buys

This pattern buys one conservative but expressive substrate declaration:

- the active source set stays visible;
- the search-side and outcome-side references over [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] spaces stay distinct;
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:0.a - TERM/LEX token-status guard (local-first)

Keep this token-status split explicit:

- `CharacteristicSpace` is the reused [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] kind. This pattern does not mint a second space kind.
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:0.b - First-minute operator cue and confusion guide
...
If one of those five cells cannot yet be filled honestly, do not improvise around it. Either you are still in [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], or you have really moved into interpretive-view work, publication, or policy, or the current line is still missing one declared basis.

| If the question under repair sounds like... | Use now | Why |
| --- | --- | --- |
| "Which space are we searching in and which space are we judging in?" | [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate]] | This pattern governs the dual-ref substrate stack. |
| "How should I help the reader inspect that already-declared line?" | [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View]] | That is one interpretive reading over the substrate, not the substrate declaration itself. |
| "What do we publish, ship, keep live, or plan next?" | [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.10 - SoTA Pack Shipping]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] | Those are downstream output or policy questions. |
| "I only need one space declaration." | [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] | No source-to-outcome substrate stack is in play yet. |
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:1 - Problem frame
...
- one search-side reference to an [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`;
- one outcome-side reference to an [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`;
...
Without an explicit substrate declaration for that stack, nearby declarations start carrying loads they are not meant to carry. [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] gets stretched from space typing into source-set governance. [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]] descriptor maps start masquerading as the whole search space. [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] and [[00_G.10 - SoTA Pack Shipping|G.10]] publication fields start reading like ontology. Interpretive views or atlas views drift into default meaning instead of staying optional derived help.

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:2 - Problem
...
2. `SearchSpaceRef` and `OutcomeSpaceRef` stay guarded refs to declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`, not new free-floating space kinds;
...
8. and neighboring declarations such as [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.10 - SoTA Pack Shipping|G.10]], and [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]] can dock to the substrate without redefining it?

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:3 - Forces

| Force | Tension |
| --- | --- |
| [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] typing vs adjacent substrate requirement | [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]] already declares `CharacteristicSpace`, but source-set and publication-form semantics still need a separate substrate declaration. |
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4 - Solution
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.1 - Declared relation-and-ref-position stack and outside work
...
- the search-side reference to one declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`;
- the outcome-side reference to one declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`;
...
- [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] space typing itself;
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.2 - Minimal declaration stack
...
- `SearchSpaceRef` points to one declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace` in the search-side position.
- `OutcomeSpaceRef` points to one declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace` in the outcome-side position.
...
`SearchSpaceRef` and `OutcomeSpaceRef` must resolve to declared [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `CharacteristicSpace`. They do not become parallel space kinds, slot aliases, or role claims.
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.4 - Profiles
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.6 - Canonical rewrite forms
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.7 - Conditional fields stay conditional
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.8 - Qualifier refs stay substrate-side
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.9 - Descriptor maps and distance definitions dock here, but do not replace the space refs
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.10 - Publication and shipping remain downstream consumers

[[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] and [[00_G.10 - SoTA Pack Shipping|G.10]] may carry metadata such as `SelectorOutcomeKind`, `SetResultFamily`, `SourceSetFamily`, `SourceSetComposition`, `DerivedViewKind`, and `BasePaletteRef` when one selected or shipped result is being published.

That does not mean [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] or [[00_G.10 - SoTA Pack Shipping|G.10]] defines the substrate.

Read the boundary this way:

- this pattern defines the substrate that later publication must preserve;
- [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] publishes selector-facing outcome metadata;
- [[00_G.10 - SoTA Pack Shipping|G.10]] ships publication metadata and pins;
- neither one redefines the search-side reference, the outcome-side reference, or the source-to-outcome relation.

### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.11 - Ordinary and heavier use
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.12 - Operator kit: choose, declare, self-check, apply governing neighbor
...
- if the next needed prose is mainly "how should the reader inspect this substrate?", continue in [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]];
- if the next needed prose is "what gets published, shipped, retained, or enacted?", apply [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.10 - SoTA Pack Shipping|G.10]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)|C.24]];
- if the current line changes because one neighbor wants different naming, glossing, or repair vocabulary, keep the substrate declaration here and let [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]], or [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] handle that neighboring requirement explicitly.

### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:4.13 - Using the substrate with neighboring patterns

Once one substrate line is declared, use neighboring patterns in this order:

- Use [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]] when the next requirement is interpretive help over the same substrate. The interpretive view may foreground the line, but it does not become the ontology.
- Use [[00_G.02 - SoTA Harvester & Synthesis|G.2]] when that interpretation becomes palette-first, tradition-facing atlas work. Keep the base palette and the cited substrate recoverable while doing it.
- Use [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] when one passage collapses source set, space ref, interpretive view, atlas view, or map/ref wording into one umbrella word. Repair the wording back to the substrate declaration before adding more theory.
- Use [[00_F.18 - Local-First Unification Naming Protocol|F.18]] when the problem is label choice or naming-side comparison around this stack. Naming notes may explain why one head is better named; they do not settle the substrate relation.
- Use [[00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]] when the task is cold-reader glossing of these tokens. Glosses help recognition; they do not replace the declaration block.
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:5 - Archetypal Grounding

### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:5.1 - System
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:5.2 - Episteme
...
### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:5.3 - Boundary anti-case
...
**Cash-out.** Apply [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] or [[00_G.10 - SoTA Pack Shipping|G.10]] to that note. Do not pad it with pseudo-substrate words just to make it look deeper than it is.

### [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:5.4 - Use-situation spread
...
| Shortlist or publication note that only says what set result or publication form is shown or shipped | Do not use this pattern. Apply [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_G.10 - SoTA Pack Shipping]] directly. | The note stays publication-facing instead of imitating substrate depth. | Padding publication metadata with pseudo-substrate language. |

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:6 - Bias-Annotation
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:7 - Conformance Checklist

Treat a line as conforming only if every gate below passes.

| ID | Gate question | Fail when | Repair or governing pattern |
| --- | --- | --- | --- |
| `CC-A19SS-1` | Is the line really declaring one substrate-bearing relation rather than only `CharacteristicSpace`, publication metadata, or policy? | The line only names a space object, or only publishes, ships, or retains something, with no explicit source, ref, relation, or posture stack. | Move to [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.10 - SoTA Pack Shipping]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] as appropriate. |
...
| `CC-A19SS-11` | When the next question is interpretive-view, publication, or policy, is the next governing pattern explicit? | The text keeps talking as if substrate, interpretation, publication, and policy were one layer, so the reader cannot tell where to continue. | Split the line and cite [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_G.10 - SoTA Pack Shipping]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)]], or [[00_C.24 - Agentic Tool-Use and Call Planning (C.Agent-Tools-CAL)]] as the next governing pattern. |
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Letting [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]] or [[00_G.10 - SoTA Pack Shipping]] sound like the substrate itself | Publication metadata then silently replaces substrate semantics. | Keep publication as downstream use of the substrate. |

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:9 - Consequences
...
- [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], and [[00_G.10 - SoTA Pack Shipping|G.10]] stay coordinated without collapsing into one layer.
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:10 - Rationale

The pattern chooses a narrow but sturdy center of gravity.

[[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] already declares `CharacteristicSpace`. The missing load is not another free-floating space kind. It is the ref-position and relation stack that tells the reader:
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:11 - SoTA-Echoing

| SoTA practice | Primary source(s) | Practice demand disciplined here | Practical safeguard bought | Adoption stance |
| --- | --- | --- | --- | --- |
| Modern multilevel evolutionary theory looks for one common substrate across several levels rather than forcing one tradition-local carrier to tell the whole story. | Vanchurin (2026) on generally covariant evolutionary dynamics; Warrell et al. (2024) on unified multilevel evolutionary frameworks. | `SS-0`, `SS-2`, `CC-A19SS-1`, `CC-A19SS-2`. | Keeps one neutral substrate beside [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], so one archive, front, or publication face cannot silently stand in for the whole substrate declaration load. | **Adapt.** Keep one neutral substrate, but bind it to FPF declaration discipline. |
...
## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:12 - Relations

- **Builds on:** [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)|A.17]], [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]].
- **Coordinates with:** [[00_C.18 - Open-Ended Search Calculus (NQD-CAL)|C.18]], [[00_C.19 - Explore-Exploit Governor (E-E-LOG)|C.19]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], [[00_G.10 - SoTA Pack Shipping|G.10]], [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]].
- **Specialized by:** [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]] and later interpretive-view or atlas specializations when one line needs derived interpretation over an already-declared substrate.
- **Does not replace:** selector outcome publication, shipping metadata, live pool policy, or enactment planning.

## [[03_A.19.SOURCE-SET-SPACE-SUBSTRATE - Source-Set and Search-Outcome-Space Substrate|A.19.SOURCE-SET-SPACE-SUBSTRATE]]:End
