...
> **Modified:** 2026‑01‑20
>
> **Governing-pattern note, Phase‑3 canonicalization:** this pattern governs the canonical `U.Mechanism.Intension` for `CPM.IntensionRef` (CHR suite stage `compare`). Mechanism-intension semantics are governed by explicitly designated governing patterns ([[00_E.20 - Mechanism Introduction Protocol|E.20]]).
> [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] governs the **template** of `U.Mechanism.Intension`; this pattern governs the **CPM-specific constraints** over the SlotKind surface supplied by the suite: operations, laws, admissibility, applicability, transport, plane, and audit obligations for that template. It is not a second schema and does not govern the CHR SlotKind lexicon.
>
> **Canonicalization hook, ID‑continuity‑safe:** any other appearances of the CPM intension (e.g., suite prose in [[06_A.19.CHR - CHRMechanismSuite|A.19.CHR]]) SHALL be reduced to a **Tell + Cite** stub pointing to **`A.19.CPM:4.1`**, while preserving the original section headings and their public `PatternId:SectionPath` IDs for continuity (alias‑dock legacy tokens rather than deleting them).
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:0 - At a glance (didactic, informative)
...
* **P2W seam:** concrete `ComparatorSpecRef.edition` and any policy ids are bound **only** in planned baseline plan items ([[03_A.15.03 - SlotFillingsPlanItem|A.15.3]] + `A.19.CHR:4.7.2`). CPM’s kernel does **not** bind project‑specific pins; executions record the **effective** refs/pins in `Audit`.
* **Reproducible comparisons:** for parity/benchmark style runs that require a stable run package + report surface (editions, windows, parity pins), route packaging through [[00_G.09 - Parity and Benchmark Harness|G.9]] (Parity / Benchmark Harness). CPM stays kernel‑only.
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:1 - Problem frame
...
* a **mechanism** (in the `U.Mechanism.Intension` sense, per [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] / slot discipline [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]),
* that is **suite‑conformant** (per CHR obligations and protocol closure in [[06_A.19.CHR - CHRMechanismSuite|A.19.CHR]]),
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:2 - Problem
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:3 - Forces
...
6. **Avoiding “second centers of gravity”:** mechanism semantics must have a governing pattern; otherwise the suite, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] archetypes, and Part‑G wiring drift apart.

## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:4 - Solution
...
### [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:4.1 - Mechanism.Intension (canonical; normative)
...
* **Scope note:** this intension is an **instance** authored to the `U.Mechanism.Intension` shape ([[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]). It does **not** publish/telemetry, does **not** publish `GateDecision` nor `DecisionLog` surfaces (gate‑only), and does **not** embed selection. It emits `Audit` pins and a tri‑state guard only (per suite obligations).
  * **P2W separation:** this intension does **not** bind project‑specific pins (editions, policy‑ids, bridge ids, etc.). Binding lives in planned baseline plan items ([[03_A.15.03 - SlotFillingsPlanItem|A.15.3]] + `A.19.CHR:4.7.2`); executions record effective refs/pins in `Audit`.
...
* **LawSet** (minimum; set‑valued comparison, no hidden scalarization):
  ...
  1. **ComparatorSet gate:** `ComparatorSpecSlot` MUST be an element of `CGSpecSlot.ComparatorSet` (legality gate; cite [[00_G.0 - Frame Standard and Comparability Governance - CG-Spec|G.0]]).
  ...
  3. **CSLC+SCP legality:** any numeric ops implied by the comparator MUST be admissible under `CGSpecSlot.SCP` and CSLC‑lawful (cite [[00_G.0 - Frame Standard and Comparability Governance - CG-Spec|G.0]] + [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]]).
...
### [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:4.2 - Interpretation notes — informative
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:5 - Archetypal Grounding — informative

### [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:5.1 - Tell
...
### [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:5.2 - Show (U.System) — comparing two supplier options without faking a total order
...
### [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:5.3 - Show (U.Episteme) — uncertainty‑aware comparison with set‑valued outcomes
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:6 - Bias-Annotation — informative
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:7 - Conformance Checklist
...
| **CC‑A19CPM‑12** | **P2W separation.** Editions/policy‑ids are bound only in planned baseline plan items; CPM records effective refs/pins in Audit and does not bind them. | Planned baseline = [[03_A.15.03 - SlotFillingsPlanItem]] + suite PlanItem. |
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:8 - Common Anti‑Patterns and How to Avoid Them
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:9 - Consequences
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:10 - Rationale
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:11 - SoTA-Echoing

**SoTA vs popular note.** This section records alignment to post‑2015 evidence‑backed practice. It is **not** a mandate to use fashionable methods; method semantics stay in SoTA packs ([[00_G.02 - SoTA Harvester & Synthesis|G.2]]) and wiring modules, while this pattern fixes the stable CPM mechanism boundary.

**Pack note (Phase‑3).** If/when a CPM‑specific [[00_G.02 - SoTA Harvester & Synthesis|G.2]] SoTA pack/ClaimSheet is introduced, prefer citing the pack’s `ClaimSheetId`(s) over raw bibliographic pointers below, keeping CPM’s kernel semantics unchanged.
...
| **Uncertainty‑aware / set‑valued inference** (e.g., Romano et al., 2019; Barber et al., 2021)                                       | Supports “comparison may abstain” and “set‑valued outcomes are honest”: uncertain profiles should not be coerced into point‑comparisons.                         | Model as comparator families (or supporting method families) packaged in [[00_G.02 - SoTA Harvester & Synthesis]]; wired into declared `ComparatorSpec`. |
...
## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:12 - Relations

**Builds on / cites (non‑exhaustive):**

* [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (shape of `U.Mechanism.Intension`; specialization discipline)
* [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] (slot discipline; SlotIndex as derived projection)
* [[06_A.19.CHR - CHRMechanismSuite|A.19.CHR]] (suite membership + obligations + `suite_protocols`; CHR SlotKind lexicon)
* [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]] + `A.19.CHR:4.7.2` (P2W planned baseline binding; CPM remains refs‑only w.r.t. pin binding)
* [[05_A.19.CN - CN-frame (comparability & normalization)|A.19.CN]] (CN‑Spec comparability routing + acceptance/admission surfaces)
* [[00_G.0 - Frame Standard and Comparability Governance - CG-Spec|G.0]] (CG‑Spec: `ComparatorSet`, `SCP`, `MinimalEvidence`, CL/ReferencePlane framing)
* [[00_A.18 - Minimal CSLC in Kernel (Characteristic ⟷ Scale ⟷ Level ⟷ Coordinate) (A.CSLC-KERNEL)|A.18]] (CSLC scale lawfulness)
* [[00_E.10 - Unified Lexical Rules for FPF|E.10]] (lexical/ontological authoring rules; kind suffix discipline)
* [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] (checks; authoring discipline)
* [[00_E.20 - Mechanism Introduction Protocol|E.20]] (governing-pattern discipline)
* [[00_F.18 - Local-First Unification Naming Protocol|F.18]] (alias docking; ID continuity)
* [[00_E.18 - Transformation Flow Structure|E.18]] (project transformation-flow structures consume CPM instances; CPM does not create a parallel “card deck”)
...
* [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]] (selection conformance), [[00_G.09 - Parity and Benchmark Harness|G.9]] (parity / benchmark harness), [[00_G.10 - SoTA Pack Shipping|G.10]]/PTM (publish/telemetry outside suite closure).

## [[11_A.19.CPM - Unified Comparison Mechanism (CPM)|A.19.CPM]]:End
