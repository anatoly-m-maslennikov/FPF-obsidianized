...
> [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] governs the **template** of `U.Mechanism.Intension`.
>
> **Canonicalization hook (ID‑continuity‑safe):** any other appearances of the UINDM intension (e.g., a legacy grounding stub in [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] or suite prose in [[06_A.19.CHR - CHRMechanismSuite|A.19.CHR]]) SHALL be reduced to a **Tell + Cite** stub pointing to **`A.19.UINDM:4.1`**, while preserving the original section headings and their public `PatternId:SectionPath` IDs for continuity (alias‑dock legacy tokens rather than deleting them).
> Such stubs MUST NOT restate SlotIndex / LawSet / Admissibility content (no “second center of gravity” via near‑duplicate prose).

## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:0 - At a glance (didactic, informative)
...
* **P2W seam:** concrete edition/policy pins are bound in planned baseline plan items ([[03_A.15.03 - SlotFillingsPlanItem|A.15.3]] + `A.19.CHR:4.7.2`); executions only record effective refs/pins in `Audit`.
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:1 - Problem frame
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:2 - Problem
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:3 - Forces
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:4 - Solution
...
Method semantics (“how to pick indicators”) remain out of suite core: they belong in SoTA packs ([[00_G.02 - SoTA Harvester & Synthesis|G.2]]) and wiring‑only extension modules (`GPatternExtension` blocks), while UINDM remains the stable mechanism boundary.

### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:4.1 - Mechanism.Intension (normative)
...
* **LawSet** (CHR‑lawful indicatorization):
  ...
  3. **No implicit NCV⇒indicator:** measurability/NCV is not sufficient; indicators exist only via `IndicatorChoicePolicySlot` (cites [[05_A.19.CN - CN-frame (comparability & normalization)|A.19.CN]] `indicator_policy`).
...
### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:4.2 - Interpretation notes (informative)
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:5 - Archetypal Grounding (informative)

### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:5.1 - Tell
...
### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:5.2 - Show (U.System) — cross‑unit engineering dashboard
...
### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:5.3 - Show (U.Episteme) — robust evaluation across environments
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:6 - Bias-Annotation (informative)
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:7 - Conformance Checklist
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:8 - Common Anti‑Patterns and How to Avoid Them
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:9 - Consequences
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:10 - Rationale
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:11 - SoTA-Echoing
...
**Pack note (Phase‑3):** this pattern does not currently cite a UINDM‑specific [[00_G.02 - SoTA Harvester & Synthesis|G.2]] SoTA pack/ClaimSheet. If/when such a pack is introduced, replace the bibliographic pointers below with the pack’s `ClaimSheetId` citations, keeping the mechanism semantics unchanged.

### [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:11.1 - SoTA alignment map (normative)
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:12 - Relations

* **Builds on**

  * [[05_A.19.CN - CN-frame (comparability & normalization)|A.19.CN]] (CN‑Spec, specifically `indicator_policy`).
...
* **Used by**
  ...
  * [[06_A.19.CHR - CHRMechanismSuite|A.19.CHR]] (suite membership and suite protocols; UINDM is the `indicatorize` stage).
* **Coordinates with**

  * [[00_G.0 - Frame Standard and Comparability Governance - CG-Spec|G.0]] (CG‑Spec / MinimalEvidence) when indicator choice is evidence‑gated.
...
## [[08_A.19.UINDM - Unified Indicatorization Mechanism (UINDM)|A.19.UINDM]]:End
