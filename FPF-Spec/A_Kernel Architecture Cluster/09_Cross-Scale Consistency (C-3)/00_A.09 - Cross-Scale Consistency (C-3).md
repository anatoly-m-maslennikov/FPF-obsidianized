...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:1 - Context
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:4 - Solution — Invariant Quintet + Meta‑Holon Transition

### [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:4.1 - Invariant Quintet
...
### [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:4.2 - Meta‑Holon Transition (MHT)
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:5 - Archetypal Grounding
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:6 - Conformance Checklist
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:7 - Consequences
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:8 - Rationale
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:9 - Relations
...
| **Foundation for** | [[B_Trans-disciplinary Reasoning Cluster/00_01_Holon Aggregation and Part-Whole Construction/00_B.01 - Holon Aggregation and Part-Whole Construction]] Holon Aggregation and Part-Whole Construction | B-section part-whole construction uses this universal-core discipline. |
| **Triggers**       | B 2 Meta‑Holon Transition            | When invariants fail through synergy, an MHT is invoked.  |

## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:10 - Known Uses (2018‑2025)
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:11 - Open Questions for expert panel
...
## [[A_Kernel Architecture Cluster/09_Cross-Scale Consistency (C-3)/00_A.09 - Cross-Scale Consistency (C-3)|A.9]]:End
