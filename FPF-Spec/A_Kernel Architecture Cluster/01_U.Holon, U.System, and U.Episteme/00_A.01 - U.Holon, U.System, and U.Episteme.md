...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:0 - Use This When
...
- If the current question is local vocabulary, role assignment, or meaning inside one semantic frame, use [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] and the role-governing patterns.
- If the current question is the episteme slot relation, use [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]].
- If the current question is selected structure over a holon, use [[00_A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]].
- If the current question is architecture of a holon in context, use [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]].
- If the current question is work, method, or role-method-work alignment, use [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] and its dependent patterns.

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:1 - Problem Frame
...
[[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] governs this holonic ontology. It lets FPF talk about composition and boundaries across systems and epistemes without building a second ontology from the words "object", "system", "document", "model", "theory", or "architecture".

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:2 - Problem

Without [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:3 - Forces
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4 - Solution

Use the [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] holon stack:
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.1 - U.Entity
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.2 - U.Holon

`U.Holon` is a `U.Entity` treated as a whole with parts and as a participant in larger wholes under a bounded context.

The [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] holon slot relation is:
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.3 - Boundary and Interaction
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.4 - Holon Membership Test
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.5 - U.System
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.6 - U.Episteme

`U.Episteme` is a holon whose parts are claim-bearing and interpretation-bearing values: claims, definitions, reference schemes, viewpoints, evidence relations, argument structures, model content, or other episteme components governed by [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]].

`U.Episteme` is non-agentive. It does not decide, promise, authorize, perform work, or revise itself. A system in role may write, revise, publish, compare, transform, or use an episteme. The episteme remains the claim-bearing holon under the [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slot relation.
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:4.7 - Cross-Level Use
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:5 - Archetypal Grounding

### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:5.1 - Water Pump as U.System
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:5.2 - Scientific Theory as U.Episteme
...
### [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:5.3 - Team as Collection or Collective System
...
If the project says "the team approved the architecture", [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] asks whether there is a collective system and whether a decision pattern or governance pattern makes that claim admissible. If not, name the specific system-in-role or decision relation that actually carries the claim.

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:6 - Bias-Annotation
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:7 - Conformance Checklist
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Architecture without holon | A selected structure is discussed without the holon whose structure is selected. | Use [[00_A.01 - U.Holon, U.System, and U.Episteme]] to name the holon, then [[00_A.22 - Structure and Structural Views (STRUCT-CAL)]] and [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] for selected structure and architecture. |

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:9 - Consequences
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:11 - SoTA-Echoing

| Source family | Current lesson for [[00_A.01 - U.Holon, U.System, and U.Episteme]] | FPF decision |
| --- | --- | --- |
...
| Domain-driven bounded-context practice. | Meaning and role assignments are local to a context; one word does not carry the same ontology everywhere. | [[00_A.01 - U.Holon, U.System, and U.Episteme]] pairs holon identity with `U.BoundedContext`; [[01_A.01.01 - U.BoundedContext Semantic Frame]] governs the semantic frame. |
| FAIR, provenance, and knowledge-representation practice. | Claim-bearing knowledge objects and their publications must be separated from physical systems and publication forms. | `U.Episteme` is a non-agentive holon governed by [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]]; systems in role create, publish, or use epistemes. |
...
Source role and currentness: the compositional open-systems and systems-engineering rows are current support for boundary-consistent grounding; bounded-context practice is carried through [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]; FAIR, provenance, and knowledge-representation practice support the separation among claim-bearing epistemes, publications, and acting systems. Older named traditions under these families are lineage or background unless a governing pattern cites them by value. Reopen [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] when accepted FPF work or current systems, KR, provenance, or digital-twin practice changes the root split among `U.Entity`, `U.Holon`, `U.System`, `U.Episteme`, boundary, or publication-form separation; do not reopen it for a new tool, notation, or diagram style that does not change that root ontology.

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:12 - Relations

- **Builds on:** [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] for ontic introduction discipline and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] for slot relation discipline.
- **Coordinates with:** [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] for bounded context, [[00_A.22 - Structure and Structural Views (STRUCT-CAL)|A.22]] for selected structure, [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]] for architecture, [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] for episteme slot relation, [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for role-method-work alignment, [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] for holon-description publication boundary, and [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] for wording-use restoration.
...
## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:13 - Footer Marker

## [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]]:End
