...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:0 - Use This When
...
- If the question is only naming a durable term, use [[00_F.18 - Local-First Unification Naming Protocol|F.18]].
- If the question is role-method-work alignment after the context is known, use [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]].
- If the question is episteme description context, use [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] with `BoundedContextRef`.
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:1 - Problem Frame
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:2 - Problem
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:3 - Forces
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4 - Solution
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.1 - Context Identity
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.2 - Context Boundary
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.3 - Local Vocabulary
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.4 - Local Invariant Set
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.5 - Local Role Taxonomy
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.6 - Bridge Relation Set
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:4.7 - Non-Enclosing Boundary
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:5 - Archetypal Grounding

### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:5.1 - Hospital Operating Room Context
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:5.2 - Special Relativity Context
...
### [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:5.3 - FPF Pattern Quality Context
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:6 - Bias-Annotation
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:7 - Conformance Checklist
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:9 - Consequences
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:10 - Rationale
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:11 - SoTA-Echoing

| Source family | Current lesson for [[01_A.01.01 - U.BoundedContext Semantic Frame]] | FPF decision |
| --- | --- | --- |
...
Source role and currentness: domain-driven bounded-context practice is the selected practice lineage generalized beyond software; team-topology and socio-technical boundary practice are current support for stewarding-system and cognitive-boundary caution; data-mesh and interoperability practice support explicit bridge relations; FAIR, provenance, and research-object practice support interpretation context and publication-boundary discipline. Reopen [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] when current practice or accepted FPF work changes the criteria for semantic locality, cross-context bridge fit and loss, local role taxonomy, or context-publication separation; do not reopen it for a new domain label, team structure, metadata format, or data product style that leaves those criteria unchanged.

## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:12 - Relations

- **Builds on:** [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] for `U.Holon`, [[00_E.24 - U.Ontic and Ontic Introduction Discipline|E.24]] for ontic discipline, and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] for slot relation discipline.
- **Coordinates with:** [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for role-method-work alignment, [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] for episteme slot relations, [[00_F.09 - Alignment & Bridge across Contexts|F.9]] for bridge relations, [[00_E.10 - Unified Lexical Rules for FPF|E.10]] and [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] for context-word repair, and [[02_E.24.PUB - Ontic Description and Publication Discipline|E.24.PUB]] for bounded-context description and publication boundary.
...
## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:13 - Footer Marker

## [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]]:End
