...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:0 — Conventions
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:1 — Problem frame
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:2 — Problem
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:3 — Forces
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4 - Solution — the Boundary Norm Square

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.1 - Two independent distinctions
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.2 — The square
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.3 — Canonical placements in the Signature Stack
...
A published view **MUST NOT** introduce new semantic claims outside this L/A/D/E-classified claim set. **[[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] (MVPK)** is a specialization that enforces this rule for a fixed set of publication face kinds.

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5 — Quadrant specifications

This section is the normative “API” of the square: what each quadrant is for, how it is written, and what it must not contain.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.1 — Quadrant L: Laws & Definitions
...
**[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] EntityOfConcern binding.** `L-*` claims are **Descriptions**: they specify semantics of the signature or mechanism description, not work.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.2 — Quadrant A: Admissibility & Gates
...
**[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] EntityOfConcern binding.** `A-*` claims are **Descriptions** of a mechanism gate. They are not “what a client must do”; they are “what the mechanism admits”.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.3 — Quadrant D: Deontics & Commitments
...
**Canonical payload (recommended; lintable).** When a `D-*` claim is intended to be lintable and reusable, it **SHOULD** be representable as a `U.Commitment` record ([[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]). Default fields to make explicit:
...
* A `D-*` statement **MUST NOT** use “the system, service, interface, or specification” as the grammatical subject unless the accountable role assignment or admitted acting system is explicitly named (so the statement is representable as a `U.Commitment` with an explicit `subject`, [[A_Kernel Architecture Cluster/02_Role Taxonomy/08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]). Use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] when contract, promise, utterance, or agreement-like boundary language is live.
...
**[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] EntityOfConcern binding.** `D-*` claims are primarily **about Objects** (accountable role assignments or admitted acting systems and their duties) or **about Carriers** (retention and exposure duties), but they are still written as **Descriptions**.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.4 — Quadrant E: Work‑Effects & Evidence
...
2. **Evidence carrier or record reference** under [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], or [[G_Discipline SoTA Patterns Kit/07_06_Evidence Graph and Provenance Ledger- Citable Evidence-Provenance Paths/00_G.06 - Evidence Graph and Provenance Ledger- Citable Evidence-Provenance Paths|G.6]] as applicable for the evidence relation or source basis
...
**[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] EntityOfConcern binding.** `E-*` claims are primarily **carrier-referenced**: they assert what carriers exist and how they relate to observed work.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6 — Cross‑quadrant link discipline
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.1 — Explicit reference rule
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2 — Canonical cross‑quadrant dependency patterns

These patterns are valid (and common). The square becomes operational when these links are used systematically.

#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.1 - (D → A) Duty-to-gate linkage
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.2 - (E → A) Evidence-for-gate linkage
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.3 - (D → E) Duty-to-evidence linkage
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.4 - (A/E → L) Semantic grounding linkage
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.5 - (D → L) Governance-to-definition linkage
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.3 — The “triangle decomposition” for mixed sentences
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.4 — Dependency direction (no “upward” imports)
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7 — Mini-register: Claim Register (informative, recommended)
...
| ID | Quadrant | Statement (verbatim) | Canonical location (section or publication unit) | Stack layer | [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)]] primary layer | viewRef | viewpointRef | References | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
* **[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] primary side** is the claim’s primary referent (`EntityOfConcern`, Description episteme, or publication carrier), even though the claim is always written as a Description episteme.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8 - Archetypal Grounding (Tell–Show–Show)

> **Informative.** Examples for learning the square; they do not add requirements beyond [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:10.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.1 - Tell (universal rule)
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.2 - Show #1: Effect signature vs handler (post‑2015 effect systems)
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.3 - Show #2: ML evaluation protocol boundary (reproducibility discipline)
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4 — Worked Rewrite Kit (informative, recommended)

> **Informative.** This kit is a worked, copy‑pasteable restatement of [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]’s rules (atomicity, L/A/D/E classification, explicit references, triangle decomposition, and no‑upward dependencies). If anything here conflicts with [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] is authoritative**.

#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.0 - Goal
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.1 - Micro-procedure (Atomize → Classify → Triangle → Link → Bind References → Recompose)
...
**Step 5 — Bind references (minimal [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] discipline).**
...
**Optional drift-control.** Add each L/A/D/E-classified claim verbatim to a Claim Register row ([[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7) with canonical location + references so faces can cite by ID without paraphrase.
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.2 - Anti-pattern (quick)
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3 - Example 1 — Software engineering (SLO-ish API latency)

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.1 - Draft sentence (non-conformant)

> “This API guarantees p95 latency < 200ms.”

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.2 - Atomize + Classify (L/A/D/E)
...
##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.3 - Triangle decomposition (explicit)
...
##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.4 - Readable recomposition
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4 - Example 2 — Mechanical engineering (fit / coaxiality)

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.1 - Draft sentence (non-conformant)

> “This fit ensures coaxiality.”

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.2 - Atomize + Classify
...
##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.3 - Readable recomposition
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5 - Example 3 — Management (project “approved or aligned”)

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.1 - Draft sentence (non-conformant)

> “The project is approved.”

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.2 - Atomize + Classify
...
##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.3 - Readable recomposition
...
#### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6 - A compact “recomposition pattern” you can reuse verbatim

##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6.1 - Tech register (2–5 lines)
...
##### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6.2 - Plain register (1 paragraph)
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:9 — Bias‑Annotation
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:10 — Conformance Checklist
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:11 - Common Anti‑Patterns and How to Avoid Them
...
| **Interface‑as‑promiser**    | “The API promises or guarantees …”                    | Category error: interface descriptions do not commit              | Identify committing role assignment or admitted acting system (`D-*`), measured property (`E-*`), and metric definition (`L-*`); use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/03_A.06.C - Contract Unpacking for Boundaries]] when contract or promise-content unpacking is live. |
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:12 — Consequences
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:13 — Rationale
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:14 — SoTA‑Echoing (post‑2015 practice alignment)

> **Informative.** Alignment notes; not normative requirements.

**Representative sources (post‑2015; illustrative).** See also [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]]:11 for a fuller list.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:15 — Relations

* **Used by [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]]:** supplies the canonical matrix and cross‑quadrant link discipline that [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]] references as “Boundary Discipline Matrix”.
* **Constrains [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind|A.6.0]] (`U.Signature`):** enforces that `L-*` laws are truth‑conditional and do not include admissibility predicates.
* **Constrains [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/05_A.06.01 - U.Mechanism - Law-governed application to a SubjectKind over a RangedValueKind|A.6.1]] (`U.Mechanism`):** enforces that admissibility lives in `AdmissibilityConditions` (`A-*`) and that evidence semantics are classified as `E-*` with carrier references.
* **Requires [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:** binds quadrants to `EntityOfConcern`, Description episteme, or publication carrier so agency and evidence are not misattributed.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:15a - Probe-coupled boundary claim classification
...
5. Apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] to reusable relation words; use [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]] only when recovered terms need durable names; apply [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] to evidence; apply [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] to assurance; apply [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] to measurement; apply [[C_Kernel Extension Specifications/14_26_Quantum-Like Modeling Lens/01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] to any remaining probe-coupled state-reading claim.
...
- an ordinary [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] L/A/D/E-classified claim set when no quantum-like probe-coupled state-reading claim remains;
- a [[C_Kernel Extension Specifications/14_26_Quantum-Like Modeling Lens/01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] classify only for the remaining probe-coupled state-reading part;
- an A.10/B.3/C.16/F.9 classification when evidence, assurance, measurement, or bridge work is the actual claim being made.

Do not write "the boundary is quantum-like" as one unL/A/D/E-classified claim. The action is: split the claim, classify the pieces, then decide whether [[C_Kernel Extension Specifications/14_26_Quantum-Like Modeling Lens/01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] still has a remaining job.

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:End
