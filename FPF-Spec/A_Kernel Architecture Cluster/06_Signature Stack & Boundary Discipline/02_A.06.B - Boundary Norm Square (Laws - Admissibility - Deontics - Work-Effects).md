...
> **Status:** Stable
> **Normativity:** Normative (unless explicitly marked informative)
> **Placement:** Part A → [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] (matrix module; referenced by [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] cluster overview)
> **Builds on:** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] (authoring template), [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] (`U.Signature`), [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (`U.Mechanism`), [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] (`U.EpistemicViewing`), [[03_E.17 - Multi-View Publication Kit|E.17]].0/E.17 (MVPK + “no new semantics” faces), [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] (EntityOfConcern and Description-episteme boundary; specification-use and publication-carrier distinction), [[00_F.18 - Local-First Unification Naming Protocol|F.18]] (promise/utterance/commitment), [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary; specification-use/refinement discipline), [[00_E.10 - Unified Lexical Rules for FPF|E.10]] publication face, form, unit, and carrier discipline
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:0 — Conventions
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:1 — Problem frame
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:2 — Problem
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:3 — Forces
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4 - Solution — the Boundary Norm Square

### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.1 - Two independent distinctions
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.2 — The square
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4.3 — Canonical placements in the Signature Stack
...
A published view **MUST NOT** introduce new semantic claims outside this L/A/D/E-classified claim set. **[[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK)** is a specialization that enforces this rule for a fixed set of publication face kinds.

## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5 — Quadrant specifications

This section is the normative “API” of the square: what each quadrant is for, how it is written, and what it must not contain.

### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.1 — Quadrant L: Laws & Definitions
...
**[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `L-*` claims are **Descriptions**: they specify semantics of the signature/mechanism description, not work.
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.2 — Quadrant A: Admissibility & Gates
...
**[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `A-*` claims are **Descriptions** of a mechanism gate. They are not “what a client must do”; they are “what the mechanism admits”.
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.3 — Quadrant D: Deontics & Commitments
...
**Canonical payload (recommended; lintable).** When a `D-*` claim is intended to be lintable/reusable, it **SHOULD** be representable as a `U.Commitment` record ([[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]). Default fields to make explicit:
...
**[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `D-*` claims are primarily **about Objects** (roles/agents and their duties) or **about Carriers** (retention/exposure duties), but they are still written as **Descriptions**.
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:5.4 — Quadrant E: Work‑Effects & Evidence
...
2. **Carrier class/schema reference** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] Carrier) that bears the evidence
...
**[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] anchoring.** `E-*` claims are primarily **Carrier‑anchored**: they assert what carriers exist and how they relate to observed work.
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6 — Cross‑quadrant link discipline
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.1 — Explicit reference rule
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2 — Canonical cross‑quadrant dependency patterns

These patterns are valid (and common). The square becomes operational when these links are used systematically.

#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.1 - (D → A) Duty-to-gate linkage
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.2 - (E → A) Evidence-for-gate linkage
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.3 - (D → E) Duty-to-evidence linkage
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.4 - (A/E → L) Semantic grounding linkage
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.2.5 - (D → L) Governance-to-definition linkage
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.3 — The “triangle decomposition” for mixed sentences
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6.4 — Dependency direction (no “upward” imports)
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7 — Mini-register: Claim Register (informative, recommended)
...
| ID | Quadrant | Statement (verbatim) | Canonical location (section or publication unit) | Stack layer | [[00_A.07 - Strict Distinction (Clarity Lattice)]] primary layer | viewRef | viewpointRef | References | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
* **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] primary side** is the claim’s primary referent (`EntityOfConcern`, Description episteme, or publication carrier), even though the claim is always written as a Description episteme.
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8 - Archetypal Grounding (Tell–Show–Show)

> **Informative.** Examples for learning the square; they do not add requirements beyond [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:10.

### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.1 - Tell (universal rule)
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.2 - Show #1: Effect signature vs handler (post‑2015 effect systems)
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.3 - Show #2: ML evaluation protocol boundary (reproducibility discipline)
...
### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4 — Worked Rewrite Kit (informative, recommended)

> **Informative.** This kit is a worked, copy‑pasteable restatement of [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]’s rules (atomicity, L/A/D/E routing, explicit references, triangle decomposition, and no‑upward dependencies). If anything here conflicts with [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] is authoritative**.

#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.0 - Goal
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.1 - Micro-procedure (Atomize → Route → Triangle → Link → Anchor → Recompose)
...
**Step 5 — Anchor (minimal [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] discipline).**
...
**Optional drift-control.** Add each L/A/D/E-classified claim verbatim to a Claim Register row ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7) with canonical location + references so faces can cite by ID without paraphrase.
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.2 - Anti-pattern (quick)
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3 - Example 1 — Software engineering (SLO-ish API latency)

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.1 - Draft sentence (non-conformant)

> “This API guarantees p95 latency < 200ms.”

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.2 - Atomize + Route (L/A/D/E)
...
##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.3 - Triangle decomposition (explicit)
...
##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.3.4 - Readable recomposition
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4 - Example 2 — Mechanical engineering (fit / coaxiality)

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.1 - Draft sentence (non-conformant)

> “This fit ensures coaxiality.”

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.2 - Atomize + Route
...
##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.4.3 - Readable recomposition
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5 - Example 3 — Management (project “approved/aligned”)

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.1 - Draft sentence (non-conformant)

> “The project is approved.”

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.2 - Atomize + Route
...
##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.5.3 - Readable recomposition
...
#### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6 - A compact “recomposition pattern” you can reuse verbatim

##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6.1 - Tech register (2–5 lines)
...
##### [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:8.4.6.2 - Plain register (1 paragraph)
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:9 — Bias‑Annotation
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:10 — Conformance Checklist
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:11 - Common Anti‑Patterns and How to Avoid Them
...
| **Interface‑as‑promiser**    | “The API promises/guarantees …”                    | Category error ([[00_F.18 - Local-First Unification Naming Protocol]]): epistemes don’t promise              | Identify committing role (`D-*`), measured property (`E-*`), and metric definition (`L-*`). |
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:12 — Consequences
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:13 — Rationale
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:14 — SoTA‑Echoing (post‑2015 practice alignment)

> **Informative.** Alignment notes; not normative requirements.

**Representative sources (post‑2015; illustrative).** See also [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:11 for a fuller list.
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:15 — Relations

* **Used by [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:** supplies the canonical matrix and cross‑quadrant link discipline that [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] references as “Boundary Discipline Matrix”.
* **Constrains [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] (`U.Signature`):** enforces that `L-*` laws are truth‑conditional and do not include admissibility predicates.
* **Constrains [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (`U.Mechanism`):** enforces that admissibility lives in `AdmissibilityConditions` (`A-*`) and that evidence semantics are routed as `E-*` with carrier anchors.
* **Requires [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:** anchors quadrants to `EntityOfConcern`, Description episteme, or publication carrier so agency and evidence are not misattributed.
...
## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:15a - Probe-coupled boundary claim routing
...
5. Apply [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] and [[00_F.18 - Local-First Unification Naming Protocol|F.18]] to reusable relation words; apply [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] to evidence; apply [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] to assurance; apply [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]] to measurement; apply [[01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] to the remaining probe-coupled support load.
...
- an ordinary [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] L/A/D/E-classified claim set when no QL support load remains;
- a [[01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] route only for the remaining probe-coupled state-reading part;
- an A.10/B.3/C.16/F.9 route when evidence, assurance, measurement, or bridge work is the real entry load.

Do not write "the boundary is quantum-like" as one unL/A/D/E-classified claim. The action is: split the claim, classify the pieces, then decide whether [[01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] still has a remaining job.

## [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:End
