...
**Not this pattern when.** Do not use [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] as a universal wording-repair pattern, evidence pattern, assurance pattern, quality pattern, source-use pattern, or architecture pattern. If [[00_E.10 - Unified Lexical Rules for FPF|E.10]] already recovered the pattern governing the recovered claim, kind, or relation, use that governing pattern directly.

**Placement.** Part A → cluster **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]] Signature Stack & Boundary Discipline** → governing pattern for **RPR specialisations** ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]], [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]], [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]], [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]], [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]], and any additional A.6.x pattern that declares this RPR relation).

**Builds on.**

* **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]]** (stack layering + boundary discipline requirements).
* **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] `U.BoundaryNormSquare`** (L, A, D, and E classification; claim atomicity; cross-quadrant references).
* **[[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]] `U.SignatureEngineeringPair`** (TargetSignature vs ConstructorSignature; canonical constructor verb mapping; effect‑free constructor ops).
* **[[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] `U.Signature`** (SlotSpec requirement for argument positions).
* **[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline`** (SlotKind/ValueKind/RefKind stratification + canonical slot verbs; `bind` reserved for name binding).
* **[[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]** (pattern authoring discipline; Tell–Show–Show; SoTA echoing hygiene).
* **[[00_F.18 - Local-First Unification Naming Protocol|F.18]]** (local-first reusable naming after relation kind and use recovery: minting decisions, reuse decisions, legacy-name documentation decisions, collision checks, lineage notes, and durable-name discipline).
* **[[00_E.10 - Unified Lexical Rules for FPF|E.10]]** (LEX‑BUNDLE discipline; EntityOfConcern versus Description epistemes and specification-use cases plus publication face, form, unit, carrier, and rendering lanes; publication-face or publication-form token discipline; reserved primitives; Tech↔Plain pairing). *(Referenced conceptually; no extra authoring apparatus implied.)*

**Coordinates with.**

* **[[04_A.02.04 - U.EvidenceRole|A.2.4]] `U.EvidenceRole`** (witness semantics: role, timespan, and freshness metadata for decision-relevant witness sets).
* **[[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]] scope + `Γ_time` discipline** (avoid implicit “current/latest”; make time selectors explicit when time matters).
* **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] Strict Distinction** (EntityOfConcern, Description episteme, specification use, publication face, form, unit, carrier, and rendering; avoid treating evidence or logs as properties of prose).
* **[[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]–[[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]** (effect‑free episteme morphisms, epistemic viewing/retargeting as disciplined slot writes).
* **[[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence discipline** (witnesses are carrier‑anchored; freshness is adjudicated in work/evidence lanes).
* **[[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] `U.EpistemeSlotRelation`** (slot read/write profiles for constructor operators, when declared).
* **[[03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]] `U.KindBridge` + `CL^k` discipline** (repairing endpoint kind mismatches; kind-level congruence + loss notes).
* **[[03_E.17 - Multi-View Publication Kit|E.17]] MVPK and multi-view publication** (faces are views; "no new semantics"; viewpoint accountability).
* **[[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]] pattern quality gates** (review/refresh discipline for guardrails and conformance lists).
* **[[00_F.17 - Unified Term Sheet (UTS)|F.17]] `UTS`** (when ambiguity clusters become recurring vocabulary: publish stable `RelationKind` tokens and facet head phrases as UTS and LEX-UTS term assets, so rewrites do not live only inside A-patterns).
* **[[00_F.09 - Alignment & Bridge across Contexts|F.9]] Bridges + CL** for cross-Context or cross-plane reuse (no silent sameness).
* **[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], and [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]** for the language-state seam: language-state chart positions, admissible moves, pre-threshold cue preservation, next-pattern publication, admissible retreat or reopen, and prompt-shaped continuations that are not yet stable relation publication; use **[[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or handoff history itself must be published as an explicit trajectory account.
* **[[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for language-state facet governance: articulation explicitness, closure degree, language-state anchoring mode, and the language-state representation-factor bundle may be cited by RPR patterns but are not governed here.

**Specialisations already in Core.**
These retained specialisations are current because they each carry one stable recurring repair case. Their mnemonic heads remain admissible entry points, but generic [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] does **not** treat token recurrence alone as sufficient to mint one new specialisation per overloaded trigger word.

* **[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]**: RPR for n-ary relations and slot discipline (archetype: "putting something into a place"; explicit SlotKinds, ValueKind, RefKind, and slot-operation lexicon).
* **[[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]]**: RPR for relative-to and basedness claims (explicit `baseRelation` token, scoped witnessed base declarations, and base-change lexicon; lexical red-flags for `anchor*`; support-as-basedness selection test for `support`, `supported by`, `support basis`, and `support relation` wording).
* **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR-SERV)**: RPR for the "service" cluster polysemy (facet-explicit `serviceSituation` lens; canonical rewrites for `service`, `server`, and `service provider`; classification tests for clause, access point, provider commitment, work, and evidence).
* **[[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]] (RPR-XCTX)**: RPR for cross-Context "same", "equivalent", "align", or "map" talk (explicit Bridges with direction, endpoint refinement, substitution licence, CL, and loss notes; blocks silent inversion and "alignment" umbrella verbs).
* **[[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]] (RPR-WHOLE)**: RPR for "whole", "part", "integrity", and "complete" polysemy (WHOL triggers plus Boundary-Parthood-Fold-Order-Time-Completeness lens; maps turnkey and end-to-end wording into [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] coverage; includes publication-form, referent, and work-level tests).

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:0 — TERM and LEX token guards (local-first)
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:1 — Problem frame
...
[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] defines a **repeatable precision restoration recipe** that makes this defect repairable and reusable across additional admitted A.6.x patterns.

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:2 — Problem
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:3 — Forces
...
| Stack discipline                      | Signature invariants, admissibility, deontics, and evidence/work must not be mixed ([[00_A.06 - Signature Stack & Boundary Discipline]] + [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]]).                      |

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4 — Solution — The RPR recipe (Lens → Slots → Change Lexicon → Guardrails), aligned to [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] / [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] / [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]]

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] defines the **RPR specialisation envelope**. A pattern is a **RPR specialisation under [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** iff it provides the ingredients below.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0 - Admission rule after lexical trigger scan

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is not the first post-authoring check for conformant FPF pattern text and not an all-purpose trigger-word registry. In conformant FPF text, [[00_E.10 - Unified Lexical Rules for FPF|E.10]] carries the lexical trigger scan. When that scan selects `epistemic precision restoration required`, [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] supplies the epistemic precision-restoration profile for pattern prose and FPF-facing publication prose. [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is applicable when the [[00_E.10 - Unified Lexical Rules for FPF|E.10]] scan has selected relation precision, endpoint recovery, support-like claim-kind discrimination, basedness, cross-context bridge wording, or another RPR repair case.

For non-FPF intake, source, review, project, or tool-output prose, [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] may still be used directly as a repair method once a reader has recognized a relation-bearing use. That use produces a repaired FPF phrase, candidate-set note, relation record, or transfer disposition. It does not make the source text itself non-conformant FPF text and does not require the source text to be rewritten.

A relation mention or relation-bearing phrase is in-scope for [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] when **any** of the following holds:
...
**Repair order note.** When a FPF-governed phrase is triggered because its **head noun** is too generic, first restore what kind of thing the head actually names: record, carrier, interpretive claim kind or admissible-use boundary, process, lane, authority use, or another local kind with named authority-reference relation. Use local EntityOfConcern and claim-target discipline ([[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], and nearby authority-reference guidance). A narrowing qualifier such as `comparative`, `safe`, `interactive`, or `reliable` may narrow the phrase, but it does **not** by itself restore the head kind. Then apply [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] to restore the remaining relation or comparison reading. Mixed-kind comparison checks come **after** those two repairs, not before them.
...
**Precision/relaxation note.** [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is not a blanket demand that every sentence stay maximally explicit forever. It is a trigger-based repair discipline for **FPF-governed** prose. In design-time FPF texts and in run-time texts being prepared for admissible publication, review, gating, or reuse, the repair should be performed before any later didactic plain-language softening or admissible coarsening. Later relaxation is allowed only when the more precise upstream repair remains recoverable and authoritative.

**Generic trigger-word governance rule (normative).** Overloaded words are diagnostic entry points, not default governing FPF patterns or `authoritySourceRef` targets. Generic [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] therefore requires this order: restore head kind first, restore the remaining relation or comparison reading second, and only then judge whether one reusable repair-case specialisation is justified. A new [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] specialization or broader trigger-word governing FPF pattern or `authoritySourceRef` target is owed only when one stable recurring repair case, one reusable lens or rewrite kit, and one `F.18 -> [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline|A.6]].P`-surviving head already exist by value across more than one worked case. Otherwise token-specific retained knowledge stays with an existing admissible specialization or in one cluster-local / source-local note rather than expanding generic [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] into a token bucket store.

**Replacement-candidate anti-umbrella rule (normative).** When an RPR repair selects a replacement term, apply the shared `E.10:0.2` replacement-candidate anti-umbrella rule before accepting the term. Then run the candidate through the local [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] recovery: name the FPF kind or local field it denotes, the [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] lane, the participant or carrier/view/EntityOfConcern positions, the relation or publication function if any, and the admissible and non-admissible use. If those cannot be named, keep the line in Candidate-Set Note form rather than treating the new term as repaired.

**Support precision restoration rule (normative).** `support`, `supported`, `supporting`, `support-looking`, and support-headed compounds are diagnostic tokens, not one recovered relation kind, not one generic record kind, not one universal evidence verdict, not one universal source relation, and not one universal reason container. Before an in-scope support phrase is used for publication, comparison, reliance, gate, assurance, decision, work, cross-context reuse, pattern-quality claims, or architecture claims, first recover the support-like claim kind or admissible-use boundary under the full [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair sequence: head kind, [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] lane, candidate endpoints, EntityOfConcern or grounding holon when live, relation kind, qualifiers, admissible use, and governing ontology named by value or governing pattern when the selected support-like case is not an [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] relation. If the selected support-like case is base-dependence, apply [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] ontology and state `dependent`, `base`, `baseRelation`, `scope`, `Γ_time` when live, witnesses when decision/publication/admissibility use is live, `admissibleUse`, and `nonAdmissibleUse`; do not mint a generic `SupportRelation`, `SupportBasis`, or `SupportRecord`.
...
| --- | --- | --- |
| **Source-to-EntityOfConcern description relation.** A source episteme, publication, view, document, model, diagram, graph, trace, or generated representation is being used to describe, expose, render, cite, or make inspectable one claim-bearing EntityOfConcern. | source episteme/publication/view/carrier where relevant, EntityOfConcern, publication/view relation, source pins or source-return condition, admissible and non-admissible use. | [[03_E.17 - Multi-View Publication Kit]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[00_A.07 - Strict Distinction (Clarity Lattice)]], and local publication/source rules. |
| **EntityOfConcern or grounding-holon contact.** The phrase says that a claim-bearing episteme, view, representation, or pattern application is grounded in the EntityOfConcern it concerns, the situation it is about, the observation setting, or the local world contact needed for the claim. | `EntityOfConcernSlot`, `GroundingHolonSlot` when grounding-holon grounding is being claimed, bounded context, reference plane, reference scheme, viewpoint, witness or observation condition if needed. | [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[09_C.02.06 - U.LanguageStateAnchoringMode]], [[00_A.07 - Strict Distinction (Clarity Lattice)]], and evidence or observation patterns governing world-contact claims when world contact is live. |
| **Base, anchor, or basedness relation.** The phrase means relative-to, based-on, anchored-in, base change, dependency on a base, or local grounding as a base relation rather than a source/document relation. Support wording belongs here only when a dependent content is usable, admissible, interpretable, comparable, publishable, or actionable relative to an explicit base. | `dependent`, `base`, declared `baseRelation` token, scoped witnessed base declaration, `Γ_time` when live, witnesses when decision/publication/admissibility use is live, base-change condition, admissible and non-admissible use. | [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)]]; use its support wording selection test and SWBD discipline. |
| **Evidence or witness support.** The phrase says a carrier, observation, test, role assignment, or evidence path bears on a claim. | evidence role, evidence path, claim ref, witness carrier, timespan/freshness, and the evidence-role field named by value when the governing pattern defines one. | [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[04_A.02.04 - U.EvidenceRole]], [[00_G.06 - Evidence Graph & Provenance Ledger]], and any evidence-role specialization named by value. |
| **Assurance or engineering-justification support.** The phrase says a claim is acceptable for assurance, safety, trust, engineering justification, or assurance calculus use. | assurance claim, argument component, confidence or trust calculus input, cited evidence path, non-admissible claim escalation. | [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]] plus the evidence pattern governing the claim when an assurance or evidence claim is live. |
| **Causal-use support.** The phrase says a causal, intervention, counterfactual, policy, off-policy, or simulation-only use is admissible. | causal-use question, `CausalityLadderRung`, estimand, `CausalEvidenceSupportBasis`, `CausalUseSupportVerdict`, supported and unsupported use. | [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]]; do not substitute [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] or [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]] value sets for the [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] causal-use vocabulary. |
| **Mathematical-lens use result.** The phrase says a lens, model, mapping, similarity, or formal construction makes a claim admissible or exposes preserved and lost structure. | lens candidate, lens-use card, primary `EntityOfConcern` or relation record or claim record named by value, preserved and lost structure, declared loss, stop condition, lens-use result, lens-use admissibility value, and the non-lens claim-kind pattern governing the claim when evidence, causal, assurance, decision, or publication claim kind or admissible-use boundary is live. | [[00_C.29 - Mathematical Lens Use]], [[00_C.26 - Quantum-Like Modeling Lens]], [[00_F.09 - Alignment & Bridge across Contexts]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], or a named mathematical-lens pattern. |
| **Characteristic, measurement, threshold, or comparison reference.** The phrase says a characteristic, metric, score, threshold, benchmark, or comparison warrants a claim. | bearer, characteristic space, scale, measure, measurement procedure, comparison reference set, threshold rule, proxy-distortion risk. | [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], [[00_A.17 - Canonical “Characteristic” (A.CHR-NORM)]]-[[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]], [[00_G.09 - Parity and Benchmark Harness]], and the bridge or comparison pattern governing the characteristic, measurement, threshold, benchmark, or comparison claim being made. |
| **Admissible-use or boundary-use rule.** The phrase says a current use, publication use, project action, work preparation, gate use, or downstream reliance is allowed. | `admissibleUse` target named by value, non-admissible claim escalation or adjacent use, L, A, D, and E split when boundary-use reading is being made, project-side kind or reference if needed. | [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]], `E.17:5.1c`, [[00_C.02.P - Epistemic Precision Restoration]], and project-side pattern governing the claim. |
| **Work, enablement, prerequisite, resource, or operational help.** The phrase says one thing helps, enables, prepares, funds, resources, scaffolds, directs, or makes work easier, without claiming evidence, authority, truth, or admissibility. | enabled work and method or action, prerequisite or resource relation if FPF-governed, remaining reader move, explicit non-admissible evidence, gate, assurance, or decision use. | [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[04_A.15.04 - Work-Relevant Source Restoration]], [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)]], [[00_C.11 - Decision Theory (Decsn-CAL)]], or Plain orientation when no FPF-governed use is live. |
| **Publication companion, entry, navigation, or reader help.** The phrase says one publication unit, section, README scenario, ToC query cue, expanded entry-disambiguation case, review packet, companion document, or reader aid helps readers find, inspect, compare, or review another EntityOfConcern. | publication unit or companion-publication kind, entry-distribution locus, reader function, publication or episteme being found, inspected, or reviewed, source-description relation, evidence path, architecture or structure relation, or review relation when that relation is being made; no downstream authority unless separately named. | [[03_E.17 - Multi-View Publication Kit]], [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline]], [[00_I.02 - Expanded Entry Disambiguation Cases]], [[00_C.02.P - Epistemic Precision Restoration]], and the governing pattern if action guidance becomes FPF-governed. |

If no support-like claim kind or admissible-use boundary can be selected from the current claim context, the phrase remains ordinary help, orientation, source-finding, quote-only wording, reduced-use cue, or blocked current transfer. A support-headed name such as `SupportRecord`, `support source`, `support relation`, `support line`, `support basis`, a support phrase that hides a state-family claim, `support view`, or `supported use` is a diagnostic trigger; it is conforming only when rewritten to a locally governed record, field, relation, admissible-use boundary, or, for the [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] case, `DeclaredSubstrateInterpretiveView` under [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]]. When the selected support-like case is base-dependence, the conforming form is [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] SWBD or a Context-local SWBD specialization with explicit `baseRelation(dependent, base)`, not a generic support-headed type. Otherwise, use the selected row above and name the relation named by value, slot, field, source-use relation, evidence path, grounding, or governing pattern ontology for that support-like case.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0r - Relation realization of [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]]

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is the relation-construction realization of the shared wording-use recovery order in [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]].
When [[00_E.10 - Unified Lexical Rules for FPF|E.10]] selects relation-like repair case, endpoint recovery, support-like claim-kind discrimination, basedness, cross-context bridge wording, whole or part wording, mapping, comparison, dependency, service wording, or another RPR repair case, `A.6.P:4.0a` supplies the relation-specific recovery path: head kind, candidate endpoints and facets, relation kind, slots, qualifiers, admissible use, non-admissible overread, and relation record or fail-closed disposition.

This pattern does not become the parent for every wording-use precision-restoration problem. Source-expression, publication, carrier, face, `PublicationUnit`, and source-use wording use [[00_C.02.P - Epistemic Precision Restoration|C.2.P]] when that stack is live. Architecture or structure wording whose selected structure, architecture relation, architecture-description use, structural-view use, or source-use relation is hidden uses [[02_C.30.P - Architecture and Structure Precision Restoration|C.30.P]]. Characteristic, scale, score, metric, indicator, threshold, comparison, or scalar-quality wording whose construction is hidden uses [[01_C.16.P - Characteristic and Scale Precision Restoration|C.16.P]]. Quality or evaluative characterization uses [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]], [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]], [[00_E.21 - FPF Pattern-Quality Evaluation CharacteristicSpace|E.21]], or another characterization pattern governing the claim unless the found problem is relation construction. Function-like wording whose FPF kind named by value, relation, or claim is hidden uses [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]] first.

The old quality-term precision-restoration placement is not retained as a live [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] child after [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] exists. [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] remains applicable for relation-shaped entry cases inside quality prose, such as bridge, basedness, comparison, action-invitation relation, or endpoint mismatch; it does not carry quality characterization or evaluative characterization as a relation by default.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0 - Language-state entry note

RPR entry normally presupposes enough [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]] articulation explicitness that at least one relation-like skeleton can be named explicitly, and often enough [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]] closure that one candidate relation-bearing use is worth publishing as a relation record rather than remaining cue-pack material.

If the content is still best treated as a cue pack, routed cue set, or unresolved candidate-route cue content, keep it in [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]] / [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] rather than forcing relation publication prematurely. If the admissible continuation is still an open explanatory question, apply [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]. If a previously published relation must be reopened or backed off because the articulation or closure record no longer holds, apply [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]] for that retreat rather than silently narrowing the published relation in place.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0a — Operational repair sequence (how repairs actually proceed)
...
1. **Trigger on textual form.** Detect umbrella relation predicates, pronominal/umbrella endpoint tokens or metonymic pointers, and generic-head-plus-FPF-governed-qualifier combinations (including domain clusters such as **service** in [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] and cross-Context “same/equivalent/align/map” in [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]]).
2. **Reconstruct the situation ontology from local context.** Enumerate candidate referents/facets for endpoints *(including [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] lane: EntityOfConcern vs Description episteme vs publication carrier when it matters)*, candidate head kinds where the phrase is noun-led, and candidate `RelationKind` tokens or comparison readings for the overloaded predicate or qualifier, plus implied participants: scope, time, view, scheme, mediator publication form, and carriers. Capture the result as a **Candidate-Set Note** ([[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0b) so review has a checkable record: candidates → selected facet/kind → why. When metonymy is plausible, include both the *literal* and the *intended* candidates.
...
5. **Emit canonical rewrites plus L, A, D, and E hooks.** Produce Tech-form rewrites such as `relationKind(...)` or arrow form and state the [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] hooks: which parts are L, A, D, or E, and which witnesses, commitments, or work claims are now demanded.
...
- consequence: require explicit `meetingRef`, `roleRef`, `Γ_time`, `witnesses` (and apply [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] separately for decision/admissibility)
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0b — Candidate‑Set Note (informative; review record)

When endpoint identity (pronoun/deixis/metonymy/coarse kind) or relation-kind selection is ambiguous, reviews can collapse into “lexicon debates”. [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] treats this as an ontology reconstruction step with an explicit, checkable intermediate record.

**Candidate‑Set Note template (informative).**

> **Collision note.** This “Candidate‑Set Note” is **not** the [[00_F.18 - Local-First Unification Naming Protocol|F.18]] naming-process *candidate set* (NQD-front). It is a local disambiguation record for endpoint referents/facets and RelationKind selection during RPR repairs.
...
* **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] side (when endpoint-side):** `EntityOfConcern` | Description episteme | publication carrier (state explicitly when live contenders span sides; side-mixing is a common source of boundary-interface category errors).
...
* **Consequence:** which SlotSpecs become required or forbidden and which [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] hooks are now triggered (L, A, D, and E).
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.1 — Stable lens
...
* **Kind-labelled qualified relation record** (default [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] lens)
* **n‑ary relation with distinguished positions** ([[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] style)
* **kind‑labelled dependence arrow over a base** ([[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] style)
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.2 — Kind‑explicit relation tokens (no umbrella meaning‑surrogates)
...
The leading **(L)/(A)/(D)/(E)** tags below indicate the intended **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] quadrant classification** for each element of the skeleton.

* **(L) applicability** ([[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]]): the Contexts or planes where the kind is defined (local meaning is first-class).
* **(L) polarity**, and (if needed) explicit **inverse tokens** (no silent role flips in Tech prose).
* **(L) SlotSpecs** for all participant positions (and any qualifier slots exposed by the relation pattern) (`⟨SlotKind, ValueKind, refMode⟩`, where `refMode` is either `ByValue` or a concrete `RefKind` token per [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]]).
...
**Important stack constraint ([[00_A.06 - Signature Stack & Boundary Discipline|A.6]], [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]], and [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]).**
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.3 — Slot‑explicit qualified relation records (recover hidden arity)
...
**Slot naming guard.** `*Slot` suffix names positions (SlotKinds), not fillers; prose SHOULD use filler names (`scope`, `witnesses`, `base`, `dependent`, …) for slot contents. This is the same guard used in [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]].

**Well‑formedness principle.** The record is typed by the relation specification: SlotSpecs are fixed by the selected RelationKind token, and missing slots are permitted only if the relation specification says they are optional. This mirrors [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]]’s scoped/witnessed declaration move (SWBD): “shape + relation specification makes a concrete typed signature”.
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.4 — Change‑class lexicon (operations are not adjectives)
...
**Edition fence rule ([[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]] / [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] alignment).**
...
These change classes are semantic; they may be realised by [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] slot verbs (retarget vs by‑value edit) and, when the relation is a basedness pattern, by [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] base‑change verbs. The semantic story must not collapse into “we edited something”.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.5 — Lexical guardrails (ban umbrella metaphors as meaning‑surrogates)
...
* Pattern-defined carve‑outs MAY exist (reserved primitives elsewhere), but they remain review triggers to ensure the reserved sense is intended (as in [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]]’s `anchor*` carve‑out rule).

**Recommended publication move (no extra authoring apparatus implied).** For stable ambiguity clusters, publish the red‑flag token list and canonical rewrites as a LEX‑BUNDLE entry (PTG=Guarded) and, when the cluster introduces new `RelationKind` tokens or stable facet head phrases, include them in the relevant UTS rows ([[00_F.17 - Unified Term Sheet (UTS)|F.17]]). This keeps rewrite discipline shareable outside the [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] cluster.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.5a - Trigger-word repair split for discoverability vocabulary

The overloaded trigger-word repair case around `discoverability` is not collapsed into one
universal substantive pattern.
[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], and [[00_E.10 - Unified Lexical Rules for FPF|E.10]] govern the repair-side trigger-word, naming, collision, and
...
* description recognition signatures in general -> [[01_A.06.RSIG - Recognition Signatures for Descriptions|A.6.RSIG]];
* pattern-entry discoverability -> [[00_E.11 - First-Practical Entry and Pattern-Use Discoverability Discipline|E.11]];
* Problem-frame recognition signatures -> [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]];
* expanded entry-disambiguation cases -> [[00_I.02 - Expanded Entry Disambiguation Cases|I.2]];
...
[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] therefore repairs the overloaded trigger-word side of the vocabulary.
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.6 — Progressive elaboration (the “precision dial” rule)

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] defines a controlled escalation discipline that preserves meaning and prevents drift:
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.7 — Two-view and polarity discipline (no silent role flips)
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.8 — Disambiguation guide (rewrite/selection)
...
* Candidate sets SHALL be stated as **kinds/facets/RelationKind tokens**, not as synonym lists. “Service” ⇒ {promise content, access point, provider principal, commitment, work+evidence, …} is the archetype ([[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]]).
* When endpoint‑side ambiguity is present, the guide SHOULD recommend producing a **Candidate‑Set Note** ([[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.0b) as part of the rewrite, so the chosen facet/kind is reviewable.
...
* Canonical rewrites SHALL land in the [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] Tech forms (functional/arrow) and SHALL specify any newly required qualifiers (scope, Γ_time, `U.Viewpoint` and `U.View`, schemes, witnesses).
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.9 — [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] classification template for RPR relation specifications

Any RPR‑pattern that claims boundary-bearing relation semantics SHALL classify its normative content using **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]**:
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:4.10 — [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]] compatibility note (ConstructorSignature is optional but canonical for engineered relation specialisations)
...
* a minimal **ConstructorSignature**: effect‑free operations that rewrite under‑specified prose into the explicit form and evolve relation records using the change‑class lexicon (mapped to [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].5/A.6.6 canonical verbs).

If a ConstructorSignature is provided, it SHOULD (conceptually) declare, for each constructor operation entry:

* whether it is a species of **[[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]] / [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] / [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]**, and
* which **`U.EpistemeSlotRelation` slots** ([[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]]) it may read and write (SlotKind/ValueKind/RefKind profile).
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:5 — Archetypal Grounding (System / Episteme)

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] requires Tell–Show–Show grounding in both System and Episteme lanes.

### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:5.1 — System archetype: “same system across environments”
...
### [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:5.2 — Episteme archetype: “the models are synced”
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:6 — Bias‑Annotation

Lenses tested: **Gov**, **Arch**, **Onto/Epist**, **Prag**, **Did**. Scope: **Universal** for RPR‑style precision restoration in the [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] cluster.
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:7 — Conformance Checklist (CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]])

A pattern P conforms to [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] (i.e., is an RPR‑pattern) iff:

 > **Note.** This checklist defines conformance for **RPR specialisations** (e.g., [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]], [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]], [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]], [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]], [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]], and additional admitted A.6.x patterns). [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] itself is the **governing RPR pattern**.

1. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑1 — Lens is explicit.**
   P SHALL name the stable lens used to stabilise the ambiguity cluster and justify its fit.

2. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑2 — RelationKind is explicit and named through admissible mint-or-reuse.**
   Every in‑scope relation claim SHALL name an explicit RelationKind token, and that token SHALL resolve to a vocabulary entry whose relation specification skeleton publishes (at minimum): polarity (and explicit inverses if needed), participant SlotSpecs `⟨SlotKind, ValueKind, refMode⟩`, qualifier requirements, witness expectations for decision/publication lanes, admissible semantic change classes, and (when applicable) cross-Context or cross-plane policy (Bridge + CL + loss notes). Claims classified under [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] SHALL respect [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]].
   When a suitable token does not already exist, authors SHALL mint or document it through **[[00_F.18 - Local-First Unification Naming Protocol|F.18]]** rather than inventing a one-off label by intuition: **MintNew** is the default, the seed candidate set and NQD-front SHALL be shown, and the final token SHALL be selected from that non-dominated front unless an explicit continuity exception is recorded.
...
3. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑3 — Slot‑explicit instances.**
...
4. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑4 — Qualifiers are explicit when required.**
...
5. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑5 — No silent polarity flips.**
...
6. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑6 — Change semantics use a change‑class lexicon.**
   ...
   Any mapping to more specific slot verbs MUST preserve the [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] retarget vs by‑value edit distinction.

7. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑7 — “bind/binding” discipline.**
...
8. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑8 — Lexical firewall is normative.**
...
9. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑9 — [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] atomicity, classification, and explicit references are respected.**
...
10. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑10 — Evidence is carrier‑anchored ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] separation).**
...
11. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑11 — [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]] compatibility when engineered.**
    If the RPR specialisation is presented as engineered/evolving, it SHALL be compatible with [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]]: distinguish TargetSignature vs ConstructorSignature; map constructor verbs to [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].5/A.6.6 canonical verbs; keep constructor ops effect‑free; and (when a ConstructorSignature is present) declare the [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] slot read/write profile and whether ops are [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].2/A.6.3/A.6.4 species.

12. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑12 — Cross-Context or cross-plane reuse is explicit (no “sameness by label”).**
...
13. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑13 — Disambiguation guide is actionable.**
...
14. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑14 — Grounding spans System and Episteme.**
    P SHALL include at least one Tell–Show–Show vignette in a **System** lane and at least one in an **Episteme** lane (per [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]), demonstrating a real ambiguity repair and a relation‑change narration using the change‑class lexicon.

15. **CC‑[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]‑15 — Trigger rule is explicit.**
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:7a - Portfolio, front, archive, and shortlist disambiguation
...
- Use the helper declarations from [[00_A.0 - Onboarding Glossary (NQD & E-E-LOG)|A.0]]:QF.1a when repairing the sentence: do not let `SetResultFamily`, `SourceSetFamily`, `SourceSetComposition`, `SubjectKind`, `DerivedViewKind`, `BasePaletteRef`, `SelectorOutcomeKind`, `HandoffKind`, `PromotionPolicy`, `RetentionIntent=steppingStone`, `EligibilitySet`, `DominanceSet`, `TieBreakerSet`, or `TelemetrySet` read as public set-outcome heads.
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:8 — Common Anti‑Patterns and How to Avoid Them
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:9 — Consequences
...
* **More explicit qualifiers.** Mitigated by keeping the lens stable and reusing slot templates ([[00_A.06 - Signature Stack & Boundary Discipline|A.6]].5/A.6.6).
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:10 — Rationale
...
[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is orthogonal to “add a global taxonomy”:
...
* It operationalises [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]’s boundary discipline by ensuring relation talk can be cleanly separated into signature invariants, admissibility, deontics, and evidence/work ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]), rather than becoming one undifferentiated boundary claim.

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:11 — SoTA‑Echoing (informative; post‑2015 alignment)

[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] echoes contemporary practice across independent traditions, while remaining notation-neutral and Context-local. A row is retained only when it changes the [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] solution, checklist, boundary, worked case, or reopen condition.

| Practice source line | Use of source | Echo | What [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] adopts or adapts | What [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] rejects |
| --- | --- | --- | --- | --- |
| W3C SHACL Recommendation (2017) for shape validation over RDF graph assertions. | Current-standard/reference use for assertion/constraint separation; not a complete current-best answer for FPF relation precision restoration. | Separates graph assertions from constraints over node/value shapes. | Adopts explicit structural constraint thinking for relation records and mutates `CC-[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/00_A.06 - Signature Stack & Boundary Discipline]].P-2`: relation claims need explicit SlotSpecs, qualifiers, witness expectations, and admissible use, not only prose assertions. | Rejects treating validation shape notation as the required FPF notation or as a substitute for relation-kind selection and lexical guardrails. |
...
| Fong and Spivak, "Seven Sketches in Compositionality" (2019), as applied-category-theory lineage for compositional modeling. | Lineage and didactic source use for compositional lens choice; not by itself current-best source use for FPF wording repair. | Shows why stable abstract lenses can be reused across domains. | Adapts compositionality as a reason to keep [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] notation-neutral while requiring relation slots and change lexicon; mutates the rationale and teaching examples. | Rejects adding a global category-theory ontology to FPF relation repair. |

These echoes justify why [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is structured as: **stable lens -> explicit slots -> explicit change classes -> lexical guardrails**, rather than "just define the verb". A source row that does not change [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] fields, examples, checklist rows, boundaries, or reopen conditions is decorative and should be removed or demoted to lineage outside the SoTA echo.

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:12 — Relations

**Specialised by**

* **[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] `U.RelationSlotDiscipline`** — slot precision restoration for n‑ary relations.
* **[[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] `U.BaseDeclarationDiscipline`** — base‑dependence precision restoration (SWBD + base‑change lexicon + `anchor*` red‑flags).
* **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR‑SERV)** — service polysemy unpacking as a relation/facet precision restoration discipline (serviceSituation lens + canonical rewrites + service‑specific tests and change narration).
* **[[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]] (RPR-XCTX)** - U.CrossContextSamenessDisambiguation - Repairing cross-context "same", "equivalent", "align", or "map" via explicit Bridges
* **[[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]] (RPR‑WHOLE)** — wholeness language unpacking (“whole/part/integrity/complete”) into boundary, typed parthood, explicit Γ selection, order/time classification, and [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] completeness/coverage claims.

**Coordinates with**

* **[[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]] `U.SignatureEngineeringPair`** — RPR rewrite operations can be packaged as a ConstructorSignature for engineered relation specialisations; must preserve canonical verb mapping and effect‑free constructor semantics.
* **[[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]] `U.CharacteristicSpace` + [[04_A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW - Declared-Substrate Interpretive View|A.19.DECLARED-SUBSTRATE-INTERPRETIVE-VIEW]]** — for declared characteristic spaces, guarded role references, and interpretive-view and atlas-view discipline when one relation repair needs those layers explicit.
* **[[00_G.02 - SoTA Harvester & Synthesis|G.2]]** — for palette, front, archive, or tradition-atlas specialization when the repaired passage is SoTA-harvest or synthesis prose.
* **[[00_F.18 - Local-First Unification Naming Protocol|F.18]]** — when the remaining issue is naming-side choice among candidate labels rather than relation typing or publication-lane repair.
* **[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], and [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]] + [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** - relation publication enters only after admissible language-state chart positioning, articulation, and closure record exist; earlier cue-pack material stays on the language-state seam, prompt-shaped continuations stay with [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]], retreat/reopen moves remain governed by [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]] is used only when lineage, branch, loss, or handoff history must itself be published.

**Candidate extraction signals (informative; not queued specialisations)**

These recurring relation-repair families are signals for applying the [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] extraction criterion. They do not by themselves create a new A.6.x pattern.
...
## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:12a - Quantum-like relation/probe wording precision note
...
7. Move to [[00_C.26 - Quantum-Like Modeling Lens|C.26]] only when ordinary relation repair still leaves order-sensitive, probe-frame-sensitive, incompatible-probe, no faithful-enough export, or state-representation coarsening claim kind or admissible-use boundary.
...
- an ordinary [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]], [[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)|A.6.9]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], or [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]] governing pattern when the repaired slots reduce to one existing governing claim kind or admissible-use boundary;
- a local explanatory phrase when no reusable relation token is justified;
- an [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair plus [[00_F.18 - Local-First Unification Naming Protocol|F.18]] naming pass when a reusable relation token is actually needed;
- a [[00_C.26 - Quantum-Like Modeling Lens|C.26]] application only for the remaining state, probe, export, frame, or coarsening claim kind or admissible-use boundary.

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:12b - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> **Mathematical-lens use relation.** [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] may select a stable mathematical substrate for relation precision restoration: arity, polarity, endpoint discipline, slot structure, and relation-kind repair. This does not by itself apply [[00_C.29 - Mathematical Lens Use|C.29]]. `C.29 Mathematical Lens Use` applies only when that substrate is used as a FPF-governed mathematical representation of a selected subject, relation, claim, or structure beyond relation repair. [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] does not by itself license source-domain ontology transfer.

## [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:End
