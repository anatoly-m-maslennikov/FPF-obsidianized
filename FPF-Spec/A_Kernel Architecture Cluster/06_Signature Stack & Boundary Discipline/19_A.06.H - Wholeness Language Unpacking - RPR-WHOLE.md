...
**Placement.** [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] precision-restoration cluster; a lexical front-end to mereology and Γ selection.
...
**Works alongside.** [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] (mereology extension), [[01_B.01.01 - Dependency Graph & Proofs|B.1.1]] (edge selection), [[04_B.01.04 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] (Γ_ctx/Γ_time), [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (role–method–work).
**Template discipline.** Canonical section order and headings follow [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]].

## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:1 - Problem frame
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:2 - Problem
...
8. **Description-publication and referent collapse.** “The whole system is documented” or “the whole model is deployed” slides between a system, the description episteme that says something about it, and a publication unit or carrier that presents that episteme. Inclusion edges and completeness claims then get attached to the wrong level ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]: referent holon, description episteme, publication unit, work occurrence, or evidence carrier).
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:3 - Forces
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4 - Solution

This pattern applies the [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair recipe to the **wholeness polysemy cluster** by introducing a stable lens, a trigger list, a facet vocabulary, and an always-unpack rewrite discipline.

### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.0 - [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] crosswalk (what this pattern adds)

This is a wholeness-specific binding of the generic [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair sequence:
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.1 - Lens: Boundary–Parthood–Fold–Order/Time–Completeness
...
4. **Order/time routing.** Is the claim about a procedure graph (**StepOf** + order/concurrency constraints such as **SerialStepOf / ParallelFactorOf**), or about **temporal continuity/coverage** (**PhaseOf** aggregated via Γ_time), rather than structural containment? If the claim is about *observed* concurrency in a specific run, route it to work/evidence ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]) rather than treating it as ParallelFactorOf.
5. **Completeness.** Is “whole/complete/end-to-end” actually about **completeness in a scope**: capability coverage, specification coverage, and/or evidence coverage ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] layer), rather than “has all parts”?
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.2 - Trigger words and phrases
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.3 - Canonical facet headphrases
...
* “In run r, Step u ExecutedConcurrentlyWith Step v” for observed concurrency in a specific work/evidence instance ([[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]); do not infer this from ParallelFactorOf alone
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.4 - Optional bundling record: wholenessSituation
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.5 - Always-unpack rule for normative surfaces
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.6 - Disambiguation guide
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.7 - Change lexicon for wholeness narratives
...
### [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:4.8 - Guardrails
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:5 - Archetypal Grounding
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:6 - Bias-Annotation
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:7 - Conformance Checklist
...
| **Completeness-by-rhetoric** | “Method is complete” without stating what it covers                    | Confuses structural wholeness with capability/spec/evidence coverage | Rewrite using [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]]: MethodDescription vs Method vs Work, plus explicit coverage                   |
...
| **Description-publication and referent drift**   | “The whole X” alternates between a system, its description episteme, and a spec/model/document publication   | Breaks auditability; smuggles relations across [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] levels            | State the reference level explicitly; use ConstituentOf for publication-unit parts; keep model-of separate |

## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:9 - Consequences
...
| **Cleaner role and method discourse.** “Turnkey” becomes a coverage statement tied to [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] rather than a vague wholeness claim.         | **Learning curve.** Mitigate with the System/Episteme examples and consistent headphrases.                                                    |

Quotable closer: **If “whole” matters, say what makes it one.**

## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:10 - Rationale
...
| --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Systems and software architecture description | Architecture descriptions distinguish the entity-of-interest from its description and structure the discussion around concerns/viewpoints, including boundary and environment notions. | ISO/IEC/IEEE 42010:2022 ([ISO][1])               | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]] adopts the same “make the viewpoint explicit” stance, but operationalizes it at the lexical level: “whole” requires a boundary/environment clause rather than a rhetorical claim.               | **Adopt/Adapt.** Adopt viewpoint discipline; adapt by using trigger-word linting as an authoring aid.                 |
| Formal ontology and upper-ontology standards       | Upper-ontology standards require explicit definitions of relations and discourage conflating distinct relation types under one label.                                              | ISO/IEC 21838-2:2021 ([ISO][2])                  | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]] aligns by forcing “part-of” to resolve into a typed relation family, and by separating continuants (structure) from occurrent-like narratives (order/time).                                     | **Adopt.** Adopt explicit relation typing; keep the facet set minimal to preserve usability.                          |
| Enterprise architecture modeling languages    | Modeling standards distinguish structural relations such as composition vs aggregation, but many organizations still overload them informally.                                         | ArchiMate 3.2 Specification ([opengroup.org][3]) | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]] adapts the idea of “different structural relations,” but extends it with Portion/Phase and with a strict routing of order/time outside structure, which is often underspecified in EA practice. | **Adapt.** Adopt the “don’t overload one relation” instinct; adapt by adding explicit order/time and coverage facets. |
| Sociotechnical team boundary practice         | Organizational design methods treat team boundaries and cognitive load as first-class, because “a team as a whole” depends on coordination interfaces and role clarity.                | Team Topologies ([teamtopologies.com][4])        | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]] uses this as support for separating “collective membership” from “structural assembly” and for treating “ownership of the whole” as a boundary-and-responsibility claim, not a part claim.      | **Adopt/Adapt.** Adopt boundary salience; adapt by binding it to explicit wholeness facets and typed relations.       |
| Requirements engineering and specification quality | Requirements standards emphasize unambiguous, verifiable statements and explicit identification of the item being specified vs its documentation (referent vs description).        | ISO/IEC/IEEE 29148:2018                          | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]] operationalizes this at the lexical level by defining load-bearing surfaces and requiring rewrites into typed relations instead of overloaded “whole/part” prose.                               | **Adopt/Adapt.** Adopt verifiability discipline; adapt via WHOL triggers + Candidate-Set Notes.                       |
| Security engineering vocabulary               | “Integrity” is treated as a security property (unauthorized modification) and as constraint satisfaction, requiring explicit threat/assumption models.                                | NIST SP 800-53 Rev.5 (2020) ([NIST][5])          | [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE]]’s integrity classification step prevents misrouting security/data integrity into wholeness/mereology and supports correct remediation.                                                         | **Adopt.** Treat integrity as quality unless explicitly wholeness/coherence.                                          |
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:12 - Relations

* **Specialises:** [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] Relational Precision Restoration (RPR).
* **Front-ends:** [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases|A.14]] Advanced Mereology; [[01_B.01.01 - Dependency Graph & Proofs|B.1.1]] edge selection guide — by turning prose triggers into typed edge choices.
* **Coordinates with:** [[04_B.01.04 - Contextual & Temporal Aggregation (Γ-ctx & Γ-time)|B.1.4]] Γ_ctx/Γ_time — to route order/time away from structure; [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role–Method–Work Alignment — for “completeness/end-to-end” coverage language (capability/spec/evidence).
* **Informs examples:** [[00_F.18 - Local-First Unification Naming Protocol|F.18]] vocabulary pitfalls (module/component, batch/lot) as recurring wholeness-word traps.
...
## [[19_A.06.H - Wholeness Language Unpacking - RPR-WHOLE|A.6.H]]:End
