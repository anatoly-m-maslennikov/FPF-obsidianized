...
builds_on:
  - "[[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]]"
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:1 - Problem frame
...
5. representation factors governed near [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]] are discussed rhetorically rather than as explicit deltas.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:3 - Forces
...
- **Governing-pattern restraint.** This pattern must stay under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], not swallow explanation governance, retargeting, bridge work, or carrier work.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4 - Solution — entityOfConcernRef-preserving representation-scheme transition under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]

### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1 - Informal definition
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1.a - Pattern, case, and published rendering distinction

`RepresentationSchemeTransition` is a **pattern description** and a named specialization under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]. Concrete entityOfConcernRef-preserving representation changes are passive episteme cases or published renderings reviewed under this pattern; the pattern itself does not act, decide, or publish.
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.1.b - Local working vocabulary
...
**Recoverability-for-use rule.** If the declared admissible use is inspection, source-finding, comparison, or technical review, `RepresentationSchemeTransition` can close with entityOfConcernRef-preserving preservation, source-relation chain, representation-scheme delta, and loss or recoverability notes. If the declared admissible use is work-planning preparation, this pattern is admissible only for reversible preparation until [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] supplies the role, method, plan, and work source relation. If the declared admissible use is evidence or currentness, gate or release, assurance, commitment, bridge or substitution, or engineering justification, the case must name the downstream governing source relation; otherwise the receiving representation remains orientation or review use only.
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.2 - Scope and exclusions
...
**Out of scope**
- any change of `entityOfConcernRef` or hidden change of EntityOfConcern ([[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]);
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.2.a - User guidance
...
- If same-EntityOfConcern continuity fails, apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.3 - Working-model first; explicit decision block only when the case is claim-bearing

Most entityOfConcernRef-preserving representation shifts stay human-usable and reviewable without turning every table, diagram, or structured rendering into a giant metadata block. This pattern therefore follows **[[00_E.14 - Human-Centric Working-Model|E.14]]'s working-model-first discipline**: ordinary non-latent cases need enough explicitness to show what stayed the same, what changed in representation and reasoning medium, what was lost or foregrounded, and when another governing pattern governs the case.
...
| `preservedEntityOfConcernRef` | The one [[01_C.02.01 - U.Episteme - Epistemes and their slot relation]] `entityOfConcernRef` preserved across the representation shift. |
| `receivingRepresentationOrRendering` | The receiving representation, diagram, table, functional description, decoded rendering, or publication rendering over that same `entityOfConcernRef`; if `entityOfConcernRef` changes, apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]]. |
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.3.a - Working admissibility defaults
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4 - Direct and correspondence-mediated profiles
...
- the result remains under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] only if same-entity conservativity is still reviewable by continuity witness and the correspondence does not silently import extra claims.
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4.a - Recurring same-entity representation moves
...
These are recurring move shapes under one specialization relation. They are not separate governing patterns and they do not override [[03_E.17 - Multi-View Publication Kit|E.17]] face discipline.

### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.4.b - How the user states representation-factor and reasoning-medium change
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5 - Shared representation rule bundle

#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.a. Preservation rule
...
#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.a.1. Local conservativity witness
...
#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.b. Loss and reliability rule
...
#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.c. Governing-pattern boundary rule
...
#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.c.1. Decode-mediated entry condition
...
#### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.5.d. Composition and reopen rule
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:4.6 - Boundary trigger table
...
| --- | --- |
| `entityOfConcernRef`, EntityOfConcern kind, ontology frame, admissible predicate set, or invariant-bearing receiving rendering changes | Apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] or the ontology-facing governing pattern. |
| The receiving rendering is only a textual rewrite | Apply `ConservativeRetextualization`. |
| The primary job is teaching, narration, or explanation-facing rendering | Apply `ExplanationFaithfulnessProfile` unless EntityOfConcern or ontology-frame change makes [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] primary. |
| The work is rendering, export, upload, serialization, OCR-style extraction, parsing-style extraction, or other carrier work | Keep carrier work outside RT; start with the pattern governing carrier or extraction use, such as [[00_A.07 - Strict Distinction (Clarity Lattice)]] when source extraction is the current question. |
...
| Problem formulation, temporal claim, dynamics claim, control claim, or transformation-flow claim becomes primary | Apply [[00_B.05.02 - Abductive Loop]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme]], [[00_E.18 - Transformation Flow Structure]], or the governing pattern for that claim. |
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5 - Archetypal grounding

### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.1 - Same-entity text-to-table shift
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2 - Same-entity table-to-diagram shift
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.a - Correspondence-mediated text-to-table shift
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.b - Same-entity diagram-to-structured-notation shift
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.2.c - Functional-description diagram, table, or screen shift
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4 - Boundary to explanation-facing renderings
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.a - Boundary to bridge-bearing comparison
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.b - Boundary to carrier work and export work
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:5.4.c - Boundary to coarsened dashboard view
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:6 - Bias-Annotation
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7 - Conformance Checklist
...
### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7.1 - RT-Core ordinary checks
...
4. **CC-RT-8 — Preserve-vs-retarget governing pattern is explicit.**
   If the case fails the ordinary checks, the governing pattern for the changed claim is named explicitly ([[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], carrier work under [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], or another governing pattern).
5. **CC-RT-14 — Functional-description publication overread is blocked.**
   Functional diagrams, tables, screens, exports, parser results, and OCR results are kept separate from performed `U.Work`, gate passage, evidence, engineering justification, supervisory architecture, control architecture, and carrier work. OCR-style extraction and parsing-style extraction start with [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]; same-entity representation work stays here only when source-relation chain, same EntityOfConcern, representation-scheme change, and loss notes remain visible.

### [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:7.2 - RT-Conditional checks
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Hiding retargeting under representation language | a changed EntityOfConcern is mislabeled as same-entity representation work | apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] whenever `EntityOfConcernRef` changes |
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:9 - Consequences
...
- The pattern remains safely bounded by [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], explanation governance, and carrier work.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:10 - Rationale

This pattern is worth splitting out because representation changes are already happening in practice and they are not well served by treating every such case as either mere rewriting or full retargeting. Keeping the family under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] preserves governing-pattern boundary while making representation-factor and recoverability evidence needs explicit.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:11 - SoTA Alignment: Adopted Invariants, Adapted Invariants, and Rejected Shortcuts
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12 - Relations

- **Builds on:** [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]]
- **Coordinates with:** `ConservativeRetextualization`, `A.6.3.CSC Controlled Semantic Coarsening`, `ExplanationFaithfulnessProfile`, `E.17.ID.CR ComparativeReviewUnit`, [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[00_E.18 - Transformation Flow Structure|E.18]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_B.05.02 - Abductive Loop|B.5.2]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_C.27 - Temporal Claim Adequacy- State Readings, Temporal Trends, and Intervention-Sensitive Temporal Change|C.27]], [[03_A.03.03 - U.Dynamics- State-Space and Transition-Law Episteme|A.3.3]], explicit decoding-access review
- **Impact radius:** primary touch [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]; selected edit companion [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; secondary review relation [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], decode-mediated recoverability review, transformation-flow interpretation under [[00_E.18 - Transformation Flow Structure|E.18]], and project-side governing patterns for claims not governed by this pattern
- **Boundary notes:** textual same-regime rewrites stay with `ConservativeRetextualization`; explanation-facing renderings stay with `ExplanationFaithfulnessProfile`; bounded comparative review cases apply `E.17.ID.CR ComparativeReviewUnit`; EntityOfConcern changes apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; coarsened source renderings apply [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]; bridge, work, evidence, assurance, gate, abductive, temporal, dynamics, and transformation-flow consequences remain bounded by explicit evidence and by the downstream governing pattern for the claim being made.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12a - Boundary with quantum-like state-representation shortcuts
...
1. Confirm that the EntityOfConcern stays the same. If it changes, RT no longer governs; apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
8. If yes, coordinate with the [[00_C.26 - Quantum-Like Modeling Lens|C.26]] state-representation coarsening admissibility section and state admissible use, non-admissible use, and return condition.
...
## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:12b - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When an entityOfConcernRef-preserving representation-scheme transition imports a contested or claim-bearing mathematical lens, [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]] still governs the source and receiving representation schemes, entityOfConcernRef-preserving relation, preserved and lost scheme features, and representation-scheme-transition boundary. The applicable [[00_C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) may be cited only for adequacy of the mathematical lens used in that transition. It does not replace the representation-scheme-transition record or broaden the transition into bridge, evidence, or causal-claim-kind.

## [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]:End
