...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:1 - Problem frame
...
**Not this pattern when.** Not this pattern when the case is primarily explanatory rendering (`ExplanationFaithfulnessProfile`), representation-scheme change (`Representation-Scheme Transition`), changed EntityOfConcern ([[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]), comparative review ([[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]), bridge or substitution use ([[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]]), or a deliberately coarsened rendering whose narrower admissible use, non-admissible downstream use, and source-bearing return card has become primary. In that last case, use `A.6.3.CSC Controlled Semantic Coarsening`.

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:2 - Problem
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:3 - Forces
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4 - Solution — entityOfConcernRef-preserving textual re-expression under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]

### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.1 - Informal definition
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.1.a - Pattern, case, and publication distinction

`ConservativeRetextualization` is a **pattern description** and a named specialization under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]. Concrete entityOfConcernRef-preserving rewrites are passive episteme cases or publication texts reviewed under this pattern; the pattern itself does not act, decide, or publish.
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.1.b - Local working vocabulary
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.2 - Scope and exclusions
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.2.a - Reader guidance
...
- If the EntityOfConcern changes, apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].

### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.2.b - What the user checks first
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.3 - Working-model first; explicit review record only when the case is claim-bearing

Most entityOfConcernRef-preserving textual rewrites should stay human-usable. This pattern therefore follows **[[00_E.14 - Human-Centric Working-Model|E.14]]’s working-model-first discipline**: ordinary report, summary, or translation cases do not need a giant inline metadata block. What they do need is enough explicitness that the user can still tell what stayed the same, what was omitted, and when another governing pattern governs the case.
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.3.a - Ordinary admissibility defaults
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.4 - Direct and correspondence-mediated profiles
...
- the result remains under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] only if the correspondence witnesses entityOfConcernRef-preserving conservativity and no new claims are imported beyond the declared witness set.
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.4.a - Recurring same-entity textual moves
...
These are recurring move shapes, not separate governing patterns. The specialization relation remains the same: entityOfConcernRef-preserving textual re-expression under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]].

### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5 - Shared conservative retextualization rule bundle

#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.a. Preservation rule
...
#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.b. Loss and reliability rule
...
#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.c. Authority and governing-pattern boundary rule
...
#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.d. Composition and reopen rule
...
#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.e. Non-collapse note for correspondence
...
#### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:4.5.f. Local conservativity witness for borderline textual cases
...
This witness is local to `ConservativeRetextualization`. It does not replace the broader conservativity invariants of [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]; it makes them inspectable for textual rewrites where fluent prose can otherwise hide strengthening.

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5 - Archetypal Grounding

### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.1 - Same-EntityOfConcern report rewrite
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.1.a - Ordinary inherited-pin summary
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.1.b - Benign omission that stays ordinary
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.1.c - Functional-description textual summary
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.1.d - Generated-summary source-relation variant
...
If the generated summary is source-pointer-only, merely plausible, claim-widened, or carrying added linkage, do not treat it as a conservative source-equivalent summary. Either keep it as source-finding or orientation, repair it against the source, or apply [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]], ExplanationFaithfulnessProfile, Representation-Scheme Transition, [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], or another governing pattern according to the claim being made.

### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.2 - Same-EntityOfConcern rewrite via declared correspondence
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.2.b - Cross-language re-expression without hidden bridge work
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.2.c - Boundary to controlled coarsening
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.3 - Boundary to explanation-facing renderings
...
### [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:5.4 - Boundary to representation-scheme transition
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:6 - Bias-Annotation

Lenses tested: **Arch**, **Onto**, **Epist**, **Prag**, **Did**.
This pattern intentionally biases toward same-entity conservativity and away from explanation or retargeting inflation. The main mitigation is to apply `ExplanationFaithfulnessProfile`, `Representation-Scheme Transition`, [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], or the downstream governing pattern when the same-entity textual interpretation stops being honest.

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:7 - Conformance Checklist
...
7. **CC-CR-7 — Governing pattern is explicit on failure.**
   If the case fails any of the checks above, the governing pattern for the changed claim is named explicitly (ExplanationFaithfulnessProfile, Representation-Scheme Transition, [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_B.05.02 - Abductive Loop|B.5.2]], or another governing pattern).
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Letting `entityOfConcernRef` shift by topic similarity | same topic is not the same EntityOfConcern | apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] if `EntityOfConcernRef` changes |

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:9 - Consequences
...
- The pattern remains safely bounded by [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], explanation-facing work, and representation-shift work.

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:10 - Rationale

This pattern is worth splitting out because same-entity textual re-expression is common, useful, and safer than many neighboring transform families when it stays explicitly conservative. Keeping it under [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] as a named specialization preserves governing-pattern boundary while making a recurring authoring move easier to review, while still respecting [[00_E.14 - Human-Centric Working-Model|E.14]]’s working-model-first discipline for ordinary cases.

## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:11 - SoTA Alignment: Adopted Invariants, Adapted Invariants, and Rejected Shortcuts
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:12 - Relations

- **Builds on:** [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes|A.6.2]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]], [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]]
- **Coordinates with:** `ExplanationFaithfulnessProfile`, `Representation-Scheme Transition`, `E.17.ID.CR ComparativeReviewUnit`, [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_B.05.02 - Abductive Loop|B.5.2]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]
- **Impact radius:** primary touch [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]]; secondary review relation [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]], [[03_E.17 - Multi-View Publication Kit|E.17]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]]; failed conservativity cases apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_B.05.02 - Abductive Loop|B.5.2]], or [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]
...
## [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]:End
