...
**Builds on.** [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]], [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_E.19 - Pattern Quality Gates- Review and Refresh Profiles|E.19]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]].

**Coordinates with.** [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], and [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].

## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:1 - Problem frame

**EntityOfConcern preservation discipline.** Controlled coarsening stays under entityOfConcernRef-preserving viewing only when the [[01_C.02.01 - U.Episteme - Epistemes and their slot relation|C.2.1]] `entityOfConcernRef` remains stable. When the source-bearing side is a declared source set, its membership, loss account, and reopen condition must also be bounded; that source-set discipline does not substitute for same-EntityOfConcern preservation. Any `entityOfConcernRef` shift leaves this pattern for [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].
...
**Neighboring project records and governing patterns.** Ordinary same-entity wording belongs under [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]]; representation-scheme change belongs under [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]]; explanation-facing class discipline belongs under [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]]; bounded comparison belongs under [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]; bridge or substitution use belongs under [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]]; changed EntityOfConcern belongs under [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]]; work authority requires [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]-governed selected method, `U.WorkPlan`, performed `U.Work`, work-result record, or result-measurement record; gate or adjudication authority requires [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]-governed project records.
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:2 - Problem
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:3 - Forces
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4 - Solution
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.1 - Ordinary mini-card
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.2 - First check
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.3 - Ordinary vs claim-bearing
...
- `sourceBearingSideRef` and `coarsenedRenderingRef` when the source-bearing side, coarsened rendering, `PublicationUnit`, publication face, [[03_E.17 - Multi-View Publication Kit|E.17]] publication-face kind value `publication face/form`, [[03_E.17 - Multi-View Publication Kit|E.17]] publication-face kind value `interop publication form`, or carrier could be confused;
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.4 - Branch and admissible-use discipline
...
Exceptional interop-facing simplification is not ordinary coarsening. It is admissible here only when it stays source-tethered and names the operative relation kind, such as bounded contrast, broader or narrower, partial overlap, proxy, lossy normalization, or context-bounded match. If the coarsened rendering makes bounded contrast across contexts or source epistemes or source publications is the primary question, use [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]]. If it implies equivalence, substitution, projection, or bridge or substitution use, use [[00_F.09 - Alignment & Bridge across Contexts|F.9]] or [[01_F.09.01 - Bridge Stance Overlay|F.9.1]].

### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.5 - Source-loss mode, recoverability, and anti-overread
...
Aggregation or quotient-like coarsening remains inside this pattern only while the coarsened rendering keeps one bounded selected set, slice, case bundle, or alternative bundle explicit as the EntityOfConcern or selected set. If several entities, alternatives, or slices become one new class-level EntityOfConcern or proxy EntityOfConcern, apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]].

### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.6 - Neighbor exits

| If the primary question is now... | Use this governing FPF pattern or `authoritySourceRef` destination |
| --- | --- |
| Same-entity textual rewording without a separate narrower-use card | [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression]] |
| Representation scheme or reasoning-medium shift | [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]] |
| Explanation-facing class over existing source `U.Episteme` or `U.EpistemePublication` | [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces]] |
| Bounded comparison over already pinned source epistemes or source publications | [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units]] |
| Equivalence, substitution, interop row, or bridge or substitution use | [[00_F.09 - Alignment & Bridge across Contexts]] |
| Stance over an already published bridge card | [[01_F.09.01 - Bridge Stance Overlay]] |
| Changed EntityOfConcern or proxy EntityOfConcern | [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] |
| Carrier, export, OCR or parsing, or front-end behavior is primary | [[00_A.07 - Strict Distinction (Clarity Lattice)]] first; then [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition]], [[01_A.06.03.CSC - Controlled Semantic Coarsening]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]], or interpretation sources only if meaning-bearing structure, loss, retargeting, or interpretive lift is live |
| Briefing treated as work plan, work authority, or execution cue | [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] |
| Gate, approval, assurance, or adjudication authority | [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]] or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] |
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:4.7 - Well-formedness constraints
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:5 - Archetypal Grounding
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:5.1 - Worked slices
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7 - Conformance Checklist
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7.1 - CSC-Core
...
### [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:7.2 - CSC-Conditional
...
| **CC-CSC-13 (Source, rendering, and publication separation).** | Claim-bearing cases SHALL separate source-bearing side, coarsened rendering, `PublicationUnit`, publication face, [[03_E.17 - Multi-View Publication Kit]] publication-face kind value `publication face/form`, [[03_E.17 - Multi-View Publication Kit]] publication-face kind value `interop publication form`, and carrier when those could be confused. | Keeps `PublicationUnit`, publication face, and carrier roles distinct. |
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Stance cure | `projection` or `nonEquivalent` is used instead of a bridge card or source return. | Apply [[00_F.09 - Alignment & Bridge across Contexts]] or [[01_F.09.01 - Bridge Stance Overlay]] for the bridge claim. |
| Briefing-as-work | A summary becomes work plan, action cue, gate, or approval. | Use [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] for the work, constraint, or gate claim. |
...
| Aggregation EntityOfConcern shift | A quotient or bundle turns several entities or alternatives into one new proxy EntityOfConcern. | Apply [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism]] rather than treating EntityOfConcern shift as a same-lineage source-to-rendering case. |

## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:9 - Consequences
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:10 - Rationale
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:11 - SoTA Alignment: Adopted Or Adapted Invariants And Rejected Shortcuts
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:12 - Relations

- **Specializes:** `A.6.3 U.EpistemicViewing` for declared source-loss mode in a same-lineage source-to-rendering relation.
- **Coordinates with:** [[02_A.06.03.CR - ConservativeRetextualization- EntityOfConcern-Preserving Textual Re-Expression|A.6.3.CR]], [[03_A.06.03.RT - Representation-Scheme Transition- EntityOfConcern-Preserving Representation-Scheme Transition|A.6.3.RT]], [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]], [[00_E.17.ID.CR - ComparativeReviewUnit - bounded comparison over comparative review units|E.17.ID.CR]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[08_A.06.04 - U.EpistemicRetargeting - EntityOfConcern retargeting morphism|A.6.4]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], and [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]].
...
## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:12a - Boundary with quantum-like state-representation coarsening
...
8. If yes, coordinate with the [[00_C.26 - Quantum-Like Modeling Lens|C.26]] state-representation coarsening admissibility section while leaving CSC as the controlled-use boundary for the coarsened version.
...
Use a fuller CSC and [[00_C.26 - Quantum-Like Modeling Lens|C.26]] coarsening boundary record only when the coarsened state representation will be reused, formalized, empirically compared, used in a high-stakes decision, or tied to a comparative performance claim:
...
- a fuller [[00_C.26 - Quantum-Like Modeling Lens|C.26]] coarsening admissibility record only when a QL cue remains and the claim is reusable, formal, empirical, high-stakes, or comparative-performance-bearing;
- no QL wording when the case is only summary, anonymization, diagramming, audience adaptation, or ordinary coarsening.

## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:12b - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> When controlled semantic coarsening depends on mathematical abstraction, quotienting, coarse-graining, or a learned coarse representation, [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]] still governs the source-bearing return condition, narrowed admissible use, non-admissible downstream claim, and coarsened rendering. The applicable [[00_C.29 - Mathematical Lens Use|C.29]] output for the stated use (`MathLensUse.LensCandidateNote`, `MathLensUse.OneLine`, `MathLensUse.MiniCard`, or `MathLensUse.FullCard` when required) may be cited only for adequacy of the mathematical abstraction or coarse-graining lens. It does not make the coarsened rendering a bridge, replacement source, evidence record, or causal-use admissibility.

## [[01_A.06.03.CSC - Controlled Semantic Coarsening|A.6.3.CSC]]:End
