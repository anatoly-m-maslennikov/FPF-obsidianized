...
> **Status:** Stable
> **Normativity:** Mixed (normative only where explicitly marked; claim-classification semantics live normatively in [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]])
> **Placement:** Part A → [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].\* (cluster overview; coordinates [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] / [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] / [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] / [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] / [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] / [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] / [[15_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]])
> **Builds on:** [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]] (authoring template), [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] (Boundary Norm Square — quadrant semantics & link discipline), [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] (U.Signature), [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] (U.Mechanism), [[00_A.06.03 - U.EpistemicViewing - EntityOfConcern-preserving morphism|A.6.3]] (U.EpistemicViewing — views as episteme-lane projections under viewpoints), [[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]] (U.MultiViewDescribing), [[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK — fixed face kinds & “no new semantics” publication), [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] (EntityOfConcern and Description-episteme boundary; specification use and publication-carrier distinction), [[00_F.18 - Local-First Unification Naming Protocol|F.18]] (promise, utterance, and commitment), [[04_E.10.D2 - EntityOfConcern, Description Episteme, and Specification-Use Discipline|E.10.D2]] (EntityOfConcern and Description-episteme boundary; specification use/refinement discipline), [[00_E.10 - Unified Lexical Rules for FPF|E.10]] publication face, form, unit, and carrier discipline
> **Purpose (one line):** Keep boundary claims evolvable by classifying each statement under the right layer of the Signature Stack and the right quadrant of the Boundary Norm Square ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]).
>
> **Mint/reuse (terminology):** Mints “Signature Stack”, “Boundary Discipline Matrix”, and “Claim Register” as local authoring aids; reuses existing FPF meanings of `U.View`/`U.Viewpoint` ([[03_E.17 - Multi-View Publication Kit|E.17]].0/A.6.3) and uses publication face/form or interop publication form terms for publication lanes. The labels **L/A/D/E** used below are *claim-classification labels for statements*, not MVPK face kinds and not pattern IDs.
>
**Canonical companion.** The square itself (quadrant definitions, form constraints, and cross‑quadrant dependency discipline) is specified normatively in **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] — Boundary Norm Square**. This overview only (i) maps quadrants onto the Signature Stack, and (ii) explains how MVPK faces project the canonical L/A/D/E-classified claim set. If anything in this overview conflicts with [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] is authoritative**.
...
**Boundary-claim activation discipline.** Use only as much claim-classification structure as the live work claim or reliance claim requires. Split a statement only where one sentence carries more than one claim kind, `governingPatternRef` or `authoritySourceRef`, or work or reliance consequence, or where evidence, gate, duty, assurance, work occurrence, P2W class, admissible work, or admissible reliance would otherwise remain ambiguous. For a local first-pass repair, an equivalent L/A/D/E-classified claim set may be a two-to-four-row scratch table. Use a persistent Claim Register when the claim set is reused, published, audited, release-bearing, cross-context, or relied on by [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]], [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]], or [[01_A.15.01 - U.Work|A.15.1]]. Do not atomize ordinary modifiers when one `governingPatternRef` or `authoritySourceRef` and one work or reliance consequence are already clear.

**Typical neighboring governing patterns and authority-reference repairs.** [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] for the quadrant semantics, [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] for contract unpacking, [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]], or [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] for lexical repair, and [[03_E.17 - Multi-View Publication Kit|E.17]] faces for audience-specific publication of the same decomposed claim set.

**Common neighboring-pattern mistakes.** If the real object is still cue preservation or an early candidate-route cue, use [[00_A.16 - Language-State Move Coordination|A.16]] or [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]]; if a qualified relation, quality term, or action invitation is itself being repaired, apply [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]], or [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]; if agent duties are being mixed into one contract sentence, split them through [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] rather than minting one more contract-soup paragraph.

**Causal/deontic split.** A mixed boundary sentence such as "deploy because it would reduce harm" is not settled by one hidden pattern. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] carries the causal-use question, `CausalityLadderRung`, estimand, support basis, support verdict, and supported causal use and unsupported causal use. [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] classifies deontic duties, boundary admissibility gates, and work-effects as atomic `L/A/D/E` claims. [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] unpacks contract, promise, commitment, utterance, and boundary-publication language when the sentence is agreement-like or release-facing. A causal support record does not by itself create a duty, commitment, promise, release gate, or boundary admissibility predicate.

**Authority wording split (subordinate boundary-claim stress case).** When a boundary, policy, API, schema, connector, or compliance statement uses "approved", "allowed", "authorized", "guaranteed", "certified", "recommended", or equivalent wording, do not decide by the word. The object under repair is still the L/A/D/E-classified boundary claim set: split the statement into [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] `L-*` definition or invariant claims, `A-*` admissibility or gate claims, `D-*` commitment claims, and `E-*` evidence or work-effect claims before treating it as action guidance. When "guaranteed", "promise", "contract", "SLA", "SLO", or certified-under-agreement wording is agreement-like, service-facing, promise-bearing, or release-facing, unpack promise content, utterance package, deontic commitment, and work or evidence substrate through [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]], [[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]], and [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] before using the L/A/D/E-classified claims. When "recommended" wording is cue preservation, advice, or action invitation, apply [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], or [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] according to the kind under repair; when it is an admissibility criterion, use the `A-*` claim and any live [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate decision; when it is evidence-supported advice, use the `E-*` claim plus [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; only recommendation-as-duty uses a `D-*` claim and [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]. If the encountered item is a dashboard or status display rather than boundary prose, do not turn color, label, or visible status into an `A-*` admissibility claim; return through [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], and, when a gate decision is live, [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]. If the split result will guide work, release, permission, role or status reliance, evidence reliance, or assurance, return through [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] to the governing FPF pattern and project-side FPF kind and reference named by value that carry the claim being made or effect.
...
**Credential-currentness boundary.** A displayed credential can support only issuer, holder, verifier, status, and currentness claims after an [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path verifies it for the relying context. Boundary permission, admissibility, authorization, deontic commitment, role or status effect, or gate passage still needs the exact [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]], [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]], [[01_A.02.01 - U.RoleAssignment- Contextual Role Assignment|A.2.1]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] source.

**Register-backed status boundary.** A pass, badge, dashboard cell, API response, certificate view, or other status-looking item may be only a publication of a governing register entry or status-source entry. If that register entry is the source that creates or changes permission, role or status, duty, or gate state in the bounded context, cite that register entry or status-source named by value entry and split the created claims through [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[01_A.02.01 - U.RoleAssignment- Contextual Role Assignment|A.2.1]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]], [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]. If the item is only an extract, cache, screenshot, certificate view, or convenience display, keep it as source-finding or currentness support under [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] until the exact source is recoverable.
...
**Lint trigger.** In boundary, API, schema, or policy text, `approved`, `authorized`, `allowed`, `guaranteed`, `certified`, or `recommended` should trigger the [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] split: identify the `L-*`, `A-*`, `D-*`, and `E-*` claims, then cite the exact source before work use, reliance use, evidence use, gate use, commitment use, or assurance use.
...
**Statement identifiers (recommended):** Adopt the quadrant‑prefixed ID scheme from **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:0** for routable statements:
...
IDs are intended to be “lintable” anchors (and are especially useful when D‑duties enforce A‑gates or E‑claims). Consider pairing IDs with a lightweight Claim Register ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7) to reduce paraphrase drift across faces.
...
**Admissibility-predicate distinction (informative):** An `A-*` claim is a mechanism admissibility predicate or entry condition inside the L/A/D/E-classified boundary claim set. It is not an [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `GateDecision`, `DecisionLogRef`, or proof that a gate passed. An `A-*` claim may name a condition that a later [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate evaluates; actual gate passage needs the [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] source. An [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] `ConstraintValidity` witness remains separate from both the predicate and the gate decision.

**Claim Register (informative, recommended).** Use the Claim Register mini‑record in **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:7**. In this cluster the register is additionally used to record stack placement (Signature/Mechanism/Norms/Evidence) and the MVPK faces that cite each claim (`viewRef`/`viewpointRef`), so “no paraphrase drift” can be audited mechanically.

## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:1 - Problem frame
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:3 - Forces
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4 - Solution — A stack + a routing matrix

### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.1 - Why “stack”: what is stacked, and what “higher/lower” means
...
2. **Mechanism layer (A: admissibility/gates).** `U.Mechanism` specializes the signature and adds **AdmissibilityConditions** (the entry gate) plus operational blocks (e.g., Transport, Audit/Observability). These blocks specify runtime gates and observability *interfaces*; they are still **descriptions**. The evidence itself exists only as carriers produced in work.
   ...
   *Audit vs AssuranceLane (avoid duplication):* the Mechanism’s **Audit/Observability** block defines the required semantics of an observability/evidence interface (carrier classes and required fields, correlation keys, exposure interface). **Retention/access/enforcement are D‑claims** (agent duties) that reference the same carrier classes by ID. An MVPK **AssuranceLane** is a projection for auditors that explains how to read/check the evidence interface. This is a special case of CC‑[[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]]: the lane references the Mechanism section and the relevant claim IDs rather than restating semantics.
...
5. **Work & realizations (outside the description stack).** Realizations (substitutable implementations) are exercised by doing work; actual executions produce state changes, traces, and measurements. Effects exist only in work. [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] already frames realizations as substitutable behind signatures and warns against smuggling bridge mechanics into the signature layer.
...
#### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.1.1 - AssuranceLane skeleton (informative)
...
- **Carrier inventory:** carrier class/schema refs ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] Carrier) + where to obtain them.
...
* **[[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] ↔ A‑quadrant:** `U.Mechanism.AdmissibilityConditions` is the canonical claim layer for `A-*` gate/admissibility claims.
* **[[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] / [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] ↔ E‑quadrant:** `E-*` claims should be anchored to evidence carriers + provenance ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]); without an explicit evidence anchor they are treated as `AssuranceLevel:L0 (Unsubstantiated)` in the Trust & Assurance calculus ([[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]).
* **[[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]] / [[00_F.12 - Service Acceptance-Work Evidence Link|F.12]] ↔ D/E separation:** a `U.PromiseContent` promise is not evidence; promise acceptance is linked to work evidence via [[00_F.12 - Service Acceptance-Work Evidence Link|F.12]], and role obligations to maintain admissibility are expressed as `D-*` duties referencing `A-*` and/or `E-*` by ID.
...
### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.2 - Boundary Discipline Matrix: route by [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] (the Boundary Norm Square)

**Normative source.** The canonical 2×2 square (the two [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] distinctions, quadrant semantics, form constraints, and cross‑quadrant reference rules) is defined in **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]**. This section provides a short operational summary and worked rewrites only.
...
If a sentence mixes roles (e.g., “MUST” + a gate predicate + an effect claim), it is **not routable** as a single statement. Per **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]**, split it into **atomic** claims so each one has exactly one quadrant (and, ideally, an identifier you can reference).

Micro‑template: **Atomize → Route → Place → Anchor ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]) → Register**
...
4. **Anchor [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]:** for each claim, name the primary [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] side it is *about* (`EntityOfConcern`, Description episteme, or publication carrier) and ensure the grammatical subject matches (agents/roles for `D-*`, carriers for `E-*`).
...
- reopen an [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] gate decision, [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] constraint-validity witness, [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]] speech act, [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]] commitment, [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path, or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim when the L/A/D/E-classified statement is being used beyond boundary wording;
...
See **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:4–[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]:6** for the normative square, quadrant form constraints, and explicit cross‑quadrant link patterns (notably: **D→A**, **E→A**, **D→E**, and **A/E→L**).

#### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.2.1 - Authority-wording split examples
...
Then:
- if a user is deciding whether the wording may guide action, enter [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]];
- if evidence, currentness, or provenance is live, attach the [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] path;
- if trust, readiness, compliance, or release confidence is being raised, build the [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance tuple;
- if an actual gate decision or gate passage is asserted, cite [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] `OperationalGate(profile)`, `GateDecision`, and `DecisionLogRef`;
- if a flow witness or constraint witness is asserted, cite [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] `ConstraintValidity` status or witness;
- if release, deployment, rollback, or execution work is asserted, cite [[01_A.15.01 - U.Work|A.15.1]] dated `U.Work` occurrence plus its [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence carrier path;
- if the phrase is only an action invitation or cue, keep it in [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]], [[00_A.16 - Language-State Move Coordination|A.16]], or [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]] according to the kind under repair.
...
### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.3 - Viewpoint is not optional: projections live under accountable viewpoints
...
* Every published face is a **Description** ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]) that is *about* an Object and is carried by some Carrier; do not conflate these layers.
* Each face must declare the viewpoint that justifies its projection (ISO/42010 discipline operationalised by MVPK).
* Per **[[03_E.17 - Multi-View Publication Kit|E.17]]** (“no new semantics”), a face **MUST NOT** introduce new semantic commitments beyond the boundary’s **canonical L/A/D/E-classified claim set** (the authoritative `L-*`, `A-*`, `D-*`, and `E-*` statements at their canonical locations). A face **MAY** add informative explanation, examples, and cross‑references, provided they are clearly marked as informative. Any **normative** sentence on a face **MUST** cite the L/A/D/E claim ID(s) it depends on (or be moved into the canonical claim set); paraphrase is allowed only as explicitly informative text.
* Per **[[03_E.17 - Multi-View Publication Kit|E.17]]** and **publication-face/form discipline** (face‑kind closure), a publication package that claims MVPK alignment **MUST NOT** mint additional MVPK face kinds (e.g., “EvidenceCard”, “NormsCard”) as if they were first‑class kinds; if you need local headings, keep them as sections within the canonical face kinds.

### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.4 - “Contract” unpacking: avoid assigning agency to epistemes

When practitioners say “the API contract”, they usually compress multiple distinct things into one word. The core naming split is the **[[00_F.18 - Local-First Unification Naming Protocol|F.18]]:16.1** triad; boundary engineering adds the missing adjudication substrate (see also **[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]**):

* **Promise content (promise content; `U.PromiseContent`, [[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]]):** what is promised to be made available to eligible consumers — **a promise, not execution** (`U.Work`).
* **Utterance package (published descriptions + instituting act):** what is said/published and versioned (signature/mechanism + MVPK faces), plus the `U.SpeechAct <: U.Work` that published/approved it when provenance matters ([[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]).
* **Commitment (deontic binding; `U.Commitment`, [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]):** what an accountable `U.Role` or `U.Agent` is obligated, permitted, or prohibited to do (often: to satisfy a promise content).
...
In [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] terms:

* The **signature** is the *utterance substrate* for the boundary; it is not itself a promiser or obligor ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]).
* Deontics belong to accountable role assignments or agents and should be expressed as `D-*` commitments (`U.Commitment`) that reference `L-*`, `A-*`, or `E-*` by ID ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]).
...
This paragraph is a compact reminder; the reusable expansion (including “Service ≠ Work” discipline, claim‑ID link hygiene, and MVPK face projection rules) is **[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] — Contract Unpacking for Boundaries**.
### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.5 - Where statements go (routing examples)

> **Informative.** Routing examples for learning the discipline; they do not add requirements beyond [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:7.
...
| ID | Example statement (typical wording) | Matrix quadrant | Put it under… | [[00_A.07 - Strict Distinction (Clarity Lattice)]] primary layer |
| --- | --- | ---: | --- | --- |
...
* When something needs to be enforceable but is mathematical, prefer predicate blocks rather than deontic language in the L/A blocks, per [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]]’s deontics vs admissibility guidance.

### [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:4.6 - Routing sanity rules (informative, concept-level)
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:5 - Archetypal Grounding (Tell–Show–Show; System / Episteme)

> **Informative.** Worked examples for learning the L/A/D/E claim-classification discipline; they do not add requirements beyond [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:7.
...
* **Signature layer ([[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]]).**
...
* **Mechanism layer ([[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]).**
...
* **Effects/evidence:** the produced report file, logs of evaluation runs, cryptographic hashes, and trace IDs are carriers. [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] discipline prevents calling the report “the evaluation” (object) and prevents treating the file as the model.
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:6 - Bias‑Annotation

Lenses tested: **Gov**, **Arch**, **Onto/Epist**, **Prag**, **Did**. Scope: **Universal** for boundary descriptions in [[00_A.06 - Signature Stack & Boundary Discipline|A.6]].\*.
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:7 - Conformance Checklist

| ID                                       | Requirement                                                                                                                                                                                                                                                                                    | Purpose                                                             |
| ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| **CC‑[[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] (Stack declaration).**        | A conforming boundary description **SHALL** identify its stack layers (Signature, Mechanism, Realization/Work evidence, Publication faces) and state which boundary publication forms or sections belong to which layer.                                                                                                    | Prevents “one doc contains everything” ambiguity.                   |
| **CC‑[[06_A.06.02 - U.EffectFreeEpistemicMorphing - Effect-free morphisms of epistemes]] (Square discipline).**        | A conforming boundary description **SHALL** conform to **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]]** (Boundary Norm Square), including atomicity, quadrant classification, and explicit cross‑quadrant references by claim ID.                                                                                                           | Makes the stack operational; prevents “contract soup” drift. |
| **CC‑[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]] ([[00_A.07 - Strict Distinction (Clarity Lattice)]] separation).**           | A conforming boundary description **SHALL** respect EntityOfConcern and Description-episteme / publication-carrier separation; statements about logs/metrics **SHALL** be written as carrier‑anchored evidence claims/policies, not as properties of the text itself. | Prevents category errors and improves auditability.                 |
| **CC‑[[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)]] (Viewpoint accountability).** | Every published MVPK face (`U.View`) **SHALL** specify `viewRef` and `viewpointRef`. Faces **SHALL** be projections of the boundary’s canonical L/A/D/E-classified claim set ([[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]]); normative content on faces **MUST** be expressed as citations to L/A/D/E claim IDs (not re‑stated prose), and faces **MUST NOT** introduce new semantic commitments beyond the underlying signature/mechanism (per **[[03_E.17 - Multi-View Publication Kit]]** “no new semantics”). | Preserves viewpoint discipline and prevents view‑forking.    |
| **CC‑A.6.6a (MVPK face‑kind discipline).**  | A publication that claims MVPK alignment **MUST** conform to **[[03_E.17 - Multi-View Publication Kit]] / publication-face/form discipline** face‑kind closure (i.e., use only `{PlainView, TechCard, InteropCard, AssuranceLane}` and **MUST NOT** mint additional face kinds). Local “cards” may exist only as headings/sections inside those face kinds. | Aligns with MVPK/publication-face/form discipline; prevents new‑face drift.            |
| **CC‑[[15_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms]] (Contract unpacking).**       | When using “contract/guarantee/promise” language, a conforming text **SHOULD** apply the reusable discipline in **[[03_A.06.C - Contract Unpacking for Boundaries]]** to disambiguate whether it refers to a promise content as promise content (`U.PromiseContent`, not execution), an utterance package, a published description, a speech act, a deontic commitment (`U.Commitment`), work effects, or evidence, and then classify each atomic statement via **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]]** (`L-*`, `A-*`, `D-*`, or `E-*`) with explicit claim‑ID references (no paraphrase drift). (**[[00_F.18 - Local-First Unification Naming Protocol]]** is a lexical anchor only.) | Stops agency attribution errors; clarifies responsibility.          |
| **CC‑[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)]] (Causal/deontic split).**     | A boundary description that mixes causal support with duty, promise, commitment, release, or admissibility language SHALL split the sentence into atomic claims: causal-use support to [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], deontic and boundary-gate claims to [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]], and contract/promise/utterance unpacking to [[03_A.06.C - Contract Unpacking for Boundaries]]. A `CausalUseSupportVerdict` does not by itself create a duty, commitment, promise, release gate, or boundary admissibility predicate. | Prevents causal evidence from being recast as boundary authority or deontic obligation. |
| **CC-[[17_A.06.09 - U.CrossContextSamenessDisambiguation - Repairing cross-context “same - equivalent - align” via explicit Bridges (RPR-XCTX)]] (Authority-wording split).** | A conforming boundary description SHALL split boundary, policy, API, schema, connector, or compliance prose using "approved", "allowed", "authorized", "guaranteed", "certified", "recommended", or equivalent wording into atomic `L-*`, `A-*`, `D-*`, and `E-*` claims before work use or reliance use. Any evidence, assurance, role effect, status effect, gate use, release use, commitment, speech-act, or work-occurrence use beyond the L/A/D/E-classified wording SHALL cite the exact `governingPatternRef` or `authoritySourceRef` rather than the wording itself. | Prevents boundary wording from becoming authority, evidence, assurance, gate passage, or work by slogan. |

## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:8 - Common Anti‑Patterns and How to Avoid Them

| Anti‑pattern                   | Symptom                                                         | Why it fails                                                                     | How to avoid / repair                                                                        |
| ------------------------------ | --------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| **Gate‑as‑law**                | Preconditions written as “laws” in the signature                | Breaks substitution; violates [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]]’s separation of signature vs mechanism gates | Move predicates to Mechanism.AdmissibilityConditions; keep signature laws truth‑conditional. |
...
| **Interface‑as‑promiser**      | “The interface promises…” without identifying an agent          | Ontological category error; contracts are agent commitments                      | Apply **[[00_F.18 - Local-First Unification Naming Protocol]]:16.1** unpacking: who commits, via which published utterance, to what promise content.           |
...
| **Deontic claim laundering or admissibility/gate overread** | "Allowed", "authorized", "approved", "certified", or "guaranteed" used as work permission, reliance permission, evidence, assurance, gate passage, or work occurrence | One word silently carries several claim families and hides missing source support | Split through `L-*`, `A-*`, `D-*`, and `E-*`, then use [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], or [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]] only when that work claim or reliance claim is live. |

## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:9 - Consequences
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:10 - Rationale
...
## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:12 - Relations

* **Implements authoring discipline:** Follows canonical section order and style expectations from [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]].
* **Constrains signature writing:** Reinforces [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]] separation of Laws vs operational gates (AdmissibilityConditions live in mechanisms).
* **Constrains mechanism writing:** Aligns with [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] structure (Signature block plus mechanism‑only blocks such as AdmissibilityConditions, Transport, Audit).
* **Requires EntityOfConcern and Description-episteme / publication-carrier discipline:** Uses [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] to prevent category mistakes; ties evidence to evidence carriers and publication faces to descriptions.
* **Operationalises `U.View` and `U.Viewpoint` accountability:** Uses MVPK and `U.MultiViewDescribing` ([[00_E.17.00 - U.MultiViewDescribing - Viewpoints, Views & Correspondences|E.17.0]]) so each face is a projection under a viewpoint, not a viewpoint‑free snapshot.
* **Unpacks “contract” talk:** Reuses [[00_F.18 - Local-First Unification Naming Protocol|F.18]]’s promise/utterance/commitment separation to keep agency and responsibility explicit.
* **Connects to signature engineering patterns:** [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] (slot discipline) and [[14_A.06.06 - U.BaseDeclarationDiscipline - Kind-explicit, scoped, witnessed base declaration discipline (with base-change lexicon)|A.6.6]] (anchor/base discipline) can be read as “constructor/enabling” operations that help *build* well‑formed signatures by disciplined unpacking and grounding (they belong in the same stack discipline because they govern boundary construction).
* **Coordinates with `C.28 CausalUse-CAL`:** When boundary prose uses causal support to justify deployment, release, duty, commitment, or admissibility, [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] splits the boundary sentence while [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] carries the causal-use question, `CausalityLadderRung`, estimand, support basis, support verdict, and supported causal use and unsupported causal use.
* **Coordinates with [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], and [[01_A.15.01 - U.Work|A.15.1]]:** When routed boundary wording is then used for work, reliance, evidence, currentness, provenance, assurance, gate decision, constraint-validity witness, release work occurrence, or deployment work occurrence, the required claim or effect is carried by the exact source: [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for `OperationalGate(profile)`, `GateDecision`, and `DecisionLogRef`; [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] for `ConstraintValidity` status or witness; [[01_A.15.01 - U.Work|A.15.1]] for dated `U.Work` occurrence.

## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:12a - Quantum-like boundary-route note

Use [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] first for ordinary boundary, interface, API, protocol, contract, connector, publication-face, and observability-evidence wording. Quantum-like boundary prose is supported only after the boundary text still needs a probe, order, frame, export, or state-reading distinction that ordinary boundary patterns would otherwise erase.

Action path:

1. Identify the boundary sentence and name the boundary object in ordinary [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] terms.
...
3. Apply the applicable ordinary FPF patterns to the ordinary boundary content: [[00_A.06 - Signature Stack & Boundary Discipline|A.6]], [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], or [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles|C.25]].
...
6. If yes, apply [[01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] only to that remaining residual question; keep the ordinary boundary pattern active.
...
| Ordinary pattern tried | Which of [[00_A.06 - Signature Stack & Boundary Discipline]], [[00_F.09 - Alignment & Bridge across Contexts]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]], or [[00_C.25 - Q-Bundle- Authoring --ilities- as Structured Quality Bundles]] already carries the baseline question |

Useful outputs:

- an L/A/D/E-classified boundary claim set when ordinary [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] is enough;
- a Bridge Card when the issue is export/loss across contexts;
- a [[01_C.26.01 - Probe-Coupled Boundary Interaction|C.26.1]] probe-coupled boundary note only when the boundary act changes the represented state in a decision-relevant way;
- a relation repair using [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] or [[00_F.18 - Local-First Unification Naming Protocol|F.18]] when coupling words become reusable relation candidates.

## [[00_A.06 - Signature Stack & Boundary Discipline|A.6]]:End
