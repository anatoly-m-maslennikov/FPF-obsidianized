...
* where the repaired statement is primarily **evaluative**, use **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]**;
* where it is primarily about **general capability**, capability wording, method wording, or method-description wording, use **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]**, `U.Capability`, `U.Method`, or `MethodDescription` according to the claim being made;
* where it is primarily **deontic**, apply **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]**;
* where it is primarily about **scheduled or executed enactment**, use the governing **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** pattern family (`U.Method`, `U.MethodDescription`, `U.WorkPlan`, or actual `U.Work` once execution has occurred) rather than letting `actionInvitation(...)` become a shadow execution model.

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:1 - Problem frame
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:2 - Problem
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:3 - Forces
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4 - Solution - Stable lens -> Sense Family -> Slots -> Normal Form -> Change Lexicon -> Guardrails

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.0 - Trigger rule

A use of affordance-like or action-first language is in scope for [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] when any of the following holds:
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.0a - Operational repair sequence

When the trigger fires, authors SHOULD follow the [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair sequence:
...
5. **Classify boundary-bearing consequences.**
   If the repaired statement is used for admissibility, commitments, publication, automation, or evidence-bearing decisions, classify the downstream claim uses with **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** and, where enactment is implied, through **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]**, instead of letting the vague action-first phrase carry evidence, admissibility, gate, or decision consequences by itself.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.1 - Post-threshold lens: action-invitation classification specified by `actionInvitation(...)`
...
Early action-guiding cue content may remain in [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/02_A.16.01 - U.PreArticulationCuePack|A.16.1]] or [[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] as cue-pack content, a `RoutedCueSet`, or another typed cue-preserving upstream publication before [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] application.
[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] is therefore applied only once local `AE` is high enough to name site, enactor, and action structure explicitly and local `CD` is high enough that one invitation interpretation is worth publishing as a relation record rather than remaining cue-pack or unresolved cue content. If the admissible publication is still a cue pack, `RoutedCueSet`, or open abductive prompt, stay in [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], or [[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]].
If a published `actionInvitation(...)` later loses those minimal articulation and closure conditions, retreat via [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]] rather than leaving a stale invitation record live.

In [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] terms, this pattern fixes one post-threshold relation family and one downstream classification discipline:
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.1a - RelationKind specification skeleton for `actionInvitation`
...
**P2W relation note.**
`candidateActionTuple` names the invited move as relation content. It is not an actual `U.Work` occurrence, not a `U.WorkPlan`, not a `U.MethodDescription`, and not a selected method. When the publication needs intended work, planned work, actual work, method selection, work result, or result measurement, use [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]], or [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]] instead of stretching `actionInvitation(...)`.

**[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] boundary note.**
...
If a publication face, publication form, interop publication form, carrier, or rendering participates, declare it in `publicationOrCarrierParticipation` under [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and publication-face and publication-form discipline rather than widening the site classification with a generic quoted `Surface` token.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.2 - Core construct: `ActionInvitationSense`
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.2a - [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]] articulation-token relation note

[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] carries `articulationHint` only as a **local articulation-cue field**.

This field is deliberately **not** a new formality progression, **not** a maturity scale, and **not** a surrogate for **F**. Its only job is to preserve local articulation and closure cues until they can be related to [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]] move logic and the explicit [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/07_C.02.04 - U.ArticulationExplicitness|C.2.4]] and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]] governing facets.

Local `articulationHint` tokens SHALL be related to [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]] move logic and to the explicit [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/07_C.02.04 - U.ArticulationExplicitness|C.2.4]] and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]] governing facets one-for-one, and [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] SHALL treat them as local publication cues only.
Until then, local hints SHALL NOT be thresholded, aggregated, or compared across Contexts.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.3 - Normative starter set of sense families
...
* In **operator-interface, alarm, or operator-panel** contexts, bare action-first phrasing SHALL rewrite to **`AIS.InterfaceAffordance`**, **`AIS.ControlOpportunity`**, or both when both senses are live. If the wording instead claims module interface, functional port, API, protocol, signature, interface specification, or service-access compatibility, use [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/10_A.06.RSIR - Relation, Signature, Interface, Role, and Slot Precision Restoration|A.6.RSIR]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/13_A.06.M - Module Relation Repair|A.6.M]], [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], or [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind over a RangedValueKind|A.6.0]] according to the recovered EoC rather than treating the cue as an action invitation.
...
* If the sentence is chiefly about **better, worse, fit, or merit**, use **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** instead of [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]].

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.4 - Required slots for a conforming `actionInvitation`
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.5 - Normal-form discipline
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.6 - Separation from quality, capability, commitment, and work

[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] SHALL prevent the collapse of action invitation language into neighbouring families.

* A statement about **better, worse, fit, or merit** belongs to **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]**.
* A statement about **what a system can do in general** belongs to capability wording, method wording, or method-description wording under **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/12_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]** and the governing pattern for the asserted capability, method, or method-description claim.
* A statement about **what must be done** belongs to **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** when the wording asserts an A-classified admissibility claim or a D-classified commitment claim.
* A statement about **what was actually done** belongs to **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** and `U.Work`.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.7 - Bridge discipline across traditions
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.8 - Change lexicon

A conforming pattern SHALL narrate changes with a stable change lexicon aligned to [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.9 - Lexical guardrails
...
* **actionable insight** MUST be rewritten to `ActionOption`, `OptionSet`, or `PolicyHook`, or to **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** if the use is primarily evaluative;
...
* `articulationHint` MUST NOT be treated as **F**, as acceptance status, or as a replacement for [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]] grounding references;
* generic `Surface` facet tokens MUST NOT be introduced inside [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]; publication face, publication form, interop publication form, carrier, or rendering participation must be declared under [[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and publication-face and publication-form discipline, not by widening the site classification;
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.10 - Progressive elaboration

[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] allows monotone elaboration:
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:5.3 - Show (Episteme case)
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:6 - Bias-Annotation
...
* **Gov bias:** this pattern may tempt authors to smuggle decisions into invitation language.
  *Mitigation:* explicit [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] claim classification and obligation barrier.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:7 - Conformance Checklist (CC-[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]])

A text or pattern conforms to [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] iff:

1. **CC-A.6.A-1 — Explicit post-threshold relation family and explicit sense.**
   Every in-scope post-threshold action-first use resolves to one declared `actionInvitation(...)` instance and one declared `ActionInvitationSense`; earlier cue-like content stays under [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/02_A.16.01 - U.PreArticulationCuePack|A.16.1]] or [[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] instead of being forced into [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] prematurely.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:8 - Common Anti-Patterns and How to Avoid Them
...
| **Invitation-as-obligation**   | "This calls for rollback" is treated as if rollback is already required                     | hides A-classified or D-classified claim status and accountability | publish `actionInvitation(...)`, then classify duty or gate use with [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]] |
| **Invitation-as-work**         | “The system reacted” is used where only a cue or option exists                              | confuses offer with execution                          | keep invitation separate from [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] and `U.Work`                   |
...
| **Premature automation**       | a cue without required witness records is wired directly into gates or controllers with no explicit hook `authoritySourceRef` named source or guard | creates unsafe action-to-automation coupling                         | require `PolicyHook`, [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]] claim classification, and witnesses                |
| **ArticulationHint as F proxy**| `hook-explicit` is treated as "more formal"                                                | recreates a forbidden second formality characteristic          | keep F in [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F]]; reserve articulation and closure semantics for [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination]] |

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:9 - Consequences
...
It also complements [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] cleanly: [[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] repairs **evaluative** ambiguity, while [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] repairs **action-inviting** ambiguity.
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:10 - Rationale

[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] makes one strategic move:
...
* **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** governs evaluative repairs,
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]** governs action-invitation repairs,
* **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** governs boundary claim classification,
* **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** governs enactment and work,
* **[[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]]** governs articulation and closure progression and admissible moves,
* **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]** remains the sole governing pattern for formality characteristic **F**.

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:11 - SoTA-Echoing

Recent philosophical and ecological work treats affordances as **action-relevant possibilities** perceived in engagement and, in some accounts, as **invitations for action**, rather than as viewpoint-free monadic site-participant properties. [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts that relational, action-first stance, adapts it by forcing explicit `siteTuple`, `invitedEnactorTuple`, and `couplingFrame` publication, and rejects silent collapse into monadic site-participant labels. ([Frontiers][1], [Springer][2])

Recent empirical review work on affordance perception emphasises **attunement and recalibration** in person-plus-environment systems rather than fixed, context-free labels. [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts the need for enactor- and situation-specific publication, adapts it into `CuePack`, `ActionOption`, and `OptionSet` normal forms, and rejects any assumption that an affordance phrase is already an admissible characteristic, scale, or universally portable invariant. ([Springer][2])

Current active-inference work frames generative models in **action-perception loops** and, in many cases, **action-oriented models** that are for adaptive interaction rather than only detached description. [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts the action-oriented emphasis and the separation between model-side cueing and enacted action; it adapts this by making `detector` and `invitedEnactor` explicit and by forbidding latent policy cues from counting as work, commitment, or explicit rationale by default. ([UCL Discovery][3])

Current robotics work increasingly uses affordances as **intermediate representations** between perception-language representations and concrete action, including compact keypoint or staged affordance plans. [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts this as evidence that affordance publication can be an admissible intermediate publication form; it adapts it into `ActionOption`, `OptionSet`, and `PolicyHook`, and rejects silent promotion of such representations into deontic obligation, proof of correctness, or objective value. ([Robotics: Science and Systems][4])
...
## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12 - Relations

* **Specialises:** **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** as an RPR pattern for overloaded affordance-like and action-first language.
* **Builds on:** **[[A_Kernel Architecture Cluster/03_Transformer Constitution (Quartet)/00_A.03 - Transformer Constitution (Quartet)|A.3]]** and **[[A_Kernel Architecture Cluster/07_Strict Distinction (Clarity Lattice)/00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]** for enactor discipline and EntityOfConcern and Description-episteme plus publication and carrier separation; **[[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** for keeping invitation distinct from enactment; **[[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** for boundary claim classification; **[[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]]** and **[[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/00_E.18 - Transformation Flow Structure|E.18]]** for viewpoint publication.
* **Works alongside:** **[[C_Kernel Extension Specifications/04_16_Measurement & Metrics Characterization (MM-CHR)/02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** for evaluative language; the two are siblings, not substitutes.
* **Coordinates with:** **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]], [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[B_Trans-disciplinary Reasoning Cluster/03_04_Canonical Evolution Loop/01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]]** for language-state chart positions, admissible moves before post-threshold repair, and retreat when a published invitation must be reopened; use **[[A_Kernel Architecture Cluster/16_Language-State Move Coordination/01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or responsibility-transfer history itself must be published as an explicit trajectory account; **[[B_Trans-disciplinary Reasoning Cluster/04_05_Canonical Reasoning Cycle/02_Abductive Loop/01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]** for probe-question cases that are still prompt-shaped; **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for language-state facet governance.
* **Must not replace:** **[[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]** as the single governing pattern for **F**.
* **Recommends publication via:** **[[E_The FPF Constitution and Authoring Guides/09_10_Unified Lexical Rules for FPF/00_E.10 - Unified Lexical Rules for FPF|E.10]], [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/17_Unified Term Sheet/00_F.17 - Unified Term Sheet|F.17]], and [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/18_Local-First Unification Naming Protocol/00_F.18 - Local-First Unification Naming Protocol|F.18]]** when `actionInvitation` tokens, starter senses, and red-flag rewrites become shared vocabulary.
...
### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.1 - Language-space refactor note
This pattern is scoped to **action-invitation repair and endpoint continuation**, not to the whole early cue family. Early action-guiding cue content may remain in [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/02_A.16.01 - U.PreArticulationCuePack|A.16.1]] as cue-pack content, a `RoutedCueSet`, or another typed cue-preserving upstream publication before it stabilizes into `actionInvitation(...)`.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.2 - Canonical downstream relation
`actionInvitation(...)` should be classified through [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] and connected to [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] when work enactment is live toward gates, commitments, methods, or work. Operator-facing starter senses such as `AIS.AlertInterventionCue` or `AIS.OperatorInterventionCue` should not be buried under generic `AIS.InterfaceAffordance` when human factors and policy hooks substantively differ.

### [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.3 - Governance boundary
Bridge stances, articulation-state governing patterns, authority-reference fields, and language-state facet characteristics are **referenced** by this pattern but remain governed by [[F_The Unification Suite (U-Suite)- Concept-Sets, SenseCells & Contextual Role Assignment/09_Alignment and Bridge across Contexts/01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[A_Kernel Architecture Cluster/16_Language-State Move Coordination/00_A.16 - Language-State Move Coordination|A.16]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]].

## [[A_Kernel Architecture Cluster/06_Signature Stack & Boundary Discipline/11_A.06.A - Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:End
