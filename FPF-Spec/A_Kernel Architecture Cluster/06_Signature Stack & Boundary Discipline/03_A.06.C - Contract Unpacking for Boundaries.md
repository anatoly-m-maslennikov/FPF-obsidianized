...
> **Status:** Stable
> **Normativity:** Normative (unless explicitly marked informative)
> **Placement:** Part A → **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]] Signature Stack & Boundary Discipline**
> **Builds on:** [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] (stack + routing intent), **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** (L/A/D/E), **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR‑SERV)** (service‑cluster polysemy unpacking), **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]** (EntityOfConcern / Description episteme / carrier), **[[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]]** (`U.PromiseContent` / promise content), **[[04_A.02.04 - U.EvidenceRole|A.2.4]]** (`U.EvidenceRole`), **[[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]** (`U.Commitment`), **[[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]** (`U.SpeechAct`), **[[01_A.15.01 - U.Work|A.15.1]]** (`U.Work`), [[00_E.10 - Unified Lexical Rules for FPF|E.10]] (L‑SERV / LEX‑BUNDLE), [[03_E.17 - Multi-View Publication Kit|E.17]] (MVPK “no new semantics” faces), [[00_F.12 - Service Acceptance-Work Evidence Link|F.12]] (service acceptance/evidence discipline)
> **Lexical anchor:** **[[00_F.18 - Local-First Unification Naming Protocol|F.18]]** (NQD front for the *service (promise) / utterance / commitment* triad; naming, not ontology)
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:1 — Problem frame
...
When these layers are collapsed, authors accidentally assign agency to epistemes (“the interface guarantees…”), encode runtime gates as if they were internal laws, or treat observability as a property of text rather than of carriers and work. [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] and [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] already provide an L/A/D/E claim-classification discipline for boundary claims, but “contract” language remains a recurring entry point for category mistakes.

**Service-cluster note (modularity + lexicon).** Boundary “contract talk” commonly co‑moves with the *service* cluster (*service*, *service provider*, *server*, *SLA/SLO/service‑level*). When those tokens appear, their referents MUST be disambiguated per **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR‑SERV)** before (or while) applying the four‑part Contract Bundle below. In particular, `U.PromiseContent` is promise content and is written in normative prose as **promise content** (not as bare “service”).

[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] makes contract-language usable inside the [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] stack by providing a canonical unpacking that can be applied to APIs, hardware interfaces, protocols, and socio-technical boundaries.

**Non‑goals (to preserve modularity).** [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] does **not**:
...
* redefine quadrant semantics (`L/A/D/E`) or cross‑quadrant reference rules; those are defined normatively in [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]].

## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:2 — Problem
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:3 — Forces
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:4 — Solution

[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] introduces a **Contract Bundle** lens for boundary writing. It is not a new foundational entity kind; it is a disciplined way to interpret and rewrite contract-language under [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]].

### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:4.1 — The Contract Bundle (four-part unpacking)
 ...
 * In FPF terms ([[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]]), **`U.PromiseContent` is promise content**—a **promise content**, not an execution event (`U.Work`) and not (by itself) an accountable deontic binding (`U.Commitment`).
 * **Prose head rule (normative).** When referring to `U.PromiseContent` in normative prose, authors SHALL use the head phrase **promise content** (or **service offering clause** or **service promise clause**) and SHALL NOT rely on the bare head noun *service*. If the surrounding text also talks about endpoints/systems/operations, apply **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]]** to select facet‑typed phrases (service access point, service delivery system, service delivery work, and so on) rather than collapsing them into “service”.
...
2. **Utterance Package (speech act + published descriptions)**
   ...
   * The work occurrence of stating/publishing/approving (a `U.SpeechAct <: U.Work`, [[09_A.02.09 - U.SpeechAct (Communicative Work Object)|A.2.9]]) **and** the utterance descriptions it produces or updates (versioned **epistemes** on carriers) that carry the L/A/D/E-classified claim set.
...
3. **Commitment (Deontic accountability relation)**
   ...
   * This bundle part is the **D‑side commitment object**: by default, one or more `U.Commitment` records ([[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]).
   * **Default checklist ([[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]] minimal structure):**
   ...
   * A commitment is not “the spec text”: utterance descriptions carry the statement, but the binding is the `U.Commitment` object ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] / [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]).
...
### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:4.2 — Routing recipe into [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] (L/A/D/E)

After unpacking, route each **atomic** statement using the Boundary Norm Square as defined normatively in **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** (quadrant semantics + form constraints + cross‑quadrant reference discipline). [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] does not redefine `L/A/D/E`; it applies them to contract-language as follows:
...
* **Commitment → D (who is accountable).**
  * Put “MUST/SHALL/commits to …” statements as **D** (`D-*`), preferably as `U.Commitment` payloads ([[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]).
...
### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:4.4 — MVPK faces are not second contracts
...
### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:4.5 — Default register: Contract Claim Register (recommended)

Use the **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] Claim Register** (IDs + statements + quadrant + anchor). Add two optional columns that make [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] auditable without adding new ontology:
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:5 — Archetypal Grounding (Tell–Show–Show)

### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:5.1 — Tell
...
### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:5.2 — Show (System archetypes)
...
### [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:5.3 — Show (Episteme archetypes)
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:6 — Bias-Annotation
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:7 — Conformance Checklist

A boundary description conforms to [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] iff it satisfies all items below:

1. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑1 (Unpacking when contract-language appears).**
...
2. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑2 (No agency to epistemes).**
...
3. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑3 (Route contract-language statements via [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]).**
...
4. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑4 (Promise content ≠ Work discipline).**
   Statements about what is executed/observed **SHALL** be expressed as **E** claims about work/evidence/carriers. Promise‑content language **SHALL** refer to the **promise content** (`U.PromiseContent`, [[03_A.02.03 - U.PromiseContent (Promise Content)|A.2.3]]) and its **L‑defined** semantics (and to explicit **D‑*** commitments represented as `U.Commitment`, [[08_A.02.08 - U.Commitment (Deontic Commitment Object)|A.2.8]]), not to execution events (`U.Work`) or runtime effects.
   Unqualified head‑noun *service* (and the co‑moving cluster *service provider* / *server*) in normative boundary prose SHALL be unpacked per **[[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)|A.6.8]] (RPR‑SERV)**.

5. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑5 (Evidence hook for operational guarantees).**
...
6. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑6 (No second contracts via faces).**
...
7. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑7 (RFC‑keyword discipline inside faces).**
...
8. **CC‑[[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]‑8 (No commitment-by-publication default).**
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:8 — Common Anti-Patterns and How to Avoid Them
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:9 — Consequences
...
## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:10 — Rationale
...
[[00_F.18 - Local-First Unification Naming Protocol|F.18]] provides the **naming** intuition (service/promise vs utterance vs commitment) via an NQD example; [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] makes that split **operational for boundaries** and extends it with the missing fourth part: **work+evidence as the adjudication substrate**. This keeps “contract” language routable under [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] and compatible with MVPK multi‑view discipline without relocating ontology into the naming chapter.

## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:11 — SoTA‑Echoing (informative; post‑2015 alignment)

> **Informative.** Alignment notes; not normative requirements.

* **Adopt — BCP 14 (RFC 2119 + RFC 8174) norm keyword discipline for spec language.** Modern spec-writing practice treats these keywords as a disciplined modality family; [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] constrains where such modality belongs (D) versus where predicate-style constraints belong (A/L).
...
* **Adapt — ISO/IEC/IEEE 42010:2022 viewpoint discipline.** Multi-view publication is treated as viewpoints governing projections; [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] applies this to contract talk to avoid face-level semantic forks.

## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:12 — Relations

* **Uses / is used by**

  * Uses **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** for L/A/D/E claim classification, atomicity, and cross-quadrant reference discipline.
  * Used by **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]]** cluster conformance (“contract unpacking”) as the detailed, reusable form of that discipline.
  * Complements **[[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]]** (signature engineering): contract unpacking is a common constructor step when turning prose boundaries into publishable signatures.
  * Coordinates with **[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** families: when an RPR pattern touches “contract/guarantee” language, apply [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] to avoid category errors. ([[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] is **not** a specialization of [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]; [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] is relation‑precision, [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] is boundary‑contract disambiguation.)

* **Coordinates with**

  * **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]** (EntityOfConcern / Description episteme / carrier) for correct placement of evidence claims.
  * **[[00_F.12 - Service Acceptance-Work Evidence Link|F.12]]** (service acceptance) for structuring how promise-level commitments connect to evidence and acceptance windows.
  * **[[03_E.17 - Multi-View Publication Kit|E.17]]** MVPK “no new semantics” rule to prevent publication faces from becoming new contracts.

## [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]]:End
