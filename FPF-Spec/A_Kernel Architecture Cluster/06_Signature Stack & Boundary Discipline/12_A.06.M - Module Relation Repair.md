...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:1 - Problem frame

Use this pattern when an architecture or engineering text says "module", "component", "interface", "port", "platform", or "open architecture", and the phrase is doing more than ordinary orientation. If a stratification or architecture-operation source label covered by [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] is doing the work, apply [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] first; use [[12_A.06.M - Module Relation Repair|A.6.M]] only when that repair recovers a module-interface relation. Use [[12_A.06.M - Module Relation Repair|A.6.M]] when the question under repair is whether one holon is being treated as a replaceable, reusable, or separately changed structural unit of a larger holon under a declared module-interface viewpoint.
...
What goes wrong if [[12_A.06.M - Module Relation Repair|A.6.M]] is missed: a functional link becomes a module interface; a signature becomes an implemented interface; a port label becomes proof of integration; "open" becomes a decoration; a platform label hides the actual extension rules; a stratification or architecture-operation source label bypasses [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] and mints a false local kind; autonomy-like wording is confused with separate module change policy; and a module diagram starts being used for claims governed elsewhere.

What [[12_A.06.M - Module Relation Repair|A.6.M]] buys in practice: the practitioner can repair one module or interface phrase into a module-relation record, see which FPF pattern governs any remaining non-module claim, and stop before full measurement, evidence, or mechanism-suite records are needed.

Not this pattern when the question under repair is the general architecture claim, selected architecture structure kind, structural view, stratification wording or source-label recovery, function wording, procedural or work-package wording, role or enactor wording, autonomous operation, independent acting, unsupervised decision or action, measurement, modularity characterization, or reusable-structure residue. Use [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.02 - Role Taxonomy|A.2]], [[00_E.16 - RoC-Autonomy Budget & Enforcement|E.16]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], or [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]] as appropriate. For any other claim being made, apply the governing FPF pattern and keep [[12_A.06.M - Module Relation Repair|A.6.M]] only for the module-relation and interface-specification portion.

**[[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] relation.** [[12_A.06.M - Module Relation Repair|A.6.M]] is the precision-restoration pattern for module-interface relation wording, interface-specification wording, platform-grammar wording, substitutability wording, change-policy wording, and open-architecture module-interface claims. [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], or [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] applies [[12_A.06.M - Module Relation Repair|A.6.M]] only after the recovered result is a module-interface relation, interface specification, platform grammar, substitutability policy, change policy, or open-architecture module-interface claim. If the source wording is still a stratification or architecture-operation source label covered by [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], apply [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] first. If the claim being made is non-module work, role, evidence, assurance, gate, decision, characteristic, flow, autonomy, component, mechanism, or mathematical-lens use, apply the governing pattern named in `A.6.M:12` and keep [[12_A.06.M - Module Relation Repair|A.6.M]] only for the module-interface slice when that module-interface relation remains the claim being made.

## [[12_A.06.M - Module Relation Repair|A.6.M]]:2 - Problem
...
- a control relation, deployment scope, or stratification or architecture-operation source label that still needs [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] recovery;
...
| Function-flow-module proximity vs false identity | Functions, [[00_E.18 - Transformation Flow Structure]] flow relations, control relations, mechanisms, and module interfaces often meet at the same artifact, but each has a different governing pattern. |
...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:4 - Solution

[[12_A.06.M - Module Relation Repair|A.6.M]] specializes [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] for module, component, interface, platform, and open-architecture wording when the recovered result is a module-interface relation, interface specification, platform grammar, substitutability relation, or open-architecture module-interface claim. Stratification or architecture-operation source labels covered by [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] are governed by [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] until that repair recovers a module-interface relation; [[12_A.06.M - Module Relation Repair|A.6.M]] applies only to that recovered module-interface result. [[12_A.06.M - Module Relation Repair|A.6.M]] does not mint root kinds from those source labels.
...
For modular synthesis, [[12_A.06.M - Module Relation Repair|A.6.M]] supplies only the module-interface slice. A synthesis move may align required functions or functional-service claims under `VP.Functional`, transformation-flow topology under [[00_E.18 - Transformation Flow Structure|E.18]] and [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], control structure under [[05_C.30.LCA - Control Structure View Adequacy (LCA)|C.30.LCA]], procedures and work packages under `VP.Procedural`, role enactors under `VP.RoleEnactor`, and modules or interfaces under `VP.ModuleInterface`; [[12_A.06.M - Module Relation Repair|A.6.M]] repairs the module-interface relation, while non-module candidate generation, evidence, assurance, decision, work, and characteristic claims are governed by the patterns named in `A.6.M:12` when those claims are being made.

### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.1 - `moduleIn(...)` relation record
...
### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.2 - Interface specification is not a label
...
### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.3 - Repair applications for overloaded words

| Source wording | Governing repair application |
| --- | --- |
| `component` | First recover an [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases]] relation such as `ComponentOf`, `ConstituentOf`, `PortionOf`, `MemberOf`, or `PhaseOf`. Apply [[12_A.06.M - Module Relation Repair]] only when a module-interface relation is being claimed. |
| `module` | Recover `moduleIn(...)` or `ModuleRelationRepairNote` over `U.Holon` refs under `VP.ModuleInterface`. |
| `functional element` | Keep as `FunctionalElement@Context` inside `FunctionalStructureView@Context`; use [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]] to repair wording and connect to module-interface structure only through correspondence or allocation. Allow many-to-many allocation: one module may realize many functional elements, many modules may realize one functional element, a functional element may be abstract before allocation, and a module may have no current functional behavior in the view. |
| `work package`, `delivery unit`, or `team boundary` | Keep work, method, work-plan, role-assignment, role, and enactor claims with [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.02 - Role Taxonomy]], `VP.Procedural`, or `VP.RoleEnactor` when the wording asserts those claim kinds. Relate them to module-interface structure only through declared correspondence, allocation, or boundary relation. |
| `deployment scope` or `placement` | Recover a deployment or placement structure under [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] or [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] when that deployment or placement structure is being claimed. Relate it to module-interface structure only through declared correspondence or boundary relation. |
| `interface` | Recover `InterfaceSpecificationRef`, not a wire, API label, port label, [[00_E.18 - Transformation Flow Structure]] transformation-flow relation, or function by itself. |
| `signature` | Keep as [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] declaration. It is not an implemented interface, mechanism, gate, evidence row, or substitution policy. |
...
| `E.18 transformation-flow relation` or `path` | Keep under [[00_E.18 - Transformation Flow Structure]] and [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]]; it may inform an architecture-to-transformation-flow relation, but it is not an interface specification. |
...
| stratification or architecture-operation source label | Apply [[03_C.30.STRAT - Stratification Wording Precision Restoration]] first. Use [[12_A.06.M - Module Relation Repair]] only when the recovered result is a module-interface relation, interface specification, platform grammar, substitutability policy, change policy, or open-architecture module-interface claim. Otherwise apply [[05_C.30.LCA - Control Structure View Adequacy (LCA)]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]], [[00_E.18 - Transformation Flow Structure]], [[01_C.16.P - Characteristic and Scale Precision Restoration]], [[00_C.29 - Mathematical Lens Use]], [[00_C.02.P - Epistemic Precision Restoration]], or use ordinary source-label disposition when no FPF-governed claim remains. |
...
### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.4 - First repair sequence

1. Name the phrase and the practical situation.
2. Select the whole holon and candidate module holon.
3. State whether the source phrase is module relation, component relation, function allocation, procedural or work-package relation, role or enactor relation, deployment or placement structure, interface specification, signature, port or endpoint, transformation-flow crossing, mechanism realization, platform grammar, control relation, autonomy-like operation claim, [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] source-label case, or open-architecture claim.
...
6. State the governing pattern for any non-module claim being made: [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy|C.30]], [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)|C.30.ASV]], [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_A.02 - Role Taxonomy|A.2]], [[00_E.18 - Transformation Flow Structure|E.18]], [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation|C.30.TFS-REL]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]], [[00_E.20 - Mechanism Introduction Protocol|E.20]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]], or [[00_C.11 - Decision Theory (Decsn-CAL)|C.11]].
7. Stop when the relation and next move are explicit.

### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.5 - Worked slices
...
Supplier-diversity, procurement suitability, use-context compatibility, business constraint, policy authorization, and provider-selection claims are not module-interface fields. If those claims are being made, [[12_A.06.M - Module Relation Repair|A.6.M]] names only the module-interface slice; non-module selection, procurement, work, role, evidence, assurance, gate, release, and mechanism claims are governed by the patterns named in `A.6.M:12`.
...
Proxy-cost replay: if a repair proposes more modules, more open interfaces, or more parallel paths, name what may get worse before claiming improvement. Synchronization work, communication overhead, conformance work, shared-resource pressure, hidden exception cost, or cross-boundary change cost can become the claim being made. [[12_A.06.M - Module Relation Repair|A.6.M]] repairs only the module-interface relation; speedup, bottleneck, modularity, measurement, work, and quality tradeoffs are governed by [[00_C.29 - Mathematical Lens Use|C.29]], [[00_E.18 - Transformation Flow Structure|E.18]], [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], or the related governing pattern named by value when that related claim is being made.

### [[12_A.06.M - Module Relation Repair|A.6.M]]:4.6 - Lowering and Reopen Conditions

Lower an [[12_A.06.M - Module Relation Repair|A.6.M]] repair to reduced-use cue, quote-only wording, blocked use, or incomplete rewrite when the module-interface relation, interface specification, admissibility conditions, substitutability policy, or change policy cannot be stated by value.

Reopen the repair when any of these change: the whole holon, candidate module holon, boundary, interface specification, explicit interface gap, substitutability policy, change policy, platform grammar, conformance expectation, evidence path relied on, source-label recovery from [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]], team-boundary correspondence, work correspondence, or the governing pattern for a related claim being made.

If the reopened material is no longer a module-interface relation, [[12_A.06.M - Module Relation Repair|A.6.M]] keeps only the previous repair as source context and the claim being made is governed by the pattern named in `A.6.M:12`.

## [[12_A.06.M - Module Relation Repair|A.6.M]]:5 - Archetypal Grounding
...
Holon and episteme: the candidate module and whole are described holons under a module relation; they may be systems, epistemes, methods, organizations, publication families, or other structured holons. The module relation, interface specification, platform grammar, and open-architecture claim are Description epistemes, specification-use descriptions, or relation records about those holons. Stratification and architecture-operation labels named by [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] remain source labels unless [[03_C.30.STRAT - Stratification Wording Precision Restoration|C.30.STRAT]] recovers a module-interface relation that [[12_A.06.M - Module Relation Repair|A.6.M]] can use.

## [[12_A.06.M - Module Relation Repair|A.6.M]]:6 - Bias-Annotation

| Bias risk | [[12_A.06.M - Module Relation Repair]] repair |
| --- | --- |
...
| Component bias | Do not treat every part as a module. Apply [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases]] to component wording unless a module-interface relation is being claimed. |
...
| Parallelism bias | Do not treat decomposition into more modules, teams, services, or paths as performance or evolvability improvement. Recover serial work, synchronization, communication overhead, shared resources, and bottleneck claims through [[00_E.18 - Transformation Flow Structure]], [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]], [[00_C.29 - Mathematical Lens Use]], [[00_C.31 - Modularity and Reusable Structure Characteristics]], or neighboring characteristic patterns when those claims are being made. |
...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:7 - Conformance Checklist
...
| `CC-A6M-2` | The repair states whether the phrase is a module relation, component relation, function allocation, procedural or work-package relation, role or enactor relation, deployment or placement structure, interface specification, signature, port or endpoint, transformation-flow crossing, mechanism realization, platform grammar, control relation, autonomy-like operation claim, [[03_C.30.STRAT - Stratification Wording Precision Restoration]] source-label case, or open-architecture claim. |
| `CC-A6M-3` | No new root kind is minted for module, interface, platform, or open architecture; stratification or architecture-operation source labels use [[03_C.30.STRAT - Stratification Wording Precision Restoration]] unless a module-interface relation has already been recovered. |
...
| `CC-A6M-8` | A current [[00_G.02 - SoTA Harvester & Synthesis]] source row for MOSA, open systems, platform practice, Conway correspondence, team-boundary correspondence, or Amdahl-style decomposition limits appears before guidance from that source is used for practitioner-facing claims being made. |
...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:8 - Common Anti-Patterns and How to Avoid Them
...
| `SignatureAsInterface` | A signature declaration is treated as implemented compatibility. | Keep signature under [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] and add interface-specification fields only when interface compatibility is being claimed. |
...
| `TeamBoundaryAsModule` | A team boundary, team responsibility label, communication boundary, or delivery unit is treated as a module interface. | Recover [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.02 - Role Taxonomy]], `VP.Procedural`, or `VP.RoleEnactor`; add [[12_A.06.M - Module Relation Repair]] only for the declared module-interface relation; use [[00_C.29 - Mathematical Lens Use]] when a homomorphism-like correspondence claim is being made. |
| `MoreModulesMeansBetter` | More modules, teams, services, threads, or parallel paths are treated as automatic improvement. | Recover serial work, synchronization, communication overhead, shared resources, and bottleneck claims; mathematical speedup or homomorphism claims are governed by [[00_C.29 - Mathematical Lens Use]], and characteristic tradeoffs are governed by [[00_C.31 - Modularity and Reusable Structure Characteristics]] and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]]. |
...
| `StackAsArchitecture` | A stack diagram is treated as the architecture itself or as a module-interface relation by label. | Apply [[03_C.30.STRAT - Stratification Wording Precision Restoration]] first; then use [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] or [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] for architecture or structural-view use, [[12_A.06.M - Module Relation Repair]] only for a recovered module-interface relation, or ordinary source-label disposition. |

## [[12_A.06.M - Module Relation Repair|A.6.M]]:9 - Consequences
...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:10 - Rationale
...
[[12_A.06.M - Module Relation Repair|A.6.M]] follows [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]: overloaded relation language is repaired by reconstructing kind, slots, qualifiers, admissible use, and witnesses. It also follows the architecture relation discipline: boundary notes catch the first confusion, while [[12_A.06.M - Module Relation Repair|A.6.M]] supplies the full repair body for module relation, interface specification, substitutability, change policy, and open-architecture conformance and admissible-use claims.

The pattern deliberately keeps measurement out of the first move. A module relation can be repaired before anyone knows whether external coupling density, interface standardization share, evidence reuse, or reusable-structure accounting will be needed. When those claims are being made, [[12_A.06.M - Module Relation Repair|A.6.M]] applies [[00_C.31 - Modularity and Reusable Structure Characteristics|C.31]], [[01_C.31.RSA - Reusable Structure Accounting|C.31.RSA]], and [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]].

## [[12_A.06.M - Module Relation Repair|A.6.M]]:11 - SoTA-Echoing
...
| Architecture-operation language, with neural-network and software-system intakes as source examples | Current practitioner-language source examples accepted by the architecture workstream; used as recognition material, not as a standard or current-best-known authority. | [[03_C.30.STRAT - Stratification Wording Precision Restoration]] source labels, including source examples such as `block`, `layer`, `expert`, `router`, `cache`, and `state`, are useful recognition prompts. | Keep them as source labels until the recovered FPF kind, relation, claim-use, or source-use disposition is known; use [[12_A.06.M - Module Relation Repair]] only for module-interface relation, interface specification, platform grammar, substitutability, or open-architecture module-interface claims. | Do not import source-context labels as module kinds or evidence of adequacy. | The same repair works for neural-network block replacement, hardware module substitution, organizational module repair, and episteme-module repair without making any source context the ontology. |
...
## [[12_A.06.M - Module Relation Repair|A.6.M]]:12 - Relations

| Pattern | Relation |
| --- | --- |
| [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline]] | [[12_A.06.M - Module Relation Repair]] is an RPR specialization for module-relation and interface-specification language. |
| [[03_C.30.STRAT - Stratification Wording Precision Restoration]] | Recovers stratification and architecture-operation source labels before [[12_A.06.M - Module Relation Repair]] governs only recovered module-interface relation cases. |
| [[00_E.16 - RoC-Autonomy Budget & Enforcement]] | Governs autonomy-budget, autonomous operation, independent acting, unsupervised decision or action, and freedom-of-action claims when those description or view uses are being made; [[12_A.06.M - Module Relation Repair]] keeps only the module-interface relation, boundary, interface specification, and substitution or change-policy slice. |
| [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases]] | Component and part-whole wording uses [[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases]] first unless a module-interface relation is being claimed. |
| [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType]] and [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)]] | Signatures, slots, ports, endpoints, and field structure remain governed by signature and slot discipline. |
| [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]], [[03_A.06.C - Contract Unpacking for Boundaries]], and [[16_A.06.08 - Service Polysemy Unpacking (RPR-SERV)]] | Boundary, interface-specification, API, protocol, service, promise, and duty wording uses [[12_A.06.M - Module Relation Repair]] only when the claim is module-interface relation, interface specification, substitutability, change policy, platform grammar, or open-architecture module-interface claim. |
| [[00_C.30 - Grounded Architecture and Selected-Structure Adequacy]] and [[04_C.30.ASV - Architecture Structural View Adequacy (ASV)]] | Architecture claims and module-interface structural views stay architecture-governed. |
| [[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)]] | Function and functional wording stays distinct from module allocation. |
| [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] and [[00_A.02 - Role Taxonomy]] | Method, work-plan, performed-work, role-assignment, role claims, enactor claims, team-boundary wording, and delivery-unit wording are governed by [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]], [[00_A.02 - Role Taxonomy]], `VP.Procedural`, or `VP.RoleEnactor` unless a module-interface relation or correspondence is recovered; [[12_A.06.M - Module Relation Repair]] governs only that recovered module-interface slice. |
| [[00_E.18 - Transformation Flow Structure]] and [[07_C.30.TFS-REL - Architecture Transformation-Flow Structure Relation]] | [[00_E.18 - Transformation Flow Structure]] transformation-flow relations, path slices, crossings, and flow valuations are not interface specifications. |
| [[00_C.31 - Modularity and Reusable Structure Characteristics]] | Modularity and reusable-structure characteristics are governed by [[00_C.31 - Modularity and Reusable Structure Characteristics]] after relation repair when characteristic or measurement use is being made. |
| [[01_C.31.RSA - Reusable Structure Accounting]] | Reusable-structure accounting is governed by [[01_C.31.RSA - Reusable Structure Accounting]] when reusable loci, bespoke residue, or report-only share claims are being made. |
| [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)]] | Measurement, score, scale, unit, comparability, and evidence-stub legality remain C.16-governed. |
| [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph]], [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)]], [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]], [[00_E.20 - Mechanism Introduction Protocol]], [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry]], [[00_C.11 - Decision Theory (Decsn-CAL)]] | Evidence, assurance, gates, causal use, mechanism suites, set-return selection, and local decisions use their governing patterns; they are not [[12_A.06.M - Module Relation Repair]] claims. |

## [[12_A.06.M - Module Relation Repair|A.6.M]]:End
