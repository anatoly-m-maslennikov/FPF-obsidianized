...
**Placement.**
Part A > cluster **[[00_A.06 - Signature Stack & Boundary Discipline|A.6]] Signature Stack & Boundary Discipline** > specialisation of **[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** for under-specified affordance-like and action-first language.

**Builds on.**
[[00_A.03 - Transformer Constitution (Quartet)|A.3]], [[00_A.06 - Signature Stack & Boundary Discipline|A.6]], [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]], [[18_A.06.S - U.SignatureEngineeringPair - Signature engineering via a ConstructorSignature and a TargetSignature|A.6.S]], [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]], [[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]], [[06_A.02.06 - Unified Scope Mechanism (USM)- Context Slices & Scopes|A.2.6]], [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]], [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[00_E.08 - FPF Authoring Conventions & Style Guide|E.8]], [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_F.09 - Alignment & Bridge across Contexts|F.9]], [[00_F.18 - Local-First Unification Naming Protocol|F.18]].

**Coordinates with.**
**[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** for evaluative-language repair; **[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]]** for language-state chart positions, articulation and closure coordination, admissible moves, early cue routing, responsibility handoff, and admissible retreat when a published invitation must be reopened; use **[[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or handoff history itself must be published as an explicit trajectory account; **[[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]** when the admissible continuation is still an open probe question rather than an invitation; **[[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for articulation, closure, anchoring, and representation-factor facets referenced but not governed here; **[[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]** and **[[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]** for evidence and assurance; **[[00_B.04 - Canonical Evolution Loop|B.4]]** and **[[00_B.05 - Canonical Reasoning Cycle|B.5]]** for anomaly-driven cycles; **[[03_E.17 - Multi-View Publication Kit|E.17]]** and **[[00_E.18 - Transformation Flow Structure|E.18]]** for viewpoint publication; **[[01_F.09.01 - Bridge Stance Overlay|F.9.1]]** for bridge-stance annotations; **[[03_C.03.03 - KindBridge & CL^k - Cross-context Mapping of Kinds|C.3.3]]** for kind-bridge repair when endpoint kind mismatches appear.

**[[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] relation.**
[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] is the precision-restoration realization pattern for action-invitation wording only. [[00_E.10 - Unified Lexical Rules for FPF|E.10]] or [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]] sends wording here when action-first language still hides a site, invited enactor, candidate action, coupling frame, detector or viewpoint, normal form, admissible use, or governing-pattern boundary after quality, capability, deontic, work, evidence, assurance, gate, decision, publication, state-family, architecture, function-like, and relation-only cases have been excluded or assigned to their patterns governing the recovered claims. If the repaired phrase is primarily evaluative, use [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]; if it is primarily capability, method, work, duty, evidence, assurance, gate, or decision, use the governing pattern and keep [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] only as an optional preceding invitation record when the invitation semantics remain live.
...
* where the repaired statement is primarily **evaluative**, use **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]**;
* where it is primarily about **general capability**, capability wording, method wording, or method-description wording, use **[[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]**, `U.Capability`, `U.Method`, or `MethodDescription` according to the claim being made;
* where it is primarily **deontic**, apply **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]**;
* where it is primarily about **scheduled or executed enactment**, dock to **[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** (`U.Method`, `U.MethodDescription`, `U.WorkPlan`, or actual `U.Work` once execution has occurred) rather than letting `actionInvitation(...)` become a shadow execution model.

## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:1 - Problem frame
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:2 - Problem
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:3 - Forces
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4 - Solution - Stable lens -> Sense Family -> Slots -> Normal Form -> Change Lexicon -> Guardrails

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.0 - Trigger rule

A use of affordance-like or action-first language is in scope for [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] when any of the following holds:
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.0a - Operational repair sequence

When the trigger fires, authors SHOULD follow the [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] repair path:
...
5. **Route boundary-bearing consequences.**
   If the repaired statement is used for admissibility, commitments, publication, automation, or evidence-bearing decisions, route the downstream hooks through **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** and, where enactment is implied, through **[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]**, instead of letting the vague action-first phrase carry evidence, admissibility, gate, or decision consequences by itself.

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.1 - Post-threshold lens: action-invitation classification anchored by `actionInvitation(...)`
...
Early action-guiding cue content may remain in [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]] or [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] as cue-pack content, a `RoutedCueSet`, or another typed route-bounded upstream publication before this pattern is entered.
[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] is therefore entered only once local `AE` is high enough to name site, enactor, and action structure explicitly and local `CD` is high enough that one invitation interpretation is worth publishing as a relation record rather than remaining cue-pack or route-candidate content. If the admissible publication is still a cue pack, routed cue, or open abductive prompt, stay in [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]], or [[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]].
If a published `actionInvitation(...)` later loses those minimal articulation and closure conditions, retreat via [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]] rather than leaving a stale invitation record live.

In [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]] terms, this pattern fixes one post-threshold relation family and one downstream classification discipline:
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.1a - RelationKind specification skeleton for `actionInvitation`
...
Within the scope of [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] it must be rewritten into an explicit `actionInvitation(...)` instance with declared downstream governing pattern or publication; earlier pre-threshold cue content may instead remain as cue-pack content, a `RoutedCueSet`, or another typed route-bounded upstream publication before [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] entry.
...
**P2W docking note.**
`candidateActionTuple` names the invited move as relation content. It is not an actual `U.Work` occurrence, not a `U.WorkPlan`, not a `U.MethodDescription`, and not a selected method. When the publication needs intended work, planned work, actual work, method selection, work result, or result measurement, it docks to [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], [[01_A.15.01 - U.Work|A.15.1]], or [[02_A.15.02 - U.WorkPlan|A.15.2]] instead of stretching `actionInvitation(...)`.

**[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] boundary note.**
...
If a publication face, publication form, interop publication form, carrier, or rendering participates, declare it in `publicationOrCarrierParticipation` under [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and publication-face and publication-form discipline rather than widening the site classification with a generic quoted `Surface` token.
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.2 - Core construct: `ActionInvitationSense`
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.2a - [[00_A.16 - Language-State Move Coordination|A.16]] alias-docking note

[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] carries `articulationHint` only as a **local alias field**.

This field is deliberately **not** a new formality progression, **not** a maturity scale, and **not** a surrogate for **F**. Its only job is to preserve local articulation and closure cues until they are docked to [[00_A.16 - Language-State Move Coordination|A.16]] move logic and the explicit [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]] and [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]] governing facets.

Local `articulationHint` tokens SHALL dock to [[00_A.16 - Language-State Move Coordination|A.16]] move logic and to the explicit [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]] and [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]] governing facets one-for-one, and [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] SHALL treat them as aliases or publication conveniences only.
Until then, local hints SHALL NOT be thresholded, aggregated, or compared across Contexts.

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.3 - Normative starter set of sense families
...
* If the sentence is chiefly about **better, worse, fit, or merit**, use **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** instead of [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]].

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.4 - Required slots for a conforming `actionInvitation`
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.5 - Normal-form discipline
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.6 - Separation from quality, capability, commitment, and work

[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] SHALL prevent the collapse of action invitation language into neighbouring families.

* A statement about **better, worse, fit, or merit** belongs to **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]**.
* A statement about **what a system can do in general** belongs to capability wording, method wording, or method-description wording under **[[11_A.06.F - Function and Functional Precision Restoration (RPR-FUNCTION)|A.6.F]]** and the governing pattern for the asserted capability, method, or method-description claim.
* A statement about **what must be done** belongs to **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** when the wording asserts an A-classified admissibility claim or a D-classified commitment claim.
* A statement about **what was actually done** belongs to **[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** and `U.Work`.
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.7 - Bridge discipline across traditions
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.8 - Change lexicon

A conforming pattern SHALL narrate changes with a stable change lexicon aligned to [[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]:
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.9 - Lexical guardrails
...
* **actionable insight** MUST be rewritten to `ActionOption`, `OptionSet`, or `PolicyHook`, or to **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** if the use is primarily evaluative;
...
* `articulationHint` MUST NOT be treated as **F**, as acceptance status, or as a replacement for [[00_A.16 - Language-State Move Coordination|A.16]] anchors;
* generic `Surface` facet tokens MUST NOT be introduced inside [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]; publication face, publication form, interop publication form, carrier, or rendering participation must be declared under [[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]] and publication-face and publication-form discipline, not by widening the site classification;
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:4.10 - Progressive elaboration

[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] allows monotone elaboration:
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:5.3 - Show (Episteme lane)
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:6 - Bias-Annotation
...
* **Gov bias:** this pattern may tempt authors to smuggle decisions into invitation language.
  *Mitigation:* explicit [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] routing and obligation barrier.
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:7 - Conformance Checklist (CC-[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]])

A text or pattern conforms to [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] iff:

1. **CC-A.6.A-1 — Explicit post-threshold relation family and explicit sense.**
   Every in-scope post-threshold action-first use resolves to one declared `actionInvitation(...)` instance and one declared `ActionInvitationSense`; earlier cue-like content stays under [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]] or [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]] instead of being forced into [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] prematurely.
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:8 - Common Anti-Patterns and How to Avoid Them
...
| **Invitation-as-obligation**   | "This calls for rollback" is treated as if rollback is already required                     | hides A-classified or D-classified routing and accountability | publish `actionInvitation(...)`, then route duty or gate use via [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]] |
| **Invitation-as-work**         | “The system reacted” is used where only a cue or option exists                              | confuses offer with execution                          | keep invitation separate from [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] and `U.Work`                   |
...
| **Premature automation**       | a cue without required witness records is wired directly into gates or controllers with no explicit hook `authoritySourceRef` named source or guard | creates unsafe action pathways                         | require `PolicyHook`, [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)]] routing, and witnesses                |
| **ArticulationHint as F proxy**| `hook-explicit` is treated as "more formal"                                                | recreates a forbidden second formality characteristic          | keep F in [[05_C.02.03 - Unified Formality Characteristic F]]; reserve articulation and closure semantics for [[00_A.16 - Language-State Move Coordination]] |

## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:9 - Consequences
...
It also complements [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] cleanly: [[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]] repairs **evaluative** ambiguity, while [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] repairs **action-inviting** ambiguity.
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:10 - Rationale

[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] makes one strategic move:
...
* **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** governs evaluative repairs,
* **[[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]** governs action-invitation repairs,
* **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** governs boundary routing,
* **[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** governs enactment and work,
* **[[00_A.16 - Language-State Move Coordination|A.16]]** governs articulation and closure progression and admissible moves,
* **[[05_C.02.03 - Unified Formality Characteristic F|C.2.3]]** remains the sole governing pattern for formality characteristic **F**.

## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:11 - SoTA-Echoing

Recent philosophical and ecological work treats affordances as **action-relevant possibilities** perceived in engagement and, in some accounts, as **invitations for action**, rather than as viewpoint-free monadic site-participant properties. [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts that relational, action-first stance, adapts it by forcing explicit `siteTuple`, `invitedEnactorTuple`, and `couplingFrame` publication, and rejects silent collapse into monadic site-participant labels. ([Frontiers][1], [Springer][2])

Recent empirical review work on affordance perception emphasises **attunement and recalibration** in person-plus-environment systems rather than fixed, context-free labels. [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts the need for enactor- and situation-specific publication, adapts it into `CuePack`, `ActionOption`, and `OptionSet` normal forms, and rejects any assumption that an affordance phrase is already an admissible characteristic, scale, or universally portable invariant. ([Springer][2])

Current active-inference work frames generative models in **action-perception loops** and, in many cases, **action-oriented models** that are for adaptive interaction rather than only detached description. [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts the action-oriented emphasis and the separation between model-side cueing and enacted action; it adapts this by making `detector` and `invitedEnactor` explicit and by forbidding latent policy cues from counting as work, commitment, or explicit rationale by default. ([UCL Discovery][3])

Current robotics work increasingly uses affordances as **intermediate representations** between perception-language representations and concrete action, including compact keypoint or staged affordance plans. [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]] adopts this as evidence that affordance publication can be an admissible intermediate publication form; it adapts it into `ActionOption`, `OptionSet`, and `PolicyHook`, and rejects silent promotion of such representations into deontic obligation, proof of correctness, or objective value. ([Robotics: Science and Systems][4])
...
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12 - Relations

* **Specialises:** **[[09_A.06.P - Relational Precision Restoration (RPR) - Kind-Explicit Qualified Relation Discipline|A.6.P]]** as an RPR pattern for overloaded affordance-like and action-first language.
* **Builds on:** **[[00_A.03 - Transformer Constitution (Quartet)|A.3]]** and **[[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]]** for enactor discipline and EntityOfConcern and Description-episteme plus publication and carrier separation; **[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]** for keeping invitation distinct from enactment; **[[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]** for boundary routing; **[[03_E.17 - Multi-View Publication Kit|E.17]]** and **[[00_E.18 - Transformation Flow Structure|E.18]]** for viewpoint publication.
* **Works alongside:** **[[02_C.16.Q - Quality-Term Precision Restoration|C.16.Q]]** for evaluative language; the two are siblings, not substitutes.
* **Coordinates with:** **[[04_C.02.2a - U.LanguageStateSpace - Language-state chart over U.CharacteristicSpace|C.2.2a]], [[00_A.16 - Language-State Move Coordination|A.16]], [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]], [[03_A.16.02 - Reopen - SketchBackoff - Respecify|A.16.2]], and [[01_B.04.01 - Observe -- Notice -- Stabilize -- Route|B.4.1]]** for language-state chart positions, admissible moves before post-threshold repair, and retreat when a published invitation must be reopened; use **[[01_A.16.00 - U.LanguageStateMoveTrajectory - Optional trajectory-account normal form over the language-state U.CharacteristicSpace|A.16.0]]** only when lineage, branch, loss, or handoff history itself must be published as an explicit trajectory account; **[[01_B.05.02.00 - U.AbductivePrompt|B.5.2.0]]** for probe-question cases that are still prompt-shaped; **[[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]]** for language-state facet governance.
* **Must not replace:** **[[05_C.02.03 - Unified Formality Characteristic F|C.2.3]]** as the single governing pattern for **F**.
* **Recommends publication via:** **[[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[00_F.17 - Unified Term Sheet (UTS)|F.17]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]]** when `actionInvitation` tokens, starter senses, and red-flag rewrites become shared vocabulary.
...
### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.1 - Language-space refactor note
This pattern is scoped to **action-invitation repair and endpoint handoff**, not to the whole early cue lane. Early action-guiding cue content may remain in [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]] as cue-pack content, a `RoutedCueSet`, or another typed route-bounded upstream publication before it stabilizes into `actionInvitation(...)`.

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.2 - Canonical downstream seam
`actionInvitation(...)` should be classified through [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]] and connected to [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] when work enactment is live toward gates, commitments, methods, or work. Operator-facing starter senses such as `AIS.AlertInterventionCue` or `AIS.OperatorInterventionCue` should not be buried under generic `AIS.InterfaceAffordance` when human factors and policy hooks substantively differ.

### [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:12.3 - Governance boundary
Bridge stances, articulation-state governing patterns, authority-reference fields, and language-state facet characteristics are **referenced** by this pattern but remain governed by [[01_F.09.01 - Bridge Stance Overlay|F.9.1]], [[00_A.16 - Language-State Move Coordination|A.16]], [[06_C.02.LS - U.LanguageStateFacetProfile - Thin profile bundle for language-state facets|C.2.LS]], [[07_C.02.04 - U.ArticulationExplicitness|C.2.4]], [[08_C.02.05 - U.LanguageStateClosureDegree|C.2.5]], [[09_C.02.06 - U.LanguageStateAnchoringMode|C.2.6]], and [[10_C.02.07 - U.LanguageStateRepresentationFactorBundle|C.2.7]].
## [[10_A.06.A - U.ActionInvitationPrecisionRestoration - Affordance and Action-Invitation Precision Restoration (ACT-INV)|A.6.A]]:End
