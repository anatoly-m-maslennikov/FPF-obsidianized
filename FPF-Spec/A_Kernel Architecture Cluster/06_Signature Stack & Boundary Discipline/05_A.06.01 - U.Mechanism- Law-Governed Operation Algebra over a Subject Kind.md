...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:1 - Problem frame
...
**Not this pattern when.** If the claim is only a reusable declaration with no operation algebra and no admissibility predicates, use [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]]. If the claim is a semantic way of doing, use [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]. If the claim is an episteme describing that way, use [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]. If the claim is planned or dated work, use [[02_A.15.02 - U.WorkPlan|A.15.2]] or [[01_A.15.01 - U.Work|A.15.1]]. If the claim is evidence, assurance, gate authority, publication use, or result acceptance, use the governing pattern for that claim.

## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:2 - Problem
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4 - Solution

### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.1 - Definition
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.2 - Mechanism declaration
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.3 - Kernel-token declarations
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.4 - Method and mechanism positions
...
A solver-selection scheme can be a `U.Method` in one bounded context; a selector mechanism can declare operations over candidate methods; a selected method can fill a mechanism slot; and a mechanism realization can be implemented through a method description and enacted in dated work. Those links do not make [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] sufficient for a mechanism claim or [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] sufficient for a method claim.
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.5 - Morphisms and constructors
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.6 - Description records
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.7 - Defaults
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:4.8 - USM and UNM as mechanism instances
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5 - Archetypal Grounding

### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.1 - Selector mechanism
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.2 - Scope mechanism
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.3 - Normalization mechanism
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:5.4 - Publication mechanism
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:6 - Bias-Annotation
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:8 - Common Anti-Patterns and How to Avoid Them
...
| Method label treated as mechanism law | Recover the current use-position first; use [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]] only when operation algebra, laws, admissibility predicates, transport, audit, or realization relation are current. |
| Tool configuration treated as mechanism declaration | Keep tool settings in the direct tooling, publication, work, or evidence pattern; put only mechanism semantics in [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind]]. |

## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:9 - Consequences
...
| Method, mechanism, work, evidence, and gate claims stay separated. | Source labels often need [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture]] recovery before typed assignment. |
...
### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:9.1 - Quick use cards
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:10 - Rationale
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12 - Relations
...
* **Coordinates with:** `A.3.1 U.Method`; `A.3.2 U.MethodDescription`; `A.15.2 U.WorkPlan`; `A.15.1 U.Work`; [[00_A.19 - CharacteristicSpace & Dynamics Hook (A.CHR-SPACE)|A.19]]; [[00_C.16 - Measurement & Metrics Characterization (MM-CHR)|C.16]]; [[00_C.29 - Mathematical Lens Use|C.29]]; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]; [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]]; [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]; [[00_E.18 - Transformation Flow Structure|E.18]]; [[00_E.20 - Mechanism Introduction Protocol|E.20]].
...
* **Uses for precision restoration:** [[00_E.10 - Unified Lexical Rules for FPF|E.10]], [[01_E.10.ARCH - Wording-Use Ontological Precision Restoration Architecture|E.10.ARCH]], and [[00_F.18 - Local-First Unification Naming Protocol|F.18]]; use `E.10.ARCH:3.1` when source labels such as `algorithm`, `program`, `workflow`, `process`, `procedure`, `recipe`, `solver`, or `control strategy` hide the current relation position.

### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12.1 - P2W mechanism-use relation

When [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] reaches a mechanism cue, [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]] carries the mechanism meaning: operation algebra, LawSet, AdmissibilityConditions, realization relation when declared, transport, and mechanism descriptions. P2W may name the cue and governing pattern, but it does not define these mechanism relations locally.

If the issue under repair is new mechanism introduction, mechanism stabilization, or method-related mechanism use, use [[00_E.20 - Mechanism Introduction Protocol|E.20]] when mechanism-governing-definition assignment is current. A P2W citation of a mechanism does not select a method, execute work, pass a gate, prove evidence, or certify a result.

### [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:12.2 - Lowering, repair, and refresh conditions

A `U.Mechanism` remains usable while its MechanismDeclaration, imported signatures, SlotSpecs, LawSet, AdmissibilityConditions, Applicability, Transport, GammaTimePolicy, PlaneRegime, and Audit relations remain recoverable and monotone with respect to [[04_A.06.00 - U.Signature - Universal, law-governed declaration for a SubjectKind on a BaseType|A.6.0]].
...
## [[05_A.06.01 - U.Mechanism- Law-Governed Operation Algebra over a Subject Kind|A.6.1]]:End
