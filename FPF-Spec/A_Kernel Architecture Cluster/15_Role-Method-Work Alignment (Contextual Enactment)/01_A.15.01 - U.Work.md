...
3. Decide whether the encountered record, trace, or source-looking carrier is performed `U.Work`, only a plan ([[02_A.15.02 - U.WorkPlan|A.15.2]]), only a method ([[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]), only a method description ([[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), only evidence for work ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]]), only a publication-use relation ([[03_E.17 - Multi-View Publication Kit|E.17]]), only a declarative representation ([[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] or the direct representation pattern), or a work-relevant source-restoration case ([[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]).
...
**Not this pattern when.** Not this pattern when the current claim is only a method ([[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]]), only a method description ([[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]]), only a plan or schedule ([[02_A.15.02 - U.WorkPlan|A.15.2]]), only a `SlotFillingsPlanItem` ([[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]), only a visible source cue that must be restored before reliance ([[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]), only evidence or assurance ([[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]), only publication-use behavior ([[03_E.17 - Multi-View Publication Kit|E.17]]), or only a declarative representation overread as a work-control or method claim ([[01_C.02.P.DR - Declarative Representation Precision Restoration|C.2.P.DR]] or the direct representation pattern).

## [[01_A.15.01 - U.Work|A.15.1]]:1 - Problem Frame
...
## [[01_A.15.01 - U.Work|A.15.1]]:2 - Problem (what breaks without a clean notion of Work)
...
## [[01_A.15.01 - U.Work|A.15.1]]:3 - Forces (what the definition must balance)
...
## [[01_A.15.01 - U.Work|A.15.1]]:4 - Solution — define `U.Work` as the accountable, dated occurrence

### [[01_A.15.01 - U.Work|A.15.1]]:4.1 - Definition
...
### [[01_A.15.01 - U.Work|A.15.1]]:4.2 - Core reference descriptors (conceptual descriptors; not a data schema)
...
9. **Context** — the bounded context under which this run is judged, normally inherited from the method-description source and `U.RoleAssignment`; see [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] for cross-checks.
...
12. **Evidence and telemetry (optional)** — if the run feeds **[[00_G.11 - Telemetry-Driven Refresh & Decay Orchestrator|G.11]]** refresh or QD and OEE archives, cite **PathId** or **PathSliceId** and the current declared **policy-id** used for illumination; do not elevate telemetry into dominance without CAL policy.

### [[01_A.15.01 - U.Work|A.15.1]]:4.3 - Clear distinctions (the four‑slot grammar in action)
...
### [[01_A.15.01 - U.Work|A.15.1]]:4.4 - Publication-use boundary for `U.Work`
...
### [[01_A.15.01 - U.Work|A.15.1]]:4.5 - Crossing visibility for work publications
...
## [[01_A.15.01 - U.Work|A.15.1]]:5 - Work mereology (how runs form holarchies)
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.1 - Parts and wholes of Work (design‑neutral, run‑time facts)
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.2 - Key relations among Work
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.3 - Operators for roll‑ups (Γ\_time and Γ\_work)
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.4 - Identity of a Work (extensional criterion, pragmatically framed)
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.5 - Interruptions, retries, resumptions (episode policy)
...
### [[01_A.15.01 - U.Work|A.15.1]]:5.6 - Compositionality of effects (Δ)
...
## [[01_A.15.01 - U.Work|A.15.1]]:6 - Archetypal grounding (parallel domains)

### [[01_A.15.01 - U.Work|A.15.1]]:6.1 - Surgical case (overlap and episodes)
...
### [[01_A.15.01 - U.Work|A.15.1]]:6.2 - ETL pipeline (parallelism and retries)
...
### [[01_A.15.01 - U.Work|A.15.1]]:6.3 - Thermodynamic cycle (work as a state-space path)
...
## [[01_A.15.01 - U.Work|A.15.1]]:7 - Bias‑Annotation (as in E‑cluster)
...
### [[01_A.15.01 - U.Work|A.15.1]]:9.2 - Resource aggregation `Γ_work`
...
## [[01_A.15.01 - U.Work|A.15.1]]:10 - Cross-Context Checks (MethodDescription, RoleAssignment, and Work)
...
## [[01_A.15.01 - U.Work|A.15.1]]:11 - Anti‑patterns (and the right move)
...
## [[01_A.15.01 - U.Work|A.15.1]]:12 - Legacy work-log repair moves
...
## [[01_A.15.01 - U.Work|A.15.1]]:13 - Consequences
...
## [[01_A.15.01 - U.Work|A.15.1]]:13a - SoTA Alignment
...
## [[01_A.15.01 - U.Work|A.15.1]]:14 - Relations

* **Builds on:** [[00_A.01 - U.Holon, U.System, and U.Episteme|A.1]] Holonic Foundation; [[01_A.01.01 - U.BoundedContext Semantic Frame|A.1.1]] `U.BoundedContext`; **U.System**; [[00_A.02 - Role Taxonomy|A.2]] `U.Role`; [[01_A.02.01 - U.RoleAssignment- Contextual Role Assignment|A.2.1]] `U.RoleAssignment`; [[02_A.02.02 - U.Capability|A.2.2]] `U.Capability`; [[01_A.03.01 - U.Method- Context-Defined Way of Doing|A.3.1]] `U.Method`; [[02_A.03.02 - U.MethodDescription- Description Episteme for a Way of Doing|A.3.2]] `U.MethodDescription`.
* **Coordinates with:** [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role-Method-Work Alignment (the "four-slot grammar"); [[00_B.01 - Universal Algebra of Aggregation (Γ)|B.1]] Γ (aggregation) for resource and time operators; E-cluster lexical rules (L-PROC and L-FUNC).
...
## [[01_A.15.01 - U.Work|A.15.1]]:15 - Didactic quick cards
...
## [[01_A.15.01 - U.Work|A.15.1]]:15a - P2W Performed-Work Use Relation

When [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] reaches performed work, `U.Work` states the dated occurrence: performer, method-description source, parameters, resources, time window, pre-state, post-state, outputs, outcome, and audit trace.
...
## [[01_A.15.01 - U.Work|A.15.1]]:16 - Lowering, Repair, and Refresh Conditions
