...
**Working enactment-alignment spine.** Role, method, plan, and work confusion -> separate role, holder, context, method description, intended `U.WorkPlan`, and actual `U.Work` -> choose proceed, plan, bounded probe, narrow, hand off, or stop -> output the smallest alignment frame needed for the next project move -> use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] only when an encountered episteme publication, display, credential view, explanation, copied statement, provenance mark, dashboard tile, schema wording, API wording, or composed source chain begins to carry or justify a work claim or reliance claim.
...
**Reliance-bearing use.** Use the fuller alignment frame when an encountered source-looking carrier or display is about to guide planned work, actual work, role attribution, status attribution, release reliance, disputed responsibility, or cross-context use. Use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] when the issue under repair is whether that carrier or display has the project-side FPF kind and reference named by value needed for that work claim or reliance claim.
...
**Not this pattern when.** Not this pattern when the honest need is only one dated work occurrence ([[01_A.15.01 - U.Work|A.15.1]]), only planning or schedule baseline ([[02_A.15.02 - U.WorkPlan|A.15.2]]), only a cue note that has not yet become an enactment-alignment question ([[00_A.16 - Language-State Move Coordination|A.16]] or [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]]), only boundary wording or policy wording without a role-method-work question under repair ([[00_A.06 - Signature Stack & Boundary Discipline|A.6]] or [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]]), or work-relevant source restoration for an encountered source-looking carrier or display ([[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]).

**Related project records and governing patterns.** [[01_A.15.01 - U.Work|A.15.1]] governs dated execution records, [[02_A.15.02 - U.WorkPlan|A.15.2]] schedule or baseline planning records, [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]] slot-filling plan items, [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] work-relevant source restoration, [[01_B.05.01 - Explore → Shape → Evidence → Operate|B.5.1]] Explore -> Shape -> Evidence -> Operate for project progression, [[00_F.11 - Method Quartet Harmonisation|F.11]] method and work vocabulary alignment across contexts, and [[00_F.17 - Unified Term Sheet (UTS)|F.17]] the human-facing work sheet.

**Causal-use work boundary.** Realized counterfactual-sampling work, counterfactual randomization, intervention assignment, target-trial emulation work, and causal evidence collection remain `U.MethodDescription`, `U.WorkPlan`, and `U.Work` structures here. [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] can say who performs which sampling or intervention work under which method and role; it does not make the resulting causal use admissible. [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability|C.28]] governs the causal-use question, `CausalityLadderRung`, causal estimand, `CausalEvidenceSupportBasis`, counterfactual sampling realizability, and supported use and unsupported use.

**Related-record mistakes.** If the first honest encountered source-looking cue is still only a cue, keep it under [[00_A.16 - Language-State Move Coordination|A.16]] or [[02_A.16.01 - U.PreArticulationCuePack|A.16.1]]; if the question under repair is boundary wording, promise, agreement-like service, or policy wording, recover the corresponding [[00_A.06 - Signature Stack & Boundary Discipline|A.6]] boundary-claim record; if you only need one executed occurrence rather than the alignment frame, recover the [[01_A.15.01 - U.Work|A.15.1]] dated work-occurrence record; if an encountered source-looking carrier or display is being used for a work relation or reliance relation, use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]].
...
This pattern provides the canonical alignment for modeling contextual enactment in FPF, serving as the ultimate implementation of the **Strict Distinction Principle ([[00_A.07 - Strict Distinction (Clarity Lattice)|A.7]])**. It weaves together several foundational concepts into a single, coherent model of how intended work becomes planned and actual `U.Work`:
*   **[[00_A.02 - Role Taxonomy|A.2]] (Contextual Role Assignment):** Provides the `Holder#Role:Context` structure for assigning roles.
*   **[[00_A.04 - Temporal Duality & Open-Ended Evolution Principle|A.4]] (Temporal Duality):** Provides the strict separation between `design-time` and `run-time`.
*   **[[00_A.12 - External Transformer & Reflexive Split|A.12]] (External Transformer):** Ensures that performed `U.Work` is attributed to a transformer-bearing system acting under a `U.RoleAssignment`.
...
To keep plan-run separation explicit, this pattern references **[[02_A.15.02 - U.WorkPlan|A.15.2]] `U.WorkPlan`** for **schedules and calendars** and **[[01_A.15.01 - U.Work|A.15.1]] `U.Work`** for **dated execution**. Ambiguous source terms like "process", "workflow", and "schedule" are constrained by **L-PROC**, **L-FUNC**, and **L-SCHED** (E-cluster): a _workflow_ cue normally resolves to `U.MethodDescription` unless the abstract way-of-doing itself is being claimed as `U.Method`; a _schedule_ cue resolves to `U.WorkPlan`; what _happened_ resolves to `U.Work`.
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:2 - Problem
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:3 - Forces
...
### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:4.1 - The Core Entities: A Strict Distinction
...
*   **`U.WorkPlan`:** An **`U.Episteme`** declaring **intended `U.Work` occurrences** (windows, dependencies, intended performers as role kinds, budgets) - see **[[02_A.15.02 - U.WorkPlan|A.15.2]]**.
...
### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:4.2 - The Canonical Relations: Connecting the Layers
...
### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:4.3 - Bounded specialization scouting and `CheckpointReturn`
...
### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:4.4 - Boundary to [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] Work-Relevant Source Restoration

Use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] when an encountered episteme, episteme publication, display, credential view, generated explanation, copied statement, provenance mark, dashboard tile, schema wording, API wording, or composed source chain is being used by appearance for a work claim, reliance claim, role-assignment currentness claim, status currentness claim, approval, permission, gate passage, evidence, engineering justification, release reliance, or performed `U.Work`.

[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] itself keeps the kernel separation: `U.Role`, holder, context, `U.Method`, `U.MethodDescription`, `U.WorkPlan`, actual `U.Work`, and the `U.RoleAssignment` chain between them. The source-restoration question asks which project-side FPF kind and reference named by value must be recovered before the encountered carrier or display can carry the work claim, reliance claim, or effect claim being made; that question belongs to [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] or to the source-restoration pattern governing that reliance named there.

A principle scheme, functional diagram, scenario, screen, or explanation that makes an [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] P2W carry-through structure recoverable may help the team plan work or find the needed source.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:5 - Archetypal Grounding

The role-method-work alignment applies whenever the question under repair is holder-in-role, method description, intended plan, or performed work. Physical engineering, knowledge work, and socio-technical cases can all use the same distinction without turning [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] into a universal process ontology.
...
### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:5.1.a - Briefing guides orientation, not execution
...
This briefing may orient the team and cue attention. If the team wants to execute from the briefing alone, use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] or the evidence, gate, decision, or assurance pattern governing the claim to recover the missing project-side kind and reference. Inside [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]], keep only the role, method, plan, and work-occurrence separation.

### [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:5.1.b - P2W principle-scheme publication guides planning, not occurrence

**Source set.** A team has a principle scheme that shows an [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] P2W carry-through structure for a fabrication task: signature or principle episteme, method-family selection, selected method, `U.WorkPlan`, performed `U.Work`, work-result record, and result measurement.
...
The scenario can guide method-family selection and work-planning preparation. Once the team selects a method or prepares a plan, record that project choice or plan as the selected [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] selected-method, work-plan, or work-occurrence record named by value. If the scenario is used for evidence, gate, or engineering-justification reliance, first recover the project evidence path, gate or constraint decision, or engineering-justification record named by value under [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]], [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]], [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]], or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]]; otherwise record only a source-restoration request, decision-request record, prospective work-plan entry, or source-gap note.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:6 - Bias-Annotation
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:7 - Conformance Checklist
...
| :--- | :--- | :--- |
| **CC-A15-1 (Entity Distinction)** | A conforming model SHALL keep `U.Role`, **`U.Method`**, **`U.MethodDescription`**, `U.Capability`, **`U.WorkPlan`**, and `U.Work` as distinct, non-overlapping types. | This is the core enforcement of **Strict Distinction ([[00_A.07 - Strict Distinction (Clarity Lattice)]])**. It prevents the category errors outlined in the "Problem" section. |
...
| **CC-A15-5 (No Roles in Mereology)** | A conforming model SHALL NOT place `U.Role` or `U.Capability` in a mereological (`partOf`) hierarchy. | The "Role-as-Part" anti-pattern is a violation. Roles and capabilities are functional, not structural. Enforces **[[00_A.14 - Advanced Mereology- Components, Portions, Aspects & Phases]]**. |
...
| **CC-A15-7 (Plan and Run Split)** | A conforming model SHALL represent schedules and calendars as `U.WorkPlan` ([[02_A.15.02 - U.WorkPlan]]). A `U.WorkPlan` SHALL NOT be used as evidence of execution; only `U.Work` carries actuals. | Preserves plan and run separation and prevents schedule-as-actual drift. |
...
| **CC-A15-12 (Causal-use Work Boundary)** | A conforming causal-use model MAY represent intervention assignment, counterfactual randomization, target-trial emulation, causal evidence collection, and realized counterfactual-sampling work here only as `U.Method`, `U.MethodDescription`, `U.WorkPlan`, `U.Work`, and role-assigned execution structure. Any claim that the resulting causal use is admissible SHALL cite [[00_C.28 - CausalUse-CAL- Causal-Use Questions, Causality-Ladder Rungs, Identification and Realizability]] for causal-use question, `CausalityLadderRung`, causal estimand, `CausalEvidenceSupportBasis`, `CausalUseSupportVerdict`, and supported use and unsupported use. | Prevents method, work-plan, or work-occurrence structure from being mistaken for causal-use authority. |
| **CC-A15-13 ([[04_A.15.04 - Work-Relevant Source Restoration]] Boundary)** | If an encountered source-looking carrier or display is being used for a work relation or reliance relation by appearance, a conforming [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] use SHALL use [[04_A.15.04 - Work-Relevant Source Restoration]] for the source-restoration question and keep only the `U.Role`, `U.Method`, `U.MethodDescription`, `U.WorkPlan`, and `U.Work` separation here. | Prevents the [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] kernel from absorbing source-restoration claims. |
| **CC-A15-14 (P2W Publication Boundary)** | A conforming use SHALL NOT treat a principle scheme, functional diagram, scenario, screen, or explanation that makes an [[01_E.18.01 - Principles-to-Work Carry-Through]] P2W carry-through structure recoverable as the selected method, `U.WorkPlan`, performed `U.Work`, work-result record, result measurement, or non-[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] claim by publication alone. | The project use names the selected [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] object named by value; any non-[[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] claim uses its governing pattern or [[04_A.15.04 - Work-Relevant Source Restoration]] source restoration. |

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:8 - Common Anti-Patterns and How to Avoid Them
...
- **Briefing-as-execution-cue.** A lighter review note, rollout summary, or redacted operations note may orient work; use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] or the source-restoration pattern governing that reliance before relying on it for execution, approval, gate, evidence, or plan claims.
- **P2W publication as work occurrence.** A principle scheme, functional diagram, scenario, screen, or explanation may guide selected method or work-planning moves named by value; recover the project-side FPF kind and reference named by value for any selected-method, work-plan, work-occurrence, result, evidence, gate, or engineering-justification claim, and keep the [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] carry-through structure separate from those typed values.
- **Source-looking carrier or display as work source.** A dashboard tile, credential display, copied approval, generated explanation, provenance label, command-like cue, or composed source chain is only a source candidate until [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] recovers the project-side kind and reference named by value needed for the work or reliance claim under repair.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:9 - Consequences
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:10 - Rationale
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:11 - SoTA Alignment: Adopted and Adapted Invariants and Rejected Shortcuts
...
For visible credential, provenance, dashboard, explanation, or composed-source cases that need project-side FPF kind and reference named by value before work or reliance, use [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]. The [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] family carries only the role, method, plan, and work portion of the case.

The nearest recovery loci are the manufacturing, peer-review, rollout briefing, `CC-A15-7`, `CC-A15-10`, `CC-A15-12`, and the boundary to [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]]. If a SoTA row cannot be recovered through those local checks, do not let the source citation stand in for the local [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] rule.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12 - Relations
...
*   **Is Used By and Provides Foundation For:**
    ...
    *   `C.28 CausalUse-CAL`: causal-use admissibility for intervention, counterfactual sampling, target-trial emulation, and causal evidence work; [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] keeps the role, method, work-plan, and work-occurrence chain.
...
*   **Coordinates with:** [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] for work-relevant source restoration; [[00_A.06 - Signature Stack & Boundary Discipline|A.6]], [[02_A.06.B - Boundary Norm Square (Laws - Admissibility - Deontics - Work-Effects)|A.6.B]], and [[03_A.06.C - Contract Unpacking for Boundaries|A.6.C]] for mixed boundary, policy, API, or schema wording; [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence, currentness, and provenance; [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance claims; [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for `OperationalGate(profile)`, `GateDecision`, and `DecisionLogRef`; [[00_A.20 - U.Flow.ConstraintValidity - Eulerian|A.20]] for `ConstraintValidity` status or witness; [[01_A.15.01 - U.Work|A.15.1]] for release or deployment work occurrence; and [[04_E.17.EFP - ExplanationFaithfulnessProfile - explanation-use discipline over existing MVPK faces|E.17.EFP]] for generated-explanation faithfulness or source-finding.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12a - Coordinated-work evidence and distributed-state relation note

Use [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] first when the claim is about who acts, by which method, under which role, under which work plan, producing which work result. Coordinated work, routine skill, team alignment, tacit knowledge, and role-method fit are not quantum-like by default.
...
3. Ask whether role-method-work alignment alone explains the case. If yes, stay in [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]].
4. If no participant statement, local component report, single evidence record, dashboard, or exported representation carries the inferred state faithfully enough for the intended state use, add a [[02_C.26.02 - Enacted Distributed State Evidence|C.26.2]] low-recoverability distributed-state reading.
5. State the weakest evidence-bound state-reading claim, time window, rival explanations, and export loss.
6. Carry evidence use through [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] and assurance claims through [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] when the reading will guide work, reliance, audit, readiness, release, or compliance.

Add a [[02_C.26.02 - Enacted Distributed State Evidence|C.26.2]] low-recoverability distributed-state reading only when coordinated work is being used as evidence for a state that no participant statement, local component report, single evidence record, dashboard, or exported representation carries faithfully enough for the intended state use. In [[02_C.26.02 - Enacted Distributed State Evidence|C.26.2]] terms, the reading is a minimal evidence-bound `U.Episteme` claim under carriers, window, rivals, and export limits; it is not a group mind, not performed work, not evidence sufficiency, and not assurance by itself. That evidence-bound reading states:
...
- an [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] work-alignment claim when work roles explain the case;
- a [[02_C.26.02 - Enacted Distributed State Evidence|C.26.2]] low-recoverability distributed-state reading when coordination evidence survives ordinary rivals;
- an [[00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] evidence path or [[00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] assurance claim path when the distributed-state reading will be used as evidence or assurance for a work claim or reliance claim;
- no distributed-state reading when evidence sources, rivals, or time window cannot be named.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12b - [[00_C.29 - Mathematical Lens Use|C.29]] mathematical-lens use relation

> If a mathematical lens helps select a method, compare method families, shape a work plan, or diagnose work, use [[00_C.29 - Mathematical Lens Use|C.29]] only for the fit of that mathematical diagnostic or method-selection reason. The next concrete object remains under the [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] family: `ChoiceResult` or local choice record when a choice is made, selected method or method-family selection when the method-governance claim is being made, `U.WorkPlan` for a plan, performed `U.Work` and work-result record for execution, and an [[04_A.15.04 - Work-Relevant Source Restoration|A.15.4]] source-restoration reference when the issue is work-relevant source restoration. A mathematical lens may explain why a diagnostic distinction is useful; it does not make a plan into performed work or a method explanation into execution evidence.

## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12c - P2W Work-Family Split

When a P2W use under [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] produces a `WorkPlanning` relation, this family carries the split among selected method, `U.WorkPlan`, `SlotFillingsPlanItem`, performed `U.Work`, and result-related records. A P2W principle scheme, functional diagram, or scenario may guide method inspection and work-planning preparation only after the current work-family object is named.
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12d - P2W Performed-Work Relation

When [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] reaches performed work, this family keeps the current kind as `U.Work`. WorkEnactment wording is explanatory only: it points to dated performed work, not to a second work kind.
...
## [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]]:12e - P2W Integration As Role Enactability

When [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] uses integration wording to mean role enactability under interface constraints, this family carries the role, method, plan, and performed-work part of the claim. Name the selected role, `U.RoleAssignment` when the role-assignment claim is being made, method or method description, relevant `U.WorkPlan` or performed `U.Work`, and the interface constraints governed by the architecture or module-interface pattern.
