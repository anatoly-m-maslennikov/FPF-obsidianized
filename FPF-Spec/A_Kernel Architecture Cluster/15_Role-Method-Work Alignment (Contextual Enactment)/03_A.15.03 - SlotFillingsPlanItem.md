...
> **Status:** Stable
> **Normativity:** Normative (unless explicitly marked informative)
> **Placement:** Part A → [[00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] (Work & WorkPlanning)
> **Builds on:** `U.WorkPlan` ([[02_A.15.02 - U.WorkPlan|A.15.2]]), performed-work occurrence discipline ([[01_A.15.01 - U.Work|A.15.1]] and [[00_E.18 - Transformation Flow Structure|E.18]]), Context discipline ([[03_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]]), `MechSuiteDescription` ([[15_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]]), and publication/view discipline ([[03_E.17 - Multi-View Publication Kit|E.17]]; views are projections, not places of meaning)
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:1 - Problem frame
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:2 - Problem (what breaks without it)
...
6. **G-pattern fragmentation:** each Part G pattern invents its own place to stash planned refs (method pick, comparator pick, QD archive config, etc.), blocking a clean “[[00_G.Core - Part G Core Invariants|G.Core]]” universal layer and making modular reuse brittle.

## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:3 - Forces (what we must balance)
...
* **Supports universalization:** one PlanItem pattern must be usable across the whole of Part G, not just [[00_G.05 - Multi-Method Dispatcher & MethodFamily Registry|G.5]].
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4 - Solution

### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.1 Definition
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.2 Core conceptual descriptors (not a data schema)
...
1. **PlanItem core (from [[02_A.15.02 - U.WorkPlan|A.15.2]])**
...
3. **EntityOfConcern and grounding (for the measurement or selected filler under planning)**
   ...
   * `described_entity_ref : <concrete RefKind>` (required)
     The referent is the *EntityOfConcern* ([[05_C.02.03 - Unified Formality Characteristic F|C.2.3]] role): the thing the planned baseline is **about**.
...
6. **Expected guard pins** (references and expectations only; no gate decisions)
   ...
   * `guard_owner_gate_ref? : <concrete OperationalGateRefKind>` (refs only; required when `expected_usm_guard_pins` is non-empty unless unambiguously derivable)
     ...
     (Use the concrete RefKind that addresses `OperationalGate(profile)` in [[00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]]. If such a RefKind does not exist, do not claim a conforming guard-owner gate reference.)
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.2.1 Canonical skeleton (Show)
...
SlotFillingsPlanItem := ⟨
  ...
  described_entity_ref = U.HolonRef(H:EntityOfConcern), // or another concrete RefKind per [[C_Kernel Extension Specifications/00_02_Epistemic holon composition (KD-CAL)/05_C.02.03 - Unified Formality Characteristic F|C.2.3]]
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.3 Relation to Work enactment (planned baseline vs actuals)
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.4 Relation to suites or kits
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.5 - Variants
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.6 - Local boundaries
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.7 - When to use
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:4.8 - Implementation notes
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:5 - Archetypal Grounding (Tell–Show–Show; System / Episteme)

### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:5.1 - Archetype 1: CHR suite planned baseline for lawful characterization
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:5.2 - Archetype 2: Archive and QD selection with edition-sensitive descriptors
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:6 - Bias-Annotation
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:7 - Conformance Checklist
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:8 - Common Anti‑Patterns and How to Avoid Them

### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:8.1 - Plan-as-execution
...
### [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:8.2 - Anti-example: Edition-key change disguised as a plan edit (backfill)
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:9 - Consequences
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:10 - Rationale
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:11 - SoTA‑Echoing (informative)
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:12 - Relations

* **Builds on and is governed by:**
  * **[[02_A.15.02 - U.WorkPlan|A.15.2]] `U.WorkPlan`** — container + PlanItem discipline; baseline citeability.
  * **[[13_A.06.05 - U.RelationSlotDiscipline - SlotKind - ValueKind - RefKind discipline for n-ary relations (with slot-operation lexicon)|A.6.5]] slot discipline** — SlotKind and RefKind hygiene and binding-time separation.
  * **[[03_E.10.D1 - Lexical Discipline for “Context” (D.CTX)|E.10.D1]] Context discipline** — explicit context and edition; no implicit “latest”.
  * **[[00_E.18 - Transformation Flow Structure|E.18]] and [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]]** — keeps `FinalizeLaunchValues` strictly in WorkEnactment; pin and guard discipline.
* **[[03_E.17 - Multi-View Publication Kit|E.17]] publication discipline** — views are projections; no new semantics on cards.
* **Interacts with and complements:**
  * **[[15_A.06.07 - MechSuiteDescription - Description of a set of distinct mechanisms|A.6.7]] `MechSuiteDescription`** — suites may require the presence of a planned-baseline reference or pin without embedding planned fillers or launch values.
  * **[[01_A.15.01 - U.Work|A.15.1]] Work and WorkEnactment discipline** — fulfilment and variance are recorded downstream against this baseline.
  * **C3.2-S-02 Time discipline** — time selection policy may be pinned by ref; run-time `Γ_time` stays in Work evidence.

## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:12a - P2W Planned-Baseline Use Relation

When [[01_E.18.01 - Principles-to-Work Carry-Through|E.18.1]] reaches a planned-baseline question, `SlotFillingsPlanItem` records the planned mapping from a slot-bearing description and `SlotKind`s to planned fillers. It may include evidence-reference hooks, edition pins, assumptions, dependencies, and freshness requests needed before work is enacted.
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:12b - Planned-Baseline To Performed-Work Boundary
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:12c - Lowering, Repair, and Refresh Conditions
...
## [[03_A.15.03 - SlotFillingsPlanItem|A.15.3]]:End
