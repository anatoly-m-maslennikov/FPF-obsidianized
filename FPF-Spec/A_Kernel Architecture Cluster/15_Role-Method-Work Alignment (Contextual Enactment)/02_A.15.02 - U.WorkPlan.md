...
3. Decide whether the encountered planning input is a `U.WorkPlan`, a method description, performed `U.Work`, a `SlotFillingsPlanItem`, `WorkEntryReadiness@Context`, evidence, gate claim, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] appearance-based reliance repair case, publication-use cue, or declarative representation. A planning input may be a record, cue, or plan element; that phrase is not a new kind.
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:2 - Problem (what breaks without `WorkPlan`)
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:3 - Forces (what the definition balances)
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4 - Solution - `U.WorkPlan` as the time-bound intention for `U.Work`

### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4.1 - Definition
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4.2 - `PlanItem` values (what a `WorkPlan` is made of)
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4.3 - Clear distinctions for schedule, process, and workflow wording
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4.4 - Plan mereology (composition of plans ≠ composition of methods or work occurrences)
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:4.5 - How `WorkPlan` Meets `Work` (Fulfilment and Variance)
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:5 - What a good `WorkPlan` states (review checklist)
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:6 - Archetypal grounding (parallel domains)

### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:6.1 - Hospital OR day plan (shift rota + cases)
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:6.2 - Fab maintenance weekend (asset reservations)
...
### [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:6.3 - Data‑center rollout (multi‑context plan)
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:7 - Scope Declaration and Rationale
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:7a - Conformance Checklist
...
| CC-A15.2-3 | Proposed `U.RoleAssignment`s remain intended assignments until checked for the performed-work interval by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)]] and [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work]]. | The plan does not accept the role assignment for that interval by publication alone. |
...
| CC-A15.2-8 | Planned preparation or full-kit tasks may appear in the WorkPlan, but `WorkEntryReadiness@Context` is governed by [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/05_A.15.05 - Work-Entry Readiness and Full-Kit Preparation]]. | The plan may say what should be prepared; it does not decide readiness for work entry by itself. |

## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:7b - Common Anti-Patterns and How to Avoid Them
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:7c - Consequences
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:7e - Relations

* **Builds on:** [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/00_A.15 - Role-Method-Work Alignment (Contextual Enactment)|A.15]] Role-Method-Work Alignment, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/01_A.15.01 - U.Work|A.15.1]] `U.Work`, [[A_Kernel Architecture Cluster/02_Role Taxonomy/01_A.02.01 - U.RoleAssignment - Contextual Work-Role Assignment|A.2.1]] `U.RoleAssignment`, `U.Method`, and `U.MethodDescription`.
* **Coordinates with:** [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/03_A.15.03 - SlotFillingsPlanItem|A.15.3]] for `SlotFillingsPlanItem` values, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] for work-relevant appearance-based reliance repair, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/05_A.15.05 - Work-Entry Readiness and Full-Kit Preparation|A.15.5]] for work-entry readiness and full-kit preparation, [[A_Kernel Architecture Cluster/10_Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph/00_A.10 - Evidence Graph Referring- Claim-Bound Evidence and Provenance Graph|A.10]] for evidence-provenance relations, [[B_Trans-disciplinary Reasoning Cluster/02_03_Trust and Assurance Calculus (F-G-R with Congruence)/00_B.03 - Trust and Assurance Calculus (F-G-R with Congruence)|B.3]] for assurance, [[A_Kernel Architecture Cluster/20_Flow Constraint Validity - Eulerian/00_A.20 - Flow Constraint Validity - Eulerian|A.20]] and [[A_Kernel Architecture Cluster/21_GateProfilization- OperationalGate(profile) (GateFit core)/00_A.21 - GateProfilization- OperationalGate(profile) (GateFit core)|A.21]] for gates and constraint decisions, [[C_Kernel Extension Specifications/20_32_Architecture Candidate Synthesis/01_C.32.P2S - Problem-to-Structure Architecturing Unfolding|C.32.P2S]] for architecturing-flow refs to intended work that realizes selected structures, and [[E_The FPF Constitution and Authoring Guides/16_17_Multi-View Publication Kit/03_E.17 - Multi-View Publication Kit|E.17]] for publication-use questions.
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:8 - P2W WorkPlanning Use Relation

When [[E_The FPF Constitution and Authoring Guides/17_18_Transformation Flow Structure/01_E.18.01 - P2W Problem-to-Work Carry-Through|E.18.1]] reaches WorkPlanning, `U.WorkPlan` states intended work occurrences, planned windows, intended role values, role-admission conditions, capability-fit conditions, planned constraints, resource budgets, acceptance targets, evidence-reference notes, source-currentness requests, and `PlanItem` values.

When the P2W use also needs a readiness question, the WorkPlan may supply target PlanItems, planned preparation tasks, reservations, and planned baselines. [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/05_A.15.05 - Work-Entry Readiness and Full-Kit Preparation|A.15.5]] carries the `WorkEntryReadiness@Context` relation that judges full-kit condition, commitment disposition, resource readiness, WIP or flow policy, and launch-gate refs when those are current.
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:9 - Launch-Value Boundary For P2W
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:10 - Lowering, Repair, and Refresh Conditions

Lower a candidate `U.WorkPlan` claim when horizon, planned window, target method, method-description reference when current, intended role value or role-admission condition, planned constraint, resource budget, dependency, acceptance target, or baseline cannot be named at the granularity required by the next planning use. The acceptable lowered result is a planning cue, method-description note, missing-source-relation note, [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/04_A.15.04 - Work-Relevant Appearance-Based Reliance Repair|A.15.4]] repair request, publication-use cue, declarative-representation note, readiness-gap note for [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/05_A.15.05 - Work-Entry Readiness and Full-Kit Preparation|A.15.5]], or evidence-reference note, not a conforming WorkPlan.
...
## [[A_Kernel Architecture Cluster/15_Role-Method-Work Alignment (Contextual Enactment)/02_A.15.02 - U.WorkPlan|A.15.2]]:End
